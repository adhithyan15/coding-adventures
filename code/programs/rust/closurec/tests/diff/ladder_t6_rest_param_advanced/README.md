# ladder_t6_rest_param_advanced

Rung 6.rest_param of the CCR-066 differential complexity ladder, at `ADVANCED`.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t6_rest_param_advanced/input/a.js
```
...
```js
function f(...a){return a.length}console.log(f(1,2));
```
