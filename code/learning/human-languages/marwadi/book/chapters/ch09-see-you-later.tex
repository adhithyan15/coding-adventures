...
\hlblockfigure{\detokenize{figures/MW-W07-chha-filmstrip.pdf}}{How \mw{छ} is written, stroke by stroke}
...
\subsection*{Script — one sign}
\hlblockfigure{\detokenize{figures/MW-W07-la-filmstrip.pdf}}{How \mw{ल} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listen:} hear one line and identify common farewell or see-you-later.
  \item \textbf{Speak:} answer a later-meeting cue with \emph{pāchhe milsū}.
  \item \textbf{Read:} match both printed lines to their meanings.
  \item \textbf{Write:} hear \emph{pāchhe milsū}, wait ten seconds, and write it without a model.
\end{enumerate}
