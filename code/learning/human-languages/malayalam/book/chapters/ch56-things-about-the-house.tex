...
% canonical-source-hash: fnv1a64:df2e5a421aac028b
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{pāya}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{vayal}, then \emph{pāya}, and say which of the two is woven
  \item \emph{Recall:} say \emph{maraṁ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{koṭṭa}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{pāya}, then \emph{koṭṭa}, and hold the doubled sound in the second
  \item \emph{Recall:} read \textbf{\ml{കൊമ്പ്}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{koṭṭa}, then \emph{katti}, and hear the same held sound in both
  \item \emph{Recall:} say \emph{taṭi}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{pātraṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{pātraṁ}, and then say which of its two senses a cook means
  \item \emph{Recall:} read \textbf{\ml{വേര്}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{pāya}, \emph{koṭṭa}, \emph{katti}, \emph{pātraṁ}, \emph{peṭṭi}
  \item \emph{Recall:} say \emph{vittŭ}
\end{itemize}
