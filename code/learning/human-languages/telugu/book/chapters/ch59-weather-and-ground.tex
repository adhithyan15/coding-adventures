...
% canonical-source-hash: fnv1a64:b57d7db2f2df369e
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{gāli}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{gāli}, then \emph{veḷḷostānu}, and use the one as a reason for the other
  \item \emph{Recall:} say \emph{meḍa}, then read \textbf{\te{కొంచెం}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{mañcu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{mañcu}, then \emph{gāli}, and say which of the two you can see
  \item \emph{Recall:} read \textbf{\te{వీపు}}, then say \emph{ekkuva}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{isuka}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{isuka}, then \emph{nadi}, and say where you would find one beside the other
  \item \emph{Recall:} say \emph{pedavi}, then read \textbf{\te{తక్కువ}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{burada}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{burada}, then \emph{isuka}, and say what turns one into the other
  \item \emph{Recall:} read \textbf{\te{గోరు}}, then say \emph{vaddu}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{nippu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then say \emph{gāli ekkuva}, and take your leave with \emph{veḷḷostānu}
  \item \emph{Recall:} say \emph{emuka}, then read \textbf{\te{అంతే}} and say what it means
\end{itemize}
