...
% canonical-source-hash: fnv1a64:b28425ca066fbac3
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{mēlē}, then read \textbf{\ta{கீழே}}, then say \emph{saṭṭai}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\ta{உள்ளே}}, then say \emph{vēṭṭi}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{veḷiyē}, then read \textbf{\ta{புடவை}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\ta{வலது}}, then say \emph{seruppu}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{iḍadu}, then read \textbf{\ta{தொப்பி}}
\end{itemize}
