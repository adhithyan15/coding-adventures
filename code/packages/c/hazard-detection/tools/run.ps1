# Build and run the hazard-detection tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name hazard_detection-tests -Sources @("tests\hazard_detection_test.c", "src\hazard_detection.c")
