...
CommonMark 0.31.2 compliant Markdown parser producing a Document AST.
...
This parser passes all 652 examples from the [CommonMark 0.31.2 specification](https://spec.commonmark.org/0.31.2/).
...
This package implements TE02 — CommonMark Parser (using the TE00 Document AST IR).
