...
## Lesson 100 — `haskell/zstd` had the same Repeated-Offset (R1/R2/R3) decode-only gap PR #9941 found in `c/zstd`; every `zstd` port needs an independent audit, not just the one that found the bug class
