# Build and run the ieee802154-core tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name ieee802154_core-tests -Sources @("tests\ieee802154_core_test.c", "src\ieee802154_core.c")
