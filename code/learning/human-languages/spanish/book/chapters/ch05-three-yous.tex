...
% canonical-source-hash: fnv1a64:c8a7a866d54f7d48
% canonical-lessons: ES-C03-tu-usted, ES-C03-tu-usted-register, ES-C03-vos, ES-C03-usted-origin, ES-C03-quien, ES-C03-repaso-tu-usted
...
\end{tcolorbox}
\section[quién]{quién — “who?” in one gentle step}

\label{lesson:ES-C03-quien}



\begin{quote}
You can choose \textbf{tú} or \textbf{usted} for the person in front of you. Now add one tiny question about a person: \textbf{¿Quién?} — “Who?”
\end{quote}

\begin{cousinweb}
Say \textbf{quién} like \emph{kyen}, one smooth beat. It asks for a \textbf{person}:

\begin{quote}
— \textbf{¿Quién?} — Who? — \textbf{Ana.}
\end{quote}
...
\begin{itemize}
\raggedright
  \item \textbf{¿Quién?} — then answer with one name
  \item \textbf{tú}, \textbf{usted} — you; \textbf{¿Quién?} — who
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which two words mean “you”? (\textbf{Tú, usted}.) Which word asks “who”? (\textbf{Quién}.) Say it once more, slowly. Stop there.
\end{tcolorbox}
...
\begin{quote}
Three words for “you,” plus \textbf{quién} for “who.” Nothing new in this lesson — only what you already have.
\end{quote}
...
\raggedright
  ...
  \item point to one person, ask \textbf{¿Quién?}, and answer with a name
