...
<!-- hl-knowledge: introduces=[HI-SCRIPT-RECOG-110]; assesses=[] -->
...
## Writing: र
<!-- hl-knowledge: introduces=[]; assesses=[HI-SCRIPT-RECOG-110] -->
...
romanization: "ka"
prerequisites: [HI-S110-letter-ra]
sounds: []
roots: []
duration:
  max_seconds: 150
...
practises:
  knowledge: [HI-SCRIPT-RECOG-110, HI-SCRIPT-RECOG-111]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus]
register: neutral
variety: standard-colloquial
reviews_of: [HI-S110-letter-ra]
---
...
<!-- hl-knowledge: introduces=[HI-SCRIPT-RECOG-111]; assesses=[] -->
...
romanization: "pa"
prerequisites: [HI-S112-vowel-sign-e]
sounds: []
roots: []
duration:
  max_seconds: 150
requires:
  knowledge: [HI-SCRIPT-RECOG-112]
introduces:
  knowledge: [HI-SCRIPT-RECOG-113]
practises:
  knowledge: [HI-SCRIPT-RECOG-112, HI-SCRIPT-RECOG-113]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus]
register: neutral
...
<!-- hl-knowledge: introduces=[HI-SCRIPT-RECOG-113]; assesses=[] -->
...
romanization: "ha"
prerequisites: [HI-S113-letter-pa]
sounds: []
roots: []
duration:
  max_seconds: 150
...
practises:
  knowledge: [HI-SCRIPT-RECOG-113, HI-SCRIPT-RECOG-114]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus]
register: neutral
variety: standard-colloquial
reviews_of: [HI-S113-letter-pa]
---
...
<!-- hl-knowledge: introduces=[HI-SCRIPT-RECOG-114]; assesses=[] -->
...
type: writing
headword: "ी"
gloss: the single character ी — recognised inside words you already say
romanization: "ī"
prerequisites: [HI-S115-letter-ya]
sounds: []
roots: []
duration:
  max_seconds: 150
...
practises:
  knowledge: [HI-SCRIPT-RECOG-115, HI-SCRIPT-RECOG-116]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus]
register: neutral
variety: standard-colloquial
reviews_of: [HI-S115-letter-ya]
---
...
[PAUSE 1s] Before the new one: य — what does it do?

[PAUSE 2s] One character this time. Just one — and you have been saying it
for pages without knowing which mark on the page it was.

## Script you'll notice: ◌ी
<!-- hl-knowledge: introduces=[HI-SCRIPT-RECOG-116]; assesses=[] -->
...
Put your pen on ◌ी and follow its line. Copy the shape you can see — slowly,
and larger than it is printed.
...
[PAUSE 1s]
- [YOU LOOK: at these words, and find ◌ी in the ones that have it]

> ख़ुशी  ·  ठीक  ·  नमस्ते

- [YOU TRACE: ◌ी three times, saying *ī* as you finish each one]
- [YOU LOOK: back at any page of this chapter and find ◌ी once more]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[HI-SCRIPT-RECOG-116] -->

[PAUSE 3s] Which character is this — ◌ी? What vowel does it put on the consonant it attaches to — and what does it take off? (**Puts *ī* on; takes the built-in *a* off.**)
Name one word you already say that contains it.
