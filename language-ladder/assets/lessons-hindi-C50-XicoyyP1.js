...
[PAUSE 2s] Before the new one: what did *ādar* mean?

## You'll want to know: आशीर्वाद
<!-- hl-knowledge: introduces=[HI-LEX-C50-COURTESY-04]; assesses=[] -->
...
[PAUSE 3s] What does आशीर्वाद mean? ("a blessing".) Say it once more.
`,r=e({default:()=>i}),i=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C50-gratitude]
---

# एहसान (ehsān) — a favour

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C49-LEAVE-05, HI-LEX-C50-COURTESY-01] -->

[PAUSE 2s] Before the new one: what did *ābhār* mean?

## You'll want to know: एहसान
<!-- hl-knowledge: introduces=[HI-LEX-C50-COURTESY-02]; assesses=[] -->

**एहसान** (*ehsān*) — "a favour".

Arabic *iḥsān*, 'the doing of what is good', on the root *ḥ-s-n*, which carries both beauty and goodness and also gives the names *ḥasan* and *ḥusn*. Persian passed it on to Hindi as the word for a kindness done to you and not forgotten.
...
[PAUSE 3s] What does एहसान mean? ("a favour".) Say it once more.
`,a=e({default:()=>o}),o=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C49-meeting]
---

# आभार (ābhār) — gratitude

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C49-LEAVE-04, HI-LEX-C49-LEAVE-05] -->

[PAUSE 2s] Before the new run of words: what did *nikalnā* mean, and what did *mulāqāt* mean?

## You'll want to know: आभार
<!-- hl-knowledge: introduces=[HI-LEX-C50-COURTESY-01]; assesses=[] -->
...
[PAUSE 3s] What does आभार mean? ("gratitude".) Say it once more.
`,s=e({default:()=>c}),c=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C50-favour]
---

# आदर (ādar) — respect

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C50-COURTESY-01, HI-LEX-C50-COURTESY-02] -->

[PAUSE 2s] Before the new one: what did *ehsān* mean?

## You'll want to know: आदर
<!-- hl-knowledge: introduces=[HI-LEX-C50-COURTESY-03]; assesses=[] -->

**आदर** (*ādar*) — "respect".

Sanskrit *ādara*, 'regard, attentiveness', from *ā-dṛ-*, 'to heed'. Hindi carries this word inside its own machinery: the आप form is called *ādar-sūcak*, the respect-marking form.
...
[PAUSE 3s] What does आदर mean? ("respect".) Say it once more.
`,l=e({default:()=>u}),u=`---
schema_version: 2
introduces_idioms: [HI-IDIOM-PRANAM-SALUTATION-01]
introduces_senses: []
introduces_culture_claims: [HI-CULTURE-PRANAM-RESPECT-SALUTATION-01]
id: HI-C50-salutation
spine_node: SPINE-COURTESY-THANK
sequence: 1640
chapter: 50
type: word
...
<!-- hl-knowledge: introduces=[HI-LEX-C50-COURTESY-05]; assesses=[] -->
...
[PAUSE 3s] What does प्रणाम mean? ("a bow, a salutation".) Say it once more.
`,d=e({default:()=>f}),f=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C51-garland]
---

# आँगन (āṁgan) — a courtyard

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C51-WELCOME-01, HI-LEX-C51-WELCOME-02] -->

[PAUSE 2s] Before the new one: what did *mālā* mean?

## You'll want to know: आँगन
<!-- hl-knowledge: introduces=[HI-LEX-C51-WELCOME-03]; assesses=[] -->
...
[PAUSE 3s] What does आँगन mean? ("a courtyard".) Say it once more.
`,p=e({default:()=>m}),m=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C50-salutation]
---

# फूल (phūl) — a flower

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C50-COURTESY-04, HI-LEX-C50-COURTESY-05] -->

[PAUSE 2s] Before the new run of words: what did *āśīrvād* mean, and what did *praṇām* mean?

## You'll want to know: फूल
<!-- hl-knowledge: introduces=[HI-LEX-C51-WELCOME-01]; assesses=[] -->
...
[PAUSE 3s] What does फूल mean? ("a flower".) Say it once more.
`,h=e({default:()=>g}),g=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C51-flower]
---

# माला (mālā) — a garland

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C50-COURTESY-05, HI-LEX-C51-WELCOME-01] -->

[PAUSE 2s] Before the new one: what did *phūl* mean?

## You'll want to know: माला
<!-- hl-knowledge: introduces=[HI-LEX-C51-WELCOME-02]; assesses=[] -->
...
[PAUSE 3s] What does माला mean? ("a garland".) Say it once more.
`,_=e({default:()=>v}),v=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
[PAUSE 2s] Before the new one: what did *mez* mean?

## You'll want to know: मिठाई
<!-- hl-knowledge: introduces=[HI-LEX-C51-WELCOME-05]; assesses=[] -->
...
[PAUSE 3s] What does मिठाई mean? ("a sweet".) Say it once more.
`,y=e({default:()=>b}),b=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
[PAUSE 2s] Before the new one: what did *āṁgan* mean?

## You'll want to know: मेज़
<!-- hl-knowledge: introduces=[HI-LEX-C51-WELCOME-04]; assesses=[] -->
...
[PAUSE 3s] What does मेज़ mean? ("a table".) Say it once more.
`,x=e({default:()=>S}),S=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C52-rice]
---

# दाल (dāl) — lentils, split pulses

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C51-WELCOME-05, HI-LEX-C52-KITCHEN-01] -->

[PAUSE 2s] What did the word before this one mean?

## You'll want to know: दाल
<!-- hl-knowledge: introduces=[HI-LEX-C52-KITCHEN-02]; assesses=[] -->
...
[PAUSE 3s] What does दाल mean? ("lentils, split pulses".) Say it once more.
`,C=e({default:()=>w}),w=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C52-lentils]
---

# तेल (tel) — oil

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C52-KITCHEN-01, HI-LEX-C52-KITCHEN-02] -->

[PAUSE 2s] Name the 2 words of this chapter so far.

## You'll want to know: तेल
<!-- hl-knowledge: introduces=[HI-LEX-C52-KITCHEN-03]; assesses=[] -->
...
English did the same thing by a different road: *oil* goes back to Latin *oleum*, from Greek *élaion*, 'olive oil' — oil named after the olive. Two languages, two plants, one habit of naming the substance after whatever you happened to press.
...
[PAUSE 3s] What does तेल mean? ("oil".) Say it once more.
`,T=e({default:()=>E}),E=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C51-sweet]
---

# चावल (chāval) — rice

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C51-WELCOME-04, HI-LEX-C51-WELCOME-05] -->

[PAUSE 2s] Before the new run of words: what did the last two words of the chapter before mean?

## You'll want to know: चावल
<!-- hl-knowledge: introduces=[HI-LEX-C52-KITCHEN-01]; assesses=[] -->
...
[PAUSE 3s] What does चावल mean? ("rice".) Say it once more.
`,D=e({default:()=>O}),O=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
[PAUSE 2s] Name the 3 words of this chapter so far.

## You'll want to know: चीनी
<!-- hl-knowledge: introduces=[HI-LEX-C52-KITCHEN-04]; assesses=[] -->
...
[PAUSE 3s] What does चीनी mean? ("sugar".) Say it once more.
`,k=e({default:()=>A}),A=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
<!-- hl-knowledge: introduces=[HI-LEX-C52-KITCHEN-05]; assesses=[] -->

**सब्ज़ी** (*sabzī*) — "a vegetable, vegetables".

A Persian word: *sabz* means 'green', and *-ī* turns an adjective into a noun. सब्ज़ी is 'greenery' — the green things, taken together.

You have met this suffix already without being told: ख़ुशी (*khushī*), 'happiness', is *khush*, 'pleased', with the same *-ī* on the end. One ending, two words, both Persian.
...
[PAUSE 3s] What does सब्ज़ी mean? ("a vegetable, vegetables".) Say it once more.
`,j=e({default:()=>M}),M=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
<!-- hl-knowledge: introduces=[HI-LEX-C53-BODY-04]; assesses=[] -->

**पीठ** (*pīṭh*) — "the back".

From Sanskrit पृष्ठ (*pṛṣṭha*), 'back, surface'. The heavy *-ṛṣṭh-* in the middle collapsed and paid for itself by lengthening the vowel in front of it.
...
[PAUSE 3s] What does पीठ mean? ("the back".) Say it once more.
`,N=e({default:()=>P}),P=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C53-knee]
---

# माथा (māthā) — a forehead

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C53-BODY-01, HI-LEX-C53-BODY-02] -->

[PAUSE 2s] Name the 2 words of this chapter so far.

## You'll want to know: माथा
<!-- hl-knowledge: introduces=[HI-LEX-C53-BODY-03]; assesses=[] -->
...
[PAUSE 3s] What does माथा mean? ("a forehead".) Say it once more.
`,F=e({default:()=>I}),I=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C53-shoulder]
---

# घुटना (ghuṭnā) — a knee

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C52-KITCHEN-05, HI-LEX-C53-BODY-01] -->

[PAUSE 2s] What did the word before this one mean?

## You'll want to know: घुटना
<!-- hl-knowledge: introduces=[HI-LEX-C53-BODY-02]; assesses=[] -->
...
[PAUSE 3s] What does घुटना mean? ("a knee".) Say it once more.
`,L=e({default:()=>R}),R=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
<!-- hl-knowledge: introduces=[HI-LEX-C53-BODY-05]; assesses=[] -->
...
Do not reach for Latin *labium* as a cousin here — it is not one. Two Indo-European languages can have perfectly ordinary words for the same body part that descend from completely different roots, which you have already met with रात beside *nox*.
...
[PAUSE 3s] What does होंठ mean? ("a lip".) Say it once more.
`,z=e({default:()=>B}),B=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C52-vegetable]
---

# कंधा (kandhā) — a shoulder

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C52-KITCHEN-04, HI-LEX-C52-KITCHEN-05] -->

[PAUSE 2s] Before the new run of words: what did the last two words of the chapter before mean?

## You'll want to know: कंधा
<!-- hl-knowledge: introduces=[HI-LEX-C53-BODY-01]; assesses=[] -->
...
[PAUSE 3s] What does कंधा mean? ("a shoulder".) Say it once more.
`,V=e({default:()=>H}),H=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C54-fish]
---

# चिड़िया (chiṛiyā) — a small bird
...
<!-- hl-knowledge: introduces=[HI-LEX-C54-ANIMAL-04]; assesses=[] -->
...
[PAUSE 3s] What does चिड़िया mean? ("a small bird".) Say it once more.
`,U=e({default:()=>W}),W=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
<!-- hl-knowledge: introduces=[HI-LEX-C54-ANIMAL-01]; assesses=[] -->

**गाय** (*gāy*) — "a cow".

From Sanskrit गो (*go*), 'cow' — and this one goes all the way back. The reconstructed ancestor is *gʷṓws*, which gives Latin *bōs*, Greek *boûs*, and English *cow*.
...
[PAUSE 3s] What does गाय mean? ("a cow".) Say it once more.
`,G=e({default:()=>K}),K=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C54-horse]
---

# मछली (machhlī) — a fish

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C54-ANIMAL-01, HI-LEX-C54-ANIMAL-02] -->

[PAUSE 2s] Name the 2 words of this chapter so far.

## You'll want to know: मछली
<!-- hl-knowledge: introduces=[HI-LEX-C54-ANIMAL-03]; assesses=[] -->
...
[PAUSE 3s] What does मछली mean? ("a fish".) Say it once more.
`,q=e({default:()=>J}),J=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
<!-- hl-knowledge: introduces=[HI-LEX-C54-ANIMAL-05]; assesses=[] -->
...
[PAUSE 3s] What does बकरी mean? ("a goat".) Say it once more.
`,Y=e({default:()=>X}),X=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-colloquial
reviews_of: [HI-C54-cow]
---

# घोड़ा (ghoṛā) — a horse

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-C53-BODY-05, HI-LEX-C54-ANIMAL-01] -->

[PAUSE 2s] What did the word before this one mean?

## You'll want to know: घोड़ा
<!-- hl-knowledge: introduces=[HI-LEX-C54-ANIMAL-02]; assesses=[] -->
...
[PAUSE 3s] What does घोड़ा mean? ("a horse".) Say it once more.
