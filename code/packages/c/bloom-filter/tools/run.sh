#!/bin/sh
# Build and run the bloom-filter tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c bloom_filter-tests tests/bloom_filter_test.c src/bloom_filter.c
