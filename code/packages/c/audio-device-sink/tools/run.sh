#!/bin/sh
# Build and run the audio-device-sink tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c audio_device_sink-tests tests/audio_device_sink_test.c src/audio_device_sink.c
