...
| 2026-08-27 | A workflow-wide build plan scheduled pure-BEAM packages on Windows while the canonical matrix deliberately skipped Elixir setup, so `mix` was unavailable. | The concurrent Elixir Windows build-front work in #13287 owns this contract; rebase FM-B024 after it lands instead of duplicating its runner pin, setup-beam, and BUILD_windows changes. |
