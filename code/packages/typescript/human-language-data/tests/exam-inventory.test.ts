...
describe("the committed A1 inventory", () => {
  ...
  it("classifies every unmapped point, so a new null cannot slip in unnoticed", () => {
    ...
    expect(unmapped.sort()).toEqual([
      ...
      "A1-F5-10", "A1-F6-06", "A1-NE02-01", "A1-NE06-01", "A1-NE06-05", "A1-NE07-04", "A1-NE07-06", "A1-NE08-02", "A1-NE09-06", "A1-NE11-04",
...
describe("what the corpus actually covers", () => {
  it("pins A1 coverage, which is the number this project is judged on", () => {
    ...
    expect(coverage.unmapped).toBe(41); // 42 -> 41 // 44 -> 42 (ch419): NE18-02 authored, NE18-05 merely wired // was 0 while only grammar was enumerated
  ...
  it("reports the shortfall in a form somebody can act on", () => {
    ...
    expect(report).toContain("spanish A1 (partial inventory): 232/273 points covered (85%)");
    expect(report).toContain("41 with no corresponding atom");
