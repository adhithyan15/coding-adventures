...
const fallbackProps = {
  "backTemplateLabel": "back-template-label",
  "backTemplatePlaceholder": "back-template-placeholder",
  "backTemplateValue": "back-template-value",
  ...
  "fieldRequiredLabel": "field-required-label",
  "fieldRequiredValue": false,
  "fieldsLabel": "fields-label",
  "frontTemplateLabel": "front-template-label",
  "frontTemplatePlaceholder": "front-template-placeholder",
  "frontTemplateValue": "front-template-value",
  "nameLabel": "name-label",
  "namePlaceholder": "name-placeholder",
  "nameValue": "name-value",
  "newLabel": "new-label",
  "noteTypeIdLabel": "note-type-id-label",
  "noteTypeIdValue": "note-type-id-value",
  "noteTypeNames": [],
  "noteTypesLabel": "note-types-label",
  "saveLabel": "save-label",
  "selectedFieldIndex": 0,
  "selectedNoteTypeIndex": 0,
  "selectedTemplateIndex": 0,
  "stylesheetLabel": "stylesheet-label",
  "stylesheetPlaceholder": "stylesheet-placeholder",
  "stylesheetValue": "stylesheet-value",
  "templateLabels": [],
  "templateNameLabel": "template-name-label",
  "templateNamePlaceholder": "template-name-placeholder",
  "templateNameValue": "template-name-value",
  "templatesLabel": "templates-label"
};
const emitPayloads = {
