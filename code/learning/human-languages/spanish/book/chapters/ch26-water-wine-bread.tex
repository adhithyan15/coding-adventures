...
\begin{quote}
Two drinks, two very different journeys from Latin. One barely changed at all. And the \textquotedblleft{}masculine-looking\textquotedblright{} article on a feminine word isn't a mistake — it's a real, well-documented rule.
\end{quote}
...
\begin{itemize}
\raggedright
  \item \textquotedblleft{}el agua\textquotedblright{} — water, feminine, but takes el
  \item \textquotedblleft{}el vino\textquotedblright{} — wine
  \item the contrast — \textquotedblleft{}agua barely changed from aqua; French's eau wore all the way down\textquotedblright{}
  \item \textquotedblleft{}el águila, el hacha\textquotedblright{} — the same el-before-stressed-a pattern
\end{itemize}
