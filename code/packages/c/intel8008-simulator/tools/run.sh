#!/bin/sh
# Build and run the intel8008-simulator tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c intel8008_simulator-tests tests/intel8008_simulator_test.c src/intel8008_simulator.c
