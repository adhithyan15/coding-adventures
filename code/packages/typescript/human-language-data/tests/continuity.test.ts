...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    expect(report.summary.neverRevisitedPercent).toBe(16); // HL-C172: +4 -- the B2 argue rung (chapter 270) // HL-C173: +3 -- B2 closes (chapter 271)
