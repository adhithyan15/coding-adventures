...
describe("corpus snapshot", () => {
  ...
  it("pins the ramp, and the size of its blind spot", () => {
    ...
    expect(report.summary.unmeasurableLessons).toBe(591); // +2: HL-C88 slice 8 review + synthesis, correctly atom-free // +1: B1 si-condition synthesis, same reason // +2: the preterite review and synthesis, both correctly atom-free -- a review introduces nothing by definition // HL-C113 step 7: +2 -- the reported-speech review and synthesis, correctly atom-free for the same reason as every other pair on this line
