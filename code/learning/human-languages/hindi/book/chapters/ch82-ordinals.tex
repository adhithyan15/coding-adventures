...
% canonical-source-hash: fnv1a64:a45d5702bb6f3a3b
...
\end{tcolorbox}
\section[pā̃cvā̃ / pā̃cvī̃ / bīsvā̃ / sauvā̃]{\hi{पाँचवाँ} (pā̃cvā̃) — fifth, and the rule at last}
...
\textbf{\hi{पाँच}} $\to$ \textbf{\hi{पाँचवाँ}} (\emph{pā̃cvā̃}). Nothing is taken away and nothing is reshaped: the cardinal stands whole and \textbf{-\hi{वाँ}} goes on the end.
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
How is an ordinal made from five upward? (\textbf{The plain number, plus -\hi{वाँ}}.) How many nasal hooks are in \textbf{\hi{पाँचवाँ}} (\emph{pā̃cvā̃})? (\textbf{Two}.) And say \textquotedblleft{}twentieth\textquotedblright{}. (\textbf{\hi{बीसवाँ}}.)
\end{tcolorbox}
