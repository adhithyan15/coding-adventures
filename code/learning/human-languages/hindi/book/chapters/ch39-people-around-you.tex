...
% canonical-source-hash: fnv1a64:c68655a2b2fa010f
% canonical-lessons: HI-C39-dost, HI-C39-baccha, HI-C39-aadmi, HI-C39-aurat, HI-S135-letter-au
...
\section[dost]{\hi{दोस्त} (dost) — the friend, who is \textquotedblleft{}the one chosen\textquotedblright{}}
...
\end{tcolorbox}
\section[bacchā / bacchī / bachṛā]{\hi{बच्चा} / \hi{बच्ची} / \hi{बछड़ा} — children and the inherited \textquotedblleft{}yearling\textquotedblright{}}
...
\end{tcolorbox}
\section[ādmī]{\hi{आदमी} (ādmī) — the man, and the lean breaking backwards}
...
\end{tcolorbox}
\section[aurat / mahilā / strī]{\hi{औरत} (aurat) — the word for \textquotedblleft{}woman,\textquotedblright{} and which one to use}
...
\begin{quote}
You have said \textbf{\hi{औरत}} (\emph{aurat}), \textquotedblleft{}woman\textquotedblright{}. Its first letter is the one this lesson writes.
