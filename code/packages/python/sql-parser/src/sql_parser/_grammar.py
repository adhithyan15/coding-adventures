        ...
        GrammarRule(
            ...
            Alternation(choices=[
                ...
                Sequence(elements=[
                    ...
                    Optional(element=
                        RuleReference(name='index_hint', is_token=False),
                    ),
                ]),
            ]),
            line_number=100,
        ...
        GrammarRule(
            ...
            Sequence(elements=[
                ...
                Repetition(element=
                    Sequence(elements=[
                        Literal(value=','),
                        RuleReference(name='table_constraint', is_token=False),
                    ]),
                ),
                Literal(value=')'),
                Optional(element=
            ...
            Alternation(choices=[
                Group(element=
                    Sequence(elements=[
                        ...
                        Literal(value='NULL'),
                        Optional(element=
                            RuleReference(name='col_conflict_clause', is_token=False),
                        ),
                    ]),
                ),
                Literal(value='NULL'),
