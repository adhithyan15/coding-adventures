...
\textbf{And Sanskrit numbers have gender.} Look at the last column. When you meet these words again in Hindi, Marathi, Bengali, Gujarati or Punjabi, they will mostly descend from the \textbf{neuter} forms — \emph{tr\'{\={\i}}ṇi} and \emph{catv\'{\={a}}ri}, not \emph{tráyaḥ} and \emph{catv\'{\={a}}raḥ}. Keep that column in view; the daughter lessons depend on it.
