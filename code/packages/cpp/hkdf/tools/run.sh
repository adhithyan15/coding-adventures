#!/bin/sh
# Build and run the hkdf tests under EVERY available C/C++ compiler (pure ISO),
...
ISO_INCLUDE="include ../hmac/include ../sha256/include $HARNESS/include"
export ISO_INCLUDE
...
iso_build_and_run cpp hkdf-tests tests/hkdf_test.cpp
