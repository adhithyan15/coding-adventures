...
namespace CodingAdventures.Argon2d;

/// <summary>Optional Argon2d inputs from RFC 9106.</summary>
public sealed class Argon2dOptions
{
    ...
    public uint Version { get; init; } = Argon2d.Version;
}

/// <summary>Pure C# Argon2d password hashing as specified by RFC 9106.</summary>
public static class Argon2d
{
    ...
    private const uint TypeD = 0;

    /// <summary>Compute an Argon2d tag.</summary>
    public static byte[] Derive(
        ...
        int parallelism,
        int tagLength,
        Argon2dOptions? options = null)
    {
        ArgumentNullException.ThrowIfNull(password);
        ArgumentNullException.ThrowIfNull(salt);
        options ??= new Argon2dOptions();
        ...
        var initialHash = InitialHash(password, salt, timeCost, memoryCost, parallelism, tagLength, options);
    ...
    /// <summary>Compute an Argon2d tag and return lowercase hexadecimal.</summary>
        ...
        int parallelism)
    {
        ...
        for (var index = startingColumn; index < segmentLength; index++)
        {
            ...
            var pseudoRandom = previousBlock[0];
