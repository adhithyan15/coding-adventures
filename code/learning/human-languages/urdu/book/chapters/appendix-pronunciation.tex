...
\setlength{\itemsep}{0.35em}
  ...
  \end{minipage}
  \item \begin{minipage}[t]{\linewidth}
  \textbf{Sound id:} \texttt{qaf-uvular}
  \par \textbf{What to do:} draw the back of the tongue further back in the throat for \textbf{\ur{ق}} than for \textbf{\ur{ک}}; many speakers merge the two in casual speech
  \par \textbf{First anchor:} \textbf{\ur{قمیض}} \emph{qamīz}
  \end{minipage}
  \item \begin{minipage}[t]{\linewidth}
  \textbf{Sound id:} \texttt{te-dots-vs-tte-loop}
  \par \textbf{What to do:} two dots above make plain dental \textbf{\ur{ت}}; a small raised loop instead makes retroflex \textbf{\ur{ٹ}}
  \par \textbf{First anchor:} \textbf{\ur{جوتا}} \emph{jūtā} against \textbf{\ur{ٹھیک}} \emph{ṭhīk}
  \end{minipage}
  \item \begin{minipage}[t]{\linewidth}
  \textbf{Sound id:} \texttt{gaf-stroke}
  \par \textbf{What to do:} \textbf{\ur{گ}} is \textbf{\ur{ک}} with one extra stroke laid across the top
  \par \textbf{First anchor:} \textbf{\ur{گرمی}} \emph{garmī}
  \end{minipage}
\end{itemize}
...
\setlength{\itemsep}{0.35em}
  ...
  \item \textbf{\ur{ق}} \emph{qāf}, first read in \textbf{\ur{قمیض}}, shares its throat position with already-known \textbf{\ur{خ}} but is a stop rather than a fricative — a plosive version of the same back-of-the-mouth place. \textbf{\ur{ض}} \emph{zād}, in the same word, joins \textbf{\ur{ظ}} (from \textbf{\ur{حافظ}}) as a second letter carrying the plain \textbf{z} sound in Urdu, even though Arabic once told the two apart.
  \item \textbf{\ur{ت}} \emph{te}, first read in \textbf{\ur{جوتا}}, shares its base scoop with already-known \textbf{\ur{ٹ}}: two dots above make it plain dental \emph{t}, where a small raised loop instead makes \textbf{\ur{ٹ}} retroflex.
  \item \textbf{\ur{گ}} \emph{gāf}, first read in \textbf{\ur{گرمی}}, is already-known \textbf{\ur{ک}} with one extra stroke laid across the top — the same dot-count logic that told \textbf{\ur{ب}} apart from \textbf{\ur{پ}}, this time with a stroke instead of a dot.
\end{itemize}
