...
% canonical-source-hash: fnv1a64:b9a9054591dbd661
...
\section[pahlā]{\hi{पहला} (pahlā) — first}
...
\begin{cousinweb}
There is no \textbf{\hi{एक}} inside \textbf{\hi{पहला}}. It comes down from Sanskrit \textbf{\hi{प्रथम}} (\emph{prathama}), a word that already meant \textquotedblleft{}foremost\textquotedblright{} before Hindi existed, and the number was never part of it.
...
Say \textquotedblleft{}the first day\textquotedblright{}. (\textbf{\hi{पहला} \hi{दिन}}.) What changes in \emph{\hi{पहली} \hi{किताब}}, and why? (\textbf{The ending} — \emph{kitāb} is feminine.) And what does \textbf{\hi{पहले}} mean? (\textbf{Before, earlier} — the same word.)
\end{tcolorbox}
\section[dūsrā]{\hi{दूसरा} (dūsrā) — second, and the other one}
...
\textbf{\hi{दूसरा}} also means \textquotedblleft{}\textbf{other}, \textbf{another}\textquotedblright{}, and that is not a separate word to learn — it is the same one.
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Say \textquotedblleft{}the second book\textquotedblright{}. (\textbf{\hi{दूसरी} \hi{किताब}}.) What is the other thing \emph{\hi{दूसरा}} means? (\textbf{Other, another}.) And say \textquotedblleft{}the other man\textquotedblright{}. (\textbf{\hi{दूसरा} \hi{आदमी}}.)
\end{tcolorbox}
\section[tīsrā]{\hi{तीसरा} (tīsrā) — third}
...
\end{tcolorbox}
\section[cauthā]{\hi{चौथा} (cauthā) — fourth}
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Say the fourth day. (\textbf{\hi{चौथा} \hi{दिन}}.) What ending does it take? (\textbf{-\hi{था}}, not the \emph{-\hi{सरा}} of the last two.) And how many of the ordinals have to be learned as separate words? (\textbf{Four} — and you now have them.)
\end{tcolorbox}
