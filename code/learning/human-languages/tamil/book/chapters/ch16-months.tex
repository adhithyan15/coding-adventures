...
% canonical-source-hash: fnv1a64:5f49aa522aafe9ec
...
\section[Chithirai Vaikāsi Āṉi Āḍi Āvaṇi …]{\ta{சித்திரை} to \ta{பங்குனி} — Tamil's own solar calendar}
...
\hlblockfigure{\detokenize{figures/TA-S07-ma-filmstrip.pdf}}{How \ta{ம} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item \textbf{a curl at the upper left}
  \item \textbf{a long horizontal stroke}
  \item \textbf{a straight vertical on the right} — that is \textbf{\ta{அ}}
  \item \textbf{a tail added on the right} — and now it is \textbf{\ta{ஆ}}
\end{enumerate}
...
\hlblockfigure{\detokenize{figures/TA-S120-letter-aa-filmstrip.pdf}}{How \ta{ஆ} is written, stroke by stroke}
