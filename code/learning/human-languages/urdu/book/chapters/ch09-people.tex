...
% canonical-source-hash: fnv1a64:a467ff7387349cc6
...
\emph{bhāī} was masculine and needed \textbf{merā}. \emph{bahan} was feminine and needed \textbf{merī}. \textbf{\ur{دوست}} breaks the pattern on purpose: it takes \textbf{the same form} for a male or a female friend, and \textbf{merā dost} works for either. Native Urdu nouns almost always commit to a gender; this Persian loan simply does not carry the machinery that would make it agree.
\end{grammarlens}
