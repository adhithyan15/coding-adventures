# Build and run the font-parser tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name font_parser-tests -Sources @("tests\font_parser_test.c", "src\font_parser.c")
