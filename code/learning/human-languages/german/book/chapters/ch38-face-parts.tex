...
% canonical-source-hash: fnv1a64:69bf0c096adfd451
...
\begin{quote}
You already have \textbf{der Kopf} and \textbf{die Hand}. The head has more in it than its own name — starting with what you see with.
\end{quote}
...
\emph{Kopf} was a container word that took over the everyday job. \emph{Auge} needed no such replacement — it has meant \textquotedblleft{}eye\textquotedblright{} the whole way down.
\end{cousinweb}
...
\begin{quote}
You have the eye. You already have the verb for what the next part does — \textbf{hören}, \textquotedblleft{}to hear\textquotedblright{} — without ever naming the part itself.
\end{quote}
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Give \textquotedblleft{}ear\textquotedblright{} with its article and plural. (\textbf{Das Ohr, die Ohren}.) Is it native or borrowed? (\textbf{Native} — cousin of English \emph{ear}.) What disputed idea would put this word inside \emph{hören}? (\textbf{The \textquotedblleft{}sharp-eared\textquotedblright{} root analysis} — cited, not settled.)
\end{tcolorbox}
...
\begin{quote}
\textbf{Auge. Ohr. Mund.} One part of the face is left, and it closes what \emph{Kopf} opened and never finished.
\end{quote}
...
\begin{cousinweb}
\textbf{Nase} is Proto-Germanic \emph{\textbf{*nasō}}, the inherited cousin of English \textbf{nose} — and, further back, of Latin \textbf{nasus}, which gave English \textbf{nasal} and \textbf{nostril}. One Proto-Indo-European root, \emph{\textbf{*nas-}}, split into Germanic and into Latin independently; German \emph{Nase} and the Latin-derived word are family by \textbf{descent}, exactly like \emph{rot} and \emph{rouge}, never by borrowing.
