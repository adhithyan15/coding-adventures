// build.rs — Linker flags for the gf256-native Node.js N-API addon
// =================================================================
//
// Node.js N-API addons are cdylib shared libraries loaded by Node.js via
// `require()`. The N-API symbols (napi_create_string_utf8, etc.) are
// provided by the Node.js process at runtime, not by a library at link time.
//
