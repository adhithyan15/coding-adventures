...
introduces_idioms: []
introduces_senses: [AR-SENSE-SAA-CLOCK-WHILE-01]
...
requires:
  knowledge: []
introduces:
  knowledge: [AR-CONCEPT-C18-AL-TAQS-01, AR-CONCEPT-C18-AL-TAQS-02]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
...
<!-- hl-knowledge: introduces=[AR-CONCEPT-C18-AL-TAQS-01]; assesses=[] -->
...
## You'll want to know — الجو حار / بارد — hot and cold, still verbless
<!-- hl-knowledge: introduces=[AR-CONCEPT-C18-AL-TAQS-02]; assesses=[] -->
...
## You'll want to know — إنها تمطر — but rain gets its OWN personal verb
<!-- hl-knowledge: introduces=[]; assesses=[] -->
