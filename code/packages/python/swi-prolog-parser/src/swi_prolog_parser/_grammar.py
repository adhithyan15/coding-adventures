...
PARSER_GRAMMAR = ParserGrammar(
    ...
    rules=[
        ...
        GrammarRule(
            ...
            body=
            Alternation(choices=[
                RuleReference(name='directive_statement', is_token=False),
        ...
        GrammarRule(
            ...
            Alternation(choices=[
                ...
                RuleReference(name='clpfd_goal', is_token=False),
        ...
        GrammarRule(
            ...
            Sequence(elements=[
                RuleReference(name='term', is_token=False),
                RuleReference(name='clpfd_operator', is_token=False),
                RuleReference(name='term', is_token=False),
            ]),
            line_number=25,
        ),
        ...
        GrammarRule(
            name='term',
            body=
            RuleReference(name='range_term', is_token=False),
            line_number=41,
        ),
        GrammarRule(
            name='range_term',
            body=
            Sequence(elements=[
                RuleReference(name='additive_term', is_token=False),
                Optional(element=
                    Sequence(elements=[
                        RuleReference(name='range_operator', is_token=False),
                        RuleReference(name='additive_term', is_token=False),
                    ]),
                ),
            ]),
        ...
        GrammarRule(
            ...
            body=
            Sequence(elements=[
                RuleReference(name='multiplicative_term', is_token=False),
                Repetition(element=
                    Sequence(elements=[
                        RuleReference(name='additive_operator', is_token=False),
                        RuleReference(name='multiplicative_term', is_token=False),
                    ]),
                ),
            ]),
        ...
        GrammarRule(
            name='multiplicative_term',
            body=
            Sequence(elements=[
                RuleReference(name='simple_term', is_token=False),
                Repetition(element=
                    Sequence(elements=[
                        RuleReference(name='multiplicative_operator', is_token=False),
                        RuleReference(name='simple_term', is_token=False),
                    ]),
                ),
            ]),
        ...
        GrammarRule(
            ...
            Alternation(choices=[
                ...
                RuleReference(name='grouped_term', is_token=False),
            ]),
            line_number=45,
        ),
        GrammarRule(
