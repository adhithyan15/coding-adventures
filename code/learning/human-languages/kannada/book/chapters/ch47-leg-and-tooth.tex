...
% canonical-source-hash: fnv1a64:6bf12f5a39eeb8a6
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kālu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kālu}, then \emph{tale}, so the top and the bottom sit together
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{hallu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kālu}, then \emph{hallu}, and say which of the two also names a fraction
  \item \emph{Recall:} read \textbf{\kn{ಅಜ್ಜ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kūdalu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all three, and listen for the little \emph{-u} at the end of each
  \item \emph{Recall:} say \emph{ajji}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{beraḷu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{beraḷu}, then \emph{bare}, and hear the same \emph{b} at the front of both
  \item \emph{Recall:} read \textbf{\kn{ಗಂಡ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{hoṭṭe}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then the three that begin with \emph{h}
  \item \emph{Recall:} say \emph{heṇḍati}
\end{itemize}
