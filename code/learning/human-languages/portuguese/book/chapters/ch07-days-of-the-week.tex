...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}segunda, terça, quarta, quinta, sexta\textquotedblright{} — Monday through Friday{]}
  \item {[}YOU SAY: hear the number in each — \textquotedblleft{}quarta $\leftarrow$ quatro (4), quinta $\leftarrow$ cinco (5), sexta $\leftarrow$ seis (6)\textquotedblright{}{]}
  \item {[}YOU SAY: drop the tail — \textquotedblleft{}Até sexta!\textquotedblright{} (\textquotedblleft{}See you Friday!\textquotedblright{}){]}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: the full week — \textquotedblleft{}domingo, segunda, terça, quarta, quinta, sexta, sábado\textquotedblright{}{]}
  \item {[}YOU SAY: the anchors — \textquotedblleft{}sábado = Sabbath, domingo = the Lord's day\textquotedblright{}{]}
  \item {[}YOU SAY: the logic — \textquotedblleft{}domingo is 1st, so segunda (Monday) is 2nd\textquotedblright{}{]}
\end{itemize}
