...
Gem::Specification.new do |spec|
  spec.name = "coding_adventures_gfm_parser"
  spec.version = CodingAdventures::CommonmarkParser::VERSION
  spec.authors = ["Adhithya Rajasekaran"]
  spec.summary = "GitHub Flavored Markdown parser producing Document AST"
  spec.description = "Parses GFM 0.31.2 Markdown into a format-agnostic Document AST " \
                       "(coding_adventures_document_ast). Passes all 652 GFM spec tests. " \
