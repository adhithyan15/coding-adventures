...
# ============================================================================
#
# These tests exercise CodingAdventures::Cas end-to-end:
#   - Module loading
...
ok( eval { require CodingAdventures::Cas; 1 }, 'CodingAdventures::Cas loads' );
ok( eval { require CodingAdventures::Cas::LocalDiskStore; 1 }, 'LocalDiskStore loads' );
ok( eval { require CodingAdventures::Cas::Error; 1 }, 'Error module loads' );
...
sub make_cas {
    ...
    my $store  = CodingAdventures::Cas::LocalDiskStore->new($tmpdir);
    my $cas    = CodingAdventures::Cas->new($store);
    return ($cas, $tmpdir);
}
...
subtest 'get: NotFound error on missing key' => sub {
    ...
    ok( ref($err) && $err->isa('CodingAdventures::Cas::Error::CasNotFoundError'),
...
subtest 'get: CorruptedError when file is tampered' => sub {
    ...
    ok( ref($err) && $err->isa('CodingAdventures::Cas::Error::CasCorruptedError'),
...
subtest 'find_by_prefix: ambiguous match' => sub {
    ...
    if (length($common_prefix) > 0) {
        ...
        ok( ref($err) && $err->isa('CodingAdventures::Cas::Error::CasAmbiguousPrefixError'),
...
subtest 'find_by_prefix: not found' => sub {
    ...
    ok( ref($err) && $err->isa('CodingAdventures::Cas::Error::CasPrefixNotFoundError'),
...
subtest 'find_by_prefix: invalid hex character' => sub {
    ...
    ok( ref($err) && $err->isa('CodingAdventures::Cas::Error::CasInvalidPrefixError'),
