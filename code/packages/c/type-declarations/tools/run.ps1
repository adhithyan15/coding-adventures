# Build and run the type-declarations tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name type_declarations-tests -Sources @("tests\type_declarations_test.c", "src\type_declarations.c")
