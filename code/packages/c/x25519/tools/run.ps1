# Build and run the x25519 tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name x25519-tests -Sources @("tests\x25519_test.c", "src\x25519.c")
