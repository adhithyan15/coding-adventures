#!/bin/sh
# Build and run the float-math tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c float_math-tests tests/float_math_test.c src/float_math.c
