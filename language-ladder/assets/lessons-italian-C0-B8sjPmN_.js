...
type: phrase
headword: buongiorno
gloss: good day / good morning
concept_tag: GREETING-DAY
prerequisites: [IT-C01-buono, IT-C01-giorno]
sounds: []
roots: [bonus, diurnum]
reviews_of: [IT-C01-buono, IT-C01-giorno]
duration:
  max_seconds: 120
requires:
  knowledge: [IT-SOUND-BUONO-02, IT-GRAMMAR-BUONO-04, IT-SOUND-GIORNO-02, IT-ETYMON-GIORNO-03]
introduces:
  knowledge: [IT-LEX-BUONGIORNO-02, IT-PRAGMATIC-BUONGIORNO-03]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: [IT-CULTURE-BUONGIORNO-FORMAL-REGISTER-01]
practises:
  knowledge: [IT-LEX-BUONGIORNO-02, IT-PRAGMATIC-BUONGIORNO-03]
...
# buongiorno — "good day," assembled

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[] -->

[PAUSE 2s] Put the two pieces together into the polite, all-purpose hello.

## The word, taken apart
<!-- hl-knowledge: introduces=[IT-LEX-BUONGIORNO-02]; assesses=[] -->

- [buon](IT-C01-buono.md) ("good") + [giorno](IT-C01-giorno.md) ("day").

> **buongiorno** = "good day," one word.

## Why it's said this way
<!-- hl-knowledge: introduces=[IT-PRAGMATIC-BUONGIORNO-03]; assesses=[] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-LEX-BUONGIORNO-02, IT-PRAGMATIC-BUONGIORNO-03] -->

[PAUSE 1s]
- [YOU SAY: "buongiorno" — buon + giorno]
- [YOU SAY: when to use it (respect, daytime) vs *ciao* (friends)]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[IT-LEX-BUONGIORNO-02, IT-PRAGMATIC-BUONGIORNO-03] -->

[PAUSE 3s] What two words make **buongiorno**, and when do you use it rather
than *ciao*? (*buon* + *giorno*; for respect / strangers / daytime.)
`,r=e({default:()=>i}),i=`---
schema_version: 2
id: IT-C01-buono
...
sounds: [uo-glide]
roots: [bonus]
reviews_of: [IT-C01-ciao]
duration:
  max_seconds: 120
requires:
  knowledge: []
introduces:
  knowledge: [IT-SOUND-BUONO-02, IT-ETYMON-BUONO-03, IT-GRAMMAR-BUONO-04]
introduces_idioms: []
introduces_senses: []
...
## Sounds you'll need
<!-- hl-knowledge: introduces=[IT-SOUND-BUONO-02]; assesses=[] -->

- **buono** = *BWOH-no* (the *uo* is a glide). Before a masculine noun it clips
  to **buon** (*bwon*).

## The word, taken apart
<!-- hl-knowledge: introduces=[IT-ETYMON-BUONO-03]; assesses=[] -->

**buono** ("good") ← Latin **bonus** → English **bon**us, **bon**anza,
**bon**bon, and (via French) **boun**ty. Spanish, another daughter of Latin,
made *bonus* into *bueno*; Italian kept it closer, *buono*.

## Grammar Lens: it agrees with the noun
<!-- hl-knowledge: introduces=[IT-GRAMMAR-BUONO-04]; assesses=[] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-SOUND-BUONO-02, IT-ETYMON-BUONO-03, IT-GRAMMAR-BUONO-04] -->

[PAUSE 1s]
- [YOU SAY: "buono", then clipped "buon"]
- [YOU SAY: English cousins — *bonus*, *bonanza*]
...
# ciao — "hi," and the word that means "I am your slave"

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[] -->

[PAUSE 2s] The most famous "hello" in the world — and it hides an astonishing
history.

## Sounds you'll need
<!-- hl-knowledge: introduces=[IT-PHONO-CIAO-01]; assesses=[] -->

- **ciao** = *CHOW*: **ci** before a vowel is the *ch* of *church*; *-ao* is one
  gliding syllable.

## The word, taken apart
<!-- hl-knowledge: introduces=[IT-ETYMON-CIAO-02]; assesses=[] -->

**ciao** began as the Venetian greeting *s-ciào (vostro)* — "[I am your] slave /
servant," a humble "at your service." That *s-ciào* is Venetian for **schiavo**
("slave") ← Medieval Latin **sclavus**. The very same word is English **slave**
— and, astonishingly, **Slav**: medieval slaves were so often Slavic captives
that the ethnic name *became* the word for "slave" across Europe. So every
casual *ciao* is a fossil of "I am your servant."

## Why it's said this way
<!-- hl-knowledge: introduces=[IT-PRAGMATIC-CIAO-03]; assesses=[] -->
...
Keep **ciao** visible. Point to **ci**, the two letters that begin the *ch* sound,
then slide your finger through **ao**. Trace the whole word once from **c** to
**o**, and say *CHOW*.

This is not a spelling test. Your eye and hand are only following one short
greeting whose sound and meaning are still on the page.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-PHONO-CIAO-01, IT-ETYMON-CIAO-02, IT-PRAGMATIC-CIAO-03] -->

[PAUSE 1s]
- [YOU SAY: "ciao" (*CHOW*)]
- [YOU SAY: its buried meaning — "I am your slave/servant"]
- [YOU SAY: the English cousins — *slave*, *Slav*]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[IT-PHONO-CIAO-01, IT-ETYMON-CIAO-02, IT-PRAGMATIC-CIAO-03] -->

[PAUSE 3s] What did **ciao** literally mean, and what two English words share
its root? ("I am your slave"; *slave* and *Slav*, from Latin *sclavus*.)
`,s=e({default:()=>c}),c=`---
schema_version: 2
id: IT-C01-giorno
spine_node: SPINE-TIME-OF-DAY
...
sounds: [soft-g]
roots: [diurnum, dies]
reviews_of: [IT-C01-il-la-lo]
duration:
  max_seconds: 126
requires:
  knowledge: []
introduces:
  knowledge: [IT-SOUND-GIORNO-02, IT-ETYMON-GIORNO-03, IT-GRAMMAR-GIORNO-04]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
...
# giorno — "day," and the road to English *journey*

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[] -->

[PAUSE 2s] Your first noun — masculine, and a cousin of *journal* and *journey*.

## Sounds you'll need
<!-- hl-knowledge: introduces=[IT-SOUND-GIORNO-02]; assesses=[] -->

- **gi** = the *j* of *jam*; **giorno** = *JOR-no*.

## The word, taken apart
<!-- hl-knowledge: introduces=[IT-ETYMON-GIORNO-03]; assesses=[] -->

**il giorno** (masc.) ← Latin **diurnum** ("daytime"), from **dies** ("day").
That detour through *diurnum* is why *giorno* looks nothing like *dies*:

- via *diurnum*: **jour**nal, ad**journ**, so**journ**, **journ**ey (a *day's*
  travel);
- via *dies*: **di**urnal, **di**ary.

Italian *giorno* and French *jour* are near-twins here; Spanish, taking *dies*
directly, got the very different *día*.

## Grammar Lens: masculine, plural by vowel-change
<!-- hl-knowledge: introduces=[IT-GRAMMAR-GIORNO-04]; assesses=[] -->

*giorno* is **masculine** (*il giorno*). Plural **i giorni** — Italian marks the
plural by changing the final vowel (*-o* → *-i*), not by adding *-s*.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-SOUND-GIORNO-02, IT-ETYMON-GIORNO-03, IT-GRAMMAR-GIORNO-04] -->

[PAUSE 1s]
- [YOU SAY: "il giorno" (masc.), "i giorni" (pl.)]
- [YOU SAY: the cousins — *journal*, *journey*, *diary*]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[IT-SOUND-GIORNO-02, IT-ETYMON-GIORNO-03, IT-GRAMMAR-GIORNO-04] -->

[PAUSE 3s] What Latin word gave **giorno**, and what English words share it?
(*diurnum* ← *dies*; *journal*, *journey*, *diurnal*, *diary*.) How does Italian
form the plural? (Changes the final vowel: *-o* → *-i*.)
`,l=e({default:()=>u}),u=`---
schema_version: 2
id: IT-C01-grazie
...
sounds: [z-is-ts]
roots: [gratia]
reviews_of: [IT-C01-buongiorno]
duration:
  max_seconds: 120
requires:
  knowledge: []
introduces:
  knowledge: [IT-SOUND-GRAZIE-02, IT-ETYMON-GRAZIE-03, IT-PRAGMATIC-GRAZIE-04]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
...
# grazie — "thank you," from *grace*

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[] -->

[PAUSE 2s] "Thanks" — and it literally offers someone *grace*.

## Sounds you'll need
<!-- hl-knowledge: introduces=[IT-SOUND-GRAZIE-02]; assesses=[] -->

- **grazie** = *GRAH-tsyeh*: **z** in Italian is *ts*; the final *-e* is sounded
  (so *-zie* is two beats).

## The word, taken apart
<!-- hl-knowledge: introduces=[IT-ETYMON-GRAZIE-03]; assesses=[] -->

**grazie** ("thanks") ← Latin **gratiae**, plural of **gratia** ("favour,
thanks, grace"). It's the *same* *gratia* behind English **grace**,
**grat**itude, **grat**eful, **grat**is ("free"), con**grat**ulate, and
in**grat**iate. So *grazie* literally wishes someone **grace**.

## Why it's said this way
<!-- hl-knowledge: introduces=[IT-PRAGMATIC-GRAZIE-04]; assesses=[] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-SOUND-GRAZIE-02, IT-ETYMON-GRAZIE-03, IT-PRAGMATIC-GRAZIE-04] -->
...
sounds: []
roots: [ille, illa]
reviews_of: [IT-C01-buono]
duration:
  max_seconds: 121
requires:
  knowledge: []
introduces:
  knowledge: [IT-ETYMON-IL-LA-LO-02, IT-GRAMMAR-IL-LA-LO-03]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
...
# il / la / lo — "the," and the gender it carries

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[] -->

[PAUSE 2s] Before your first noun: the words for "the." Italian splits "the" by
gender — a habit inherited from Latin.

## The word, taken apart
<!-- hl-knowledge: introduces=[IT-ETYMON-IL-LA-LO-02]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[IT-GRAMMAR-IL-LA-LO-03]; assesses=[] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-ETYMON-IL-LA-LO-02, IT-GRAMMAR-IL-LA-LO-03] -->

[PAUSE 1s]
- [YOU SAY: "il", "la", "lo"]
- [YOU SAY: their source — Latin *ille / illa*]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[IT-ETYMON-IL-LA-LO-02, IT-GRAMMAR-IL-LA-LO-03] -->

[PAUSE 3s] What Latin word gave **il / lo / la**, and how many genders does
Italian have? (*ille / illa*; two — masculine and feminine.)
`,p=e({default:()=>m}),m=`---
schema_version: 2
id: IT-C01-notte
...
sounds: [double-tt]
roots: [noctem]
reviews_of: [IT-C01-sera, IT-C01-giorno]
duration:
  max_seconds: 120
requires:
  knowledge: [IT-GRAMMAR-BUONO-04]
introduces:
  knowledge: [IT-ETYMON-NOTTE-02, IT-LEX-NOTTE-03]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
...
# notte / buonanotte — "night," and the *-ct-* → *-tt-* rule

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[] -->

[PAUSE 2s] "Night" — and a sound-rule that decodes dozens of Italian words at
once.

## The word, taken apart
<!-- hl-knowledge: introduces=[IT-ETYMON-NOTTE-02, IT-LEX-NOTTE-03]; assesses=[] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-ETYMON-NOTTE-02, IT-LEX-NOTTE-03] -->
...
type: practice
headword: (recap)
gloss: Chapter 1 recap — the day of greetings
concept_tag: REVIEW
...
duration:
  max_seconds: 129
requires:
  knowledge: [IT-PHONO-CIAO-01, IT-ETYMON-CIAO-02, IT-PRAGMATIC-CIAO-03, IT-SOUND-BUONO-02, IT-ETYMON-BUONO-03, IT-GRAMMAR-BUONO-04, IT-ETYMON-IL-LA-LO-02, IT-GRAMMAR-IL-LA-LO-03, IT-SOUND-GIORNO-02, IT-ETYMON-GIORNO-03, IT-GRAMMAR-GIORNO-04, IT-LEX-BUONGIORNO-02, IT-PRAGMATIC-BUONGIORNO-03, IT-ETYMON-SERA-02, IT-GRAMMAR-SERA-03, IT-ETYMON-NOTTE-02, IT-LEX-NOTTE-03, IT-SOUND-GRAZIE-02, IT-ETYMON-GRAZIE-03, IT-PRAGMATIC-GRAZIE-04]
introduces:
  knowledge: []
introduces_idioms: []
introduces_senses: []
...
[PAUSE 2s] No new words today. Everything below is something you have
already met, said once, and can now put in one place.

## What you've built — the day of greetings
<!-- hl-knowledge: introduces=[]; assesses=[IT-PHONO-CIAO-01, IT-ETYMON-CIAO-02, IT-PRAGMATIC-CIAO-03, IT-SOUND-BUONO-02, IT-ETYMON-BUONO-03, IT-GRAMMAR-BUONO-04, IT-ETYMON-IL-LA-LO-02, IT-GRAMMAR-IL-LA-LO-03, IT-SOUND-GIORNO-02, IT-ETYMON-GIORNO-03, IT-GRAMMAR-GIORNO-04, IT-LEX-BUONGIORNO-02, IT-PRAGMATIC-BUONGIORNO-03, IT-ETYMON-SERA-02, IT-GRAMMAR-SERA-03, IT-ETYMON-NOTTE-02, IT-LEX-NOTTE-03, IT-SOUND-GRAZIE-02, IT-ETYMON-GRAZIE-03, IT-PRAGMATIC-GRAZIE-04] -->
...
- **ciao** ← *sclavus* ("slave"; English *slave*, *Slav*)
- **buono** ← *bonus*
- **giorno** ← *diurnum* (English *journal*, *journey*)
- **notte** ← *noctem*, via the *-ct-* → *-tt-* rule (*notte*, not *noche*/*nuit*)
- **grazie** ← *gratia* ("grace"; English *grace*, *gratitude*)

And two Italian habits: adjectives **agree** with the noun's gender (*buon
giorno* m. / *buona sera* f.), and the plural is made by **changing the final
vowel** (*giorno* → *giorni*), not adding *-s*.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-PHONO-CIAO-01, IT-ETYMON-CIAO-02, IT-PRAGMATIC-CIAO-03, IT-SOUND-BUONO-02, IT-ETYMON-BUONO-03, IT-GRAMMAR-BUONO-04, IT-ETYMON-IL-LA-LO-02, IT-GRAMMAR-IL-LA-LO-03, IT-SOUND-GIORNO-02, IT-ETYMON-GIORNO-03, IT-GRAMMAR-GIORNO-04, IT-LEX-BUONGIORNO-02, IT-PRAGMATIC-BUONGIORNO-03, IT-ETYMON-SERA-02, IT-GRAMMAR-SERA-03, IT-ETYMON-NOTTE-02, IT-LEX-NOTTE-03, IT-SOUND-GRAZIE-02, IT-ETYMON-GRAZIE-03, IT-PRAGMATIC-GRAZIE-04] -->

[PAUSE 1s]
- [YOU SAY: all five greetings]
- [YOU SAY: greet and thank — "buongiorno!" … "grazie."]
- [YOU SAY: the buried story of *ciao* ("I am your slave")]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[IT-PHONO-CIAO-01, IT-ETYMON-CIAO-02, IT-PRAGMATIC-CIAO-03, IT-SOUND-BUONO-02, IT-ETYMON-BUONO-03, IT-GRAMMAR-BUONO-04, IT-ETYMON-IL-LA-LO-02, IT-GRAMMAR-IL-LA-LO-03, IT-SOUND-GIORNO-02, IT-ETYMON-GIORNO-03, IT-GRAMMAR-GIORNO-04, IT-LEX-BUONGIORNO-02, IT-PRAGMATIC-BUONGIORNO-03, IT-ETYMON-SERA-02, IT-GRAMMAR-SERA-03, IT-ETYMON-NOTTE-02, IT-LEX-NOTTE-03, IT-SOUND-GRAZIE-02, IT-ETYMON-GRAZIE-03, IT-PRAGMATIC-GRAZIE-04] -->

[PAUSE 3s] Say all five greetings. Which one once meant "I am your slave"?
...
gloss: evening / good evening
concept_tag: GREETING-EVENING
prerequisites: [IT-C01-buongiorno]
sounds: []
roots: [serus]
reviews_of: [IT-C01-buongiorno, IT-C01-buono]
duration:
  max_seconds: 120
requires:
  knowledge: [IT-GRAMMAR-BUONO-04]
introduces:
  knowledge: [IT-ETYMON-SERA-02, IT-GRAMMAR-SERA-03]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
...
# sera / buonasera — "evening" and "good evening"

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[] -->

[PAUSE 2s] The evening swap for *buongiorno*.

## The word, taken apart
<!-- hl-knowledge: introduces=[IT-ETYMON-SERA-02]; assesses=[] -->

**la sera** (fem.) ← Latin **sera** ("late [hour]"), from **serus**, "late."
English cousin: the rare *serotine* (a bat of the *late* evening).
**buonasera** = *buona* + *sera*, "good evening" — *buona* in its **feminine**
form, because *sera* is feminine (contrast the masculine *buon giorno*).

## Grammar Lens: feminine agreement
<!-- hl-knowledge: introduces=[IT-GRAMMAR-SERA-03]; assesses=[] -->

Notice *buon**a** sera* vs. *buon giorno*: the "good" word matches its noun's
gender — feminine *sera* takes *buona*, masculine *giorno* takes *buon*. Same
adjective, two coats.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-ETYMON-SERA-02, IT-GRAMMAR-SERA-03] -->

[PAUSE 1s]
- [YOU SAY: "buonasera" (*buona* + *sera*)]
- [YOU SAY: why it's *buona* here but *buon* in *buon giorno* (gender)]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[IT-ETYMON-SERA-02, IT-GRAMMAR-SERA-03] -->

[PAUSE 3s] What Latin word gave **sera**, and why is it *buonasera* but *buon
giorno*? (*sera* ← *serus*, "late"; *sera* is feminine so "good" is *buona*.)
`,y=e({default:()=>b}),b=`---
schema_version: 2
id: IT-C02-come-sta
spine_node: SPINE-CHECK-WELLBEING
...
`,k=e({default:()=>A}),A=`---
schema_version: 2
id: IT-C02-non-ce-male
spine_node: SPINE-CHECK-WELLBEING
sequence: 165
chapter: 2
type: phrase
headword: non c'è male
gloss: not bad — a fixed wellbeing answer learned whole for now
concept_tag: IT-STATE-NOT-BAD
prerequisites: [IT-C02-cosi-cosi]
sounds: [open-e]
roots: []
etymology_hook: "non c'è male is admitted as an unanalyzed pre-A1 formula; its negation and c'è construction return later on their own ramps"
duration:
  max_seconds: 145
requires:
  knowledge: [IT-SOUND-COSI-COSI-02, IT-ETYMON-COSI-COSI-03, IT-GRAMMAR-COSI-COSI-04]
introduces:
  knowledge: [IT-LEX-NON-CE-MALE-02]
introduces_idioms: [IT-IDIOM-NON-CE-MALE-NOT-BAD-01]
introduces_senses: []
introduces_culture_claims: []
practises:
...
register: neutral
variety: standard-contemporary
reviews_of: [IT-C02-cosi-cosi, IT-C02-come-stai]
---
...
## You'll want to know — The formula
<!-- hl-knowledge: introduces=[IT-LEX-NON-CE-MALE-02]; assesses=[] -->

> **Non c'è male.** — "Not bad."

Learn the four sounds as one useful answer for now. The pieces behind it —
negation and the **c'è** construction — belong to later lessons. You do not need
their rules to answer honestly today.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-GRAMMAR-COSI-COSI-04, IT-LEX-NON-CE-MALE-02] -->

- [YOU SAY: "Come stai? — Così così."]
- [YOU SAY: "Come stai? — Non c'è male."]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[IT-LEX-NON-CE-MALE-02] -->

[PAUSE 3s] Give the new "not bad" answer. (**Non c'è male.**) Must you explain
each word yet? (**No. It is an unanalyzed pre-A1 formula for now.**)
`,j=e({default:()=>M}),M=`---
schema_version: 2
id: IT-C02-practice
spine_node: SPINE-CHECK-WELLBEING
...
`,N=e({default:()=>P}),P=`---
schema_version: 2
id: IT-C02-prego-come-again
spine_node: SPINE-COURTESY-THANK
sequence: 106
chapter: 2
type: word
headword: Prego? — come again?
...
introduces:
  knowledge: [IT-PRAGMATIC-PREGO-COME-AGAIN-06]
introduces_idioms: []
...
register: polite
variety: standard-contemporary
reviews_of: [IT-C02-prego, IT-C02-prego-go-ahead, IT-C02-prego-here-you-are]
---
...
## You'll want to know — One more job
<!-- hl-knowledge: introduces=[IT-PRAGMATIC-PREGO-COME-AGAIN-06]; assesses=[IT-SOUND-PREGO-02] -->

If you did not hear, lift your voice into a question:

> **Prego?** — "Sorry? Come again?"

The rising question sound separates this repair from a flat **prego** while
handing something over. Listen to the situation and the voice together.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-PRAGMATIC-PREGO-GO-AHEAD-04, IT-PRAGMATIC-PREGO-HERE-YOU-ARE-05, IT-PRAGMATIC-PREGO-COME-AGAIN-06] -->

- [YOU SAY: flat "Prego" — here you are]
- [YOU ASK: rising "Prego?" — come again?]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[IT-PRAGMATIC-PREGO-COME-AGAIN-06] -->

[PAUSE 3s] You did not catch a sentence. What do you ask? (**Prego?**) What
marks the listening-repair use? (**Question intonation and the situation.**)
`,F=e({default:()=>I}),I=`---
schema_version: 2
id: IT-C02-prego-go-ahead
spine_node: SPINE-COURTESY-THANK
sequence: 102
chapter: 2
type: word
headword: prego — go ahead
gloss: please, go ahead, after you — the first extension beyond "you're welcome"
concept_tag: IT-COURTESY-GO-AHEAD
prerequisites: [IT-C02-prego]
sounds: [hard-g-before-o]
roots: [precari-latin]
etymology_hook: "prego still carries pregare 'to pray': when you yield a seat or doorway, it politely invites the other person to act"
duration:
  max_seconds: 150
requires:
  knowledge: [IT-SOUND-PREGO-02, IT-ETYMON-PREGO-03]
introduces:
  knowledge: [IT-PRAGMATIC-PREGO-GO-AHEAD-04]
introduces_idioms: []
introduces_senses: [IT-SENSE-PREGO-GO-AHEAD-01]
introduces_culture_claims: []
practises:
  knowledge: [IT-SOUND-PREGO-02, IT-ETYMON-PREGO-03, IT-PRAGMATIC-PREGO-GO-AHEAD-04]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal]
strands: [meaning-input, meaning-output, language-focus]
register: polite
...
# prego — "please, go ahead"

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[IT-SOUND-PREGO-02, IT-ETYMON-PREGO-03] -->

[PAUSE 2s] Answer **grazie** first: **prego**. Keep that meaning. Now picture a
doorway and add one nearby use.

## You'll want to know — One more job
<!-- hl-knowledge: introduces=[IT-PRAGMATIC-PREGO-GO-AHEAD-04]; assesses=[IT-SOUND-PREGO-02] -->

When you let someone pass or offer a seat, **prego** means **"please, go ahead"
/ "after you."** The polite invitation still grows from *pregare*, "to pray or
entreat."

> You hold the door. **Prego.** — "After you."

Do not add another meaning yet. The same sound now owns two situations: after
**grazie**, "you're welcome"; at a doorway, "go ahead."

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-SOUND-PREGO-02, IT-ETYMON-PREGO-03, IT-PRAGMATIC-PREGO-GO-AHEAD-04] -->

- [YOU SAY: "Grazie. — Prego."]
- [YOU SAY: "Prego" while yielding a doorway]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[IT-PRAGMATIC-PREGO-GO-AHEAD-04] -->

[PAUSE 3s] At a doorway, what does **prego** mean? (**Please, go ahead / after
you.**) After **grazie**? (**You're welcome.**) Keep both; the next lesson adds
only one more.
`,L=e({default:()=>R}),R=`---
schema_version: 2
id: IT-C02-prego-here-you-are
spine_node: SPINE-COURTESY-THANK
sequence: 104
chapter: 2
type: word
headword: prego — here you are
gloss: here you are — what prego says while handing something over
concept_tag: IT-COURTESY-HERE-YOU-ARE
prerequisites: [IT-C02-prego-go-ahead]
sounds: [hard-g-before-o]
roots: [precari-latin]
etymology_hook: "prego extends the same polite invitation from a doorway to an offered object"
duration:
  max_seconds: 145
requires:
  knowledge: [IT-SOUND-PREGO-02, IT-ETYMON-PREGO-03, IT-PRAGMATIC-PREGO-GO-AHEAD-04]
introduces:
  knowledge: [IT-PRAGMATIC-PREGO-HERE-YOU-ARE-05]
introduces_idioms: []
...
register: polite
variety: standard-contemporary
reviews_of: [IT-C02-prego, IT-C02-prego-go-ahead]
---
...
## You'll want to know — One more job
<!-- hl-knowledge: introduces=[IT-PRAGMATIC-PREGO-HERE-YOU-ARE-05]; assesses=[IT-SOUND-PREGO-02] -->

When you hand something to someone, **prego** means **"here you are."** The
object can be a cup, a ticket, or anything already requested.

> You pass over the cup. **Prego.** — "Here you are."

The meanings stay tied to visible situations: thanks, doorway, offered object.
You do not have to guess between them without context.
...
[PAUSE 3s] You hand someone a cup. What does **prego** mean? (**Here you are.**)
At a doorway? (**Go ahead.**) After thanks? (**You're welcome.**)
`,z=e({default:()=>B}),B=`---
schema_version: 2
id: IT-C02-prego
spine_node: SPINE-COURTESY-THANK
...
finish.
`;export{r as A,_ as C,l as D,d as E,s as O,y as S,p as T,k as _,$ as a,C as b,q as c,V as d,z as f,j as g,N as h,te as i,t as j,a as k,G as l,F as m,ae as n,Z as o,L as p,re as r,Y as s,se as t,U as u,D as v,h as w,x,T as y};