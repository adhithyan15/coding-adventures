...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C41-DEIXIS-01, ML-LEX-AANU-01] -->

[PAUSE 2s] Say *this*. Then say the little word that finishes a sentence by
saying something **is** so.

## You'll want to know
<!-- hl-knowledge: introduces=[ML-LEX-C96-EASY-01]; assesses=[] -->
...
- [YOU SAY: *eḷuppaṁ*]
- [YOU SAY: *eḷuppamāṇŭ*]
- [YOU SAY: *itŭ eḷuppamāṇŭ*]
- [YOU LOOK: at **സുഖമാണ്** and **എളുപ്പമാണ്**, and find the part that is the
  same]
...
type: word
headword: "പ്രയാസം"
gloss: difficult — the other half of the pair, built in exactly the same frame
romanization: "prayāsaṁ"
concept_tag: ML-DIFFICULT
prerequisites: [ML-C96-eluppam]
sounds: []
roots: []
duration:
  max_seconds: 250
requires:
  knowledge: [ML-LEX-C96-EASY-01, ML-LEX-AANU-01]
introduces:
  knowledge: [ML-LEX-C96-DIFFICULT-01]
practises:
  knowledge: [ML-LEX-C96-DIFFICULT-01, ML-LEX-C96-EASY-01, ML-LEX-AANU-01, ML-LEX-C41-DEIXIS-01]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output]
register: neutral
variety: standard-colloquial
reviews_of: [ML-C96-eluppam]
---

# പ്രയാസം (prayāsaṁ) — difficult

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C96-EASY-01] -->

[PAUSE 2s] Say *this is easy*. All of it, in one breath.

## You'll want to know
<!-- hl-knowledge: introduces=[ML-LEX-C96-DIFFICULT-01]; assesses=[] -->

**പ്രയാസം** — *prayāsaṁ* — **difficult.**

> **ഇത് പ്രയാസമാണ്.** — *itŭ prayāsamāṇŭ* — "**This is difficult.**"

**It ends in ം as well**, so it behaves the way the last one did, and you did
not have to be told a second time.

| | |
|---|---|
| **ഇത് എളുപ്പമാണ്** | this is easy |
| **ഇത് പ്രയാസമാണ്** | this is difficult |

**One word apart, and the sentence is the opposite.** Everything around it holds
still.

## What you've built
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C96-DIFFICULT-01, ML-LEX-C96-EASY-01, ML-LEX-AANU-01] -->

This is a pair you can say about anything you can point at — a word, a letter,
a road, a lesson. It is also the first thing most learners want to say about the
language itself, and **you can now say it in the language**, which is a better
place to complain from.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C96-DIFFICULT-01, ML-LEX-C96-EASY-01, ML-LEX-C41-DEIXIS-01] -->

[PAUSE 1s]
- [YOU SAY: *prayāsaṁ*]
- [YOU SAY: *itŭ prayāsamāṇŭ*]
- [YOU SAY: the two sentences one after the other, and hear where they part]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C96-DIFFICULT-01, ML-LEX-C96-EASY-01] -->

[PAUSE 3s] Easy and difficult? (**എളുപ്പം, പ്രയാസം**.) Did the second one need a
new rule? (**No** — it ends the same way, so it behaves the same way.)
`,a=e({default:()=>o}),o=`---
schema_version: 2
id: ML-C97-alla-sundaram
spine_node: SPINE-DEFINITE-REFERENCE
sequence: 3460
chapter: 97
type: grammar
...
[PAUSE 2s] Say *this is beautiful*. Then say *child* — you have had that word a
long time.

## You'll want to know
<!-- hl-knowledge: introduces=[ML-LEX-C97-BEAUTY-01]; assesses=[] -->
...
| | |
|---|---|
| **സുന്ദരം** → **സുന്ദരമാണ്** | the **m** was already there |
| **ഭംഗി** → **ഭംഗിയാണ്** | a **യ** is genuinely added |

In **സുന്ദരമാണ്** nothing is added at all. The **ം** is the sound **m**, and it
...
[PAUSE 1s]
- [YOU SAY: *bhaṁgi*, then *bhaṁgiyāṇŭ*]
- [YOU SAY: *sundaraṁ*, then *sundaramāṇŭ*]
- [YOU SAY: which of the two actually gained a sound, and which only changed its spelling]
...
type: word
headword: "സുന്ദരം"
gloss: beautiful — a new word dropped straight into the frame the last chapter built
romanization: "sundaraṁ"
concept_tag: ML-BEAUTIFUL
prerequisites: [ML-R96-ease-recall, ML-C41-this, ML-C96-prayaasam]
sounds: []
roots: []
duration:
  max_seconds: 240
requires:
  knowledge: [ML-LEX-C96-EASY-01, ML-LEX-C96-DIFFICULT-01, ML-LEX-C41-DEIXIS-01, ML-LEX-AANU-01, ML-CONCEPT-C02-COPULA-01]
introduces:
  knowledge: [ML-LEX-C97-BEAUTIFUL-01]
practises:
  knowledge: [ML-LEX-C97-BEAUTIFUL-01, ML-LEX-C96-EASY-01, ML-LEX-C96-DIFFICULT-01, ML-LEX-C41-DEIXIS-01, ML-LEX-AANU-01, ML-CONCEPT-C02-COPULA-01]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output]
register: neutral
...
# സുന്ദരം (sundaraṁ) — beautiful

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C96-EASY-01, ML-LEX-C41-DEIXIS-01] -->

[PAUSE 2s] Say *this is easy*. You built that sentence one chapter ago.

## You'll want to know
<!-- hl-knowledge: introduces=[ML-LEX-C97-BEAUTIFUL-01]; assesses=[] -->

**സുന്ദരം** — *sundaraṁ* — **beautiful.**

> **ഇത് സുന്ദരമാണ്.** — *itŭ sundaramāṇŭ* — "**This is beautiful.**"
...
- [YOU SAY: *sundaraṁ*]
- [YOU SAY: *itŭ sundaramāṇŭ*]
- [YOU SAY: the same sentence about something being easy]
...
**കളി** — *kaḷi* — **a game**, and also **play** itself.
...
**This is the book's first word for play.**

You could already say that you read, that you eat, that you work, that you go.
Every one of those has a point outside itself. **കളി** names the kind of doing
that is its own point — and until this lesson the book had given you no word
for it.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C98-GAME-01, ML-LEX-C41-DEIXIS-01] -->

[PAUSE 1s]
- [YOU SAY: *kaḷi*]
- [YOU SAY: *itŭ kaḷiyāṇŭ*]
...
type: word
headword: "കളിക്കുക"
gloss: to play — the game word with a verb ending you have had since long before this chapter
romanization: "kaḷikkuka"
concept_tag: ML-VERB-PLAY
prerequisites: [ML-C98-kali, ML-C33-vaayikkuka]
sounds: []
roots: []
duration:
  max_seconds: 250
requires:
  knowledge: [ML-LEX-C98-GAME-01, ML-CONCEPT-C33-VAAYIKKUKA-01, ML-LEX-SAMSAARIKKUKA-01, ML-CONCEPT-C34-CODIKKUKA-01, ML-LEX-C85-DRINK-01]
introduces:
  knowledge: [ML-LEX-C98-PLAY-01]
practises:
  knowledge: [ML-LEX-C98-PLAY-01, ML-LEX-C98-GAME-01, ML-CONCEPT-C33-VAAYIKKUKA-01, ML-LEX-NJAAN-01, ML-LEX-SAMSAARIKKUKA-01, ML-CONCEPT-C34-CODIKKUKA-01, ML-LEX-C85-DRINK-01]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output]
register: neutral
variety: standard-colloquial
reviews_of: [ML-C98-kali, ML-C33-vaayikkuka]
---

# കളിക്കുക (kaḷikkuka) — to play

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C98-GAME-01, ML-CONCEPT-C33-VAAYIKKUKA-01] -->

[PAUSE 2s] Say *a game*. Then say *to read*.

## You'll want to know
<!-- hl-knowledge: introduces=[ML-LEX-C98-PLAY-01]; assesses=[] -->

**കളിക്കുക** — *kaḷikkuka* — **to play.**

> **ഞാൻ കളിക്കുന്നു.** — *ñān kaḷikkunnu* — "I play."

## The word, taken apart
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C98-PLAY-01, ML-LEX-C98-GAME-01, ML-CONCEPT-C33-VAAYIKKUKA-01, ML-LEX-SAMSAARIKKUKA-01, ML-CONCEPT-C34-CODIKKUKA-01, ML-LEX-C85-DRINK-01] -->

**The noun is sitting inside the verb.** **കളി** is the game; **കളിക്കുക** is
doing it.

And the shape is one you have had for a long time. Put it beside the reading
verb:

| | |
|---|---|
| **വായിക്കുക** → **വായിക്കുന്നു** | reads |
| **കളിക്കുക** → **കളിക്കുന്നു** | plays |

**Verb after verb in this book already ends in -ിക്കുക** — **സംസാരിക്കുക**,
**വായിക്കുക**, **ചോദിക്കുക**, **കുടിക്കുക** — so this one arrives asking
nothing new of you. The only new part is the two syllables at the front.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C98-PLAY-01, ML-CONCEPT-C33-VAAYIKKUKA-01, ML-LEX-NJAAN-01] -->

[PAUSE 1s]
- [YOU SAY: *kaḷikkuka*]
- [YOU SAY: *ñān kaḷikkunnu*]
- [YOU SAY: *vāyikkunnu*, then *kaḷikkunnu*]
- [YOU LOOK: at **കളി** inside **കളിക്കുക**]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C98-PLAY-01, ML-LEX-C98-GAME-01] -->

[PAUSE 3s] What is *to play*? (**കളിക്കുക**.) What word can you see inside it?
(**കളി**.) Did its ending need learning? (**No** — the reading verb already had
it.)
`,h=e({default:()=>g}),g=`---
schema_version: 2
id: ML-C98-sinima
...
register: neutral
variety: standard-colloquial
reviews_of: [ML-C98-kali, ML-C92-hottal]
---

# സിനിമ (sinima) — a film

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C98-GAME-01, ML-LEX-C92-EATERY-01] -->

[PAUSE 2s] Say *a game*. Then say the borrowed word for a place that serves food.

## You'll want to know
<!-- hl-knowledge: introduces=[ML-LEX-C98-CINEMA-01]; assesses=[] -->

**സിനിമ** — *sinima* — **a film**, and **the cinema** as well.
...
**Do not read that as *a vowel brings യ*.** Which letter slides in is settled by
*which* vowel the word ends in, and you already have one that goes the other
way:
