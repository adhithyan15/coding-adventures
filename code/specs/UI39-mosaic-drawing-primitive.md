...
**Status:** XAML and Qt implemented (`circle`/`line`/`curve`); SwiftUI/
Flutter/Compose/react/html/webcomponent not yet — see §6.
...
| SwiftUI, Flutter, Compose | not yet — tracked as follow-up issues |
