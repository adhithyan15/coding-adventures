...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    */
    expect(report.summary.missedByWindow.R2).toBe(3690); // Marwadi Chapter 2 retrieves every newly measurable Chapter 1 atom inside R2 instead of exposing new debt.
  });
