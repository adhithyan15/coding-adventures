...
concept_tag: MR-WRITE-TIMED
prerequisites: [MR-A1F13-six-field-independent, MR-A1M18-independent-message]
sounds: []
roots: []
...
duration:
  max_seconds: 280
requires:
  knowledge: [MR-A1-FORM-LABEL-NAAV, MR-A1-FORM-LABEL-SHAHAR, MR-A1-FORM-LABEL-BHASHA, MR-A1-FORM-LABEL-AVDATE-PEY, MR-A1-FORM-LABEL-AVADTI-KRUTI, MR-A1-FORM-LABEL-MITRACHE-NAAV]
introduces:
  knowledge: []
introduces_idioms: []
introduces_senses: []
...
reviews_of: [MR-A1F13-six-field-independent, MR-A1M18-independent-message]
---

# The same six fields, with a clock

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[MR-A1-FORM-LABEL-NAAV] -->

[PAUSE 2s] You have done this writing with as long as you liked.
...
<!-- hl-knowledge: introduces=[]; assesses=[MR-A1-FORM-LABEL-NAAV, MR-A1-FORM-LABEL-SHAHAR, MR-A1-FORM-LABEL-BHASHA, MR-A1-FORM-LABEL-AVDATE-PEY, MR-A1-FORM-LABEL-AVADTI-KRUTI, MR-A1-FORM-LABEL-MITRACHE-NAAV] -->
...
Both are worth learning from your own clock rather than from an examiner.
