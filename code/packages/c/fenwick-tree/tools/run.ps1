# Build and run the fenwick-tree tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name fenwick_tree-tests -Sources @("tests\fenwick_tree_test.c", "src\fenwick_tree.c")
