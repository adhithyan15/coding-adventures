...
date, month, week, time, datetime-local, color, file, boolean, choice, and multiline
...
HTML image submit inputs reuse the button control family for intrinsic sizing,
paint, focus, and activation while submission-specific coordinate policy stays
outside layout.
