...
// Its dedicated Qaf clip independently repeats the closed head, continues into
// a much deeper bowl, then places the right and left upper dots as separate runs.
...
// ச is Frame 3's preceding row: movements 1-3 make its upper frame and
// projecting middle bar, then movement 4 restarts around the lower-left bowl.
...
// ட is Frame 1's first row: its left descent turns directly into the long
// rightward foot, so the two numbered movements form one pen-down run.
...
export const DUCTUS: Record<string, LetterDuctus> = {
  ...
  ஒ: {
    ...
    strokes: [
      { segments: [
        { label: "circle the small left loop and climb into the crown", path: [
          { x: 150, y: 160 }, { x: 220, y: 105 }, { x: 305, y: 120 },
          { x: 345, y: 180 }, { x: 350, y: 255 }, { x: 345, y: 310 },
          { x: 290, y: 350 }, { x: 215, y: 350 }, { x: 140, y: 315 }, { x: 95, y: 255 },
          { x: 95, y: 190 }, { x: 135, y: 125 },
        ] },
        { label: "sweep through the large right loop and curl inward", path: [
          { x: 135, y: 125 }, { x: 80, y: 300 }, { x: 180, y: 430 }, { x: 360, y: 515 }, { x: 500, y: 530 },
          { x: 675, y: 505 }, { x: 810, y: 435 }, { x: 885, y: 330 }, { x: 895, y: 225 },
          { x: 860, y: 135 }, { x: 790, y: 100 }, { x: 720, y: 105 }, { x: 670, y: 150 },
          { x: 660, y: 220 }, { x: 680, y: 285 }, { x: 655, y: 325 }, { x: 600, y: 275 },
          { x: 550, y: 210 }, { x: 520, y: 140 }, { x: 520, y: 60 }, { x: 600, y: -20 },
          { x: 720, y: -65 }, { x: 850, y: -70 },
        ] },
      ] },
      { segments: [
        { label: "draw the separate lower bowl and return left", path: [
          { x: 675, y: -95 }, { x: 625, y: -175 }, { x: 550, y: -245 }, { x: 455, y: -280 },
          { x: 350, y: -275 }, { x: 275, y: -225 }, { x: 250, y: -150 }, { x: 280, y: -80 },
        ] },
      ] },
    ],
    source: {
      citation: "Sankaran Radhakrishnan, Tamil Script Learners Manual, Module 14, ஒ, with Appendix I: Hand-movements, Frame 14 (University of Texas at Austin), p. 195",
      url: "https://sites.la.utexas.edu/tamilscript/category/3-moduals/module-14",
      variation: "Module 14 identifies ஒ as short o. Appendix I Frame 14 numbers three movements: the left loop and large right loop stay joined, followed by the separate lower bowl after one lift. This two-run learner order is fitted to the bundled Noto Sans Tamil outline; Tamil handwriting varies by school.",
    },
  },
  க: {
    script: "tamil",
    ...
    strokes: [
      {
        segments: [
          {
            label: "turn around the hooked left lobe and sweep through the broad lower bowl",
            path: [
              { x: 142, y: 258 },
              { x: 200, y: 270 },
              { x: 260, y: 310 },
      ...
      },
      {
        segments: [
          {
            label: "turn around the rounded right lobe and return left along the inner bar",
            path: [
              { x: 610, y: 220 },
              { x: 610, y: 190 },
              { x: 650, y: 205 },
  ...
  [ductusKey("telugu", "ఉ")]: {
    ...
    strokes: [
        ...
        segments: [
          {
            ...
            path: [
              { x: 610, y: 410 }, { x: 550, y: 440 }, { x: 470, y: 465 },
              { x: 380, y: 468 }, { x: 285, y: 445 }, { x: 205, y: 405 },
              { x: 145, y: 350 }, { x: 110, y: 285 },
            ],
          },
          {
            label: "continue down and around the broad lower bowl",
            path: [
              { x: 110, y: 285 }, { x: 78, y: 215 }, { x: 78, y: 145 },
              { x: 105, y: 85 }, { x: 155, y: 45 }, { x: 215, y: 25 },
              { x: 275, y: 35 }, { x: 325, y: 70 }, { x: 365, y: 115 },
              { x: 405, y: 75 }, { x: 455, y: 42 },
            ],
          },
          {
            label: "curl upward around the rounded right lobe without lifting",
            path: [
              { x: 455, y: 42 }, { x: 520, y: 20 }, { x: 585, y: 25 },
              { x: 645, y: 55 }, { x: 685, y: 105 }, { x: 690, y: 155 },
              { x: 665, y: 205 }, { x: 620, y: 225 }, { x: 575, y: 220 },
            ],
          },
        ],
      },
      {
        segments: [
          {
            label: "lift and draw the inner horizontal bar from left to right",
            path: [
              { x: 95, y: 282 }, { x: 205, y: 282 }, { x: 320, y: 282 },
              { x: 440, y: 282 }, { x: 560, y: 282 }, { x: 680, y: 282 },
              { x: 750, y: 282 },
            ],
          },
        ],
        ...
        segments: [
          {
            ...
            path: [
              { x: 378, y: 610 }, { x: 378, y: 570 }, { x: 378, y: 525 },
              { x: 378, y: 490 },
            ],
          },
        ],
  ...
  [ductusKey("telugu", "ఎ")]: {
    ...
    strokes: [
      ...
      },
      {
        segments: [
          {
            label: "restart at the junction and sweep up through the broad outer arch",
            path: [
              { x: 275, y: 141 },
              { x: 325, y: 95 },
              { x: 390, y: 52 },
