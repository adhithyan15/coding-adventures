#!/bin/sh
# Build and run the intel-4004-assembler tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c intel_4004_assembler-tests tests/intel_4004_assembler_test.c src/intel_4004_assembler.c
