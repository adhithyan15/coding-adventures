...
require_relative "lib/coding_adventures/wasm_runtime/version"

Gem::Specification.new do |spec|
  spec.name          = "coding_adventures_wasm_runtime"
  spec.version       = CodingAdventures::WasmRuntime::VERSION
  spec.authors       = ["Adhithya Rajasekaran"]
  spec.summary       = "WebAssembly 1.0 wasm-runtime"
