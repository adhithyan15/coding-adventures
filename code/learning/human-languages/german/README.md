...
- **Chapter 16 — Numbers Eleven to Twenty**: elf/zwölf (the *-lif* "left over"
  story), 13–20.
- **Chapter 17 — Colours**: schwarz/weiß, rot/blau.
- **Chapter 18 — To Have**: *haben* — the four present forms the ending
...
- **Chapter 19 — The Wrapped Participle**: the weak past participle met one
...
- **Chapter 20 — The Past Built From Have**: the *Perfekt* — *haben* plus a
...
- **Chapter 21 — The Simple Past**: the *Präteritum* — *sagte*, *machte*,
...
- **Chapter 22 — I Am, You Are**: *sein*, met one present form per lesson —
  *bin*, *bist*, *ist*, *sind*, *seid* — plus *müde*, and the grid only at the
  end, as a recap.
- **Chapter 23 — Being Your Years**: *alt*, *das Jahr*, *Wie alt bist du?* and
...
- **Chapter 24 — Three Verbs Under One Roof**: *war/warst/waren*, the three
  Proto-Indo-European roots inside one infinitive, suppletion, and why the
  commonest words are the last to be regularised.
- **Chapter 25 — The Past That Takes To Be**: the *sein*-perfect —
  *kommen*, *fahren*, *werden*, *bleiben*, the learned list, and the
  participle that agrees with nothing where French has four forms.
- **Chapter 26 — Head and Hand**: *der Kopf*, *Haupt*, *die Hand*.
- **Chapter 27 — Yes and No**: *ja*, *nein*, and the negative-answer *doch*.
- **Chapter 28 — Please**: *Wasser, bitte* from previously learned words.
- **Chapter 29 — Sorry**: *Entschuldigung*, *es tut mir leid*.
- **Chapter 30 — Weather**: *das Wetter*, *es ist heiß/kalt*, *es regnet*.
- **Chapter 31 — Dog and Cat**: *Hund*, *Katze*.
- **Chapter 32 — Green and Yellow**: *grün*, *gelb*.
- **Chapter 33 — Verbs of the Mind**: *denken*, *verstehen*, *lesen*,
  *schreiben* — and the strong-verb vowel break (*du liest*).
- **Chapter 34 — Taking, Asking, Helping, Liking**: *nehmen*, *fragen*,
  *helfen*, *mögen/lieben* — and *gern*, German'''s third way of liking.
- **Chapter 35 — Sitting, Standing, Sleeping, Hearing**: *sitzen*, *stehen*,
  *schlafen*, *hören* — the second sound shift's *t*-branch, and a second way
  for a strong verb to break (*du schläfst*).
- **Chapter 36 — Going, Running, Opening, Closing**: *gehen*, *laufen*,
  *rennen*, *öffnen*, *schließen* — where German's walk/run line actually
  falls, and the first separable verbs (*Ich mache die Hand auf*).
- **Chapter 37 — Coffee, Tea, and Milk**: *der Kaffee*, *der Tee*, *die
  ...
  word.
- **Chapter 38 — Friend and Family**: *der Freund*, *die Freundin* (the
  native *-in* feminine suffix), *die Familie* (the one Latin loan in the
  chapter).
- **Chapter 39 — Eyes, Ears, Mouth, Nose**: *das Auge*, *das Ohr*, *der
  Mund*, *die Nase* — extends Chapter 26's body-part material to the rest of
  the face.
- **Chapter 40 — Arm, Finger, Foot, Heart**: *der Arm*, *der Finger*, *der
  Fuß*, *das Herz* — completes the five-word Hand/Arm/Finger/Fuß/Herz set
  Chapter 26 named but only a fifth of which it taught.
...
**Thirty-four of forty chapters are atom-scored: 1–11 and 18–40.** Those
are exactly the chapters whose lessons have been migrated to schema version 2
and so declare real knowledge atoms. Chapters 12–17 are still schema v1 and carry
...
Chapter 26 is the one authored chapter that fails. It runs three word lessons
...
real Kopf/Haupt/Hand practice lesson. Chapter 27 has the same missing-practice
shape but clears the floor because *nein* reassesses *ja*.

Chapters 33 and 34 close over **all** of their own atoms, and both payoffs also
reach back past their own chapter — chapter 33's to `GE-LEX-HAND-02`,
`GE-ETYMON-HAND-MANUS-05` and `GE-SOUND-GRIMMS-LAW-04` from chapter 26;
chapter 34's to all four of chapter 33's verbs plus `GE-LEX-HUND-02`,
...
Chapters 35 and 36 do the same and were written to drain it deliberately.
Chapter 35's payoff reaches to `GE-SOUND-GRIMMS-LAW-04` (ch. 22),
`GE-LEX-HUND-02`/`GE-ETYMON-HUND-03`/`GE-LEX-KATZE-04` (ch. 27) and all three
of chapter 34's closing atoms; chapter 36's reaches to `GE-LEX-NEHMEN-02`,
`GE-ETYMON-NEHMEN-03` and `GE-ETYMON-HELFEN-08` (ch. 30), `GE-LEX-HAND-02` and
`GE-SOUND-HAND-03` (ch. 22), and back into chapter 35. Six atoms that no lesson
...
Chapters 37–40 are the pre-A1 vocabulary tranche (fourteen nouns; see
CHANGELOG). All four payoffs close over their own chapter's atoms at 1.00
representativeness. Chapter 37's payoff also rescues chapter 36's two
never-revisited atoms, `GE-LEX-SCHLIESSEN-10` and `GE-ETYMON-SCHLIESSEN-11`;
chapter 39's rescues chapter 35's disputed `GE-ETYMON-HOEREN-10` "sharp-eared"
link, never revisited since it was flagged; chapter 40's reaches to chapters
14, 17, 26, 31 and 35 at once, completing the Hand/Arm/Finger/Fuß/Herz set
chapter 26 printed but only a fifth of which it taught.

## Reinforcement chaining (HL09 §7)

A chapter-end payoff cannot close the R1 window (n+1…n+3), so the reach-back
runs at two cadences. Every lesson in chapters 33–34 also names atoms from the
...
| `GE-C25-moegen-lieben` | all of chapters 33 and 34, plus chapters 30 and 31 |
...
| `GE-C26-hoeren` | all of chapter 35, plus chapters 26, 31 and 34 |
...
| `GE-C30-nase` | all of chapter 39, plus ch. 22 `GE-LEX-KOPF-02`/`GE-LEX-HAND-02` |
...
| `GE-C31-herz` | all of chapter 40, plus ch. 22 `GE-LEX-HAND-02`, ch. 27 `GE-ETYMON-HUND-03`, ch. 31 `GE-ETYMON-HOEREN-10` |
