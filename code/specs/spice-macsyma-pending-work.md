...
- PSS residual finite-difference Jacobians across Python, TypeScript, and Rust
  SPICE engines: ordered residual vectors and L2/RMS norms have landed, and
  this follow-up exposes the next shooting-Newton foothold from reactive
  initial conditions to the ordered residual vector.
