#!/bin/sh
# Build and run the logic-core tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c logic_core-tests tests/logic_core_test.c src/logic_core.c
