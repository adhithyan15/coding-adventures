// Package argon2i implements Argon2i (RFC 9106) -- data-independent
...
// ``argon2id`` (the RFC-recommended default).
//
...
// fillSegment -- Argon2i uses data-independent addressing in every
// segment.  The (J1, J2) pairs come from a deterministic stream
// generated by double-G of an input block seeded with
// (pass, lane, slice, total memory, total passes, type, counter, 0, ...).
...
// Sum computes an Argon2i tag (RFC 9106 §3).
