# Build and run the fab-process-simulation tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name fab_process_simulation-tests -Sources @("tests\fab_process_simulation_test.cpp")
