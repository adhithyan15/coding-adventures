...
% canonical-source-hash: fnv1a64:50f7f7c953717c0b
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{ippuḍu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{ippuḍu}, then \emph{ippuḍu veḷḷu} — \textquotedblleft{}go now\textquotedblright{}
  \item \emph{Recall:} say \emph{guruvu}, then read \textbf{\te{నిజం}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{elluṇḍi}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{ippuḍu}, then \emph{elluṇḍi}, and say which one is further off
  \item \emph{Recall:} read \textbf{\te{విద్యార్థి}}, then say \emph{cālu}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{prayāṇaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{prayāṇaṁ}, then \emph{dīpaṁ}, and name the ending they share
  \item \emph{Recall:} say \emph{vaidyuḍu}, then read \textbf{\te{తప్పకుండా}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{bayaludēru}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{bayaludēru}, then \emph{prayāṇaṁ}, and say which of the two is inherited
  \item \emph{Recall:} read \textbf{\te{రైతు}}, then say \emph{ēmō}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{veḷḷostānu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{veḷḷostānu}, then the reply \emph{veḷḷi raṇḍi}, and say why neither half stands alone
  \item \emph{Recall:} say \emph{atithi}, then read \textbf{\te{అలాగే}} and say what it means
\end{itemize}
