# Changelog — lua/b-tree

## [0.1.0] — 2026-04-11

### Added
- Initial implementation of `coding_adventures.b_tree` (DT11) in Lua.
...
- Comprehensive test suite: 15 describe blocks covering all deletion cases,
