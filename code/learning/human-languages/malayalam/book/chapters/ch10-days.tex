...
\midrule
\textbf{\ml{തിങ്കളാഴ്ച}} & \emph{thiṅkaḷ} & "\textbf{Moon}" & \emph{thiṅgaḷ} — nearly identical \\
\textbf{\ml{ചൊവ്വാഴ്ച}} & \emph{covva} & traditionally "\textbf{the red one}" & \emph{cevvāy} — the same word, worn differently \\
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: "thiṅkaḷ" — moon — then "āzhcha," day/week{]}
  \item {[}YOU SAY: the shared words — "veḷḷi" (Venus), same in both Malayalam and Tamil{]}
  \item {[}YOU SAY: the Sanskrit ones — "budhan, vyāzham, śani" — Mercury, Jupiter, Saturn{]}
\end{itemize}
