...
% canonical-source-hash: fnv1a64:673e44aa76c21dab
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{paśu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{paśu}, then \emph{pāl}, and say which one gives the other
  \item \emph{Recall:} say \emph{kūṭutal}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{āṭŭ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{nāṭŭ}, then \emph{āṭŭ}, and say which of the two is an animal
  \item \emph{Recall:} read \textbf{\ml{കുറവ്}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kōḻi}, then \emph{puḻa}, and say which sound the two have in common
  \item \emph{Recall:} say \emph{kuṟaccŭ}
\end{itemize}
...
Of all the birds around a house this is the one a household deals with daily. Cooked rice — \emph{cōṟŭ} — set out on a step at the back is put there for the \ml{കാക്ക}, and it arrives within the minute.
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kākka}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kākka}, then \emph{kōḻi}, and say which of the two is kept and which turns up
  \item \emph{Recall:} read \textbf{\ml{വേണ്ട}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{āna}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{paśu}, \emph{āṭŭ}, \emph{kōḻi}, \emph{kākka}, \emph{āna}
  \item \emph{Recall:} say \emph{pōruṁ}
\end{itemize}
