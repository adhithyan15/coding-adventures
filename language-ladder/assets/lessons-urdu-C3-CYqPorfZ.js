...
duration:
  max_seconds: 150
requires:
  knowledge: [UR-LEX-AAP-TUM-TU]
introduces:
  knowledge: [UR-ETYMON-TUM-THOU]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [UR-ETYMON-TUM-THOU, UR-LEX-AAP-TUM-TU]
skills: [listening, speaking, reading]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C03-aap-tum-tu]
---
# (آپ / تم / تو, continued) — The word, taken apart

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-AAP-TUM-TU] -->

[PAUSE 2s] Before going on: say **آپ / تم / تو** again, and what it means.
...
[PAUSE 1s]
- [YOU SAY: what this lesson added to **آپ / تم / تو**, in one sentence]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[UR-ETYMON-TUM-THOU] -->
<!-- hl-activity: {"id":"UR-C03-aap-tum-tu-more-thou","kind":"text","assesses":["UR-ETYMON-TUM-THOU"],"prompt":"Which old English word for 'you' is a relative of Urdu tum and tū?","answer":"thou","accepted":["thee"],"feedback":{"correct":"Right: tum/tū, Sanskrit tvam, Latin tū and English thou are one family.","incorrect":"The relative is English thou, beside Sanskrit tvam and Latin tū."},"response_seconds":8} -->

[PAUSE 3s] What did this lesson add to **آپ / تم / تو**? Say it once more, without
looking.
`,a=e({default:()=>o}),o=`---
schema_version: 2
...
duration:
  max_seconds: 150
requires:
  knowledge: [UR-LEX-MAIN]
introduces:
  knowledge: [UR-GRAMMAR-MAIN-HUN-FRAME]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [UR-GRAMMAR-MAIN-HUN-FRAME, UR-LEX-MAIN]
skills: [listening, speaking, reading]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral
...
---
# (میں ... ہوں, continued) — the verb closes the frame

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-MAIN] -->

[PAUSE 2s] Before going on: say **میں ... ہوں** again, and what it means.
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[UR-GRAMMAR-MAIN-HUN-FRAME] -->

[PAUSE 1s]
- [YOU SAY: what this lesson added to **میں ... ہوں**, in one sentence]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[UR-GRAMMAR-MAIN-HUN-FRAME] -->
<!-- hl-activity: {"id":"UR-C04-main-hun-more-frame","kind":"text","assesses":["UR-GRAMMAR-MAIN-HUN-FRAME"],"prompt":"Type the Urdu frame 'I am ...', leaving three dots for the state word.","answer":"میں ... ہوں","accepted":["میں ۔۔۔ ہوں","main ... hun","maiṅ ... hūṅ"],"feedback":{"correct":"Right: میں opens the answer and ہوں closes it.","incorrect":"Use میں ... ہوں — maiṅ ... hūṅ."},"response_seconds":10} -->

[PAUSE 3s] What did this lesson add to **میں ... ہوں**? Say it once more, without
looking.
`,y=e({default:()=>b}),b=`---
schema_version: 2
id: UR-C04-main-hun
...
duration:
  max_seconds: 150
requires:
  knowledge: [UR-LEX-KHUDA-HAFIZ]
introduces:
  knowledge: [UR-GRAMMAR-KHUDA-HAFIZ-ELLIPSIS, UR-PRAGMATICS-STANDARD-FAREWELL, UR-CROSSLINGUAL-KHUDA-HAFIZ-SPELLING]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [UR-GRAMMAR-KHUDA-HAFIZ-ELLIPSIS, UR-PRAGMATICS-STANDARD-FAREWELL, UR-CROSSLINGUAL-KHUDA-HAFIZ-SPELLING, UR-LEX-KHUDA-HAFIZ]
skills: [listening, speaking, reading]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C05-khuda-hafiz]
---
# (خدا حافظ, continued) — Grammar Lens — a whole social move

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-KHUDA-HAFIZ] -->

[PAUSE 2s] Before going on: say **خدا حافظ** again, and what it means.
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[UR-GRAMMAR-KHUDA-HAFIZ-ELLIPSIS, UR-PRAGMATICS-STANDARD-FAREWELL, UR-CROSSLINGUAL-KHUDA-HAFIZ-SPELLING] -->

[PAUSE 1s]
- [YOU SAY: what this lesson added to **خدا حافظ**, in one sentence]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[UR-GRAMMAR-KHUDA-HAFIZ-ELLIPSIS, UR-PRAGMATICS-STANDARD-FAREWELL, UR-CROSSLINGUAL-KHUDA-HAFIZ-SPELLING] -->
<!-- hl-activity: {"id":"UR-C05-khuda-hafiz-more-spacing","kind":"text","assesses":["UR-CROSSLINGUAL-KHUDA-HAFIZ-SPELLING"],"prompt":"Type the Urdu goodbye with its conventional space between the two words.","answer":"خدا حافظ","accepted":["khuda hafiz","khudā hāfiz"],"feedback":{"correct":"Right: Urdu keeps the visible space in خدا حافظ.","incorrect":"Urdu writes خدا حافظ with a space; Persian joins it as خداحافظ."},"response_seconds":9} -->

[PAUSE 3s] What did this lesson add to **خدا حافظ**? Say it once more, without
looking.
`,j=e({default:()=>M}),M=`---
schema_version: 2
