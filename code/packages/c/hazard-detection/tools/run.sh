#!/bin/sh
# Build and run the hazard-detection tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c hazard_detection-tests tests/hazard_detection_test.c src/hazard_detection.c
