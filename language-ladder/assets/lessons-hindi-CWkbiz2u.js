...
requires:
  knowledge: [HI-SCRIPT-RECOG-118]
introduces:
  knowledge: [HI-SCRIPT-RECOG-119]
practises:
  knowledge: [HI-SCRIPT-RECOG-118, HI-SCRIPT-RECOG-119]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus]
register: neutral
...
[PAUSE 1s] Before the new one: ◌ँ — what does it do?

[PAUSE 2s] One character this time. Just one — and you have been saying it
for pages without knowing which mark on the page it was.

## Script you'll notice: ष
<!-- hl-knowledge: introduces=[HI-SCRIPT-RECOG-119]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[]; assesses=[HI-SCRIPT-RECOG-119] -->

Put your pen on ष and follow its line. Copy the shape you can see — slowly,
and larger than it is printed.
...
- [YOU TRACE: ष three times, saying *ssa* as you finish each one]
- [YOU LOOK: back at any page of this chapter and find ष once more]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[HI-SCRIPT-RECOG-119] -->

[PAUSE 3s] Which character is this — ष? What sound does it carry? (***ssa***.)
Name one word you already say that contains it.
`,s=e({default:()=>c}),c=`---
schema_version: 2
id: HI-S120-vowel-sign-u
spine_node: SPINE-MEET-GREET
sequence: 631
delivery: script
chapter: 16
type: writing
headword: "ु"
gloss: the single character ु — recognised inside words you already say
romanization: "u"
prerequisites: [HI-S119-letter-ssa]
sounds: []
roots: []
duration:
  max_seconds: 150
requires:
  knowledge: [HI-SCRIPT-RECOG-119]
introduces:
  knowledge: [HI-SCRIPT-RECOG-120]
practises:
  knowledge: [HI-SCRIPT-RECOG-119, HI-SCRIPT-RECOG-120]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus]
register: neutral
variety: standard-colloquial
reviews_of: [HI-S119-letter-ssa]
---
...
<!-- hl-knowledge: introduces=[HI-SCRIPT-RECOG-120]; assesses=[] -->
...
- **ख़ुशी** — happiness / pleased to meet you
...
Put your pen on ◌ु and follow its line. Copy the shape you can see — slowly,
and larger than it is printed.
...
[PAUSE 1s]
- [YOU LOOK: at these words, and find ◌ु in the ones that have it]
...
[PAUSE 3s] Which character is this — ◌ु? What vowel does it put on the consonant it attaches to — and what does it take off? (**Puts *u* on; takes the built-in *a* off.**)
Name one word you already say that contains it.
`,l=e({default:()=>u}),u=`---
schema_version: 2
id: HI-S121-letter-la
spine_node: SPINE-MEET-GREET
sequence: 641
delivery: script
chapter: 17
type: writing
headword: "ल"
gloss: the single character ल — recognised inside words you already say
romanization: "la"
prerequisites: [HI-S120-vowel-sign-u]
sounds: []
roots: []
duration:
  max_seconds: 150
requires:
  knowledge: [HI-SCRIPT-RECOG-120]
introduces:
  knowledge: [HI-SCRIPT-RECOG-121]
practises:
  knowledge: [HI-SCRIPT-RECOG-120, HI-SCRIPT-RECOG-121]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus]
register: neutral
variety: standard-colloquial
reviews_of: [HI-S120-vowel-sign-u]
---
...
[PAUSE 1s] Before the new one: ◌ु — what does it do?

[PAUSE 2s] One character this time. Just one — and you have been saying it
for pages without knowing which mark on the page it was.

## Script you'll notice: ल
<!-- hl-knowledge: introduces=[HI-SCRIPT-RECOG-121]; assesses=[] -->
...
> This is one attested teaching order and not a national standard — handwriting
> here is taught with school-to-school variation. Source: Opiaterein, ‘Deva-ल-order.gif’, strokes 1–4, Wikimedia Commons, 11 May 2009.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[HI-SCRIPT-RECOG-121] -->

[PAUSE 1s]
- [YOU LOOK: at these words, and find ल in the ones that have it]
...
[PAUSE 3s] Which character is this — ल? What sound does it carry? (***la***.)
Name one word you already say that contains it.
`,d=e({default:()=>f}),f=`---
schema_version: 2
...
romanization: "kha"
prerequisites: [HI-S121-letter-la]
sounds: []
roots: []
duration:
  max_seconds: 150
...
practises:
  knowledge: [HI-SCRIPT-RECOG-121, HI-SCRIPT-RECOG-122]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus]
register: neutral
variety: standard-colloquial
reviews_of: [HI-S121-letter-la]
---
...
[PAUSE 1s] Before the new one: ल — what does it do?

[PAUSE 2s] One character this time. Just one — and you have been saying it
for pages without knowing which mark on the page it was.

## Script you'll notice: ख
<!-- hl-knowledge: introduces=[HI-SCRIPT-RECOG-122]; assesses=[] -->
...
Put your pen on ख and follow its line. Copy the shape you can see — slowly,
and larger than it is printed.
