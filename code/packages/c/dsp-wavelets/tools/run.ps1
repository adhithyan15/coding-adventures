# Build and run the dsp-wavelets tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name dsp_wavelets-tests -Sources @("tests\dsp_wavelets_test.c", "src\dsp_wavelets.c")
