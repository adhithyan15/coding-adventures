...
% canonical-source-hash: fnv1a64:16226818cd33e43f
...
\section[āṁkh]{\hi{आँख} (āṁkh) — the eye, which is the same word in English}
...
\end{tcolorbox}
\section[pair / pāṁv]{\hi{पैर} (pair) — the foot, and the ancestor it does not have}
...
\end{tcolorbox}
\section[peṭ]{\hi{पेट} (peṭ) — the belly, and a trail that genuinely stops}
