...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}oui\textquotedblright{} — \emph{wee}{]}
  \item {[}YOU SAY: the origin — \textquotedblleft{}hoc ille $\to$ oïl $\to$ oui\textquotedblright{}: \emph{that's the one}{]}
  \item {[}YOU SAY: the contradiction — \textquotedblleft{}Tu ne viens pas ? — Si !\textquotedblright{}{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} How do you say yes in French? (\textbf{oui}.) What Latin phrase is it worn down from? (\textbf{hoc ille}, \textquotedblleft{}this is it,\textquotedblright{} via \emph{oïl}.) What were the \emph{langue d'oïl} and \emph{langue d'oc} named after? (The two medieval words for \textbf{yes}.) When do you answer \textbf{si} instead of \emph{oui}? (To \textbf{contradict a negative} — \emph{Tu ne viens pas? — Si!})
\end{tcolorbox}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}non\textquotedblright{} — nasal, through the nose, like the \emph{-on} in \emph{bon}{]}
  \item {[}YOU SAY: the pair with yes — \textquotedblleft{}oui / non\textquotedblright{}{]}
