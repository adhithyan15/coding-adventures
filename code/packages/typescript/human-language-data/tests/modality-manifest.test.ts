...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3401, // +1 Italian guided-copy step on top of Latin's merged step
      ...
      voice: 2464, // Italian's legacy opener becomes honestly classified as pen
      ...
      pen: 347, // +2 Italian pen lessons on top of Latin's merged two
      ...
      drivableLessons: 2464, // +2: Marwadi synthesis lessons remain drivable
      ...
      unstartableChapters: 211, // Italian chapter 1 now honestly starts with pen. // French/Marathi order recovery on current main: measured, not inferred. // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
