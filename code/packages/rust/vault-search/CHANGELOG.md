...
- `SearchableFieldsSummary` plus `SearchableFields::summary()` for
  descriptor-level diagnostics over declared indexable fields,
  usable weights, skipped weights, and max weight without touching
  document plaintext.
