...
iso_build_and_run c lisp_vm-tests tests/lisp_vm_test.c src/lisp_vm.c ../lisp-compiler/src/lisp_compiler.c ../lisp-parser/src/lisp_parser.c ../lisp-lexer/src/lisp_lexer.c
