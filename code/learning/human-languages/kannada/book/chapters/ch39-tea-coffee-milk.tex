...
% canonical-source-hash: fnv1a64:b8b46f6044bd6917
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}dayaviṭṭu cahā\textquotedblright{} — tea, please
  \item \emph{Say it:} the road — \textquotedblleft{}chá … chāy … cahā\textquotedblright{}
  \item \emph{Say it:} two Persian loans — \textquotedblleft{}hava … cahā\textquotedblright{}
  \item \emph{Say it:} land against sea — \textquotedblleft{}chai … tea\textquotedblright{}
  \item \emph{Recall:} say \emph{snēhita}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}dayaviṭṭu kāphi\textquotedblright{} — coffee, please
  \item \emph{Say it:} plain and aspirated — \textquotedblleft{}pa … pha\textquotedblright{}
  \item \emph{Say it:} the chain — \textquotedblleft{}qahwa … kahve … koffie … coffee … kāphi\textquotedblright{}
  \item \emph{Say it:} two drinks, two roads — \textquotedblleft{}cahā, three languages … kāphi, five\textquotedblright{}
  \item \emph{Recall:} read \textbf{\kn{ಮಗು}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}dayaviṭṭu hālu\textquotedblright{} — milk, please
  \item \emph{Say it:} Chapter 32's four pairs again — \textquotedblleft{}pōgu, hōgu … pattu, hattu … pāl, hālu … peyar, hesaru\textquotedblright{}
  \item \emph{Say it:} turmeric milk, and its color — \textquotedblleft{}ariśina hālu … haḷadi\textquotedblright{}
  \item \emph{Say it:} three drinks now — \textquotedblleft{}cahā, kāphi, hālu\textquotedblright{}
  \item \emph{Recall:} say \emph{maga}
\end{itemize}
