...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3404, // +3: Tamil adds one bridge; Persian adds two writing lessons.
      ...
      voice: 2462, // Tamil's opener now exposes its pen dependency too
      ...
      pen: 352, // +4: Tamil and Persian each add observe-trace and guided-copy evidence.
      ...
      // Persian Chapter 1 now begins with pen, so four formerly reachable voice
      // lessons move behind the intentionally visual writing start.
      ...
      unstartableChapters: 214, // Tamil and Persian Chapter 1 now honestly start with pen.
      overriddenLessons: 0,
