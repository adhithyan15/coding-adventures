#!/bin/sh
# Build and run the vigenere-cipher tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c vigenere_cipher-tests tests/vigenere_cipher_test.c src/vigenere_cipher.c
