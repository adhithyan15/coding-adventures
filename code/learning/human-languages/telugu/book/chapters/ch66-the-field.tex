...
% canonical-source-hash: fnv1a64:175703af19ec1c61
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{polaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{polaṁ}, then \emph{grāmaṁ}, and say which one feeds the other
  \item \emph{Recall:} say \emph{kūḍā}, then read \textbf{\te{స్వాగతం}} and say what it means
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{vari}, then say which of \te{బియ్యం} and \te{అన్నం} comes next
  \item \emph{Recall:} read \textbf{\te{మాత్రమే}}, then say \emph{maryāda}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{gaḍḍi}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{gaḍḍi}, then \emph{gēde}, and say which one is carried to the other
  \item \emph{Recall:} say \emph{ayitē}, then read \textbf{\te{మనవి}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kallaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kallaṁ}, then \emph{cīpuru}, and say which one is used on the other
  \item \emph{Recall:} read \textbf{\te{తరువాత}}, then say \emph{anumati}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{paṇṭa}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then take your leave with \emph{veḷḷostānu}
  \item \emph{Recall:} say \emph{iṅkā}, then read \textbf{\te{నమ్మకం}} and say what it means
\end{itemize}
