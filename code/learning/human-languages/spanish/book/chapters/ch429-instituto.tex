...
% canonical-source-hash: fnv1a64:4b54689bb21e5047
...
\begin{quote}
\textbf{IES Ejemplo} \textbf{Boletín de calificaciones}
\end{quote}
...
A real letterhead carries the centre's own name after those three letters — usually a poet, a scientist or a place. \textbf{Ejemplo} stands in for it here, so nothing on this page points at a school somebody actually attends. What you read off a real document is the same three things: the \textbf{IES}, the heading, and the column.
\end{tcolorbox}
