...
`x25519`, `brainfuck-wasm-compiler`, and `argon2i` ports:

| Current breadth | Packages | Missing slots to all 15 |
|---|---:|---:|
| Present in 10-15 languages | 172 | 335 |
...
The 172 packages present in at least ten implementation languages need 335
