...
- HashAlgorithm type for SHA-256 and SHA-512 selection
- Error types for invalid output length (ErrOutputTooLong, ErrOutputTooShort)
- Empty/nil salt handling (uses HashLen zero bytes per RFC 5869)
