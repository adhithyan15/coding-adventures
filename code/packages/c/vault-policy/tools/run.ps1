# Build and run the vault-policy tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name vault_policy-tests -Sources @("tests\vault_policy_test.c", "src\vault_policy.c")
