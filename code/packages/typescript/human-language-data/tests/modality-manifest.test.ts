...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3402, // +1: Italian's guided-copy bridge
      ...
      voice: 2462, // Italian's legacy opener now exposes its pen dependency
      ...
      pen: 350, // +2: Italian's opener trace and guided copy
      ...
      drivableLessons: 2462, // Italian's opener leaves the hands-free set.
