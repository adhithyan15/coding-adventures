...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3401, // +1: Tamil's two-minute guided-copy bridge
      ...
      voice: 2463, // Tamil and Chinese openers now declare detachable pen segments
      ...
      pen: 348, // Tamil's two pen lessons join Chinese's opener trace
      ...
      drivableLessons: 2463, // Tamil and Chinese openers are honestly pen-dependent
      ...
      unstartableChapters: 212, // French/Marathi order recovery on current main: measured, not inferred. // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
