...
% canonical-source-hash: fnv1a64:70f4143194832750
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What happens to the \textbf{\ml{ം}} when the plural arrives? (\textbf{It is traded for \ml{ങ്ങൾ}}.) Which noun tells you to expect that? (\textbf{One whose last letter is \ml{ം}}.) Where else have you been saying that ending? (\textbf{On the end of the respectful \emph{you}}.)
\end{tcolorbox}
