...
describe("corpus snapshot", () => {
  ...
  it("pins the ramp, and the size of its blind spot", () => {
    ...
    expect(report.summary.measurablePercent).toBe(73); // +1: HL-C98 // +1: vocabulary wave 5 added 40 schema-v2 lessons, all measurable // +1: vocabulary wave 6 added 54 schema-v2 lessons, all measurable // HL12: +30 recognition segments (telugu/kannada/malayalam 8 each, sanskrit 6) -- all schema-v2 and all atom-bearing, so the measurable share rises // HL-C137 wave II: +36 adjective lessons, +6 chapters, all six Indic tracks // HL-C156: letter ledgers replicated to all six — 85 one-character segments
  });
