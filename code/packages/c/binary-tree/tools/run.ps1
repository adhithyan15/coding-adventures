# Build and run the binary-tree tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name binary_tree-tests -Sources @("tests\binary_tree_test.c", "src\binary_tree.c")
