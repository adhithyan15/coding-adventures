...
Current selection: **RCPU-045**, the RISC-V RV64I + M functional implementation.
The checked Spec 07a functional/gate pair is complete; chronological priority
now advances to the RV64I + M pair while earlier cells publish one at a time.
