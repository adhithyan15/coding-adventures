...
% canonical-source-hash: fnv1a64:b2378c324a0419a5
...
\textbf{By the end of this chapter:} \emph{I can name the head and the hand in Portuguese and explain the nasal vowel that swallowed the n of manus.}
...
\begin{itemize}
\raggedright
  \item “a cabeça” — make \textbf{ç} an \textbf{s}
  \item “Dói-me a cabeça.”
  \item “cabeça $\leftarrow$ caput”
\end{itemize}

\emph{Twice through:} “A cabeça — feminine; ç sounds s.”

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Say “the head.” (\textbf{A cabeça}.) What does the cedilla do? (Marks \emph{c} as \textbf{s} before \emph{a/o/u}.) What is the Latin root? (\emph{\textbf{Caput}}.) Next: compare the head-words and find that root a second time in learned vocabulary.
\end{tcolorbox}
...
\begin{itemize}
\raggedright
  \item “cabeça — inherited”
  \item “capital — re-borrowed”
  \item “tête/testa: pot; Kopf: cup”
\end{itemize}

\emph{Twice through:} “Cabeça and capital — two routes from \emph{caput}.”

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which two languages kept \emph{caput} as their everyday head-word? (\textbf{Portuguese and Spanish}.) What did French, Italian, and German use instead? (\textbf{Container words}.) Why do \emph{cabeça} and \emph{capital} look different? (One is \textbf{inherited}; one is \textbf{re-borrowed}.) Next: the hand and the disappearing \emph{n}.
\end{tcolorbox}
\section[a mão]{a mão — \textquotedblleft{}the hand\textquotedblright{}}
...
\begin{itemize}
\raggedright
  \item \textquotedblleft{}a mão, as mãos\textquotedblright{}
  \item the change — \textquotedblleft{}ma\textbf{n}us … mã\textbf{o}\textquotedblright{}
  \item the family — \textquotedblleft{}lua, boa, pão — all lost an \textbf{n}\textquotedblright{}
  \item the contrast — \textquotedblleft{}Spanish \emph{mano}, Portuguese \emph{mão}\textquotedblright{}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Say \textquotedblleft{}the hand\textquotedblright{} and \textquotedblleft{}the hands.\textquotedblright{} (\emph{A mão} / \emph{as mãos}.) What happened to the \emph{n} of \emph{manus}? (It \textbf{dissolved between vowels}, leaving a nasal vowel — which the \textbf{til} marks.) Name two other words that did the same. (\emph{Lua} $\leftarrow$ \emph{lūna}, \emph{boa} $\leftarrow$ \emph{bona}, \emph{pão} — Ch. 11.) Did they all keep the nasality? (\textbf{No} — \emph{mão} and \emph{pão} did; \emph{lua} and \emph{boa} lost it again.) What did Spanish do? (\textbf{Kept the \emph{n}} in all — \emph{mano}, \emph{luna}, \emph{pan}.) Why is \emph{mão} feminine? (Latin \emph{manus} was \textbf{fourth-declension feminine} — the same reason Italian says \emph{la mano}.) Next: the rest of the body.
\end{tcolorbox}
