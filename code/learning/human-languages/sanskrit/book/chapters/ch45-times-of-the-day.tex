...
% canonical-source-hash: fnv1a64:83ec3806a69b8544
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{prātaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{nīlaḥ}, then \emph{prātaḥ}
  \item \emph{Recall:} say \emph{ātithyam}, then read \textbf{\sk{श्वेतः}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{madhyāhnaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{prātaḥ}, then \emph{madhyāhnaḥ}
  \item \emph{Recall:} read \textbf{\sk{विनयः}}, then say \emph{śyāmaḥ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{sāyam}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{madhyāhnaḥ}, then \emph{sāyam}
  \item \emph{Recall:} say \emph{namratā}, then read \textbf{\sk{पीतः}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{māsaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{sāyam}, then \emph{māsaḥ}
  \item \emph{Recall:} read \textbf{\sk{विश्वासः}}, then say \emph{haritaḥ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{saṁvatsaraḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{prātaḥ} and \emph{saṁvatsaraḥ} together
  \item \emph{Recall:} say \emph{saralaḥ}, then read \textbf{\sk{नीलः}}
\end{itemize}
