...
schema_version: 2
id: ML-R114-letters-first-pass
spine_node: SPINE-CHECK-WELLBEING
sequence: 4270
chapter: 114
type: review
headword: (nine letters)
gloss: first pass over the nine letters taken from words you already say
...
# (nine letters) — From the letter to the word — a first pass

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[ML-SCRIPT-C113-SHA-01, ML-SCRIPT-C113-NGA-01] -->

[PAUSE 3s] Say **ശരി** (*śari*), then write the letter it gave you.
...
[PAUSE 3s] Which word did each letter come from? (**ശ** from **ശരി**; **ങ** from **നിങ്ങൾ**; **ള** from **നാളെ**; **ഖ** from **സുഖം**; **ധ** from **ബുധൻ**; **ബ** from **ബുധൻ**; **ർ** from **ഞായർ**; **ഛ** from **അച്ഛൻ**; **◌ൈ** from **കൈ**.)
`,r=e({default:()=>i}),i=`---
schema_version: 2
