...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Nothing to recall yet. Before the first Chinese word arrives, one thing your voice is about to be asked to do that English never asks of it.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{mā} high and flat, then \textbf{mà} falling — hear how far apart they are{]}
  \item {[}YOU ANSWER: if you change the pitch of a Mandarin syllable, what changes?{]}
\end{itemize}
...
Source: \href{https://github.com/adhithyan15/coding-adventures/blob/main/code/learning/human-languages/data/scripts/chinese.json}{the tone inventory this track keeps}
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Say the four tones on \emph{ma} once, in order. Hold the third one — low and dipping. The first Chinese word carries exactly that pitch.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{nǐ} — low and dipping, not flat{]}
  \item {[}YOU READ: \textbf{\zh{你}} — name its left piece, then its right piece{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Say the word for \textquotedblleft{}you\textquotedblright{} without looking. Which of its two components is the person? Now hold that low, dipping pitch — the next word wants the same one.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{hǎo} — low and dipping, the \emph{ow} of \textquotedblleft{}how\textquotedblright{}{]}
  \item {[}YOU READ: \textbf{\zh{好}} — name its left component, then its right one{]}
  \item {[}YOU ANSWER: why does this track use component pictures instead of English cousins?{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Two characters, both already yours. Say the one that means \textquotedblleft{}you\textquotedblright{}. Say the one that means \textquotedblleft{}good\textquotedblright{}. Now put them in that order and you have said hello — but say it slowly for one more moment, because the tones are about to do something.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{nǐ hǎo} — greeting someone you have just met{]}
  \item {[}YOU SAY: \textbf{nǐ hǎo} — answering that same greeting{]}
  \item {[}YOU ANSWER: how many characters is this word, and how many words is it?{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Say the greeting once, slowly, giving both syllables the low dipping third tone you were taught. It should feel awkward in the mouth. That awkwardness is the whole lesson.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{ní hǎo} — first syllable rising, second dipping{]}
  \item {[}YOU SAY: it again, at speaking speed, without the pause between them{]}
  \item {[}YOU ANSWER: which spelling changes when the rule applies — pinyin, characters, or neither?{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Name the character built from a woman and a child, and say what it means. Hold its tone: low and dipping.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU ANSWER: \textbf{hǎo} or \textbf{hào} — which one means \textquotedblleft{}good\textquotedblright{}?{]}
  \item {[}YOU ANSWER: what changed between them, and what stayed the same?{]}
  \item {[}YOU ANSWER: which two components is this character built from?{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Retrieve the two words separately first: the one meaning \textquotedblleft{}you\textquotedblright{}, then the one meaning \textquotedblleft{}good\textquotedblright{}. Do not run them together yet.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: greet someone you have just met{]}
  \item {[}YOU SAY: answer that greeting{]}
  \item {[}YOU READ: \textbf{\zh{你好}} aloud from the characters alone, with no pinyin{]}
\end{itemize}
