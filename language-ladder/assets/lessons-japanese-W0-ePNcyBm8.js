...
headword: ち
romanization: chi
gloss: the hiragana sign for the mora chi — two strokes, and a sound the romanization spells with four letters
prerequisites: [JA-W01-ni]
sounds: [mora]
roots: []
etymology_hook: ち is written with two strokes and romanised with four letters — the clearest sign that the roman spelling is a description, not the writing system.
duration:
  max_seconds: 180
requires:
...
practises:
  knowledge: [JA-SCRIPT-CHI-01, JA-SCRIPT-HIRAGANA-MORA, JA-SCRIPT-NI-01]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral-across-levels
variety: standard-japanese-tokyo
reviews_of: [JA-W01-ni]
---
...
[PAUSE 2s] Three strokes: vertical, short bar, long bar. Write the sign read *ni*.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-CHI-01]; assesses=[JA-SCRIPT-HIRAGANA-MORA] -->
...
**Count what just happened.** One sign. One beat. **Four roman letters** to
describe it. The romanization is a pronunciation aid written for people who do not
read the script yet — it is not a smaller version of the writing system, and the
number of letters in it tells you nothing about the number of beats in the word.

This is the moment the roman spelling starts costing you more than it pays, and it
is why the signs are worth the effort.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-CHI-01, JA-SCRIPT-HIRAGANA-MORA] -->

- [YOU WRITE: ち — top bar, then the body in one movement]
- [YOU SAY: **chi**, one beat — as long as any other sign, no longer]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-CHI-01, JA-SCRIPT-HIRAGANA-MORA] -->
<!-- hl-activity: {"id":"JA-W01-chi-beats","kind":"text","assesses":["JA-SCRIPT-CHI-01"],"prompt":"This sign is romanised with four letters. How many beats does it take?","answer":"1","accepted":["one","one beat","1 beat"],"feedback":{"correct":"One — the letter count is a description, not a measure.","incorrect":"One beat. The four roman letters describe the sound; they do not count time."},"response_seconds":10} -->

Does the number of roman letters tell you how long a sign is held? (**No.**)
...
prerequisites: [JA-W01-hai-read]
sounds: [pure-vowels, mora]
roots: []
etymology_hook: え completes a second word without a second effort — its two companions are signs you already hold.
duration:
  max_seconds: 180
requires:
  knowledge: [JA-SCRIPT-I-01, JA-SCRIPT-HAI-READ-01]
introduces:
...
[PAUSE 2s] Read the word for *yes* off the page, sign by sign, out loud.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-E-01]; assesses=[] -->
...
2. the **body** — across to the right, back down and left in a flat zigzag, then
   out to the lower right in one continuous movement
...
prerequisites: [JA-W01-ha]
sounds: [mora]
roots: []
etymology_hook: nothing new is introduced here — two known signs are simply set side by side, and a word appears.
duration:
  max_seconds: 160
requires:
...
shown, you are **reading** it — assembling it out of two pieces you can write from
memory and sound out in order.

That is the whole method for this writing system, and it does not get harder. It
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-E-01] -->

[PAUSE 2s] The two-stroke sign read *e* — tick, then body. Write it once.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-KO-01]; assesses=[] -->

> こ

The simplest sign you have met. Two short horizontal strokes, stacked, the lower
one longer and slightly curved:
...
Nothing joins them. The gap between the two strokes is part of the shape — close
it and you have a different sign.
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-KO-01] -->
<!-- hl-activity: {"id":"JA-W01-ko-strokes","kind":"text","assesses":["JA-SCRIPT-KO-01"],"prompt":"How many strokes does the hiragana sign read 'ko' have?","answer":"2","accepted":["two","2 strokes","two strokes"],"feedback":{"correct":"Two, stacked and separate.","incorrect":"Two: a short upper stroke and a longer lower one."},"response_seconds":8} -->
...
Add the fifth — the one that is read *wa* because it is a topic marker — and the
greeting is on the page:

> **こ** + **ん** + **に** + **ち** + **は** → **こんにちは**

**ko-n-ni-chi-wa.** Five signs, **five beats**, all even. Say it against a steady
...
<!-- hl-activity: {"id":"JA-W01-konnichiwa-read-beats","kind":"text","assesses":["JA-SCRIPT-KONNICHIWA-READ-01"],"prompt":"How many beats (morae) does the written daytime greeting take?","answer":"5","accepted":["five","5 beats","five beats"],"feedback":{"correct":"Five — one per sign, and the vowel-less one counts fully.","incorrect":"Five: one beat per sign, including the one with no vowel."},"response_seconds":10} -->
...
headword: に
romanization: ni
gloss: the hiragana sign for the mora ni — three strokes, and a left post you have written before
prerequisites: [JA-W01-n]
sounds: [mora]
roots: []
etymology_hook: に opens with the same tall left post as the sign read ha — the first time two hiragana share a visible part.
duration:
  max_seconds: 180
requires:
  knowledge: [JA-SCRIPT-N-01, JA-SCRIPT-HA-01]
introduces:
  knowledge: [JA-SCRIPT-NI-01]
practises:
...
## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-NI-01]; assesses=[JA-SCRIPT-HA-01] -->
...
**This is the first time two signs share a visible part**, and it is worth
naming, because it is nearly the last. Hiragana is not built from recombining
components the way Chinese characters are — these two happen to have worn down to
similar left-hand posts, not because they mean or sound anything alike. Treat the
resemblance as a **handwriting** convenience, not as a clue. Reading information
into it is the mistake this book keeps warning you off.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-NI-01, JA-SCRIPT-HA-01] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-NI-01] -->
<!-- hl-activity: {"id":"JA-W01-ni-shared","kind":"text","assesses":["JA-SCRIPT-NI-01"],"prompt":"Two signs so far share a similar left-hand vertical. Does that shared shape tell you anything about their sound or meaning?","answer":"no","accepted":["none","it does not","nothing","no it does not"],"feedback":{"correct":"Nothing — it is a handwriting resemblance, not a component.","incorrect":"No. Hiragana signs are not built from meaningful parts; the resemblance is coincidental."},"response_seconds":12} -->
...
## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-WA-01]; assesses=[JA-SCRIPT-HA-01] -->

> わ

Two strokes:

1. the **vertical** on the left, with the small flick at the foot
2. the **body** — a short bar right from the top, then down, round to the left in
   a loop, and out to the lower right with a curl
...
The daytime greeting **sounds** like it ends in *wa*. **It is not written with
this sign.** It ends with the sign read *ha* — the one you learned early and were
told was holding a second job.

That second job is grammatical: は is also Japanese's topic marker, and **as a
topic marker it is pronounced *wa***. The greeting is a frozen fragment of a
longer sentence, and it kept the marker's spelling along with the marker's sound.

So the rule you need is not about sound at all:

- **わ** is the sign for the mora *wa* inside ordinary words.
- **は** read as *wa* means you are looking at the topic marker, or at something
  that used to contain one.

Getting this backwards is the single most common beginner spelling error in
Japanese, and it is the reason this book taught you the sign for *wa* **after**
you already knew the greeting — so the shape could arrive with its warning
attached rather than be quietly assumed.
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-WA-01, JA-PARTICLE-WA-SPELLING] -->
<!-- hl-activity: {"id":"JA-W01-wa-particle","kind":"text","assesses":["JA-PARTICLE-WA-SPELLING"],"prompt":"The daytime greeting ends in a sound like 'wa'. Is it written with the sign for wa, or the sign for ha?","answer":"ha","accepted":["the ha sign","sign for ha","ha sign"],"feedback":{"correct":"The ha sign — it is the topic marker, and the marker is read wa.","incorrect":"The HA sign. It is the topic marker, which is pronounced wa."},"response_seconds":12} -->

Which of the two is a fact about **grammar** rather than about sound? (The one
where は is read *wa*.)
...
3. a **loop** that starts at the upper right, sweeps down and left across the
   vertical, curls round at the bottom, and finishes pointing right

The loop is one continuous movement, not a circle drawn separately. Start it,
cross what you have already written, and come back out.
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-A-01] -->
<!-- hl-activity: {"id":"JA-W03-a-strokes","kind":"text","assesses":["JA-SCRIPT-A-01"],"prompt":"How many strokes does the hiragana sign read 'a' have?","answer":"3","accepted":["three","3 strokes","three strokes"],"feedback":{"correct":"Three — horizontal, vertical, then the loop.","incorrect":"Three: a horizontal, a vertical, and one looping stroke."},"response_seconds":8} -->

Is the loop drawn as a separate circle, or in one movement? (**One movement**,
crossing what you have already written.)
...
prerequisites: [JA-W03-u]
sounds: [mora]
roots: []
etymology_hook: no new sign appears here: ありがとう is five shapes you can already write, set in a row.
duration:
  max_seconds: 200
requires:
  knowledge: [JA-SCRIPT-A-01, JA-SCRIPT-RI-01, JA-SCRIPT-KA-01, JA-SCRIPT-DAKUTEN-01, JA-SCRIPT-TO-01, JA-SCRIPT-U-01]
introduces:
  knowledge: [JA-SCRIPT-ARIGATOU-READ-01]
practises:
  knowledge: [JA-SCRIPT-ARIGATOU-READ-01, JA-SCRIPT-A-01, JA-SCRIPT-RI-01, JA-SCRIPT-KA-01, JA-SCRIPT-DAKUTEN-01, JA-SCRIPT-TO-01, JA-SCRIPT-U-01]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral-across-levels
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-A-01, JA-SCRIPT-RI-01, JA-SCRIPT-KA-01] -->

[PAUSE 2s] Write あ, り and か in a row. Then add the two ticks to the last one.

## Script — the assembly
<!-- hl-knowledge: introduces=[JA-SCRIPT-ARIGATOU-READ-01]; assesses=[JA-SCRIPT-DAKUTEN-01, JA-SCRIPT-TO-01, JA-SCRIPT-U-01] -->
...
That is the whole point of the last five lessons. In Chapter 1 this word was a
sound you copied and a romanization you leaned on. It is now something you can
read off a shop sign, and — more to the point — something you could write on a
note without being able to say a single sentence of Japanese.
...
- [YOU READ: ありがとう — name each sign before you say the word]
- [YOU WRITE: ありがとう — all five, in order, without looking above]
- [YOU SAY: **arigatou** — five beats, the last two one long o]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-ARIGATOU-READ-01, JA-SCRIPT-DAKUTEN-01] -->
<!-- hl-activity: {"id":"JA-W03-arigatou-read-ga","kind":"text","assesses":["JA-SCRIPT-ARIGATOU-READ-01"],"prompt":"Which sign in ありがとう is another sign plus the dakuten, and what is underneath it?","answer":"ga, which is ka","accepted":["が, from か","ga from ka","the third sign, ka","が is か plus the marks","ka"],"feedback":{"correct":"が — か with two ticks.","incorrect":"The third sign が, which is か plus the dakuten."},"response_seconds":12} -->

How many signs did you have to learn for this word? (**Five** — but one of them
was free, because が is か with two ticks.)
...
gloss: two small marks that voice a sign — か becomes ga, こ becomes go
prerequisites: [JA-W03-ka]
sounds: [mora]
roots: []
etymology_hook: The dakuten is the cheapest thing in Japanese writing: two ticks, and a sign you already know becomes a second one.
duration:
  max_seconds: 190
requires:
  knowledge: [JA-SCRIPT-KA-01, JA-SCRIPT-KO-01]
introduces:
...
register: neutral-across-levels
variety: standard-japanese-tokyo
reviews_of: [JA-W03-ka, JA-W01-ko]
---

# ゛— two ticks, and every sign you know doubles

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-KA-01, JA-SCRIPT-KO-01] -->

[PAUSE 2s] Write か. Then write こ, from Chapter 2.

## Script — the mark
<!-- hl-knowledge: introduces=[JA-SCRIPT-DAKUTEN-01]; assesses=[] -->
...
It is called the **dakuten**, and it does one job: it **voices** the consonant.
Voicing is what separates English *k* from *g*, or *s* from *z* — the same
mouth position, with the vocal cords switched on.
...
**No new shape.** The sign underneath is exactly the one you already write; the
marks sit above and to the right of it, small, and clear of the strokes.

This is worth pausing on, because it changes the size of the job in front of
you. Hiragana has forty-six signs. Learning the dakuten does not add signs — it
**doubles the ones you already have**, at the price of two ticks. Every *k* you
know becomes a *g*, every *s* a *z*, every *t* a *d*, every *h* a *b*.

You have now met four signs that take it -- は, こ, ち and か -- and two of them
are in the word this chapter is building.
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-DAKUTEN-01] -->
<!-- hl-activity: {"id":"JA-W03-dakuten-job","kind":"text","assesses":["JA-SCRIPT-DAKUTEN-01"],"prompt":"What do the two small marks of the dakuten do to a hiragana sign?","answer":"they voice the consonant","accepted":["voice it","voices the consonant","make it voiced","turn k into g","they make the consonant voiced"],"feedback":{"correct":"They voice it — ka becomes ga, ko becomes go.","incorrect":"They VOICE the consonant: ka to ga, ko to go, sa to za."},"response_seconds":12} -->

Does が need a new shape learned? (**No** — it is か plus two ticks.)
...
headword: か
romanization: ka
gloss: the hiragana sign for the mora ka — three strokes, and the base of another sign
prerequisites: [JA-W03-ri]
sounds: [mora]
roots: []
etymology_hook: か is the base of が: the same shape with a mark added, which is the next lesson's whole idea.
duration:
  max_seconds: 180
requires:
...
[PAUSE 2s] Write り. Short left, long right, gap between.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-KA-01]; assesses=[] -->
...
Remember this shape more carefully than the others. **You are about to get a
second sign out of it for free** — か is the base of が, and the difference
between them is two small marks rather than a new character to learn.
...
prerequisites: [JA-W03-sa]
sounds: [mora]
roots: []
etymology_hook: ま is the fourth sign of ございます, and its looping last stroke is the same movement as あ's.
duration:
  max_seconds: 170
requires:
...
[PAUSE 2s] Write さ, then ざ.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-MA-01]; assesses=[] -->

> ま

Three strokes, and the order is top-down as always:

1. an **upper horizontal**, short
2. a **lower horizontal**, a little wider, below and parallel to it
3. a **looping vertical** that crosses both, falls, and curls left at the bottom

The third stroke is the same movement you learned on あ — down through what you
have written, then a small loop at the foot. If あ's loop is comfortable, this
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-MA-01] -->
<!-- hl-activity: {"id":"JA-W03-ma-strokes","kind":"text","assesses":["JA-SCRIPT-MA-01"],"prompt":"How many strokes does the hiragana sign read 'ma' have?","answer":"3","accepted":["three","3 strokes","three strokes"],"feedback":{"correct":"Three — two horizontals and the looping vertical.","incorrect":"Three: two horizontal strokes, then the looping vertical."},"response_seconds":8} -->
...
headword: り
romanization: ri
gloss: the hiragana sign for the mora ri — two strokes, and a sound that is not an English r
prerequisites: [JA-W03-a]
sounds: [mora]
roots: []
etymology_hook: り is the second sign of ありがとう, and its consonant is a tap rather than the English r.
duration:
  max_seconds: 180
requires:
  knowledge: [JA-SCRIPT-A-01]
...
[PAUSE 2s] Write あ. Horizontal, vertical, loop.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-RI-01]; assesses=[] -->

> り

Two strokes, drawn left to right, and they never touch:

1. a **short left stroke**, curving gently down and to the right
2. a **long right descender**, starting higher, falling much further, and
   hooking left at the very bottom

The gap between them is the shape. So is the difference in length — the right
stroke should fall roughly twice as far as the left.

Now the sound, and it is worth a moment. **Japanese r is not the English r.**
It is a single **tap** of the tongue against the ridge behind the teeth — very
close to the *r* of Spanish *pero*, and not far from the *dd* in an American
saying *ladder*. Your tongue touches once and releases.

If you say an English *r* here you will be understood and you will sound foreign
in a way that one minute of practice fixes.
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-RI-01] -->
<!-- hl-activity: {"id":"JA-W03-ri-tap","kind":"text","assesses":["JA-SCRIPT-RI-01"],"prompt":"Is the Japanese r in 'ri' closer to an English r or to a single tap of the tongue?","answer":"a single tap","accepted":["a tap","tap","single tap","closer to a tap"],"feedback":{"correct":"A tap — like the r in Spanish pero.","incorrect":"A single TAP of the tongue, not an English r."},"response_seconds":10} -->
...
duration:
  max_seconds: 180
requires:
  knowledge: [JA-SCRIPT-ARIGATOU-READ-01, JA-SCRIPT-DAKUTEN-01]
introduces:
  knowledge: [JA-SCRIPT-SA-01]
practises:
...
[PAUSE 2s] Write ありがとう. All five signs, no help.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-SA-01]; assesses=[JA-SCRIPT-DAKUTEN-01] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-SA-01] -->
<!-- hl-activity: {"id":"JA-W03-sa-za","kind":"text","assesses":["JA-SCRIPT-SA-01"],"prompt":"What does the sign read 'sa' become when the dakuten is added?","answer":"za","accepted":["ざ","it becomes za"],"feedback":{"correct":"ざ za — same shape, voice switched on.","incorrect":"It becomes ざ, read za."},"response_seconds":8} -->
...
headword: と
romanization: to
gloss: the hiragana sign for the mora to — two strokes, and the fourth sign of the thank-you
...
[PAUSE 2s] Write が. Then say what the two ticks did to it.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-TO-01]; assesses=[] -->
...
headword: う
romanization: u
gloss: the hiragana sign for the mora u — two strokes, and here it lengthens the vowel before it
prerequisites: [JA-W03-to]
sounds: [mora]
roots: []
etymology_hook: う after と does not add a syllable: it holds the o for a second beat, which is why arigatou ends the way it sounds.
duration:
  max_seconds: 190
requires:
  knowledge: [JA-SCRIPT-TO-01]
introduces:
  knowledge: [JA-SCRIPT-U-01]
practises:
  knowledge: [JA-SCRIPT-U-01, JA-SCRIPT-TO-01]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral-across-levels
variety: standard-japanese-tokyo
reviews_of: [JA-W03-to]
---

# う — two strokes, and a vowel that stretches

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-TO-01] -->

[PAUSE 2s] Write と. Tick, then sweep, no join.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-U-01]; assesses=[] -->

> う

Two strokes, the simplest pair in this chapter:

1. a **short tick** at the top, roughly horizontal
2. a **wide curve** beneath it, falling from the upper left, bellying right, and
   tapering away to the lower left

Read **u**: close to the *oo* of *food* but shorter, and with the lips much less
rounded than an English speaker expects. Do not push them forward.

## What you've built — and what this sign does after と
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-U-01, JA-SCRIPT-TO-01] -->
...
**う after an o-sound does not add a syllable. It holds the one before it for a
second beat.** The beat is still there — Japanese counts it, and dropping it
...
- [YOU WRITE: う — the tick, then the wide curve]
- [YOU SAY: **to**, then **too** — one beat, then two, same vowel]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-U-01] -->
<!-- hl-activity: {"id":"JA-W03-u-long","kind":"text","assesses":["JA-SCRIPT-U-01"],"prompt":"When u follows an o-sound in hiragana, what does it do?","answer":"it lengthens the o","accepted":["makes the o long","holds the o for another beat","lengthens the vowel","it makes it a long o"],"feedback":{"correct":"It holds the o for a second beat — a long o, not a new syllable.","incorrect":"It LENGTHENS the o: the beat is counted, but the vowel does not change."},"response_seconds":12} -->

Is the extra beat optional? (**No** — Japanese counts it, and dropping it sounds
clipped.)
