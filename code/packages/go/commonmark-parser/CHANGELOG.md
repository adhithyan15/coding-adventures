...
- Initial Go port of the CommonMark 0.31.2 Markdown block and inline parser
...
- **Phase 2 — inline parser** (`inline_parser.go`):
  - CommonMark Appendix A delimiter-stack algorithm for emphasis and strong
    emphasis resolution.
...
- All 652 CommonMark 0.31.2 spec examples pass (verified by the `commonmark`
  package's `TestCommonMarkSpec`).
