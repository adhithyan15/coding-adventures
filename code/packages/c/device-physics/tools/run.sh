#!/bin/sh
# Build and run the device-physics tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c device_physics-tests tests/device_physics_test.c src/device_physics.c
