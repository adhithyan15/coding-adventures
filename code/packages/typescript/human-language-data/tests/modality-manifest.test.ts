...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      voice: 2461, // German's cleaned opener adds one voice lesson to the combined Urdu baseline.
      ...
      */
      ...
      drivableLessons: 2461, // German adds one hands-free opener to the combined Urdu baseline.
      /* Superseded merge-side totals:
