...
Chief of Staff job/session/agent
  ...
  -> command resolution brief over audit, remediation, operator-action, and
     closeout-retention signals without dispatching commands or draining queues
  ...
  -> runtime snapshot, morning-brief, platform-brief, pending-work, attention-overview,
     system-health, operator-action, service-execution readiness,
