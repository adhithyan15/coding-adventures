#!/bin/sh
# Build and run the http-core tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c http_core-tests tests/http_core_test.c src/http_core.c
