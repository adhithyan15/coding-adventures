...
Exact integer control assignments may be followed across multiple passes until
their checked increment exits, subject to the same 4,096-pass analysis cap.
