...
% canonical-source-hash: fnv1a64:3100b3308fc6eed2
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\hi{बड़ा}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{dost}, then read \textbf{\hi{यह}}, then say \emph{vah}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\hi{छोटा}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} read \textbf{\hi{बच्चा}}, then say \emph{yahā̃}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\hi{अच्छा}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{ādmī}, then read \textbf{\hi{वहाँ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\hi{नया}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{aurat / mahilā / strī}, then say \emph{kaun}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\hi{पुराना}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{kahā̃}
\end{itemize}
