# Build and run the format-doc-std tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
$env:ISO_INCLUDE = "include ..\format-doc\include $harness\include"
. (Join-Path $harness 'lib\iso-lib.ps1')
Iso-BuildAndRun -Lang c -Name format_doc_std-tests -Sources @("tests\format_doc_std_test.c", "src\format_doc_std.c", "..\format-doc\src\format_doc.c")
