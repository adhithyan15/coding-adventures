...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      // Arabic harakat split adds one four-minute pen micro-lesson.
      ...
      voice: 2466, // +2: Marwadi synthesis lessons include voice
      ...
      pen: 344, // +5: Marwadi writing lessons
      ...
      drivableLessons: 2466, // +2: Marwadi synthesis lessons remain drivable
      ...
      // Legacy reading-order recovery changes 204 -> 209: authored order exposes five
      // existing pen/sight-first chapter starts. The Arabic split adds none.
      unstartableChapters: 209, // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
