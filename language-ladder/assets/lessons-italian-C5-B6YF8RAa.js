...
having* your place. The English family:

- **habitat** — where a creature dwells; **inhabit**, **inhabitant**,
  **habitation**.
- via *habēre* ("have"): **habit** (what you keep having), **able**, **ability**.

French kept the *h* in spelling (*habiter*); Italian dropped it (*abitare*) —
same Latin verb, same meaning. Now you can answer a *dove* ("where") question:
...
Identical to *parlare* — nothing new. That's the whole point of a regular
pattern.
...
- [YOU SAY: "abito, abiti, abita" — same endings as *parlo/parli/parla*]
...
(Habitat, inhabit.) Say "I live in Rome." (*Abito a Roma.*) Next: **lavorare**,
"to work."
`,r=e({default:()=>i}),i=`---
schema_version: 2
id: IT-C05-lavorare
...
to *speak* is, at root, to *tell parables*. The English family:

- **parable**, **parole** (a word of honour), **palaver**, **parley**,
  **parliament** (a *talking*-place).

And a lovely cross-link: **Italian *parlare* and French *parler* are the same
word** — both from *parabolāre*. **Spanish went a different way**: its "to speak,"
*hablar*, is from *fabulārī* ("to chat," ← *fābula* → fable). So Italy and France
...
Like Spanish (*hablo/hablas*), **Italian drops the subject pronoun** — *parlo*
already says "I," so you don't need *io*. This closes a neat circle you've been
building:

- **Drop the pronoun**: Spanish (*hablo*), **Italian (*parlo*)** — endings are
  distinct.
- **Keep the pronoun**: French (*je parle* — endings silent), German (*ich
...
- [YOU SAY: "parlo, parli, parla" — no *io* needed]
...
root, and which? (Spanish *hablar* ← *fabulārī*.) Does Italian keep or drop *io*,
and why? (Drops it — the endings are distinct.) Next: **abitare**, "to live."
`,s=e({default:()=>c}),c=`---
schema_version: 2
...
gloss: "I speak Italian" — your first full sentence (italiano = Italian)
concept_tag: IT-WORD-ITALIANO
prerequisites: [IT-C05-parlare]
...
Oscan **víteliú**, *"land of calves / young cattle"* (kin to Latin *vitulus*,
...
> **Parlo** (I speak, from *parlare*) + **italiano** (Italian) = **Parlo
> italiano.**

A complete, grammatical Italian sentence. Notice what's *not* there:

- **No *io*.** Italian drops it (like Spanish *hablo español*) — the *-o* of
  *parlo* already says "I". *Io parlo italiano* is fine for emphasis only.
...
- [YOU SAY: drop the *io* — Italian doesn't need it (like Spanish, unlike French)]
...
article? (The *-o* ending is "I"; languages take no article.) Which two of the
five languages *drop* the pronoun? (Spanish and Italian.) Next: practice.
`,l=e({default:()=>u}),u=`---
schema_version: 2
id: IT-C05-practice
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
type: practice-mix
headword: (practice)
gloss: making sentences with -are verbs, and the pro-drop circle
...
- **parlare** (← *parabolāre* → parable; = French *parler*, vs Spanish *hablar*),
  **abitare** (← *habitāre* → habitat; twin of *habiter*), **lavorare** (←
  *labōrāre* → labor/laboratory — the "labour" road, not Spanish/French "torture").
- **Parlo italiano** — first self-assembled sentence (*italiano* ← *Italia*,
  perhaps "calf-land").
- **The pronoun circle across 5 languages**: ES *hablo* + IT *parlo* **drop**;
...
- [YOU SAY: chain it — "Ciao! Parlo italiano. Parli italiano? … Arrivederci!"]
...
subject pronoun, and which keep it, and why? (Drop: ES/IT — distinct endings;
keep: FR — silent endings, DE — grammar.) Italian now moves in real sentences.
`,d=e({default:()=>f}),f=`---
schema_version: 2
...
- \`c-before-i\` — **cinque** = *CHEEN-kweh*: *c* before *i/e* is a "ch" sound, but
...
|---|---|---|---|
| **uno** (1) | *ūnus* | *uno* / *un* | **unit, union, unique** (and *a/an*, *one*) |
| **due** (2) | *duo* | *dos* / *deux* | **duo, dual, duet, double** |
| **tre** (3) | *trēs* | *tres* / *trois* | **trio, triple, triangle** |
| **quattro** (4) | *quattuor* | *cuatro* / *quatre* | **quart, quarter, quatrain** |
| **cinque** (5) | *quīnque* | *cinco* / *cinq* | **quintet, quintessence** |

Notice **cinque** — Italian kept Latin *quīnque* almost whole (*-que* and all),
while Spanish softened it to *cinco* and French clipped it to *cinq*. And
**quattro** is why a musical foursome is a *quartet* and four singers make a
...
or *z-*), **una** (fem.). *un caffè* "a/one coffee," *una birra* "a/one beer." The
...
- [YOU SAY: each with its English cousin — "due/duo, tre/trio, quattro/quart,
  cinque/quintet"]
...
*cinco* / *cinq*.) What does *un/una* mean besides "one"? ("A/an.") Next: **6–10**,
and the months hidden inside them.
`,p=e({default:()=>m}),m=`---
schema_version: 2
...
|---|---|---|---|
| **sei** (6) | *sex* | *seis* | **sextet, sextant** |
| **sette** (7) | *septem* | *siete* | **settembre** (the *7th* month!), septet |
| **otto** (8) | *octō* | *ocho* | **ottobre** (8th), **octave, octopus** |
| **nove** (9) | *novem* | *nueve* | **novembre** (9th), novena |
| **dieci** (10) | *decem* | *diez* | **dicembre** (10th), **decimal, decade** |

Watch the doubled consonants do historical work: Latin *septem* had a *-pt-* that
Italian smoothed to *-tt-* → **sette**; Latin *octō* had a *-ct-* that likewise
became *-tt-* → **otto**. Italian didn't drop those clusters (as French did in
*huit*) — it **assimilated** them into twins. So *otto* and *ottobre* still show
the 8 side by side.
...
and August, for Julius and Augustus) pushed the counting months down two slots.
The Latin numbers stuck to the labels. Every *dicembre*, you say Roman "**ten**" —
...
- [YOU SAY: "sette/settembre, otto/ottobre, nove/novembre, dieci/dicembre"]
...
*dicembre* Latin for "ten"? (The Roman year began in March.) Next chapter builds
on this toward time and days.
`,h=e({default:()=>g}),g=`---
schema_version: 2
id: IT-C07-giorni-1
