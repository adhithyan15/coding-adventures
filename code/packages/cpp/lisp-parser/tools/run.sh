...
# Include this package's headers, the sibling header-only lisp-lexer's (a
# dependency), and the harness's (for iso_test.h).
...
iso_build_and_run cpp lisp_parser-tests tests/lisp_parser_test.cpp
