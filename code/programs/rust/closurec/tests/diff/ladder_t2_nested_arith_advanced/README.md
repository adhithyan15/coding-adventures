# ladder_t2_nested_arith_advanced

Rung 2.nested_arith of the CCR-047 differential complexity ladder, at
`ADVANCED`.

## What this rung is for

Exercises nested constant arithmetic, so folding must recurse.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t2_nested_arith_advanced/input/a.js
```
