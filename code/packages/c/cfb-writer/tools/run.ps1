# Build and run the cfb-writer tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name cfb_writer-tests -Sources @("tests\cfb_writer_test.c", "src\cfb_writer.c")
