#!/bin/sh
# Build and run the lisp-compiler tests under EVERY available C/C++ compiler (pure ISO),
...
ISO_INCLUDE="include ../lisp-parser/include ../lisp-lexer/include $HARNESS/include"
export ISO_INCLUDE
...
iso_build_and_run c lisp_compiler-tests tests/lisp_compiler_test.c src/lisp_compiler.c ../lisp-parser/src/lisp_parser.c ../lisp-lexer/src/lisp_lexer.c
