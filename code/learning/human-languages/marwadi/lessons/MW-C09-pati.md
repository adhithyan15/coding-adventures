...
headword: पति
romanization: pati
gloss: husband, written after dental ta
concept_tag: MW-FAMILY-HUSBAND-WRITTEN
prerequisites: [MW-W09-ta]
sounds: [unaspirated-p, dental-t, short-i]
roots: []
etymology_hook: Familiar प and ि now meet the newly isolated त.
duration:
  max_seconds: 155
requires:
...
reviews_of: [MW-C09-hear-pati, MW-W09-ta, MW-W07-i-matra, MW-C09-nana]
---

# पति — husband on the page
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[MW-LEX-PATI-01, MW-SCRIPT-PATI-01] -->
<!-- hl-activity: {"id":"MW-C09-pati-dictation","kind":"text","assesses":["MW-LEX-PATI-01","MW-SCRIPT-PATI-01"],"prompt":"From pati, write the taught relationship word.","answer":"पति","accepted":["पति husband"],"feedback":{"correct":"Right: पति is built only after त is secure.","incorrect":"Build प + ति, keeping the short-i sign before त."},"response_seconds":12} -->
