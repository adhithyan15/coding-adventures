# Build and run the irc-framing tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name irc_framing-tests -Sources @("tests\irc_framing_test.c", "src\irc_framing.c")
