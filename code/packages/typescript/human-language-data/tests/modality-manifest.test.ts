...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3401, // +1 French guided-copy step on top of Latin's merged step
      ...
      voice: 2464, // French's legacy voice opener becomes honestly classified as pen
      ...
      pen: 347, // +2 French pen lessons on top of Latin's merged two
      ...
      drivableLessons: 2464, // French's migrated opener now exposes its writing dependency
      drivablePercent: 72, // French crosses the rounding boundary after its opener becomes pen.
      trackCount: 23,
      ...
      unstartableChapters: 211, // French chapter 1 now honestly starts with pen. // French/Marathi order recovery on current main: measured, not inferred. // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
