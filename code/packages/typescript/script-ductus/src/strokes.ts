// ---------------------------------------------------------------------------
// strokes.ts — public geometry helpers and fixed Script Ductus owner assembly
// ---------------------------------------------------------------------------

import { assembleDuctusRegistry } from "./strokes/registry.ts";
import { entries as japaneseEntries } from "./strokes/japanese.ts";
import { entries as chineseEntries } from "./strokes/chinese.ts";
import { entries as devanagariEntries } from "./strokes/devanagari.ts";
...
// that observable key order without introducing a per-glyph manifest.
export const DUCTUS: Record<string, LetterDuctus> = assembleDuctusRegistry([
  { owner: "japanese", entries: japaneseEntries },
  { owner: "chinese", entries: chineseEntries },
  { owner: "devanagari", entries: devanagariEntries },
  { owner: "cyrillic", entries: cyrillicEntries },
  { owner: "gujarati", entries: gujaratiEntries },
  { owner: "hebrew", entries: hebrewEntries },
  { owner: "arabic-family", entries: arabicFamilyMainEntries },
  { owner: "tamil", entries: tamilMainEntries },
  { owner: "kannada", entries: kannadaEntries },
  { owner: "telugu", entries: teluguEntries },
