#!/bin/sh
# Build and run the intel4004-encoder tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp intel4004_encoder-tests tests/intel4004_encoder_test.cpp
