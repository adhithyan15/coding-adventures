...
All notable changes to `coding_adventures_commonmark_parser` are documented here.
...
- Initial release.
- Full CommonMark 0.31.2 compliance — passes all 652 specification examples.
...
- Delimiter stack algorithm (CommonMark Appendix A) for emphasis/strong.
...
- 678 tests (25 basic smoke tests + 653 CommonMark spec examples).
- 92%+ line coverage, 87%+ branch coverage.
- Spec: TE01 — CommonMark Parser.
