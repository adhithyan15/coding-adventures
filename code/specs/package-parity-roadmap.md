...
rotation. The TypeScript (#11753) and Python (#11754) consumers reproduce that
full corpus through repository-owned primitives with immutable values. They
report secret erasure honestly as `best_effort` and `not_enforceable`,
respectively. Go, Ruby, and Elixir consumers, the central gate, and crash-safe
durable epoch activation (#11734) remain explicit follow-up work.
