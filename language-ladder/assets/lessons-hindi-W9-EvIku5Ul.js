...
concept_tag: HI-WRITE-TIMED
prerequisites: [HI-A1F01-name-no-model, HI-A1F01-name-delayed]
sounds: []
roots: []
...
duration:
  max_seconds: 280
requires:
  knowledge: [HI-FORM-LABEL-NAME-01, HI-FORM-NAME-MIRA-01, HI-FORM-NAME-CUE-MAP-01, HI-FORM-NAME-NO-MODEL-01]
introduces:
  knowledge: []
introduces_idioms: []
introduces_senses: []
...
reviews_of: [HI-A1F01-name-no-model, HI-A1F01-name-delayed]
---

# The same form, with a clock
...
<!-- hl-knowledge: introduces=[]; assesses=[HI-FORM-LABEL-NAME-01, HI-FORM-NAME-MIRA-01, HI-FORM-NAME-CUE-MAP-01, HI-FORM-NAME-NO-MODEL-01] -->
