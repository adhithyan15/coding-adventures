% Preamble for "German, Step by Step, Root by Root" (HL00 book format).
...
\hypersetup{
  pdftitle={German, Step by Step, Root by Root},
  pdfauthor={Adhithya Rajasekaran},
  pdfsubject={Etymology-driven German curriculum},
  pdfkeywords={German, etymology, Latin, language learning}
}
...
\newenvironment{vocabtable}{%
  ...
  \toprule
  \textbf{German} & \textbf{Gender} & \textbf{English} \\
  \midrule
  \endhead
}{%
  \bottomrule
