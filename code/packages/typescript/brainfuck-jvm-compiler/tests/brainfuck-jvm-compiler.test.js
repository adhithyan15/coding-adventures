...
import { BrainfuckJvmCompiler, PackageError, compileSource, packSource, writeClassFile, } from "../src/index.js";
describe("brainfuck-jvm-compiler", () => {
    ...
    it("raises stage-labeled lower-jvm errors", () => {
        ...
        try {
            ...
            expect(error.stage).toBe("lower-jvm");
        }
    });
});
//# sourceMappingURL=brainfuck-jvm-compiler.test.js.map