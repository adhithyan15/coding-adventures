...
% canonical-source-hash: fnv1a64:3b663ac2b30027cd
...
\raggedright
  ...
  \item a \textbf{vertical} crossing it, leaning slightly left as it falls
  \item a \textbf{loop} that starts at the upper right, sweeps down and left across the vertical, curls round at the bottom, and finishes pointing right
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item a \textbf{short left stroke}, curving gently down and to the right
  \item a \textbf{long right descender}, starting higher, falling much further, and hooking left at the very bottom
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item a \textbf{hooked left stroke} — down, curving right at the foot into a small hook
  \item a \textbf{short vertical}, crossing the first stroke near its top and falling to the right of it
  \item a \textbf{short dot}, up at the right, slanting down-right
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item a \textbf{short stroke} at the upper left, little more than a tick leaning down-right
  \item a \textbf{long sweeping stroke} starting above and to the right of it, falling down and left, then curving out to the right at the bottom
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item a \textbf{short tick} at the top, roughly horizontal
  \item a \textbf{wide curve} beneath it, falling from the upper left, bellying right, and tapering away to the lower left
\end{enumerate}
...
And one word from before: say \emph{wani} and what it means.
\end{quote}
