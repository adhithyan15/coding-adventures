module github.com/adhithyan15/coding-adventures/code/packages/go/excel-parser

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/grammar-tools v0.0.0
	github.com/adhithyan15/coding-adventures/code/packages/go/excel-lexer v0.0.0
...
replace github.com/adhithyan15/coding-adventures/code/packages/go/excel-lexer => ../excel-lexer
