...
```rust
use coding_adventures_cas::{ContentAddressableStore, LocalDiskStore};
...
println!("{}", coding_adventures_cas::key_to_hex(&key)); // e.g. "8ddd8be4b179..."
...
```rust
use coding_adventures_cas::{BlobStore, ContentAddressableStore};
