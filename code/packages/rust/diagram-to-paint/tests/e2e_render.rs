...
mod apple {
    ...
    use mermaid_parser::{
        ...
        parse_to_diagram as parse_mermaid_to_diagram, parse_cynefin, parse_info, parse_ishikawa, parse_radar, parse_railroad, parse_swimlane, parse_treeview, parse_treemap, parse_venn, parse_wardley, parse_xychart,
    };
