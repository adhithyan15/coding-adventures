...
% canonical-source-hash: fnv1a64:27e9275b3908b296
...
\begin{sounds}
\kn{ಮಾ} (\emph{mā}) + \kn{ತ} (\emph{ta}) + \kn{ನಾ} (\emph{nā}) + \kn{ಡು} (\emph{ḍu}) $\to$ \kn{ಮಾತನಾಡು}.
\end{sounds}
...
\begin{itemize}
\raggedright
  \item \textquotedblleft{}mātanāḍu\textquotedblright{} (speak)
  \item \textquotedblleft{}I speak\textquotedblright{} — \emph{mātanāḍuttēne}
  \item the word \textquotedblleft{}speech\textquotedblright{} inside it (\emph{mātu})
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \textquotedblleft{}iru\textquotedblright{}
  \item \textquotedblleft{}I live in Bangalore\textquotedblright{} — \emph{nānu Beṅgaḷūrinalli iddēne}
  \item where \textquotedblleft{}in\textquotedblright{} (\emph{-alli}) sits — glued to the end of the noun
\end{itemize}
