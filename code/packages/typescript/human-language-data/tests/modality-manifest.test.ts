...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      totalLessons: 3405, // Italian, French, and Portuguese each add one guided-copy bridge.
      */
      totalLessons: 3412, // French adds one guided-copy bridge to merged Arabic and Portuguese work.
      ...
      */
      ...
      /* Superseded French-only total:
      voice: 2459, // All three Romance openers now expose their pen dependencies.
      */
      voice: 2461, // French's opener becomes pen-dependent after Arabic adds two voice-first greetings.
      /* Superseded merge-side totals:
      ...
      */
      ...
      pen: 356, // Italian, French, and Portuguese each add opener trace and guided copy.
      ...
      drivableLessons: 2459, // All three Romance openers leave the hands-free set.
      */
      pen: 364, // French adds trace and guided copy to the merged Arabic and Portuguese total.
      drivableLessons: 2461, // French removes one opener from the merged hands-free set.
      /* Superseded merge-side totals:
      ...
      */
      drivablePrefixTotal: 2169, // French removes eight opening lessons and Portuguese removes three from the Italian baseline.
      ...
      unstartableChapters: 216, // Italian, French, and Portuguese Chapter 1 now honestly start with pen.
      overriddenLessons: 0,
