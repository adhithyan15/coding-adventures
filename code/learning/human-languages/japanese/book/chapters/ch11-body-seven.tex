...
\begin{enumerate}
\raggedright
  \item Hear \emph{te}; touch one hand.
  \item See \textbf{\ja{て}}; say “hand.”
  \item Hide the word and write its one sign.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item Hear \emph{mimi}; point to an ear.
  \item Read \textbf{\ja{み} | \ja{み}} aloud.
  \item Hide it and write the repeated sign twice.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item Hear \emph{kuchi}; point to the mouth.
  \item Read \textbf{\ja{く} | \ja{ち}}.
  \item Hide it and write the two signs in order.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item Hear \emph{ashi}; touch a foot or leg.
  \item Read \textbf{\ja{あ} | \ja{し}}.
  \item Hide it and write both known signs.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item Hear \emph{hana}; point to the nose.
  \item Read \textbf{\ja{は} | \ja{な}} as \emph{ha-na}.
  \item Hide it and write both signs.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item Hear two beats, \emph{ka-o}; point to the face.
  \item Read \textbf{\ja{か} | \ja{お}}.
  \item Hide it and write the two signs.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item Hear \emph{me}; point to an eye.
  \item See \textbf{\ja{め}}; say the meaning.
  \item Hide it and write the one-sign word.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listen:} point to the named body part.
  \item \textbf{Speak:} name any three without reading.
  \item \textbf{Read:} read all seven from left to right.
  \item \textbf{Write:} choose any three and write them from memory.
\end{enumerate}
