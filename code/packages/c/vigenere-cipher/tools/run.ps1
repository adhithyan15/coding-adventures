# Build and run the vigenere-cipher tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name vigenere_cipher-tests -Sources @("tests\vigenere_cipher_test.c", "src\vigenere_cipher.c")
