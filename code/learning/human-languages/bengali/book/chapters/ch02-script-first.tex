...
% canonical-source-hash: fnv1a64:cdae6c02a5bfae37
...
\end{tcolorbox}
\section[\bn{ন}]{\bn{ন} — trace it, with the bar last}
...
\end{tcolorbox}
\section[\bn{ন}]{\bn{ন} — copy it twice, and join the bar}
...
\end{tcolorbox}
\section[\bn{ন}]{\bn{ন} — write it with the model covered}
...
\end{tcolorbox}
\section[\bn{ন}]{\bn{ন} — the letter from the sound}
