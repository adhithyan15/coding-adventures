...
% canonical-source-hash: fnv1a64:d7eb944ac3171538
...
\section[iṉiya iravu]{\ta{இனிய} \ta{இரவு} (iṉiya iravu) — \textquotedblleft{}good night,\textquotedblright{} and Tamil breaking the pattern one more time}
...
\end{tcolorbox}
\section[nalla iravu / iravu vaṇakkam]{\ta{நல்ல} \ta{இரவு} and \ta{இரவு} \ta{வணக்கம்} — old roots recombined}
