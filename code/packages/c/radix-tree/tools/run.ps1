# Build and run the radix-tree tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name radix_tree-tests -Sources @("tests\radix_tree_test.c", "src\radix_tree.c")
