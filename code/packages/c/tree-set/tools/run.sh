...
# Include this package's headers, the sibling avl-tree's (the set backend), and
# the harness's (for iso_test.h).
ISO_INCLUDE="include ../avl-tree/include $HARNESS/include"
export ISO_INCLUDE
...
# The test compiles the sibling avl-tree backend source in.
iso_build_and_run c tree_set-tests tests/tree_set_test.c src/tree_set.c ../avl-tree/src/avl_tree.c
