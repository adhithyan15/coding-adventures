# Build and run the csv-parser tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name csv_parser-tests -Sources @("tests\csv_parser_test.cpp")
