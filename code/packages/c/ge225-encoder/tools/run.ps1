# Build and run the ge225-encoder tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name ge225_encoder-tests -Sources @("tests\ge225_encoder_test.c", "src\ge225_encoder.c")
