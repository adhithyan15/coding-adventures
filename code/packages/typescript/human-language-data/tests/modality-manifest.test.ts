...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3402, // +2: Persian's guided-copy bridge and chapter-1 payoff
      ...
      pen: 348, // +2: Persian's new guided-copy and payoff lessons
      ...
      unstartableChapters: 212, // Persian chapter 1 now honestly starts with pen.
      overriddenLessons: 0,
