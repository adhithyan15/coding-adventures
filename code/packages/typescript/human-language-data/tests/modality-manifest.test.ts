...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      voice: 2464, // Tamil's migrated opener now declares its detachable pen segment
      ...
      pen: 347, // +2: Tamil's opener trace and guided copy
      ...
      drivableLessons: 2464, // Tamil's opener is now honestly pen-dependent as a whole lesson
      ...
      unstartableChapters: 211, // French/Marathi order recovery on current main: measured, not inferred. // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
