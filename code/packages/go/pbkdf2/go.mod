module github.com/adhithyan15/coding-adventures/code/packages/go/pbkdf2
...
require github.com/adhithyan15/coding-adventures/code/packages/go/md5 v0.0.0 // indirect
