#!/bin/sh
# Build and run the vcd-writer tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c vcd_writer-tests tests/vcd_writer_test.c src/vcd_writer.c
