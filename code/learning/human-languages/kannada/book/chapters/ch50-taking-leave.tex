...
% canonical-source-hash: fnv1a64:a57c4df15ce3c088
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{īga}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{īga}, then \emph{āga}, and point at the near one and the far one
  \item \emph{Recall:} say \emph{śikṣaka}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{nāḍiddu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{īga}, \emph{nāḷe}, \emph{nāḍiddu} — today's moment, then one day out, then two
  \item \emph{Recall:} read \textbf{\kn{ವಿದ್ಯಾರ್ಥಿ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{prayāṇa}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{śubha prayāṇa} to someone leaving, then \emph{prayāṇa} on its own
  \item \emph{Recall:} say \emph{vaidya}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{horaḍu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{horaḍu}, then \emph{hōgu}, and say which of the two has a destination in it
  \item \emph{Recall:} read \textbf{\kn{ರೈತ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{bīḷkoḍuge}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{bīḷkoḍuge} and the \emph{koḍu} hiding inside it
