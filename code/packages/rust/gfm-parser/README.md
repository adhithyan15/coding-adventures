...
GitHub Flavored Markdown parser — produces a Document AST.
...
Parses a GitHub Flavored Markdown string into a `DocumentNode` AST — the format-agnostic IR defined in the `document-ast` crate.
...
- **Full spec compliance**: all 652 GFM 0.31.2 examples pass
- **Correct tab handling**: virtual column tracking for partial-tab stripping
- **Delimiter stack**: emphasis resolution per GFM Appendix A
...
// Parse any GitHub Flavored Markdown
