...
describe("the script ramp against the real corpus", () => {
  it("pins the script ramp, which no gate had ever measured", () => {
    ...
    */
    expect(report.summary.lessonViolations).toBe(55); // The harakat split removes Arabic's final spike after the greeting ramp removes three.
