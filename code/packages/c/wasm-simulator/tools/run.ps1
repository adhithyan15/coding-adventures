# Build and run the wasm-simulator tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name wasm_simulator-tests -Sources @("tests\wasm_simulator_test.c", "src\wasm_simulator.c")
