# ladder_t4_dead_branch_advanced

Rung 4.dead_branch of the CCR-066 differential complexity ladder, at `ADVANCED`.

## What this rung is for

Exercises a branch whose condition folds to false, so the whole statement is removable.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t4_dead_branch_advanced/input/a.js
```
