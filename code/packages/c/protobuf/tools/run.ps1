# Build and run the protobuf tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name protobuf-tests -Sources @("tests\protobuf_test.c", "src\protobuf.c")
