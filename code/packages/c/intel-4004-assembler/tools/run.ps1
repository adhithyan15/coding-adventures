# Build and run the intel-4004-assembler tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name intel_4004_assembler-tests -Sources @("tests\intel_4004_assembler_test.c", "src\intel_4004_assembler.c")
