...
covers all of them for full GFM compliance.
"""
...
# forms of HTML character references defined by GFM:
...
def escape_html(text: str) -> str:
    ...
    Note: ' is NOT escaped. GFM's reference HTML renderer (cmark)
    ...
    parsers, and would fail GFM spec tests that expect the literal '.
