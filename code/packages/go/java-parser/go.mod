module github.com/adhithyan15/coding-adventures/code/packages/go/java-parser

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/grammar-tools v0.0.0
	github.com/adhithyan15/coding-adventures/code/packages/go/java-lexer v0.0.0
...
replace github.com/adhithyan15/coding-adventures/code/packages/go/java-lexer => ../java-lexer
