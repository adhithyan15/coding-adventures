# Sanskrit / संस्कृतम् — Reference

A **reference**, not a chapter — the lessons teach reading through real words.
This page gathers the system and the points Sanskrit needs even from a Devanagari
reader.

## How Devanagari works (the three facts)

1. **Consonants carry a built-in "a".** क = ka, न = na, म = ma — left to right
...
- **Sandhi** — fixed sound-rules fuse words at their seams: *su* + *āgata* →
  *svāgata*. The lessons flag each fusion where it happens.
