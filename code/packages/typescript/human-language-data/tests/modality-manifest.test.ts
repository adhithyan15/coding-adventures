...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3401, // +1: German's guided-copy bridge
      ...
      voice: 2463, // German's opener now exposes its pen dependency
      ...
      pen: 348, // +2: German's opener trace and guided copy
      ...
      drivableLessons: 2463, // German's opener leaves the hands-free set.
      ...
      unstartableChapters: 212, // Chinese chapter 1 now honestly starts with pen. // French/Marathi order recovery on current main: measured, not inferred. // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
