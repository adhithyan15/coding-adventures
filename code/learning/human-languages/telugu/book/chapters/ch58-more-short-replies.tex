...
% canonical-source-hash: fnv1a64:e452e35418edc9a2
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{koñcem}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{koñcem}, then \emph{koñcem pālu}, and hear how much softer it is than \emph{pālu} alone
  \item \emph{Recall:} say \emph{cāpa}, then read \textbf{\te{మెడ}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{ekkuva}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{ekkuva}, then \emph{koñcem}, and say them as a pair
  \item \emph{Recall:} read \textbf{\te{బుట్ట}}, then say \emph{vīpu}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{takkuva}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{takkuva}, then \emph{ekkuva}, and say which one climbs
  \item \emph{Recall:} say \emph{katti}, then read \textbf{\te{పెదవి}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vaddu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{vaddu}, then \emph{vaddaṇḍi}, and say which one you would use with a stranger
  \item \emph{Recall:} read \textbf{\te{గిన్నె}}, then say \emph{gōru}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{antē}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then refuse a second helping with \emph{vaddu}, \emph{antē}
  \item \emph{Recall:} say \emph{peṭṭe}, then read \textbf{\te{ఎముక}} and say what it means
\end{itemize}
