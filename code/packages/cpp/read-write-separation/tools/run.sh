#!/bin/sh
# Build and run the read-write-separation tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp read_write_separation-tests tests/read_write_separation_test.cpp
