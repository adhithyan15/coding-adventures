...
Audit base: `cd73f3ad86` (2026-09-05); corpus counts updated for VM-047b, VM-057, VM-047c, VM-039b, VM-061 and VM-042. This is an inventory of the implemented
...
The normal non-ALGOL capstone therefore declares 210 programs and 1551
...
host with `erl` now reports 1341 exercised + 210 skipped = 1551; the three
new cells are exercised, not skipped, since `erl` was present when they were
...
again — VM-042's own Brainfuck change updated both the test's expected tuple
and this row together, exactly as that test's own doc comment requires. ALGOL
