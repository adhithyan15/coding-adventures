...
% canonical-source-hash: fnv1a64:cd0d9cdb45286562
...
\begin{itemize}
\raggedright
  \item \textbf{cover} the model;
  \item \textbf{wait} five seconds;
  \item \textbf{write} the word once from memory;
  \item \textbf{uncover} \emph{salut}, compare, and repair only the place that differs.
\end{itemize}
