...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} You can greet, ask \emph{tudo bem?}, and reply. Now close the conversation. The Portuguese goodbye is \textbf{adeus} — and it's a tiny prayer: \textbf{\textquotedblleft{}to God.\textquotedblright{}}
\end{quote}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} The everyday Portuguese goodbye isn't \emph{adeus} (that's a bit final) — it's \textbf{até logo}, \textquotedblleft{}until soon.\textquotedblright{} And its first word carries the same surprise Spanish's \emph{hasta} does: it came from \textbf{Arabic}.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}até logo\textquotedblright{} — \emph{ah-TEH LOH-goo}{]}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}até amanhã\textquotedblright{} — \emph{ah-TEH ah-mah-NYÃ}, nasal ending{]}
  \item {[}YOU SAY: amanhã / mañana / domani — three children of \emph{māne}, \textquotedblleft{}morning\textquotedblright{}{]}
  \item {[}YOU SAY: Portuguese \emph{nh} = Spanish \emph{ñ} = the \emph{ny} sound{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What does \emph{amanhã} come from, and literally mean? (\emph{Ad māneāna} — \textquotedblleft{}to the morning.\textquotedblright{}) How does Portuguese spell the \emph{ny} sound that Spanish writes as \emph{ñ}? (As \emph{nh}.) Next: \textquotedblleft{}see you soon\textquotedblright{} — \textbf{até breve}.
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} The last of the \emph{até} goodbyes: \textbf{até breve}, \textquotedblleft{}until soon\textquotedblright{} — literally \textquotedblleft{}until {[}a{]} \emph{short} {[}while{]}.\textquotedblright{} \emph{Breve} is a word English wears in several coats.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}até breve\textquotedblright{} — \emph{ah-TEH BREH-vee}{]}
  \item {[}YOU SAY: \textquotedblleft{}breve\textquotedblright{} then English \textquotedblleft{}brief, brevity, abbreviate\textquotedblright{} — one root{]}
  \item {[}YOU SAY: the three \emph{até} goodbyes — até logo / até amanhã / até breve{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What does \emph{breve} mean, and its English cousins? (\textquotedblleft{}Short\textquotedblright{} — brief, brevity, abbreviate.) So \emph{até breve} literally says? (\textquotedblleft{}Until a short while\textquotedblright{} $\to$ see you soon.) Next: put the Portuguese goodbyes together.
\end{tcolorbox}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: greet, ask, and close — \textquotedblleft{}Olá! Tudo bem? … Até amanhã!\textquotedblright{}{]}
