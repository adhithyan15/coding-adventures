# Build and run the range-coder tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name range_coder-tests -Sources @("tests\range_coder_test.cpp")
