...
```python
from coding_adventures_cas import ContentAddressableStore, LocalDiskStore
...
```python
from coding_adventures_cas import BlobStore, ContentAddressableStore
...
This is a port of the Rust `coding-adventures-cas` package. Key differences:
