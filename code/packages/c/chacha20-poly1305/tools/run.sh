#!/bin/sh
# Build and run the chacha20-poly1305 tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c chacha20_poly1305-tests tests/chacha20_poly1305_test.c src/chacha20_poly1305.c
