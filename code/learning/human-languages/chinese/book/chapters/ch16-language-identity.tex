...
\hlblockfigure{\detokenize{figures/ZH-W16-han-observe-filmstrip.pdf}}{How \zh{汉} is written, stroke by stroke}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/ZH-W16-yu-observe-filmstrip.pdf}}{How \zh{语} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listening:} hear the three words in mixed order and choose each meaning.
  \item \textbf{Speaking:} produce all three from meaning cards, with tones audible.
  \item \textbf{Reading:} read \textbf{\zh{字}, \zh{汉语}, \zh{汉字}} cold and give each meaning.
  \item \textbf{Writing:} hear \textbf{Chinese character} and \textbf{Chinese language}, then write both without a model.
\end{enumerate}
