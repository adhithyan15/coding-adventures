# Build and run the ldp-format tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name ldp_format-tests -Sources @("tests\ldp_format_test.c", "src\ldp_format.c")
