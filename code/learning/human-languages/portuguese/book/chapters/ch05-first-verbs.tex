...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}falar\textquotedblright{} — \emph{fah-LAR}{]}
  \item {[}YOU SAY: \textquotedblleft{}falo, falas, fala\textquotedblright{} — no \emph{eu} needed{]}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} A second \textbf{-ar} verb — and a distinctive Portuguese choice. Where its sisters say \textquotedblleft{}live\textquotedblright{} with \emph{habitāre} (\textquotedblleft{}keep having a place\textquotedblright{}), everyday Portuguese uses \textbf{morar} — from a verb that means to \textbf{linger}.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}morar\textquotedblright{} — \emph{moh-RAR}{]}
  \item {[}YOU SAY: \textquotedblleft{}moro, moras, mora\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}Onde você mora?\textquotedblright{} — \textquotedblleft{}Where do you live?\textquotedblright{}; \textquotedblleft{}morar\textquotedblright{} $\leftrightarrow$ \emph{moratorium}{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What Latin verb is \emph{morar} from, and what did it mean? (\emph{morārī} — \textquotedblleft{}to delay / linger.\textquotedblright{}) English cousins? (\emph{Moratorium}, \emph{demur}.) Say \textquotedblleft{}I live in Lisbon.\textquotedblright{} (\emph{Moro em Lisboa.}) Next: \textbf{trabalhar}, \textquotedblleft{}to work.\textquotedblright{}
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} A third \textbf{-ar} verb — and Portuguese rejoins its Iberian sister on the darkest etymology in the curriculum. \textbf{trabalhar} (\textquotedblleft{}to work\textquotedblright{}), like Spanish \emph{trabajar}, began as a word for \textbf{torture}.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}trabalhar\textquotedblright{} — \emph{tra-ba-LYAR}{]}
  \item {[}YOU SAY: \textquotedblleft{}trabalho, trabalhas, trabalha\textquotedblright{}{]}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} The payoff: you take a \textbf{verb} you conjugated and a \textbf{noun}, and build a sentence no one handed you — \emph{Falo português}, \textquotedblleft{}I speak Portuguese.\textquotedblright{} (\emph{Falo} covers both \textquotedblleft{}I speak\textquotedblright{} and \textquotedblleft{}I'm speaking.\textquotedblright{})
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}Falo português\textquotedblright{} — \emph{FAH-loo por-too-GESH}{]}
  \item {[}YOU SAY: drop the \emph{eu} — Portuguese doesn't need it{]}
  \item {[}YOU SAY: \textquotedblleft{}português\textquotedblright{} $\leftarrow$ \emph{Portus Cale}, a single harbour town that named a nation{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} Where does \emph{português} come from? (\emph{Portus Cale}, a port at the Douro's mouth $\to$ Porto.) In \emph{Falo português}, why no \emph{eu} and no article? (The \emph{-o} is \textquotedblleft{}I\textquotedblright{}; languages take no article.) Which three of the five languages drop the pronoun? (Spanish, Portuguese, Italian.) Next: practice.
\end{tcolorbox}
...
\raggedright
  ...
  \item {[}YOU SAY: chain it — \textquotedblleft{}Olá! Falo português. Você fala português? … Até logo!\textquotedblright{}{]}
\end{itemize}

{[}REPEAT x2{]} \textquotedblleft{}Você fala português? — Falo um pouco.\textquotedblright{}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What are the three singular \emph{-ar} endings? (\emph{-o / -as / -a}.) Give the \textquotedblleft{}I\textquotedblright{} forms of the three verbs. (\emph{Falo, moro, trabalho}.) \emph{falar} vs Spanish \emph{hablar} — what's the sound-law difference? (Portuguese kept \emph{f-}; Spanish shifted \emph{f$\to$h}.) All five of your languages now move in real sentences — the course has handed over rules, not phrases.
\end{tcolorbox}
