...
% canonical-source-hash: fnv1a64:1b3fd812e6b54f96
...
\subsection*{Script}
\hlblockfigure{\detokenize{figures/MW-W05-na-filmstrip.pdf}}{How \mw{न} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item hear the line and point to the person naming themself
  \item say the line once with \emph{rām}
  \item read the four groups without romanization
\end{enumerate}
