...
% canonical-source-hash: fnv1a64:905e166e0b2fc66c
...
\raggedright
  ...
  \item \emph{Say it:} \emph{saṛak}, the thing you set out along
  \item \emph{Recall:} say \emph{gāy}, then read \textbf{\hi{सूरज}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{gā̃v}, and feel the nasal where the \emph{m} used to be
  \item \emph{Recall:} say \emph{ghoṛā}, then read \textbf{\hi{चाँद}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{bāzār}, on the \emph{saṛak}
  \item \emph{Recall:} say \emph{machhlī}, then read \textbf{\hi{तारा}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{dukān}, in the \emph{bāzār}
  \item \emph{Recall:} say \emph{chiṛiyā}, then read \textbf{\hi{बादल}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{khet}, \emph{gā̃v}, \emph{saṛak}, \emph{bāzār}, \emph{dukān} — walk it in order
  \item \emph{Recall:} say \emph{bakrī}, then read \textbf{\hi{आसमान}}
\end{itemize}
