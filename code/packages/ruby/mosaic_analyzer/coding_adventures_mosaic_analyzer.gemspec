...
require_relative "lib/coding_adventures/mosaic_analyzer/version"

Gem::Specification.new do |spec|
  spec.name          = "coding_adventures_mosaic_analyzer"
  spec.version       = CodingAdventures::MosaicAnalyzer::VERSION
  spec.authors       = ["Adhithya Rajasekaran"]
  spec.summary       = "Validates the Mosaic AST and produces a typed MosaicIR"
