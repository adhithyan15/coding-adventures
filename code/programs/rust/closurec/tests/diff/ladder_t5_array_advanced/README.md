# ladder_t5_array_advanced

Rung 5.array of the CCR-066 differential complexity ladder, at `ADVANCED`.

## What this rung is for

Exercises an array literal and an index read.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t5_array_advanced/input/a.js
```
...
closurec does not propagate a single-use array literal into its use site and eliminate the binding (CCR-068).
