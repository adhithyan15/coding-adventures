# Build and run the b-plus-tree tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name b_plus_tree-tests -Sources @("tests\b_plus_tree_test.cpp")
