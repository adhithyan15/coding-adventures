#!/bin/sh
# Build and run the activation-functions tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c activation_functions-tests tests/activation_functions_test.c src/activation_functions.c
