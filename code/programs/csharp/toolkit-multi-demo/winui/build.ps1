...
#
# Driver for the Button WinUI 3 host project. Regenerates the per-component
...
$proj = Join-Path $PSScriptRoot "Button.csproj"
...
if ($Run) {
    ...
    $exe = Join-Path $PSScriptRoot "bin\x64\Debug\net9.0-windows10.0.19041.0\win-x64\Button.exe"
