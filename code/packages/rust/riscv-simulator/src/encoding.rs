...
pub fn encode_addi(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_ADDI, OPCODE_OP_IMM)
}
pub fn encode_slti(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_SLTI, OPCODE_OP_IMM)
}
pub fn encode_sltiu(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_SLTIU, OPCODE_OP_IMM)
}
pub fn encode_xori(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_XORI, OPCODE_OP_IMM)
}
pub fn encode_ori(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_ORI, OPCODE_OP_IMM)
}
pub fn encode_andi(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_ANDI, OPCODE_OP_IMM)
}
...
pub fn encode_add(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_ADD, FUNCT7_NORMAL)
}
pub fn encode_sub(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_ADD, FUNCT7_ALT)
}
pub fn encode_mul(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_MUL, FUNCT7_M)
}
pub fn encode_mulhu(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_MULHU, FUNCT7_M)
}
pub fn encode_div(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_DIV, FUNCT7_M)
}
pub fn encode_divu(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_DIVU, FUNCT7_M)
}
pub fn encode_rem(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_REM, FUNCT7_M)
}
pub fn encode_remu(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_REMU, FUNCT7_M)
}
pub fn encode_sll(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_SLL, FUNCT7_NORMAL)
}
pub fn encode_slt(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_SLT, FUNCT7_NORMAL)
}
pub fn encode_sltu(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_SLTU, FUNCT7_NORMAL)
}
pub fn encode_xor(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_XOR, FUNCT7_NORMAL)
}
pub fn encode_srl(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_SRL, FUNCT7_NORMAL)
}
pub fn encode_sra(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_SRL, FUNCT7_ALT)
}
pub fn encode_or(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_OR, FUNCT7_NORMAL)
}
pub fn encode_and(rd: u32, rs1: u32, rs2: u32) -> u32 {
    encode_r_type(rd, rs1, rs2, FUNCT3_AND, FUNCT7_NORMAL)
}

pub fn encode_lb(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_LB, OPCODE_LOAD)
}
pub fn encode_lh(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_LH, OPCODE_LOAD)
}
pub fn encode_lw(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_LW, OPCODE_LOAD)
}
pub fn encode_lbu(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_LBU, OPCODE_LOAD)
}
pub fn encode_lhu(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, FUNCT3_LHU, OPCODE_LOAD)
}
...
pub fn encode_sb(rs2: u32, rs1: u32, imm: i32) -> u32 {
    encode_s_type(rs2, rs1, imm, FUNCT3_SB)
}
pub fn encode_sh(rs2: u32, rs1: u32, imm: i32) -> u32 {
    encode_s_type(rs2, rs1, imm, FUNCT3_SH)
}
pub fn encode_sw(rs2: u32, rs1: u32, imm: i32) -> u32 {
    encode_s_type(rs2, rs1, imm, FUNCT3_SW)
}
...
pub fn encode_jalr(rd: u32, rs1: u32, imm: i32) -> u32 {
    encode_i_type(rd, rs1, imm, 0, OPCODE_JALR)
}

pub fn encode_lui(rd: u32, imm: u32) -> u32 {
    ((imm & 0xFFFFF) << 12) | (rd << 7) | OPCODE_LUI
}
pub fn encode_auipc(rd: u32, imm: u32) -> u32 {
    ((imm & 0xFFFFF) << 12) | (rd << 7) | OPCODE_AUIPC
}

pub fn encode_ecall() -> u32 {
    OPCODE_SYSTEM
}
pub fn encode_mret() -> u32 {
...
pub fn encode_csrrw(rd: u32, csr: u32, rs1: u32) -> u32 {
    encode_csr(rd, csr, rs1, FUNCT3_CSRRW)
}
pub fn encode_csrrs(rd: u32, csr: u32, rs1: u32) -> u32 {
    encode_csr(rd, csr, rs1, FUNCT3_CSRRS)
}
pub fn encode_csrrc(rd: u32, csr: u32, rs1: u32) -> u32 {
    encode_csr(rd, csr, rs1, FUNCT3_CSRRC)
}
