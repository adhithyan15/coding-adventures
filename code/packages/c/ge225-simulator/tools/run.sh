#!/bin/sh
# Build and run the ge225-simulator tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c ge225_simulator-tests tests/ge225_simulator_test.c src/ge225_simulator.c
