...
finite literal `+`, `-`, `*`, or `/` arithmetic and exact tracked local scalar
snapshots before feeding another pure built-in bounded exponent. The selector
still executes; uninitialized or global snapshots, non-finite results,
