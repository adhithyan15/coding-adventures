...
% canonical-source-hash: fnv1a64:61575b04ea12ba13
...
\section[divasam]{\ml{ദിവസം} (divasam) — the everyday Sanskrit day-word}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}divasam\textquotedblright{} — \textquotedblleft{}day,\textquotedblright{} the everyday counting word
  \item \emph{Say it:} \textquotedblleft{}dinam\textquotedblright{} — the same Sanskrit word as Kannada's dina, but formal here
  \item \emph{Recall:} say \emph{pāthirā}, then read \textbf{\ml{മണി}}
\end{itemize}
