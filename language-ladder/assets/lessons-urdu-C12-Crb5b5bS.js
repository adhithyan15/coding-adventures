...
reviews_of: [UR-C12-pani, UR-C09-bhai]
---

# چائے — "tea," which walked to Urdu rather than sailed
...
<!-- hl-knowledge: introduces=[UR-LEX-CHAI]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[]; assesses=[UR-SCRIPT-HAMZA-YE] -->
...
southern coastal Chinese, which is why English says **tea** and French
says *thé* instead of *chai*. One drink, two words, sorted by whether it
...
headword: دودھ
romanization: dūdh
gloss: milk — a sixth letter learns to breathe, and an English cousin that is NOT the word you'd guess
concept_tag: UR-MILK
prerequisites: [UR-C12-chai]
sounds: [rtl, long-u, do-chashmi-he]
roots: [sanskrit-dugdha, pie-dheugh]
etymology_hook: dudh continues Sanskrit dugdhá, "milked," from Proto-Indo-European *dhewgh- "to be fit, to yield, to produce" -- the same root gives Sanskrit duh-, "to milk," and English doughty, "brave, capable"; it does NOT give English dough, which comes from the unrelated PIE root *dheigh-, "to knead, to form" -- a tempting false match worth naming precisely so it is not repeated.
duration:
  max_seconds: 280
requires:
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C12-chai]
---

# دودھ — "milk," and a false friend worth naming before you fall for it

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-CHAI, UR-ETYMON-CHAI-SILKROAD, UR-SCRIPT-DO-CHASHMI-HE] -->

[PAUSE 2s] Say **merī chāy** — my tea, which walked overland from China
through Persian before reaching Urdu. This word is what turns it milky, and
it hands the two-eyed **ھ** a sixth letter to aspirate.

## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-DOODH]; assesses=[] -->
...
## The letters in this word
<!-- hl-knowledge: introduces=[]; assesses=[UR-SCRIPT-DO-CHASHMI-HE] -->
...
<!-- hl-knowledge: introduces=[UR-ETYMON-DOODH-DOUGHTY]; assesses=[UR-LEX-DOODH] -->

**dūdh** continues Sanskrit *dugdhá*, literally "milked," from
Proto-Indo-European **\\*dʰewgʰ-**, "to be fit, to yield, to produce." That
root also gives Sanskrit **duh-**, "to milk" — the verb sitting directly
under this noun.

Here is the trap. English **dough** looks like the obvious match, and it
is **not**: *dough* comes from a completely different PIE root,
**\\*dʰeigʰ-**, "to knead, to form" — the root behind the shape of bread,
not the substance of milk. The real English cousin of **دودھ** is a
quieter word: **doughty**, "brave, capable," from the very same
**\\*dʰewgʰ-**, "fit for, of use." A doughty person and milked milk share an
ancestor; bread dough does not.
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-DOODH, UR-ETYMON-DOODH-DOUGHTY] -->
<!-- hl-activity: {"id":"UR-C12-doodh-false-friend","kind":"text","assesses":["UR-ETYMON-DOODH-DOUGHTY"],"prompt":"Which English word is the REAL cousin of دودھ — dough, or doughty?","answer":"doughty","accepted":["doughty, not dough"],"feedback":{"correct":"Right: doughty, from *dʰewgʰ-. Dough is from an unrelated root, *dʰeigʰ-.","incorrect":"It's doughty, not dough — dough comes from a different, unrelated PIE root."},"response_seconds":9} -->

[PAUSE 3s] Which English word looks like a match for **دودھ** but is not
one? (**Dough.**) Which English word actually is the cousin? (**Doughty.**)
What Sanskrit verb sits directly under **دودھ**? (**duh-, "to milk."**)

Sources: [Wiktionary: دودھ](https://en.wiktionary.org/wiki/%D8%AF%D9%88%D8%AF%DA%BE); [Etymonline: doughty](https://www.etymonline.com/word/doughty).
`,a=e({default:()=>o}),o=`---
schema_version: 2
id: UR-C12-pani
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C11-dil, UR-C08-lena]
---

# پانی — "water," and لینا put back to work

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-DIL, UR-ETYMON-DIL-HEART-PIE, UR-LEX-LENA, UR-GRAMMAR-NA-INFINITIVE] -->

[PAUSE 2s] Say **merā dil** — my heart, closing the body words, and recall
that its PIE root reached Urdu by the Persian road while the same root
reached Sanskrit's *hṛdaya* by a different one. This chapter turns to the
four things you would actually ask for. **لینا**, "to take," from three
chapters back, gets its first real use since it was taught.

## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-PANI]; assesses=[] -->
...
transitive verb does. You already hold the whole verb; **پانی** is the
first noun you have had to put in front of it.

## The word, taken apart — a drink-word, not a water-word
<!-- hl-knowledge: introduces=[UR-ETYMON-PANI-DRINK]; assesses=[UR-LEX-PANI] -->

**pānī** continues Sanskrit *pānīya*, "water, drink," built on
**pā-**, "to drink," from Proto-Indo-European **\\*peh₃-**. English
**water** is unrelated — it comes from an entirely different PIE root.
But *\\*peh₃-* itself did reach English, by a different door: Latin
*potare*, "to drink," gave English **potion** and, by way of a sense
narrowed to "a poisoned drink," **poison**. **پانی** is, underneath, "the
drinkable thing" — the same idea English kept for what you drink, not for
...
[PAUSE 3s] Is **پانی** related to English **water**? (**No.**) Name two
English words that do share its root. (**Potion** and **poison**.) Say "I
take/get water," once as a man would, once as a woman would.

Sources: [Wiktionary: پانی](https://en.wiktionary.org/wiki/%D9%BE%D8%A7%D9%86%DB%8C).
`,s=e({default:()=>c}),c=`---
schema_version: 2
id: UR-C12-roti
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
headword: روٹی
romanization: roṭī
gloss: bread — an honest dead end, and پسند put back to work on everything this chapter taught
concept_tag: UR-BREAD
prerequisites: [UR-C12-doodh]
sounds: [rtl, retroflex-t, long-i]
roots: [sanskrit-rotika]
etymology_hook: roti continues Sauraseni Prakrit rotta-, from Sanskrit roṭikā, "a kind of bread," built inside Sanskrit itself on a root meaning "to strike, to crush" -- the pounding and rolling that makes flatbread -- with no further Indo-European ancestry behind that root, the same honest stop paṭh- and karṇa hit earlier.
duration:
  max_seconds: 290
requires:
...
## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-ROTI]; assesses=[] -->
...
## The word, taken apart — another honest dead end
<!-- hl-knowledge: introduces=[UR-ETYMON-ROTI-STRIKE]; assesses=[UR-LEX-ROTI] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-ROTI, UR-ETYMON-ROTI-STRIKE, UR-GRAMMAR-DATIVE-EXPERIENCER, UR-LEX-DOODH, UR-LEX-PANI, UR-LEX-CHAI] -->

- [YOU SAY: **roṭī** — bread; then **merī roṭī**]
- [YOU SAY: **mujhe roṭī pasand hai**, then swap in **pānī**, then
  **dūdh**]
- [YOU SORT: inherited — **pānī, dūdh, roṭī**; Persian — **chāy**]
- [YOU SAY: all four foods with **merā** or **merī** correctly chosen]
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C13-safed]
---

# کالا — "black," and the first color that agrees
...
## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-KALA]; assesses=[] -->
...
it reached Urdu. Inherited from Sanskrit, yes — but Sanskrit's own source
sits outside the Indo-European family this book has been tracing.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-KALA, UR-ETYMON-KALA-DRAVIDIAN, UR-GRAMMAR-ADJECTIVE-AGREEMENT, UR-LEX-SAFED] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-KALA, UR-GRAMMAR-ADJECTIVE-AGREEMENT, UR-ETYMON-KALA-DRAVIDIAN, UR-GRAMMAR-KHUDA-HAFIZ-ELLIPSIS, UR-PRAGMATICS-RESPECTFUL-GENDER-CHOICE] -->
...
Sources: [Wiktionary: کالا](https://en.wiktionary.org/wiki/%DA%A9%D8%A7%D9%84%D8%A7).
`,d=e({default:()=>f}),f=`---
schema_version: 2
id: UR-C13-lal
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C12-roti]
---

# لال — "red," and a word that never changes shape
...
## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-LAL]; assesses=[] -->
...
**لال** ends in a consonant, not in **ا**. That matters: it stays **لال**
whether the thing it describes is masculine or feminine, singular or
plural. *merā kamīz lāl hai*, *merī ṭopī lāl hai* — same word, no change.
Not every color in this book will be this simple.
...
[PAUSE 3s] What does **لال** mean, and which layer does it belong to —
...
Sources: [Wiktionary: لال](https://en.wiktionary.org/wiki/%D9%84%D8%A7%D9%84).
`,p=e({default:()=>m}),m=`---
schema_version: 2
id: UR-C13-nila
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C13-kala, UR-C13-safed, UR-C13-lal]
---

# نیلا — "blue," and this book's fourth color closes the set

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-KALA, UR-GRAMMAR-ADJECTIVE-AGREEMENT, UR-LEX-LAL] -->

[PAUSE 2s] Recall **کالا**/**کالی**, the color that agrees, against
**لال**, the color that never does. This chapter's last word decides which
kind it is, then does something none of the other three managed: it left
Urdu again, centuries later, and became an English word.

## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-NILA]; assesses=[] -->
...
## The word, taken apart — a dead end, and then a long way forward
<!-- hl-knowledge: introduces=[UR-ETYMON-NILA-ANILINE]; assesses=[UR-LEX-NILA, UR-LEX-SAFED] -->

**نیلا** comes from Sanskrit *nīla*, "dark blue." No further root
is documented behind it — an honest dead end backward, unlike **کالا**'s
root, which kept going sideways into Dravidian.

But Sanskrit's related word **nīlī**, "the indigo plant," did not stop
...
Sources: [Wiktionary: نیلا](https://en.wiktionary.org/wiki/%D9%86%DB%8C%D9%84%D8%A7), [Etymonline: aniline](https://www.etymonline.com/word/aniline).
`,h=e({default:()=>g}),g=`---
schema_version: 2
id: UR-C13-safed
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
headword: سفید
romanization: safed
gloss: white — Persian, and a real cousin of English white by the Iranian road, the same shape as دل and hṛdaya
concept_tag: UR-WHITE
prerequisites: [UR-C13-lal]
sounds: [rtl, short-vowels-unwritten]
roots: [middle-persian-sped, pie-kweyt]
etymology_hook: safed continues Middle Persian spēt, from Old Iranian *spaita-, from Proto-Indo-Iranian *ćwaytás, from Proto-Indo-European *ḱweyt- "to shine, white." That is the exact same root behind Sanskrit śvetá and, through Proto-Germanic, English white -- so safed and śvetá are two roads from one root, the same shape as دل and hṛdaya, and this time English is family too.
duration:
  max_seconds: 280
requires:
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C13-lal, UR-C08-puchhna]
---

# سفید — "white," and English joins the family this time

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-LAL, UR-ETYMON-LAL-PERSIAN] -->

[PAUSE 2s] Recall **لال** — red, Persian, and a dead end. This word is also
Persian, also ends in a consonant, and also never changes shape. But its
root does not stop where **لال**'s did.

## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-SAFED]; assesses=[] -->
...
## The word, taken apart — one root, and English is in it this time
<!-- hl-knowledge: introduces=[UR-ETYMON-SAFED-WHITE-PIE]; assesses=[UR-LEX-SAFED, UR-REGISTER-TWO-ROADS-ONE-ROOT] -->

**سفید** continues Middle Persian *spēt*, from Old Iranian **\\*spaita-**,
from Proto-Indo-Iranian **\\*ćwaytás**, from Proto-Indo-European
**\\*ḱweyt-**, "to shine, white." That is the **exact same root** behind
Sanskrit **śvetá**, "white" — so **سفید** and Sanskrit's word for white
split at the Indo-Iranian fork, one road east into Sanskrit, one road west
into Iranian and then Urdu, the same shape as **دل** and *hṛdaya* two
chapters back.
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-SAFED, UR-ETYMON-SAFED-WHITE-PIE, UR-REGISTER-TWO-ROADS-ONE-ROOT, UR-LEX-LAL] -->

- [YOU SAY: **safed** — white; then **merī ṭopī safed hai**]
- [YOU CONTRAST: **لال** — Persian, dead end; **سفید** — Persian, and the
  root keeps going]
- [YOU TRACE: **safed** ← Middle Persian ← PIE *\\*ḱweyt-* → Sanskrit
  **śvetá** → English **white**]
- [YOU SAY: one root, three roads this time, not two]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-SAFED, UR-ETYMON-SAFED-WHITE-PIE, UR-CROSSLINGUAL-THIK, UR-DIALOGUE-TAKE-LEAVE] -->
...
headword: جوتا
romanization: jūtā
gloss: shoe — inherited, and a real cousin of English yoke, and of Sanskrit's own yoga
concept_tag: UR-SHOE
prerequisites: [UR-C14-qamiz]
sounds: [rtl, long-u, te-dots-vs-tte-loop]
roots: [sanskrit-yukta, pie-yewg]
etymology_hook: jūtā continues Sauraseni Prakrit jutta, "joined," from Sanskrit yukta ("joined, yoked"), from Proto-Indo-European *yewg- "to yoke." That root also gives English yoke directly, and gives Sanskrit its own word yoga -- so jūtā, yoke, and yoga are three words from one root, each keeping a different piece of the old meaning "joined."
duration:
  max_seconds: 280
requires:
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C14-qamiz]
---

# جوتا — "shoe," a cousin of yoke, and a cousin of yoga too
...
## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-JUTA]; assesses=[] -->

> **جوتا** — *jūtā* — **shoe**

> **میرا جوتا کالا ہے۔** — *merā jūtā kālā hai.* — "My shoe is black."

**جوتا** is masculine — that is why **کالا** stays **کالا** here rather
than becoming **کالی**.

## The letters in this word
<!-- hl-knowledge: introduces=[UR-SCRIPT-TE-VS-TTE]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[UR-ETYMON-JUTA-YOKE]; assesses=[UR-LEX-JUTA] -->

**jūtā** continues Sauraseni Prakrit *jutta*, "joined," from Sanskrit
*yukta*, "joined, yoked," from Proto-Indo-European
**\\*yewg-**, "to yoke." That root gives English **yoke** directly, the
wooden bar that joins two oxen. It also gives Sanskrit its own word
**yoga** — literally "a joining, a yoking" — the same root, kept inside
one language this time rather than split across two. **جوتا** keeps the
oldest, plainest sense: a thing joined onto the foot.
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C14-topi, UR-C14-juta, UR-C14-qamiz]
---

# کوٹ — "coat," and every direction a loan can travel
...
## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-KOAT]; assesses=[] -->
...
## The word, taken apart — a third layer, and every direction covered
<!-- hl-knowledge: introduces=[UR-REGISTER-ENGLISH-LAYER]; assesses=[UR-LEX-KOAT] -->

**کوٹ** is borrowed directly from English **coat** — a modern loan, one
generation old rather than a thousand years. It happens to look identical
to an older, unrelated **کوٹ** meaning "fort," inherited from Sanskrit
*koṭṭa* — the two are homographs, not cousins, and the spelling gives no
warning either way.

This book has named two layers before now: the inherited Indo-Aryan core,
and the Persian-Arabic literary layer borrowed centuries ago. **کوٹ** is
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-KOAT, UR-REGISTER-ENGLISH-LAYER, UR-LEX-TOPI, UR-LEX-JUTA, UR-LEX-QAMIZ] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-KOAT, UR-REGISTER-ENGLISH-LAYER, UR-LEX-KHUDA-HAFIZ, UR-PRAGMATICS-STANDARD-FAREWELL, UR-LEX-WELLBEING-REPLY] -->

[PAUSE 3s] What does **کوٹ** mean, and where does it come from? (**Coat**;
...
headword: قمیض
romanization: qamīz
gloss: shirt — Arabic, and probably the very same word English borrowed as chemise, by a completely different road
concept_tag: UR-SHIRT
prerequisites: [UR-C13-nila]
sounds: [rtl, short-vowels-unwritten, qaf-uvular]
roots: [arabic-qamis, latin-camisia, pie-kam]
etymology_hook: qamīz is borrowed from Classical Persian qamīs, from Arabic qamīṣ, probably from Latin camisia, from Proto-West Germanic *hamiþi, from Proto-Indo-European *ḱam- "cover, clothes." That same Latin camisia gives French chemise and English chemise -- so قمیض and chemise are very likely the same word, one arriving through Arabic and Persian, the other through French, both eventually landing in the same wardrobe.
duration:
  max_seconds: 290
requires:
  knowledge: [UR-LEX-NILA, UR-ETYMON-NILA-ANILINE]
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C13-nila]
---

# قمیض — "shirt," and a word that meets its English cousin in a wardrobe

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-NILA, UR-ETYMON-NILA-ANILINE] -->

[PAUSE 2s] Recall **نیلا**'s long trip forward into English **aniline**.
This lesson opens a new chapter — four things you wear — and its first
word makes an even stranger connection than blue did.

## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-QAMIZ]; assesses=[] -->

> **قمیض** — *qamīz* — **shirt**

> **میری قمیض نیلی ہے۔** — *merī qamīz nīlī hai.* — "My shirt is blue."

**قمیض** is feminine — that is why **نیلا** becomes **نیلی** here.

## The letters in this word
<!-- hl-knowledge: introduces=[UR-SCRIPT-QAMIZ-LETTERS]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[UR-ETYMON-QAMIZ-CHEMISE]; assesses=[UR-LEX-QAMIZ] -->

**قمیض** is borrowed from Classical Persian *qamīs*, from Arabic
**qamīṣ**, probably from Latin **camisia**, from Proto-West Germanic
**\\*hamiþi**, from Proto-Indo-European **\\*ḱam-**, "cover, clothes." That
same Latin **camisia** also gives French **chemise**, borrowed straight
into English as **chemise**. Two roads out of one Late Latin word: one
east through Arabic and Persian into Urdu, one north through French into
English — and both landed, centuries later, meaning a piece of clothing
worn on the upper body.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-QAMIZ, UR-ETYMON-QAMIZ-CHEMISE, UR-SCRIPT-QAMIZ-LETTERS, UR-LEX-NILA] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-QAMIZ, UR-ETYMON-QAMIZ-CHEMISE, UR-SCRIPT-QAMIZ-LETTERS, UR-GRAMMAR-AAP-KA] -->

[PAUSE 3s] What does **قمیض** mean, and is it masculine or feminine?
(**Shirt**; **feminine**.) Which English word probably shares **قمیض**'s
Latin source? (**Chemise.**) What does **آپ کا نام کیا ہے؟**
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C14-juta]
---

# ٹوپی — "cap," a dead end behind it, a loan ahead of it
...
## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-TOPI]; assesses=[] -->
...
**ٹوپی** is inherited from Sauraseni Prakrit *ṭopiā*, "helmet," related to
Sanskrit *ṭopikā*. No further root is documented behind that — another
honest dead end, like **روٹی** and **کان**.

But **ٹوپی** did something those two never did: it left Urdu and Hindi and
...
[PAUSE 3s] What does **ٹوپی** mean, and is it masculine or feminine?
...
Sources: [Wiktionary: ٹوپی](https://en.wiktionary.org/wiki/%D9%B9%D9%88%D9%BE%DB%8C), [Dictionary.com: topee](https://www.dictionary.com/browse/topee).
