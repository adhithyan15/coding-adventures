...
//
// It has now moved once, as designed: 69 -> 64, when Telugu chapters 1-5 were
// retired into the generator. That flip is the ONE edit this literal is here to
// force somebody to make consciously, and it was made only after
// `handwritten_parity.py --check telugu` exited 0 with those five chapters
// still hand-written — i.e. after the prose they held had been carried into the
// lessons. Lowering the number without that evidence is the exact move the
