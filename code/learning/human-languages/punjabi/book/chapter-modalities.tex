...
\expandafter\def\csname hlchaptermodality1\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (5) \quad \hlsightsign{}~\textbf{eyes} (1) \quad \hlpensign{}~\textbf{pen} (7)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 3 of 13 lessons.%
    \par}\medskip
}

\expandafter\def\csname hlchaptermodality2\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (3) \quad \hlsightsign{}~\textbf{eyes} (6)\quad
...
\expandafter\def\csname hlchaptermodality3\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (3) \quad \hlsightsign{}~\textbf{eyes} (4)\quad
...
\expandafter\def\csname hlchaptermodality4\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (3) \quad \hlsightsign{}~\textbf{eyes} (3)\quad
