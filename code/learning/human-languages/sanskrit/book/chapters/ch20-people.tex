...
% canonical-source-hash: fnv1a64:b86ce2c7ff51025b
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{naraḥ} — \textquotedblleft{}man\textquotedblright{}
  \item \emph{Say it:} \textquotedblleft{}a good man\textquotedblright{} — \emph{uttama naraḥ}
  \item \emph{Say it:} the English word built on its Greek cousin (\emph{android})
  \item \emph{Recall:} say \emph{kadā}, then read \textbf{\sk{षट्}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{nārī} — \textquotedblleft{}woman\textquotedblright{}
  \item \emph{Say it:} it against \emph{naraḥ}, and name the shared piece
  \item \emph{Say it:} the four endings you have now met
  \item \emph{Recall:} read \textbf{\sk{किमर्थम्}}, then say \emph{sapta}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{bālaḥ} — \textquotedblleft{}child\textquotedblright{}
  \item \emph{Say it:} the feminine — \emph{bālā}
  \item \emph{Say it:} the two different feminine endings you have now seen
  \item \emph{Recall:} say \emph{kati}, then read \textbf{\sk{अष्ट}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vṛddhaḥ} — \textquotedblleft{}an elder\textquotedblright{}
  \item \emph{Say it:} which of \emph{purātana} and \emph{vṛddha} you would use for a temple
  \item \emph{Say it:} what √\sk{वृध्} means (to grow)
  \item \emph{Recall:} read \textbf{\sk{कुतः}}, then say \emph{navan}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{janaḥ} — \textquotedblleft{}people\textquotedblright{}
  \item \emph{Say it:} three English words from its Latin cousin
  \item \emph{Say it:} all five people, in order
  \item \emph{Recall:} say \emph{daśa}
\end{itemize}
