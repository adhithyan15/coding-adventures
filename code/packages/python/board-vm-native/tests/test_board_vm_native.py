...
def test_known_targets_are_exposed_from_rust_registry():
    ...
    assert "network.tcp.available" in uno_r4_wifi.capabilities
    assert "network.udp" in uno_r4_wifi.capabilities
    assert "network.udp.write_bytes" in uno_r4_wifi.capabilities
    assert "network.udp.read_bytes" in uno_r4_wifi.capabilities
    ...
    assert "network.dns.set_server" in uno_r4_wifi.capabilities
    assert "network.dns.query" in uno_r4_wifi.capabilities
    assert "network.dns.response_ipv4" in uno_r4_wifi.capabilities
    assert "network.dns.exchange_udp" in uno_r4_wifi.capabilities
    assert "network.dns.exchange_udp_retry" in uno_r4_wifi.capabilities
    assert "network.dns.exchange_udp_fallback" in uno_r4_wifi.capabilities
