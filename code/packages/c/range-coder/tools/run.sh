#!/bin/sh
# Build and run the range-coder tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c range_coder-tests tests/range_coder_test.c src/range_coder.c
