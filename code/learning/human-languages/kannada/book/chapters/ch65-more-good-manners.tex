...
% canonical-source-hash: fnv1a64:51bd93a572146817
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vinanti}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{dayaviṭṭu}, then \emph{vinanti}, and say which one goes inside a sentence
  \item \emph{Recall:} say \emph{hasivu}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{anumati}, then \emph{horaḍu}, and say which one comes first
  \item \emph{Recall:} read \textbf{\kn{ನಿದ್ದೆ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{saṅkōca}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{saṅkōca}, then \emph{bēḍa}, and say what a host tells a guest
  \item \emph{Recall:} say \emph{jvara}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{nambike}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{gaurava}, then \emph{nambike}, and say which one is earned slowly
  \item \emph{Recall:} read \textbf{\kn{ನೋವು}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{saujanya}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{dhanyavāda} to close
  \item \emph{Recall:} say \emph{ārōgya}
\end{itemize}
