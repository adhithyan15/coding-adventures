#!/bin/sh
# Build and run the scytale-cipher tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c scytale_cipher-tests tests/scytale_cipher_test.c src/scytale_cipher.c
