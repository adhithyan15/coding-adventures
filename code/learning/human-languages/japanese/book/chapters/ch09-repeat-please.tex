...
% canonical-source-hash: fnv1a64:0cfc580bb7429557
...
\begin{quote}
Say the farewell from the last chapter once. Now imagine that the other person has spoken and you missed it. Do not guess; open a repair.
\end{quote}
...
\begin{quote}
Say \emph{sumimasen} once, then write known \textbf{\ja{ま}}. The new sign shares the \emph{m} opening but carries a different vowel.
\end{quote}
...
\begin{quote}
Say \emph{sumimasen, yoku wakarimasen}. Write \textbf{\ja{め}} once.
\end{quote}
