...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    expect(report.summary.neverRevisitedPercent).toBe(17); // HL-C172: +4 -- the B2 argue rung (chapter 270)
