...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 1878, // +3: HL-C97 adds the repair kit (no entiendo, mas despacio) at chapter 14 // +40: vocabulary wave 5 (persian 12, telugu 13, malayalam 15)
      ...
      voice: 1269, // +35: vocabulary wave 5, mostly ear-only lessons
      ...
      sight: 540, // +5: vocabulary wave 5's honest cousin-script citations in a handful of lessons
      ...
      drivableLessons: 1269, // +35: vocabulary wave 5
      drivablePercent: 68, // +1: vocabulary wave 5's lessons are mostly ear-only
      trackCount: 22,
      chapterCount: 674, // +15: vocabulary wave 5 (persian +3, telugu +6, malayalam +6)
      ...
      drivablePrefixTotal: 1079, // +32: vocabulary wave 5's new chapters, mostly ear-only from their own start
      ...
      fullyDrivableChapters: 453, // +6: shorter chapters are more often drivable end to end // +10: vocabulary wave 5's new chapters
      ...
      unstartableChapters: 165, // +2: two of vocabulary wave 5's new chapters need eyes from their own first lesson
      overriddenLessons: 0,
