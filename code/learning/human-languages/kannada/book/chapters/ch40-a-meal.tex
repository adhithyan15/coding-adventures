...
% canonical-source-hash: fnv1a64:a1b933219dd370b9
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}ūṭa māḍu\textquotedblright{} — to have a meal
  \item \emph{Say it:} everyday against full — \textquotedblleft{}tinnuttēne … ūṭa māḍu\textquotedblright{}
  \item \emph{Say it:} the hour and the meal — \textquotedblleft{}śubha madhyāhna … ūṭa\textquotedblright{}
  \item \emph{Say it:} the meal and the goodnight after it — \textquotedblleft{}ūṭa … śubha rātri\textquotedblright{}
  \item \emph{Say it:} this chapter's three drinks, once more — \textquotedblleft{}cahā, kāphi, hālu\textquotedblright{}
  \item \emph{Recall:} say \emph{magaḷu}
\end{itemize}
