        ...
        rules: vec![
            ...
            GrammarRule {
                ...
                body: GrammarElement::Alternation {
                    choices: vec![
                        GrammarElement::Literal {
                            value: r#"u4"#.to_string(),
                        },
                        GrammarElement::Literal {
                            value: r#"u8"#.to_string(),
                        },
                        GrammarElement::Literal {
                            value: r#"bcd"#.to_string(),
                        },
                        GrammarElement::Literal {
                            value: r#"bool"#.to_string(),
                        },
                    ],
                },
                line_number: 202,
