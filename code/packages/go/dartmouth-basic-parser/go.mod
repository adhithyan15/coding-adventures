module github.com/adhithyan15/coding-adventures/code/packages/go/dartmouth-basic-parser

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/dartmouth-basic-lexer v0.0.0
