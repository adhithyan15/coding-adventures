...
#
# Runs all 652 examples from the CommonMark 0.31.2 specification, comparing
    ...
    class TestCommonmarkSpec < Minitest::Test
      ...
      def test_spec_has_652_examples
        assert_equal 652, SPEC_EXAMPLES.length,
          "Expected 652 CommonMark 0.31.2 examples, got #{SPEC_EXAMPLES.length}"
      end
      ...
      SPEC_EXAMPLES.each do |example|
        ...
        define_method(method_name) do
          ...
          assert_equal expected, actual,
            "CommonMark spec example #{num} (#{example["section"]}) failed.\n" \
