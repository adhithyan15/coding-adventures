#!/bin/sh
# Build and run the aarch64-encoder tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c aarch64_encoder-tests tests/aarch64_encoder_test.c src/aarch64_encoder.c
