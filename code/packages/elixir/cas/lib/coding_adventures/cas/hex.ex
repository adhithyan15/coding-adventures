defmodule CodingAdventures.Cas.Hex do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> CodingAdventures.Cas.Hex.key_to_hex(<<0xda, 0x39, 0xa3, 0xee, 0x5e, 0x6b, 0x4b, 0x0d, 0x32, 0x55, 0xbf, 0xef, 0x95, 0x60, 0x18, 0x90, 0xaf, 0xd8, 0x07, 0x09>>)
  ...
  ## Examples
      ...
      iex> CodingAdventures.Cas.Hex.hex_to_key("da39a3ee5e6b4b0d3255bfef95601890afd80709")
      {:ok, <<0xda, 0x39, 0xa3, 0xee, 0x5e, 0x6b, 0x4b, 0x0d, 0x32, 0x55, 0xbf, 0xef, 0x95, 0x60, 0x18, 0x90, 0xaf, 0xd8, 0x07, 0x09>>}

      iex> CodingAdventures.Cas.Hex.hex_to_key("not-valid")
      {:error, :invalid_hex}
  """
  ...
  ## Examples
      ...
      iex> CodingAdventures.Cas.Hex.decode_hex_prefix("a3f4")
      {:ok, <<0xa3, 0xf4>>}

      iex> CodingAdventures.Cas.Hex.decode_hex_prefix("a3f")
      {:ok, <<0xa3, 0xf0>>}

      iex> CodingAdventures.Cas.Hex.decode_hex_prefix("")
      {:error, :invalid_hex}

      iex> CodingAdventures.Cas.Hex.decode_hex_prefix("zz")
      {:error, :invalid_hex}
  """
