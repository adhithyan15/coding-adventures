...
- **Ch. 16 — *sein* in the present**: ***sein*** (`GE-C16-sein`) is the one
...
- **Ch. 17 — Three verbs under one roof**: the past — *ich war*, *du warst*,
  ...
  **present** and Spanish's **past**), *war/waren* ← \**wes-* "dwell, remain"
  ...
  at. **Authored.**
- **Ch. 18 — The Perfekt built on *sein***: the same
...
- **Ch. 19 — The body: a cup for a head, and a hand with no Latin cousin**:
...
- **Ch. 26 — Verbs of the mind**: ***denken*** (`GE-C24-denken`) — the verb
  ...
  *write*; *Manuskript* closes Chapter 19's *Hand*/*manus* circle. **Authored.**
- **Ch. 27 — Taking, asking, helping, liking**: ***nehmen*** (`GE-C25-nehmen`)
...
- **Ch. 28 — Sitting, standing, sleeping, hearing**: ***sitzen***
  ...
  *session* and Greek *hédra* into *cathedral*. "Strong" is separated from "the
  vowel breaks" → ***stehen*** (`GE-C26-stehen`) — the verb Ch. 26 found inside
...
- **Ch. 29 — Going, running, opening, closing**: ***gehen*** (`GE-C27-gehen`)
  ...
  *gehen* unhurried, *rennen* flat out, *laufen* across the line — with the
  ...
  (`GE-C27-oeffnen`) — *offen* is the *open* Ch. 27 only listed; neither word is
  ...
  Ch. 27's *nehmen* story a second time. *Schloss*, *Schlüssel*, *Schluss* are
  the household German built on the verb it kept; the proposed link to Latin
  *claudere* is reported as unestablished. **Authored.**

- **Ch. 30 — Coffee, tea, and milk**: the pre-A1 vocabulary tranche's food
  ...
  *Kaffee* → ***der Tee*** (`GE-C28-tee`) — a different loan by a different
  ...
  closed beside the loanword *Wein*. Extends Ch. 21's *Wasser, bitte* pattern
  to two more drinks and rescues Ch. 29's two orphaned atoms. **Authored.**
- **Ch. 31 — Friend and family**: ***der Freund*** (`GE-C29-freund`) — the
...
- **Ch. 32 — Eyes, ears, mouth, nose**: extends Ch. 19's *Kopf*/*Hand*
  ...
  shared descent, the same *rot*/*rouge* shape as Ch. 13. Rescues Ch. 28's
  disputed "sharp-eared" *hören*/*Ohr* link. **Authored.**
- **Ch. 33 — Arm, finger, foot, heart**: completes the five-word
  Hand/Arm/Finger/Fuß/Herz comparison Ch. 19 printed but only taught a fifth
  ...
  *hören*/*akoúein* (Ch. 28) and *Hund*/*canis* (Ch. 24). **Authored.**

## Planned

| Chapter | Theme |
|---|---|
| 34+ | Cases (der→den→dem) — owed since Ch. 27 had to route around the accusative article after *mögen* and the dative object of *helfen*, and Ch. 29 had to pick *die Hand* as its object for the same reason; then the rest of the separable verbs now that Ch. 29 has opened them, sprechen & the remaining irregular verbs — following the shared theme order |
