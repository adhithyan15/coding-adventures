...
describe("the whole corpus", () => {
  ...
  it("narrates every lesson in the corpus", () => {
    ...
    expect(chapters).toHaveLength(731); // +3: HL-C113 (B1 si-condition rung) // +3: HL-C113 preterite plural // HL-C113: HL-C113 imperfect subjunctive // HL-C136 wave I: +42 lessons, +6 chapters — 'Pointing, and Asking', six deixis words and the pattern behind them, one chapter per Indic track
  });
