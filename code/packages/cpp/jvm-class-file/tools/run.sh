#!/bin/sh
# Build and run the jvm-class-file tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp jvm_class_file-tests tests/jvm_class_file_test.cpp
