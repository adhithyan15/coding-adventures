...
% canonical-source-hash: fnv1a64:4a03256dd640c9d4
...
\begin{itemize}
\raggedright
  \item \textbf{heißen} = \emph{HY-ssen}. The \textbf{ß} (\emph{Eszett}) is just a sharp \textquotedblleft{}ss.\textquotedblright{} \textbf{ei} is the vowel of English \emph{eye}. So \textbf{heiße} = \emph{HY-ssuh}.
\end{itemize}
\end{sounds}
