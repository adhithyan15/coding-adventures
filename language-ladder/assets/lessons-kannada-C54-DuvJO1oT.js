...
gloss: "a branch"
romanization: "kombe"
concept_tag: KA-NOUN-BRANCH
prerequisites: [KA-C54-tree, KA-C52-chair]
sounds: []
roots: []
duration:
  max_seconds: 210
...
introduces:
  knowledge: [KA-LEX-C54-TREE-02]
practises:
  knowledge: [KA-LEX-C53-SKY-05, KA-LEX-C54-TREE-01, KA-LEX-C54-TREE-02, KA-LEX-C52-WELCOME-02]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output]
register: neutral
variety: standard-colloquial
reviews_of: [KA-C54-tree]
---

# ಕೊಂಬೆ (kombe) — a branch

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C53-SKY-05, KA-LEX-C54-TREE-01] -->

[PAUSE 2s] Before the new one: what did *mara* mean?

## You'll want to know: ಕೊಂಬೆ
<!-- hl-knowledge: introduces=[KA-LEX-C54-TREE-02]; assesses=[] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C53-SKY-05, KA-LEX-C54-TREE-01, KA-LEX-C54-TREE-02, KA-LEX-C52-WELCOME-02] -->
...
[PAUSE 3s] What does ಕೊಂಬೆ mean? ("a branch".) Say it once more.
`,r=e({default:()=>i}),i=`---
schema_version: 2
id: KA-C54-leaf
spine_node: SPINE-EXCHANGE-NAMES
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C54-branch]
---

# ಎಲೆ (ele) — a leaf

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C54-TREE-01, KA-LEX-C54-TREE-02] -->

[PAUSE 2s] Before the new one: what did *kombe* mean?

## You'll want to know: ಎಲೆ
<!-- hl-knowledge: introduces=[KA-LEX-C54-TREE-03]; assesses=[] -->
...
[PAUSE 3s] What does ಎಲೆ mean? ("a leaf".) Say it once more.
`,a=e({default:()=>o}),o=`---
schema_version: 2
id: KA-C54-root
spine_node: SPINE-EXCHANGE-NAMES
...
[PAUSE 2s] Before the new one: what did *ele* mean?

## You'll want to know: ಬೇರು
<!-- hl-knowledge: introduces=[KA-LEX-C54-TREE-04]; assesses=[] -->
...
[PAUSE 3s] What does ಬೇರು mean? ("a root".) Say it once more.
`,s=e({default:()=>c}),c=`---
schema_version: 2
id: KA-C54-seed
spine_node: SPINE-EXCHANGE-NAMES
...
[PAUSE 2s] Before the new one: what did *bēru* mean?

## You'll want to know: ಬೀಜ
<!-- hl-knowledge: introduces=[KA-LEX-C54-TREE-05]; assesses=[] -->
...
[PAUSE 3s] What does ಬೀಜ mean? ("a seed".) Say it once more.
`,l=e({default:()=>u}),u=`---
schema_version: 2
id: KA-C54-tree
spine_node: SPINE-EXCHANGE-NAMES
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C53-cloud]
---

# ಮರ (mara) — a tree

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C53-SKY-04, KA-LEX-C53-SKY-05] -->

[PAUSE 2s] Before the new run: what did *cukki* mean, and what did *mōḍa* mean?

## You'll want to know: ಮರ
<!-- hl-knowledge: introduces=[KA-LEX-C54-TREE-01]; assesses=[] -->
...
[PAUSE 3s] What does ಮರ mean? ("a tree".) Say it once more.
`,d=e({default:()=>f}),f=`---
schema_version: 2
id: KA-C55-hill
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C55-tank]
---

# ಬೆಟ್ಟ (beṭṭa) — a hill

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C55-ROAD-01, KA-LEX-C55-ROAD-02] -->

[PAUSE 2s] Before the new one: what did *kere* mean?

## You'll want to know: ಬೆಟ್ಟ
<!-- hl-knowledge: introduces=[KA-LEX-C55-ROAD-03]; assesses=[] -->
...
[PAUSE 3s] What does ಬೆಟ್ಟ mean? ("a hill".) Say it once more.
`,p=e({default:()=>m}),m=`---
schema_version: 2
id: KA-C55-path
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
[PAUSE 2s] Before the new one: what did *haḷḷi* mean?

## You'll want to know: ದಾರಿ
<!-- hl-knowledge: introduces=[KA-LEX-C55-ROAD-05]; assesses=[] -->

**ದಾರಿ** (*dāri*) — "a way, a path".

This is the word that turns the other four into directions. ಕೆರೆಗೆ ದಾರಿ — the way to the tank — and you already have the little *-ge* that hangs on the end of the place you are heading for.
...
[PAUSE 3s] What does ದಾರಿ mean? ("a way, a path".) Say it once more.
`,h=e({default:()=>g}),g=`---
schema_version: 2
id: KA-C55-river
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C54-seed]
---

# ನದಿ (nadi) — a river

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C54-TREE-04, KA-LEX-C54-TREE-05] -->

[PAUSE 2s] Before the new run: what did *bēru* mean, and what did *bīja* mean?

## You'll want to know: ನದಿ
<!-- hl-knowledge: introduces=[KA-LEX-C55-ROAD-01]; assesses=[] -->
...
Kannada's own river-word is ಹೊಳೆ (*hoḷe*), and it opens with the *h* you have learned to read as an old *p*. ಹೊಳೆ is the water you can walk to — the stream behind the village. ನದಿ is the ಕಾವೇರಿ. The borrowed word took the big rivers and left the small ones to the inherited one, which is the opposite of what usually happens.
...
[PAUSE 3s] What does ನದಿ mean? ("a river".) Say it once more.
`,_=e({default:()=>v}),v=`---
schema_version: 2
id: KA-C55-tank
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C55-river]
---

# ಕೆರೆ (kere) — a tank, a reservoir

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C54-TREE-05, KA-LEX-C55-ROAD-01] -->

[PAUSE 2s] Before the new one: what did *nadi* mean?

## You'll want to know: ಕೆರೆ
<!-- hl-knowledge: introduces=[KA-LEX-C55-ROAD-02]; assesses=[] -->
...
[PAUSE 3s] What does ಕೆರೆ mean? ("a tank, a reservoir".) Say it once more.
`,y=e({default:()=>b}),b=`---
schema_version: 2
id: KA-C55-village
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C55-hill]
---

# ಹಳ್ಳಿ (haḷḷi) — a village

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C55-ROAD-01, KA-LEX-C55-ROAD-02, KA-LEX-C55-ROAD-03] -->

[PAUSE 2s] Before the new one: what did *beṭṭa* mean?

## You'll want to know: ಹಳ್ಳಿ
<!-- hl-knowledge: introduces=[KA-LEX-C55-ROAD-04]; assesses=[] -->

**ಹಳ್ಳಿ** (*haḷḷi*) — "a village".

The *h* tells you what happened: an older *paḷḷi* stands behind it, worn down by the same law that turned the fruit-word and the flower-word into ಹಣ್ಣು and ಹೂವು.
...
Tamil kept *paḷḷi* too and steered it a different way, toward a place of rest and then toward a school.
...
[PAUSE 3s] What does ಹಳ್ಳಿ mean? ("a village".) Say it once more.
`,x=e({default:()=>S}),S=`---
schema_version: 2
id: KA-C56-basket
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C56-mat]
---

# ಬುಟ್ಟಿ (buṭṭi) — a basket

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C55-ROAD-05, KA-LEX-C56-HOUSE-01] -->

[PAUSE 2s] Before the new one: what did *cāpe* mean?

## You'll want to know: ಬುಟ್ಟಿ
<!-- hl-knowledge: introduces=[KA-LEX-C56-HOUSE-02]; assesses=[] -->
...
ಬುಟ್ಟಿ shares its ending with the ಚಾಪೆ's world rather than the ಕುರ್ಚಿ's: another light, cheap, repairable thing made from what grows nearby, and one that a house replaces every few years without thinking about it.
...
[PAUSE 3s] What does ಬುಟ್ಟಿ mean? ("a basket".) Say it once more.
`,C=e({default:()=>w}),w=`---
schema_version: 2
id: KA-C56-box
spine_node: SPINE-COURTESY-THANK
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C56-vessel]
---

# ಪೆಟ್ಟಿಗೆ (peṭṭige) — a box

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C56-HOUSE-01, KA-LEX-C56-HOUSE-02, KA-LEX-C56-HOUSE-03, KA-LEX-C56-HOUSE-04] -->

[PAUSE 2s] Before the new one: what did *pātre* mean?

## You'll want to know: ಪೆಟ್ಟಿಗೆ
<!-- hl-knowledge: introduces=[KA-LEX-C56-HOUSE-05]; assesses=[] -->

**ಪೆಟ್ಟಿಗೆ** (*peṭṭige*) — "a box".

All four sisters have this word and it is nearly the same in each: Tamil *peṭṭi*, Malayalam *peṭṭi*, Telugu *peṭṭe*, and Kannada ಪೆಟ್ಟಿಗೆ. Only Kannada carries the extra closing syllable, which is a habit you have now seen a few times — Kannada tends to be the long one.
...
[PAUSE 3s] What does ಪೆಟ್ಟಿಗೆ mean? ("a box".) Say it once more.
`,T=e({default:()=>E}),E=`---
schema_version: 2
id: KA-C56-knife
spine_node: SPINE-COURTESY-THANK
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C56-basket]
---

# ಚಾಕು (cāku) — a knife

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C56-HOUSE-01, KA-LEX-C56-HOUSE-02] -->

[PAUSE 2s] Before the new one: what did *buṭṭi* mean?

## You'll want to know: ಚಾಕು
<!-- hl-knowledge: introduces=[KA-LEX-C56-HOUSE-03]; assesses=[] -->
...
[PAUSE 3s] What does ಚಾಕು mean? ("a knife".) Say it once more.
`,D=e({default:()=>O}),O=`---
schema_version: 2
id: KA-C56-mat
spine_node: SPINE-COURTESY-THANK
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C55-path]
---

# ಚಾಪೆ (cāpe) — a mat

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C55-ROAD-04, KA-LEX-C55-ROAD-05] -->

[PAUSE 2s] Before the new run: what did *haḷḷi* mean, and what did *dāri* mean?

## You'll want to know: ಚಾಪೆ
<!-- hl-knowledge: introduces=[KA-LEX-C56-HOUSE-01]; assesses=[] -->
...
[PAUSE 3s] What does ಚಾಪೆ mean? ("a mat".) Say it once more.
`,k=e({default:()=>A}),A=`---
schema_version: 2
id: KA-C56-vessel
spine_node: SPINE-COURTESY-THANK
...
[PAUSE 2s] Before the new one: what did *cāku* mean?

## You'll want to know: ಪಾತ್ರೆ
<!-- hl-knowledge: introduces=[KA-LEX-C56-HOUSE-04]; assesses=[] -->
...
[PAUSE 3s] What does ಪಾತ್ರೆ mean? ("a vessel, a cooking pot".) Say it once more.
