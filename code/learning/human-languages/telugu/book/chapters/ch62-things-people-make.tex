...
% canonical-source-hash: fnv1a64:aed35c3165e0bfbf
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{dāraṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{dāraṁ}, then \emph{dayacēsi}, and ask for it politely
  \item \emph{Recall:} say \emph{gēde}, then read \textbf{\te{పెరుగు}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{sūdi}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{sūdi}, then \emph{dāraṁ}, and say which one goes through the other
  \item \emph{Recall:} read \textbf{\te{మేక}}, then say \emph{neyyi}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{cīpuru}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{cīpuru}, then \emph{muggu}, and say which one comes first
  \item \emph{Recall:} say \emph{kōḍi}, then read \textbf{\te{నూనె}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{goḍugu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{goḍugu}, then \emph{gāli}, and say what one does to the other
  \item \emph{Recall:} read \textbf{\te{చీమ}}, then say \emph{cakkera}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{addaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then say \emph{dayacēsi addaṁ ivvaṇḍi}
  \item \emph{Recall:} say \emph{pakṣi}, then read \textbf{\te{మిరప}} and say what it means
\end{itemize}
