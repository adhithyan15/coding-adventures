# Build and run the hash-functions tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name hash_functions-tests -Sources @("tests\hash_functions_test.c", "src\hash_functions.c")
