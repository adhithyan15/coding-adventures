...
% canonical-source-hash: fnv1a64:45a6df49d032acd8
% canonical-lessons: AR-C39-laysa, AR-C39-ma, AR-C39-la-wala, AR-C39-hal, AR-R39-denying-and-asking, AR-R39-every-way-to-leave-again
...
\end{tcolorbox}
\section[maʿa s-salāma · ilā l-liqāʾ]{Every way to leave, asked and denied}

\label{lesson:AR-R39-every-way-to-leave-again}



\begin{quote}
Give both farewells and what each one literally says. Then use this chapter's question particle to ask whether somebody is leaving, and its negator to answer that they are not.
\end{quote}

\subsection*{The exchange}
\begin{itemize}
\raggedright
  \item \emph{Say it:} the whole arc — greet, give your name, ask after them, part
  \item \emph{Say it:} part with safety — \emph{maʿa s-salāma}
  \item \emph{Say it:} part until the meeting — \emph{ilā l-liqāʾ}
  \item \emph{Recall:} the one root that opens the greeting and closes the farewell
\end{itemize}

Everything above stands on a handful of three-consonant roots, and the farewell uses the same one the first greeting did. \textbf{s–l–m} gives \emph{salām}, \emph{salāma}, \emph{islām}, \emph{muslim} — peace, safety, wholeness, one family.

\begin{grammarlens}[title={Grammar Lens: with, until, and the pattern between them}]
\textbf{\ar{مع}} \emph{maʿa} is \emph{mīm} plus \emph{ʿayn} and means \textbf{with}. It is a preposition that \textbf{stands apart} — unlike \textbf{\ar{الـ}} and \textbf{\ar{بـ}}, which fasten onto the word after them. Its Hebrew cousin is \emph{ʿim}.

\textbf{\ar{السلامة}} is \textbf{\ar{الـ}} + \emph{salām} + \textbf{\ar{ة}}, and the middle piece has been poured into the pattern \emph{faʿāla}, which converts a thing into \textbf{the state of} that thing: \emph{peace} becomes \emph{safety}. Then the sun-letter rule bites, so \textbf{\ar{الس}} is read \textbf{as-}, and the phrase is \emph{as-salāma}, never \emph{al-salāma}.
\end{grammarlens}

\subsection*{You'll want to know: until the meeting}
\textbf{\ar{إلى} \ar{اللقاء}} is \textbf{\ar{إلى}} (\emph{until}) plus \textbf{\ar{اللقاء}} (\emph{the meeting}), root \textbf{l–q–y}, to meet. Arabic does not name the parting; it names \textbf{the next meeting} and points at it.

Spanish does the same thing with \emph{hasta luego}, \emph{until later}, and both leave the listener holding a future rather than an ending. The \textbf{\ar{إ}} with its hamza below and the \textbf{\ar{ق}} \emph{qāf} both sit outside the writing set, so read them.

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Give the three pieces of \textbf{\ar{السلامة}}. (\textbf{\ar{الـ}} + \emph{salām} + \textbf{\ar{ة}}.) Say whether \textbf{\ar{مع}} attaches to the next word. (\textbf{No}.) Give the root inside \textbf{\ar{اللقاء}} and its sense. (\textbf{l–q–y}, to meet.) And name the root that both opens and closes this book's first four chapters of speech. (\textbf{s–l–m}.)
\end{tcolorbox}
