# Build and run the intel4004-encoder tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name intel4004_encoder-tests -Sources @("tests\intel4004_encoder_test.c", "src\intel4004_encoder.c")
