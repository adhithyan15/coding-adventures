# ladder_t2_bool_fold_simple

Rung 2.bool_fold of the CCR-047 differential complexity ladder, at
`SIMPLE`.

## What this rung is for

Exercises a constant comparison folding to a boolean.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level SIMPLE_OPTIMIZATIONS --js tests/diff/ladder_t2_bool_fold_simple/input/a.js
```
