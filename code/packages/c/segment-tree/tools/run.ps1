# Build and run the segment-tree tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name segment_tree-tests -Sources @("tests\segment_tree_test.c", "src\segment_tree.c")
