defmodule CodingAdventures.Cas.BlobStore do
  @moduledoc """
  ...
  Rust. Any module that says `@behaviour CodingAdventures.Cas.BlobStore` and
  implements all four callbacks can be plugged into `CodingAdventures.Cas.Store`
