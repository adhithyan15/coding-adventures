...
describe("the committed corpus", () => {
  it("pins the first measurement", () => {
    ...
    expect(r.summary.worstTerms.slice(0, 2)).toEqual([
      { term: "verb", lessons: 1011 }, // The migrated Arabic recap explicitly retrieves the verb "to be."
      { term: "noun", lessons: 530 }, // Marwadi's ear-first mharo/tharo lessons state the masculine-noun agreement cue.
