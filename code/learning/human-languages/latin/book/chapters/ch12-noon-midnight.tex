...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}medius diēs\textquotedblright{} — mid-day, then \textquotedblleft{}media nox\textquotedblright{} — mid-night{]}
  \item {[}YOU SAY: the three fates — \textquotedblleft{}Spanish kept both halves, French kept only night, English used a different phrase entirely\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}nōna hōra\textquotedblright{} — the ninth hour — English's real ancestor for \textquotedblleft{}noon\textquotedblright{}{]}
\end{itemize}
