...
% canonical-source-hash: fnv1a64:89422aceb2b0b30d
% canonical-lessons: JA-W01-ko, JA-W01-n, JA-W01-ni, JA-W01-chi, JA-C02-wani, JA-W01-wa, JA-W01-konnichiwa-read, JA-C01-konnichiwa
...
\begin{enumerate}
\raggedright
  \item the \textbf{upper} stroke, short, curving down a little at its right end
  \item the \textbf{lower} stroke, wider, sweeping right and lifting slightly
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item the \textbf{vertical} down the left, with the same small flick left at the foot as the sign read \emph{ha}
  \item a \textbf{short horizontal} to its right, upper area
  \item a \textbf{longer horizontal} below it, sweeping right
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item a \textbf{short horizontal} across the top
  \item the \textbf{body} — down from the middle of that bar, curving left, then round into a full belly to the right and up
\end{enumerate}
...
Source: \href{https://www.unicode.org/charts/PDF/U3040.pdf}{Unicode Hiragana chart}; stroke order per \emph{Hitsujun Shido no Tebiki} (Japanese Ministry of Education, 1958).
\end{tcolorbox}
\section[wani]{\ja{わに} (wani) — a crocodile}

\label{lesson:JA-C02-wani}
...
\subsection*{You'll want to know: \ja{わに}}
\textbf{\ja{わに}} — \emph{wani} — \textquotedblleft{}a crocodile\textquotedblright{}.

Say it: \emph{wani}. Look at its shape as you say it: the lessons that follow take pieces of it, \textbf{\ja{わ}}, and write each one on its own.
...
\raggedright
  \item \emph{wani}
  \item \emph{wani}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}a crocodile\textquotedblright{}? (\textbf{\ja{わに}}, \emph{wani}.)
\end{tcolorbox}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/JA-W01-wa-filmstrip.pdf}}{How \ja{わ} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item the \textbf{vertical} on the left, with the small flick at the foot
  \item the \textbf{body} — a short bar right from the top, then down, round to the left in a loop, and out to the lower right with a curl
\end{enumerate}
