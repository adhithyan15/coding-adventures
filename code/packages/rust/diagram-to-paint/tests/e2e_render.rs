...
mod apple {
    ...
    use diagram_to_paint::{
        diagram_to_paint, diagram_to_paint_chart, diagram_to_paint_packet, diagram_to_paint_sequence,
    ...
    use mermaid_parser::{
        parse_block, parse_c4_diagram, parse_er_diagram, parse_gantt, parse_gitgraph, parse_journey, parse_packet, parse_pie,
