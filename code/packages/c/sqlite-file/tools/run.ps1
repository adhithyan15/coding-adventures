# Build and run the sqlite-file tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name sqlite_file-tests -Sources @("tests\sqlite_file_test.c", "src\sqlite_file.c")
