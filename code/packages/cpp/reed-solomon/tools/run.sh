#!/bin/sh
# Build and run the reed-solomon tests under EVERY available C/C++ compiler (pure ISO),
...
ISO_INCLUDE="include ../gf256/include $HARNESS/include"
export ISO_INCLUDE
...
iso_build_and_run cpp reed_solomon-tests tests/reed_solomon_test.cpp
