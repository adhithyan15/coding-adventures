...
# Include this package's headers, the sibling header-only sha256 package's
# (HMAC-SHA256 is the tested instantiation), and the harness's (for iso_test.h).
...
iso_build_and_run cpp hmac-tests tests/hmac_test.cpp
