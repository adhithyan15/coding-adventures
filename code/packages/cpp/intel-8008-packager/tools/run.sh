#!/bin/sh
# Build and run the intel-8008-packager tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp intel_8008_packager-tests tests/intel_8008_packager_test.cpp
