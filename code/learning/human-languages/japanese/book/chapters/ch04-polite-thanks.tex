...
\begin{enumerate}
\raggedright
  \item a short \textbf{horizontal}, near the top
  \item a \textbf{short curving stroke} below it, falling down and left
  \item a \textbf{separate small curve} at the foot, opening left — \textbf{not joined} to the stroke above it
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item an \textbf{upper horizontal}, short
  \item a \textbf{lower horizontal}, a little wider, below and parallel to it
  \item a \textbf{looping vertical} that crosses both, falls, and curls left at the bottom
\end{enumerate}
...
\raggedright
  \item a short \textbf{horizontal}, near the top
  \item a \textbf{vertical} crossing it, falling, and finishing in a loop that closes back on itself before tailing away
\end{enumerate}
