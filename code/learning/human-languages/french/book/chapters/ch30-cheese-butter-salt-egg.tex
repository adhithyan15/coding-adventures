...
% canonical-source-hash: fnv1a64:505fe336168225d2
...
\begin{quote}
You can name \emph{la personne} and \emph{l'enfant} now. The café chapter asked politely for a drink; this chapter asks for what goes with it — starting with a word every other Romance language names completely differently.
\end{quote}
