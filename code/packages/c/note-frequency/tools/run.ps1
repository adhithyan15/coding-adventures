# Build and run the note-frequency tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name note_frequency-tests -Sources @("tests\note_frequency_test.c", "src\note_frequency.c")
