...
completely on its own — and it opens a family of English words you already
use.
...
- **bene**fit — literally "to do **well**" (*bene* + *facere*).
- **bene**volent — "wishing **well**" (*bene* + *volens*).
- **bene**diction — "speaking **well**," a blessing (*bene* + *dicere*).
- **bene**factor, **bene**ficial, be**nign**.

So *bien* is the Spanish member of the *bene-* family you've owned in English
your whole life.
...
Spanish uses **bueno** (for a masculine word) or **buena** (for a feminine
word). These come from Latin **bonus** ("good"), *bene*'s sibling: Latin
split the idea of "good" into an adverb (*bene*) and an adjective (*bonus*),
and Spanish kept both. The Latin-descended English cousins of *bueno* are
*bonus*, *bonanza*, and *bounty*.

> **English does the exact same split**: *well* (adverb) vs. *good*
> (adjective) — "you did *well*" but "a *good* job." English's pair happens to
> be Germanic, not Latin, so *well/good* aren't blood cousins of *bien/bueno*
> — but the *structure* is identical, and that parallel is your handle:
...
you good days."* You weren't wishing one good morning; you were asking heaven
for many good days ahead. The plural is the last bone of that prayer — and
it's why *buenos días* feels warm and a little formal, where *hola* is
casual. It is, almost literally, a small *bene*diction (the *bien* lesson's word). *(A
...
- **di**ary, **di**urnal ("of the day").
- **jour**nal, **jour**ney — French *jour*, "a day" (a *journey* was once "a
  day's travel").
- quoti**di**an ("every-day"), meri**di**an ("mid-day"), and *dismal*
  (*dies mali*, "evil days").
...
**Gender.** *día* is **masculine** — *el día* — which is a small surprise,
because it ends in *-a*, the ending that usually signals feminine. Why the
exception? Because Latin *dies* was masculine, and *día* inherited that gender
whole, spelling be damned. (This is exactly why gender must be learned *with*
the word, not guessed from the ending — and it's the first of several
"*-a*-but-masculine" nouns you'll meet.)

**Number.** One rule for now: a noun ending in a vowel adds **-s**. *día →
...
precisely because *día* is masculine and plural. So the gender you just
...
- [YOU SAY: is *día* masculine or feminine, and why? (masculine — from Latin
  *dies*, despite the *-a*)]
...
Over centuries the pointing force faded and the initial *i-* dropped: *ille →
el*, *illa → la*. What began as "that one" softened into a plain "the." The
same *ille/illa* spread across the whole family — French *le/la*, Italian
*il/la* — every Romance "the" is eroded Latin "that."

**The twin thread.** Those *same* Latin words, *ille/illa*, also became
Spanish **él** ("he") and **ella** ("she"). So the article *el* ("the") and
the pronoun *él* ("he") are twins from one Latin parent — told apart only by
