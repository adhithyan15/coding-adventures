...
% canonical-source-hash: fnv1a64:fdbe9b835a9cc91a
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kayaṟ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{tēṅṅa}, then \emph{kayaṟ}, and say which one the other is made from
  \item \emph{Recall:} say \emph{paśu}
\end{itemize}
...
It closes on the bare \emph{l} of \emph{cōṟŭ} and \emph{vērŭ}: the consonant with its vowel shaved off.
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{nūlŭ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kayaṟ}, then \emph{nūlŭ}, and say which of the two is thicker
  \item \emph{Recall:} read \textbf{\ml{ആട്}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{sūci}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{nūlŭ}, then \emph{sūci}, and say which one goes through the other
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{cūlŭ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{sūci}, then \emph{cūlŭ}, and say which of the two you hold in a fist
  \item \emph{Recall:} read \textbf{\ml{കാക്ക}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{muṟaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{kayaṟ}, \emph{nūlŭ}, \emph{sūci}, \emph{cūlŭ}, \emph{muṟaṁ}
  \item \emph{Recall:} say \emph{āna}
\end{itemize}
