...
% canonical-source-hash: fnv1a64:89e42aff862fe196
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kaṇ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kaṇ}, then \emph{talai}, so the part and the whole sit together
  \item \emph{Recall:} say \emph{kuḻandai}, then read \textbf{\ta{பழம்}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kādu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kaṇ}, then \emph{kādu}, and hear the long \emph{ā} arrive in the second
  \item \emph{Recall:} read \textbf{\ta{மகன்}}, then say \emph{tuṇi}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{mūkku}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kādu}, then \emph{mūkku}, and let the second start long
  \item \emph{Recall:} say \emph{makaḷ}, then read \textbf{\ta{விளக்கு}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{pal}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{mūkku}, then \emph{pal}, and cut the second one short
  \item \emph{Recall:} read \textbf{\ta{குடும்பம்}}, then say \emph{uppu}
\end{itemize}
