# ladder_t6_rest_param_ws

Rung 6.rest_param of the CCR-066 differential complexity ladder, at `WHITESPACE_ONLY`.

## What this rung is for

Exercises a rest parameter.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level WHITESPACE_ONLY --js tests/diff/ladder_t6_rest_param_ws/input/a.js
```
