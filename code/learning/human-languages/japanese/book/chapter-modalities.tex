...
\expandafter\def\csname hlchaptermodality11\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (8) \quad \hlpensign{}~\textbf{pen} (4)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} none of the 12 lessons.%
    \par}\medskip
}
...
\expandafter\def\csname hlchaptermodality12\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (20)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} all 20 lessons.%
    \par}\medskip
}

\expandafter\def\csname hlchaptermodality13\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (15) \quad \hlpensign{}~\textbf{pen} (2)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} none of the 17 lessons.%
    \par}\medskip
}
