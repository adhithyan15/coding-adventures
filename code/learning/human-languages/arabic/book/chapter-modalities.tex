...
\expandafter\def\csname hlchaptermodality1\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (1) \quad \hlsightsign{}~\textbf{eyes} (7) \quad \hlpensign{}~\textbf{pen} (6)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 8 of 14 lessons.%
    \par}\medskip
}
