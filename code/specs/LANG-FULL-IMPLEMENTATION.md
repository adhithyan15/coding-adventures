...
- ✅ **AL7** — direct call-by-name (Jensen-style expression thunks).
  ...
  element writes retain caller storage. Recursive name-formal dispatch remains
