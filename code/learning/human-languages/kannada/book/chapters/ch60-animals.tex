...
% canonical-source-hash: fnv1a64:c7047cd19ac999bf
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{hasu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{hasu}, then \emph{hālu}, and say which one comes out of the other
  \item \emph{Recall:} say \emph{svalpa}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{mēke}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{hasu}, then \emph{mēke}, and say which one climbs
  \item \emph{Recall:} read \textbf{\kn{ಹೆಚ್ಚು}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kōḷi}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kōḷi}, then \emph{beḷagge}, and say which one comes first
  \item \emph{Recall:} say \emph{kaḍime}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kāge}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kāge}, then \emph{kōḷi}, and say which one is kept and which one turns up
  \item \emph{Recall:} read \textbf{\kn{ಬೇಡ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{hakki}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{namaskāra} to whoever keeps them
  \item \emph{Recall:} say \emph{aṣṭē}
\end{itemize}
