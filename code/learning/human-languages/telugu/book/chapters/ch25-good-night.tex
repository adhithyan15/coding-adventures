...
% canonical-source-hash: fnv1a64:e6b94bd507b0d7f7
...
\begin{quote}
Before the new one: \te{జ} — what does it do?
...
Say \textbf{\te{బ}} (\emph{ba}), then say it again and let a puff of breath out on top of it. That second thing is \textbf{\te{భ}}. Telugu gives the breathy one its own letter rather than a mark on the plain one, and it does the same for other pairs you have seen: \textbf{\te{ద}} (\emph{da}) has \textbf{\te{ధ}} (\emph{dha}) beside it, the letter standing second in \emph{dhanyavādamulu} from the first pages of this book. The \emph{h} in the romanization \emph{bha} is that puff, not a separate sound.
