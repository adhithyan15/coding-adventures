...
describe("corpus snapshot", () => {
  ...
  it("pins where the corpus actually stands on the ladder", () => {
    ...
    */
    expect(summary.mappedPercent).toBe(99); // Japanese family tranche: +17 mapped pre-A1 lessons raises the rounded corpus percentage // HL-C251: +1 -- IMPROVEMENT, mapped percent rises as the russian ch1 lessons gain a spine_node // +1: vocabulary wave 6 grows the mapped corpus faster than the unmapped 86 // kannada pre-A1 tranche: +35 lessons, +7 chapters (chapters 46-52) // +1: Chinese's six-lesson vocabulary tranche is fully mapped // Gujarati's seven courtesy-glyph lessons are fully mapped
  });
