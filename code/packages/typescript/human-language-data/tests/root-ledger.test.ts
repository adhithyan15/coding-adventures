...
describe("the committed corpus", () => {
  ...
  it("pins the first ledger, and it is the reason the rule exists", () => {
    ...
    expect(l.summary.roots).toBe(2963); // +5: vos-latin slug and ES-ETYMON-VOS-03 // +78: vocabulary wave 5 // +6: HL-C88 slices 5-6 // +2: HL-C88 slice 8 // +111: vocabulary wave 6 // +2: HL-C113 (B1 si-condition rung) // HL-C113: HL-C113 imperfect subjunctive
    ...
    expect(byNamespace).toEqual({ roots: 2117, "etymon-atom": 846 }); // +1 root + 1 etymon atom: HL-C88 slice 8 // +72 roots, +39 etymon-atom: vocabulary wave 6 // +1 root + 1 etymon atom: HL-C113 (B1 si-condition rung) // HL-C113: HL-C113 imperfect subjunctive
  });
