...
concept_tag: REVIEW
prerequisites: [TA-C01-answering, TA-C01-vanakkam-family-register, TA-C01-nandri-family-register, TA-C01-aam, TA-C01-illai, TA-C01-sari, TA-W00-va-guided-copy]
sounds: []
roots: []
est_minutes: 4
...
The Tamil is printed beside each word on purpose. You are expected to recognise
only the opening **வ** of **வணக்கம்**, and you may keep that model visible when
you copy it below. Nothing asks you to read or write the other shapes. Formal
...
Say it *sari*, two light syllables, stress even. The opening sound sits
between English *s* and *ch*, and Tamil treats that whole range as one
sound chosen by **position** in the word rather than by a separate spelling
— the same economy that lets one *k*-sound also be heard as *g* or a
soft *h*.

## The word, taken apart
<!-- hl-knowledge: introduces=[]; assesses=[] -->

சரி (*sari*) is native Tamil for “correct, even, level,” and so
“okay, agreed.” It is the verbal nod of the language: propose a plan, hear a
warm *sari*; doubled, *sari sari* = “alright, alright.”

## Grammar lens
<!-- hl-knowledge: introduces=[]; assesses=[] -->

**One letter, several sounds.** For its stop-consonants Tamil writes
*one* letter per mouth-position and lets rules of position fill in the
voicing (*k*/*g*, *s*/*ch*). The payoff is a strikingly
*small* alphabet; the price is that the exact sound isn't always
...
requires:
  knowledge: []
introduces:
  knowledge: [TA-PHONO-VANAKKAM-01, TA-ETYMON-VANAKKAM-02, TA-PRAGMATIC-VANAKKAM-03]
practises:
  knowledge: [TA-PHONO-VANAKKAM-01, TA-ETYMON-VANAKKAM-02, TA-PRAGMATIC-VANAKKAM-03]
...
<!-- hl-knowledge: introduces=[]; assesses=[TA-PRAGMATIC-VANAKKAM-03] -->

Said with the palms pressed together and a small bow — the gesture *is*
the word. It serves as both **hello and goodbye**, any time, to almost
