#!/bin/sh
# Build and run the feature-normalization tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp feature_normalization-tests tests/feature_normalization_test.cpp
