...
% canonical-source-hash: fnv1a64:3e0185c41232996b
% canonical-lessons: ML-C34-edukkuka, ML-C34-codikkuka, ML-C34-sahaayikkuka, ML-S127-letter-ha, ML-C34-ishtam
...
\begin{itemize}
\raggedright
  \item \textbf{\ml{സഹായിക്കുക}} \emph{sahāyikkuka} — to help
  \item \textbf{\ml{സഹായം}} \emph{sahāyaṁ} — help, the noun inside that verb
\end{itemize}
...
\begin{quote}
\ml{സഹായം}  ·  \ml{സഹായിക്കുക}  ·  \ml{നന്ദി}
\end{quote}
