...
describe("book chapter modality projection", () => {
  ...
  it("covers all 523 generated and handwritten chapter openings in all 22 books", () => {
    ...
    expect(ledgers.flatMap((track) => track.chapters)).toHaveLength(782); //HL-C136 wave I: 42 lessons, 6 chapters — 'Pointing, and Asking', six deixis words per Indic track, re-measured against the merged base after main landed HL-C128 steps 3-10 and HL-C127 // +4: HL-C98 // +15: vocabulary wave 5 // +4: HL-C88 slices 5-6 // +3: HL-C88 slice 8 // +12: vocabulary wave 6 // +3: HL-C113 (B1 si-condition rung) // +3: HL-C113 preterite plural // HL-C113 preterite close // HL-C113: HL-C113 imperfect subjunctive // HL-C137 wave II: +36 lessons, +6 chapters — the first adjectives (big/small/good/new/old) and the placement rule behind them, one chapter per Indic track // HL-C152: +5 lessons, +1 chapter — Spanish realizes SPINE-NEGATE-AND-ASK, completing A2 at 5/5 // HL-C158: +4 -- the B1 travel rung (chapter 268) // HL-C159: +4 -- the B1 describe-experience rung (chapter 269) // HL-C163: +6 -- Sanskrit chapter 16
