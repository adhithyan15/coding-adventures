...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3404, // +1: Spanish's first forward-language practice lesson. // +1: Italian's guided-copy bridge on the Tamil baseline.
      ...
      voice: 2462, // Spanish's forward-language practice is voice-first. // Italian's legacy opener now exposes its pen dependency.
      ...
      pen: 352, // +2: Italian's opener trace and guided copy.
      ...
      drivableLessons: 2462, // Spanish adds one hands-free practice lesson. // Italian's opener leaves the hands-free set.
      ...
      drivablePrefixTotal: 2181, // +1: Spanish's new terminal voice practice extends its chapter prefix.
      ...
      */
      ...
      unstartableChapters: 214, // Italian Chapter 1 now honestly starts with pen.
      overriddenLessons: 0,
