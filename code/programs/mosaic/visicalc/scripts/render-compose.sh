...
# is not native-complete on Compose: 8 degradations, all of them accessibility
...
assert n == 8, f'expected the 8 known table-semantics degradations (#14843), got {n}: ' + repr([x[\"code\"] for x in d['degradations']])
"
