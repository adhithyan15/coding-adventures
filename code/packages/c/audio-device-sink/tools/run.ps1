# Build and run the audio-device-sink tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name audio_device_sink-tests -Sources @("tests\audio_device_sink_test.c", "src\audio_device_sink.c")
