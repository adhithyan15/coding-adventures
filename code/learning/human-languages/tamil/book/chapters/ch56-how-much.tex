...
% canonical-source-hash: fnv1a64:33bbe659e79c82ca
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{siṟitu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{elumbu}, then \emph{siṟitu}, and keep the second one short
  \item \emph{Recall:} say \emph{pāy}, then read \textbf{\ta{கழுத்து}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{niṟaiya}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{siṟitu}, then \emph{niṟaiya}, the little and the lot
  \item \emph{Recall:} read \textbf{\ta{கூடை}}, then say \emph{mutuku}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kuṟaivu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{niṟaiya}, then \emph{kuṟaivu}, plenty and then not enough
  \item \emph{Recall:} say \emph{katti}, then read \textbf{\ta{உதடு}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{tēvaiyillai}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kuṟaivu}, then \emph{tēvaiyillai}, and let the whole of the second run as one word
  \item \emph{Recall:} read \textbf{\ta{கிண்ணம்}}, then say \emph{nakam}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{ākaṭṭum}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{siṟitu}, \emph{niṟaiya}, \emph{kuṟaivu}, \emph{tēvaiyillai}, \emph{ākaṭṭum}
  \item \emph{Recall:} say \emph{peṭṭi}, then read \textbf{\ta{எலும்பு}}
\end{itemize}
