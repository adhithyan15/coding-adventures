...
% canonical-source-hash: fnv1a64:3eaf5de08326a1a5
...
\emph{Hear:} \emph{sat srī akāl}. It serves as both \textbf{hello} and \textbf{goodbye} among Sikhs. Answer by repeating it: \emph{Say it:} \emph{sat srī akāl}. One careful return is enough.
...
\emph{Hear:} \emph{namaste}. It is a respectful \textbf{hello} used across communities and across much of India. Answer in kind: \emph{Say it:} \emph{namaste}.
...
\emph{Hear:} \emph{hā̃} — \textbf{yes}. Hold the vowel, then let the ending pass gently through the nose.

\emph{Hear:} \emph{nahī̃} — \textbf{no}. The second syllable is long, and its ending is nasal too.

Answer aloud once: \emph{Say it:} \emph{hā̃} — yes. Then once: \emph{Say it:} \emph{nahī̃} — no. Do not take the Gurmukhi apart yet. The next three tiny sessions will teach one piece at a time before you are asked to read or write \textbf{\pa{ਹਾਂ}}.
...
\begin{enumerate}
\raggedright
  \item cover \textbf{\pa{ਹਾਂ}}
  \item wait five seconds
  \item write it once from memory
  \item uncover the model and compare \textbf{\pa{ਹ}}, \textbf{\pa{ਾ}}, then \textbf{\pa{ਂ}}
\end{enumerate}
...
\emph{Hear:} \emph{dhannavād} — \textbf{thank you}. Return it once: {[}YOU SAY: \emph{dhannavād}{]}.
...
\subsection*{You'll want to know first — listen and use}
\emph{Hear:} \emph{shukrīā} — \textbf{thank you}. Return it once: \emph{Say it:} \emph{shukrīā}.
...
\emph{Say it:} \emph{sat srī akāl}, \emph{Say it:} \emph{namaste}, \emph{Say it:} \emph{dhannavād}, \emph{Say it:} \emph{shukrīā}. Record this courtesy check separately from the yes/no speaking check below.
...
\emph{Hear:} \emph{nahī̃} Choose the meaning without looking at a written Punjabi answer. Record only the listening result.
...
\emph{Say it:} \emph{hā̃} — yes. Record only the spoken response. The written answer from the previous check cannot supply speaking credit.
