---
schema_version: 2
id: ML-C105-thalasthaanam
spine_node: SPINE-DEFINITE-REFERENCE
sequence: 3840
chapter: 105
type: word
headword: "തലസ്ഥാനം"
gloss: a capital — literally a head-place, and the head in it is the one on your shoulders
romanization: "talasthānaṁ"
...
duration:
  max_seconds: 240
requires:
  knowledge: [ML-LEX-C105-CITY-01, ML-CONCEPT-C13-SHAREERA-BHAAGANGAL-01]
introduces:
  knowledge: [ML-LEX-C105-CAPITAL-01]
practises:
  knowledge: [ML-LEX-C105-CAPITAL-01, ML-LEX-C105-CITY-01, ML-CONCEPT-C13-SHAREERA-BHAAGANGAL-01]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus]
register: neutral
variety: standard-colloquial
reviews_of: [ML-C13-shareera-bhaagangal, ML-C105-nagaram]
---

# തലസ്ഥാനം — a capital

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C105-CITY-01, ML-CONCEPT-C13-SHAREERA-BHAAGANGAL-01] -->

[PAUSE 2s] Say *a city*. Then say the word for the part of your body that sits
on top.

## You'll want to know
<!-- hl-knowledge: introduces=[ML-LEX-C105-CAPITAL-01]; assesses=[ML-CONCEPT-C13-SHAREERA-BHAAGANGAL-01] -->
...
**English says exactly the same thing, and hides it.** *Capital* comes from
