...
|---|---|---|---|
| **um** (1) | *ūnus* | *uno* | **unit, union, unique** (and *a/an*, *one*) |
| **dois** (2) | *duo* | *dos* | **duo, dual, double** |
| **três** (3) | *trēs* | *tres* | **trio, triple, triangle** |
| **quatro** (4) | *quattuor* | *cuatro* | **quart, quarter, quadrant** |
| **cinco** (5) | *quīnque* | *cinco* | **quintet, quintessence** |

*Cinco* is spelled **identically** to Spanish — the two closest sisters. But watch
*two*.
...
inflects it — **dois** (masc.) / **duas** (fem.) — a direct survival of Latin
*duo* (masc.) / *duae* (fem.). So it's *dois cafés* but *duas cervejas*. Spanish
levelled this to a single *dos* centuries ago; Portuguese kept the old split. The
...
- [YOU SAY: the gendered two — "dois cafés" (masc.) / "duas cervejas" (fem.)]
...
What does *um/uma* mean besides "one"? ("A/an.") Next: **6–10**, where a Portuguese
sound-shift is on full display.
