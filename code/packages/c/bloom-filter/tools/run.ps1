# Build and run the bloom-filter tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name bloom_filter-tests -Sources @("tests\bloom_filter_test.c", "src\bloom_filter.c")
