...
- Combined hkdf() convenience method (extract-then-expand)
- Support for SHA-256 (32-byte output) and SHA-512 (64-byte output)
- All three RFC 5869 test vectors verified
- Input validation: rejects length <= 0 or > 255 * HashLen
- Empty/nil salt handling: uses HashLen zero bytes per RFC 5869 Section 2.2
