...
**Status:** XAML, Qt, and Flutter implemented (`circle`/`line`/`curve`);
SwiftUI/Compose/react/html/webcomponent not yet — see §6.
...
| SwiftUI, Compose | not yet — tracked as follow-up issues |
