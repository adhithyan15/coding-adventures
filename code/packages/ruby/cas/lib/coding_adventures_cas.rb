...
# coding_adventures_cas — Generic Content-Addressable Storage
#
...
# =============
#
#   require "coding_adventures_cas"
#   require "tmpdir"
#
#   Dir.mktmpdir do |root|
#     store = CodingAdventures::Cas::LocalDiskStore.new(root)
#     cas   = CodingAdventures::Cas::ContentAddressableStore.new(store)
#
...
require_relative "coding_adventures/cas/version"
...
module CodingAdventures
  module Cas
    ...
    #
    #   CodingAdventures::Cas.key_to_hex("\xa3\xf4".b + "\x00" * 18)
    ...
    #
    #   key = CodingAdventures::Cas.hex_to_key("a9993e364706816aba3e25717850c26c9cd0d89d")
    #   key.bytesize  # → 20
    ...
    # Use CodingAdventures::Cas.key_to_hex(err.key) to convert it to a human-
    ...
    class CasNotFoundError < CasError
      ...
      def initialize(key)
        @key = key
        super("object not found: #{CodingAdventures::Cas.key_to_hex(key)}")
      end
    end
    ...
    class CasCorruptedError < CasError
      ...
      def initialize(key)
        @key = key
        super("object corrupted: #{CodingAdventures::Cas.key_to_hex(key)}")
      end
    end
    ...
    class ContentAddressableStore
      ...
      #
      #   store = CodingAdventures::Cas::LocalDiskStore.new("/tmp/mystore")
      #   cas   = CodingAdventures::Cas::ContentAddressableStore.new(store)
      ...
      # Convert it to hex with CodingAdventures::Cas.key_to_hex(key).
      #
    ...
    class LocalDiskStore
      ...
      #
      #   store = CodingAdventures::Cas::LocalDiskStore.new("/tmp/myobjects")
      def initialize(root)
        @root = root.to_s
