#!/bin/sh
# Build and run the cpu-cache tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c cpu_cache-tests tests/cpu_cache_test.c src/cpu_cache.c
