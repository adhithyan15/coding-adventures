...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      voice: 2464, // Chinese's opener now exposes its pen dependency
      ...
      pen: 346, // +1: Chinese's opener becomes an honest pen lesson
      ...
      drivableLessons: 2464, // Chinese's opener leaves the hands-free set. // +2: Marwadi synthesis lessons remain drivable
      ...
      unstartableChapters: 211, // Chinese chapter 1 now honestly starts with pen. // French/Marathi order recovery on current main: measured, not inferred. // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
