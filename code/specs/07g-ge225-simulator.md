...
4. the optional central-processor decimal arithmetic, real-time clock, and
   canonical `MOV` repertoire (RCPU-P005A);
5. complete direct I/O instruction decode and deterministic card, paper-tape,
