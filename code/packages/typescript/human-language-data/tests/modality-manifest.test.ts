...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3402, // +1: Portuguese's guided-copy bridge
      ...
      voice: 2462, // Portuguese's legacy opener now exposes its pen dependency
      ...
      pen: 350, // +2: Portuguese's opener trace and guided copy
      ...
      drivableLessons: 2462, // Portuguese's opener leaves the hands-free set.
      ...
      unstartableChapters: 213, // Chinese chapter 1 now honestly starts with pen. // French/Marathi order recovery on current main: measured, not inferred. // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
