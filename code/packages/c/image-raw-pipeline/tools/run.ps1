# Build and run the image-raw-pipeline tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name image_raw_pipeline-tests -Sources @("tests\image_raw_pipeline_test.c", "src\image_raw_pipeline.c")
