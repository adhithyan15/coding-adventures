...
% canonical-source-hash: fnv1a64:1a94dddc6b1ca585
% canonical-lessons: MR-C01-dhanyavad, MR-C02-dukh, MR-C02-aabhaal, MR-C02-sant, MR-C02-bet, MR-W02-visarga, MR-W02-aa-independent, MR-W02-bha, MR-W02-e-matra, MR-W02-anusvara, MR-W02-ta
...
\end{tcolorbox}
\section[duḥkh]{\mr{दुःख} (duḥkh) — sorrow, grief}

\label{lesson:MR-C02-dukh}
...
\subsection*{You'll want to know: \mr{दुःख}}
\textbf{\mr{दुःख}} — \emph{duḥkh} — \textquotedblleft{}sorrow, grief\textquotedblright{}.

Say it: \emph{duḥkh}. Look at its shape as you say it: the lessons that follow take pieces of it, \textbf{\mr{ः}}, \textbf{\mr{ु}} and \textbf{\mr{ख}}, and write each one on its own.
...
\raggedright
  \item \emph{duḥkh}
  \item \emph{duḥkh}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}sorrow, grief\textquotedblright{}? (\textbf{\mr{दुःख}}, \emph{duḥkh}.)
\end{tcolorbox}
\section[ābhāḷ]{\mr{आभाळ} (ābhāḷ) — the sky}

\label{lesson:MR-C02-aabhaal}
...
\subsection*{You'll want to know: \mr{आभाळ}}
\textbf{\mr{आभाळ}} — \emph{ābhāḷ} — \textquotedblleft{}the sky\textquotedblright{}.

Say it: \emph{ābhāḷ}. Look at its shape as you say it: the lessons that follow take pieces of it, \textbf{\mr{आ}}, \textbf{\mr{भ}} and \textbf{\mr{ळ}}, and write each one on its own.
...
\raggedright
  \item \emph{ābhāḷ}
  \item \emph{ābhāḷ}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}the sky\textquotedblright{}? (\textbf{\mr{आभाळ}}, \emph{ābhāḷ}.)
\end{tcolorbox}
\section[sant]{\mr{संत} (sant) — a saint}

\label{lesson:MR-C02-sant}
...
\subsection*{You'll want to know: \mr{संत}}
\textbf{\mr{संत}} — \emph{sant} — \textquotedblleft{}a saint\textquotedblright{}.

Say it: \emph{sant}. Look at its shape as you say it: the lessons that follow take pieces of it, \textbf{\mr{ं}} and \textbf{\mr{त}}, and write each one on its own.
...
\raggedright
  \item \emph{sant}
  \item \emph{sant}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}a saint\textquotedblright{}? (\textbf{\mr{संत}}, \emph{sant}.)
\end{tcolorbox}
\section[bet]{\mr{बेत} (bet) — a plan}

\label{lesson:MR-C02-bet}
...
\subsection*{You'll want to know: \mr{बेत}}
\textbf{\mr{बेत}} — \emph{bet} — \textquotedblleft{}a plan\textquotedblright{}.

Say it: \emph{bet}. Look at its shape as you say it: the lessons that follow take pieces of it, \textbf{\mr{ब}} and \textbf{\mr{े}}, and write each one on its own.
...
\raggedright
  \item \emph{bet}
  \item \emph{bet}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}a plan\textquotedblright{}? (\textbf{\mr{बेत}}, \emph{bet}.)
\end{tcolorbox}
...
\hlblockfigure{\detokenize{figures/MR-W02-aa-independent-filmstrip.pdf}}{How \mr{आ} is written, stroke by stroke}
...
\hlblockfigure{\detokenize{figures/MR-W02-bha-filmstrip.pdf}}{How \mr{भ} is written, stroke by stroke}
...
\hlblockfigure{\detokenize{figures/MR-W02-ta-filmstrip.pdf}}{How \mr{त} is written, stroke by stroke}
