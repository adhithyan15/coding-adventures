...
**11 -> 10**. Old chapters 16-33 renumbered to 18-35.
...
`GE-C15-perfekt` and one arrived in `GE-C15-perfekt-practice`.
...
| corpus hand-written chapters | 21 | **20** |
| `handwritten_parity.py` german | 55 | **50** blocks at risk |
| German lessons (schema-v2) | 124 | **151** |
| atoms taught | 267 | **291** |
| atom-measurement-blind lessons | 26 | **23** |
| chapters over the 12-atom budget | 4 | **4** |
| culture claims | 14 | **16** |
| atoms never revisited | 73 | **72** |
| forward references | 40 | **40** |
| cross-chapter prose references | 0 | **0** |
| book pages | 279 | **315** |

Forward references held at 40 because both candidates were phrased around rather
...
zero overfull or underfull boxes and zero missing characters (315 pages), and
