...
import { NibJvmCompiler, PackageError, compileSource, packSource, writeClassFile, } from "../src/index.js";
describe("nib-jvm-compiler", () => {
    ...
    it("raises type-check errors with stage labels", () => {
        ...
        try {
            ...
            expect(error.stage).toBe("type-check");
        }
    });
...
//# sourceMappingURL=nib-jvm-compiler.test.js.map
