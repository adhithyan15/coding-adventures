...
\expandafter\def\csname hlchaptermodality2\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (3) \quad \hlsightsign{}~\textbf{eyes} (5) \quad \hlpensign{}~\textbf{pen} (5)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 8 of 13 lessons.%
    \par}\medskip
}
