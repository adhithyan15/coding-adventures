...
% canonical-source-hash: fnv1a64:5df6708f428c50ef
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{nūlu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{nūlu}, then \emph{baṭṭe}, and say which one comes first
  \item \emph{Recall:} say \emph{hasu}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{sūji}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{nūlu}, then \emph{sūji}, and say which one goes through the other
  \item \emph{Recall:} read \textbf{\kn{ಮೇಕೆ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{hagga}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{nūlu}, then \emph{hagga}, and say which one holds a cow
  \item \emph{Recall:} say \emph{kōḷi}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{porake}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{porake}, then \emph{raṅgōli}, and say which one comes first
  \item \emph{Recall:} read \textbf{\kn{ಕಾಗೆ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{koḍe}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{dayaviṭṭu} in front of the one you want
  \item \emph{Recall:} say \emph{hakki}
\end{itemize}
