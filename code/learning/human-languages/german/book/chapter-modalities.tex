...
\expandafter\def\csname hlchaptermodality1\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (11) \quad \hlsightsign{}~\textbf{eyes} (1)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 4 of 12 lessons.%
    \par}\medskip
}
...
\expandafter\def\csname hlchaptermodality4\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (6) \quad \hlpensign{}~\textbf{pen} (3)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 6 of 9 lessons.%
    \par}\medskip
}
