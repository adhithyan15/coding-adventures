...
% canonical-source-hash: fnv1a64:832895e858ab5c62
% canonical-lessons: LA-C48-nescio, LA-C48-male, LA-C48-second-pass-three-closings, LA-C48-malus, LA-C48-sed, LA-C48-aut
...
\end{tcolorbox}
\section[focus · mare · somnus]{focus · mare · somnus — hearth, sea, sleep}

\label{lesson:LA-C48-second-pass-three-closings}



\begin{quote}
Three words, one from the end of each of the last three chapters: the hearth, the sea, and sleep. Say all three before reading on.
\end{quote}

\subsection*{You'll want to know: each one is a shelf of English}
\noindent
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
\toprule
\textbf{Latin} & \textbf{what it named} & \textbf{what English took} \\
\midrule
\textbf{focus} & the hearth & \emph{focus} — the point a lens gathers to \\
\textbf{mare} & the sea & \emph{marine}, \emph{maritime}, \emph{mariner}, \emph{submarine} \\
\textbf{somnus} & sleep & \emph{insomnia}, \emph{somnolent} \\
\bottomrule
\end{tabularx}

\textbf{focus} is the odd one. English did not borrow the fireplace; it borrowed the idea of \textbf{the one point a house is arranged around} and handed it to optics. Meanwhile spoken Latin took the other road and let \emph{focus} drift from the fireplace to the fire itself, which is where the Romance words for \emph{fire} come from.

\textbf{mare} and \textbf{terra} together make \textbf{mediterrāneum}, the sea in the middle of the earth — two words you hold explaining a name most people never read. And \textbf{somnus} goes back to a root that reached Sanskrit \textbf{svapna} and Old English \emph{sweven}, a word for a dream that Chaucer still used.
...
\begin{itemize}
\raggedright
  \item the three words, then their three meanings
  \item what \emph{focus} named first, and what it names now
  \item the two words inside \emph{mediterrāneum}
  \item two English words built on \emph{somnus}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What did \textbf{focus} name in a Roman house? (\textbf{The hearth}.) Which two words make \emph{mediterrāneum}? (\textbf{Mare} and \textbf{terra}.) What does \textbf{somnus} mean, and which English word denies it? (\textbf{Sleep} — \emph{insomnia}.) And which of the three drifted, in speech, to mean \emph{fire}? (\textbf{Focus}.)
\end{tcolorbox}
