# Build and run the symbolic-ir tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name symbolic_ir-tests -Sources @("tests\symbolic_ir_test.c", "src\symbolic_ir.c")
