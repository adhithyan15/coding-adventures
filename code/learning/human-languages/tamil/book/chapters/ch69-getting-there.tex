...
% canonical-source-hash: fnv1a64:73fa4c89ecc5051c
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{saṭṭai}, then read \textbf{\ta{கடை}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\ta{வேட்டி}}, then say \emph{vilai}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{puḍavai}, then read \textbf{\ta{பணம்}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\ta{செருப்பு}}, then say \emph{vāṅgu}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{toppi}, then read \textbf{\ta{பை}}
\end{itemize}
