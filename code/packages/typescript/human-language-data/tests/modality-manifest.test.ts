...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3405, // Italian and Persian add two writing bridges apiece to the earlier baseline.
      ...
      voice: 2461, // Italian's legacy opener now exposes its pen dependency.
      ...
      pen: 354, // +4: Italian and Persian each add observe-trace and guided-copy work.
      ...
      drivableLessons: 2461, // Italian's opener leaves the hands-free set.
      ...
      */
      drivablePrefixTotal: 2176, // Persian Chapter 1 removes four more hands-free opening lessons.
      ...
      */
      ...
      unstartableChapters: 215, // Italian and Persian Chapter 1 now honestly start with pen.
      overriddenLessons: 0,
