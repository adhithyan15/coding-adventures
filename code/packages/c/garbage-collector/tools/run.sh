#!/bin/sh
# Build and run the garbage-collector tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c garbage_collector-tests tests/garbage_collector_test.c src/garbage_collector.c
