...
% canonical-source-hash: fnv1a64:152b41647b99a30b
...
\section[sañje]{\kn{ಸಂಜೆ} (sañje) — a Sanskrit word that arrived already worn down}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}sañje\textquotedblright{} — \textquotedblleft{}evening,\textquotedblright{} from Sanskrit sandhyā via Maharashtri Prakrit
  \item \emph{Say it:} the contrast with dina/ratri/madhyāhna — those arrived whole; sañje arrived already worn down
  \item \emph{Say it:} the striking convergence — Hindi's \dv{साँझ}, same Sanskrit root, different Prakrit path, nearly the same sound today
  \item \emph{Recall:} say \emph{hasiru haḷadi}, then read \textbf{\kn{ದಿನ}}
\end{itemize}
