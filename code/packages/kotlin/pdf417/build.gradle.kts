...
dependencies {
    ...
    // Order: leaf → root.  paint-instructions has no local deps;
    // barcode-2d depends on paint-instructions (declared as `implementation`,
    // so NOT transitively re-exported and must be listed explicitly here).
