use alpha_axp_simulator::AlphaState;
use coding_adventures_alpha_axp_gatelevel::AlphaGateSimulator;

fn seeded_state(cpu: &AlphaGateSimulator, raw: u32, seed: usize) -> AlphaState {
...
fn python_full_state_decode_and_fault_corpus_matches() {
    let fixture = include_str!("../../alpha-axp-simulator/tests/python_oracle_hashes.txt");
    let mut count = 0;
    let mut errors = 0;
