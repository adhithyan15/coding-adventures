# Build and run the float-math tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name float_math-tests -Sources @("tests\float_math_test.cpp")
