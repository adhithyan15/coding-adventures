...
// Python interpreter at runtime. The C API symbols (PyModule_Create2,
// PyUnicode_FromStringAndSize, etc.) are provided by the interpreter,
// not by a library we link against. We need to tell the linker:
//
