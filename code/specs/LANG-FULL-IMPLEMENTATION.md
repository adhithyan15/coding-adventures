...
- ✅ **AL14** — direct formal procedures. A name- or value-mode `procedure p`
  ...
  capturing an enclosing value formal or recursively forwarded through its
  active specialised sibling), implemented standard-function, or
