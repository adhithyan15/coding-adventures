...
delimiter, `ON`/`NOT ON OVERFLOW`, a signed / fractional / non-numeric / over-wide
...
index — and a `WITH POINTER p` phrase over a `PIC 9(n)` pointer ARE supported), or a
