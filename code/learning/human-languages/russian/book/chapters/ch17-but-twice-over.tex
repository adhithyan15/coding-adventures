...
% canonical-source-hash: fnv1a64:cf42157548cee9e4
...
\raggedright
  ...
  \item \emph{Recall:} \emph{\ru{сестра}}, which completes the pair as securely as \emph{\ru{брат}} did
...
\begin{itemize}
\raggedright
  \item \textbf{.} — \textbf{\ru{точка}} — the full stop, and the Russian word for it means \emph{a dot}
