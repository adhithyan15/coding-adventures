module github.com/adhithyan15/coding-adventures/code/packages/go/starlark-ast-to-bytecode-compiler
...
require (
	...
	github.com/adhithyan15/coding-adventures/code/packages/go/starlark-parser v0.0.0
