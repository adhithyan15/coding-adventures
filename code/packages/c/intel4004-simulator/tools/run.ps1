# Build and run the intel4004-simulator tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name intel4004_simulator-tests -Sources @("tests\intel4004_simulator_test.c", "src\intel4004_simulator.c")
