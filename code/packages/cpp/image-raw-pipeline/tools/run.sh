#!/bin/sh
# Build and run the image-raw-pipeline tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp image_raw_pipeline-tests tests/image_raw_pipeline_test.cpp
