...
% canonical-source-hash: fnv1a64:dad806973a381ee4
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{haṇṇu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{haṇṇu}, then \emph{dayaviṭṭu haṇṇu koḍi} — \textquotedblleft{}please give a fruit\textquotedblright{}
  \item \emph{Recall:} say \emph{nillu}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{baṭṭe}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{haṇṇu}, then \emph{baṭṭe}, and ask for each one with \emph{dayaviṭṭu}
  \item \emph{Recall:} read \textbf{\kn{ಕೊಡು}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{dīpa}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all three so far, and say which of them a potter makes
  \item \emph{Recall:} say \emph{nōḍu}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{uppu}, then \emph{haṇṇu}, and hear the \emph{p} survive in one and vanish from the other
  \item \emph{Recall:} read \textbf{\kn{ಕೇಳು}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{pustaka}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then sort them into the inherited and the borrowed
  \item \emph{Recall:} say \emph{mātāḍu}
\end{itemize}
