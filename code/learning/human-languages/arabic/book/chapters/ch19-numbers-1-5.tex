...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Before the numbers themselves — an honest correction to a very common mix-up: \textquotedblleft{}Arabic numerals\textquotedblright{} (the digit shapes \textbf{0, 1, 2, 3}...) are \textbf{not} these words, and don't come from Arabic at all.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}wāḥid, ithnān, thalātha, arbaʿa, khamsa\textquotedblright{} — one through five{]}
  \item {[}YOU SAY: the honest correction — \textquotedblleft{}Arabic numerals\textquotedblright{} (the digit SHAPES) are actually Indian in origin, not these Arabic WORDS{]}
\end{itemize}
