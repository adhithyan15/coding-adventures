#!/bin/sh
# Build and run the ct-compare tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c ct_compare-tests tests/ct_compare_test.c src/ct_compare.c
