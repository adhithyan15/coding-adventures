...
# ============================================================================
#
# These tests exercise CodingAdventures::Cas::LocalDiskStore directly, without
...
subtest 'new() creates root directory if absent' => sub {
    ...
    my $newdir = "$base/nested/cas/root";

    ok( ! -d $newdir, 'new directory does not exist yet' );

    my $store = CodingAdventures::Cas::LocalDiskStore->new($newdir);
