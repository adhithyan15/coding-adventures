...
- **അ** = **"a"** — an **independent vowel** (the word starts with a vowel, so
  it gets a full letter).
- **തെ** = "the" — **ത** (tha, a soft *th* as in *this*) with the **"e" vowel
  sign** written *in front* of the consonant.

Left to right: **അ · തെ** = *a-the* →
...
by **echoing the verb** of the question (*vannu*, "[I] came," for "did you
...
introduces:
  knowledge: [ML-LEX-ILLA-01, ML-CONCEPT-C01-NEGATIVE-EXISTENCE-01]
practises:
  knowledge: [ML-LEX-ILLA-01, ML-CONCEPT-C01-NEGATIVE-EXISTENCE-01]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
...
register: neutral
variety: standard-colloquial
reviews_of: [ML-C01-athe, ML-C01-namaskaram]
---
...
[PAUSE 2s] The partner of *athe*, and more family evidence: this Malayalam "no"
is essentially the **same word** as Tamil's *illai* and Kannada's *illa* — the
old Dravidian *il-* runs right through.
...
- **ഇ** = **"i"** — an **independent vowel** (word-initial, so a full letter,
  like **അ** in *athe*).
- **ല്ല** = "lla" — a **conjunct**: **ല** (la) loses its vowel and joins
  another **ല** (la) into a doubled, held "ll."

Left to right: **ഇ · ല്ല** = *i-lla* →

> **ഇല്ല** = **illa**

## The word, taken apart
<!-- hl-knowledge: introduces=[ML-LEX-ILLA-01]; assesses=[] -->
...
| Tamil | *illai* (இல்லை) | the **same** root |
| Kannada | *illa* (ಇಲ್ಲ) | the **same** root |
| Telugu | *lēdu* (లేదు) | native, a **different** root |
| Hindi | *nahīṁ* (नहीं) | Indo-European (unrelated) |

## Grammar Lens: Dravidian negates by *being*
<!-- hl-knowledge: introduces=[ML-CONCEPT-C01-NEGATIVE-EXISTENCE-01]; assesses=[ML-LEX-ILLA-01] -->
...
- **ന** = "na."
- **ന്ദി** = "ndi" — a **conjunct**: **ന** (na) loses its vowel and joins
  **ദ** (da) into "nd," then the **"i" vowel sign** gives "ndi."

Left to right: **ന · ന്ദി** = *na-ndi* →
...
Tamil split from one language about a thousand years ago, so their oldest,
most everyday words are near-twins — and "thanks" is a perfect example:
Malayalam *nandi*, Tamil *naṉṟi*, one word lightly reshaped.

Its neighbours went the other way: Kannada and Telugu use the Sanskrit
*dhanyavāda*. So the map of "thanks" traces the family's fault-line exactly —
...
|---|---|---|
| **Malayalam** | *nandi* (നന്ദി) | **native** (root *nal*, "good") |
| Tamil | *naṉṟi* (நன்றி) | the **same** native root |
| Kannada | *dhanyavāda* (ಧನ್ಯವಾದ) | Sanskrit |
...
- [YOU SAY: the pair across the split — Malayalam *nandi*, Tamil *naṉṟi*]
...
[PAUSE 2s] Five words, and a first handful of Malayalam letters read straight
off the page. Let's gather only what you have already learned and make it feel
easy.
...
Tamil's closest sister — while only the formal greeting reached for Sanskrit.

## Why it's said this way — a promise for later
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-NAMASKARAM-01] -->

Malayalam has a warm departure phrase built around going and coming back. It
...
Malayalam. Next chapter starts introducing yourself, one short possession form
at a time.
`,d=e({default:()=>f}),f=`---
schema_version: 2
id: ML-C01-sari
...
- **ശ** = "śa" — a *sh*-sound (the palatal *ś*). Malayalam, having borrowed so
  much Sanskrit, keeps the full set of Sanskrit sibilants (*ś, ṣ, s*) as
  separate letters — more than Tamil, which makes do with one.
- **രി** = "ri" — **ര** (ra) with the **"i" vowel sign**.

Left to right: **ശ · രി** = *śa-ri* →
...
Kannada as *sari* and Telugu as *sarē*; Malayalam simply spells its opening
...
[PAUSE 1s]
- [YOU SAY: śa · ri → "śari"]
- [YOU SAY: the everyday triple — *athe* (yes) · *illa* (no) · *śari* (okay)]
...
## The word, taken apart
<!-- hl-knowledge: introduces=[ML-LEX-AANU-01]; assesses=[] -->
...
duration:
  max_seconds: 180
requires:
  knowledge: [ML-LEX-PERU-01, ML-LEX-ENRE-01, ML-LEX-AANU-01]
introduces:
  knowledge: [ML-PHRASE-C02-MY-NAME-IS-01]
practises:
  knowledge: [ML-PHRASE-C02-MY-NAME-IS-01, ML-CONCEPT-C02-COPULA-01]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus]
register: neutral
...
## The word, taken apart
<!-- hl-knowledge: introduces=[ML-LEX-ENRE-01]; assesses=[] -->
...
## The word, taken apart
<!-- hl-knowledge: introduces=[ML-LEX-ENTU-01]; assesses=[] -->
...
## The word, taken apart
<!-- hl-knowledge: introduces=[ML-LEX-NII-NINGAL-01]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[ML-CONCEPT-C02-RESPECT-BY-PLURAL-01]; assesses=[ML-LEX-NII-NINGAL-01] -->
...
duration:
  max_seconds: 180
requires:
  knowledge: [ML-LEX-ENTU-01, ML-LEX-NII-NINGAL-01]
introduces:
  knowledge: [ML-PHRASE-C02-WHATS-YOUR-NAME-01]
practises:
  knowledge: [ML-PHRASE-C02-WHATS-YOUR-NAME-01, ML-CONCEPT-C02-RESPECT-BY-PLURAL-01]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus]
register: neutral
...
## The phrase, taken apart
<!-- hl-knowledge: introduces=[ML-PHRASE-C02-WHATS-YOUR-NAME-01]; assesses=[] -->
...
type: word
headword: "പെൺകുട്ടി"
romanization: "peṇkuṭṭi"
gloss: "a girl"
concept_tag: ML-ANCHOR-PENKUTTI
...
practises:
  knowledge: [ML-LEX-ANCHOR-PENKUTTI, ML-SCRIPT-RECOG-07]
skills: [listening, speaking, reading]
...
## You'll want to know: പെൺകുട്ടി
<!-- hl-knowledge: introduces=[ML-LEX-ANCHOR-PENKUTTI]; assesses=[] -->

**പെൺകുട്ടി** — *peṇkuṭṭi* — "a girl".

Say it: *peṇkuṭṭi*. Look at its shape as you say it: the next lesson takes one
piece of it, **ൺ**, and writes it on its own.
...
[PAUSE 1s]
- [YOU SAY: *peṇkuṭṭi*]
- [YOU SAY: *peṇkuṭṭi*, and what it means]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-ANCHOR-PENKUTTI] -->

[PAUSE 3s] What is "a girl"? (**പെൺകുട്ടി**, *peṇkuṭṭi*.)
`,D=e({default:()=>O}),O=`---
schema_version: 2
id: ML-C02-peru
spine_node: SPINE-EXCHANGE-NAMES
...
introduces:
  knowledge: [ML-LEX-ANCHOR-PULI]
practises:
  knowledge: [ML-LEX-ANCHOR-PULI, ML-SCRIPT-RECOG-06]
skills: [listening, speaking, reading]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral
...
## You'll want to know: പുലി
<!-- hl-knowledge: introduces=[ML-LEX-ANCHOR-PULI]; assesses=[] -->

**പുലി** — *puli* — "a tiger".

Say it: *puli*. Look at its shape as you say it: the next lesson takes one
piece of it, **ു**, and writes it on its own.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-ANCHOR-PULI] -->

[PAUSE 1s]
- [YOU SAY: *puli*]
- [YOU SAY: *puli*, and what it means]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-ANCHOR-PULI] -->

[PAUSE 3s] What is "a tiger"? (**പുലി**, *puli*.)
`,N=e({default:()=>P}),P=`---
schema_version: 2
id: ML-C02-santosham
spine_node: SPINE-EXCHANGE-NAMES
...
## Script: two new shapes to notice
<!-- hl-knowledge: introduces=[]; assesses=[] -->
