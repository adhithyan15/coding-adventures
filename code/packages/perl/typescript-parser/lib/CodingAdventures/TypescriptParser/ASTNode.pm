package CodingAdventures::TypescriptParser::ASTNode;

# ============================================================================
# CodingAdventures::TypescriptParser::ASTNode — AST node for the TS parser
# ============================================================================
#
# Every node in the TypeScript Abstract Syntax Tree is an instance of this
...
#     children  => [],
#     is_leaf   => 1,
#     token     => { type => "LET", value => "let", line => 1, col => 1 },
#   }
#
...
#
# Arguments:
#   $token  hashref  — a token as produced by CodingAdventures::TypescriptLexer
...
CodingAdventures::TypescriptParser::ASTNode - AST node for the TypeScript parser
...
=head1 SYNOPSIS
    ...
    # Inner node
    my $node = CodingAdventures::TypescriptParser::ASTNode->new('if_stmt', \@children);
    print $node->rule_name;   # "if_stmt"
    print $node->is_leaf;     # 0

    # Leaf node
    my $leaf = CodingAdventures::TypescriptParser::ASTNode->new_leaf($token);
    print $leaf->is_leaf;         # 1
    print $leaf->token->{value};  # e.g. "let"

=head1 DESCRIPTION

Lightweight AST node class used by C<CodingAdventures::TypescriptParser>.
