...
describe("the committed corpus", () => {
  it("pins the first measurement", () => {
    ...
    expect(r.summary.worstTerms.slice(0, 2)).toEqual([
      { term: "verb", lessons: 1016 }, // spanish pre-A1 survival tranche: +15 lessons, +3 chapters (chapters 303-305): +2 // Marathi's explicit review sessions retrieve its verb families at distance.
      { term: "noun", lessons: 533 }, // spanish pre-A1 survival tranche: +15 lessons, +3 chapters (chapters 303-305): +2 // Marathi's family review explicitly contrasts the noun histories.
