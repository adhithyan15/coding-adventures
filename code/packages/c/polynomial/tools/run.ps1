# Build and run the polynomial tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name polynomial-tests -Sources @("tests\polynomial_test.c", "src\polynomial.c")
