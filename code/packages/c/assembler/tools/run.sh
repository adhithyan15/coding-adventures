#!/bin/sh
# Build and run the assembler tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c assembler-tests tests/assembler_test.c src/assembler.c
