...
% canonical-source-hash: fnv1a64:1f100d9d6e561849
...
The word has a second life you should meet now, because you will hear it far more often than the first. Said alone, \textbf{\mr{बरोबर}} means \textbf{that's right} — agreement, confirmation, \emph{correct}. It is built on the same base as \textbf{\mr{बरं}}, the \emph{fine, good} of chapter four: \textbf{\mr{बरोबर}} is \emph{good-alongside}, and a thing that lines up alongside another is both \emph{with} it and \emph{right}.
...
Say the middle form of each line aloud. Each one is \textbf{\mr{माझं} / \mr{तुझं} / \mr{तुमचं}} with its ending changed to \textbf{-\mr{या}}, which is exactly what a noun in \textbf{-\mr{ए}} did back in chapter forty-one. The machinery is the same; only the starting form is different, and the starting form is the possessive.
