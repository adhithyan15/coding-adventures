...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} You already met Malayalam's native word for \textquotedblleft{}day\textquotedblright{} back in Chapter 4 — hiding inside \textquotedblleft{}tomorrow.\textquotedblright{} This lesson gives it, and its Sanskrit rival, their own honest reckoning.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}divasam\textquotedblright{} — \textquotedblleft{}day,\textquotedblright{} the everyday counting word{]}
  \item {[}YOU SAY: \textquotedblleft{}dinam\textquotedblright{} — the same Sanskrit word as Kannada's dina, but formal here{]}
\end{itemize}
