# Build and run the scytale-cipher tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name scytale_cipher-tests -Sources @("tests\scytale_cipher_test.cpp")
