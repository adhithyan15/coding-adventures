...
func EncodeSlli(rd, rs1, shamt int) uint32 {
	return uint32((Funct7Normal << 25) | ((shamt & 0x1F) << 20) | (rs1 << 15) | (Funct3SLLI << 12) | (rd << 7) | OpcodeOpImm)
}

// EncodeSrli encodes: srli rd, rs1, shamt  (shift right logical immediate)
func EncodeSrli(rd, rs1, shamt int) uint32 {
	return uint32((Funct7Normal << 25) | ((shamt & 0x1F) << 20) | (rs1 << 15) | (Funct3SRLI << 12) | (rd << 7) | OpcodeOpImm)
}
...
func EncodeSrai(rd, rs1, shamt int) uint32 {
	return uint32((Funct7Alt << 25) | ((shamt & 0x1F) << 20) | (rs1 << 15) | (Funct3SRLI << 12) | (rd << 7) | OpcodeOpImm)
}
...
func EncodeJal(rd, offset int) uint32 {
	...
	return uint32((bit20 << 31) | (bits10_1 << 21) | (bit11 << 20) | (bits19_12 << 12) | (rd << 7) | OpcodeJAL)
}
...
func EncodeJalr(rd, rs1, imm int) uint32 {
	return encodeIType(rd, rs1, imm, 0, OpcodeJALR)
}
