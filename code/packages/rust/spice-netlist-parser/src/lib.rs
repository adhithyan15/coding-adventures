...
fn parse_element(
    ...
    match prefix {
        ...
        'Q' => {
            ...
            let reverse_early_voltage = model
                .params
                .get("VAR")
                .or_else(|| model.params.get("VB"))
                .copied()
                .unwrap_or(0.0);
            if !reverse_early_voltage.is_finite() || reverse_early_voltage < 0.0 {
                return Err(NetlistParseError::new(
        ...
        'J' => {
            ...
            let source_resistance = *model.params.get("RS").unwrap_or(&0.0);
            if !source_resistance.is_finite() || source_resistance < 0.0 {
                return Err(NetlistParseError::new(
