...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      voice: 2465, // +2: Marwadi synthesis lessons include voice
      ...
      drivableLessons: 2465, // +2: Marwadi synthesis lessons remain drivable
