...
- **Phase 88 — Five-Sqrt × Six-Log × polynomial numerator** (`_five_sqrt_six_log_poly_effective_x2`):
  ...
  - 3 new unit tests in `TestPhase88FiveSqrtSixLogPoly`.

## 2.24.0 — 2026-05-26

### Added

- **Phase 87 — Four-Sqrt × Six-Log × polynomial numerator** (`_four_sqrt_six_log_poly_effective_x2`):
  ...
  Closes when `2·den_deg > effective_x2` or non-polynomial diverging denominator.
  - 3 new unit tests in `TestPhase87FourSqrtSixLogPoly`.
