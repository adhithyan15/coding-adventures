...
% canonical-source-hash: fnv1a64:e8c0cbbb1a8192a3
...
The \emph{tū / vōs} lesson made a point of it: in Classical Latin the difference is \textbf{number only}, with no politeness in it at all. This is \emph{tū}'s possessive, and it inherits that: \textbf{tuus} is not familiar or rude; it means only that the thing belongs to one person. For several, Latin says \textbf{vester}.
