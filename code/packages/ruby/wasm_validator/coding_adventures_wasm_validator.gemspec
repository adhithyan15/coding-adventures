...
require_relative "lib/coding_adventures/wasm_validator/version"

Gem::Specification.new do |spec|
  spec.name          = "coding_adventures_wasm_validator"
  spec.version       = CodingAdventures::WasmValidator::VERSION
  spec.authors       = ["Adhithya Rajasekaran"]
  spec.summary       = "WebAssembly 1.0 wasm-validator"
