# Build and run the wall-clock tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name wall_clock-tests -Sources @("tests\wall_clock_test.cpp")
