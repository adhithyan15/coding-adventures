...
% canonical-source-hash: fnv1a64:7a326ee718273b94
% canonical-lessons: BN-W02-ami-read, BN-W02-la, BN-W02-e-matra, BN-C06-eka, BN-W04-e-indep, BN-W03-o-matra, BN-W02-kemon-read
...
\begin{quote}
Write \textbf{\bn{ি}} once, and say which side of its consonant it goes on. Then read \textbf{\bn{হ্যাঁ}}, and name the piece in it that makes no sound.
\end{quote}
...
Source: \href{https://www.unicode.org/charts/PDF/U0980.pdf}{Unicode Bengali chart}.
\end{tcolorbox}
\section[ekā]{\bn{একা} (ekā) — alone}

\label{lesson:BN-C06-eka}
...
\subsection*{You'll want to know: \bn{একা}}
\textbf{\bn{একা}} — \emph{ekā} — \textquotedblleft{}alone\textquotedblright{}.

Say it: \emph{ekā}. Look at its shape as you say it: the next lesson takes one piece of it, \textbf{\bn{এ}}, and writes it on its own.
...
\raggedright
  \item \emph{ekā}
  \item \emph{ekā}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}alone\textquotedblright{}? (\textbf{\bn{একা}}, \emph{ekā}.)
\end{tcolorbox}
...
\raggedright
  ...
  \item \emph{Read it:} \bn{হ্যাঁ} \bn{না}
