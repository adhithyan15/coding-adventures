...
// specExample represents one entry in the GFM spec test suite.
...
// TestGFMSpec runs all 652 GFM 0.31.2 spec examples.
//
...
func TestGFMSpec(t *testing.T) {
	...
	t.Logf("Running %d GFM 0.31.2 spec examples", len(examples))
