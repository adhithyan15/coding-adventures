#!/bin/sh
# Build and run the note-frequency tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c note_frequency-tests tests/note_frequency_test.c src/note_frequency.c
