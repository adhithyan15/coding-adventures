...
describe("the committed corpus", () => {
  ...
  it("pins the first measurement", () => {
    ...
    expect(report.summary.lessons).toBe(1727); // +8: HL-C94 payoff lessons // +4: HL-C98
    ...
    expect(report.summary.paradigmTables).toBe(91);
    expect(report.summary.fullParadigmGrids).toBe(18);
    expect(report.summary.lessonsWithFindings).toBe(105);
  });
