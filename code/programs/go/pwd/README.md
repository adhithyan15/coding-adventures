# pwd -- Print Working Directory (Go)

A reimplementation of the POSIX `pwd` utility in Go, powered by [CLI Builder](../../../packages/go/cli-builder/).
...
```
pwd.json (declarative spec)     main.go (business logic only)
+-------------------------+     +-----------------------------+
