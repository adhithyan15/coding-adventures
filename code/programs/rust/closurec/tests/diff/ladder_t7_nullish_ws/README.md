# ladder_t7_nullish_ws

Rung 7.nullish of the CCR-066 differential complexity ladder, at `WHITESPACE_ONLY`.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level WHITESPACE_ONLY --js tests/diff/ladder_t7_nullish_ws/input/a.js
```
