...
describe("real curriculum", () => {
  ...
  it("preserves every existing LaTeX book and maps each chapter to short lessons", () => {
    ...
    // 37 -> 39: the final verb tranche added Chapters 38 (traer, conseguir, jugar,
    // conocer — the four whose yo-form or stem misbehaves) and 39 (esperar, contestar,
    // comprar — the three that are regular, where the whole difficulty is meaning).
    // Split 4+3 to stay inside maxNewAtomsPerChapter, again on SPINE-SAY-WHAT-I-DO.
