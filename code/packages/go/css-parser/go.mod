module github.com/adhithyan15/coding-adventures/code/packages/go/css-parser

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/css-lexer v0.0.0
...
replace github.com/adhithyan15/coding-adventures/code/packages/go/css-lexer => ../css-lexer
