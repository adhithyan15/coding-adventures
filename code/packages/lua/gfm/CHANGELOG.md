# Changelog — coding-adventures-gfm (Lua)
...
- Initial release of the Lua GFM 0.31.2 pipeline package.
- `to_html(source, opts)` — parses Markdown and renders to HTML in one call.
- Wires together `coding-adventures-gfm-parser` and
...
- 652/652 GFM 0.31.2 specification examples pass
  (test file `tests/test_commonmark_spec.lua`).
- LuaRocks rockspec (`coding-adventures-gfm-0.1.0-1.rockspec`).
