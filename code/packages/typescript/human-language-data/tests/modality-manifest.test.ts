...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3402, // +1: French's guided-copy bridge
      ...
      voice: 2462, // French's opener now exposes its pen dependency too
      ...
      pen: 350, // +2: French's opener trace and guided copy
      ...
      drivableLessons: 2462, // French's opener leaves the hands-free set too.
      ...
      unstartableChapters: 213, // French chapter 1 now honestly starts with pen too.
      overriddenLessons: 0,
