...
This is the Rust port of the CPU cache simulator. It sits at layer 8 of the accelerator stack, above the arithmetic units and below the CPU pipeline. The cache hierarchy connects the CPU core to main memory, providing fast access to recently used data.
