...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}ek, dui, tin, chār, pā̃ch\textquotedblright{}{]}
  \item {[}YOU SAY: the twos — \textquotedblleft{}dvá- … do … don … \textbf{dui}\textquotedblright{}{]}
  \item {[}YOU SAY: the Ch. 1 echo — \textquotedblleft{}\textbf{no}moshkar, not \textbf{na}maskār\textquotedblright{}{]}
\end{itemize}
