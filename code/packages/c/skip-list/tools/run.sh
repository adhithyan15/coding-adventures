#!/bin/sh
# Build and run the skip-list tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c skip_list-tests tests/skip_list_test.c src/skip_list.c
