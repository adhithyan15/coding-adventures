 ...
 *          ↓ depends on both
 *   @coding-adventures/commonmark           ← you are here
...
export { parse } from "@coding-adventures/commonmark-parser";
export type { ParseOptions } from "@coding-adventures/commonmark-parser";
