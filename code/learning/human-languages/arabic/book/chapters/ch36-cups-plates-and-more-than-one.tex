...
% canonical-source-hash: fnv1a64:f033a258adce55f6
% canonical-lessons: AR-C36-zayt, AR-C36-kub, AR-C36-tabaq, AR-C36-milaqa, AR-R36-the-family-and-the-body-again
...
\end{tcolorbox}
\section[yad · ab · ukht]{The hand that holds the spoon}

\label{lesson:AR-R36-the-family-and-the-body-again}



\begin{quote}
Pick up the spoon this chapter gave you and name the part of the body doing it. Then name the one at the other end. Both words came once, a long way back.
\end{quote}

\begin{tcolorbox}[breakable,skin=enhanced,colback=violet!6,colframe=violet!45!black,boxrule=0.5pt,arc=1mm,left=6pt,right=6pt,top=4pt,bottom=4pt,fonttitle=\bfseries,title={Across the family: the inherited stock}]
\noindent
...
\textbf{\ar{أخ}} / \textbf{\ar{أخت}} \emph{akh / ukht} & brother / sister & \textbf{\he{אח}} \emph{ach} \\
\bottomrule
\end{tabularx}

Neither language borrowed these from the other; both inherited them. \textbf{\ar{يد}} has barely moved at all — two letters, one syllable, and its Hebrew cousin is said almost the same way after several thousand years.

\textbf{\ar{أخت}} is \textbf{\ar{أخ}} with one letter added. Set that beside the colour words, which needed a whole reshaped template to change gender, and the contrast is the point: the oldest words take the cheapest endings.
\end{tcolorbox}

\begin{culture}
\textbf{\ar{رئيس}} \emph{raʾīs}, \textbf{president} or \textbf{chief}, is built on \emph{head} with nothing borrowed — Arabic reached for its own oldest word, the way English reached for Latin \emph{caput} to make \emph{capital} and \emph{captain}.

\textbf{\ar{أم}} and \textbf{\ar{أبو}} are still forming names today. Add a child's name and you have a \textbf{kunya}: \emph{mother of} and \emph{father of}, used as an honorific in ordinary speech.
\end{culture}

\subsection*{Script: the two halves of the farewell}
Write these out:

\begin{itemize}
\raggedright
  \item \textbf{\ar{مع}} — \emph{mīm}, round head, joining left into \emph{ʿayn}
  \item \textbf{\ar{السلامة}} — \textbf{\ar{الـ}}, then \emph{sīn · lām · alif · mīm}, then the tied \textbf{\ar{ة}}
\end{itemize}

\textbf{\ar{مع}} needed no new letters when you first wrote it. And \textbf{\ar{السلامة}} is not a new word: it is \textbf{\ar{الـ}} wrapped round the very first word you learned to draw, with a tied \emph{tāʾ} closing it — the same \textbf{\ar{ة}} that closes \textbf{\ar{ملعقة}}, the spoon in your hand.

\subsection*{Your turn}
\begin{itemize}
\raggedright
  \item \emph{Say it:} hand, head — \emph{yad}, \emph{raʾs}
  \item \emph{Say it:} the four relatives — \emph{ab}, \emph{umm}, \emph{akh}, \emph{ukht}
  \item \emph{Recall:} the word for president, and the body part underneath it
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Name the word in this set that has changed least from its Hebrew cousin. (\textbf{\ar{يد}}.) Say what separates \textbf{\ar{أخ}} from \textbf{\ar{أخت}}. (\textbf{One added letter}.) Name the letter that closes both \textbf{\ar{السلامة}} and \textbf{\ar{ملعقة}}. (\textbf{\ar{ة}}, the tied \emph{tāʾ}.) And give the chief built on the word for head. (\textbf{\ar{رئيس}}.)
\end{tcolorbox}
