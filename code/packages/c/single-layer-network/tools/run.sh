#!/bin/sh
# Build and run the single-layer-network tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c single_layer_network-tests tests/single_layer_network_test.c src/single_layer_network.c
