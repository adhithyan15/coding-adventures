...
% canonical-source-hash: fnv1a64:7926d3d5718394ad
...
\section[gheṇe]{\mr{घेणे} (gheṇe) — \textquotedblleft{}to take,\textquotedblright{} which you have been saying since Chapter 5}
...
\begin{culture}
Chapter 7's rule holds here: neither language is simply older. Marathi's \textbf{\mr{दोन}} took its final \emph{n} by copying \textbf{\mr{तीन}} — an innovation. Hindi's \textbf{\mr{पाँच}} kept a nasal Marathi dropped — a retention. Now a verb: Marathi kept its native word for liking, Hindi took a Persian one.
\end{culture}
