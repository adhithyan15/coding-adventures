# Build and run the wasm-leb128 tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name wasm_leb128-tests -Sources @("tests\wasm_leb128_test.c", "src\wasm_leb128.c")
