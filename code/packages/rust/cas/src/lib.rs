...
//!
//! ```rust
//! use coding_adventures_cas::{ContentAddressableStore, LocalDiskStore, key_to_hex};
...
///
/// ```
/// use coding_adventures_cas::key_to_hex;
...
///
/// ```
/// use coding_adventures_cas::{key_to_hex, hex_to_key};
...
impl<S: BlobStore> ContentAddressableStore<S> {
    ...
    ///
    /// ```rust
    /// use coding_adventures_cas::{ContentAddressableStore, LocalDiskStore, CasError};
...
impl LocalDiskStore {
    ...
    ///
    /// ```rust
    /// use coding_adventures_cas::LocalDiskStore;
