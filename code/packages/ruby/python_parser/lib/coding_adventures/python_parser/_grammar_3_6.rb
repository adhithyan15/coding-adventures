  ...
  rules: [
    ...
    GT::GrammarRule.new(
      ...
      body: GT::Alternation.new(choices: [
        ...
        GT::RuleReference.new(name: "annotated_assign_stmt", is_token: false),
    ...
    GT::GrammarRule.new(
      ...
      body: GT::Sequence.new(elements: [
        ...
        GT::Group.new(element: GT::Alternation.new(choices: [
            GT::RuleReference.new(name: "dotted_name", is_token: false),
            GT::RuleReference.new(name: "relative_import", is_token: false),
          ])),
        GT::Literal.new(value: "import"),
        GT::Group.new(element: GT::Alternation.new(choices: [
    ...
    GT::GrammarRule.new(
      ...
      body: GT::Sequence.new(elements: [
        ...
        GT::OptionalElement.new(element: GT::RuleReference.new(name: "dotted_name", is_token: false)),
      ]),
      line_number: 116,
    ),
    GT::GrammarRule.new(
    ...
    GT::GrammarRule.new(
      ...
      body: GT::Alternation.new(choices: [
        ...
        GT::RuleReference.new(name: "decorated_stmt", is_token: false),
    ...
    GT::GrammarRule.new(
      ...
      body: GT::Sequence.new(elements: [
        ...
        GT::Group.new(element: GT::Alternation.new(choices: [
            GT::RuleReference.new(name: "async_def_stmt", is_token: false),
            GT::RuleReference.new(name: "async_for_stmt", is_token: false),
            GT::RuleReference.new(name: "async_with_stmt", is_token: false),
          ])),
      ]),
      line_number: 461,
    ),
    ...
    GT::GrammarRule.new(
      name: "target_list",
      body: GT::Sequence.new(elements: [
        GT::RuleReference.new(name: "target_item", is_token: false),
        GT::Repetition.new(element: GT::Sequence.new(elements: [
            GT::RuleReference.new(name: "COMMA", is_token: true),
            GT::RuleReference.new(name: "target_item", is_token: false),
          ])),
    ...
    GT::GrammarRule.new(
      ...
      body: GT::Alternation.new(choices: [
        ...
        GT::RuleReference.new(name: "IMAGINARY", is_token: true),
        GT::RuleReference.new(name: "string_atom", is_token: false),
        ...
        GT::RuleReference.new(name: "dict_set_expr", is_token: false),
    ...
    GT::GrammarRule.new(
      ...
      body: GT::Sequence.new(elements: [
        ...
        GT::Repetition.new(element: GT::RuleReference.new(name: "fstring_part", is_token: false)),
    ...
    GT::GrammarRule.new(
      ...
      body: GT::Alternation.new(choices: [
        ...
        GT::RuleReference.new(name: "fstring_expr", is_token: false),
      ]),
      line_number: 835,
    ),
    GT::GrammarRule.new(
      name: "fstring_expr",
      body: GT::Sequence.new(elements: [
        GT::RuleReference.new(name: "LBRACE_EXPR", is_token: true),
        GT::RuleReference.new(name: "expression", is_token: false),
        ...
        GT::RuleReference.new(name: "RBRACE_EXPR", is_token: true),
      ]),
      line_number: 849,
    ),
    GT::GrammarRule.new(
      ...
      body: GT::Sequence.new(elements: [
        GT::RuleReference.new(name: "EXCL", is_token: true),
        GT::RuleReference.new(name: "NAME", is_token: true),
      ]),
      line_number: 854,
    ),
    ...
    GT::GrammarRule.new(
      ...
      body: GT::Sequence.new(elements: [
        ...
        GT::OptionalElement.new(element: GT::RuleReference.new(name: "dict_set_body", is_token: false)),
