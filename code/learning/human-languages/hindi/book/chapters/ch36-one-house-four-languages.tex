...
% canonical-source-hash: fnv1a64:171cf74b87f67037
% canonical-lessons: HI-C36-ghar, HI-C36-darvaaza, HI-C36-kamra, HI-C36-kursi, HI-S147-letter-na-retroflex
...
\section[ghar]{\hi{घर} (ghar) — \textquotedblleft{}house,\textquotedblright{} and the fence that came first}
...
\end{tcolorbox}
\section[darvāzā]{\hi{दरवाज़ा} (darvāzā) — the door, and the oldest word you already know}
...
\end{tcolorbox}
\section[kamrā]{\hi{कमरा} (kamrā) — the room that is also a camera}
