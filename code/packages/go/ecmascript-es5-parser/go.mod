module github.com/adhithyan15/coding-adventures/code/packages/go/ecmascript-es5-parser

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/ecmascript-es5-lexer v0.0.0
...
replace github.com/adhithyan15/coding-adventures/code/packages/go/ecmascript-es5-lexer => ../ecmascript-es5-lexer
