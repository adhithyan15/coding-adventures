...
const fallbackProps = {
  "addNoteLabel": "add-note-label",
  "addNoteTypeLabel": "add-note-type-label",
  "collectionLabel": "collection-label",
  "deleteNoteDisabled": false,
  "deleteNoteLabel": "delete-note-label",
  "deleteNoteTypeDisabled": false,
  "deleteNoteTypeLabel": "delete-note-type-label",
  "exportLabel": "export-label",
  "importLabel": "import-label",
  "mediaCountLabel": "media-count-label",
  "mediaCountValue": "media-count-value",
  "missingMediaFilenames": [],
  "missingMediaLabel": "missing-media-label",
  "missingMediaValue": "missing-media-value",
  "noteCountLabel": "note-count-label",
  "noteCountValue": "note-count-value",
  "noteTypeCountLabel": "note-type-count-label",
  "noteTypeCountValue": "note-type-count-value",
  "pruneUnusedMediaLabel": "prune-unused-media-label",
  "referencedMediaLabel": "referenced-media-label",
  "referencedMediaValue": "referenced-media-value",
  "unusedMediaAssetIds": [],
  "unusedMediaLabel": "unused-media-label",
  "unusedMediaValue": "unused-media-value"
};
const emitPayloads = {
  "onAddNote": [],
  "onAddNoteType": [],
