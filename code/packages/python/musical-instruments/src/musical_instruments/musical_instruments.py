...
_GM_PROGRAM_ROWS: tuple[tuple[int, str, str, str], ...] = (
    ...
    (9, "Celesta", "chromatic percussion", "mallet_naive"),
    (10, "Glockenspiel", "chromatic percussion", "mallet_naive"),
    (11, "Music Box", "chromatic percussion", "mallet_naive"),
    (12, "Vibraphone", "chromatic percussion", "mallet_naive"),
    (13, "Marimba", "chromatic percussion", "mallet_naive"),
    (14, "Xylophone", "chromatic percussion", "mallet_naive"),
    (15, "Tubular Bells", "chromatic percussion", "mallet_naive"),
    ...
    (48, "Timpani", "strings", "mallet_naive"),
    ...
    (109, "Kalimba", "ethnic", "mallet_naive"),
    (110, "Bagpipe", "ethnic", "clarinet_naive"),
    (111, "Fiddle", "ethnic", "violin_naive"),
    (112, "Shanai", "ethnic", "clarinet_naive"),
    (113, "Tinkle Bell", "percussive", "mallet_naive"),
    (114, "Agogo", "percussive", "mallet_naive"),
    (115, "Steel Drums", "percussive", "mallet_naive"),
    (116, "Woodblock", "percussive", "mallet_naive"),
    (117, "Taiko Drum", "percussive", "mallet_naive"),
    (118, "Melodic Tom", "percussive", "mallet_naive"),
