...
% canonical-source-hash: fnv1a64:681e7532314008c9
% canonical-lessons: KA-C31-shubha-madhyahna, KA-C31-krushi, KA-S131-vowel-sign-vocalic-r
...
\end{tcolorbox}
\section[kṛṣi]{\kn{ಕೃಷಿ} (kṛṣi) — farming}

\label{lesson:KA-C31-krushi}
...
\subsection*{You'll want to know: \kn{ಕೃಷಿ}}
\textbf{\kn{ಕೃಷಿ}} — \emph{kṛṣi} — \textquotedblleft{}farming\textquotedblright{}.

Say it: \emph{kṛṣi}. Look at its shape as you say it: the next lesson takes one piece of it, \textbf{\kn{ೃ}}, and writes it on its own.
...
\raggedright
  \item \emph{kṛṣi}
  \item \emph{kṛṣi}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}farming\textquotedblright{}? (\textbf{\kn{ಕೃಷಿ}}, \emph{kṛṣi}.)
\end{tcolorbox}
