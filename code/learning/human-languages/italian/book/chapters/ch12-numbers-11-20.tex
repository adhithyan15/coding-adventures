...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} True to form, Italian keeps the teens \textbf{closest to Latin} — so close that the word for \textquotedblleft{}ten\textquotedblright{} is still sitting in plain sight inside each one. Where French wore \emph{decem} down to a bare \textbf{-ze}, Italian kept \textbf{-dici}.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}undici, dodici, tredici, quattordici, quindici, sedici\textquotedblright{}{]}
  \item {[}YOU SAY: the ten inside — \textquotedblleft{}-dici = \emph{decem} = \textbf{dieci}\textquotedblright{}{]}
  \item {[}YOU SAY: the three-sister line — \textquotedblleft{}sedici / seize / dezesseis, one Latin word\textquotedblright{}{]}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: 16$\to$20 — \textquotedblleft{}sedici, diciassette, diciotto, diciannove, venti\textquotedblright{}{]}
  \item {[}YOU SAY: the turn — \textquotedblleft{}\emph{se}-dici (six-ten) $\to$ \emph{dici}-assette (ten-seven)\textquotedblright{}{]}
