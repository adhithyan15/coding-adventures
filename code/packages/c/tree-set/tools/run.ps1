...
$env:ISO_INCLUDE = "include ..\avl-tree\include $harness\include"
. (Join-Path $harness 'lib\iso-lib.ps1')
Iso-BuildAndRun -Lang c -Name tree_set-tests -Sources @("tests\tree_set_test.c", "src\tree_set.c", "..\avl-tree\src\avl_tree.c")
