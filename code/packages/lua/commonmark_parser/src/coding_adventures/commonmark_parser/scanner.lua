...
-- CommonMark defines Unicode punctuation as: ASCII punctuation OR any
...
-- This covers the characters tested by the CommonMark spec test suite.
--
...
--
-- CommonMark §4.7: normalization uses Unicode case-folding. Lua's
