# Build and run the huffman-compression tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name huffman_compression-tests -Sources @("tests\huffman_compression_test.c", "src\huffman_compression.c")
