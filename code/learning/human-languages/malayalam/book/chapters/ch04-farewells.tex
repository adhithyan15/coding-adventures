...
% canonical-insertion: ML-S110-letter-va
\section[The letter va]{\ml{വ} --- one character, met inside a word you already say}
\label{lesson:ML-S110-letter-va}

\begin{sounds}
\ml{വ} is \emph{va}, a consonant, so it already carries a short \emph{a}. Every farewell this chapter is heading for is built on \ml{വരിക} \emph{varika}, ``to come,'' so the shape is worth having in hand first.
Find \ml{വ} in \ml{വരിക}, copy the shape three times while you say \emph{va},
then look back through this chapter and find it once more.
\end{sounds}

% canonical-insertion: ML-S116-letter-u
\section[The letter u]{\ml{ഉ} --- one character, met inside a word you already say}
\label{lesson:ML-S116-letter-u}

\begin{sounds}
\ml{ഉ} is \emph{u}, an independent vowel --- the shape this vowel takes when a word \emph{begins} with it. Every Malayalam verb you are about to meet ends in \ml{ഉക} \emph{-uka}, and this is the vowel that opens that ending. You already read its sign form, \ml{ു}, in the name \ml{അരുൺ}.
Find \ml{ഉ} in \ml{ഉക}, copy the shape three times while you say \emph{u},
then look back through this chapter and find it once more.
\end{sounds}
...
% canonical-insertion: ML-S141-vowel-sign-uu
\section[The long u sign]{\ml{ൂ} --- one character, met inside a word you already say}
\label{lesson:ML-S141-vowel-sign-uu}

\begin{sounds}
\ml{ൂ} is \emph{ū}, a vowel sign; it never stands alone, and it replaces the \emph{a} built into the consonant it leans on. It is the long partner of \ml{ു}: same place under the consonant, same vowel, held longer, and the shape grows a second loop to say so. It makes the short command \ml{വരൂ} \emph{varū}, ``come!''
Find \ml{ൂ} in \ml{വരൂ}, copy the shape three times while you say \emph{ū},
then look back through this chapter and find it once more.
\end{sounds}
