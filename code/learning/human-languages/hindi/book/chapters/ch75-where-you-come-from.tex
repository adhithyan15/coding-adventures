...
% canonical-source-hash: fnv1a64:98daa7351b2bf7cd
...
\begin{quote}
Two words back, from the last run of five: what does \emph{ghās} mean, and what is \textbf{\hi{कुआँ}}? You have since filled in a \hi{नाम} line without a model, and a form asks for more than a name. The next five words are what it asks for.
\end{quote}
