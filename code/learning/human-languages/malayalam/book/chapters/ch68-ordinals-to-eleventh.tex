...
% canonical-source-hash: fnv1a64:1450f5631ee92739
...
\textbf{\ml{ആറാം} \ml{ദിവസം}} (\emph{āṟāṁ divasaṁ}), the sixth day.
...
\raggedright
  ...
  \item \emph{āṟāṁ divasaṁ} — the sixth day
\end{itemize}
...
\textbf{\ml{ഏഴാം} \ml{ദിവസം}} (\emph{ēḻāṁ divasaṁ}), the seventh day.
...
\textbf{\ml{എട്ടാം} \ml{ദിവസം}} (\emph{eṭṭāṁ divasaṁ}), the eighth day.
...
\textbf{\ml{ഒമ്പതാം} \ml{ദിവസം}} (\emph{ompathāṁ divasaṁ}), the ninth day.
...
\textbf{\ml{പത്താം} \ml{ദിവസം}} (\emph{pathāṁ divasaṁ}), the tenth day.
...
\end{tcolorbox}
\section[patinonnāṁ]{\ml{പതിനൊന്നാം} (patinonnāṁ) — eleventh, and the edge that is not there}
...
\textbf{\ml{പതിനൊന്നാം}} (\emph{patinonnāṁ}) — \textquotedblleft{}\textbf{eleventh}\textquotedblright{}.
...
\textbf{\ml{പതിനൊന്നാം} \ml{ദിവസം}} (\emph{patinonnāṁ divasaṁ}), the eleventh day.
...
\begin{itemize}
\raggedright
  \item \emph{patinonnŭ}, then \emph{patinonnāṁ}
  \item \emph{pathāṁ, patinonnāṁ}
  \item take \emph{irupatŭ} and make its ordinal yourself
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Recall:} say \emph{patinonnāṁ}, and say why \emph{irupathāṁ} needs no lesson — \textbf{R1}
...
\begin{quote}
\textbf{\ml{ആദ്യം} \ml{ഊണ്}, \ml{പിന്നെ} \ml{ചായ}.} — \emph{Ādyaṁ ūṇŭ, pinne cāya.} \textquotedblleft{}Lunch first, then tea.\textquotedblright{}
\end{quote}
...
\begin{itemize}
\raggedright
  \item \emph{ādyaṁ}, then \emph{ādyaṁ ūṇŭ, pinne cāya}
