...
% canonical-source-hash: fnv1a64:9a60d5c1efb50d0b
...
\end{tcolorbox}
\section[\sk{न}]{\sk{न} — copy it in three strokes, counting the lifts}
...
\end{tcolorbox}
\section[\sk{न}]{\sk{न} — write it with the model covered}
...
\end{tcolorbox}
\section[\sk{न}]{\sk{न} — the letter from the sound}
