...
**あ** *a*, **り** *ri*, **と** *to* and **う** *u* are ordinary hiragana. **が**
is the new idea: it is the sign **か** *ka* with two short strokes added at the
top right. That mark is the **dakuten**, and it voices the consonant — the same
two strokes turn *ka* into *ga*, *sa* into *za*, *ta* into *da*, *ha* into *ba*.
One mark, learned once, doubles how much of the script you can read.
...
duration:
  max_seconds: 225
requires:
  knowledge: [JA-LEX-ARIGATOU, JA-SCRIPT-DAKUTEN, JA-SCRIPT-HIRAGANA-MORA]
introduces:
  knowledge: [JA-LEX-ARIGATOU-GOZAIMASU, JA-REGISTER-TEINEIGO]
practises:
  knowledge: [JA-LEX-ARIGATOU, JA-SCRIPT-DAKUTEN, JA-LEX-ARIGATOU-GOZAIMASU, JA-REGISTER-TEINEIGO]
skills: [listening, speaking, reading]
modes: [interpersonal, mediation]
strands: [meaning-input, meaning-output, language-focus]
register: teineigo-polite
variety: standard-japanese-tokyo
reviews_of: [JA-C01-arigatou]
---

# ありがとうございます — politeness you cannot leave out

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-LEX-ARIGATOU, JA-SCRIPT-DAKUTEN] -->

[PAUSE 2s] Say **ありがとう** once and rebuild **が** from **か**. This lesson
adds the ending that makes it usable with a stranger, a shopkeeper, or a boss.

## Script — five more signs, two of them dakuten
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-DAKUTEN] -->

> **ございます** — **ご** *go* + **ざ** *za* + **い** *i* + **ま** *ma* + **す** *su*

Two of the five are dakuten forms you can already build: **ご** is **こ** with
the two strokes, and **ざ** is **さ** *sa* with them. **い** you have read since
**はい**. Only **ま** *ma* and **す** *su* are genuinely new.

The whole phrase is ten beats — *a-ri-ga-to-o go-za-i-ma-su* — and the final
**す** is normally said with the *u* barely voiced, close to a plain *s*.
...
**predicate**, and every sentence has one, so every sentence is marked. There is
no neutral setting: **ありがとう** to a friend and **ありがとうございます** to a
...
- [YOU SAY: **ありがとうございます** — ten beats, final *su* light] [REPEAT x2]
- [YOU CHOOSE: a close friend → **ありがとう**; a shop assistant → **ありがとうございます**]
- [YOU BUILD: **こ** → **ご**, **さ** → **ざ**]
...
[PAUSE 2s] Nothing is assumed yet. Begin with the shortest useful answer in the
...
Japanese runs left to right. **はい** is written with two signs of **hiragana**,
the everyday script. A hiragana sign is not a letter. It is one whole beat —
a **mora** — and normally a consonant and a vowel already fused into one shape.
There is no separate *h* to write, because **は** already is *ha*.

Five vowels, and they stay pure: *a* as in father, *i* as in machine, then
*u*, *e*, *o*. So **はい** is *ha-i*, two beats of the same length, and not the
single gliding sound of English "high."
...
track offers instead is the writing itself, built up one sign at a time, and —
later — the real family Japanese does have, through the characters it borrowed.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[JA-LEX-HAI, JA-SCRIPT-HIRAGANA-MORA] -->

- [YOU SAY: **はい** — *ha-i*, two even beats] [REPEAT x2]
- [YOU READ: **は**, then **い**, left to right]
- [YOU ANSWER: your name is called → **はい**]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-LEX-HAI, JA-SCRIPT-HIRAGANA-MORA] -->
<!-- hl-activity: {"id":"JA-C01-hai-beats","kind":"text","assesses":["JA-LEX-HAI"],"prompt":"Write the Japanese word for 'yes' in hiragana.","answer":"はい","accepted":["hai","ha-i"],"feedback":{"correct":"Right: はい, two even morae.","incorrect":"It is はい — ha plus i."},"response_seconds":8} -->

How many beats does **はい** hold? (Two.) Which sign carries *ha*? (**は**.)

Source: [Wiktionary: はい](https://en.wiktionary.org/wiki/%E3%81%AF%E3%81%84).
`,s=e({default:()=>c}),c=`---
schema_version: 2
id: JA-C01-iie
spine_node: SPINE-RESPOND-BASIC
...
prerequisites: [JA-C01-hai]
sounds: [mora, pure-vowels, mora-length]
roots: []
etymology_hook: いえ is a house and いいえ is “no” — one extra beat is the whole difference.
duration:
  max_seconds: 185
requires:
...
[PAUSE 2s] Say **はい** once and count its two beats out loud. This lesson adds
the opposite answer, and one fact about beats that Japanese will never let go of.

## Script — one new sign, three beats
<!-- hl-knowledge: introduces=[JA-SCRIPT-MORA-LENGTH]; assesses=[] -->

> **いいえ** — **い** *i* + **い** *i* + **え** *e*

Only **え** *e* is new; **い** you already read in **はい**. Written out, the
word is three signs, so it is three beats: *i-i-e*. The first two are the same
sign twice, which is exactly how Japanese writes a long vowel in hiragana —
by writing the vowel again.

Beat count is not decoration. **いえ** (two beats) means **house**. **いいえ**
(three beats) means **no**. Nothing else distinguishes them. Hold the first *i*
for two beats and the word lands; clip it and you have said "house."

## The word, taken apart — いいえ
<!-- hl-knowledge: introduces=[JA-LEX-IIE]; assesses=[] -->

**いいえ** is the plain **no** — and, just as often, a modest **"not at all"**
used to wave away thanks or a compliment. That second use is the common one in
daily speech, which is worth knowing before you meet it as an answer to
**thank you** at the end of this chapter.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[JA-LEX-IIE, JA-SCRIPT-MORA-LENGTH, JA-SCRIPT-HIRAGANA-MORA] -->
...
<!-- hl-activity: {"id":"JA-C01-iie-length","kind":"text","assesses":["JA-SCRIPT-MORA-LENGTH"],"prompt":"How many beats (morae) does いいえ hold?","answer":"three","accepted":["3","three beats","three morae"],"feedback":{"correct":"Right: i-i-e, three morae. Two beats would be いえ, 'house'.","incorrect":"Three: い, い, え — one beat per sign."},"response_seconds":8} -->

Which single sign is new here? (**え**.) What changes when the long *i* is cut
short? (The word becomes **いえ**, house.)

Source: [Wiktionary: いいえ](https://en.wiktionary.org/wiki/%E3%81%84%E3%81%84%E3%81%88).
`,l=e({default:()=>u}),u=`---
schema_version: 2
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-HIRAGANA-MORA, JA-LEX-HAI] -->
...
a particle? (It is the opening of a sentence nobody finishes any more.)

Source: [Wiktionary: こんにちは](https://en.wiktionary.org/wiki/%E4%BB%8A%E6%97%A5%E3%81%AF).
`,d=e({default:()=>f}),f=`---
schema_version: 2
id: JA-C01-koohii
spine_node: SPINE-MEET-GREET
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-MORA-LENGTH] -->

[PAUSE 2s] Recall how hiragana writes a long vowel: it writes the vowel twice,
...
This is **katakana**, the third system, and it is a full twin of hiragana: the
same beats, the same five vowels, different shapes. Its job is different too.
Katakana marks a word as coming from outside — borrowed vocabulary, foreign
names, sound effects, scientific terms.

The two scripts are siblings by origin as well as by sound. Hiragana came from
whole Chinese characters written in flowing cursive; katakana came from
*fragments* of characters, shorthand that monks scribbled beside a text to
remember how to read it. **こ** and **コ** even trace back to the same character,
which is why they still look alike.

**ー** is the *chōonpu*, the long-vowel bar. It holds the previous vowel for one
more beat, and it belongs to katakana almost exclusively. So **コーヒー** is four
beats: *ko-o-hi-i*.

## The word, taken apart — a shared borrowing
<!-- hl-knowledge: introduces=[JA-LEX-KOOHII]; assesses=[] -->

**コーヒー** is **coffee**, and it entered Japanese from Dutch *koffie* through
the Nagasaki trade. Dutch had it from Turkish *kahve*, and Turkish from Arabic
*qahwa* — which is exactly where English *coffee* comes from as well.
...
- [YOU SAY: **コーヒー** — *ko-o-hi-i*, four beats] [REPEAT x2]
- [YOU TRACE: Arabic *qahwa* → Turkish *kahve* → Dutch *koffie* → **コーヒー**]
- [YOU DECIDE: a borrowed word is written in katakana, not hiragana]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-LEX-KOOHII, JA-SCRIPT-CHOUON] -->
<!-- hl-activity: {"id":"JA-C01-koohii-bar","kind":"text","assesses":["JA-SCRIPT-CHOUON"],"prompt":"What does the bar ー do in コーヒー?","answer":"it holds the vowel for one more beat","accepted":["lengthens the vowel","long vowel","it lengthens the previous vowel","adds a beat to the vowel"],"feedback":{"correct":"Right: the chōonpu adds one more beat of the same vowel.","incorrect":"It lengthens the vowel before it by one beat — ko-o-hi-i."},"response_seconds":10} -->

Which script signals a borrowed word? (Katakana.) How many beats does
**コーヒー** hold? (Four.)

Source: [Wiktionary: コーヒー](https://en.wiktionary.org/wiki/%E3%82%B3%E3%83%BC%E3%83%92%E3%83%BC).
`,p=e({default:()=>m}),m=`---
schema_version: 2
id: JA-C01-nihongo
spine_node: SPINE-MEET-GREET
...
These are **kanji**: characters borrowed from Chinese, each carrying a meaning
rather than a sound. 日 is sun or day. 本 is origin or root. 語 is language.
...
**word**: you learn 日本語 as *nihongo*, and the reading of each character comes
along with it.
...
Here the cousin web finally works — just not toward English. The on-readings
*nichi*, *hon*, *go* are borrowings of Middle Chinese, so 日本語 has genuine
relatives: Mandarin writes the same three characters and says *Rìběnyǔ*; Korean
...
<!-- hl-activity: {"id":"JA-C01-nihongo-readings","kind":"text","assesses":["JA-SCRIPT-KANJI-READINGS"],"prompt":"How is the character 日 read inside 日本語?","answer":"ni","accepted":["as ni","に","read ni"],"feedback":{"correct":"Right: ni here — though the same character is nichi, jitsu, hi, bi, or ka elsewhere.","incorrect":"In 日本語 it is ni. The character has no single sound; the word decides."},"response_seconds":10} -->

What does 日本 mean literally? (Sun-origin.) Does 日 have one pronunciation?
(No — the word it appears in chooses one.)

Source: [Wiktionary: 日本語](https://en.wiktionary.org/wiki/%E6%97%A5%E6%9C%AC%E8%AA%9E).
`,h=e({default:()=>g}),g=`---
schema_version: 2
id: JA-C01-practice
spine_node: SPINE-COURTESY-THANK
...
duration:
  max_seconds: 220
requires:
  knowledge: [JA-LEX-KONNICHIWA, JA-LEX-NIHONGO, JA-LEX-HAI, JA-LEX-IIE, JA-LEX-ARIGATOU-GOZAIMASU, JA-REGISTER-TEINEIGO, JA-PARTICLE-WA-SPELLING, JA-SCRIPT-HIRAGANA-MORA, JA-SCRIPT-KANJI-READINGS]
introduces:
...
register: teineigo-polite
variety: standard-japanese-tokyo
reviews_of: [JA-C01-konnichiwa, JA-C01-nihongo, JA-C01-hai, JA-C01-iie, JA-C01-gozaimasu]
---

# Practice — one daytime exchange, three scripts

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-LEX-KONNICHIWA, JA-LEX-HAI, JA-LEX-IIE] -->

[PAUSE 2s] Before reading on, retrieve three answers: the daytime greeting, the
short yes, and the short no. Nothing new is added here.

## The exchange — every line already learned
<!-- hl-knowledge: introduces=[JA-DIALOGUE-DOORWAY]; assesses=[] -->
...
Three lines of hiragana, one of kanji, and no word that has not been taught.
Japanese lets a bare noun with a rising tone stand as a question, so **日本語**
with the voice lifted is a complete and natural way to ask "Japanese, then?" —
and **はい** answers it.
...
duration:
  max_seconds: 240
requires:
  knowledge: [JA-SCRIPT-ARIGATOU-READ-01, JA-SCRIPT-SA-01, JA-SCRIPT-MA-01, JA-SCRIPT-SU-01, JA-SCRIPT-DAKUTEN-01, JA-SCRIPT-KO-01, JA-SCRIPT-I-01]
introduces:
...
register: neutral-across-levels
variety: standard-japanese-tokyo
reviews_of: [JA-W03-arigatou-read, JA-W03-sa, JA-W03-ma, JA-W03-su, JA-C01-gozaimasu]
---
...
**ありがとう** on its own is warm and ordinary — friends, family, a shopkeeper
you know. **ありがとうございます** is the same thanks in polite form, and it is
what you want for a stranger, a colleague, anyone serving you.

The difference is not strength. Adding ございます does not mean you are *more*
grateful; it means you are being **more formal about it**. Getting that wrong in
either direction is the commonest register mistake a beginner makes.

If you are unsure which to use, use the long one. Being slightly too polite in
Japanese costs you nothing.
...
- **eight shapes** — あ り か と う さ ま す
- **one mark** — ゛, which turned か into が, こ into ご, さ into ざ

Ten signs in ありがとうございます, and only eight of them cost you a shape. The
dakuten is the first thing in this book that made the job *smaller* the further
you went into it, and it keeps doing that: every *k*, *s*, *t* and *h* sign you
ever learn arrives with a voiced twin already attached.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-GOZAIMASU-READ-01, JA-SCRIPT-ARIGATOU-READ-01] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-GOZAIMASU-READ-01] -->
<!-- hl-activity: {"id":"JA-C03-practice-ticks","kind":"text","assesses":["JA-SCRIPT-GOZAIMASU-READ-01"],"prompt":"In ありがとうございます, how many signs are an earlier sign plus the dakuten?","answer":"3","accepted":["three","3 signs","three signs","ga za and go","が ご ざ"],"feedback":{"correct":"Three — が, ご and ざ, from か, こ and さ.","incorrect":"Three: が from か, ご from こ, and ざ from さ."},"response_seconds":12} -->

Which form would you use with a stranger — the short one or the long one? (The
**long** one; being slightly too polite costs nothing.)
