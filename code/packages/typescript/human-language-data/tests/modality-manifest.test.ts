...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3404, // +1: Arabic harakat split. // +1: Italian's guided-copy bridge on the Tamil baseline.
      ...
      pen: 353, // +1: Arabic harakat split. // +2: Italian's opener trace and guided copy.
