...
quadratic, cubic, quartic, and factored-polynomial programs, and the ladder maps
those root sets to printed options without host-side solving. From here, rungs 3→5 gate the broader
