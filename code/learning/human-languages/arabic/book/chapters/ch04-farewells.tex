...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} This is the letter people think of when they think "Arabic." \textbf{\ar{ع}} (\emph{ʿayn}) writes a sound made \textbf{deep in the throat} — one English simply does not have. And its history holds the best surprise in the whole alphabet: this consonant is the ancestor of our vowel \textbf{O}.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU WRITE: \textbf{\ar{ع}} — the open curve, then the bowl beneath{]}
  \item {[}YOU SAY: the sound, from the throat — as in \emph{ʿalaykum}{]}
  \item {[}YOU SAY: the family — "\emph{ʿayn} \ar{ع}, and \emph{ghayn} \ar{غ} = the same shape \textbf{plus one dot}"{]}
  \item {[}YOU SAY: "\emph{ʿayin} = \textbf{eye} $\to$ the Greeks made it \textbf{O}"{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} Describe \textbf{\ar{ع}}'s two pieces. (An \textbf{open-mouth curve} on top, a \textbf{bowl} below when isolated or final.) What did Phoenician \emph{ʿayin} mean, and what letter did the Greeks turn it into? ("\textbf{Eye}"; they had no such sound, so they made it the vowel \textbf{O}.) Which letter shares its skeleton? (\textbf{\ar{غ}} \emph{ghayn} — one dot above.) Next: \textbf{\ar{ه}} and the feminine ending \textbf{\ar{ة}}.
\end{tcolorbox}
\section[hāʾ, tāʾ marbūṭa]{\ar{ه} and \ar{ة} — the loop, and the ending that means "feminine"}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Two related shapes. \textbf{\ar{ه}} (\emph{hāʾ}) is a plain "h" — and the most \textbf{shape-shifting} letter you've met, wearing four genuinely different coats. Then \textbf{\ar{ة}}, a letter built \emph{out of} it, whose whole job is to say one grammatical thing: \textbf{this word is feminine}.
\end{quote}
...
\subsection*{Script — \ar{ة} (tāʾ marbūṭa) — the "tied tāʾ"}
...
Its name says exactly what it is: \textbf{tāʾ marbūṭa}, "the \textbf{tied-up tāʾ}" — a \textbf{\ar{ت}} (\emph{tāʾ}, Lesson 4) whose ends have been \textbf{tied into a loop}. It appears \textbf{only at the end of a word}, and it is the standard mark of a \textbf{feminine} noun or adjective.
...
\begin{itemize}
\raggedright
  \item {[}YOU WRITE: \textbf{\ar{ه}} — the loop; then try it isolated and final, feel it change{]}
  \item {[}YOU WRITE: \textbf{\ar{ة}} — the same loop, \textbf{plus tāʾ's two dots above}{]}
  \item {[}YOU SAY: the name — "\emph{tāʾ marbūṭa}, the \textbf{tied} tāʾ — it marks the feminine"{]}
  \item {[}YOU SAY: "\emph{hē} $\to$ Greek epsilon $\to$ Latin \textbf{E}"{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What makes \textbf{\ar{ه}} unusual among the letters you've learned? (Its \textbf{loop changes shape} dramatically by position — four very different coats.) What is \textbf{\ar{ة}} made of, and what does its name mean? (\emph{hāʾ}'s loop \textbf{+ tāʾ's two dots}; "\textbf{tied tāʾ}".) What does \textbf{\ar{ة}} tell you about a word, and where can it appear? (That it is \textbf{feminine}; only at the \textbf{end}.) Next: assembling the farewell \textbf{\ar{مع} \ar{السلامة}}.
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} The closing move. \textbf{\ar{مع} \ar{السلامة}} (\emph{maʿa s-salāma}) is how Arabic says goodbye — literally "\textbf{with safety}," \emph{go in peace}. And the heart of it is a word you wrote \textbf{all the way back in Lesson 3}: \textbf{\ar{سلام}}. Everything since has been leading here.
\end{quote}

\subsection*{Script — Part 1 — \ar{مع} (maʿa, "with")}
...
$\to$ \textbf{\ar{مع}} = \emph{maʿa}, "with."

\subsection*{Script — Part 2 — \ar{السلامة} (as-salāma, "the safety")}
Look at what this is made of:

\begin{itemize}
\raggedright
  \item \textbf{\ar{ال}} — the \textbf{al-} ("the"), \emph{alif} + \emph{lām}, both from Lessons 1–2. You've read it since Chapter 1 in \textbf{\ar{ال}}\ar{خير} and \textbf{\ar{ال}}\ar{سلام} \ar{عليكم}.
...
\emph{salām}, \emph{salāma}, \emph{islām}, \emph{muslim} — all from the Semitic root \textbf{s–l–m}, "peace, safety, wholeness." The greeting you learned first (\textbf{\ar{السلام} \ar{عليكم}}, "peace be upon you") and the farewell you learn last (\textbf{\ar{مع} \ar{السلامة}}, "with safety") come from the \textbf{same three consonants}. Arabic opens and closes a conversation with one idea.
...
\begin{itemize}
\raggedright
  \item {[}YOU WRITE: \textbf{\ar{مع}} — mīm into ʿayn{]}
  \item {[}YOU WRITE: \textbf{\ar{السلامة}} — "the \emph{al-}, then your Lesson-3 word, then the feminine \ar{ة}"{]}
  \item {[}YOU SAY: "\emph{maʿa s-salāma} — \textbf{with safety}"{]}
  \item {[}YOU SAY: the bookend — "\textbf{\ar{السلام} \ar{عليكم}} to greet, \textbf{\ar{مع} \ar{السلامة}} to part — same root \textbf{s-l-m}"{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What does \textbf{\ar{مع} \ar{السلامة}} literally mean? ("\textbf{With safety}.") Which earlier word sits inside \textbf{\ar{السلامة}}, and what was added? (\textbf{\ar{سلام}} from Lesson 3 — plus \textbf{\ar{ال}} in front and \textbf{\ar{ة}} behind.) What does the final \textbf{\ar{ة}} signal? (\emph{salāma} is \textbf{feminine}.) What root ties the first greeting to the last farewell? (\textbf{s–l–m} — peace/safety.) You can now hand-write an Arabic conversation from hello to goodbye.
\end{tcolorbox}
\section[maʿa]{\ar{مع} (maʿa) — "with"}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Two letters, both already yours, and a word that will carry the whole chapter.
\end{quote}

\subsection*{You'll want to know — The letters}
\emph{(Skim if you read Arabic.)} \textbf{\ar{م}} (\emph{mīm}) from Lesson 3 of the writing set, and \textbf{\ar{ع}} (\emph{ʿayn}) from Lesson 10 — the throat sound whose Phoenician ancestor meant "\textbf{eye}," and which the Greeks recycled into the vowel \textbf{O}.
...
\textbf{\ar{مع}} (\emph{maʿa}) = "\textbf{with}, together with."
...
\midrule
\textbf{\ar{الـ}} \emph{al-} "the" & yes \\
\textbf{\ar{بـ}} \emph{bi-} "in/with" & yes \\
\textbf{\ar{لـ}} \emph{li-} "to" & yes \\
\textbf{\ar{مع}} \emph{maʿa} "with" & \textbf{no} \\
\bottomrule
\end{tabularx}

So Arabic has \emph{two} words touching on "with": the one-letter \textbf{\ar{بـ}} (\emph{bi-}, "in/by means of," as in \emph{bi-khayr}) and the full word \textbf{\ar{مع}} (\emph{maʿa}, "accompanied by"). \emph{Bi-khayr} is "\textbf{in} goodness"; \emph{maʿa} is standing \textbf{next to} something.

\begin{culture}
\emph{maʿa} $\leftarrow$ Semitic \emph{*ʿimma}, and its Hebrew cousin is \textbf{\he{עִם}} (\emph{ʿim}), "with." The same pairing you met with \textbf{salām / shalom} in Chapter 1 and \textbf{ism / shem} in Chapter 2. Three chapters, three cousins — the family resemblance is systematic, not a coincidence.
\end{culture}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: "\emph{maʿa}" — the \emph{ʿayn} from the throat{]}
  \item {[}YOU SAY: the contrast — "\emph{bi-khayr} \textbf{in} goodness · \emph{maʿa} \textbf{with}"{]}
  \item {[}YOU SAY: the cousin — "\emph{maʿa} · Hebrew \emph{ʿim}"{]}
  \item {[}YOU WRITE: \textbf{\ar{مع}} — mīm joining into ʿayn{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What does \textbf{\ar{مع}} mean? ("\textbf{With}.") Does it attach to the next word, like \emph{al-} and \emph{bi-}? (\textbf{No} — it stands alone.) What is the difference between \emph{bi-} and \emph{maʿa}? (\emph{Bi-} = "\textbf{in}/by means of"; \emph{maʿa} = "\textbf{accompanied by}".) What is its Hebrew cousin? (\emph{\textbf{ʿim}}.) Next: the word it goes with — and you already know most of it.
\end{tcolorbox}
\section[as-salāma]{\ar{السلامة} (as-salāma) — "the safety"}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} This looks like a long new word. It isn't. It is \textbf{one word you learned in Chapter 1} with a piece added at each end.
\end{quote}
...
\midrule
\textbf{\ar{الـ}} & \emph{al-}, "the" & Ch. 1 \\
\textbf{\ar{سلام}} & \emph{salām}, "peace" & Ch. 1 — the very first word \\
\textbf{\ar{ة}} & \emph{tāʾ marbūṭa}, feminine ending & writing Lesson 11 \\
\bottomrule
\end{tabularx}

$\to$ \textbf{\ar{السلامة}} = \emph{al-} + \emph{salām} + \emph{-a} = "\textbf{the safety}."
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: "\emph{as-salāma}" — with the doubled \emph{s}, not \emph{al-s}{]}
  \item {[}YOU SAY: the build — "\emph{salām} … \emph{salāma} … \emph{as-salāma}"{]}
  \item {[}YOU SAY: the pattern — "peace $\to$ \textbf{the state of} peace"{]}
  \item {[}YOU WRITE: \textbf{\ar{السلامة}}{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What three pieces make \textbf{\ar{السلامة}}? (\emph{\textbf{al-}} + \emph{\textbf{salām}} + \emph{\textbf{\ar{ة}}}.) What did the \emph{faʿāla} pattern do to the meaning? (Turned "peace" into "\textbf{the state of} being at peace" — safety.) Why is it \emph{as-salāma} and not \emph{al-salāma}? (\textbf{\ar{س}} is a \textbf{sun letter}; the \emph{l} assimilates.) What does the \textbf{\ar{ة}} tell you? (The word is \textbf{feminine}.) Next: put \emph{maʿa} in front of it.
\end{tcolorbox}
\section[maʿa s-salāma]{\ar{مع} \ar{السلامة} (maʿa s-salāma) — "goodbye"}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Put the last two lessons together and the farewell falls out. You have already \textbf{hand-written} this phrase; now it means something.
\end{quote}

\subsection*{You'll want to know — The assembly}
\begin{quote}
\textbf{\ar{مع}} (\emph{maʿa}, "with") + \textbf{\ar{السلامة}} (\emph{as-salāma}, "the safety") $\to$ \textbf{\ar{مع} \ar{السلامة}} — "\textbf{with safety}."
\end{quote}
...
It is not "goodbye" in the English sense of a plain sign-off. It is a \textbf{wish}: \emph{go in safety}.
...
\textbf{Goodbye} looks like a single word. It is worn down from \emph{\textbf{God be with ye}}. So the English farewell is also built on "\textbf{with}" — you are being commended to something protective as you go.
...
\midrule
Arabic & \emph{maʿa s-salāma} & "\textbf{with} safety" \\
English & \emph{goodbye} & "God be \textbf{with} ye" \\
Spanish & \emph{adiós} & "to God" \\
French & \emph{adieu} & "to God" \\
\bottomrule
\end{tabularx}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: "\emph{maʿa s-salāma}"{]}
  \item {[}YOU SAY: the bookend — "\emph{as-salāmu ʿalaykum} … \emph{maʿa s-salāma}"{]}
  \item {[}YOU SAY: the root aloud — "\textbf{s · l · m}"{]}
  \item {[}YOU SAY: "goodbye $\leftarrow$ God be \textbf{with} ye"{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What does \textbf{\ar{مع} \ar{السلامة}} literally mean? ("\textbf{With safety}.") What root is it built on, and where have you met that root before? (\textbf{s–l–m} — the Chapter 1 greeting \emph{as-salāmu ʿalaykum}, and \emph{salām} itself.) So what does Arabic open and close a conversation with? (\textbf{The same idea} — peace/safety.) What is English \emph{goodbye} worn down from? ("\textbf{God be with ye}.") Next: a second farewell, and a word Spanish borrowed.
\end{tcolorbox}
\section[ilā l-liqāʾ]{\ar{إلى} \ar{اللقاء} (ilā l-liqāʾ) — "see you"}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} The other everyday farewell — and the one with a surprise waiting in the Spanish track.
\end{quote}
...
\raggedright
  ...
  \item \textbf{\ar{ى}} in \textbf{\ar{إلى}} — this is \emph{alif maqṣūra}, "shortened alif": it wears \textbf{yāʾ's skeleton with no dots} and is pronounced as a long \emph{ā}. You already know from writing Lessons 4–5 that dots are what separate letters sharing a body; this is that same principle, taken one step further.
\end{itemize}
...
\midrule
\textbf{\ar{إلى}} \emph{ilā} & "to, until" \\
\textbf{\ar{اللقاء}} \emph{al-liqāʾ} & "the meeting" \\
\bottomrule
\end{tabularx}

$\to$ \textbf{\ar{إلى} \ar{اللقاء}} = "\textbf{until the meeting}."

\textbf{\ar{لقاء}} (\emph{liqāʾ}) comes from the root \textbf{l–q–y}, "\textbf{to meet}." The final \textbf{\ar{ء}} is the \emph{hamza} from writing Lesson 6 — a glottal stop, a real consonant here, not decoration.
...
\begin{quote}
\emph{hasta luego} — "\textbf{until} later" \emph{hasta mañana} — "\textbf{until} tomorrow"
\end{quote}

Same shape as \emph{ilā l-liqāʾ}: \textbf{"until" + a future point}. But it goes further — Spanish \emph{\textbf{hasta}} is itself an \textbf{Arabic loanword}, from \emph{\textbf{ḥattā}} ("until"). Of the roughly four thousand Arabic words Spanish took during the eight centuries of al-Andalus, most are nouns; \emph{hasta} is one of the rare borrowed \textbf{function words}.
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: "\emph{ilā l-liqāʾ}" — double the \emph{l}{]}
  \item {[}YOU SAY: the two farewells — "\emph{maʿa s-salāma} · \emph{ilā l-liqāʾ}"{]}
  \item {[}YOU SAY: the loan — "\emph{hasta} $\leftarrow$ \emph{ḥattā}"{]}
  \item {[}YOU SAY: the root — "\textbf{l · q · y} — to meet"{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What does \textbf{\ar{إلى} \ar{اللقاء}} literally say? ("\textbf{Until the meeting}.") What root is \emph{liqāʾ} from? (\textbf{l–q–y}, "to meet".) Which two letters here has the writing track \textbf{not} reached? (\textbf{\ar{ق}} \emph{qāf}, and \textbf{\ar{ى}} \emph{alif maqṣūra}.) What is \emph{alif maqṣūra}? (\textbf{Yāʾ's body with no dots}, pronounced long \emph{ā}.) Which Spanish word for "until" came from Arabic? (\emph{\textbf{Hasta}} $\leftarrow$ \emph{\textbf{ḥattā}}.) Next: practise the whole conversation, hello to goodbye.
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Four chapters. Greet, introduce, ask after someone, part. Here it all is in one piece.
\end{quote}
...
Read the right-hand column top to bottom. \textbf{Not one line contains a verb "to be."} The zero copula has held for four chapters.
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: the full dialogue, both parts, addressing a \textbf{man}{]}
  \item {[}YOU SAY: it again to a \textbf{woman} — every \emph{-ka} becomes \emph{-ki}{]}
  \item {[}YOU WRITE: \textbf{\ar{مع} \ar{السلامة}} — every letter is one you have drawn{]}
  \item {[}YOU SAY: the bookend — "\textbf{\ar{السلام}} to open, \textbf{\ar{السلامة}} to close"{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} Give a complete greeting-to-farewell exchange. (The dialogue above.) Which root opens \textbf{and} closes it? (\textbf{s–l–m}.) Which piece of the chapter doesn't glue onto the next word? (\textbf{\ar{مع}} \emph{maʿa}.) What single word is absent from every literal translation? (\textbf{"Is"} — the zero copula.) Which Spanish word came from Arabic \emph{ḥattā}? (\emph{\textbf{Hasta}}.) You can now hold — and hand-write — a short Arabic conversation from beginning to end.
\end{tcolorbox}
