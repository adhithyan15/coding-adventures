# Build and run the intel-8008-packager tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name intel_8008_packager-tests -Sources @("tests\intel_8008_packager_test.cpp")
