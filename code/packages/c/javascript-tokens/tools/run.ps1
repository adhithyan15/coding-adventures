# Build and run the javascript-tokens tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name javascript_tokens-tests -Sources @("tests\javascript_tokens_test.c", "src\javascript_tokens.c")
