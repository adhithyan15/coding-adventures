...
describe("real curriculum", () => {
  ...
  it("produces a machine-readable migration gap baseline", () => {
    ...
    // KA-C01-namaskara (333s) and TE-C01-namaskaram (314s). The Telugu lesson
    // now keeps one greeting, one decode, one guided copy and one etymology
    // payoff in four effective minutes. Kannada remains visible work on this
    // branch; the ceiling is never raised to make either lesson look compliant.
