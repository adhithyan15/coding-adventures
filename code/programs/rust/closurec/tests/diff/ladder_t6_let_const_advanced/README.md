# ladder_t6_let_const_advanced

Rung 6.let_const of the CCR-066 differential complexity ladder, at `ADVANCED`.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t6_let_const_advanced/input/a.js
```
