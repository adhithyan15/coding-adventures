...
% canonical-source-hash: fnv1a64:4975742e430e35f3
% canonical-lessons: ES-C37-abrir, ES-C37-cerrar, ES-C37-sentarse, ES-C37-levantarse, ES-C37-repaso-sentado-de-pie-andando
...
\end{tcolorbox}
\section[(review)]{Review — down, up, and away}

\label{lesson:ES-C37-repaso-sentado-de-pie-andando}



\begin{quote}
\textquotedblleft{}I sit down.\textquotedblright{} (\emph{Me siento}.) \textquotedblleft{}I get up.\textquotedblright{} (\emph{Me levanto}.)
\end{quote}

\begin{grammarlens}[title={What you've built}]
Four verbs, and between them a whole body's worth of positions.

\emph{Me siento} puts you down. \emph{Me levanto} brings you up. And once you are up, there is a phrase for staying there: \textbf{de pie} — on foot, standing.

Notice that \emph{de pie} is not a verb at all. Spanish says the posture with a noun and a preposition where English reaches for \emph{standing}.
\end{grammarlens}

\begin{culture}
\emph{Sentarse} and \emph{levantarse} look unrelated. They were made by the same move.

Latin had \emph{sedēre}, \textquotedblleft{}to sit,\textquotedblright{} and its participle \emph{sedēns}, \textquotedblleft{}sitting.\textquotedblright{} Someone built a new verb straight off that participle — \emph{sedentāre} — and Spanish inherited it as \emph{sentar}. Then Latin had \emph{levāre}, \textquotedblleft{}to raise,\textquotedblright{} participle \emph{levāns}, and the same thing happened: \emph{levantāre}, Spanish \emph{levantar}.

Two verbs, one recipe: take the part of the verb that means \emph{doing it right now}, and build a fresh verb on top.

Now walk, and the tidiness ends. \emph{Caminar} comes off \emph{el camino}, which Latin took from Gaulish — a clean, traceable borrowing. \emph{Andar} comes from Medieval Latin \emph{andāre}, and where \emph{andāre} came from is \textbf{genuinely disputed}. Two candidates, neither proved.
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{me siento} · \emph{me levanto} · \emph{de pie} · \emph{camino} · \emph{ando}
\end{itemize}

\emph{Twice through:}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What did Latin build \emph{sentar} and \emph{levantar} out of? (\textbf{A participle} — \emph{sedēns} and \emph{levāns}.) What does \emph{de pie} mean literally? (\textbf{On foot}.) Which of the four verbs has no agreed origin? (\emph{\textbf{Andar}}.)
\end{tcolorbox}
