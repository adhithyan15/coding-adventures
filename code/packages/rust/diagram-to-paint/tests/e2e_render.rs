...
mod apple {
    ...
    use diagram_layout_hierarchy::{layout_swimlane, layout_treeview, layout_treemap};
    ...
    use diagram_to_paint::{
        ...
        diagram_to_paint_cynefin, diagram_to_paint_ishikawa, diagram_to_paint_swimlane, diagram_to_paint_treeview, diagram_to_paint_treemap, diagram_to_paint_venn, diagram_to_paint_wardley,
    ...
    use mermaid_parser::{
        ...
        parse_to_diagram as parse_mermaid_to_diagram, parse_cynefin, parse_ishikawa, parse_radar, parse_swimlane, parse_treeview, parse_treemap, parse_venn, parse_wardley, parse_xychart,
    };
