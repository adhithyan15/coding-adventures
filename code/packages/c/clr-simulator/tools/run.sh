#!/bin/sh
# Build and run the clr-simulator tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c clr_simulator-tests tests/clr_simulator_test.c src/clr_simulator.c
