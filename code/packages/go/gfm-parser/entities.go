...
// # Why this matters
//
// GFM spec §2.5: "An entity reference consists of & + any valid HTML5
...
func DecodeEntity(ref string) string {
	...
	if strings.HasPrefix(inner, "#") {
		...
		// Invalid or null code point — per GFM spec, replace with U+FFFD
...
//	"  → &quot;
//
// Apostrophes are NOT escaped because GFM's reference implementation
