# Build and run the matrix tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name matrix-tests -Sources @("tests\matrix_test.c", "src\matrix.c")
