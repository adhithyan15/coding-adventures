...
% canonical-source-hash: fnv1a64:c9af0370f865e7d1
...
\raggedright
  ...
  \item \emph{Say it:} \emph{ākāśaṁ}, then \emph{namaskāraṁ}, as you would greet somebody out of doors
  \item \emph{Recall:} say \emph{kṛtajñata}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{sūryan}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{ākāśaṁ}, then \emph{sūryan}, and say which of the two is the container
  \item \emph{Recall:} read \textbf{\ml{ഉപകാരം}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{candran}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{sūryan}, then \emph{candran}, and hear the same tail on both
  \item \emph{Recall:} say \emph{bahumānaṁ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{nakṣatraṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{nakṣatraṁ}, then \emph{candran}, and say which of the two moves through the other
  \item \emph{Recall:} read \textbf{\ml{അനുഗ്രഹം}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{ākāśaṁ}, \emph{sūryan}, \emph{candran}, \emph{nakṣatraṁ}, \emph{veyil}
  \item \emph{Recall:} say \emph{vandanaṁ}
\end{itemize}
