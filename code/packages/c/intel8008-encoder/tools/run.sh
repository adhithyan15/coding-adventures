#!/bin/sh
# Build and run the intel8008-encoder tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c intel8008_encoder-tests tests/intel8008_encoder_test.c src/intel8008_encoder.c
