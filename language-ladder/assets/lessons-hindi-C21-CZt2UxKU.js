...
<!-- hl-knowledge: introduces=[HI-CONCEPT-C21-SIX-NINE-TEN-HISTORY-01]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[HI-CONCEPT-C21-SIX-NINE-TEN-HISTORY-02]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[HI-CONCEPT-C21-SIX-NINE-TEN-HISTORY-03]; assesses=[] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[HI-CONCEPT-C21-SIX-NINE-TEN-HISTORY-01, HI-CONCEPT-C21-SIX-NINE-TEN-HISTORY-02, HI-CONCEPT-C21-SIX-NINE-TEN-HISTORY-03] -->
...
<!-- hl-knowledge: introduces=[HI-CONCEPT-C22-GYARAH-BEES-03]; assesses=[] -->
...
## The two words — बीस
<!-- hl-knowledge: introduces=[HI-CONCEPT-C22-GYARAH-BEES-04]; assesses=[] -->
...
romanization: "os"
gloss: "dew"
concept_tag: HI-ANCHOR-OS
prerequisites: [HI-S128-letter-uu]
sounds: []
roots: []
duration:
  max_seconds: 120
...
introduces:
  knowledge: [HI-LEX-ANCHOR-OS]
practises:
  knowledge: [HI-LEX-ANCHOR-OS, HI-SCRIPT-RECOG-128]
skills: [listening, speaking, reading]
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-SCRIPT-RECOG-128] -->

[PAUSE 2s] Before the new word: say the last thing you learned, once, out loud.

## You'll want to know: ओस
<!-- hl-knowledge: introduces=[HI-LEX-ANCHOR-OS]; assesses=[] -->

**ओस** — *os* — "dew".

Say it: *os*. Look at its shape as you say it: the next lesson takes one
piece of it, **ओ**, and writes it on its own.
...
[PAUSE 1s]
- [YOU SAY: *os*]
- [YOU SAY: *os*, and what it means]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-ANCHOR-OS] -->

[PAUSE 3s] What is "dew"? (**ओस**, *os*.)
`,l=e({default:()=>u}),u=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
...
introduces:
  knowledge: [HI-LEX-ANCHOR-UUN]
practises:
  knowledge: [HI-LEX-ANCHOR-UUN, HI-SCRIPT-RECOG-127]
skills: [listening, speaking, reading]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral
...
## You'll want to know: ऊन
<!-- hl-knowledge: introduces=[HI-LEX-ANCHOR-UUN]; assesses=[] -->

**ऊन** — *ūn* — "wool".

Say it: *ūn*. Look at its shape as you say it: the next lesson takes one
piece of it, **ऊ**, and writes it on its own.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-ANCHOR-UUN] -->

[PAUSE 1s]
- [YOU SAY: *ūn*]
- [YOU SAY: *ūn*, and what it means]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[HI-LEX-ANCHOR-UUN] -->

[PAUSE 3s] What is "wool"? (**ऊन**, *ūn*.)
`,d=e({default:()=>f}),f=`---
schema_version: 2
introduces_idioms: []
introduces_senses: []
