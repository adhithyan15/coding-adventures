...
schema_version: 2
id: AR-W00-alif-mim-salam
spine_node: SPINE-MEET-GREET
sequence: 14
chapter: 1
type: writing
headword: "ا م — سلام"
gloss: add alif and mim, then guided-copy salām
romanization: alif, mīm — salām
prerequisites: [AR-W00-sin-lam]
sounds: [arabic-alif, arabic-mim, long-a]
roots: [phoenician-aleph, phoenician-mem, semitic-s-l-m]
duration:
  max_seconds: 240
requires:
  knowledge: [AR-C01-SALAM-01, AR-SCRIPT-SIN-LAM-02]
introduces:
  knowledge: [AR-SCRIPT-WRITE-SALAM-03, AR-SCRIPT-JOINING-FORMS-04]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [AR-C01-SALAM-01, AR-SCRIPT-SIN-LAM-02, AR-SCRIPT-WRITE-SALAM-03, AR-SCRIPT-JOINING-FORMS-04]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral
variety: modern-standard-arabic
reviews_of: [AR-W00-sin-lam, AR-C01-salam]
---

# ا and م — finish **سلام** without a cliff

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[AR-C01-SALAM-01, AR-SCRIPT-SIN-LAM-02] -->

[PAUSE 2s] Recall **س** and **ل**. Add just two shapes, then the spoken word
*salām* becomes readable and writable.

## Script — observe two new shapes
<!-- hl-knowledge: introduces=[AR-SCRIPT-WRITE-SALAM-03, AR-SCRIPT-JOINING-FORMS-04]; assesses=[AR-C01-SALAM-01, AR-SCRIPT-SIN-LAM-02] -->

- **ا** is *alif*: one clean upright carrying the long *ā* here. From
  Phoenician **ʾālep** ("ox") — ancestor of Greek *alpha* and Latin **A**.
- **م** is *mīm*: a small round head and a tail; it gives the final *m*. From
  Phoenician **mem** ("water") — sibling of Greek *mu* and Latin **M**.

Arabic letters join — and a joined letter **changes shape**. The same letter
looks different at the start, the middle and the end of a joined run. Its
skeleton never changes (three teeth stay three teeth); only the connectors at
its edges do. This is the one habit that makes Arabic read like handwriting
rather than like print.

Watch all of it happen in one short word. In **سلام**, *sīn* reaches leftward
into *lām*; *lām* and *alif* fuse into the fixed pair **لا**; then *alif*, which
never joins leftward, forces a pen lift before final *mīm*.

## Writing — guided copy, then delayed copy
<!-- hl-knowledge: introduces=[]; assesses=[AR-C01-SALAM-01, AR-SCRIPT-SIN-LAM-02, AR-SCRIPT-WRITE-SALAM-03, AR-SCRIPT-JOINING-FORMS-04] -->
...
[PAUSE 3s] Read **سلام**. (**salām, peace.**) What changes when a letter joins,
and what stays the same? (**The connectors at its edges change; its skeleton
does not.**) Where does the pen lift? (**After alif.**) Write the word once
without looking. This is delayed recall, not penmanship perfection.
`,r=e({default:()=>i}),i=`---
schema_version: 2
id: AR-W00-ayn-ya
spine_node: SPINE-MEET-GREET
...
register: neutral
variety: modern-standard-arabic
reviews_of: [AR-C01-as-salamu-alaykum, AR-C01-salam]
---
...
register: neutral
variety: modern-standard-arabic
reviews_of: [AR-W00-ra-ha, AR-C01-marhaba, AR-W00-alif-mim-salam]
---
...
1. Point right to left: **م · ر · ح · ب · ا**.
...
`,s=e({default:()=>c}),c=`---
schema_version: 2
id: AR-W00-full-greeting-recall
spine_node: SPINE-MEET-GREET
sequence: 46
chapter: 1
type: writing
...
register: neutral
variety: modern-standard-arabic
reviews_of: [AR-W00-kaf-waw-alaykum, AR-C01-as-salamu-alaykum]
---
...
3. Reveal **السلام عليكم**.
4. Compare from right to left. Circle one uncertain shape and repair it once.

Stop after one repaired attempt. Retrieval is the goal; repetition without
attention is not.
...
register: neutral
variety: modern-standard-arabic
reviews_of: [AR-W00-ayn-ya, AR-C01-as-salamu-alaykum, AR-W00-alif-mim-salam]
---
...
3. Copy **السلام عليكم** once while looking.
...
type: writing
headword: "ر ح"
gloss: notice and trace ra and deep ha after saying marḥaban
romanization: rāʾ, ḥāʾ
prerequisites: [AR-C01-marhaba]
sounds: [arabic-ra, arabic-ha]
roots: [phoenician-resh]
duration:
  max_seconds: 240
requires:
...
register: neutral
variety: modern-standard-arabic
reviews_of: [AR-C01-marhaba, AR-W00-alif-mim-salam]
---
...
- **ح** is *ḥāʾ*, the deep, breathy *ḥ*. Its open bowl has **no dot**.
...
new skeleton and two dot-cousins.
`,p=e({default:()=>m}),m=`---
schema_version: 2
id: AR-W00-sin-lam
spine_node: SPINE-MEET-GREET
...
type: writing
headword: "س ل"
gloss: notice and trace the first two shapes in salām
...
# س and ل — recall one shape, add one

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[AR-C01-SALAM-01] -->

[PAUSE 2s] Say *salām*. You already know what it means and traced **س** once.
Now recall that shape and add only its next consonant. Arabic runs **right to
left**, so the first shape waits on the right.
...
1. Trace **س** once with a finger: three teeth, then the bowl.
2. Trace **ل** once: tall upright, then the low curve.
...
[PAUSE 1s]
- [YOU POINT: **س**, and say *sīn*]
- [YOU POINT: **ل**, and say *lām*]
- [YOU WRITE: **س ل** once, leaving them separate]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[AR-C01-SALAM-01, AR-SCRIPT-SIN-LAM-02] -->

[PAUSE 3s] Which way do Arabic words run? (**Right to left.**) Which letter has
three teeth? (**س, sīn.**) Which has the tall upright? (**ل, lām.**)
`,h=e({default:()=>g}),g=`---
schema_version: 2
id: AR-W02-satri-al-khass
spine_node: SPINE-SAY-WHY
sequence: 1250
chapter: 43
type: writing
headword: "(my own line)"
gloss: your own line, chosen from a closed supply, with nothing to copy
concept_tag: AR-WRITE-COMPOSE
prerequisites: [AR-C42-first-passage, AR-C38-wa]
sounds: []
roots: []
etymology_hook: "every writing step before this one had a model to reach for; this one has none, and in Arabic the hand has to decide something extra before it starts -- which of four shapes each letter wears where it stands"
duration:
  max_seconds: 250
requires:
  knowledge: [AR-LEX-C38-WA-01, AR-LEX-C38-LAKIN-01]
introduces:
  knowledge: []
introduces_idioms: []
introduces_senses: []
...
register: polite
variety: modern-standard-arabic
reviews_of: [AR-C38-wa, AR-C38-lakin]
---

# My own line — the first writing with no model

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[AR-LEX-C38-WA-01] -->

[PAUSE 2s] Everything you have written so far had something to reach for.

[PAUSE 1s] This does not. You choose the words, from a supply that is closed:
only what this book has taught you.

## Writing — controlled composition
<!-- hl-knowledge: introduces=[]; assesses=[AR-LEX-C38-WA-01, AR-LEX-C38-LAKIN-01] -->
<!-- hl-writing-stage: controlled-composition -->

[PAUSE 2s] Write **one line** about yourself, right to left.

[PAUSE 2s] And here is the extra decision Arabic asks for that most scripts do
not. A letter does not have one shape. It has up to **four**, and which one you
write depends on **where in the word it stands** — alone, at the start, in the
middle, at the end.

[PAUSE 2s] Copying hid that from you: the model already showed the right shape.
Choosing your own words means choosing the shapes too, and a letter you have
only ever copied in the middle of a word is a letter you may not yet be able to
start one with.

[PAUSE 3s] Write the line. Then read it back and check the **joins** before you
check anything else — a letter that should have connected and did not is the
error a reader notices first.

## Wrap-up recall
<!-- hl-knowledge: introduces=[]; assesses=[AR-LEX-C38-LAKIN-01] -->

[PAUSE 2s] How many shapes can one Arabic letter have? (**Up to four.**)

[PAUSE 2s] And what decides which one you write? (**Where it stands in the
word.**)
