...
% Page numbers in the table of contents. `book.cls` gives them a 1.55em box,
% which holds three digits. At chapter 151 this book's lesson pages pass 999,
% and every contents line with a four-digit page ("1000" is 4.93pt wider than
% the box) reported an overfull \hbox -- 78 of them. 2.4em holds four bold
% digits; the right margin that keeps titles clear of the numbers widens by the
% same 0.85em so the dotted leaders still stop short of them.
