...
% canonical-source-hash: fnv1a64:df815778928d8e13
% canonical-lessons: RU-C01-privet, RU-C01-zdravstvuyte, RU-C01-da, RU-C01-net, RU-C01-spasibo, RU-C01-pozhaluysta, RU-C01-practice, RU-W01-false-friends-v-r, RU-W02-false-friends-s-n, RU-W03-new-shapes-b-d, RU-W04-privet-letters-p-i, RU-W05-privet-letters-e-t, RU-W05-privet-observe, RU-W05-privet-guided-copy, RU-W05-privet-delayed-copy, RU-W05-privet-dictation
...
\end{tcolorbox}
\section[privét]{\ru{привет} — one supported copy}
...
\end{tcolorbox}
\section[privét]{\ru{привет} — look, hide, write, compare}
...
\end{tcolorbox}
\section[privét]{One heard greeting — write what you know}
...
{[}YOU HEAR: \emph{privét} — informal \textquotedblleft{}hi\textquotedblright{}{]}
