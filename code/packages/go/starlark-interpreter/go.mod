module github.com/adhithyan15/coding-adventures/code/packages/go/starlark-interpreter

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/starlark-ast-to-bytecode-compiler v0.0.0
	github.com/adhithyan15/coding-adventures/code/packages/go/starlark-vm v0.0.0
...
replace github.com/adhithyan15/coding-adventures/code/packages/go/starlark-vm => ../starlark-vm
