...
hand-edited totals.
Malayalam and Hindi A1 point-specific audit history now lives with the
corresponding direct owner under `core/exam-inventory-<track>-a1.d/`; chapter
agents must not recreate the retired aggregate inventories.
