# Build and run the x86_64-encoder tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name x86_64_encoder-tests -Sources @("tests\x86_64_encoder_test.c", "src\x86_64_encoder.c")
