# Build and run the cpu-pipeline tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name cpu_pipeline-tests -Sources @("tests\cpu_pipeline_test.c", "src\cpu_pipeline.c")
