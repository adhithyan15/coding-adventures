...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}vēr, aestās, autumnus, hiems\textquotedblright{} — the four seasons{]}
  \item {[}YOU SAY: the one that survived plainly — \textquotedblleft{}autumnus $\to$ otoño, automne, autumn\textquotedblright{}{]}
  \item {[}YOU SAY: the two built from phrases — \textquotedblleft{}prīma vēra $\to$ primavera,\textquotedblright{} \textquotedblleft{}hībernum $\to$ invierno, hiver\textquotedblright{}{]}
\end{itemize}
