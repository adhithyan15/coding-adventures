...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} You already say \textbf{obrigado / obrigada} (\textquotedblleft{}I am obliged\textquotedblright{}). The reply that closes the exchange is \textbf{de nada} — \textquotedblleft{}of nothing\textquotedblright{} — the very same phrase, word for word, as Spanish.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}obrigado / obrigada\textquotedblright{} … \textquotedblleft{}de nada\textquotedblright{} — the full exchange{]}
  \item {[}YOU SAY: \textquotedblleft{}de nada\textquotedblright{} then English \textquotedblleft{}native, nature\textquotedblright{} — nada's true family{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What did \emph{nada} originally mean in Latin? (A \emph{born thing} — \emph{nāta}.) Which language shares \emph{de nada} exactly, and which uses \emph{de rien} instead? (Spanish; French.) Next: \textbf{como}, \textquotedblleft{}how.\textquotedblright{}
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} One of two everyday ways to ask \emph{how are you?} in Portuguese starts with \textbf{como}, \textquotedblleft{}how.\textquotedblright{} It's the same word you've met (or will meet) across the Romance family.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}como\textquotedblright{} — \emph{KOH-moo}{]}
  \item {[}YOU SAY: como / cómo / come / comment — the four \emph{quomodo} siblings{]}
  \item {[}YOU SAY: \textquotedblleft{}Como vai?\textquotedblright{} and \textquotedblleft{}Como está?\textquotedblright{} — go, and stand{]}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}tudo\textquotedblright{} — \emph{TOO-doo}{]}
  \item {[}YOU SAY: \textquotedblleft{}Tudo bem?\textquotedblright{} — everything well?{]}
  \item {[}YOU SAY: \textquotedblleft{}tudo\textquotedblright{} then English \textquotedblleft{}total, totally\textquotedblright{} — one family{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What Latin word gives \emph{tudo}, and its English cousins? (\emph{tōtus} $\to$ total, totally, teetotal.) Why is \emph{Tudo bem?} so easy to use? (No pronoun, no verb — it dodges the \emph{você/tu/senhor} choice.) What's Portuguese for \textquotedblleft{}well\textquotedblright{}? (\emph{bem} $\leftarrow$ \emph{bene}.) Next: assemble all three \textquotedblleft{}how are you\textquotedblright{}s.
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Someone asks \emph{Tudo bem?} You're okay-ish. The Portuguese shrug is \textbf{mais ou menos} — \textquotedblleft{}more or less\textquotedblright{} — the same words, root for root, that Spanish uses.
\end{quote}
