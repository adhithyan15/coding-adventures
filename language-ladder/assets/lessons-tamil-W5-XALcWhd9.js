...
gloss: recognize and trace the first three Tamil numerals
...
register: neutral
variety: standard
reviews_of: [TA-C07-numbers-1-5]
---

# ௧ · ௨ · ௩ — three numeral shapes

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[TA-LEX-NUMBERS-1-5-01] -->

[PAUSE 2s] Say *onru, irantu, muunru*. The meanings and sounds are familiar;
...
gloss: recognize and trace two more Tamil numerals
prerequisites: [TA-W07-digits-1-3]
sounds: []
roots: []
duration:
  max_seconds: 135
...
register: neutral
variety: standard
reviews_of: [TA-W07-digits-1-3]
---

# ௪ · ௫ — finish the first five numerals
...
gloss: recognize and trace three Tamil numeral shapes
...
register: neutral
variety: standard
reviews_of: [TA-C07-numbers-6-10]
---

# ௬ · ௭ · ௮ — three more numeral shapes
...
romanization: "onru irantu muunru naanku aintu"
gloss: connect familiar Tamil letters and numerals to the first five words
prerequisites: [TA-W07-digits-4-5]
...
register: neutral
variety: standard
reviews_of: [TA-C07-numbers-1-5, TA-W07-digits-4-5]
---

# Five familiar words — now in Tamil script

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[TA-LEX-NUMBERS-1-5-01] -->

[PAUSE 2s] Say one to five, then read **௧ ௨ ௩ ௪ ௫**. No new numeral shape
appears below.
...
Follow each word with your finger while saying it. The letters have appeared
...
romanization: "aaru eezhu ettu onpatu pattu"
gloss: connect familiar Tamil letters and numerals to six through ten
prerequisites: [TA-W07-digits-9-10]
...
register: neutral
variety: standard
reviews_of: [TA-C07-numbers-6-10, TA-W07-digits-9-10]
---

# Six to ten — now in Tamil script

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[TA-LEX-NUMBERS-6-10-01, TA-LEX-NUMBERS-6-10-02] -->

[PAUSE 2s] Say six to ten, then read **௬ ௭ ௮ ௯ ௰**. No new numeral shape
appears below.
...
The curled sound you heard in *eezhu* is **ழ**. Follow **ஏழு** with your finger
...
`,_=e({default:()=>v}),v=`---
schema_version: 2
id: TA-W07-numbers-1-5-delayed-copy
spine_node: SPINE-COUNT-ONE-TO-FIVE
sequence: 425
delivery: script
chapter: 7
...
prerequisites: [TA-W07-numbers-1-5-guided-copy]
sounds: []
roots: []
duration:
  max_seconds: 120
...
register: neutral
variety: standard
reviews_of: [TA-W07-numbers-1-5-guided-copy]
---
...
`,y=e({default:()=>b}),b=`---
schema_version: 2
id: TA-W07-numbers-1-5-dictation
spine_node: SPINE-COUNT-ONE-TO-FIVE
sequence: 426
delivery: script
chapter: 7
...
prerequisites: [TA-W07-numbers-1-5-delayed-copy]
sounds: []
roots: []
duration:
  max_seconds: 135
...
register: neutral
variety: standard
reviews_of: [TA-W07-numbers-1-5-delayed-copy]
---
...
Write the three numeral shapes from sound alone. Then uncover: **௨ ௫ ௩**.
...
`,x=e({default:()=>S}),S=`---
schema_version: 2
id: TA-W07-numbers-1-5-guided-copy
spine_node: SPINE-COUNT-ONE-TO-FIVE
sequence: 424
delivery: script
chapter: 7
...
prerequisites: [TA-W07-number-words-1-5]
sounds: []
roots: []
duration:
  max_seconds: 120
...
register: neutral
variety: standard
reviews_of: [TA-W07-number-words-1-5]
---

# ௧ ௨ ௩ ௪ ௫ — one visible copy
...
`,C=e({default:()=>w}),w=`---
schema_version: 2
id: TA-W07-numbers-6-10-delayed-copy
spine_node: SPINE-COUNT-ONE-TO-FIVE
sequence: 446
delivery: script
chapter: 7
...
prerequisites: [TA-W07-numbers-6-10-guided-copy]
...
register: neutral
variety: standard
reviews_of: [TA-W07-numbers-6-10-guided-copy]
---
...
`,F=e({default:()=>I}),I=`---
schema_version: 2
id: TA-W08-sollungal-delayed-copy
spine_node: SPINE-POLITE-REQUEST-REPAIR
sequence: 474
delivery: script
chapter: 8
...
gloss: retrieve familiar solluṅgaḷ after hiding its model
romanization: "solluṅgaḷ"
prerequisites: [TA-W08-sollungal-guided-copy]
sounds: [tamil-vowel-sign-o]
roots: []
duration:
  max_seconds: 120
...
register: respectful
variety: standard-colloquial
reviews_of: [TA-W08-sollungal-guided-copy]
---

# Solluṅgaḷ — hide, then write

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[TA-SCRIPT-SHORT-O-01, TA-SCRIPT-WRITE-SOLLUNGAL-02] -->

Study **சொல்லுங்கள்** for five seconds. Point to **சொ**, say *solluṅgaḷ*, then
cover the model.
...
Write **சொ** while the model is hidden. If that feels secure, continue and
write the whole request. Peek once if needed, cover it again, and finish. Then
uncover the model and repair only the short-*o* syllable.

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[TA-SCRIPT-SHORT-O-01, TA-SCRIPT-WRITE-SOLLUNGAL-02, TA-LEX-SOLLUNGAL-01] -->

[PAUSE 3s] What changed from the previous step? (**The model was hidden before
writing.**) Say what your word means. (**Please tell me.**)
`,L=e({default:()=>R}),R=`---
schema_version: 2
id: TA-W08-sollungal-dictation
spine_node: SPINE-POLITE-REQUEST-REPAIR
sequence: 475
delivery: script
chapter: 8
type: writing
headword: "சொல்லுங்கள்"
gloss: write familiar solluṅgaḷ from sound alone
romanization: "solluṅgaḷ"
prerequisites: [TA-W08-sollungal-delayed-copy]
sounds: [tamil-vowel-sign-o]
roots: []
duration:
  max_seconds: 120
...
register: respectful
variety: standard-colloquial
reviews_of: [TA-W08-sollungal-delayed-copy, TA-C08-sollungal]
---

# One heard request — write it

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[TA-LEX-SOLLUNGAL-01] -->

Cover every Tamil model. You will hear the same useful request you have already
said, traced, copied, and retrieved.

## Writing — dictation
<!-- hl-knowledge: introduces=[]; assesses=[TA-SCRIPT-SHORT-O-01, TA-SCRIPT-WRITE-SOLLUNGAL-02, TA-LEX-SOLLUNGAL-01] -->
<!-- hl-writing-stage: dictation-transcription -->

[YOU HEAR: *solluṅgaḷ* — **please tell me**]

Write the request from sound alone. Then uncover **சொல்லுங்கள்**. Check **சொ**
first: the short-*o* sign should reach around **ச**. Repair one place if needed;
do not rewrite the whole word.

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[TA-SCRIPT-SHORT-O-01, TA-SCRIPT-WRITE-SOLLUNGAL-02, TA-LEX-SOLLUNGAL-01] -->

[PAUSE 3s] Without looking, write only the opening syllable of *solluṅgaḷ*.
(**சொ**.) You are ready to compare this ordinary respectful request with the
weightier *tayavu seytu*.
`,z=e({default:()=>B}),B=`---
schema_version: 2
