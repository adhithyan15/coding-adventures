...
% canonical-source-hash: fnv1a64:9b1a0cadb96bfe1c
% canonical-lessons: FA-C05-khoda, FA-C05-hafez, FA-C05-khodahafez, FA-C05-khodahafez-more, FA-C05-practice
...
\end{tcolorbox}
\section[(khodâ hâfez, continued)]{(\fa{خداحافظ}, continued) — Grammar Lens — a complete wish without a full sentence}

\label{lesson:FA-C05-khodahafez-more}



\begin{quote}
Before going on: say \textbf{\fa{خداحافظ}} again, and what it means.
\end{quote}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} what this lesson added to \textbf{\fa{خداحافظ}}, in one sentence
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What did this lesson add to \textbf{\fa{خداحافظ}}? Say it once more, without looking.
\end{tcolorbox}
