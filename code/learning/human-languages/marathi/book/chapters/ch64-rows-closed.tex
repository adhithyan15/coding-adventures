...
% canonical-source-hash: fnv1a64:06546597db71aa1f
% canonical-lessons: MR-C64-dhol, MR-W64-ddha, MR-C64-phanas, MR-W64-pha, MR-W64-danda, MR-R64-rows-closed
...
\section[ḍhol]{\mr{ढोल} (ḍhol) — a drum}

\label{lesson:MR-C64-dhol}
...
\subsection*{You'll want to know: \mr{ढोल}}
\textbf{\mr{ढोल}} — \emph{ḍhol} — \textquotedblleft{}a drum\textquotedblright{}.

Say it: \emph{ḍhol}. Look at its shape as you say it: the next lesson takes one piece of it, \textbf{\mr{ढ}}, and writes it on its own.
...
What is \textquotedblleft{}a drum\textquotedblright{}? (\textbf{\mr{ढोल}}, \emph{ḍhol}.)
\end{tcolorbox}
...
\hlblockfigure{\detokenize{figures/MR-W64-ddha-filmstrip.pdf}}{How \mr{ढ} is written, stroke by stroke}
...
\end{tcolorbox}
\section[phaṇas]{\mr{फणस} (phaṇas) — a jackfruit}

\label{lesson:MR-C64-phanas}
...
\subsection*{You'll want to know: \mr{फणस}}
\textbf{\mr{फणस}} — \emph{phaṇas} — \textquotedblleft{}a jackfruit\textquotedblright{}.

Say it: \emph{phaṇas}. Look at its shape as you say it: the next lesson takes one piece of it, \textbf{\mr{फ}}, and writes it on its own.
...
\raggedright
  \item \emph{phaṇas}
  \item \emph{phaṇas}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}a jackfruit\textquotedblright{}? (\textbf{\mr{फणस}}, \emph{phaṇas}.)
\end{tcolorbox}
...
\subsection*{Writing: guided copy}
\hlblockfigure{\detokenize{figures/MR-W64-pha-filmstrip.pdf}}{How \mr{फ} is written, stroke by stroke}
