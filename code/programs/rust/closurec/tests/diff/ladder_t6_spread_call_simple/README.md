# ladder_t6_spread_call_simple

Rung 6.spread_call of the CCR-066 differential complexity ladder, at `SIMPLE`.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level SIMPLE_OPTIMIZATIONS --js tests/diff/ladder_t6_spread_call_simple/input/a.js
```
