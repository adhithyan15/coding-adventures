...
describe("what the corpus actually covers", () => {
  ...
  it("reports the shortfall in a form somebody can act on", () => {
    ...
    expect(report).toContain("spanish A1 (partial inventory): 255/273 points covered (93%)");
    expect(report).toContain("18 with no corresponding atom");
