...
describe("the committed corpus", () => {
  ...
  it("pins the first ledger, and it is the reason the rule exists", () => {
    ...
    expect(l.summary.roots).toBe(3079); // +1: Portuguese's typed olá opener records its etymon atom
    expect(l.summary.underspent).toBe(2965); // +1: Portuguese's new etymon atom begins underspent. // +1: rāma is introduced once in the Marwadi starter
    ...
    expect(byNamespace).toEqual({ roots: 2194, "etymon-atom": 885 }); // +1 etymon-atom: Portuguese olá
  });
