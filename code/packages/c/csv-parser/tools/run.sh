#!/bin/sh
# Build and run the csv-parser tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c csv_parser-tests tests/csv_parser_test.c src/csv_parser.c
