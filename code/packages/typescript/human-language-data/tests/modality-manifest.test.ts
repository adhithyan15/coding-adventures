...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 2233, // +3: HL-C97 adds the repair kit (no entiendo, mas despacio) at chapter 14 // +40: vocabulary wave 5 (persian 12, telugu 13, malayalam 15) // +4: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +3: HL-C88 slice 8 (-ario, review, synthesis) // +54: vocabulary wave 6 (russian 14, persian 14, urdu 13, bengali 13) // +1: HL-C88 slice 9 (falsos amigos) // +3: B1 si-condition rung // +3: HL-C113 preterite plural // +4: HL-C113 preterite close (strong plurals, review, synthesis) // +2: HL-C113 imperfect subjunctive // +3: HL-C113 unreal condition // HL-C113 step 7: +4 // HL-C113 step 8: +3 // HL-C128 step 2: +5 // HL-C128 step 3: +4 // HL-C128 step 4: +6 // HL-C128 step 5: +5 // HL-C127: +5 // HL-C128 step 7: +5 // HL-C128 step 8: +6 // HL-C128 step 9: +5 // HL-C128 step 10: +5 // HL-C136 wave I: +42, seven lessons in each of six new chapters // HL-C137 wave II: +36 adjective lessons, +6 chapters, and drivablePercent rises AGAIN // HL-C152: Spanish realizes SPINE-NEGATE-AND-ASK — five lessons, one chapter, A2 complete at 5/5 // HL-C157: +2 // HL-C156: 85 script segments across the six Indic tracks // HL-C158: +4 -- the B1 travel rung (chapter 268)
      ...
      voice: 1463, // HL-C157 // +35: vocabulary wave 5, mostly ear-only lessons // +3: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +3: HL-C88 slice 8 (-ario, review, synthesis) // +36: vocabulary wave 6 // +1: HL-C88 slice 9 (falsos amigos) // +3: B1 si-condition rung // +3: HL-C113 preterite plural // +4: HL-C113 preterite close (strong plurals, review, synthesis) // +2: HL-C113 imperfect subjunctive // +3: HL-C113 unreal condition // HL-C113 step 7: +2 // HL-C113 step 8: +3 // HL-C128 step 2: +4 // HL-C128 step 3: +3 // HL-C128 step 4: +6 // HL-C128 step 5: +4 // HL-C127: +3 // HL-C128 step 7: +3 // HL-C128 step 8: +6 // HL-C128 step 9: +5 // HL-C128 step 10: +5 // HL-C136 wave I: +42 -- ALL of it. Not one of the 42 needs eyes, so `sight` and `pen` below do not move at all // HL-C137 wave II: +36 adjective lessons, +6 chapters, and drivablePercent rises AGAIN // HL-C152: Spanish realizes SPINE-NEGATE-AND-ASK — five lessons, one chapter, A2 complete at 5/5 // HL-C158: +4 -- the B1 travel rung (chapter 268)
      ...
      drivableLessons: 1463, // HL-C157 // +35: vocabulary wave 5 // +3: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +3: HL-C88 slice 8 (-ario, review, synthesis) // +36: vocabulary wave 6 // +1: HL-C88 slice 9 (falsos amigos) // +3: B1 si-condition rung // +3: HL-C113 preterite plural // +4: HL-C113 preterite close (strong plurals, review, synthesis) // +2: HL-C113 imperfect subjunctive // +3: HL-C113 unreal condition // HL-C113 step 7: +2 -- the review and synthesis narrate; 214 and 215 are sight-cue, being ABOUT written marks // HL-C113 step 8: +3 // HL-C128 step 2: +4 -- ch223 is sight-cue, being about the letters visible inside aquel // HL-C128 step 3: +3 // HL-C128 step 4: +6 -- all six narrate // HL-C128 step 5: +4 // HL-C127: +3 // HL-C128 step 7: +3 -- all five narrate // HL-C128 step 8: +6 -- ch252 and ch255 are sight-cue -- both turn on written accents // HL-C128 step 9: +5 // HL-C128 step 10: +5 // HL-C136 wave I: +42, the same 42 // HL-C137 wave II: +36 adjective lessons, +6 chapters, and drivablePercent rises AGAIN // HL-C152: Spanish realizes SPINE-NEGATE-AND-ASK — five lessons, one chapter, A2 complete at 5/5 // HL-C158: +4 -- the B1 travel rung (chapter 268)
      ...
      trackCount: 22,
      chapterCount: 780, // +15: vocabulary wave 5 (persian +3, telugu +6, malayalam +6) // +4: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +3: HL-C88 slice 8 (-ario, review, synthesis) // +12: vocabulary wave 6 // +1: HL-C88 slice 9 (falsos amigos) // +3: B1 si-condition rung // +3: HL-C113 preterite plural // +4: HL-C113 preterite close (strong plurals, review, synthesis) // +2: HL-C113 imperfect subjunctive // +3: HL-C113 unreal condition // HL-C113 step 7: +4 // HL-C113 step 8: +3 // HL-C128 step 2: +5 // HL-C128 step 3: +4 // HL-C128 step 4: +6 // HL-C128 step 5: +5 // HL-C127: +5 // HL-C128 step 7: +5 // HL-C128 step 8: +6 // HL-C128 step 9: +5 // HL-C128 step 10: +5 // HL-C136 wave I: +6, one chapter per Indic track // HL-C137 wave II: +36 adjective lessons, +6 chapters, and drivablePercent rises AGAIN // HL-C152: Spanish realizes SPINE-NEGATE-AND-ASK — five lessons, one chapter, A2 complete at 5/5 // HL-C158: +4 -- the B1 travel rung (chapter 268)
      ...
      drivablePrefixTotal: 1261, // HL-C157: the future-tense conjugation table is sight so ch49 leaves the drivable prefix, // +32: vocabulary wave 5's new chapters, mostly ear-only from their own start // +3: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +3: HL-C88 slice 8 (-ario, review, synthesis) // +26: vocabulary wave 6 // +1: HL-C88 slice 9 (falsos amigos) // +3: B1 si-condition rung // +3: HL-C113 preterite plural // +4: HL-C113 preterite close (strong plurals, review, synthesis) // +2: HL-C113 imperfect subjunctive // +3: HL-C113 unreal condition // HL-C113 step 7: +2 // HL-C113 step 8: +3 // HL-C128 step 2: +4 // HL-C128 step 3: +3 // HL-C128 step 4: +6 // HL-C128 step 5: +4 // HL-C127: +3 // HL-C128 step 7: +3 // HL-C128 step 8: +6 // HL-C128 step 9: +5 // HL-C128 step 10: +5 // HL-C136 wave I: +42 -- each of the six chapters is drivable from its own first lesson to its last, so the prefix is the whole chapter // HL-C137 wave II: +36 adjective lessons, +6 chapters, and drivablePercent rises AGAIN // HL-C152: Spanish realizes SPINE-NEGATE-AND-ASK — five lessons, one chapter, A2 complete at 5/5 // HL-C158: +4 -- the B1 travel rung (chapter 268)
      ...
      fullyDrivableChapters: 480, // HL-C157: same table same chapter, // +6: shorter chapters are more often drivable end to end // +10: vocabulary wave 5's new chapters // +3: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +3: HL-C88 slice 8 (-ario, review, synthesis) // +5: vocabulary wave 6 // +1: HL-C88 slice 9 (falsos amigos) // +3: B1 si-condition rung // +3: HL-C113 preterite plural // +4: HL-C113 preterite close (strong plurals, review, synthesis) // +2: HL-C113 imperfect subjunctive // +3: HL-C113 unreal condition // HL-C113 step 7: +2 // HL-C113 step 8: +3 // HL-C128 step 2: +4 // HL-C128 step 3: +3 // HL-C128 step 4: +6 // HL-C128 step 5: +4 // HL-C127: +3 // HL-C128 step 7: +3 // HL-C128 step 8: +6 // HL-C128 step 9: +5 // HL-C128 step 10: +5 // HL-C136 wave I: +6 -- all six new chapters end to end, which is what a wave with no script section looks like // HL-C137 wave II: +36 adjective lessons, +6 chapters, and drivablePercent rises AGAIN // HL-C152: Spanish realizes SPINE-NEGATE-AND-ASK — five lessons, one chapter, A2 complete at 5/5 // HL-C156: 85 script segments across the six Indic tracks // HL-C158: +4 -- the B1 travel rung (chapter 268)
