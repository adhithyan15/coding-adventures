...
headword: منہ
romanization: muṅh
gloss: mouth — the plain نون that already nasalized آنکھ, unglossed, and a Greek word possibly hiding behind the same root
concept_tag: UR-MOUTH
prerequisites: [UR-C10-aankh]
sounds: [rtl, nasal-vowel, short-vowels-unwritten]
roots: [sanskrit-mukha, pie-mu]
etymology_hook: muṅh continues Sanskrit mukha, "mouth, face" -- Mayrhofer's proposed Proto-Indo-European *mu-, "a vocal gesture for pressed lips," would connect it distantly to Greek mȳthos (behind English myth) and German Maul, though he flags borrowing from a non-Indo-European source as less likely but not impossible, so this stays held loosely like bahan's link to bhaj-.
duration:
  max_seconds: 280
requires:
...
> **منہ** — *muṅh* — **mouth** (also: **face**)

> **میرا منہ۔** — *merā muṅh.* — "my mouth."

**منہ** is masculine.

## The letters in this word
<!-- hl-knowledge: introduces=[UR-SCRIPT-NUN-NASAL-VOWEL]; assesses=[UR-SCRIPT-MAIN-HUN, UR-LEX-AANKH] -->

From the right edge: **م** *m*, then **ن**, then **ہ**, the round *he* you
...
## The word, taken apart — a word possibly behind myth
<!-- hl-knowledge: introduces=[UR-ETYMON-MUNH-MYTH]; assesses=[UR-LEX-MUNH] -->

**muṅh** continues Sanskrit *múkha*, "mouth, face." One proposal,
from the Sanskrit etymologist Manfred Mayrhofer, ties it to a
Proto-Indo-European gesture-root **\\*mu-**, "pressed lips" — the same root
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-MUNH, UR-SCRIPT-NUN-NASAL-VOWEL, UR-ETYMON-MUNH-MYTH, UR-LEX-AANKH, UR-LEX-KAAN, UR-LEX-NAAK] -->

- [YOU SAY: **muṅh** — mouth; then **merā muṅh**]
- [YOU CONTRAST: plain **ن** nasalizing in **āṅkh** and **muṅh**; **ں**
  *nūn ghunna* nasalizing in **maiṅ** and **hūṅ**]
- [YOU SAY: four face words now — **kān, nāk, āṅkh, muṅh**]
- [YOU CONNECT: **muṅh** possibly ← *\\*mu-* → Greek **mŷthos** → English
  **myth**, held loosely]
...
Sources: [Wiktionary: منہ](https://en.wiktionary.org/wiki/%D9%85%D9%86%DB%81).
`,_=e({default:()=>v}),v=`---
schema_version: 2
id: UR-C10-naak
spine_node: SPINE-CHECK-WELLBEING
...
register: neutral
variety: contemporary-standard-urdu
reviews_of: [UR-C10-kaan]
---

# ناک — "nose," the same three letters as کان, backwards

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-KAAN, UR-GRAMMAR-MERA-GENDER-AGREEMENT] -->

[PAUSE 2s] Say **merā kān** — my ear, masculine, unchanged **merā**. This
word shares every letter with it.

## You'll want to know first — one word
<!-- hl-knowledge: introduces=[UR-LEX-NAAK]; assesses=[] -->

> **ناک** — *nāk* — **nose**

> **میری ناک۔** — *merī nāk.* — "my nose."

**ناک** is feminine — **merī**, not **merā**. Grammatical gender does not
follow shape or sound; it has to be learned noun by noun.

## The letters in this word
<!-- hl-knowledge: introduces=[UR-SCRIPT-KAAN-NAAK-REVERSAL]; assesses=[UR-LEX-KAAN, UR-LEX-NAAK] -->

**کان** is **ک ا ن** — *k, ā, n*. **ناک** is **ن ا ک** — *n, ā, k*. The same
three letters, in exactly the opposite order. Ear and nose, spelled as
mirror images of each other — a coincidence of Urdu's script, not of its
history; the two words are not related.

## The word, taken apart — a real cousin, and English agrees
<!-- hl-knowledge: introduces=[UR-ETYMON-NAAK-NOSE]; assesses=[UR-LEX-NAAK, UR-ETYMON-KAAN-UNCERTAIN] -->

**nāk** continues Sauraseni Prakrit *ṇakka*, from Proto-Indo-Iranian
...
<!-- hl-activity: {"id":"UR-C10-naak-reversal","kind":"text","assesses":["UR-SCRIPT-KAAN-NAAK-REVERSAL"],"prompt":"Type the Urdu word for 'nose' — the same three letters as کان, reversed.","answer":"ناک","accepted":["naak","nāk"],"feedback":{"correct":"Right: ناک — ن ا ک, the reverse of کان's ک ا ن.","incorrect":"Use ناک — nāk."},"response_seconds":9} -->

[PAUSE 3s] What is the letter relationship between **کان** and **ناک**?
(**Same three letters, reversed order.**) Is **ناک**'s English cousin
settled or disputed? (**Settled — *nose* shares its root.**) Is **ناک**
masculine or feminine? (**Feminine.**)

Sources: [Wiktionary: ناک](https://en.wiktionary.org/wiki/%D9%86%D8%A7%DA%A9).
