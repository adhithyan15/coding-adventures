...
describe("the committed corpus", () => {
  ...
  it("pins the first ledger, and it is the reason the rule exists", () => {
    ...
    expect(l.summary.roots).toBe(3082); // Italian and French typed openers each record an etymon atom.
    ...
    expect(byNamespace).toEqual({ roots: 2194, "etymon-atom": 888 }); // +2: Italian and French migrated opener etymons.
  });
