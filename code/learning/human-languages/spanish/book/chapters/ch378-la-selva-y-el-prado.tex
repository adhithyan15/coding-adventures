...
% canonical-source-hash: fnv1a64:c185280a83d7bb99
...
One last thing, because it is the opposite of what you would guess. The nearest English relative is not \emph{culminate}, which is a late borrowing off the same Latin noun. It is Latin \textbf{columna}, the pillar, which the etymological dictionaries file as \emph{culmen}'s twin rather than its cousin. A pillar and a mountaintop are both the thing that stands highest.
\end{cousinweb}
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What did Latin \emph{culmen} mean first? (The ridge of a roof.) And which Latin word is its closest relative? (\emph{Columna}, the pillar — its twin form.)
\end{tcolorbox}
