...
headword: ど
romanization: do
gloss: the hiragana sign と voiced with dakuten to carry the mora do
prerequisites: [JA-C09-wakarimasen]
sounds: [mora, dakuten]
roots: []
etymology_hook: The learner already owns both the base sign and the voicing mark; this microstep makes their new combination explicit before ichido asks for decoding.
duration:
  max_seconds: 160
requires:
  knowledge: [JA-SCRIPT-TO-01, JA-SCRIPT-DAKUTEN-01, JA-LEX-WAKARIMASEN]
introduces:
  knowledge: [JA-SCRIPT-DO-01]
practises:
  knowledge: [JA-SCRIPT-DO-01, JA-SCRIPT-TO-01, JA-SCRIPT-DAKUTEN-01, JA-LEX-WAKARIMASEN]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus, meaning-input]
register: neutral-across-levels
variety: standard-japanese-tokyo
reviews_of: [JA-C09-wakarimasen, JA-W03-to, JA-W03-dakuten]
---

# ど — voice a sign you already own

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-TO-01, JA-SCRIPT-DAKUTEN-01, JA-LEX-WAKARIMASEN] -->

[PAUSE 12s] Write **と**. Add the two-stroke dakuten beside it. Say
*wakarimasen* once as the reason a repetition may be needed.

## Script — carry the voicing mark
<!-- hl-knowledge: introduces=[JA-SCRIPT-DO-01]; assesses=[] -->

> **と** *to* + **゛** → **ど** *do*

The base shape does not change. Write **と** first, then add the two short
dakuten strokes at the upper right. The mark voices the opening consonant: *t*
becomes *d* while the vowel stays *o*.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-DO-01, JA-SCRIPT-TO-01, JA-SCRIPT-DAKUTEN-01] -->

1. Copy **と → ど** once.
2. Cover the model and write the voiced sign from the heard mora *do*.
3. Read **と / ど** as *to / do* without changing the vowel.

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-DO-01] -->
<!-- hl-activity: {"id":"JA-W09-do-build","kind":"text","assesses":["JA-SCRIPT-DO-01"],"prompt":"Voice と with the dakuten and write the resulting sign.","answer":"ど","accepted":["hiragana do"],"feedback":{"correct":"Right: と plus dakuten is ど.","incorrect":"Write と first, then add the dakuten: ど."},"response_seconds":10} -->

Write **ど** once more from memory.

Source: [Unicode Hiragana chart](https://www.unicode.org/charts/PDF/U3040.pdf); voicing pattern and stroke order per *Hitsujun Shido no Tebiki* (Japanese Ministry of Education, 1958).
`,k=e({default:()=>A}),A=`---
schema_version: 2
id: JA-W09-ku
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
headword: く
romanization: ku
gloss: the hiragana sign for the mora ku
prerequisites: [JA-C09-yoku]
sounds: [mora]
roots: []
etymology_hook: One clean angle closes the two-sign word yoku without turning a vocabulary lesson into a script cliff.
duration:
  max_seconds: 155
requires:
  knowledge: [JA-LEX-YOKU, JA-SCRIPT-YO-01]
introduces:
  knowledge: [JA-SCRIPT-KU-01]
practises:
  knowledge: [JA-SCRIPT-KU-01, JA-LEX-YOKU, JA-SCRIPT-YO-01]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus, meaning-input]
register: neutral-across-levels
variety: standard-japanese-tokyo
reviews_of: [JA-C09-yoku, JA-C09-sumimasen, JA-W08-yo]
---

# く — one angled stroke

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-LEX-YOKU, JA-SCRIPT-YO-01] -->

[PAUSE 8s] Write known **よ** and say *yoku*.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-KU-01]; assesses=[] -->

> **く** — *ku*

One stroke. Begin high on the right, sweep down-left to the point, then turn and
sweep down-right. Keep it narrow and open. The turn is part of the same stroke.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-KU-01, JA-LEX-YOKU] -->
1. Look at **く** for five seconds.
2. Hide it and write the one angled stroke.
3. Reveal, check, then join known **よ** + **く** → **よく**.

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-KU-01] -->
<!-- hl-activity: {"id":"JA-W09-ku-write","kind":"text","assesses":["JA-SCRIPT-KU-01"],"prompt":"Write the one-stroke hiragana sign for ku.","answer":"く","accepted":["hiragana ku"],"feedback":{"correct":"Yes: く is one continuous angled stroke.","incorrect":"Write く: down-left, turn, down-right."},"response_seconds":10} -->

Read **よく** once without romanization.

Source: [Unicode Hiragana chart](https://www.unicode.org/charts/PDF/U3040.pdf); stroke order per *Hitsujun Shido no Tebiki* (Japanese Ministry of Education, 1958).
`,j=e({default:()=>M}),M=`---
schema_version: 2
id: JA-W09-me
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
headword: め
romanization: me
gloss: the hiragana sign for the mora me
prerequisites: [JA-W09-mi]
sounds: [mora]
roots: []
etymology_hook: A second isolated shape makes another part of sumimasen readable while the remaining signs stay supported by romanization.
duration:
  max_seconds: 170
requires:
  knowledge: [JA-LEX-SUMIMASEN, JA-SCRIPT-MI-01]
introduces:
  knowledge: [JA-SCRIPT-ME-01]
practises:
  knowledge: [JA-SCRIPT-ME-01, JA-SCRIPT-MI-01, JA-LEX-SUMIMASEN]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus, meaning-input]
register: neutral-across-levels
variety: standard-japanese-tokyo
reviews_of: [JA-W09-mi, JA-C09-sumimasen]
---

# め — cross, loop, release

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-MI-01, JA-LEX-SUMIMASEN] -->

[PAUSE 10s] Find **み** in **すみません**, then say the five-mora repair opener.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-ME-01]; assesses=[] -->

> **め** — *me*

Two strokes. The short first stroke leans down to the right. The longer second
stroke crosses it, curves into an open loop, and releases at the lower right.
Keep that final opening visible; do not close it into a circle.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-ME-01, JA-SCRIPT-MI-01] -->
- [YOU COPY: **め** once with the model visible]
- [YOU READ: point to **み**, then **め** and say *mi, me*]
- [YOU FIND: circle **め** inside **すみません**]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-ME-01] -->
<!-- hl-activity: {"id":"JA-W09-me-strokes","kind":"text","assesses":["JA-SCRIPT-ME-01"],"prompt":"How many strokes does め have?","answer":"2","accepted":["two","2 strokes","two strokes"],"feedback":{"correct":"Two: a short diagonal, then the crossing open loop.","incorrect":"Two strokes; the long second stroke makes the open loop."},"response_seconds":8} -->

Write **め** once more while saying *me*.
...
headword: み
romanization: mi
gloss: the hiragana sign for the mora mi
prerequisites: [JA-C09-sumimasen]
sounds: [mora]
roots: []
etymology_hook: One new sign unlocks the second mora of the repair opener without asking the learner to decode the whole word.
duration:
  max_seconds: 165
requires:
  knowledge: [JA-LEX-SUMIMASEN, JA-SCRIPT-HIRAGANA-MORA]
introduces:
...
register: neutral-across-levels
variety: standard-japanese-tokyo
reviews_of: [JA-C09-sumimasen, JA-W03-ma]
---
...
Write it in two strokes. First make the bent left body, ending in a small turn.
Then begin at the upper right, sweep down through the middle, and finish by
lifting to the right. Say *mi* only when the second stroke ends.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-MI-01] -->
1. Trace **み** once with a finger.
2. Trace it once with a pencil.
3. Point to **み** inside **すみません**; do not decode the other signs yet.

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-MI-01] -->
<!-- hl-activity: {"id":"JA-W09-mi-select","kind":"text","assesses":["JA-SCRIPT-MI-01"],"prompt":"Which sign carries mi?","answer":"み","accepted":["hiragana mi"],"feedback":{"correct":"Right: み carries mi.","incorrect":"Write み, the two-stroke looped bridge."},"response_seconds":8} -->
...
headword: も
romanization: mo
gloss: the hiragana sign for the mora mo
prerequisites: [JA-C09-mou]
sounds: [mora]
roots: []
etymology_hook: The first sign of mō is isolated so the learner can see that final u, not an invisible spelling rule, supplies the second mora.
duration:
  max_seconds: 160
requires:
  knowledge: [JA-LEX-MOU, JA-SCRIPT-U-01]
introduces:
  knowledge: [JA-SCRIPT-MO-01]
practises:
  knowledge: [JA-SCRIPT-MO-01, JA-LEX-MOU, JA-SCRIPT-U-01, JA-SCRIPT-MI-01]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus, meaning-input]
register: neutral-across-levels
variety: standard-japanese-tokyo
reviews_of: [JA-C09-mou, JA-W03-u, JA-W09-mi]
---

# も — two bars, then the curve

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[JA-LEX-MOU, JA-SCRIPT-U-01, JA-SCRIPT-MI-01] -->

[PAUSE 10s] Write known **う** and **み**, then say *mo | o*.

## Script — the shape
<!-- hl-knowledge: introduces=[JA-SCRIPT-MO-01]; assesses=[] -->

> **も** — *mo*

Three strokes. Draw the central curve first, from the upper left down and around.
Then add the upper short horizontal and the lower short horizontal. Both bars
cross the central stroke.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-MO-01, JA-LEX-MOU, JA-SCRIPT-U-01] -->
1. Copy **も** once.
2. Hide it for ten seconds and write it again.
3. Add known **う**: **もう**. Read *mo | o*.

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[JA-SCRIPT-MO-01] -->
<!-- hl-activity: {"id":"JA-W09-mo-order","kind":"text","assesses":["JA-SCRIPT-MO-01"],"prompt":"In も, what comes first: the long curve or the two short bars?","answer":"the long curve","accepted":["curve","long curve first","the curve"],"feedback":{"correct":"Right: curve first, then the upper and lower bars.","incorrect":"Write the long curve first; add the two short bars after it."},"response_seconds":8} -->

Cover the model and write **もう** once.
