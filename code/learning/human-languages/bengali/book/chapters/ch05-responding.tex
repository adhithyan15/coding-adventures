...
% canonical-source-hash: fnv1a64:b64c4e94f86c61dd
...
\section[āmi]{\bn{আমি} (āmi) — \textquotedblleft{}I,\textquotedblright{} cousin of English \emph{am}}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}āmi\textquotedblright{}
  \item \emph{Say it:} the pair — \emph{āmi} (I), \emph{āmār} (my)
  \item \emph{Say it:} the English cousin hidden in it (\emph{am} — from the same \emph{asmi})
  \item \emph{Recall:} say \emph{ki}, then say \emph{tumi / āpni}
\end{itemize}
...
\end{tcolorbox}
\section[kēmon]{\bn{কেমন} (kēmon) — \textquotedblleft{}how,\textquotedblright{} another of the k- questions}
...
\begin{quote}
You met \textbf{\bn{কি}} (\emph{ki}, \textquotedblleft{}what\textquotedblright{}) in Chapter 3. Here is its sibling.
\end{quote}
...
\end{tcolorbox}
\section[tumi kēmon āchho?]{\bn{তুমি} \bn{কেমন} \bn{আছো}? (tumi kēmon āchho?) — \textquotedblleft{}how are you?\textquotedblright{}}
...
\end{tcolorbox}
\section[bhālo]{\bn{ভালো} (bhālo) — \textquotedblleft{}well,\textquotedblright{} and how to answer}
...
\end{tcolorbox}
\section[kono bæpār nā]{\bn{কোনো} \bn{ব্যাপার} \bn{না} (kono bæpār nā) — \textquotedblleft{}no matter\textquotedblright{}}
