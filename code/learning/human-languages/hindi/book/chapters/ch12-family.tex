...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}pitā, mātā\textquotedblright{} — the Sanskrit-descended, formal pair{]}
  \item {[}YOU SAY: \textquotedblleft{}bāp, māṁ\textquotedblright{} — the everyday, spoken pair{]}
  \item {[}YOU SAY: the deep cousin — \textquotedblleft{}pitā and father are the same ancient PIE word\textquotedblright{}{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} You've met \emph{frāter} and \emph{soror} as PIE cousins of \textquotedblleft{}brother\textquotedblright{} and \textquotedblleft{}sister.\textquotedblright{} Hindi's pair has a genuine surprise hiding in it: only \textbf{one} of these two continues that ancient family.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}bhāī\textquotedblright{} — brother — the true PIE cousin of \textquotedblleft{}brother\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}bahin\textquotedblright{} — sister — from bhaginī, \textquotedblleft{}the one who shares,\textquotedblright{} NOT from the PIE word for sister{]}
