# ladder_t4_after_return_simple

Rung 4.after_return of the CCR-066 differential complexity ladder, at `SIMPLE`.

## What this rung is for

Exercises a statement after return, which is unreachable by control flow.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level SIMPLE_OPTIMIZATIONS --js tests/diff/ladder_t4_after_return_simple/input/a.js
```
