...
it("pins Marwadi-owned chapters and objective activities", () => {
  ...
  expect(lessons).toHaveLength(350);
  expect(new Set(lessons.map((lesson) => Number(lesson.frontmatter.chapter)))).toEqual(
    new Set(Array.from({ length: 43 }, (unused, index) => index + 1)),
  );
  ...
  expect(activities.map((activity) => activity.id).sort()).toEqual([
    ...
    "MW-C32-chaar-dictation",
    "MW-C32-count-five-payoff",
    "MW-C32-do-two-dictation",
    "MW-C32-ek-dictation",
    "MW-C32-hear-chaar-breath",
    "MW-C32-hear-do-two-sense",
    "MW-C32-hear-ek-meaning",
    "MW-C32-hear-paanch-count",
    "MW-C32-hear-teen-count",
    "MW-C32-paanch-dictation",
    "MW-C32-teen-dictation",
    "MW-C33-aath-dictation",
    "MW-C33-chha-dictation",
    "MW-C33-count-ten-payoff",
    "MW-C33-das-dictation",
    "MW-C33-hear-aath-place",
    "MW-C33-hear-chha-breath",
    "MW-C33-hear-das-count",
    "MW-C33-hear-no-nine-rhyme",
    "MW-C33-hear-saat-count",
    "MW-C33-no-nine-pair",
    "MW-C33-saat-dictation",
    "MW-C34-bees-dictation",
    "MW-C34-counter-offer-write",
    "MW-C34-hear-bees-tens",
    "MW-C34-hear-counter-offer-slot",
    "MW-C34-hear-price-number-answer",
    "MW-C34-hear-so-triple",
    "MW-C34-numbered-price-payoff",
    "MW-C34-price-number-write",
    "MW-C34-so-dictation",
    "MW-C35-read-eight-ticket-two-digit",
    "MW-C35-read-five-ticket-both-ways",
    "MW-C35-read-ten-ticket-figure",
    "MW-C35-read-ticket-hundred",
    "MW-C35-ticket-four-payoff",
    "MW-C36-numbered-exchange-payoff",
    "MW-C37-baara-dictation",
    "MW-C37-chauda-dictation",
    "MW-C37-hear-baara-count",
    "MW-C37-hear-chauda-count",
    "MW-C37-hear-igyaara-count",
    "MW-C37-hear-pandara-count",
    "MW-C37-hear-tera-count",
    "MW-C37-igyaara-build",
    "MW-C37-pandara-dictation",
    "MW-C37-tera-dictation",
    "MW-C38-athara-dictation",
    "MW-C38-hear-athara-count",
    "MW-C38-hear-satara-count",
    "MW-C38-hear-sola-count",
    "MW-C38-hear-ughanis-count",
    "MW-C38-satara-dictation",
    "MW-C38-sola-dictation",
    "MW-C38-ughanis-dictation",
    ...
    "MW-R32-count-recall-shuffle",
    "MW-R32-script-close-recall",
    "MW-R33-count-recall-shuffle",
    "MW-R33-script-close-recall",
    "MW-R34-round-recall-column",
    "MW-R34-script-close-recall",
    "MW-R35-script-close-recall",
    "MW-R36-count-at-distance-mixed",
    "MW-R36-food-numbered-tea",
    "MW-R36-letters-close-recall",
    "MW-R36-script-close-recall",
    "MW-R36-shopping-numbered-offer",
    ...
    "MW-W21-kha-write",
    "MW-W32-e-recall",
    "MW-W35-digit-nine-recall",
    "MW-W35-digits-six-seven-eight-trap",
    "MW-W35-digits-three-four-five-trap",
    "MW-W35-digits-zero-one-two-recall",
    "MW-W37-i-recall",
    "MW-W38-a-recall",
    "MW-W38-lla-recall",
    "MW-W38-u-recall",
