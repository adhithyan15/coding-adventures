...
% canonical-source-hash: fnv1a64:5ae329ca8d7995b4
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{gaṇḍa}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} it after \emph{ajji}, so the two sit together
  \item \emph{Recall:} say \emph{bā}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{heṇḍati}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} it after \emph{gaṇḍa}, so the two sit together
  \item \emph{Recall:} read \textbf{\kn{ಕುಳಿತುಕೋ}}
\end{itemize}
