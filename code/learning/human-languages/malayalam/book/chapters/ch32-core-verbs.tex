...
% canonical-source-hash: fnv1a64:c420e2f54e19ed5b
...
Chapter 2 gave you \textbf{\ml{ആണ്}} (\emph{āṇŭ}), the \textquotedblleft{}is\textquotedblright{} that links two nouns: \emph{enṟe pēr Arun āṇŭ}, \textquotedblleft{}my name is Arun.\textquotedblright{} \textbf{\ml{ഉണ്ട്}} does a different job — \textbf{existing} and \textbf{having}: \emph{enikkŭ oru sahōdaran uṇṭŭ}, \textquotedblleft{}to-me one brother there-is,\textquotedblright{} which is how Malayalam says \textquotedblleft{}I have a brother.\textquotedblright{} \textbf{\ml{ഇരിക്കുക}} is being in a \textbf{place}: \emph{ñān vīṭṭil irikkunnu}, \textquotedblleft{}I am at home.\textquotedblright{}
...
\raggedright
  ...
  \item \textquotedblleft{}enikkŭ oru sahōdaran uṇṭŭ\textquotedblright{} — I have a brother
...
\midrule
now & \textbf{\ml{പോകുന്നു}} \emph{pōkunnu} & \emph{-unnu} \\
already & \textbf{\ml{പോയി}} \emph{pōyi} & \emph{-i} \\
not yet & \textbf{\ml{പോകും}} \emph{pōkuṁ} & \emph{-uṁ} \\
\bottomrule
\end{tabularx}
...
In most languages a tense is a \textbf{list}. English has \emph{I go / he goes}. Tamil, Malayalam's closest sister, needs an ending for every person: \emph{pōgiṟēṉ} (\textquotedblleft{}I go\textquotedblright{}), \emph{pōgiṟāy} (\textquotedblleft{}you go\textquotedblright{}), \emph{pōgiṟāṉ} (\textquotedblleft{}he goes\textquotedblright{}).

Malayalam's present tense is one word long. \emph{Ñān pōkunnu}, \emph{nī pōkunnu}, \emph{avar pōkunnu} — I, you, they, and \emph{pōkunnu} every time. So those three forms are not the start of a conjugation. \textbf{They are the whole of it.}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}pōkuka\textquotedblright{} — to go
  \item \emph{Say it:} the three times — \textquotedblleft{}pōkunnu … pōyi … pōkuṁ\textquotedblright{}
  \item \emph{Look:} at the three on the page — \textbf{\ml{പോകുന്നു}}, \textbf{\ml{പോയി}}, \textbf{\ml{പോകും}}
  \item \emph{Say it:} the pair that shares one sound-law — \textquotedblleft{}pattŭ … hattu\textquotedblright{}, \textquotedblleft{}pō … hōgu\textquotedblright{}
  \item \emph{Say it:} four people, one verb — \textquotedblleft{}ñān, nī, avan, avar … pōkunnu\textquotedblright{}
  \item \emph{Recall:} read \textbf{\ml{ദിവസം}}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Say \textquotedblleft{}I will go.\textquotedblright{} (\emph{Ñān pōkuṁ}) — and find it written: \textbf{\ml{ഞാൻ} \ml{പോകും}}. How many words are in this verb's whole Malayalam present tense? (\textbf{One} — \emph{pōkunnu}, for every person.) Is Kannada's \emph{hōgu} a different root from \emph{pō}? (\textbf{No} — the same old \emph{p} softened to \emph{h}.) Next: the one place a Malayalam verb can still surprise you.
\end{tcolorbox}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} the command — \textquotedblleft{}vā!\textquotedblright{}
  \item \emph{Say it:} the three times — \textquotedblleft{}varunnu … vannu … varuṁ\textquotedblright{}
  \item \emph{Say it:} the pair, past against past — \textquotedblleft{}pōyi … vannu\textquotedblright{}
  \item \emph{Say it:} the goodbye you now understand — \textquotedblleft{}pōyi varāṁ\textquotedblright{}
  \item \emph{Recall:} say \emph{rātri}
\end{itemize}
...
\begin{quote}
\textbf{\ml{എനിക്ക്} \ml{മലയാളം} \ml{അറിയാം}.} — \emph{enikkŭ malayāḷaṁ aṟiyāṁ} — \textquotedblleft{}I know Malayalam.\textquotedblright{}
\end{quote}
...
\begin{itemize}
\raggedright
  \item \emph{enikkŭ aṟiyāṁ} — it is known \textbf{to me}
...
\raggedright
  ...
  \item \textquotedblleft{}enikkŭ malayāḷaṁ aṟiyāṁ\textquotedblright{} — I know Malayalam
  \item three knowers, one verb — \textquotedblleft{}enikkŭ … ninakku … avanŭ aṟiyāṁ\textquotedblright{}
