    ...
    ParserGrammar {
        ...
        GrammarRule {
            ...
            body: GrammarElement::Alternation { choices: vec![
                ...
                GrammarElement::RuleReference { name: r#"probabilistic_rule_statement"#.to_string() },
                GrammarElement::RuleReference { name: r#"probabilistic_fact_statement"#.to_string() },
        ...
        GrammarRule {
            name: r#"probabilistic_fact_statement"#.to_string(),
            body: GrammarElement::Sequence { elements: vec![
                GrammarElement::RuleReference { name: r#"probability"#.to_string() },
                GrammarElement::TokenReference { name: r#"PROB_SEP"#.to_string() },
                GrammarElement::RuleReference { name: r#"callable_term"#.to_string() },
                GrammarElement::TokenReference { name: r#"DOT"#.to_string() },
            ] },
            line_number: 31,
        ...
        GrammarRule {
            name: r#"probabilistic_rule_statement"#.to_string(),
            body: GrammarElement::Sequence { elements: vec![
                GrammarElement::RuleReference { name: r#"probability"#.to_string() },
                GrammarElement::TokenReference { name: r#"PROB_SEP"#.to_string() },
                GrammarElement::RuleReference { name: r#"callable_term"#.to_string() },
