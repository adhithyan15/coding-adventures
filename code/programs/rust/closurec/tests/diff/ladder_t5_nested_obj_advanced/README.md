# ladder_t5_nested_obj_advanced

Rung 5.nested_obj of the CCR-066 differential complexity ladder, at `ADVANCED`.

## What this rung is for

Exercises nested object literals, so property access must chain.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t5_nested_obj_advanced/input/a.js
```
