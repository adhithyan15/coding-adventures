...
`mosaic-compile pkg --token-palette <JSON>` and package manifests may declare
`[styles].token_palette`. Dependency defaults are lower precedence than a
consuming package palette, and explicit application input wins last.
