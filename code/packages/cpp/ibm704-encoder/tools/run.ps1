# Build and run the ibm704-encoder tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name ibm704_encoder-tests -Sources @("tests\ibm704_encoder_test.cpp")
