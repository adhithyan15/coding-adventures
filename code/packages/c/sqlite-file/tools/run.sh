#!/bin/sh
# Build and run the sqlite-file tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c sqlite_file-tests tests/sqlite_file_test.c src/sqlite_file.c
