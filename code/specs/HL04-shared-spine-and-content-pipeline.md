...
| Mixed-language practice | Learn advances independent local frontiers, prefers compiled objective activities, blocks advancement after a wrong focused check, and admits only independently passed, visually distinguishable lessons to mixed SRS review. The first cross-language tranche reaches 17 of 113 mapped non-lexical lessons across 15 tracks. | Extend objective activity coverage across the measured 96 remaining non-lexical frontiers and expand prompt directions beyond text entry. |
