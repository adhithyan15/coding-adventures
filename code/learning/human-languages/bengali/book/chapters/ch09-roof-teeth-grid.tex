...
% canonical-source-hash: fnv1a64:a0a0a9903da2da3b
% canonical-lessons: BN-W04-pa, BN-W03-da, BN-W03-dha, BN-W04-cha, BN-W04-chha, BN-W04-achhi-read, BN-C09-jal, BN-W04-ja
...
Source: \href{https://www.unicode.org/charts/PDF/U0980.pdf}{Unicode Bengali chart}.
\end{tcolorbox}
\section[jāl]{\bn{জাল} (jāl) — a net}

\label{lesson:BN-C09-jal}
...
\subsection*{You'll want to know: \bn{জাল}}
\textbf{\bn{জাল}} — \emph{jāl} — \textquotedblleft{}a net\textquotedblright{}.

Say it: \emph{jāl}. Look at its shape as you say it: the next lesson takes one piece of it, \textbf{\bn{জ}}, and writes it on its own.
...
\raggedright
  \item \emph{jāl}
  \item \emph{jāl}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}a net\textquotedblright{}? (\textbf{\bn{জাল}}, \emph{jāl}.)
\end{tcolorbox}
