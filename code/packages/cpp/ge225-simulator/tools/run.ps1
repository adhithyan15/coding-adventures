# Build and run the ge225-simulator tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name ge225_simulator-tests -Sources @("tests\ge225_simulator_test.cpp")
