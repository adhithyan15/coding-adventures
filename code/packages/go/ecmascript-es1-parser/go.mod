module github.com/adhithyan15/coding-adventures/code/packages/go/ecmascript-es1-parser

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/ecmascript-es1-lexer v0.0.0
...
replace github.com/adhithyan15/coding-adventures/code/packages/go/ecmascript-es1-lexer => ../ecmascript-es1-lexer
