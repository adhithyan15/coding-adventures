# ladder_t7_nullish_simple

Rung 7.nullish of the CCR-066 differential complexity ladder, at `SIMPLE`.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level SIMPLE_OPTIMIZATIONS --js tests/diff/ladder_t7_nullish_simple/input/a.js
```
