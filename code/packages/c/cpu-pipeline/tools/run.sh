#!/bin/sh
# Build and run the cpu-pipeline tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c cpu_pipeline-tests tests/cpu_pipeline_test.c src/cpu_pipeline.c
