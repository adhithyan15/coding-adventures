#!/bin/sh
# Build and run the argon2id tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c argon2id-tests tests/argon2id_test.c src/argon2id.c ../blake2b/src/blake2b.c
