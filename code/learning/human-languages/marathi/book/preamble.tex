...
\newunicodechar{ṟ}{\b{r}}
\newunicodechar{ḻ}{\b{l}}
% The breve marks the short vowel Marathi writes with ॲ, the "a" of English
% *cat*, which the pronunciation reference transliterates as ĕ. Latin Modern
% has no U+0115, so compose the accent rather than look the character up.
\newunicodechar{ĕ}{\u{e}}
