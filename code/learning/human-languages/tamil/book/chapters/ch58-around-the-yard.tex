...
% canonical-source-hash: fnv1a64:c891738492859fe8
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{siṟitu}, then read \textbf{\ta{காற்று}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\ta{நிறைய}}, then say \emph{maṇal}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{kuṟaivu}, then read \textbf{\ta{சேறு}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\ta{தேவையில்லை}}, then say \emph{pukai}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{ākaṭṭum}, then read \textbf{\ta{கனல்}}
\end{itemize}
