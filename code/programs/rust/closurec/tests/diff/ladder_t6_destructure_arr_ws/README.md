# ladder_t6_destructure_arr_ws

Rung 6.destructure_arr of the CCR-066 differential complexity ladder, at `WHITESPACE_ONLY`.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level WHITESPACE_ONLY --js tests/diff/ladder_t6_destructure_arr_ws/input/a.js
```
