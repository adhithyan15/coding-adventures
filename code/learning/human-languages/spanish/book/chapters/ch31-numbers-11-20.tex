...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Spanish counts past ten in \textbf{two completely different ways}, and the join between them is a real boundary in the language, not a place someone drew a line. Today: the first five, which you simply have to learn as words.
\end{quote}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} You just learned five numbers whose insides had been ground smooth. Now say \textbf{fifteen} and then \textbf{sixteen} — \emph{quince}, \emph{dieciséis} — and hear the language change gear. From here you are not memorising words; you are following a rule.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}dieciséis, diecisiete, dieciocho, diecinueve\textquotedblright{}{]}
  \item {[}YOU SAY: the seam out loud — \textquotedblleft{}diez y seis\textquotedblright{} then \textquotedblleft{}dieciséis\textquotedblright{}{]}
  \item {[}YOU SAY: the boundary — \textquotedblleft{}quince\textquotedblright{} (remembered), \textquotedblleft{}dieciséis\textquotedblright{} (built){]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} Count sixteen to nineteen. (\emph{Dieciséis, diecisiete, dieciocho, diecinueve}.) Are these fused or transparent? (\textbf{Transparent} — plain \textquotedblleft{}ten and X.\textquotedblright{}) Which of the two groups do you have to memorise, and which can you generate? (\textbf{Memorise 11-15}; \textbf{generate 16-19} from \emph{dieci-} plus the digit.)
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} \emph{Dieciocho} and \emph{diecinueve} look like the least interesting words in the chapter — just two more ten-and-X compounds. They are actually the most interesting, because of what Latin said instead.
\end{quote}

\subsection*{You'll want to know first}
\begin{itemize}
\raggedright
  \item \href{https://github.com/adhithyan15/coding-adventures/blob/main/code/learning/human-languages/spanish/lessons/ES-C31-dieciseis-diecinueve.md}{dieciséis — diecinueve} — the \emph{dieci-} plus digit template.
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Latin's own 18 and 19 were counted \emph{down from twenty}. So it is worth meeting twenty itself — the number the whole run has been aiming at.
\end{quote}
