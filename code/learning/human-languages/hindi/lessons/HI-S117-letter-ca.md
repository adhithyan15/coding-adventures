...
romanization: "ca"
prerequisites: [HI-S116-vowel-sign-ii]
sounds: []
roots: []
duration:
  max_seconds: 150
requires:
  knowledge: [HI-SCRIPT-RECOG-116]
introduces:
  knowledge: [HI-SCRIPT-RECOG-117]
practises:
  knowledge: [HI-SCRIPT-RECOG-116, HI-SCRIPT-RECOG-117]
skills: [reading, writing]
modes: [interpretive, presentational]
strands: [language-focus]
register: neutral
variety: standard-colloquial
reviews_of: [HI-S116-vowel-sign-ii]
---

# च — one character, met inside words you already say

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[HI-SCRIPT-RECOG-116] -->

[PAUSE 1s] Before the new one: ◌ी — what does it do?

[PAUSE 2s] One character this time. Just one — and you have been saying it
for pages without knowing which mark on the page it was.

## Script you'll notice: च
<!-- hl-knowledge: introduces=[HI-SCRIPT-RECOG-117]; assesses=[] -->
...
- **पाँच** *pāṁch* — Sanskrit's nasal consonant survives inside the Hindi vowel
...
[PAUSE 1s]
- [YOU LOOK: at these words, and find च in the ones that have it]
