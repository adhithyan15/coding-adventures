...
% canonical-source-hash: fnv1a64:f5970c7c147356bc
% canonical-lessons: KA-C38-hrudaya, KA-C38-namah, KA-S132-sign-visarga
...
\end{tcolorbox}
\section[namaḥ]{\kn{ನಮಃ} (namaḥ) — a salutation, bowing}

\label{lesson:KA-C38-namah}
...
\subsection*{You'll want to know: \kn{ನಮಃ}}
\textbf{\kn{ನಮಃ}} — \emph{namaḥ} — \textquotedblleft{}a salutation, bowing\textquotedblright{}.

Say it: \emph{namaḥ}. Look at its shape as you say it: the next lesson takes one piece of it, \textbf{\kn{ಃ}}, and writes it on its own.
...
\raggedright
  \item \emph{namaḥ}
  \item \emph{namaḥ}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}a salutation, bowing\textquotedblright{}? (\textbf{\kn{ನಮಃ}}, \emph{namaḥ}.)
\end{tcolorbox}
...
\hlblockfigure{\detokenize{figures/KA-S132-sign-visarga-filmstrip.pdf}}{How \kn{ಃ} is written, stroke by stroke}
