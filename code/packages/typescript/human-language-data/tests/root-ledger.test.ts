...
describe("the committed corpus", () => {
  ...
  it("pins the first ledger, and it is the reason the rule exists", () => {
    ...
    expect(l.summary.roots).toBe(3081); // Tamil and French schema-v2 openers expose their etymon atoms.
    ...
    expect(byNamespace).toEqual({ roots: 2194, "etymon-atom": 887 }); // +2: Tamil and French opener etymons.
  });
