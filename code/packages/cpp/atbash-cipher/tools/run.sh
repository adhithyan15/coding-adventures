#!/bin/sh
# Build and run the atbash-cipher tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp atbash_cipher-tests tests/atbash_cipher_test.cpp
