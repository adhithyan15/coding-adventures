...
// for GFM flanking rules.
//
// GFM defines this (per the cmark reference) as any ASCII punctuation
...
// NormalizeLinkLabel normalizes a link label per GFM:
...
//
// Per GFM §4.7: "ß" (U+00DF) and "ẞ" (U+1E9E) should both fold to
