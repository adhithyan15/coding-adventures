...
% canonical-source-hash: fnv1a64:cda8e351773cbc21
% canonical-lessons: SA-C19-six, SA-C19-seven, SA-C19-eight, SA-C19-nine, SA-C19-ten, SA-C19-number-family, SA-S120-letter-ja
...
\begin{quote}
Before the new one: \sk{ख} — what does it do?
...
\begin{itemize}
\raggedright
  \item \textbf{\sk{जानाति}} \emph{jānāti} — he, she, or it knows
  \item \textbf{\sk{ज्ञान}} \emph{jñāna} — knowledge
\end{itemize}

The root behind \emph{jānāti} is written \sk{ज्ञ} — \sk{ज} and \sk{ञ} joined — and it is said \emph{jña} in some regions and \emph{gya} in others. The letter is steady even where the sound is not.
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at these words, and find \sk{ज} in the ones that have it
\end{itemize}
