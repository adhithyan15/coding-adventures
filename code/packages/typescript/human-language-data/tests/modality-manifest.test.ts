...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3400, // +1: French's two-minute guided-copy step
      ...
      voice: 2465, // French's legacy voice opener becomes honestly classified as pen
      ...
      pen: 345, // +2: French observe-trace and guided-copy lessons
      ...
      drivableLessons: 2465, // French's migrated opener now exposes its writing dependency
      ...
      unstartableChapters: 210, // French chapter 1 now honestly starts with pen. // French/Marathi order recovery on current main: measured, not inferred. // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
