...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3403, // +2: Persian's guided-copy bridge and chapter-1 payoff
      ...
      pen: 350, // +2: Persian's new guided-copy and payoff lessons
      ...
      unstartableChapters: 213, // Persian chapter 1 now honestly starts with pen.
      overriddenLessons: 0,
