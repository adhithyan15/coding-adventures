...
% canonical-source-hash: fnv1a64:6f4ee9ae087c28a3
...
\section[ek do tīn chār pāṁch]{\hi{एक}, \hi{दो}, \hi{तीन}, \hi{चार}, \hi{पाँच} — the five forms}
...
\end{tcolorbox}
\section[tīn, chār]{\hi{तीन} and \hi{चार} — weight moves from consonants to vowels}
...
\begin{enumerate}
\raggedright
  \item \emph{\textbf{tr\'{\={\i}}ṇi\emph{ $\to$ }tiṇṇi}}: \emph{r} is lost and \textbf{ṇ doubles} to make up the weight. Long \emph{ī} shortens because the doubled consonant already makes the syllable heavy.
  \item \emph{\textbf{tiṇṇi\emph{ $\to$ }tīn}}: the double simplifies and the \textbf{vowel lengthens} to pay for the lost consonant weight.
\end{enumerate}
...
\hlblockfigure{\detokenize{figures/HI-S01-letter-ma-filmstrip.pdf}}{How \hi{म} is written, stroke by stroke}
...
\hlblockfigure{\detokenize{figures/HI-S110-letter-ra-filmstrip.pdf}}{How \hi{र} is written, stroke by stroke}
