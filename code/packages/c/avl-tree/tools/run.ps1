# Build and run the avl-tree tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name avl_tree-tests -Sources @("tests\avl_tree_test.c", "src\avl_tree.c")
