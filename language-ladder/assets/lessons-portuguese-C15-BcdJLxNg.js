...
type: word
headword: falei
gloss: the pretérito perfeito — Portuguese kept its simple past, where three sisters gave theirs up
concept_tag: PT-PAST-SIMPLE
prerequisites: [PT-C14-ter, PT-C05-falar]
...
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: [PT-CULTURE-FALAMOS-PAST-ORTHOGRAPHY-01]
practises:
...
The *nós* form is worth a note: Portugal writes **falámos** with an accent to
separate it from the present *falamos*, while Brazil writes both **falamos** and
lets context decide. Same word, one accent, two spelling conventions.

**falei** ← Vulgar Latin perfect **\\*fabulāvī**, the same source as Spanish *hablé*. The
...
| Italian | *parlò* | **south** yes, north literary |
| German | *sagte* | retreating, standard in **writing** |
| French | *il parla* | **literature only** |

All five inherited the same thing. French, German and northern Italy each built a
compound past out of "have" and let it push the old simple past out of
conversation. **Portuguese and Spanish, at the western edge of the map, didn't.**

Portuguese has all the parts to build a compound — *ter* from Chapter 14, and a
participle (*falado*). It simply doesn't use them for this job. The next lesson
...
- [YOU SAY: "Ontem falei com a minha mãe" ("Yesterday I spoke with my mother")]
- [YOU SAY: "Trabalhei" — Ch. 5's verb in the past]
...
Spanish *hablé*.) Which two languages kept this tense in everyday speech?
(**Portuguese** and **Spanish**.) Which one exiled it to literature? (**French**.)
Next: what Portuguese does with *ter* + participle, since it isn't this.
`,r=e({default:()=>i}),i=`---
schema_version: 2
...
gloss: "ter + participle — which does NOT mean 'I have spoken', the trap English speakers walk into"
concept_tag: PT-PAST-COMPOUND-ITERATIVE
prerequisites: [PT-C15-preterito-perfeito, PT-C14-ter]
...
*Tenho falado com ele* does **not** mean "I have spoken to him [once]." It means
"I **have been** speaking to him" — **more than once, over a recent stretch of
time, and it may still be going on**.
...
Portuguese never did — ***falei*** was already occupying that slot and never left.
So when Portuguese assembled the same *have* + participle machinery, there was **no
vacancy**, and the construction drifted into a different job: **repeated or
continuing** action.

Same parts, same era, same family. Different outcome, because of what was already
in the way.

| language | have + participle means |
|---|---|
| French | *j'ai parlé* — **I spoke** |
| Italian | *ho parlato* — **I spoke** |
| German | *ich habe gesagt* — **I said** |
...
- [YOU SAY: "Falei com ele ontem" — one event]
- [YOU SAY: "Tenho falado com ele" — repeatedly, lately]
...
(The simple past — ***falei***.) Why doesn't Portuguese's compound mean "I
spoke"? (Because ***falei*** **never vacated** that slot, so the new construction
took a different job.) Which languages let their compound take over the plain
past? (**French, Italian, German**.)
`,a=e({default:()=>o}),o=`---
schema_version: 2
...
That is not a one-off. Portuguese systematically **dropped n between vowels**,
nasalising the vowel in front of it. What happened next depends on the word: the
nasality **stayed** where the result was a nasal diphthong, and **faded again**
where it left a plain vowel. The **til** (**~**) marks the ones that kept it.

| Latin | Portuguese | |
|---|---|---|
| *manus* | **mão** | hand — **nasality kept** |
| *lūna* | **lua** | moon — nasality faded |
| *bona* | **boa** | good (f.) — nasality faded |
| *pānis* | **pão** | bread — **kept**; Chapter 11 told this one |

Compare Spanish, which kept the ***n*** in all of them: *mano*, *luna*, *buena*, *pan*. This single
change is a large part of why written Portuguese and Spanish look so similar and
sound so different.
...
but could be feminine. The declension is long gone; the gender outlived it.

Portuguese is less startling about it than Italian, because *mão* doesn't end in
...
- [YOU SAY: the change — "ma**n**us … mã**o**"]
- [YOU SAY: the family — "lua, boa, pão — all lost an **n**"]
...
which the **til** marks.) Name two other words that did the same. (*Lua* ←
*lūna*, *boa* ← *bona*, *pão* — Ch. 11.) Did they all keep the nasality? (**No** —
*mão* and *pão* did; *lua* and *boa* lost it again.) What did Spanish do?
(**Kept the *n*** in all
— *mano*, *luna*, *pan*.) Why is *mão* feminine? (Latin *manus* was
**fourth-declension feminine** — the same reason Italian says *la mano*.) Next: the rest of the body.
