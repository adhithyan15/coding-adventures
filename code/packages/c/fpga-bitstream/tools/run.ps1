# Build and run the fpga-bitstream tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name fpga_bitstream-tests -Sources @("tests\fpga_bitstream_test.c", "src\fpga_bitstream.c")
