...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Your first \textbf{case ending}. English puts \textquotedblleft{}to\textquotedblright{} in \textbf{front}, as a separate word. Kannada sticks it on the \textbf{back} — the biggest structural fact about the language, in one suffix.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}\emph{hesaru} … \emph{hesarige}\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}\emph{nānu} … \emph{nanage}\textquotedblright{} — \textquotedblleft{}I\textquotedblright{} … \textquotedblleft{}to me\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}\emph{kelasakke}\textquotedblright{} — \textquotedblleft{}for work,\textquotedblright{} from Ch. 5's \kn{ಕೆಲಸ}{]}
  \item {[}YOU SAY: the family — \textquotedblleft{}\emph{-ukku · -ku · -\textbf{ge}} · -ikku\textquotedblright{}{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Chapter 5 gave you \textbf{\kn{ನಾನು} \kn{ಕನ್ನಡ}} — \textquotedblleft{}\textbf{I} speak Kannada\textquotedblright{} — with the verb \textbf{\kn{ಮಾತನಾಡುತ್ತೇನೆ}}. Now say \textquotedblleft{}I \textbf{know} Kannada.\textquotedblright{} Kannada will not let you use \emph{nānu}.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}\emph{nanage kannaḍa gottu}\textquotedblright{}{]}
  \item {[}YOU SAY: the contrast — \textquotedblleft{}\emph{nānu kannaḍa mātanāḍuttēne}\textquotedblright{} (I speak) … \textquotedblleft{}\emph{nanage kannaḍa gottu}\textquotedblright{} (known to me){]}
  \item {[}YOU SAY: the literal — \textquotedblleft{}to-me Kannada known\textquotedblright{}{]}
  \item {[}YOU SAY: the four cousins — \textquotedblleft{}\emph{-ge · -ukku · -ku · -ikku}\textquotedblright{}{]}
\end{itemize}
