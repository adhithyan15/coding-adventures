...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} You've already met a gendered adjective — \textbf{\ar{آسف}/\ar{آسفة}} (\textquotedblleft{}sorry\textquotedblright{}), which just added a feminine ending. Color words go further: they reshape the \textbf{whole word}, front and back, for gender.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: masculine — \textquotedblleft{}aswad, abyad\textquotedblright{} — black, white{]}
  \item {[}YOU SAY: feminine — \textquotedblleft{}sawdāʾ, bayḍāʾ\textquotedblright{} — black, white{]}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: masculine — \textquotedblleft{}aḥmar, azraq\textquotedblright{} — red, blue{]}
  \item {[}YOU SAY: feminine — \textquotedblleft{}ḥamrāʾ, zarqāʾ\textquotedblright{} — red, blue{]}
  \item {[}YOU SAY: all four masculine forms in a row — \textquotedblleft{}aswad, abyad, aḥmar, azraq\textquotedblright{}{]}
\end{itemize}
