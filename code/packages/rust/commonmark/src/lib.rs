...
pub use commonmark_parser::parse;
...
/// Parse a CommonMark Markdown string and render it to HTML in one call.
///
...
/// for CommonMark spec compliance). If rendering **untrusted** Markdown, use
...
/// Parse a CommonMark Markdown string and render it to HTML with raw HTML
