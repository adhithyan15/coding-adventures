#!/bin/sh
# Build and run the dsp-wavelets tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c dsp_wavelets-tests tests/dsp_wavelets_test.c src/dsp_wavelets.c
