#!/bin/sh
# Build and run the static-vector tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp static_vector-tests tests/static_vector_test.cpp
