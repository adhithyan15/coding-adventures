# ladder_t6_spread_call_advanced

Rung 6.spread_call of the CCR-066 differential complexity ladder, at `ADVANCED`.

## What this rung is for

Exercises spread in a call argument list.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t6_spread_call_advanced/input/a.js
```
...
```js
function f(a,b){return a+b}var p=[1,2];console.log(f(...p));
```
