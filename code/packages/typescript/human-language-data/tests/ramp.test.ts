...
describe("corpus snapshot", () => {
  ...
  it("pins the ramp, and the size of its blind spot", () => {
    ...
    expect(report.summary.chapterViolations).toBe(22); // HL-C251: +1 -- russian ch1 adds a script-ramp step that was invisible while its lessons were v1 // -1: HL-C96 splits ch7, the last Spanish chapter over budget -- Spanish is now clean // +1: vocabulary wave 6
