# Changelog — lua/b-plus-tree

## [0.1.0] — 2026-04-11

### Added
- Initial implementation of `coding_adventures.b_plus_tree` (DT12) in Lua.
...
- `is_valid` for structural verification + `is_linked_list_valid` for
  linked-list count and sort-order integrity.
- Comprehensive test suite: 16 describe blocks including linked-list integrity,
