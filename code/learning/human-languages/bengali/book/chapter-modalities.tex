...
\expandafter\def\csname hlchaptermodality2\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (3) \quad \hlsightsign{}~\textbf{eyes} (5)\quad
...
\expandafter\def\csname hlchaptermodality4\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (2) \quad \hlsightsign{}~\textbf{eyes} (3)\quad
...
\expandafter\def\csname hlchaptermodality14\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlsightsign{}~\textbf{eyes} (5)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} all 5 lessons.%
    \par}\medskip
}
