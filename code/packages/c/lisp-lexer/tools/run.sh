#!/bin/sh
# Build and run the lisp-lexer tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c lisp_lexer-tests tests/lisp_lexer_test.c src/lisp_lexer.c
