...
% canonical-source-hash: fnv1a64:8433d5dbd75ee6a4
% canonical-lessons: GU-C04-athaanun, GU-C04-divaali, GU-W04-lla, GU-W04-tha, GU-W04-independent-a, GU-W04-i-matra, GU-R04-first-four-r1
...
\section[athāṇũ]{\gu{અથાણું} (athāṇũ) — pickle}

\label{lesson:GU-C04-athaanun}
...
From memory, write \textbf{\gu{ર}}, \textbf{\gu{દ}} and \textbf{\gu{છ}} once each. Then say \emph{chīp} and what it means.
\end{quote}

\subsection*{You'll want to know: \gu{અથાણું}}
\textbf{\gu{અથાણું}} — \emph{athāṇũ} — \textquotedblleft{}pickle\textquotedblright{}.

Say it: \emph{athāṇũ}. Look at its shape as you say it: the lessons that follow take pieces of it, \textbf{\gu{અ}} and \textbf{\gu{થ}}, and write each one on its own.
...
\raggedright
  \item \emph{athāṇũ}
  \item \emph{athāṇũ}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}pickle\textquotedblright{}? (\textbf{\gu{અથાણું}}, \emph{athāṇũ}.)
\end{tcolorbox}
\section[divāḷī]{\gu{દિવાળી} (divāḷī) — Diwali, the festival of lights}

\label{lesson:GU-C04-divaali}
...
From memory, write \textbf{\gu{વ}}, \textbf{\gu{ય}} and \textbf{\gu{ક}} once each. Then say \emph{kaṇ} and \emph{śak}, and what each means.
\end{quote}

\subsection*{You'll want to know: \gu{દિવાળી}}
\textbf{\gu{દિવાળી}} — \emph{divāḷī} — \textquotedblleft{}Diwali, the festival of lights\textquotedblright{}.

Say it: \emph{divāḷī}. Look at its shape as you say it: the lessons that follow take pieces of it, \textbf{\gu{ળ}} and \textbf{\gu{િ}}, and write each one on its own.
...
\raggedright
  \item \emph{divāḷī}
  \item \emph{divāḷī}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}Diwali, the festival of lights\textquotedblright{}? (\textbf{\gu{દિવાળી}}, \emph{divāḷī}.)
\end{tcolorbox}
...
\hlblockfigure{\detokenize{figures/GU-W04-lla-filmstrip.pdf}}{How \gu{ળ} is written, stroke by stroke}
...
\subsection*{Writing — notice and trace}
\hlblockfigure{\detokenize{figures/GU-W04-tha-filmstrip.pdf}}{How \gu{થ} is written, stroke by stroke}
...
\subsection*{Writing — notice and trace}
\hlblockfigure{\detokenize{figures/GU-W04-independent-a-filmstrip.pdf}}{How \gu{અ} is written, stroke by stroke}
