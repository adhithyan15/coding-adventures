...
% canonical-source-hash: fnv1a64:12ecb246e01b4cb8
...
\end{tcolorbox}
\section[namaskār]{\hi{नमस्कार} (namaskār) — the more formal bow}
...
\end{tcolorbox}
\section[dhanyavād]{\hi{धन्यवाद} (dhanyavād) — \textquotedblleft{}thank you,\textquotedblright{} the Sanskrit way}
...
\end{tcolorbox}
\section[shukriyā]{\hi{शुक्रिया} (shukriyā) — \textquotedblleft{}thanks,\textquotedblright{} Hindi's other heritage}
...
\end{tcolorbox}
\section[alvidā]{\hi{अलविदा} (alvidā) — \textquotedblleft{}farewell,\textquotedblright{} and the Arabic \emph{al-} again}
