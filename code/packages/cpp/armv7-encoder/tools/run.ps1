# Build and run the armv7-encoder tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name armv7_encoder-tests -Sources @("tests\armv7_encoder_test.cpp")
