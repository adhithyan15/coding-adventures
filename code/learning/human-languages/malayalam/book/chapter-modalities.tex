...
\expandafter\def\csname hlchaptermodality1\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (1) \quad \hlsightsign{}~\textbf{eyes} (4) \quad \hlpensign{}~\textbf{pen} (9)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 1 of 14 lessons.%
    \par}\medskip
}
...
\expandafter\def\csname hlchaptermodality7\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (2) \quad \hlpensign{}~\textbf{pen} (15)\quad
...
\expandafter\def\csname hlchaptermodality10\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlsightsign{}~\textbf{eyes} (1) \quad \hlpensign{}~\textbf{pen} (2)\quad
