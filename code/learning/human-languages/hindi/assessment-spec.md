# Coding Adventures Hindi Assessment

**Version:** 1.0 target contract, 2026-08-31

**Basis:** project-defined CEFR-aligned equivalent

**Status:** target specified; pre-A1 through C2 task inventories and two parallel
pre-A1 through C2 mocks are checked in. Calibration and human validation remain
backlog

This specification names the assessment that the complete Hindi book must
...
learner-facing name at each rung is **Coding Adventures Hindi <Level>
...
a Hindi awarding body. The Council of Europe also states that it does not
verify or validate an examination's claimed link to CEFR. Every target here is
therefore labelled `project-defined`.

The Central Hindi Training Institute, under India's Department of Official
Language, administers the Hindi Teaching Scheme examinations **Prabodh**,
**Praveen**, **Pragya**, and **Parangat**. Official material describes them as
in-service Hindi training for Union-government and public-sector personnel and
relates their standards to school or degree study. They are important evidence
that Hindi assessment infrastructure exists, but they are not a public
pre-A1-to-C2 four-skill CEFR ladder and are not presented here as one. This
project therefore defines a transparent approximation instead of borrowing
their names or authority.

The assessed variety is contemporary standard Hindi written in Devanagari.
...
trained Hindi reviewer adjudicates unfamiliar forms. A valid response may use
the speaker's natural gender agreement consistently. Urdu, Bhojpuri, Marathi,
or English replacement is not silently accepted as Hindi, while natural
...
- [Central Hindi Training Institute](https://chti.rajbhasha.gov.in/)
- [Department of Official Language annual report describing the Hindi Teaching Scheme](https://rajbhasha.gov.in/sites/default/files/ar20172018eng.pdf)
...
3. range and control of Hindi vocabulary and grammar;
...
is not meaningfully in Hindi cannot earn task-fulfilment credit. Documented
...
evidence. Before release, at least eight qualified Hindi educators or
...
- Listening recordings use Hindi speakers. Words-per-minute bands below are
  form-assembly targets, not a claim that Hindi has one natural speaking rate.
- Pre-A1 and A1 directions may also be supplied in a declared support language,
  so misunderstanding directions is not confused with Hindi proficiency.
  From A2 onward directions are in Hindi, with one unscored example.
