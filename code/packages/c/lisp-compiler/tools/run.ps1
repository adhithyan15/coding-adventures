...
Iso-BuildAndRun -Lang c -Name lisp_compiler-tests -Sources @("tests\lisp_compiler_test.c", "src\lisp_compiler.c", "..\lisp-parser\src\lisp_parser.c", "..\lisp-lexer\src\lisp_lexer.c")
