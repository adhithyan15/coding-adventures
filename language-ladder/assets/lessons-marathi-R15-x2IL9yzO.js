...
gloss: distant script retrieval — first batch
concept_tag: REVIEW
prerequisites: [MR-R18-script-warmup]
sounds: []
roots: []
duration:
  max_seconds: 135
...
register: neutral
variety: standard
reviews_of: [MR-R09-script-a-r3]
---

# First batch at long distance
...
gloss: distant script retrieval — second batch
concept_tag: REVIEW
prerequisites: [MR-R18-script-a-r4]
sounds: []
roots: []
duration:
  max_seconds: 135
...
register: neutral
variety: standard
reviews_of: [MR-R09-script-b-r3]
---

# Second batch at long distance
...
gloss: distant script retrieval — voiced consonant batch
concept_tag: REVIEW
prerequisites: [MR-R18-script-b-r4]
sounds: []
roots: []
duration:
  max_seconds: 135
...
register: neutral
variety: standard
reviews_of: [MR-R09-script-c-r3]
---

# Voiced batch at long distance
...
gloss: distant script retrieval — final doorway batch
concept_tag: REVIEW
prerequisites: [MR-R18-script-c-r4]
sounds: []
roots: []
duration:
  max_seconds: 135
...
reviews_of: [MR-R09-script-d-r3]
---

# Final batch at long distance
...
<!-- hl-activity: {"id":"MR-R18-script-d-r4-check","kind":"text","assesses":["MR-SCRIPT-YA-01","MR-SCRIPT-LLA-01","MR-SCRIPT-VA-01"],"prompt":"Write ya, lla, and va at long distance.","answer":"य ळ व","accepted":[],"feedback":{"correct":"All twelve doorway signs now have long-distance evidence.","incorrect":"Repair only the missed sign."},"response_seconds":26} -->

From spoken names only, write *ya*, curled-back *ḷa*, and *va*. Compare once:
**य ळ व**.
`,l=e({default:()=>u}),u=`---
schema_version: 2
...
gloss: distant doorway warm-up — meaning before signs
concept_tag: REVIEW
prerequisites: [MR-R14-kutumb-r3, MR-R09-script-d-r3]
sounds: []
roots: []
duration:
  max_seconds: 120
...
reviews_of: [MR-W03-dhanyavad-write]
---

# The doorway word, much later
...
Hear *dhanyavād*. Say its meaning, read **धन्यवाद**, then cover the model and
write it once. This reconnects meaning and script without adding anything new.
