...
describe("the real corpus", () => {
  ...
  it("shows what a declared reading order was worth", () => {
    ...
    expect(spanish).toMatchObject({
      ...
      lessonCount: 375, // +4: HL-C98 // +3: HL-C97 adds the repair kit (no entiendo, mas despacio) at chapter 14 // +8 payoff lessons // +1 ES-C03-vos, +1 ES-C02-concordancia // +4: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +3: HL-C88 slice 8 (-ario, review, synthesis) // +1: HL-C88 slice 9 (falsos amigos) // +3: B1 si-condition rung // +3: HL-C113 preterite plural // +4: HL-C113 preterite close (strong plurals, review, synthesis) // +2: HL-C113 imperfect subjunctive // +3: HL-C113 unreal condition // HL-C113 step 7: +4 // HL-C113 step 8: +3 // HL-C128 step 2: +5 // HL-C128 step 3: +4
      ...
      atomsTaught: 581, // +3: HL-C98's per-cell atoms // +7: HL-C88 slices 5-6 // +2: HL-C88 slice 7 (ES-C09-ncia) // +2: HL-C88 slice 8 (-ario, review, synthesis) // +2: HL-C88 slice 9 (falsos amigos) // +3: B1 si-condition rung // +3: HL-C113 preterite plural // +2: HL-C113 preterite close (strong plurals, review, synthesis) // +3: HL-C113 imperfect subjunctive // +1: HL-C113 unreal condition // HL-C113 step 7: +2 // HL-C113 step 8: +8 // HL-C128 step 2: +9 -- the demonstratives, their deixis, their position rule and three etymons // HL-C128 step 3: +10 -- muy, bastante, mal, malo, the scale, the apocope pattern and three etymons
      atomsNeverRevisited: 80, // slice 8 nets zero: -1 ES-FRIEND-NCIA-NCE (the new review and synthesis revisit it), +1 ES-ETYMON-ARIUS (introduced, never re-practised) // +2: HL-C98 // +4: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +1: HL-C88 slice 9 (falsos amigos) // +1: B1 si-condition rung // +2: HL-C113 preterite plural // -2 (the review and synthesis revisit two orphaned atoms): HL-C113 preterite close (strong plurals, review, synthesis) // +2: HL-C113 imperfect subjunctive // -1 (the review revisits an orphaned atom): HL-C113 unreal condition // HL-C113 step 7: -3 -- the review and synthesis revisit the three reported-speech atoms step 6 left unspent // HL-C113 step 8: +4 -- pero/tambien/tampoco mint lexical atoms the review rung has not spent yet // HL-C128 step 3: +1
    });
  });
