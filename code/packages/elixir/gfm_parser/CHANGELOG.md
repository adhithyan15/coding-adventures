...
Initial release. Implements GFM 0.31.2 with 100% spec conformity (652/652 examples).
...
- Seven HTML block types per GFM §4.6
...
- Delimiter stack algorithm (GFM Appendix A)
