...
- Bullseye finder pattern, orientation marks, Full-symbol reference grid.
- `M.encode(data, options)` — encodes string/byte-array to ModuleGrid table.
- `M.VERSION`, `M.AztecError`, `M.InputTooLongError` constants.
