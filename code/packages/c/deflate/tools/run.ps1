# Build and run the deflate tests under MSVC (cl.exe) — pure ISO C/C++ — via
...
Iso-BuildAndRun -Lang c -Name deflate-tests -Sources @("tests\deflate_test.c", "src\deflate.c", "..\lzss\src\lzss.c")
