...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      voice: 2220, // HL-C251: -1 -- RU-C01-practice, see drivableLessons // HL-C247: +4 -- all four chapter 33 lessons are drivable; french has no glyph lessons to anchor a pen prefix // HL-C246: +2 -- ZH-C11-qing and ZH-C11-practice, both drivable // HL-C245: +3 -- ZH-C10-xiexie, ZH-C10-buxie and ZH-C10-practice, all drivable // HL-C244: +2 -- ZH-C09-shenme and ZH-C09-practice, both drivable // merge with main (round 5): +2 -- main advanced again while this tranche was still open // merge with main (round 4): +6 -- HL-C231..C240 landed on main while this tranche was in flight; six of the new lessons are ear-only // telugu pre-A1 round 3: +35 lessons, +7 chapters (chapters 60-66) -- all 35 are ear-only, so `sight` and `pen` do not move // merge with main: +9 -- HL-C229 French question tranche landed on main while this tranche was in flight; all nine new lessons are ear-only // tamil pre-A1 tranche: +35 lessons, +7 chapters (chapters 44-50) // HL-C200: +35 telugu pre-A1 lessons, +7 chapters (chapters 46-52) // HL: +35 -- Sanskrit chapters 24-30, 35 pre-A1 vocabulary lessons // HL-C194: +16 Spanish words // HL-C192: +24 family words // HL-C190: see/say verbs across four tracks // HL-C189: +8 -- Tamil and Sanskrit verb tranche // HL-C187: +20 -- verb tranche across the five behind tracks // HL-C181: +5 -- chapter 277, the spine closes at 33/33 // HL-C180: +4 -- chapter 276; ARCHAIC-FORM was already taught at chapter 3 // HL-C179: +5 -- chapter 275, fine shades // HL-C178: +5 -- chapter 274, C2 opens // HL-C177: +5 -- chapter 273, C1 closes // HL-C175: +5 -- chapter 272, reading between the lines // HL-C173: +3 -- B2 closes (chapter 271) // HL-C173: +2 -- B2 closes (chapter 271) // HL-C172: +4 -- the B2 argue rung (chapter 270) // HL-C166: +11 -- Sanskrit chapters 19 and 20 // HL-C157 // +35: vocabulary wave 5, mostly ear-only lessons // +3: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +3: HL-C88 slice 8 (-ario, review, synthesis) // +36: vocabulary wave 6 // +1: HL-C88 slice 9 (falsos amigos) // +3: B1 si-condition rung // +3: HL-C113 preterite plural // +4: HL-C113 preterite close (strong plurals, review, synthesis) // +2: HL-C113 imperfect subjunctive // +3: HL-C113 unreal condition // HL-C113 step 7: +2 // HL-C113 step 8: +3 // HL-C128 step 2: +4 // HL-C128 step 3: +3 // HL-C128 step 4: +6 // HL-C128 step 5: +4 // HL-C127: +3 // HL-C128 step 7: +3 // HL-C128 step 8: +6 // HL-C128 step 9: +5 // HL-C128 step 10: +5 // HL-C136 wave I: +42 -- ALL of it. Not one of the 42 needs eyes, so `sight` and `pen` below do not move at all // HL-C137 wave II: +36 adjective lessons, +6 chapters, and drivablePercent rises AGAIN // HL-C152: Spanish realizes SPINE-NEGATE-AND-ASK — five lessons, one chapter, A2 complete at 5/5 // HL-C158: +4 -- the B1 travel rung (chapter 268) // HL-C159: +4 -- the B1 describe-experience rung (chapter 269) // HL-C160: +1 -- depende closes SPINE-EXPRESS-CONDITION, and B1 // HL-C163: +6 -- Sanskrit chapter 16 // HL-C165: +11 -- Sanskrit chapters 17 and 18 // kannada pre-A1 tranche: +35 lessons, +7 chapters (chapters 46-52) // malayalam pre-A1 tranche: 35 lessons over 7 chapters -- voice +34 and sight +1 sum to 35; the prefix figures follow from the per-chapter walk // hindi pre-A1 tranche: +35 lessons, +7 chapters (chapters 45-51) // spanish pre-A1 tranche: +35 lessons, +7 chapters (chapters 282-288) // sanskrit pre-A1 round 2: +35 lessons, +7 chapters (chapters 31-37) // telugu pre-A1 round 2: +35 lessons, +7 chapters (chapters 53-59) // kannada pre-A1 round 2: +35 lessons, +7 chapters (chapters 53-59) // spanish pre-A1 round 2: +35 lessons, +7 chapters (chapters 289-295) // latin pre-A1 tranche: +20 lessons, +4 chapters (chapters 44-47) -- all 20 are voice-first, so the whole tranche is drivable // malayalam pre-A1 round 2: +35 lessons, +7 chapters (chapters 53-59) -- all 35 are ear-only, so `sight` and `pen` do not move // tamil pre-A1 round 2: +35 lessons, +7 chapters (chapters 51-57) -- all 35 are voice, none carries a table or a sight cue // sanskrit pre-A1 round 3: +35 lessons, +7 chapters (chapters 38-44) -- all 35 are ear-only, so `sight` and `pen` do not move
      ...
      pen: 338, // HL-C246: +1 -- ZH-W11-qing // HL-C245: +2 -- ZH-W10-yan and ZH-W10-xie, both writing lessons // HL-C244: +2 -- ZH-W09-shen and ZH-W09-me, both writing lessons // merge with main (round 5): +2 -- main advanced again while this tranche was still open // merge with main (round 4): +29 -- HL-C231..C240 script chapters (urdu ch16, persian ch15, russian ch15, japanese ch3) landed on main while this tranche was in flight // HL-C168: +1 -- Kannada's ledger closes at 24 of 24 // HL-C156: 85 script segments across the six Indic tracks // chinese script chapter: +7 lessons, +1 chapter -- the seven components 你好 is built from, one glyph each // japanese hiragana tranche: +10 lessons, +1 chapter -- eight signs, one per lesson, plus two assemblies that introduce none // gujarati script tranche: +10 lessons, +1 chapter (ch13) -- nine pieces, one per lesson, plus one assembly // marathi script tranche: +11 lessons, +1 chapter (ch14) -- ten pieces, one per lesson, plus one assembly // punjabi script tranche: +10 lessons, +1 chapter (ch14) -- nine pieces, one per lesson, plus one assembly // russian script tranche: +11 lessons, +1 chapter (ch14) -- eleven letters, one per lesson, chosen by how many words each unblocks // bengali script tranche: +10 lessons, +1 chapter (ch16) -- nine pieces, one per lesson, plus one assembly // hindi script second wave: +11 lessons, +1 chapter (ch59) -- ten glyphs plus the word-final schwa-deletion rule
      ...
      unstartableChapters: 203, // HL-C246: +1 -- chapter 11 opens on ZH-W11-qing, a pen lesson, so its drivable prefix is 0 // HL-C245: +1 -- chapter 10 opens on ZH-W10-yan, a pen lesson, so its drivable prefix is 0 // HL-C244: +1 -- Chinese chapter 9 opens on ZH-W09-shen, a pen lesson, so its drivable prefix is 0 // merge with main (round 5): +1 -- main advanced again while this tranche was still open // merge with main (round 4): +5 -- HL-C231..C240 script chapters (urdu ch16, persian ch15, russian ch15, japanese ch3, and the Chinese ch4 box lesson) landed on main while this tranche was in flight; all need a pen or start with the box // HL-C200: +35 telugu pre-A1 lessons, +7 chapters (chapters 46-52) // HL-C181: +5 -- chapter 277, the spine closes at 33/33 // +2: two of vocabulary wave 5's new chapters need eyes from their own first lesson // +1: HL-C88 slices 5-6 // +5: vocabulary wave 6 // HL-C113 step 7: +2 -- chapters 214 and 215 are sight-only // HL-C128 step 2: +1 -- ch223 // HL-C128 step 3: +1 // HL-C128 step 5: +1 // HL-C127: +2 // chinese script chapter: +7 lessons, +1 chapter -- the seven components 你好 is built from, one glyph each // japanese hiragana tranche: +10 lessons, +1 chapter -- eight signs, one per lesson, plus two assemblies that introduce none // gujarati script tranche: +10 lessons, +1 chapter (ch13) -- all ten need a pen, so the chapter has no drivable prefix // marathi script tranche: +1 -- all eleven lessons need a pen, so ch14 has no drivable prefix // punjabi script tranche: +10 lessons, +1 chapter (ch14) -- nine pieces, one per lesson, plus one assembly -- all ten need a pen, so ch14 has no drivable prefix // russian script tranche: +11 lessons, +1 chapter (ch14) -- eleven letters, one per lesson, chosen by how many words each unblocks -- all eleven need a pen // bengali script tranche: +10 lessons, +1 chapter (ch16) -- nine pieces, one per lesson, plus one assembly -- all ten need a pen // hindi script second wave: +11 lessons, +1 chapter (ch59) -- ten glyphs plus the word-final schwa-deletion rule -- all eleven need a pen
      overriddenLessons: 0,
