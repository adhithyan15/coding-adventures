...
\expandafter\def\csname hlchaptermodality2\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (1) \quad \hlpensign{}~\textbf{pen} (3)\quad
...
\expandafter\def\csname hlchaptermodality3\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (2) \quad \hlpensign{}~\textbf{pen} (3)\quad
...
\expandafter\def\csname hlchaptermodality5\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (6) \quad \hlpensign{}~\textbf{pen} (4)\quad
...
\expandafter\def\csname hlchaptermodality6\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (5) \quad \hlpensign{}~\textbf{pen} (3)\quad
...
\expandafter\def\csname hlchaptermodality10\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (7) \quad \hlsightsign{}~\textbf{eyes} (2) \quad \hlpensign{}~\textbf{pen} (1)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 1 of 10 lessons.%
    \par}\medskip
}
...
\expandafter\def\csname hlchaptermodality11\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (8) \quad \hlsightsign{}~\textbf{eyes} (2) \quad \hlpensign{}~\textbf{pen} (2)\quad
...
\expandafter\def\csname hlchaptermodality12\endcsname{%
  {\small\noindent
    ...
    \hlvoicesign{}~\textbf{Hands-free start:} first 5 of 8 lessons.%
    \par}\medskip
}
...
\expandafter\def\csname hlchaptermodality13\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (7) \quad \hlpensign{}~\textbf{pen} (1)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 3 of 8 lessons.%
    \par}\medskip
}

\expandafter\def\csname hlchaptermodality14\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (7) \quad \hlpensign{}~\textbf{pen} (2)\quad
...
\expandafter\def\csname hlchaptermodality16\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (9)\quad
...
\expandafter\def\csname hlchaptermodality17\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (10) \quad \hlpensign{}~\textbf{pen} (3)\quad
...
\expandafter\def\csname hlchaptermodality18\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (9) \quad \hlpensign{}~\textbf{pen} (1)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 1 of 10 lessons.%
    \par}\medskip
}
