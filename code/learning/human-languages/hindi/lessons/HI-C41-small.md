...
gloss: "small"
romanization: "choṭā"
concept_tag: HI-ADJ-SMALL
prerequisites: [HI-C41-big, HI-C39-baccha, HI-C40-here]
sounds: []
roots: []
duration:
  max_seconds: 210
...
introduces:
  knowledge: [HI-LEX-C41-ADJ-02]
practises:
  knowledge: [HI-LEX-C41-ADJ-01, HI-LEX-C41-ADJ-02, HI-CONCEPT-C39-BACCHA-01, HI-CONCEPT-C39-BACCHA-02, HI-LEX-C40-DEIXIS-03]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output]
register: neutral
variety: standard-colloquial
reviews_of: [HI-C41-big]
---
...
<!-- hl-knowledge: introduces=[HI-LEX-C41-ADJ-02]; assesses=[] -->
...
[PAUSE 3s] What is *choṭā*? (**small**.) Where does it go — before the word
