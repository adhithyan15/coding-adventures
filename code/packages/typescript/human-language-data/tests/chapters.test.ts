...
describe("corpus snapshot", () => {
  ...
  it("pins the first published chapter-gate snapshot", () => {
    ...
    expect(report.summary.payoffsNotRepresentative).toBe(29); // +1: HL-C88 slices 5-6
  });
