#!/bin/sh
# Build and run the red-black-tree tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp red_black_tree-tests tests/red_black_tree_test.cpp
