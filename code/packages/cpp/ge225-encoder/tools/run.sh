#!/bin/sh
# Build and run the ge225-encoder tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp ge225_encoder-tests tests/ge225_encoder_test.cpp
