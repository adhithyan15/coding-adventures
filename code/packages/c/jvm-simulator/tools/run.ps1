# Build and run the jvm-simulator tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name jvm_simulator-tests -Sources @("tests\jvm_simulator_test.c", "src\jvm_simulator.c")
