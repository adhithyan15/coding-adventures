...
describe("the real corpus", () => {
  ...
  it("finds far more closure debt than the pace budget ever could", () => {
    ...
    // 293 once Italian, Telugu, Malayalam and Sanskrit stopped hand-writing their
    // opening chapters. Sanskrit's share is ten: romanizing the prose of its five
    // opening chapters took the track 31 -> 21 and its chapters 1-5 to zero.
    // Whoever raises it writes down why.
    expect(report.summary.violations).toBeLessThanOrEqual(293);
