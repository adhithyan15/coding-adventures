...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    */
    expect(report.summary.missedByWindow.R2).toBe(3687); // Portuguese's opener etymon and guided-copy sequence expose three wider-window reviews for a later tranche.
  });
