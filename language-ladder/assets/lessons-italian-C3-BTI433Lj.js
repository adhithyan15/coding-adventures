...
`,j=e({default:()=>M}),M=`---
schema_version: 2
id: IT-C05-second-pass-first-conversation
spine_node: SPINE-POLITE-REQUEST-REPAIR
sequence: 325
chapter: 5
type: review
headword: (practice)
gloss: the three exchanges you have built, run end to end as one conversation, with prego doing its fourth job
concept_tag: CH5-SECOND-PASS
prerequisites: [IT-C02-prego-come-again, IT-C02-practice, IT-C03-practice, IT-C04-practice, IT-C05-practice]
sounds: []
roots: []
duration:
  max_seconds: 200
requires:
  knowledge: [IT-PRAGMATIC-PREGO-COME-AGAIN-06, IT-LEX-PRACTICE-02, IT-NOTICE-PRACTICE-03, IT-LEX-C03-PRACTICE-02, IT-NOTICE-C03-PRACTICE-03, IT-LEX-C04-PRACTICE-02, IT-NOTICE-C04-PRACTICE-03]
introduces:
  knowledge: []
introduces_idioms: []
introduces_senses: []
...
register: neutral
variety: standard-contemporary
reviews_of: [IT-C02-prego-come-again, IT-C02-practice, IT-C03-practice, IT-C04-practice]
---
# One conversation, from hello to goodbye

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[IT-LEX-PRACTICE-02, IT-LEX-C03-PRACTICE-02] -->

[PAUSE 3s] You have practised three exchanges one at a time. Nothing has yet
asked you to run them together, which is what a real conversation is.

## You'll want to know: the three, joined up
<!-- hl-knowledge: introduces=[]; assesses=[IT-LEX-PRACTICE-02, IT-LEX-C03-PRACTICE-02, IT-LEX-C04-PRACTICE-02, IT-PRAGMATIC-PREGO-COME-AGAIN-06] -->

One formal meeting, first word to last:

> — Buongiorno. Come sta?
> — Bene, grazie. E Lei? Come si chiama?
> — **Prego?**
> — Come si chiama?
> — Mi chiamo Anna. Piacere.
> — Piacere. Arrivederci, a domani!

The third line is the one to notice. **Prego?** on a rising voice is not the
*prego* that answers *grazie* — it is the repair for a sentence you did not
catch, and a first conversation in a new language needs it more than any other
line in the exchange.

## What you've built — three chapters in one view
<!-- hl-knowledge: introduces=[]; assesses=[IT-NOTICE-PRACTICE-03, IT-NOTICE-C03-PRACTICE-03, IT-NOTICE-C04-PRACTICE-03] -->

| informal · formal | |
|---|---|
| *Come stai* · *Come sta* | asking how someone is |
| *Come ti chiami* · *Come si chiama* | asking a name |
| *Ciao* · *Arrivederci* | leaving |

The first two rows differ in the **verb ending**, not in an added polite word.
The third row is the exception that proves it: **arrivederci** is "until we
re-see each other", **a domani** "until tomorrow", **a presto** "until soon".
Italian takes its leave by naming the next meeting, as *au revoir* and *auf
Wiedersehen* do.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[IT-LEX-PRACTICE-02, IT-LEX-C03-PRACTICE-02, IT-LEX-C04-PRACTICE-02, IT-PRAGMATIC-PREGO-COME-AGAIN-06] -->

- [YOU SAY: the whole formal meeting above, both voices, without stopping]
- [YOU SAY: it informally — every verb ending moves]
- [YOU ASK: rising *Prego?*, then the question you missed]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[IT-PRAGMATIC-PREGO-COME-AGAIN-06, IT-LEX-PRACTICE-02, IT-NOTICE-PRACTICE-03, IT-LEX-C03-PRACTICE-02, IT-NOTICE-C03-PRACTICE-03, IT-LEX-C04-PRACTICE-02, IT-NOTICE-C04-PRACTICE-03] -->

[PAUSE 3s] Where does Italian mark formal against informal? (**In the verb ending.**) What does a rising **Prego?** ask for? (**A repeat.**) What do *arrivederci*, *a domani* and *a presto* share? (**Each names the next meeting.**) Which word answers *piacere*? (**Piacere.**)
