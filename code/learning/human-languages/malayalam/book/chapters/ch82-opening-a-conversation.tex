...
% canonical-source-hash: fnv1a64:9cc26540f5108958
% canonical-lessons: ML-C82-chettaa, ML-C82-chechi-address, ML-C82-greeting-register, ML-R82-address-recall, ML-R82-the-opening-second-pass
...
\end{tcolorbox}
\section[nandi · śari · athe · santōṣaṁ]{\ml{നന്ദി} · \ml{ശരി} · \ml{അതെ} — the first four chapters, run cold}

\label{lesson:ML-R82-the-opening-second-pass}



\begin{quote}
Thanks, yes, and the word that accepts what somebody has said. All three, before you read on.
\end{quote}

\subsection*{The exchange}
A whole first meeting, in the order it happens.

Say these aloud:

\begin{itemize}
\raggedright
  \item ask a name — \emph{ninṟe pēru entāṇu?}
  \item answer with your own — \emph{enṟe pēru … āṇu}
  \item that meeting them is a pleasure — \emph{santōṣaṁ}
  \item ask after them — \emph{sukhamāṇō?}
  \item leave, promising to come back — \emph{pōyi varāṁ}
  \item leave, promising to meet — \emph{vīṇḍuṁ kāṇāṁ}
\end{itemize}

\begin{culture}
\textbf{A question in Malayalam can be made by an ending rather than a word order.} \emph{Sukhamāṇō} is the statement \emph{you are well} with an \textbf{-ō} on the end, and the whole difference between telling and asking sits in that one syllable.

The two goodbyes make a distinction English collapses. \textbf{\ml{പോയി} \ml{വരാം}} is \emph{I will go and come back} — said by the person leaving, about themselves. \textbf{\ml{വീണ്ടും} \ml{കാണാം}} is \emph{we will meet again} — said about both of you. Neither is a word for \emph{goodbye}, because neither treats the parting as final.
\end{culture}

\subsection*{Your turn}
\begin{itemize}
\raggedright
  \item \emph{Say it:} agree that something is so — \emph{athe} — and say what it literally claims
  \item \emph{Write it:} \textbf{\ml{സന്തോഷം}}, from memory, and check the shapes against the page afterwards
\end{itemize}

\textbf{\ml{ശരി}} is the one to hold up. It is written four different ways across the languages that share it, and the same spoken word carries across all of them — a reminder that a script boundary is not a language boundary.

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What turns \emph{you are well} into \emph{are you well?} (\textbf{The ending -ō.}) Which of the two farewells is about you alone? (\emph{\textbf{Pōyi varāṁ}} — I will go and come back.)
\end{tcolorbox}
