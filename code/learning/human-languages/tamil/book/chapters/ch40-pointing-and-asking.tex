...
% canonical-source-hash: fnv1a64:3c29ed4baadb571c
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\ta{இது}\textquotedblright{} three times, pointing at something different each time
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\ta{இங்கே}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{sugam}, then read \textbf{\ta{எவ்வளவு}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\ta{யார்}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{viḍai}, then read \textbf{\ta{ஒரு}}
\end{itemize}
