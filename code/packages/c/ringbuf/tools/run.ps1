# Build and run the ringbuf tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name ringbuf-tests -Sources @("tests\ringbuf_test.c", "src\ringbuf.c")
