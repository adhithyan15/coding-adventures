#!/bin/sh
# Build and run the resp-protocol tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c resp_protocol-tests tests/resp_protocol_test.c src/resp_protocol.c
