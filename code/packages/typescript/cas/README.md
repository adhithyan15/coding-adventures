...
```bash
npm install @coding-adventures/cas
```
...
```ts
import { BlobStore, ContentAddressableStore } from "@coding-adventures/cas";
...
- `coding-adventures-cas` — Rust implementation (same spec, same design)
