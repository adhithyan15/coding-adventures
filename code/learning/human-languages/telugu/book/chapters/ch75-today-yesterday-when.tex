...
% canonical-source-hash: fnv1a64:5ed57762f3906c82
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{tīpi}, then read \textbf{\te{మరియు}} and say what it means
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\te{పులుపు}}, then say \emph{kānī}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{cēdu}, then read \textbf{\te{లేదా}} and say what it means
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\te{కారం}}, then say \emph{enduku}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{vagaru}, then read \textbf{\te{ఎందుకంటే}} and say what it means
\end{itemize}
