...
describe("corpus regression", () => {
  ...
  it("pins the core as strictly better than the whole, now that writing segments exist", () => {
    ...
    /* Superseded French-only total:
    expect(summary.lessonsWithWritingSegments).toBe(153); // Italian, French, and Portuguese each add two writing segments.
    */
    expect(summary.lessonsWithWritingSegments).toBe(159); // French adds two segments to the merged Arabic, Italian, and Portuguese total.
