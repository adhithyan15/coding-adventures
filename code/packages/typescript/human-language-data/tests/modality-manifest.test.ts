...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3401, // +1 Portuguese guided-copy step on top of Latin's merged step
      ...
      voice: 2464, // Portuguese's legacy opener becomes honestly classified as pen
      ...
      pen: 347, // +2 Portuguese pen lessons on top of Latin's merged two
      ...
      unstartableChapters: 211, // Portuguese chapter 1 now honestly starts with pen. // French/Marathi order recovery on current main: measured, not inferred. // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
