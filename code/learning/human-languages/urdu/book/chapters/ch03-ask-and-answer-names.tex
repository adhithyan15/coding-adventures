...
% canonical-source-hash: fnv1a64:a93aa87643d914d2
% canonical-lessons: UR-C03-aap-tum-tu, UR-C03-aap-tum-tu-more, UR-C03-kya, UR-W03-lam, UR-C03-aap-ka-naam-kya-hai, UR-C03-khushi-hui, UR-W03-mim, UR-C03-practice
...
\textbf{By the end of this chapter:} \emph{I can ask someone's name with respectful āp, answer with my own, and close the introduction politely. I can write lām and mīm from memory.}
...
\end{tcolorbox}
\section[(āp / tum / tū, continued)]{(\ur{آپ} / \ur{تم} / \ur{تو}, continued) — The word, taken apart}

\label{lesson:UR-C03-aap-tum-tu-more}



\begin{quote}
Before going on: say \textbf{\ur{آپ} / \ur{تم} / \ur{تو}} again, and what it means.
\end{quote}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} what this lesson added to \textbf{\ur{آپ} / \ur{تم} / \ur{تو}}, in one sentence
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What did this lesson add to \textbf{\ur{آپ} / \ur{تم} / \ur{تو}}? Say it once more, without looking.
\end{tcolorbox}
...
\begin{quote}
Which “you” opens a respectful first meeting? (\emph{āp}.) Now add the question word.
\end{quote}
...
Read right to left: \textbf{\ur{ک}} \emph{k}, \textbf{\ur{ی}} supplying the \emph{y} glide here, then \textbf{\ur{ا}} long \emph{ā}. The same \textbf{\ur{ی}} carried long \emph{ī} in \emph{jī} and \emph{nahī̃} — words you say but cannot spell yet. Its job depends on the word; here the learned shape is \emph{kyā}.
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{salām}, then say \emph{shukriyā}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which letter acts as \emph{y} here but as long \emph{ī} in \emph{jī}? (\textbf{\ur{ی}}.) What does \textbf{\ur{کیا}} mean? (\textbf{What}.)
\end{tcolorbox}
\section[lām]{\ur{ل} — alif, and then a bowl under the line}

\label{lesson:UR-W03-lam}
...
\hlblockfigure{\detokenize{figures/UR-W03-lam-filmstrip.pdf}}{How \ur{ل} is written, stroke by stroke}
...
\label{lesson:UR-W03-mim}



\begin{quote}
Write \ur{س}. Three teeth, then the bowl, no lift. Now write \ur{ل} beside it: upright, then the bowl below the line.
\end{quote}

\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/UR-W03-mim-filmstrip.pdf}}{How \ur{م} is written, stroke by stroke}
