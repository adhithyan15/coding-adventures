# ladder_t6_top_const_cond_simple

Rung 6.top_const_cond of the CCR-066 differential complexity ladder, at `SIMPLE`.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level SIMPLE_OPTIMIZATIONS --js tests/diff/ladder_t6_top_const_cond_simple/input/a.js
```
