...
- Reworked the Unix `BUILD` script to use a subshell instead of shell line continuations so CI can run the dependent `http_core` build and package tests reliably
