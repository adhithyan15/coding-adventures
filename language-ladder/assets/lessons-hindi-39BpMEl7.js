...
<!-- hl-knowledge: introduces=[HI-CONCEPT-C10-SOMAVAAR-SHUKRAVAAR-01]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[HI-CONCEPT-C10-SOMAVAAR-SHUKRAVAAR-02]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[HI-CONCEPT-C11-KAALAA-SAFED-01]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[HI-CONCEPT-C11-KAALAA-SAFED-02]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[HI-CONCEPT-C12-BHAAI-BAHIN-01]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[HI-CONCEPT-C12-BHAAI-BAHIN-02]; assesses=[] -->
...
## You'll want to know — The word
<!-- hl-knowledge: introduces=[HI-CONCEPT-C13-HAATH-01]; assesses=[] -->

**हाथ** (*hāth*) = "**hand**" — from Sanskrit **हस्त** (*hasta*), "hand."

## You'll want to know — The honest sound-change story
<!-- hl-knowledge: introduces=[HI-CONCEPT-C13-HAATH-02]; assesses=[] -->
