...
% canonical-source-hash: fnv1a64:4309e804adeab3d9
% canonical-lessons: HI-C32-shubh-sandhya, HI-S133-letter-jha, HI-S145-letter-sha, HI-C32-evening-register
...
\begin{quote}
You know \textbf{\hi{साँझ}} (\emph{sāñjh}), \textquotedblleft{}dusk\textquotedblright{}. This lesson writes its last letter.
...
\hlblockfigure{\detokenize{figures/HI-S133-letter-jha-filmstrip.pdf}}{How \hi{झ} is written, stroke by stroke}
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which letter is \textbf{\hi{झ}} the breathy partner of? (\textbf{\hi{ज}}.) How many pen lifts does it take, and why one more than \textbf{\hi{ज}}? (Three — the crossbar.) Which word did it come from? (\textbf{\hi{साँझ}}.)
\end{tcolorbox}
...
\hlblockfigure{\detokenize{figures/HI-S145-letter-sha-filmstrip.pdf}}{How \hi{श} is written, stroke by stroke}
