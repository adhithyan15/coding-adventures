# Build and run the reed-solomon tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
$env:ISO_INCLUDE = "include ..\gf256\include $harness\include"
. (Join-Path $harness 'lib\iso-lib.ps1')
Iso-BuildAndRun -Lang cpp -Name reed_solomon-tests -Sources @("tests\reed_solomon_test.cpp")
