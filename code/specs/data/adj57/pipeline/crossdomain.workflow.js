export const meta = {
  name: 'adj58-crossdomain-headtohead',
...
const DOMAINS = [
  { id: 'engineering', find: 'a published engineering/metallurgical FAILURE INVESTIGATION (e.g. from Engineering Failure Analysis, Case Studies in Engineering Failure Analysis, NTSB/NASA reports) where a component or structure failed and the ROOT CAUSE was determined (fatigue, stress-corrosion cracking, overload, hydrogen embrittlement, manufacturing defect, creep, etc.). The "answer" is the root cause.' },
  { id: 'astronomy', find: 'a published CLASSIFICATION of an astronomical object or transient from observations (e.g. a supernova subtype Ia/II/Ibc, a variable-star class, an exoplanet vs an astrophysical false positive, a fast radio burst source). The "answer" is the object class.' },
  { id: 'cybersecurity', find: 'a documented MALWARE / THREAT analysis where a sample was attributed to a malware family, or an intrusion to a threat actor, from observable indicators (file/behavioral features, IOCs, TTPs, code overlap). The "answer" is the family/actor.' },
]
