...
- `RevisionStoreSummary` and `InMemoryRevisionStore::summary()` for
  payload-free host telemetry over history, namespace, policy, revision,
  ciphertext-byte, and archive-time pressure.
