...
% canonical-source-hash: fnv1a64:8553d6c3fd34d262
...
\raggedright
  ...
  \item \emph{Say it:} \emph{dāru}, then \emph{nadī}
  \item \emph{Recall:} say \emph{ākāśaḥ}, then read \textbf{\sk{तरुः}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{setuḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{nadī}, then \emph{setuḥ}
  \item \emph{Recall:} read \textbf{\sk{चन्द्रः}}, then say \emph{patram}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{parvataḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{setuḥ}, then \emph{parvataḥ}
  \item \emph{Recall:} say \emph{tārā}, then read \textbf{\sk{तृणम्}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{puram}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{parvataḥ}, then \emph{puram}
  \item \emph{Recall:} read \textbf{\sk{वायुः}}, then say \emph{latā}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{samudraḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then say where a \emph{nadī} ends
  \item \emph{Recall:} say \emph{himam}, then read \textbf{\sk{दारु}}
\end{itemize}
