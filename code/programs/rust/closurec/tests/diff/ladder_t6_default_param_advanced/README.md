# ladder_t6_default_param_advanced

Rung 6.default_param of the CCR-066 differential complexity ladder, at `ADVANCED`.

## What this rung is for

Exercises a default parameter value.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t6_default_param_advanced/input/a.js
```
