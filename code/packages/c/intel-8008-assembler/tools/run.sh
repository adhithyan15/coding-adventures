#!/bin/sh
# Build and run the intel-8008-assembler tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c intel_8008_assembler-tests tests/intel_8008_assembler_test.c src/intel_8008_assembler.c
