# Build and run the lisp-vm tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
$env:ISO_INCLUDE = "include ..\lisp-compiler\include ..\lisp-parser\include ..\lisp-lexer\include $harness\include"
. (Join-Path $harness 'lib\iso-lib.ps1')
Iso-BuildAndRun -Lang c -Name lisp_vm-tests -Sources @("tests\lisp_vm_test.c", "src\lisp_vm.c", "..\lisp-compiler\src\lisp_compiler.c", "..\lisp-parser\src\lisp_parser.c", "..\lisp-lexer\src\lisp_lexer.c")
