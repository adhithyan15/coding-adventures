...
1. Add image layout helpers for Board VM ESP firmware artifacts.
2. Replace temporary `esptool`/`espflash` compatibility calls in smoke helpers.
3. Share target detection through Ruby, Python, Lua, and future language sugar
