...
% canonical-source-hash: fnv1a64:ae59146abb9b8c5d
...
\begin{enumerate}
\raggedright
  \item \textbf{Ask what the sentence is about.} A destination, a deadline, a recipient, a purpose — \emph{para}. A cause, a route, a swap, a duration — \emph{por}.
  \item \textbf{If it is genuinely both, it is genuinely both.} \emph{Lo hago para ti} and \emph{lo hago por ti} are both good Spanish; you are not choosing right from wrong, you are choosing which thing to say.
\end{enumerate}
