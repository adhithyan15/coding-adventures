...
\expandafter\def\csname hlchaptermodality1\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (10) \quad \hlsightsign{}~\textbf{eyes} (1)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 7 of 11 lessons.%
    \par}\medskip
}

\expandafter\def\csname hlchaptermodality2\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (7) \quad \hlsightsign{}~\textbf{eyes} (2)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 4 of 9 lessons.%
    \par}\medskip
}
