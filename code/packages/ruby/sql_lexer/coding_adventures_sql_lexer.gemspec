...
require_relative "lib/coding_adventures/sql_lexer/version"

Gem::Specification.new do |spec|
  spec.name          = "coding_adventures_sql_lexer"
  spec.version       = CodingAdventures::SqlLexer::VERSION
  spec.authors       = ["Adhithya Rajasekaran"]
  spec.summary       = "Tokenizes SQL text using a grammar-driven lexer"
  spec.description   = "A thin wrapper around the grammar-driven lexer engine that loads " \
                        "sql.tokens to tokenize ANSI SQL text from Ruby. " \
