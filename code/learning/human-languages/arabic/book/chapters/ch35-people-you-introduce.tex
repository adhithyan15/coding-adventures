...
% canonical-source-hash: fnv1a64:637613dc511ed67b
% canonical-lessons: AR-C35-jar, AR-C35-ibn-bint, AR-C35-sadiq, AR-R35-the-name-exchange-again
...
\end{tcolorbox}
\section[mā ismuka? · tasharrafnā]{The name exchange, with somebody else in the room}

\label{lesson:AR-R35-the-name-exchange-again}



\begin{quote}
Ask a woman her name, answer with your own, and close politely. This chapter has given you a neighbour, a friend, a son and a daughter — so run the exchange, then introduce one of them.
\end{quote}
...
\begin{itemize}
\raggedright
  \item ask a man — \emph{mā ismuka?}
  \item ask a woman — \emph{mā ismuki?}
  \item answer — \emph{ismī …}
  \item close — \emph{tasharrafnā}
  \item now name your neighbour, your friend, your son, your daughter into the same frame
\end{itemize}

Every line above is missing a verb, and none of them feels short. That is the zero copula doing its work: \emph{my-name Arun}, with the \emph{is} understood.

\begin{grammarlens}[title={Grammar Lens: the suffix set, whole}]
\noindent
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
\toprule
\textbf{noun} & \textbf{glued on} & \textbf{result} \\
\midrule
\textbf{\ar{اسم}} \emph{ism} & \textbf{\ar{ـي}} \emph{-ī} & \textbf{\ar{اسمي}} my name \\
\textbf{\ar{اسم}} \emph{ism} & \textbf{\ar{ـك}} \emph{-ka} & \textbf{\ar{اسمك}} your name, to a man \\
\textbf{\ar{اسم}} \emph{ism} & \textbf{\ar{ـك}} \emph{-ki} & \textbf{\ar{اسمك}} your name, to a woman \\
\bottomrule
\end{tabularx}

\textbf{\ar{اسم}} is three letters, all from the first writing set: \emph{alif · sīn · mīm}. What follows it is never a separate word. Arabic has no free-standing \emph{my} — it glues \textbf{\ar{ي}} on, the same habit that glues \textbf{\ar{الـ}} for \emph{the} and \textbf{\ar{بـ}} for \emph{in}.

The two \emph{your} forms are \textbf{identical on the page}. Only the unwritten vowel separates them, which is why the ear does the work the eye cannot.
\end{grammarlens}

\subsection*{The two words}
\textbf{\ar{ما}} \emph{mā} is \emph{mīm} plus \emph{alif} and means \textbf{what} — the form you want before a noun, where \emph{māḏā} is the one for verbs.

Two of these words have histories worth holding onto. \textbf{\ar{اسم}} shares its root \textbf{s–m–w} with Hebrew \emph{shem} and has no tie to English \emph{name} at all. And \textbf{\ar{تشرفنا}} comes from \textbf{sh–r–f}, honour: \emph{sharaf}, \emph{sharīf}, and at a long distance English \emph{sheriff}. It does not mean \emph{pleased to meet you}. It means \textbf{we have been honoured}.

\begin{grammarlens}[title={Grammar Lens: which axis splits you}]
\textbf{\ar{أنت}} is one skeleton — hamza-seated \emph{alif}, \emph{nūn}, \emph{tāʾ} — for both genders. \textbf{\ar{أنتَ}} \emph{anta} addresses a man, \textbf{\ar{أنتِ}} \emph{anti} a woman, and the split is Semitic: the same \emph{t} marks \emph{you} in Hebrew \emph{atta} and \emph{att}.

The European and Dravidian tracks split \emph{you} by \textbf{register}. Arabic splits it by \textbf{who is listening}. Two languages can make the same distinction in form and mean something entirely different by it.
\end{grammarlens}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Give the root behind \textbf{\ar{تشرفنا}} and what the word literally claims. (\textbf{sh–r–f}, honour — \emph{we have been honoured}.) Name the axis Arabic uses for \textbf{\ar{أنت}}. (\textbf{The listener's gender}.) Say how Arabic builds \emph{my}. (\textbf{A glued suffix \ar{ـي}}, never a separate word.) And say which \emph{what} goes before a noun. (\textbf{\ar{ما}}.)
\end{tcolorbox}
