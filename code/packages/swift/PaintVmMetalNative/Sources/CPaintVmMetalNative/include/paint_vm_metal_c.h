#ifndef CODING_ADVENTURES_PAINT_VM_METAL_C_H
#define CODING_ADVENTURES_PAINT_VM_METAL_C_H
...
uint8_t paint_vm_metal_render_rect_scene(
    uint32_t width,
    uint32_t height,
...
void paint_vm_metal_free_buffer_data(uint8_t *data, size_t len);
