...
- **#14986: twelve hormones, six pages, and one envelope about beta cells.**
  ...
  Twelve rows are grounded on **six different pages** — SEER pancreas, thyroid, adrenal, pituitary and
  ...
  ### Two spellings kept deliberately

  The SEER page writes **"glucagons"**. The span is quoted as the page has it and the row atom stays
  `glucagon` — silently correcting a quote is how a citation stops being checkable — and a mutant that
  "fixes" the spelling reddens. The melatonin row cites `pituitary.html` because that SEER page covers
  ...
  names**: all twelve occur **exactly once**, and each contains both its hormone and its gland. The
  ...
  **8 of 8 mutants killed. Two controls, counted separately.** Un-widening each of the three anaphoric
  ...
  which now matters across six pages, and it is the shape #15139 found rotting undetected in eight
