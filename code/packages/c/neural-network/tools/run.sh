#!/bin/sh
# Build and run the neural-network tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c neural_network-tests tests/neural_network_test.c src/neural_network.c
