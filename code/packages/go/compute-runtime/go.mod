module github.com/adhithyan15/coding-adventures/code/packages/go/compute-runtime

go 1.26

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/device-simulator v0.0.0
)
...
replace (
	...
	github.com/adhithyan15/coding-adventures/code/packages/go/compute-runtime => ./
)
