...
% canonical-source-hash: fnv1a64:cd8a2eb9a2260ec3
...
\begin{sounds}
Look at \textbf{\kn{ಟ್ಟು}} — a \textbf{doubled} \emph{ṭ}, stacked exactly the way \textbf{\kn{ತ್ತು}} was in \textbf{\kn{ಒಂಬತ್ತು}}. The first \textbf{\kn{ಟ್}} is \emph{ṭa} silenced by the \textbf{virama}, tucked \textbf{under} \textbf{\kn{ಟು}} \emph{ṭu} as an \emph{ottu}. Same rule, a new letter.
\end{sounds}

\subsection*{Your turn}
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}daya\textquotedblright{} — compassion — then \textquotedblleft{}iṭṭu,\textquotedblright{} having placed
  \item \emph{Say it:} the whole word — \textquotedblleft{}dayaviṭṭu\textquotedblright{} = please
  \item \emph{Say it:} the everyday way — the verb ending: \textquotedblleft{}kuḷitukoḷḷi\textquotedblright{} = please sit
  \item \emph{Recall:} say \emph{nālku}
\end{itemize}
