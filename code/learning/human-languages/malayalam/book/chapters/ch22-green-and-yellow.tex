...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: "\ml{പച്ച}" — green, matching Tamil paccai{]}
  \item {[}YOU SAY: "\ml{മഞ്ഞ}" — yellow, matching Tamil mañcaḷ, a separate root entirely{]}
  \item {[}YOU SAY: the contrast — paccha and mañña are NOT doublets of each other, unlike Telugu's pacca/pasupu{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} Does \textbf{\ml{മഞ്ഞ}} (\emph{mañña}, "yellow") share a root with \textbf{\ml{പച്ച}} (\emph{paccha}, "green")? (\textbf{No} — they are two separate native Dravidian roots.) What Tamil word does \textbf{\ml{മഞ്ഞ}} closely match? (\textbf{\ta{மஞ்சள்}}, \emph{mañcaḷ}, "turmeric/yellow.") Across Kannada, Telugu, and Malayalam, is there one single pattern for how green and yellow relate? (\textbf{No} — Kannada split them into native vs. Sanskrit-loan; Telugu made them doublets of one root; Malayalam keeps them as two separate native roots.)
\end{tcolorbox}
