...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}onnu, raṇṭu, mūnnu, nālu, añcu\textquotedblright{}{]}
  \item {[}YOU SAY: the near-identity — \textquotedblleft{}oṉṟu $\leftrightarrow$ onnu\textquotedblright{}, \textquotedblleft{}iraṇṭu $\leftrightarrow$ raṇṭu\textquotedblright{}{]}
  \item {[}YOU SAY: the one that shifted — \textquotedblleft{}aintu $\to$ añcu\textquotedblright{}{]}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}āṟu, ēḻu, eṭṭu, onpatu, pattu\textquotedblright{}{]}
  \item {[}YOU SAY: seven's kept sound — \textquotedblleft{}ēḻu\textquotedblright{}, the ḻ of \emph{Tamiḻ} (not the ḷ of \emph{Malayāḷam}){]}
  \item {[}YOU SAY: nine taken apart — \textquotedblleft{}oṉ + patu $\to$ ompatu\textquotedblright{}, one short of ten{]}
\end{itemize}
