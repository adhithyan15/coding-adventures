...
% canonical-source-hash: fnv1a64:48c7b196e3498743
% canonical-lessons: SA-C24-water, SA-C24-rice, SA-C24-fruit, SA-C24-cloth, SA-C24-lamp, SA-S122-letter-pha, SA-S123-letter-o
...
\begin{quote}
Before the new one: \sk{उ} — what does it do?
...
You already say this word, and it has \sk{फ} inside it:
...
\sk{फ} is \sk{प} with a puff of breath after it — the same relation \sk{ठ} has to \sk{ट}. Say \emph{p} and \emph{ph} with a hand in front of your mouth and the difference is the air.
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at these words, and find \sk{फ} in the ones that have it
\end{itemize}
...
\begin{quote}
Before the new one: \sk{फ} — what does it do?
...
It is an \textbf{independent vowel} — the shape the vowel \emph{o} takes when a word begins with it, rather than the sign it becomes inside a word.
...
You already say this word, and it has \sk{ओ} inside it:
...
Look at \sk{आ} and then at \sk{ओ}. The whole of \sk{आ} is in there; \sk{ओ} adds one arc over the top. That is how the vowel letters are built — not twelve unrelated shapes but a few shapes wearing marks.
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at these words, and find \sk{ओ} in the ones that have it
\end{itemize}
