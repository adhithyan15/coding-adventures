...
concept_tag: FR-NUM-1-5
prerequisites: []
sounds: [nasal-un, vowel-eu]
roots: [unus-duo-tres-latin]
etymology_hook: "un/deux/trois/quatre/cinq ← ūnus/duo/trēs/quattuor/quīnque → unit, duo, trio, quart, quintet (= Spanish uno/dos/tres/cuatro/cinco)"
est_minutes: 4
reviews_of: [FR-C05-practice]
---

# un, deux, trois, quatre, cinq — counting to five

## Warm-up

[PAUSE 2s] Numbers are the most-reused words in any language, and French — like
its sibling Spanish — inherited them almost unchanged from Latin. So you already
half-know them from English, and you'll see the **Spanish twin** beside each.

## Sounds you'll need

- \`nasal-un\` — **un** is a nasal vowel, *œ̃*, close to "uh" said through the nose;
  no *n* is actually pronounced.
- \`vowel-eu\` — **deux** = *deuh* (rounded *eu*), the *x* is silent.

## The numbers, taken apart

| French | ← Latin | Spanish twin | English cousins |
|---|---|---|---|
| **un** (1) | *ūnus* | *uno* | **unit, union, unique, universe** (and *a/an*, *one*) |
| **deux** (2) | *duo* | *dos* | **duo, dual, duet, double** |
| **trois** (3) | *trēs* | *tres* | **trio, triple, trident, triangle** |
| **quatre** (4) | *quattuor* | *cuatro* | **quart, quarter, quatrain, quadrant** |
| **cinq** (5) | *quīnque* | *cinco* | **quintet, quintessence** (French *cinq* → English *cinque*, the 5 on dice) |

Latin *ūnus, duo, trēs* barely changed on the way into French and Spanish alike —
*trois* and *tres* are the same Roman **trēs**, just worn two different ways.

## Grammar Lens: un → un / une (one = a/an)

**un** doubles as the article "a/an," and it takes gender: **un** (masc.) /
**une** (fem.) — *un café* "a/one coffee," *une bière* "a/one beer." French makes
no difference between "one" and "a," exactly like Spanish *un/una*. The others
(*deux, trois…*) don't change.

## Guided Practice

[PAUSE 1s]
- [YOU SAY: "un, deux, trois, quatre, cinq" — count up]
- [YOU SAY: each with its English cousin — "un/unit, deux/duo, trois/trio, quatre/
  quart, cinq/quintet"]
- [YOU SAY: "un café, une bière" — *un/une* before a noun]

## Wrap-up Recall

[PAUSE 3s] Give 1–5 in French. (*Un, deux, trois, quatre, cinq*.) What English
word is *cinq* the cousin of? (*Quintet* / *cinque*, ← *quīnque*.) What two things
does *un/une* mean, and its Spanish twin? ("One" *and* "a/an"; *un/una*.) Next:
**6–10**, where the months hide the numbers.
`,s=e({default:()=>c}),c=`---
...
# six, sept, huit, neuf, dix — and the calendar's secret

## Warm-up

[PAUSE 2s] The rest of the way to ten. These four hide the same fact the English
and Spanish numbers do: **septembre–décembre are just Latin for 7, 8, 9, 10.**
And *huit* shows how violently French can wear a Latin word down.

## Sounds you'll need

- **six** and **dix** end in a *-s* sound when counting (*sees*, *dees*) but go
  **silent** before a consonant (*six livres* = *see livres*) — a liaison quirk.
- **neuf** = *nuhf*; its *f* turns to a *v* sound before a vowel (*neuf ans* =
  *neu-v-ans*).
...
| French | ← Latin | Spanish twin | English cousins |
|---|---|---|---|
| **six** (6) | *sex* | *seis* | **sextet, sextant, semester** |
| **sept** (7) | *septem* | *siete* | **septembre** (the *7th* month!), septet |
| **huit** (8) | *octō* | *ocho* | **octobre** (8th), **octave, octopus** |
| **neuf** (9) | *novem* | *nueve* | **novembre** (9th), novena |
| **dix** (10) | *decem* | *diez* | **décembre** (10th), **decimal, dime** (← French *disme*) |

Look at **huit**: Latin *octō* lost its *c*, softened, and grew an *h-* prop —
*octō → oit → huit*. The number is unrecognizable, but *octobre* keeps the old
*oct-* intact, so the 8 is still visible in the **month**. And *dix* gave English
**dime** (a tenth of a dollar), through Old French *disme* ← *decima* "a tenth."

## Grammar Lens: why the months are "off by two"

*Septembre* means "7th," yet it's the **9th** month. Why? The old **Roman year
began in March**, so *September* really was the seventh. Julius and Augustus later
inserted **juillet** and **août** (named for themselves), shoving the counting
months out of place — but the Latin numbers stuck. Every *décembre*, you're saying
Roman "**ten**." (Identical to the Spanish story — *diciembre* ← *decem* too.)

## Guided Practice

[PAUSE 1s]
- [YOU SAY: "six, sept, huit, neuf, dix" — finish the count]
- [YOU SAY: "sept/septembre, huit/octobre, neuf/novembre, dix/décembre"]
- [YOU SAY: "octō → oit → huit" — hear the erosion; then "dix → dime"]

## Wrap-up Recall

[PAUSE 3s] Give 6–10 in French. (*Six, sept, huit, neuf, dix*.) Why is *décembre*
Latin for "ten"? (The Roman year started in March.) Which everyday English coin
comes from *dix*? (*Dime*, ← *disme* ← *decima*.) Next chapter builds on this —
