...
```ruby
require "coding_adventures/lzw"

data       = "TOBEORNOTTOBEORTOBEORNOT"
compressed = CodingAdventures::LZW.compress(data)
original   = CodingAdventures::LZW.decompress(compressed)
```
...
CMP03 (LZW,     1984) — LZ78 + pre-initialized dict; powers GIF  ← this gem
