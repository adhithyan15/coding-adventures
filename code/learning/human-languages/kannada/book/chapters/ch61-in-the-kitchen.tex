...
% canonical-source-hash: fnv1a64:36124497c3380483
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{mosaru}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{hālu}, then \emph{mosaru}, and say which one waits overnight
  \item \emph{Recall:} say \emph{gāḷi}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{tuppa}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{mosaru}, then \emph{tuppa}, and say which one is poured
  \item \emph{Recall:} read \textbf{\kn{ಮಂಜು}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{eṇṇe}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{tuppa}, then \emph{eṇṇe}, and say which one starts as a seed
  \item \emph{Recall:} say \emph{maraḷu}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{bella}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{bella}, then \emph{uppu}, and say which two go into the same pot
  \item \emph{Recall:} read \textbf{\kn{ಕೆಸರು}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{sakkare}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then give your name to the person cooking
  \item \emph{Recall:} say \emph{beṅki}
\end{itemize}
