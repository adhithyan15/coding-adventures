#!/bin/sh
# Build and run the hmac tests under EVERY available C/C++ compiler (pure ISO),
...
# Include this package's headers, the sibling sha256 package's (HMAC-SHA256 is
# the tested instantiation), and the harness's (for iso_test.h).
ISO_INCLUDE="include ../sha256/include $HARNESS/include"
export ISO_INCLUDE
...
iso_build_and_run c hmac-tests tests/hmac_test.c src/hmac.c ../sha256/src/sha256.c
