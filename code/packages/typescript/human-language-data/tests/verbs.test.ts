...
describe("corpus snapshot", () => {
  ...
  it("pins the core verb baseline: eighteen tracks, and Spanish has joined", () => {
    ...
    expect(spanish.extras.length).toBe(8); // HL-C128 step 9: 6 -> 7 -- ch258 names subject-verb agreement, which adds one verb-adjacent extra beyond the paradigm set // HL-C152: +5 lessons, +1 chapter — Spanish realizes SPINE-NEGATE-AND-ASK, completing A2 at 5/5
