...
| CCR-081 | The 138-fixture `non-minify-unverified-stdout` set is dispositioned `upstream_golden` but only 63 of 138 match upstream byte-for-byte; 67 differ and 8 are inputs upstream will not compile. Swept 2026-09-21, and the nine "incomplete invocations" completed 2026-09-23 (externs / module-resolution flags): 1 agreed, 8 differed. Partition and next steps are on the issue. | [#15868](https://github.com/adhithyan15/coding-adventures/issues/15868) |
