module github.com/adhithyan15/coding-adventures/code/packages/go/starlark-vm

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/starlark-ast-to-bytecode-compiler v0.0.0
...
replace github.com/adhithyan15/coding-adventures/code/packages/go/starlark-ast-to-bytecode-compiler => ../starlark-ast-to-bytecode-compiler

replace github.com/adhithyan15/coding-adventures/code/packages/go/starlark-parser => ../starlark-parser

replace github.com/adhithyan15/coding-adventures/code/packages/go/starlark-lexer => ../starlark-lexer

replace github.com/adhithyan15/coding-adventures/code/packages/go/bytecode-compiler => ../bytecode-compiler
