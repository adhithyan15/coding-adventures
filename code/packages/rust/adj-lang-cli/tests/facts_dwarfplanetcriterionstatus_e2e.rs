...
fn dwarf_planet_criterion_status_recalls_cleared_orbit_with_citation() {
    ...
    assert!(
        out.contains("\"source\":\"Dwarf planets like Pluto were defined as objects that orbit the Sun, and are nearly round, but have not been able to clear their orbit of debris\""),
