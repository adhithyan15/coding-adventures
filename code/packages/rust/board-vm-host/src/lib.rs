use board_vm_ir::{
    ...
    CAP_I2C_WRITE_U8, CAP_LED_MATRIX_FRAME, CAP_NETWORK_DNS_EXCHANGE_UDP, CAP_NETWORK_DNS_QUERY,
...
mod tests {
    ...
    use board_vm_ir::{
        ...
        CAP_NETWORK_DNS_RESOLVE, CAP_NETWORK_DNS_RESPONSE_IPV4, CAP_NETWORK_DNS_SET_SERVER,
        CAP_NETWORK_TCP_AVAILABLE, CAP_NETWORK_TCP_CLOSE, CAP_NETWORK_TCP_CONNECTED,
        CAP_NETWORK_TCP_OPEN, CAP_NETWORK_TCP_READ, CAP_NETWORK_TCP_WRITE,
        CAP_NETWORK_UDP_AVAILABLE, CAP_NETWORK_UDP_CLOSE, CAP_NETWORK_UDP_OPEN,
        CAP_NETWORK_UDP_READ, CAP_NETWORK_UDP_READ_BYTES, CAP_NETWORK_UDP_WRITE,
        CAP_NETWORK_UDP_WRITE_BYTES, CAP_PWM_WRITE, CAP_RTC_NOW, CAP_RTC_SET, CAP_SPI_OPEN,
