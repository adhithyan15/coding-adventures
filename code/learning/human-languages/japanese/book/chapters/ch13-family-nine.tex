...
% canonical-source-hash: fnv1a64:88a078391c1cc824
...
\hlblockfigure{\detokenize{figures/JA-W13-tsu-filmstrip.pdf}}{How \ja{つ} is written, stroke by stroke}
...
\begin{quote}
Start with two older forms. Write distant katakana \textbf{\ja{ヒ}}. Then read \textbf{\ja{コーヒー}} and recall why a loanword uses katakana.

Now hear, say, read, and write these four later body words: \textbf{\ja{あたま・かみ・は・かた}}.

Finish with the remaining three: \textbf{\ja{おなか・せなか・こし}}.
\end{quote}
