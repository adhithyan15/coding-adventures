...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    */
    expect(report.summary.missedByWindow.R2).toBe(3688); // Italian exposes three wider-window reviews; Persian's opener exposes one more for a later tranche.
  });
