...
% canonical-source-hash: fnv1a64:9c6f583d8ac56798
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{śikṣak}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{śikṣak}, then \emph{galā}, so the teacher and the voice sit together
  \item \emph{Recall:} say \emph{phal}, then read \textbf{\hi{बाल}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{chātra}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{chātra}, then \emph{śikṣak}, the pair that needs each other
  \item \emph{Recall:} say \emph{kapṛā}, then say \emph{uṅglī}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kisān}, then \emph{chātra}, then \emph{śikṣak}, back down the run
  \item \emph{Recall:} say \emph{dīyā}, then read \textbf{\hi{कान}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{mehmān}, then \emph{kisān}, so the visitor and the host sit together
  \item \emph{Recall:} read \textbf{\hi{नमक}}, then say \emph{nāk}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{śikṣak}, \emph{chātra}, \emph{kisān}, \emph{mehmān}, \emph{paṛosī}
  \item \emph{Recall:} say \emph{sābun}, then read \textbf{\hi{गला}}
\end{itemize}
