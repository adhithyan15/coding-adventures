#!/bin/sh
# Build and run the caesar-cipher tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp caesar_cipher-tests tests/caesar_cipher_test.cpp
