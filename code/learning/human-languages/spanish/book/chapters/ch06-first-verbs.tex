...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Fixed phrases got you this far. \textbf{Hablar} (\textquotedblleft{}to speak\textquotedblright{}) is the first verb you will take apart and put back together. Today: the word itself. Next lesson: the pattern it unlocks.
\end{quote}
...
\raggedright
  ...
  \item {[}YOU SAY: the sound law — \textquotedblleft{}fābulārī\textquotedblright{} then \textquotedblleft{}hablar\textquotedblright{}{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What Latin word is \emph{hablar} from, and what English word shares it? (\emph{Fābulārī} $\leftarrow$ \emph{fābula} — \textbf{fable}.) What happened to its initial Latin \emph{f-}? (It weakened away, leaving the written but \textbf{silent} Spanish \emph{h-}.) Next: the ending pattern that turns this one verb into a machine.
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} \emph{Hablar} is one word. Swap its last two letters and it becomes \textquotedblleft{}I speak,\textquotedblright{} or a question to a friend, or a polite question to a stranger. This is the biggest single piece of leverage in the course so far.
\end{quote}

\subsection*{You'll want to know first}
\begin{itemize}
\raggedright
  \item \href{https://github.com/adhithyan15/coding-adventures/blob/main/code/learning/human-languages/spanish/lessons/ES-C06-hablar.md}{hablar} — the verb and its \emph{fābula} root.
  \item \href{https://github.com/adhithyan15/coding-adventures/blob/main/code/learning/human-languages/spanish/lessons/ES-C03-tu-usted-register.md}{tú \emph{or} usted} — which forms \emph{usted} takes.
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} You have practised writing this word's \textbf{ñ}. Now find out what is inside it — because \emph{español} is not a Spanish-made word at all.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}español\textquotedblright{} — \emph{es-pa-NYOL}{]}
  \item {[}YOU SAY: the path — \textquotedblleft{}Hispania, hispaniolus, español\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}español\textquotedblright{} then English \textquotedblleft{}Hispanic\textquotedblright{} — same root{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} Where does \emph{español} come from? (\textbf{Hispania}, the Roman name for Iberia.) What letter does its ending bring back, and from what Latin sequence? (\textbf{ñ}, from \textbf{-ni-} in \emph{Hispaniolus}.) Next: put it behind a verb and build your first sentence.
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} This is the moment the course has been building to. You take a \textbf{verb} you conjugated yourself and a \textbf{noun} you took apart yourself, and make a sentence \textbf{nobody handed you pre-assembled}.
\end{quote}
