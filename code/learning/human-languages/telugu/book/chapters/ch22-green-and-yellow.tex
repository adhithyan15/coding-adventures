...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}\te{పచ్చ}\textquotedblright{} — green, from Proto-Dravidian \emph{pac-{]}}
  \item {[}YOU SAY: \textquotedblleft{}\te{పసుపు}\textquotedblright{} — yellow/turmeric, a true doublet of pacca, same root{]}
