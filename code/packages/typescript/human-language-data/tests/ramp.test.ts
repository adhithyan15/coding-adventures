...
describe("the script ramp against the real corpus", () => {
  it("pins the script ramp, which no gate had ever measured", () => {
    ...
    expect(report.summary.lessonViolations).toBe(60); // Urdu's authored order makes shukriya's existing five-shape spike measurable; #12261 owns the gentle split.
