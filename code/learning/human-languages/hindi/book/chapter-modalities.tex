...
\expandafter\def\csname hlchaptermodality2\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (4) \quad \hlsightsign{}~\textbf{eyes} (5) \quad \hlpensign{}~\textbf{pen} (15)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 8 of 24 lessons.%
    \par}\medskip
}
