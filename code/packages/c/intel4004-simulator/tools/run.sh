#!/bin/sh
# Build and run the intel4004-simulator tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c intel4004_simulator-tests tests/intel4004_simulator_test.c src/intel4004_simulator.c
