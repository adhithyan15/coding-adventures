# Build and run the compiler-source-map tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name compiler_source_map-tests -Sources @("tests\compiler_source_map_test.c", "src\compiler_source_map.c")
