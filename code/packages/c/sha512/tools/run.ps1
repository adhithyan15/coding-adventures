# Build and run the sha512 tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name sha512-tests -Sources @("tests\sha512_test.c", "src\sha512.c")
