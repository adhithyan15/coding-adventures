#!/bin/sh
# Build and run the x86_64-encoder tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c x86_64_encoder-tests tests/x86_64_encoder_test.c src/x86_64_encoder.c
