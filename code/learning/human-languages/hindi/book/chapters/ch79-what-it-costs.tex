...
% canonical-source-hash: fnv1a64:ddc628f600605251
% canonical-lessons: HI-C72-money, HI-C72-rupee, HI-C72-price, HI-C72-expensive, HI-C72-buy, HI-C72-sau
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{khel}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\hi{खेलना}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} \emph{dām kyā hai?}
  \item \emph{Say it:} it again, pointing at something in the room
  \item \emph{Recall:} say \emph{krikeṭ}, then read \textbf{\hi{आज}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\hi{गाना}}, then say \emph{bhī}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{ārām}, then read \textbf{\hi{बहुत}}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What does \hi{ख़रीदना} mean? (\textquotedblleft{}to buy\textquotedblright{}.) Ask what a thing costs.
\end{tcolorbox}
\section[sau]{\hi{सौ} — the round figure}

\label{lesson:HI-C72-sau}



\begin{quote}
Say the word for a rupee, and the word for buying. You can ask what a thing costs — but you cannot yet say the number the answer usually is.
\end{quote}

\subsection*{You'll want to know: \hi{सौ}}
\textbf{\hi{सौ}} (\emph{sau}) — a hundred.

\begin{grammarlens}[title={Grammar Lens: two letters, and the number a price lands on}]
\noindent
...
Number first, then the thing. That is the whole construction, and both halves are now yours.

\textbf{\hi{रुपये}} rather than \textbf{\hi{रुपया}}, because more than one is being counted — the same bend the track has been making since the adjectives, costing nothing new here.

It is two letters, the shortest number word you will meet, and it does more work than any of the bigger ones: a price, an age, a distance, and the round figure anybody reaches for when they mean \emph{a great many}.

Your counting still stops at \textbf{\hi{बीस}}, so the numbers between twenty and this one are still ahead of you. \textbf{\hi{सौ}} arrives early because a price cannot wait for them.
\end{grammarlens}
...
\raggedright
  \item \hi{सौ}
  \item \hi{सौ} \hi{रुपये}
  \item why the last word is \hi{रुपये} rather than \hi{रुपया}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What number is \textbf{\hi{सौ}}? How do you say \emph{a hundred rupees}? Which comes first, the number or the thing?
\end{tcolorbox}
