...
% canonical-source-hash: fnv1a64:83cc217358a63aa5
...
\raggedright
  ...
  \item \emph{Say it:} \emph{gāy}, and hear the \emph{c-} of \emph{cow} inside it
  \item \emph{Recall:} say \emph{chāval}, then read \textbf{\hi{कंधा}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{ghoṛā}, then \emph{gāy} — the one that was replaced, the one that was not
  \item \emph{Recall:} read \textbf{\hi{दाल}}, then say \emph{ghuṭnā}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{machhlī}, and remember it is feminine
  \item \emph{Recall:} say \emph{tel}, then say \emph{māthā}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{chiṛiyā}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{chiṛiyā}, small and feminine
  \item \emph{Recall:} read \textbf{\hi{चीनी}}, then say \emph{pīṭh}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{bakrī}, \emph{gāy}, \emph{ghoṛā}, \emph{machhlī}, \emph{chiṛiyā} — name them round
  \item \emph{Recall:} say \emph{sabzī}, then read \textbf{\hi{होंठ}}
\end{itemize}
