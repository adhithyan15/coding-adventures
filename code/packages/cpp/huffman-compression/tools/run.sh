#!/bin/sh
# Build and run the huffman-compression tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp huffman_compression-tests tests/huffman_compression_test.cpp
