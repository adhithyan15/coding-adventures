...
type: word
headword: ਧੰਨਵਾਦ
romanization: "dhannavād"
gloss: "thank you — the Sanskritic choice"
concept_tag: COURTESY-THANKS
prerequisites: [PA-W01-haan-dictation]
sounds: []
roots: [dhanya, vada]
duration:
  max_seconds: 150
...
reviews_of: [PA-C01-namaste, PA-C01-han-nahin]
---

# *dhannavād* — “thank you,” the Sanskrit way

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-NAMASTE-01, PA-LEX-HAAN-NAHIN-01] -->

[PAUSE 2s] You can greet and answer yes or no. Add one spoken thanks. The
Gurmukhi above is a label, not a word you must decode.

## You'll want to know first — listen and use
<!-- hl-knowledge: introduces=[PA-LEX-DHANVAAD-01]; assesses=[PA-LEX-NAMASTE-01, PA-LEX-HAAN-NAHIN-01] -->

[YOU HEAR: *dhannavād*] — **thank you**. Return it once: [YOU SAY:
*dhannavād*].

It descends from Sanskrit *dhanya*, “worthy” or “blessed,” plus *vāda*, “a
saying.” This is Punjabi’s Sanskritic thanks. The next session adds a
Perso-Arabic choice with the same everyday function.

## Wrap-up recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-DHANVAAD-01] -->
<!-- hl-activity: {"id":"PA-C01-dhanvaad-meaning","kind":"text","assesses":["PA-LEX-DHANVAAD-01"],"prompt":"You hear dhannavād. Type its English meaning.","answer":"thank you","accepted":["thanks"],"feedback":{"correct":"Right: dhannavād means thank you.","incorrect":"Dhannavād is the Sanskritic way to say thank you."},"response_seconds":8} -->

[PAUSE 3s] Is this the Sanskritic or Perso-Arabic choice? (**Sanskritic.**)
`,r=e({default:()=>i}),i=`---
schema_version: 2
id: PA-C01-han-nahin
...
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: [PA-CULTURE-NAMASTE-BROADER-COMMUNITY-GREETING-01]
practises:
...
duration:
  max_seconds: 180
requires:
  knowledge: [PA-LEX-NAAM-02, PA-LEX-MERA-02]
introduces:
  knowledge: [PA-LEX-HAI-02, PA-GRAMMAR-VERB-LAST-02]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [PA-LEX-NAAM-02, PA-LEX-MERA-02, PA-LEX-HAI-02, PA-GRAMMAR-VERB-LAST-02]
skills: [listening, speaking]
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-NAAM-02, PA-LEX-MERA-02] -->
...
<!-- hl-knowledge: introduces=[PA-GRAMMAR-VERB-LAST-02]; assesses=[PA-LEX-HAI-02] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-NAAM-02, PA-LEX-MERA-02, PA-LEX-HAI-02, PA-GRAMMAR-VERB-LAST-02] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-HAI-02, PA-GRAMMAR-VERB-LAST-02] -->
<!-- hl-activity: {"id":"PA-C02-hai-order","kind":"text","assesses":["PA-LEX-HAI-02","PA-GRAMMAR-VERB-LAST-02"],"prompt":"Complete merā nāṁ Arun ... and say where Punjabi puts this verb.","answer":"hai; at the end","accepted":["hai, at the end","hai; end"],"feedback":{"correct":"Right: hai means is and waits at the end.","incorrect":"Use hai, is; Punjabi places the verb at the end."},"response_seconds":10} -->
...
type: phrase
headword: ਖ਼ੁਸ਼ੀ ਹੋਈ
romanization: "khushī hoī"
gloss: "pleased to meet you — literally happiness happened"
concept_tag: INTRO-NICE-TO-MEET-YOU
prerequisites: [PA-C02-mera-naam-hai, PA-C01-shukriya]
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-KHUSHI-HOI-02, PA-ETYMON-KHUSH-PERSIAN-02] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-KHUSHI-HOI-02, PA-ETYMON-KHUSH-PERSIAN-02] -->
<!-- hl-activity: {"id":"PA-C02-khushi-meaning","kind":"text","assesses":["PA-PHRASE-KHUSHI-HOI-02","PA-ETYMON-KHUSH-PERSIAN-02"],"prompt":"You hear khushī hoī after an introduction. Give its use and source.","answer":"pleased to meet you; Persian khush","accepted":["pleased to meet you, Persian","nice to meet you; Persian"],"feedback":{"correct":"Right: the welcome uses Persian khush, happy.","incorrect":"It means pleased to meet you and khushī comes through Persian khush."},"response_seconds":12} -->
...
introduces_culture_claims: []
practises:
  knowledge: [PA-LEX-YOU-REGISTER-02, PA-LEX-KI-02]
skills: [listening, speaking]
modes: [interpretive, presentational]
strands: [meaning-input, meaning-output, language-focus]
register: neutral
...
## The word, taken apart
<!-- hl-knowledge: introduces=[PA-LEX-KI-02]; assesses=[] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-KI-02] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-KI-02] -->
<!-- hl-activity: {"id":"PA-C02-ki-meaning","kind":"text","assesses":["PA-LEX-KI-02"],"prompt":"You hear kī in a question. Type its English meaning.","answer":"what","accepted":[],"feedback":{"correct":"Right: kī means what.","incorrect":"Punjabi kī is the k-family question word what."},"response_seconds":8} -->
...
introduces_culture_claims: []
practises:
  knowledge: [PA-LEX-NAAM-02, PA-LEX-MERA-02, PA-LEX-HAI-02, PA-GRAMMAR-VERB-LAST-02, PA-PHRASE-MY-NAME-02]
skills: [listening, speaking]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus]
register: neutral
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-NAAM-02, PA-LEX-MERA-02, PA-LEX-HAI-02] -->

[PAUSE 2s] Three atoms you now own, assembled into a first sentence.

## The exchange — assembled
<!-- hl-knowledge: introduces=[PA-PHRASE-MY-NAME-02]; assesses=[PA-LEX-NAAM-02, PA-LEX-MERA-02, PA-LEX-HAI-02] -->

**ਮੇਰਾ** (my) + **ਨਾਂ** (name) + your name + **ਹੈ** (is) = **merā nāṁ … hai**,
"my name is…" *Merā nāṁ Arun hai.* → "My name is Arun."

## Grammar Lens: the verb goes last
<!-- hl-knowledge: introduces=[]; assesses=[PA-GRAMMAR-VERB-LAST-02, PA-PHRASE-MY-NAME-02] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-MY-NAME-02, PA-GRAMMAR-VERB-LAST-02] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-MY-NAME-02, PA-GRAMMAR-VERB-LAST-02] -->
<!-- hl-activity: {"id":"PA-C02-mera-naam-hai-speaking","kind":"text","assesses":["PA-PHRASE-MY-NAME-02","PA-GRAMMAR-VERB-LAST-02"],"prompt":"Say my name is Mira in Punjabi, then type the romanized sentence you said.","answer":"merā nāṁ Mira hai","accepted":["mera nam Mira hai","mera naam Mira hai"],"feedback":{"correct":"Right: merā nāṁ Mira hai, with hai last.","incorrect":"Build my plus name plus Mira plus is: merā nāṁ Mira hai."},"response_seconds":12} -->
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-NAAM-02] -->
...
## The word, taken apart
<!-- hl-knowledge: introduces=[PA-LEX-MERA-02]; assesses=[PA-LEX-NAAM-02] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-MERA-02] -->
<!-- hl-activity: {"id":"PA-C02-mera-meaning","kind":"text","assesses":["PA-LEX-MERA-02"],"prompt":"You hear merā nāṁ. Which word means my?","answer":"merā","accepted":["mera"],"feedback":{"correct":"Right: merā means my before the masculine noun nāṁ.","incorrect":"The phrase is merā nāṁ: merā means my."},"response_seconds":8} -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-NAAM-02] -->
<!-- hl-activity: {"id":"PA-C02-naam-meaning","kind":"text","assesses":["PA-LEX-NAAM-02"],"prompt":"You hear nāṁ. Type its English meaning.","answer":"name","accepted":[],"feedback":{"correct":"Right: nāṁ means name.","incorrect":"The first introduction word is nāṁ, name."},"response_seconds":8} -->

[PAUSE 3s] What Sanskrit and PIE roots is *nāṁ* from, and its English cousins?
(*Nāman* / *\\*h₃nómn*, with a syllabic final *n*; **name**, **noun**,
**nominate**.)
`,T=e({default:()=>E}),E=`---
schema_version: 2
id: PA-C02-practice
...
type: practice
headword: (dialogue)
gloss: "Chapter 2 oral checkpoint — the introduction exchange"
concept_tag: REVIEW
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-NAAM-02, PA-LEX-MERA-02, PA-LEX-HAI-02, PA-LEX-YOU-REGISTER-02, PA-LEX-KI-02] -->

[PAUSE 2s] No new words. The whole introduction, assembled from atoms you now own.

## The exchange
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-MY-NAME-02, PA-PHRASE-YOUR-NAME-02, PA-PHRASE-KHUSHI-HOI-02] -->
<!-- hl-activity: {"id":"PA-C02-practice-listening","kind":"text","assesses":["PA-PHRASE-YOUR-NAME-02"],"prompt":"You hear tuhāḍā nāṁ kī hai? Type what the speaker wants to know.","answer":"your name","accepted":["what my name is","my name"],"feedback":{"correct":"Listening score: the speaker asks your name.","incorrect":"The respectful question asks what your name is."},"response_seconds":10} -->
<!-- hl-activity: {"id":"PA-C02-practice-speaking","kind":"text","assesses":["PA-PHRASE-MY-NAME-02","PA-PHRASE-YOUR-NAME-02","PA-PHRASE-KHUSHI-HOI-02"],"prompt":"Say a three-turn introduction aloud, then type the romanized turns you said.","answer":"merā nāṁ Mira hai; tuhāḍā nāṁ kī hai?; khushī hoī","accepted":["mera naam Mira hai; tuhada naam ki hai; khushi hoi"],"feedback":{"correct":"Speaking score: statement, respectful question, and warm close are all present.","incorrect":"Use three oral turns: merā nāṁ ... hai; tuhāḍā nāṁ kī hai; khushī hoī."},"response_seconds":24} -->
...
## Guided Practice — the atoms
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-NAAM-02, PA-LEX-MERA-02, PA-LEX-HAI-02, PA-GRAMMAR-VERB-LAST-02, PA-LEX-YOU-REGISTER-02, PA-LEX-KI-02] -->
...
## The word, taken apart — roots you now carry
<!-- hl-knowledge: introduces=[]; assesses=[PA-ETYMON-KHUSH-PERSIAN-02] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-NAAM-02, PA-LEX-MERA-02, PA-LEX-HAI-02, PA-GRAMMAR-VERB-LAST-02, PA-PHRASE-MY-NAME-02, PA-LEX-YOU-REGISTER-02, PA-LEX-KI-02, PA-PHRASE-YOUR-NAME-02, PA-PHRASE-KHUSHI-HOI-02, PA-ETYMON-KHUSH-PERSIAN-02] -->

[PAUSE 2s] Independent Gurmukhi reading and writing are **not scored here**.
Chapter 2 still contains untaught forms; #13068 must build their visible-model,
guided-copy, delayed-copy, and dictation runway before either skill can earn
credit. A romanized answer never counts as Gurmukhi writing.
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-YOU-REGISTER-02] -->
<!-- hl-activity: {"id":"PA-C02-tu-tusi-register","kind":"text","assesses":["PA-LEX-YOU-REGISTER-02"],"prompt":"Which Punjabi you belongs in a first meeting: tū̃ or tusī̃?","answer":"tusī̃","accepted":["tusi"],"feedback":{"correct":"Right: tusī̃ is the respectful first-meeting choice.","incorrect":"Use plural-shaped tusī̃ with elders and strangers."},"response_seconds":8} -->
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-YOU-REGISTER-02, PA-LEX-KI-02] -->

[PAUSE 2s] Turn the introduction around — ask, instead of tell.

## The exchange — assembled
<!-- hl-knowledge: introduces=[PA-PHRASE-YOUR-NAME-02]; assesses=[PA-LEX-NAAM-02, PA-LEX-HAI-02, PA-GRAMMAR-VERB-LAST-02, PA-LEX-YOU-REGISTER-02, PA-LEX-KI-02] -->
...
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-YOUR-NAME-02, PA-PHRASE-MY-NAME-02] -->
...
## The word, taken apart
<!-- hl-knowledge: introduces=[PA-LEX-KIVEIN-03, PA-ETYMON-QUESTION-K-03]; assesses=[PA-LEX-KI-02] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-KIVEIN-03, PA-ETYMON-QUESTION-K-03] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-KIVEIN-03, PA-ETYMON-QUESTION-K-03] -->
<!-- hl-activity: {"id":"PA-C03-kivein-meaning","kind":"text","assesses":["PA-LEX-KIVEIN-03","PA-ETYMON-QUESTION-K-03"],"prompt":"You hear kivēṁ. Type its meaning and the question-family sound it shares with kī.","answer":"how; k-","accepted":["how, k","how; k"],"feedback":{"correct":"Right: kivēṁ means how and belongs to Punjabi's k- question family.","incorrect":"Kivēṁ means how; listen for the opening k- shared with kī."},"response_seconds":10} -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-NO-PROBLEM-03, PA-ETYMON-NEGATIVE-NE-03] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-NO-PROBLEM-03, PA-ETYMON-NEGATIVE-NE-03] -->
<!-- hl-activity: {"id":"PA-C03-koi-gall-nahin-response","kind":"text","assesses":["PA-PHRASE-NO-PROBLEM-03","PA-ETYMON-NEGATIVE-NE-03"],"prompt":"Someone says dhannavād. Give the gracious Punjabi reply aloud, then type its romanization.","answer":"koī gall nahīṁ","accepted":["koi gall nahin","koi gal nahi"],"feedback":{"correct":"Speaking score: koī gall nahīṁ answers thanks with no problem.","incorrect":"Reply koī gall nahīṁ, literally there is no matter."},"response_seconds":12} -->
...
## The word, taken apart
<!-- hl-knowledge: introduces=[PA-LEX-MAIN-03, PA-ETYMON-FIRST-PERSON-M-03]; assesses=[PA-LEX-MERA-02] -->
...
<!-- hl-knowledge: introduces=[PA-GRAMMAR-MAIN-HAAN-03]; assesses=[PA-LEX-MAIN-03] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-MAIN-03, PA-GRAMMAR-MAIN-HAAN-03, PA-ETYMON-FIRST-PERSON-M-03] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-MAIN-03, PA-GRAMMAR-MAIN-HAAN-03, PA-ETYMON-FIRST-PERSON-M-03] -->
<!-- hl-activity: {"id":"PA-C03-main-pair","kind":"text","assesses":["PA-LEX-MAIN-03","PA-GRAMMAR-MAIN-HAAN-03","PA-ETYMON-FIRST-PERSON-M-03"],"prompt":"Say Punjabi I, then complete the spoken frame I am: maiṁ ...","answer":"maiṁ; maiṁ ... hāṁ","accepted":["main; main haan","mai; mai haan"],"feedback":{"correct":"Right: maiṁ means I, and its copula frame ends in hāṁ.","incorrect":"Use maiṁ for I and finish the frame with hāṁ, am."},"response_seconds":12} -->
...
type: practice
headword: (dialogue)
gloss: "Chapter 3 oral checkpoint — the how-are-you exchange"
concept_tag: REVIEW
...
duration:
  max_seconds: 240
requires:
  knowledge: [PA-LEX-KIVEIN-03, PA-ETYMON-QUESTION-K-03, PA-PHRASE-HOW-ARE-YOU-03, PA-GRAMMAR-TUSI-HO-03, PA-LEX-MAIN-03, PA-GRAMMAR-MAIN-HAAN-03, PA-ETYMON-FIRST-PERSON-M-03, PA-LEX-THIK-03, PA-PHRASE-I-AM-FINE-03, PA-PHRASE-NO-PROBLEM-03, PA-ETYMON-NEGATIVE-NE-03, PA-LEX-DHANVAAD-01]
introduces:
  knowledge: []
introduces_idioms: []
introduces_senses: []
...
register: respectful
variety: standard-punjabi
reviews_of: [PA-C03-kivein, PA-C03-tusi-kivein-ho, PA-C03-main, PA-C03-thik, PA-C03-koi-gall-nahin, PA-C01-dhanvaad]
---

# Chapter 3 — The how-are-you exchange

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-HOW-ARE-YOU-03, PA-PHRASE-I-AM-FINE-03, PA-PHRASE-NO-PROBLEM-03] -->

[PAUSE 2s] No new words. The whole responding cycle, from atoms you now own.

## The exchange
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-HOW-ARE-YOU-03, PA-GRAMMAR-TUSI-HO-03, PA-PHRASE-I-AM-FINE-03, PA-PHRASE-NO-PROBLEM-03, PA-LEX-DHANVAAD-01] -->
<!-- hl-activity: {"id":"PA-C03-practice-listening","kind":"text","assesses":["PA-PHRASE-HOW-ARE-YOU-03","PA-GRAMMAR-TUSI-HO-03"],"prompt":"You hear tusī̃ kivēṁ ho? Type what the respectful speaker wants to know.","answer":"how I am","accepted":["how are you","how I am doing","how I feel"],"feedback":{"correct":"Listening score: the speaker respectfully asks how you are.","incorrect":"Tusī̃ kivēṁ ho asks how you are, using respectful tusī̃ and ho."},"response_seconds":10} -->
<!-- hl-activity: {"id":"PA-C03-practice-speaking","kind":"text","assesses":["PA-PHRASE-HOW-ARE-YOU-03","PA-PHRASE-I-AM-FINE-03","PA-PHRASE-NO-PROBLEM-03","PA-LEX-DHANVAAD-01"],"prompt":"Say a polite reply, return the question, and answer thanks aloud; then type the romanized turns.","answer":"maiṁ ṭhīk hāṁ, dhannavād; tusī̃ kivēṁ ho?; koī gall nahīṁ","accepted":["main thik haan, dhannavad; tusi kivein ho; koi gall nahin"],"feedback":{"correct":"Speaking score: answer, returned respectful question, and courtesy close are all present.","incorrect":"Use three oral turns: maiṁ ṭhīk hāṁ, dhannavād; tusī̃ kivēṁ ho?; koī gall nahīṁ."},"response_seconds":24} -->
...
## Guided Practice — the atoms
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-KIVEIN-03, PA-PHRASE-HOW-ARE-YOU-03, PA-GRAMMAR-TUSI-HO-03, PA-LEX-MAIN-03, PA-GRAMMAR-MAIN-HAAN-03, PA-LEX-THIK-03, PA-PHRASE-I-AM-FINE-03] -->
...
## The word, taken apart — roots you now carry
<!-- hl-knowledge: introduces=[]; assesses=[PA-ETYMON-QUESTION-K-03, PA-ETYMON-FIRST-PERSON-M-03, PA-ETYMON-NEGATIVE-NE-03] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-KIVEIN-03, PA-ETYMON-QUESTION-K-03, PA-PHRASE-HOW-ARE-YOU-03, PA-GRAMMAR-TUSI-HO-03, PA-LEX-MAIN-03, PA-GRAMMAR-MAIN-HAAN-03, PA-ETYMON-FIRST-PERSON-M-03, PA-LEX-THIK-03, PA-PHRASE-I-AM-FINE-03, PA-PHRASE-NO-PROBLEM-03, PA-ETYMON-NEGATIVE-NE-03, PA-LEX-DHANVAAD-01] -->
...
[PAUSE 2s] Independent Gurmukhi reading and writing are **not scored here**.
Chapter 3 still contains untaught forms; #13068 must build their visible-model,
guided-copy, delayed-copy, and dictation runway before either skill can earn
credit. A romanized answer never counts as Gurmukhi writing.
`,z=e({default:()=>B}),B=`---
schema_version: 2
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[PA-PHRASE-HOW-ARE-YOU-03] -->
...
## The word, taken apart
<!-- hl-knowledge: introduces=[PA-LEX-THIK-03]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[PA-PHRASE-I-AM-FINE-03]; assesses=[PA-PHRASE-HOW-ARE-YOU-03, PA-LEX-MAIN-03, PA-GRAMMAR-MAIN-HAAN-03, PA-LEX-THIK-03] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-THIK-03, PA-PHRASE-I-AM-FINE-03] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-THIK-03, PA-PHRASE-I-AM-FINE-03] -->
<!-- hl-activity: {"id":"PA-C03-thik-reply","kind":"text","assesses":["PA-LEX-THIK-03","PA-PHRASE-I-AM-FINE-03"],"prompt":"Reply I am fine aloud in Punjabi, then type the romanized words you said.","answer":"maiṁ ṭhīk hāṁ","accepted":["main thik haan","mai thik haan"],"feedback":{"correct":"Speaking score: maiṁ ṭhīk hāṁ gives a natural short reply.","incorrect":"Say maiṁ ṭhīk hāṁ: I, fine, am."},"response_seconds":12} -->

[PAUSE 3s] Give the reply to *tusī̃ kivēṁ ho?* aloud. (*Maiṁ ṭhīk hāṁ.*)
`,V=e({default:()=>H}),H=`---
schema_version: 2
...
## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[PA-LEX-KIVEIN-03, PA-LEX-YOU-REGISTER-02] -->

[PAUSE 2s] Three words you own, assembled into the first thing you ask after
hello.

## The phrase, taken apart
<!-- hl-knowledge: introduces=[PA-PHRASE-HOW-ARE-YOU-03, PA-GRAMMAR-TUSI-HO-03]; assesses=[PA-LEX-KIVEIN-03, PA-LEX-YOU-REGISTER-02] -->
