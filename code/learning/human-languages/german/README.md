...
- **Chapter 14 — To Have**: *haben* — the four present forms the ending
...
- **Chapter 19 — Being Your Years**: *alt*, *das Jahr*, *Wie alt bist du?* and
...
- **Chapter 20 — Three Verbs Under One Roof**: *war/warst/waren*, the three
  Proto-Indo-European roots inside one infinitive, suppletion, and why the
  commonest words are the last to be regularised.
- **Chapter 21 — The Past That Takes To Be**: the *sein*-perfect —
  *kommen*, *fahren*, *werden*, *bleiben*, the learned list, and the
  participle that agrees with nothing where French has four forms.
- **Chapter 22 — Head and Hand**: *der Kopf*, *Haupt*, *die Hand*.
- **Chapter 23 — Yes and No**: *ja*, *nein*, and the negative-answer *doch*.
- **Chapter 24 — Please**: *Wasser, bitte* from previously learned words.
- **Chapter 25 — Sorry**: *Entschuldigung*, *es tut mir leid*.
- **Chapter 26 — Weather**: *das Wetter*, *es ist heiß/kalt*, *es regnet*.
- **Chapter 27 — Dog and Cat**: *Hund*, *Katze*.
- **Chapter 28 — Green and Yellow**: *grün*, *gelb*.
- **Chapter 29 — Verbs of the Mind**: *denken*, *verstehen*, *lesen*,
  *schreiben* — and the strong-verb vowel break (*du liest*).
- **Chapter 30 — Taking, Asking, Helping, Liking**: *nehmen*, *fragen*,
  *helfen*, *mögen/lieben* — and *gern*, German'''s third way of liking.
- **Chapter 31 — Sitting, Standing, Sleeping, Hearing**: *sitzen*, *stehen*,
  *schlafen*, *hören* — the second sound shift's *t*-branch, and a second way
  for a strong verb to break (*du schläfst*).
- **Chapter 32 — Going, Running, Opening, Closing**: *gehen*, *laufen*,
  *rennen*, *öffnen*, *schließen* — where German's walk/run line actually
  falls, and the first separable verbs (*Ich mache die Hand auf*).
- **Chapter 33 — Coffee, Tea, and Milk**: *der Kaffee*, *der Tee*, *die
  ...
  word.
- **Chapter 34 — Friend and Family**: *der Freund*, *die Freundin* (the
  native *-in* feminine suffix), *die Familie* (the one Latin loan in the
  chapter).
- **Chapter 35 — Eyes, Ears, Mouth, Nose**: *das Auge*, *das Ohr*, *der
  Mund*, *die Nase* — extends Chapter 22's body-part material to the rest of
  the face.
- **Chapter 36 — Arm, Finger, Foot, Heart**: *der Arm*, *der Finger*, *der
  Fuß*, *das Herz* — completes the five-word Hand/Arm/Finger/Fuß/Herz set
  Chapter 22 named but only a fifth of which it taught.

**All thirty-six chapters are authored and in the book (346 pages).**
...
**Twenty-eight of thirty-six chapters are atom-scored: 1–5 and 14–36.** Those
are exactly the chapters whose lessons have been migrated to schema version 2
and so declare real knowledge atoms. Chapters 6–13 are still schema v1 and carry
...
| 14 To Have | `GE-C14-practice` | 8 / 8 = 1.00 |
...
| 19 Being Your Years | `GE-C14-alter-practice` | 6 / 6 = 1.00 |
| 20 Three Verbs Under One Roof | `GE-C16-war-practice` | 7 / 7 = 1.00 |
| 21 The Past That Takes To Be | `GE-C16-haben-oder-sein` | 8 / 8 = 1.00 |
| 22 Head and Hand | `GE-C17-hand` | 4 / 12 = 0.33 — **below the floor** |
| 23 Yes and No | `GE-C18-nein` | 5 / 8 = 0.63 |
| 24 Please | `GE-C19-bitte-requests` | 3 / 3 = 1.00 |
| 25 Sorry | `GE-C20-entschuldigung` | 3 / 3 = 1.00 |
| 26 Weather | `GE-C21-das-wetter` | 5 / 5 = 1.00 |
| 27 Dog and Cat | `GE-C22-hund-katze` | 5 / 5 = 1.00 |
| 28 Green and Yellow | `GE-C23-gruen-gelb` | 5 / 5 = 1.00 |
| 29 Verbs of the Mind | `GE-C24-schreiben` | 10 / 10 = 1.00 |
| 30 Taking, Asking, Helping, Liking | `GE-C25-moegen-lieben` | 10 / 10 = 1.00 |
| 31 Sitting, Standing, Sleeping, Hearing | `GE-C26-hoeren` | 10 / 10 = 1.00 |
| 32 Going, Running, Opening, Closing | `GE-C27-schliessen` | 10 / 10 = 1.00 |
| 33 Coffee, Tea, and Milk | `GE-C28-milch` | 9 / 9 = 1.00 |
| 34 Friend and Family | `GE-C29-familie` | 9 / 9 = 1.00 |
| 35 Eyes, Ears, Mouth, Nose | `GE-C30-nase` | 12 / 12 = 1.00 |
| 36 Arm, Finger, Foot, Heart | `GE-C31-herz` | 12 / 12 = 1.00 |

Chapter 22 is the one authored chapter that fails. It runs three word lessons
...
real Kopf/Haupt/Hand practice lesson. Chapter 23 has the same missing-practice
shape but clears the floor because *nein* reassesses *ja*.

Chapters 29 and 30 close over **all** of their own atoms, and both payoffs also
reach back past their own chapter — chapter 29's to `GE-LEX-HAND-02`,
`GE-ETYMON-HAND-MANUS-05` and `GE-SOUND-GRIMMS-LAW-04` from chapter 22;
chapter 30's to all four of chapter 29's verbs plus `GE-LEX-HUND-02`,
...
Chapters 31 and 32 do the same and were written to drain it deliberately.
Chapter 31's payoff reaches to `GE-SOUND-GRIMMS-LAW-04` (ch. 22),
`GE-LEX-HUND-02`/`GE-ETYMON-HUND-03`/`GE-LEX-KATZE-04` (ch. 27) and all three
of chapter 30's closing atoms; chapter 32's reaches to `GE-LEX-NEHMEN-02`,
`GE-ETYMON-NEHMEN-03` and `GE-ETYMON-HELFEN-08` (ch. 30), `GE-LEX-HAND-02` and
`GE-SOUND-HAND-03` (ch. 22), and back into chapter 31. Six atoms that no lesson
...
Chapters 33–36 are the pre-A1 vocabulary tranche (fourteen nouns; see
CHANGELOG). All four payoffs close over their own chapter's atoms at 1.00
representativeness. Chapter 33's payoff also rescues chapter 32's two
never-revisited atoms, `GE-LEX-SCHLIESSEN-10` and `GE-ETYMON-SCHLIESSEN-11`;
chapter 35's rescues chapter 31's disputed `GE-ETYMON-HOEREN-10` "sharp-eared"
link, never revisited since it was flagged; chapter 36's reaches to chapters
10, 13, 22, 27 and 31 at once, completing the Hand/Arm/Finger/Fuß/Herz set
chapter 22 printed but only a fifth of which it taught.

## Reinforcement chaining (HL09 §7)

A chapter-end payoff cannot close the R1 window (n+1…n+3), so the reach-back
runs at two cadences. Every lesson in chapters 29–30 also names atoms from the
...
| `GE-C25-moegen-lieben` | all of chapters 29 and 30, plus chapters 26 and 27 |
...
| `GE-C26-hoeren` | all of chapter 31, plus chapters 22, 27 and 30 |
...
| `GE-C30-nase` | all of chapter 35, plus ch. 22 `GE-LEX-KOPF-02`/`GE-LEX-HAND-02` |
...
| `GE-C31-herz` | all of chapter 36, plus ch. 22 `GE-LEX-HAND-02`, ch. 27 `GE-ETYMON-HUND-03`, ch. 31 `GE-ETYMON-HOEREN-10` |
