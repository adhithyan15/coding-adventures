...
% canonical-source-hash: fnv1a64:93619aca6600398d
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\kn{ಇದು}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{kaṇṇu}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\kn{ಅದು}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} read \textbf{\kn{ಕಿವಿ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\kn{ಇಲ್ಲಿ}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{mūgu}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\kn{ಅಲ್ಲಿ}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} read \textbf{\kn{ಬಾಯಿ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\kn{ಯಾರು}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{hṛdaya}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\kn{ಎಲ್ಲಿ}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} read \textbf{\kn{ಚಹಾ}}
\end{itemize}
