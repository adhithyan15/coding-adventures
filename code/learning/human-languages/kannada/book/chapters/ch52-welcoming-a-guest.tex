...
% canonical-source-hash: fnv1a64:58434cd2b5719fca
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{bāgilu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{bāgilu}, then \emph{bāyi}, and hear the \emph{b} and the \emph{v} trade places
  \item \emph{Recall:} say \emph{īga}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kurci}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kuḷitukō}, then \emph{kurci} — the command, then the thing it needs
  \item \emph{Recall:} read \textbf{\kn{ನಾಡಿದ್ದು}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{raṅgōli}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{raṅgōli}, then \emph{dīpa}, and name the row inside each
  \item \emph{Recall:} say \emph{prayāṇa}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{hūvu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{hūvu}, then \emph{haṇṇu} and \emph{hallu}, three inherited words with one \emph{h} each
  \item \emph{Recall:} read \textbf{\kn{ಹೊರಡು}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{hūmāle}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{hūvu} and \emph{hūmāle} one after the other
  \item \emph{Recall:} say \emph{bīḷkoḍuge}
\end{itemize}
