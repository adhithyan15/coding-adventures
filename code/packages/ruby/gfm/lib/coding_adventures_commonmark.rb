...
# coding_adventures_gfm — GFM pipeline convenience package
#
...
#
# Spec: TE00 (Document AST), TE01 (GFM Parser), TE02 (Document AST to HTML)
...
module CodingAdventures
  # GFM pipeline — convenience wrapper over the parser and HTML renderer.
  #
  # Provides a simple two-step (or one-step) API for the most common use case:
  # converting a GitHub Flavored Markdown string to an HTML string.
  module Commonmark
    ...
    # Convert a GitHub Flavored Markdown string directly to an HTML string.
    #
