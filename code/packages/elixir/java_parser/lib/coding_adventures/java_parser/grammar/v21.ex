defmodule CodingAdventures.JavaParser.Grammar.V21 do
      ...
      rules: [
        ...
        %{
          ...
          body: {:sequence, [
            ...
            {:optional, {:sequence, [
                {:literal, "permits"},
                {:rule_reference, "permits_list", false},
              ]}},
        ...
        %{
          ...
          body: {:sequence, [
            ...
            {:rule_reference, "NAME", true},
            {:optional, {:rule_reference, "type_parameters", false}},
            {:rule_reference, "record_component_list", false},
            {:optional, {:sequence, [
                {:literal, "implements"},
                {:rule_reference, "interface_type_list", false},
              ]}},
        ...
        %{
          ...
          body: {:alternation, [
            ...
            {:sequence, [
              {:literal, "case"},
              {:rule_reference, "case_pattern", false},
              {:repetition, {:sequence, [
                  {:rule_reference, "COMMA", true},
                  {:rule_reference, "case_pattern", false},
                ]}},
        ...
        %{
          name: "case_pattern",
          body: {:sequence, [
            {:rule_reference, "primary_pattern", false},
            {:optional, {:sequence, [
                {:literal, "when"},
                {:rule_reference, "expression", false},
              ]}},
        ...
        %{
          ...
          body: {:alternation, [
            ...
            {:rule_reference, "type_pattern", false},
            {:rule_reference, "unnamed_pattern", false},
          ]},
          line_number: 1273,
        },
        %{
        ...
        %{
          ...
          body: {:sequence, [
            {:rule_reference, "class_type", false},
            {:rule_reference, "LPAREN", true},
            {:optional, {:rule_reference, "pattern_list", false}},
            {:rule_reference, "RPAREN", true},
          ]},
          line_number: 1293,
        },
        ...
        %{
          name: "pattern",
          body: {:rule_reference, "primary_pattern", false},
          line_number: 1300,
        },
        %{
        ...
        %{
          ...
          body: {:sequence, [
            ...
            {:repetition, {:alternation, [
                ...
                {:sequence, [
                  {:literal, "instanceof"},
                  {:rule_reference, "instanceof_target", false},
                ]},
              ]}},
          ]},
          line_number: 1624,
        ...
        %{
          ...
          body: {:alternation, [
            ...
            {:rule_reference, "TEXT_BLOCK", true},
