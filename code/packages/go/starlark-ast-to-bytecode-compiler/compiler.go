...
//
// Only comparable types (int, string, bool, float64, nil, etc.) are
// deduplicated. CodeObject, maps, and slices are not comparable in Go —
// comparing them with == would panic. Those always get a fresh slot.
