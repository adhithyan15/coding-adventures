# Build and run the aes-modes tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
$env:ISO_INCLUDE = "include ..\aes\include ..\gf256\include $harness\include"
. (Join-Path $harness 'lib\iso-lib.ps1')
Iso-BuildAndRun -Lang cpp -Name aes_modes-tests -Sources @("tests\aes_modes_test.cpp")
