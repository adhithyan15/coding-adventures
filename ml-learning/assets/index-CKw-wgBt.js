...
`)}_emitBlockItem(e,t){return e.children.length>0?this._emitNode(e.children[0],t):``}_emitDeclarationOrNested(e,t){return e.children.length>0?this._emitNode(e.children[0],t):``}_emitDeclaration(e,t){let n=``,r=``,i=``;for(let t of e.children){if(!Km(t))continue;let e=t;e.ruleName===`property`?n=this._emitProperty(e,0):e.ruleName===`value_list`?r=this._emitValueList(e,0):e.ruleName===`priority`&&(i=` !important`)}return this.minified?`${n}:${r}${i};`:`${n}: ${r}${i};`}_emitProperty(e,t){return e.children.length>0?e.children[0].value:``}_emitPriority(e,t){return`!important`}_emitValueList(e,t){let n=[];for(let r of e.children){let e=this._emitNode(r,t);n.push(e)}let r=n.join(` `);return r=r.replace(/ , /g,`, `).replace(/ ,/g,`,`),r}_emitValue(e,t){let n=e.children;if(n.length===1){let e=n[0];if(!Km(e)){let t=e;return qm(t)===`STRING`?`"${t.value}"`:t.value}return this._emitNode(e,t)}return this._emitDefault(e,t)}_emitFunctionCall(e,t){let n=e.children;if(n.length===1)return n[0].value;let r=[];for(let e of n)if(Km(e))r.push(this._emitNode(e,t));else{let t=e,n=qm(t);n===`FUNCTION`?r.push(t.value):n===`RPAREN`?r.push(`)`):r.push(t.value)}return r.join(``)}_emitFunctionArgs(e,t){let n=[];for(let r of e.children)n.push(this._emitNode(r,t));let r=n.join(` `);return r=r.replace(/ , /g,`, `).replace(/ ,/g,`,`),r}_emitFunctionArg(e,t){let n=e.children;if(n.length===1){let e=n[0];return Km(e)?this._emitNode(e,t):e.value}let r=[];for(let e of n)if(Km(e))r.push(this._emitNode(e,t));else{let t=e;r.push(qm(t)===`RPAREN`?`)`:t.value)}return r.join(``)}_emitDefault(e,t){let n=[];for(let r of e.children)n.push(this._emitNode(r,t));return n.join(` `)}};function Ym(e,t={}){let n=sp(e),r=new Gm().transform(n);return new Jm(t.indent??`  `,t.minified??!1).emit(r)}function Xm(e,t={}){return Ym(e,t)}var Zm=`$paper: #f7f8f3;
$ink: #17201c;
$muted: #5d6d68;
...
.reference-result--fail {
  background: rgba(187, 61, 61, 0.1);
  color: #9c3030;
}

.reference-protocol ol {
  display: grid;
  grid-template-columns: repeat(4, minmax(0, 1fr));
  gap: 9px;
  margin: 10px 0 0;
...
.reference-protocol li p {
  margin: 0;
  font-size: 0.75rem;
}

.reference-roster .panel-heading label {
  display: grid;
  gap: 5px;
  color: $muted;
  font-size: 0.7rem;
...
.reference-family-grid button[aria-pressed="true"] {
  border-color: rgba(109, 91, 208, 0.52);
  background: rgba(109, 91, 208, 0.09);
}

.reference-family-grid small,
.reference-family-grid span {
  color: $muted;
  font-size: 0.68rem;
}

.reference-family-grid strong {
  overflow-wrap: anywhere;
}

.reference-selected dl {
  display: grid;
  gap: 8px;
  margin: 11px 0 0;
}

.reference-selected dl > div {
  display: grid;
...
.reference-selected dt {
  color: $muted;
  font-size: 0.7rem;
  text-transform: uppercase;
}

.reference-selected dd {
  min-width: 0;
  margin: 0;
}
...
@media (max-width: 820px) {
  .reference-intro,
  .reference-paper .panel-heading,
  .reference-protocol .panel-heading,
  .reference-roster .panel-heading,
  .reference-selected .panel-heading {
    display: grid;
  }
...
.consumer-result {
  ...
  flex: 0 0 auto;
  border-radius: 999px;
  background: rgba(20, 116, 104, 0.09);
  color: #12695f;
  padding: 7px 10px;
  font-size: 0.72rem;
  font-weight: 700;
...
.consumer-products > div {
  ...
  gap: 7px;
  border-radius: 9px;
  background: rgba(20, 116, 104, 0.055);
  padding: 12px;
}

.consumer-products small,
.consumer-lane-grid small,
.consumer-lane-grid span {
  color: $muted;
  font-size: 0.68rem;
}
...
.consumer-lane-grid button[aria-pressed="true"] {
  border-color: rgba(20, 116, 104, 0.52);
  background: rgba(20, 116, 104, 0.09);
}

.consumer-selected dl {
  display: grid;
  gap: 8px;
  margin: 11px 0 0;
}

.consumer-selected dl > div {
  display: grid;
  grid-template-columns: 120px minmax(0, 1fr);
  gap: 8px;
  border-top: 1px solid $line;
...
.consumer-selected dt {
  color: $muted;
  font-size: 0.7rem;
  text-transform: uppercase;
}

.consumer-selected dd {
  min-width: 0;
  margin: 0;
}

.consumer-selected code,
.consumer-command {
  overflow-wrap: anywhere;
}
...
.consumer-protocol li > span {
  display: grid;
  width: 24px;
  height: 24px;
  place-items: center;
  border-radius: 50%;
  background: rgba(20, 116, 104, 0.15);
  color: #12695f;
  font-weight: 700;
}

.consumer-protocol li p {
  margin: 0;
  font-size: 0.75rem;
}
...
@media (max-width: 820px) {
  .consumer-intro,
  .consumer-paper .panel-heading,
  .consumer-lanes .panel-heading,
  .consumer-selected .panel-heading,
  .consumer-protocol .panel-heading {
    display: grid;
  }
...
`,Qm=`coding-adventures-lattice-styles`;function $m(){if(document.getElementById(Qm)===null)try{let e=document.createElement(`style`);e.id=Qm,e.textContent=Xm(Zm),document.head.append(e)}catch(e){console.error(`Failed to install Lattice styles`,e)}}$m(),(0,u.createRoot)(document.getElementById(`root`)).render((0,E.jsx)(l.StrictMode,{children:(0,E.jsx)(Bf,{})}));