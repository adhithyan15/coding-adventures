# Build and run the skip-list tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name skip_list-tests -Sources @("tests\skip_list_test.c", "src\skip_list.c")
