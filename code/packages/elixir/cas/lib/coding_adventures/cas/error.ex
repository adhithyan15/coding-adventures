defmodule CodingAdventures.Cas.Error do
  @moduledoc """
  Typed error reasons returned by `CodingAdventures.Cas.Store`.
  ...
  Useful for logging and error messages.
      ...
      iex> CodingAdventures.Cas.Error.format(:not_found)
      "object not found"

      iex> CodingAdventures.Cas.Error.format({:invalid_prefix, "xyz!"})
