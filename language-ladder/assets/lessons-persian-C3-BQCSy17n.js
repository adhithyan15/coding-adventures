...
`,l=e({default:()=>u}),u=`---
schema_version: 2
id: FA-C03-shoma-to-more
spine_node: SPINE-EXCHANGE-NAMES
sequence: 65
chapter: 3
type: etymology
headword: "(شما / تو, continued)"
romanization: "(shomâ / to, continued)"
gloss: "The word, taken apart"
concept_tag: FA-C03-SHOMA-TO-MORE
prerequisites: [FA-C03-shoma-to]
sounds: []
roots: []
duration:
  max_seconds: 150
requires:
  knowledge: [FA-LEX-SHOMA-TO]
introduces:
  knowledge: [FA-ETYMON-TO-THOU]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [FA-ETYMON-TO-THOU, FA-LEX-SHOMA-TO]
skills: [listening, speaking, reading]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral
variety: contemporary-iranian-persian
reviews_of: [FA-C03-shoma-to]
---
# (شما / تو, continued) — The word, taken apart

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[FA-LEX-SHOMA-TO] -->

[PAUSE 2s] Before going on: say **شما / تو** again, and what it means.
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[FA-ETYMON-TO-THOU] -->

[PAUSE 1s]
- [YOU SAY: what this lesson added to **شما / تو**, in one sentence]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[FA-ETYMON-TO-THOU] -->
<!-- hl-activity: {"id":"FA-C03-shoma-to-more-thou","kind":"text","assesses":["FA-ETYMON-TO-THOU"],"prompt":"Which old English word for 'you' is a relative of Persian to?","answer":"thou","accepted":["thee"],"feedback":{"correct":"Right: to, English thou, Latin tū and Sanskrit tvam are one family.","incorrect":"The relative is English thou, beside Latin tū and Sanskrit tvam."},"response_seconds":8} -->

[PAUSE 3s] What did this lesson add to **شما / تو**? Say it once more, without
looking.
`,d=e({default:()=>f}),f=`---
schema_version: 2
id: FA-C03-shoma-to
...
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: [FA-CULTURE-WELLBEING-CAREFUL-EVERYDAY-01]
practises:
...
`,k=e({default:()=>A}),A=`---
schema_version: 2
id: FA-C05-khodahafez-more
spine_node: SPINE-TAKE-LEAVE
sequence: 195
chapter: 5
type: grammar
headword: "(خداحافظ, continued)"
romanization: "(khodâ hâfez, continued)"
gloss: "Grammar Lens — a complete wish without a full sentence"
concept_tag: FA-C05-KHODAHAFEZ-MORE
...
duration:
  max_seconds: 150
requires:
  knowledge: [FA-LEX-KHODAHAFEZ]
introduces:
  knowledge: [FA-GRAMMAR-KHODAHAFEZ-ELLIPSIS, FA-PRAGMATICS-STANDARD-FAREWELL]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [FA-GRAMMAR-KHODAHAFEZ-ELLIPSIS, FA-PRAGMATICS-STANDARD-FAREWELL, FA-LEX-KHODAHAFEZ]
skills: [listening, speaking, reading]
modes: [interpretive, presentational]
strands: [meaning-input, language-focus]
register: neutral
variety: contemporary-iranian-persian
reviews_of: [FA-C05-khodahafez]
---
# (خداحافظ, continued) — Grammar Lens — a complete wish without a full sentence

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[FA-LEX-KHODAHAFEZ] -->

[PAUSE 2s] Before going on: say **خداحافظ** again, and what it means.
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[FA-GRAMMAR-KHODAHAFEZ-ELLIPSIS, FA-PRAGMATICS-STANDARD-FAREWELL] -->

[PAUSE 1s]
- [YOU SAY: what this lesson added to **خداحافظ**, in one sentence]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[FA-GRAMMAR-KHODAHAFEZ-ELLIPSIS, FA-PRAGMATICS-STANDARD-FAREWELL] -->
<!-- hl-activity: {"id":"FA-C05-khodahafez-more-goodbye","kind":"text","assesses":["FA-PRAGMATICS-STANDARD-FAREWELL"],"prompt":"Type the everyday Persian way to say goodbye.","answer":"خداحافظ","accepted":["khodâ hâfez","khodahafez"],"feedback":{"correct":"Right: خداحافظ closes the conversation.","incorrect":"Use خداحافظ — khodâ hâfez."},"response_seconds":9} -->

[PAUSE 3s] What did this lesson add to **خداحافظ**? Say it once more, without
looking.
`,j=e({default:()=>M}),M=`---
schema_version: 2
