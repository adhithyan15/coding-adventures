...
% canonical-source-hash: fnv1a64:c21c1d40fc096369
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{agniḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{āśīrvādaḥ}, then \emph{agniḥ}
  \item \emph{Recall:} say \emph{api}, then read \textbf{\sk{शान्तिः}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{bhasma}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{agniḥ}, then \emph{bhasma}
  \item \emph{Recall:} read \textbf{\sk{सर्वम्}}, then say \emph{sādaram}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{śilā}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{bhasma}, then \emph{śilā}
  \item \emph{Recall:} say \emph{tathā}, then read \textbf{\sk{प्रसन्नः}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{sikatā}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{śilā}, then \emph{sikatā}
  \item \emph{Recall:} read \textbf{\sk{मन्दम्}}, then say \emph{abhinandanam}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{mṛttikā}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{agniḥ} and \emph{mṛttikā} together
  \item \emph{Recall:} say \emph{samyak}, then read \textbf{\sk{आशीर्वादः}}
\end{itemize}
