...
// Regenerate with: grammar-tools compile-combined mosstyle.tokens mosstyle.grammar
//
...
pub fn token_grammar() -> TokenGrammar {
    TokenGrammar {
        ...
        keywords: vec![r#"style"#.to_string(), r#"part"#.to_string(), r#"state"#.to_string(), r#"transition"#.to_string()],
        mode: None,
    ...
    ParserGrammar {
        ...
        GrammarRule {
            ...
            body: GrammarElement::Alternation { choices: vec![
                ...
                GrammarElement::RuleReference { name: r#"transition_decl"#.to_string() },
        ...
        GrammarRule {
            ...
            body: GrammarElement::Sequence { elements: vec![
                ...
                GrammarElement::TokenReference { name: r#"NAME"#.to_string() },
                GrammarElement::TokenReference { name: r#"LBRACE"#.to_string() },
                GrammarElement::Repetition { element: Box::new(GrammarElement::RuleReference { name: r#"state_item"#.to_string() }) },
                GrammarElement::TokenReference { name: r#"RBRACE"#.to_string() },
            ] },
            line_number: 88,
        },
        ...
        GrammarRule {
            ...
            body: GrammarElement::Sequence { elements: vec![
                ...
                GrammarElement::Optional { element: Box::new(GrammarElement::RuleReference { name: r#"style_value"#.to_string() }) },
