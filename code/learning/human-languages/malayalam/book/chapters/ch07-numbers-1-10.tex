...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Of all the Dravidian cousins, Malayalam is Tamil's closest — they were one language a thousand years ago — and its numbers show it.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: "onnu, raṇṭu, mūnnu, nālu, añcu"{]}
  \item {[}YOU SAY: the near-identity — "oṉṟu $\leftrightarrow$ onnu", "iraṇṭu $\leftrightarrow$ raṇṭu"{]}
  \item {[}YOU SAY: the one that shifted — "aintu $\to$ añcu"{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} Count to five in Malayalam. (\emph{Onnu, raṇṭu, mūnnu, nālu, añcu}.) Does Malayalam's \textbf{one} follow Tamil or break away like Telugu? (\textbf{Follows Tamil} — \emph{onnu} $\leftrightarrow$ \emph{oṉṟu}.) Which number changed most from Tamil, and how? (\textbf{Five} — \emph{aintu}'s \emph{nt} palatalised to \emph{añcu}.) What does the \textbf{chandrakkala} \ml{്} do to a word's last sound? (Trims its vowel to a half-heard \emph{ŭ}.) Next: six to ten.
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Malayalam holds onto a Tamil sound the other cousins let go — and you'll hear it in seven.
\end{quote}
...
\begin{cousinweb}
\textbf{Nine} comes, exactly as in Tamil, from the old \emph{oṉ} ("one") + \emph{patu} ("ten") — one short of ten. But before the \emph{p}, the \emph{n} shifts to an \textbf{m}: so the underlying \emph{oṉpatu} is both \textbf{written \ml{ഒമ്പത്}} and \textbf{said \emph{ompatu}} (say "onpatu" fast and you'll do it yourself). Kannada does the same in \emph{ombattu}.
\end{cousinweb}
