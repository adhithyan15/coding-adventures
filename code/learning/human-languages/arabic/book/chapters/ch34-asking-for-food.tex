...
% canonical-source-hash: fnv1a64:a229bdaa799395ed
% canonical-lessons: AR-C34-milh, AR-C34-lahm, AR-C34-jubn, AR-C34-taam, AR-R34-pardon-and-until-tomorrow
...
\end{tcolorbox}
\section[ʿafwan · ilā l-ghad · tuṣbiḥ ʿalā khayr]{Pardon, and until tomorrow}

\label{lesson:AR-R34-pardon-and-until-tomorrow}



\begin{quote}
Say \emph{see you tomorrow} and \emph{good night} in Arabic. Each was taught in a single lesson and neither has come back. Then say what the second one literally wishes you.
\end{quote}

\subsection*{You'll want to know: one word, several jobs}
\textbf{\ar{عفوا}} \emph{ʿafwan} answers \emph{shukran} as \textbf{you are welcome}. But the same word, on a different tone, does duty as \textbf{excuse me} and as \textbf{pardon} — somebody stepping past you in a corridor says it, and so does somebody who did not quite hear you.

One word, three jobs, and the root explains all three: \textbf{ʿ-f-w} is about \textbf{erasing}. Whatever was owed or intruded upon is wiped off.

\subsection*{You'll want to know: until tomorrow}
\textbf{\ar{إلى} \ar{الغد}} \emph{ilā l-ghad} is the farewell pattern you already own with a new word in the slot: \textbf{\ar{إلى}} (\emph{until}) — the very same \emph{ilā} as in \emph{ilā l-liqāʾ} — plus \textbf{\ar{الغد}}, tomorrow.

The root \textbf{gh-d-w} means \textbf{to set out at dawn}. Arabic's \emph{tomorrow} therefore grows out of \emph{early morning}: the next day is named after the hour you start it.

\begin{culture}
\textbf{\ar{تصبح} \ar{على} \ar{خير}} \emph{tuṣbiḥ ʿalā khayr} is the everyday \textbf{good night} — and it wishes you nothing whatever about the night.

Literally it is \textbf{may you wake up into goodness}. English, French, German and Spanish all wish the sleeper a peaceful \emph{night}; Arabic looks straight past it to the morning on the other side. \emph{Tuṣbiḥ} carries the same root as the morning greeting, and \textbf{\ar{خير}} is the goodness you already answer \emph{how are you} with.

So the two halves of the phrase are borrowed from two things you met long before bedtime came up at all.
\end{culture}

\subsection*{Script: the throat letter and the loop}
Write these out:

\begin{itemize}
\raggedright
  \item \textbf{\ar{ع}} — the open-mouth curve, then the bowl beneath it
  \item \textbf{\ar{عفوا}}, then \textbf{\ar{على}} — the same letter opening both
\end{itemize}

\textbf{\ar{ع}} \emph{ʿayn} is a curve above a bowl, and it heads a \textbf{third} dots-family, with \textbf{\ar{غ}} \emph{ghayn} as its dotted partner. It sits at the front of two of the three phrases on this page.

\textbf{\ar{ه}} \emph{hāʾ} is the shape-shifter: one loop, no dots, four different coats by position. Its dotted relative \textbf{\ar{ة}} is the tied \emph{tāʾ} that closes feminine words.

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Name two jobs \textbf{\ar{عفوا}} does besides \emph{you are welcome}. (\textbf{Excuse me} and \textbf{pardon}.) Give the literal sense of the root behind \emph{tomorrow}. (\textbf{To set out at dawn}.) Say what \textbf{\ar{تصبح} \ar{على} \ar{خير}} actually wishes. (\textbf{That you wake into goodness} — the morning, not the night.) And name \textbf{\ar{ع}}'s dotted partner. (\textbf{\ar{غ}}.)
\end{tcolorbox}
