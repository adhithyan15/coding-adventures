...
pub use simulator::{
    ...
    HOST_ECALL_F64_CMP, HOST_ECALL_F64_DIV, HOST_ECALL_F64_FLOOR, HOST_ECALL_F64_MUL,
    HOST_ECALL_F64_SUB, HOST_ECALL_F64_TO_I64_TRUNC, HOST_ECALL_I64_TO_F64,
    HOST_ECALL_FLOAT_CONVERSION_FAULT_EXIT_CODE, HOST_ECALL_READ_BYTE, HOST_ECALL_SERVICE_REGISTER,
    HOST_ECALL_WRITE_BYTE, HOST_ECALL_WRITE_F64, HOST_ECALL_WRITE_I64,
};
