#!/bin/sh
# Build and run the jvm-simulator tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp jvm_simulator-tests tests/jvm_simulator_test.cpp
