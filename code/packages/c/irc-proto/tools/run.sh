#!/bin/sh
# Build and run the irc-proto tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c irc_proto-tests tests/irc_proto_test.c src/irc_proto.c
