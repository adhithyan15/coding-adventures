...
\noindent\begin{minipage}[t]{\linewidth}
\raggedright
\textbf{\pa{ਕਿਵੇਂ}}\enspace\emph{kivēṁ}\par
\small how\par
...
\noindent\begin{minipage}[t]{\linewidth}
\raggedright
\textbf{\pa{ਕੋਈ} \pa{ਗੱਲ} \pa{ਨਹੀਂ}}\enspace\emph{koī gall nahīṁ}\par
\small it is nothing; no problem; you are welcome\par
\footnotesize Introduced in Chapter 3.
\end{minipage}\par\medskip
...
\noindent\begin{minipage}[t]{\linewidth}
\raggedright
\textbf{\pa{ਮੈਂ}}\enspace\emph{maiṁ}\par
\small I\par
\footnotesize Introduced in Chapter 3.
\end{minipage}\par\medskip
...
\noindent\begin{minipage}[t]{\linewidth}
\raggedright
\textbf{\pa{ਠੀਕ}}\enspace\emph{ṭhīk}\par
\small fine, well — and the reply maiṁ ṭhīk hāṁ\par
\footnotesize Introduced in Chapter 3.
\end{minipage}\par\medskip
...
\noindent\begin{minipage}[t]{\linewidth}
\raggedright
\textbf{\pa{ਤੁਸੀਂ} \pa{ਕਿਵੇਂ} \pa{ਹੋ}?}\enspace\emph{tusī̃ kivēṁ ho?}\par
