#!/bin/sh
# Build and run the type-declarations tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp type_declarations-tests tests/type_declarations_test.cpp
