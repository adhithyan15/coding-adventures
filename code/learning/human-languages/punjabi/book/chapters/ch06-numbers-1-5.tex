...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}ikk, do, tinn, chār, panj\textquotedblright{}{]}
  \item {[}YOU SAY: the two marks — \textquotedblleft{}\textbf{addak} doubles, \textbf{tippi} nasalises\textquotedblright{}{]}
  \item {[}YOU SAY: the Ch. 5 callback — \textquotedblleft{}\textbf{panj} + \textbf{āb} = five rivers\textquotedblright{}{]}
\end{itemize}
