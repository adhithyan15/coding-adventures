...
% canonical-source-hash: fnv1a64:079835a614667e60
...
This is the second component you have met that carries meaning rather than sound, and the pair is worth holding together:
...
This is new, and it is not a quirk. Mandarin builds a great many words by \textbf{saying a piece twice}, and doubling usually softens something — it makes an action smaller, lighter, more everyday. A single \zh{谢} is closer to \emph{to thank}, the bare idea. \textbf{\zh{谢谢}} is the ordinary thing you say to a person who handed you something.
\end{cousinweb}
...
That is the useful lesson: \textbf{the light syllable is not a property of the character, it is a property of the position.} \zh{谢} falls on the left and goes light on the right, in the same word, on the same day. {[}REPEAT x2{]}
