...
describe("book chapter modality projection", () => {
  ...
  it("covers all 523 generated and handwritten chapter openings in all 22 books", () => {
    ...
    expect(ledgers.flatMap((track) => track.chapters)).toHaveLength(698); // +4: HL-C98 // +15: vocabulary wave 5 // +4: HL-C88 slices 5-6 // +3: HL-C88 slice 8 // +12: vocabulary wave 6 // +3: HL-C113 (B1 si-condition rung)
