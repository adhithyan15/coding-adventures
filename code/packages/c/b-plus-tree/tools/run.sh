#!/bin/sh
# Build and run the b-plus-tree tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c b_plus_tree-tests tests/b_plus_tree_test.c src/b_plus_tree.c
