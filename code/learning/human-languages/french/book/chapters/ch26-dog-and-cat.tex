...
% canonical-source-hash: fnv1a64:5ae4598d24c307d1
% canonical-lessons: FR-C22-chien-chat, FR-C22-chien-chat-more
...
\end{tcolorbox}
\section[(chien, chat, continued)]{(chien, chat, continued) — chat}

\label{lesson:FR-C22-chien-chat-more}



\begin{quote}
Before going on: say \textbf{chien, chat} again, and what it means.
\end{quote}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} what this lesson added to \textbf{chien, chat}, in one sentence
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What did this lesson add to \textbf{chien, chat}? Say it once more, without looking.
\end{tcolorbox}
