...
% canonical-source-hash: fnv1a64:27ead68c9c3c8f4e
...
\section[unakku ettanai vayathu aakirathu?]{\ta{உனக்கு} \ta{எத்தனை} \ta{வயது} \ta{ஆகிறது}? (unakku ettanai vayathu aakirathu?) — Tamil actually has BOTH shapes}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}vayathu\textquotedblright{} — age — then the whole formal question, \textquotedblleft{}unakku ettanai vayathu aakirathu?\textquotedblright{}
...
\end{tcolorbox}
\section[un vayasu enna? / unakku ettanai …]{Your age what? / To you how many years becomes?}
