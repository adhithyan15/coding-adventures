...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3403, // +2: Tamil and French each add a guided-copy bridge.
      ...
      voice: 2461, // Tamil and French now expose their opener pen dependencies.
      ...
      pen: 352, // +4: Tamil and French each add observe-trace and guided-copy steps.
      ...
      drivableLessons: 2461, // Tamil and French openers leave the hands-free set.
      ...
      // French Chapter 1 now begins with pen, so its former eight-lesson voice
      ...
      unstartableChapters: 214, // Tamil and French Chapter 1 now honestly start with pen.
      overriddenLessons: 0,
