#!/bin/sh
# Build and run the segment-tree tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c segment_tree-tests tests/segment_tree_test.c src/segment_tree.c
