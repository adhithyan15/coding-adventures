...
|---|---|---|
| Twig | `42`, variadic arithmetic, top-level value `define`, and typed E4 string literal/named/local/function-call/annotated-parameter/direct-call-inferred-parameter proofs from literal, named, lexical, and derived sequential `let*` actuals, including substring/index and lexical ordering | rich Lisp frontend; lists/lambdas/dynamic globals/records/symbols still need E5/E6, and captured/reassigned/unobserved or conflicting parameter strings stay on the dynamic path |
...
- ✅ **TW4** — typed E4 strings on code-gen backends. Direct literals,
  ...
  parameter typing from literal, named top-level, lexical, and derived
  sequential `let*` actuals across
