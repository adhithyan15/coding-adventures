...
% canonical-source-hash: fnv1a64:6efb56609368a7a4
% canonical-lessons: ML-C31-shubha-madhyaahnam, ML-C31-oonjaal, ML-S125-letter-uu, ML-C31-afternoon-convergence
...
\end{tcolorbox}
\section[ūññāl]{\ml{ഊഞ്ഞാൽ} (ūññāl) — a swing}

\label{lesson:ML-C31-oonjaal}
...
\subsection*{You'll want to know: \ml{ഊഞ്ഞാൽ}}
\textbf{\ml{ഊഞ്ഞാൽ}} — \emph{ūññāl} — \textquotedblleft{}a swing\textquotedblright{}.

Say it: \emph{ūññāl}. Look at its shape as you say it: the next lesson takes one piece of it, \textbf{\ml{ഊ}}, and writes it on its own.
...
\raggedright
  \item \emph{ūññāl}
  \item \emph{ūññāl}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}a swing\textquotedblright{}? (\textbf{\ml{ഊഞ്ഞാൽ}}, \emph{ūññāl}.)
\end{tcolorbox}
...
\hlblockfigure{\detokenize{figures/ML-S125-letter-uu-filmstrip.pdf}}{How \ml{ഊ} is written, stroke by stroke}
