...
Last prioritized: 2026-08-08, after merging #10150 and starting HL-C70.
...
`nuestro`/`nuestra` stay inside that same closed frontier. HL-C70 is now the
active slice: Spanish Chapter 12 keeps `hacer`, `decir`, and the first `yo`-go
comparison away from later club members and untaught weather or homework
vocabulary. The audit queued HL-C71 next so Chapter 13 introduces `poner`,
