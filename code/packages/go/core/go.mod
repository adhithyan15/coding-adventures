module github.com/adhithyan15/coding-adventures/code/packages/go/core

go 1.26

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/branch-predictor v0.0.0
	...
	github.com/adhithyan15/coding-adventures/code/packages/go/cpu-pipeline v0.0.0
	github.com/adhithyan15/coding-adventures/code/packages/go/cpu-simulator v0.0.0
	github.com/adhithyan15/coding-adventures/code/packages/go/hazard-detection v0.0.0
)
