...
- PSS Newton iteration helpers across Python, TypeScript, and Rust SPICE
  ...
  circuits have landed. This follow-up gates one candidate update by residual
  L2 improvement and reports the retained circuit/state for the next shooting
  step.
