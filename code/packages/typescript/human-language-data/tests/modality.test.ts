...
describe("corpus regression", () => {
  ...
  it("pins the core as strictly better than the whole, now that writing segments exist", () => {
    ...
    expect(summary.lessonsWithWritingSegments).toBe(47); // HL12: +30 recognition segments (telugu/kannada/malayalam 8 each, sanskrit 6). Each carries a detachable tracing block, so the hands-free view keeps the rest of the lesson // HL12 payment two: +8 Hindi segments
