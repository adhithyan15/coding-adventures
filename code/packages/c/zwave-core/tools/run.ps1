# Build and run the zwave-core tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name zwave_core-tests -Sources @("tests\zwave_core_test.c", "src\zwave_core.c")
