...
% canonical-source-hash: fnv1a64:ae00c80cf08e8984
...
\textbf{\ml{അമ്മ} ends in a vowel, and that is why it takes -\ml{യുടെ}.} \ml{അധ്യാപകൻ} ends in a consonant, so it took the other one.
...
\midrule
\textbf{\ml{അധ്യാപകൻ}}, ending in a consonant & \textbf{-\ml{ന്റെ}} \\
\textbf{\ml{അമ്മ}}, ending in a vowel & \textbf{-\ml{യുടെ}} \\
\bottomrule
\end{tabularx}

\textbf{Two nouns, two landings — and not the whole story.} Malayalam has more than these two, and this book will show you another before long. What holds already is the shape of the question: \textbf{you do not choose between them.} The noun in front does, and it decides by its last sound rather than by anything you mean. So the question to ask is never \emph{which ending do I want} — it is \emph{what does this word end in}.
\end{grammarlens}
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which ending does \textbf{\ml{അമ്മ}} take, and why? (\textbf{-\ml{യുടെ}} — it ends in a vowel.) How do you say \emph{mother's book}? (\emph{\textbf{\ml{അമ്മയുടെ} \ml{പുസ്തകം}}}.) And who picks the ending — you, or the noun? (\textbf{The noun}.)
\end{tcolorbox}
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which ending does \textbf{\ml{അധ്യാപകൻ}} take? (\textbf{-\ml{ന്റെ}}.) And \textbf{\ml{അമ്മ}}? (\textbf{-\ml{യുടെ}}.) What decides it? (\textbf{The noun's last sound} — never you.) And what does either one do to the noun it lands on? (\textbf{Makes it the owner}.)
\end{tcolorbox}
