# Build and run the resp-protocol tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name resp_protocol-tests -Sources @("tests\resp_protocol_test.cpp")
