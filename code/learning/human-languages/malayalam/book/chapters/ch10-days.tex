...
% canonical-source-hash: fnv1a64:0b43762667f6fddd
% canonical-lessons: ML-C10-azhcha, ML-S05-letter-na
...
\section[tiṅkaḷ covva budhan vyāzham veḷḷi śani …]{\ml{തിങ്കൾ} to \ml{ഞായർ} — the week Malayalam shares with Tamil}
...
\midrule
\textbf{\ml{തിങ്കളാഴ്ച}} & \emph{tiṅkaḷ} & \textquotedblleft{}\textbf{Moon}\textquotedblright{} & \emph{thiṅgaḷ} — nearly identical \\
...
\begin{culture}
This is the closest family match anywhere in Dravidian: \textbf{tiṅkaḷ/thiṅgaḷ}, \textbf{veḷḷi/veḷḷi}, and \textbf{ñāyar/ñāyiṟu} are essentially \textbf{the same words}, because Malayalam only became a distinct language from Tamil within roughly the last thousand years or so. Tamil builds its weekday names with \textbf{\ta{கிழமை}} (\emph{kizhamai}, \textquotedblleft{}day of the week\textquotedblright{}), while Malayalam builds them with \textbf{\ml{ആഴ്ച}} (\emph{āḻca}, \textquotedblleft{}week\textquotedblright{}). The two words are not confirmed cognates; treat them as two languages solving the same naming problem separately, not necessarily as one shared root. Like Tamil, Malayalam mixes \textbf{native} planet-words (Moon, Mars, Venus, Sun) with \textbf{Sanskrit} ones (Mercury, Jupiter, Saturn) — the same split, inherited from the same shared ancestor language.
\end{culture}
...
\begin{itemize}
\raggedright
  \item \textquotedblleft{}tiṅkaḷ\textquotedblright{} — moon — then \textquotedblleft{}āḻca,\textquotedblright{} week
