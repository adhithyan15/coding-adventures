...
% canonical-source-hash: fnv1a64:ec9458b8b7a5102b
...
No \emph{per} and no \emph{to}: use \textbf{sapere} with the plain infinitive. \emph{So parlare} says what \emph{parlo} does not — that you learnt it.
...
\textbf{Three — scepticism.} A bare, slow \textbf{Non so …} with the sentence left hanging is how an Italian expresses doubt about the previous statement. It is the politest disagreement in the language, and it is a great deal gentler than \emph{non sono d'accordo}.
