# Bengali / বাংলা — Reference

A **reference**, not a chapter — the lessons teach reading through real words.
This page gathers the system and flags what is special about the **Bengali
script** and Bengali sounds.

## How the Bengali script works (the three facts)

1. **Consonants carry a built-in vowel — and it is ô, not "a".** ক = kô, ন = nô,
   ম = mô — written left to right under a connecting top line, like Devanagari
   but with rounder shapes. This single fact (*a→ô*) is why Sanskrit words sound
   "Bengali."
2. **A vowel sign changes it:** কা kā · কি ki · কী kī · কু ku · কে ke · কো ko.
   The *i*-signs ি / ী are written *before* the consonant but read *after* it. A
   *chandrabindu* ঁ nasalises the vowel.
3. **Standalone vowels have their own letters:** আ ā · অ ô · ই i · উ u · এ e · ও
   o — used when a word starts with a vowel.

## What is special about Bengali sounds
