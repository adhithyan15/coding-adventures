...
// ============================================================================
// Package.swift — MOSFET and BJT transistor physics simulation — the semiconductor devices that implement every logic gate
// ============================================================================
//
...
let package = Package(
    name: "transistors",
    products: [
        .library(name: "Transistors", targets: ["Transistors"]),
    ],
    targets: [
        .target(
            name: "Transistors"
        ...
        .testTarget(
            name: "TransistorsTests",
            dependencies: ["Transistors"]
        ),
    ]
)
