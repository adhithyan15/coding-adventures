...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}ho, hai, ha, abbiamo, avete, hanno\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}Ho un fratello\textquotedblright{} (\textquotedblleft{}I have a brother\textquotedblright{}) — Ch. 10's family{]}
  \item {[}YOU SAY: the pair — \textquotedblleft{}\textbf{hanno} they have · \textbf{anno} a year\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}Abbiamo pane e vino\textquotedblright{} — Ch. 11's food{]}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}Quanti anni hai?\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}Ho venti anni\textquotedblright{} — hold the \textbf{nn}{]}
  \item {[}YOU SAY: your own age, using Ch. 12's numbers{]}
  \item {[}YOU SAY: the pair aloud — \textquotedblleft{}\textbf{hanno} … \textbf{anno}\textquotedblright{} — identical sound{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} Which verb does Italian use for age? (\emph{\textbf{Avere}}, never \emph{essere}.) What does \emph{ho venti anni} literally say? (\textquotedblleft{}I \textbf{have} twenty years.\textquotedblright{}) Where does \emph{anno} come from? (Latin \emph{\textbf{annus}} $\to$ \emph{annual/anniversary}.) What separates \emph{hanno} from \emph{anno}? (\textbf{Only the silent h} — they sound identical.) Which two languages say \textquotedblleft{}I \textbf{am}\textquotedblright{} instead? (\textbf{German and English}.)
\end{tcolorbox}
