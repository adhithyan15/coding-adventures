...
export function encodeModule(module) {
    ...
    if (module.types.length > 0)
        sections.push(section(1, vector(module.types, encodeFuncType)));
    if (module.imports.length > 0)
        sections.push(section(2, vector(module.imports, encodeImport)));
    if (module.functions.length > 0)
        sections.push(section(3, vector(module.functions, u32)));
    if (module.tables.length > 0)
        sections.push(section(4, vector(module.tables, encodeTableType)));
    if (module.memories.length > 0)
        sections.push(section(5, vector(module.memories, encodeMemoryType)));
    if (module.globals.length > 0)
        sections.push(section(6, vector(module.globals, encodeGlobal)));
    if (module.exports.length > 0)
        sections.push(section(7, vector(module.exports, encodeExport)));
    if (module.start !== null)
        sections.push(section(8, u32(module.start)));
    if (module.elements.length > 0)
        sections.push(section(9, vector(module.elements, encodeElement)));
    if (module.code.length > 0)
        sections.push(section(10, vector(module.code, encodeFunctionBody)));
    if (module.data.length > 0)
        sections.push(section(11, vector(module.data, encodeDataSegment)));
...
function vector(values, encoder) {
...
function encodeImport(importValue) {
    const parts = [
    ...
    switch (importValue.kind) {
        ...
        case ExternalKind.TABLE:
            parts.push(encodeTableType(importValue.typeInfo));
            break;
        case ExternalKind.MEMORY:
            parts.push(encodeMemoryType(importValue.typeInfo));
            break;
        case ExternalKind.GLOBAL:
            parts.push(encodeGlobalType(importValue.typeInfo));
            break;
        default:
...
//# sourceMappingURL=wasm_module_encoder.js.map