...
## Unreleased — the बच्चा lesson now declares its full taught family

Chapter 39 already teaches and assesses feminine **बच्ची** beside masculine
**बच्चा**, then contrasts both with inherited **बछड़ा** (“calf”) to explain the
shared Indo-Iranian history. Its headword now declares **बच्चा / बच्ची / बछड़ा**,
making the practised gender pair and inherited cousin visible to reports and
generated study artifacts.

## Unreleased — Hindi's written marks now declare their taught names

The Chapter 2 writing sequence already teaches **विराम** and everyday **हलंत**
as names for **्**, and teaches **पूर्ण विराम** as the name for **।**. Learners
produce and recall those terms, but both lesson headwords previously declared
only the glyphs. The headwords now pair each mark with its taught Hindi names,
making the terminology visible to reports and generated study artifacts.

## Unreleased — formal आयु joins everyday उम्र

Chapter 19 already defines **आयु** as the formal or literary Sanskrit-derived
alternative to everyday Perso-Arabic **उम्र**, asks learners to contrast the two
registers, and assesses the alternative in wrap-up recall. The headword now
declares **उम्र / आयु**, exposing both taught choices to reports and generated
study artifacts.
