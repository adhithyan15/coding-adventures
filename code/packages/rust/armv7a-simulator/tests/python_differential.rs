...
fn seeded_state(cpu: &Armv7ASimulator, raw: &[u8], seed: usize) -> Armv7AState {
...
fn python_full_state_corpus_matches() {
        ...
        .filter(|line| !line.starts_with('#'))
    {
        ...
        cpu.restore(&seeded_state(&cpu, &raw, seed))
    ...
    assert_eq!(count, 417, "corpus must retain every generated vector");
}
