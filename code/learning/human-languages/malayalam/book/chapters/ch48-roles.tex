...
% canonical-source-hash: fnv1a64:a52406c68e38d9f1
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{adhyāpakan}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{adhyāpakan}, then \emph{makan}, and hear the same chillu close both
  \item \emph{Recall:} say \emph{paḻaṁ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vidyārtthi}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{adhyāpakan}, then \emph{vidyārtthi}, the pair that need each other
  \item \emph{Recall:} read \textbf{\ml{തുണി}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vaidyan}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{vidyārtthi}, then \emph{vaidyan}, and find the piece they share
  \item \emph{Recall:} say \emph{viḷakkŭ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{karṣakan}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{karṣakan}, then \emph{adhyāpakan}, and count the chillus in each
  \item \emph{Recall:} read \textbf{\ml{ഉപ്പ്}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{adhyāpakan}, \emph{vidyārtthi}, \emph{vaidyan}, \emph{karṣakan}, \emph{atithi}
  \item \emph{Recall:} say \emph{pustakaṁ}
\end{itemize}
