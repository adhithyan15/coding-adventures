...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}um, dois, três, quatro, cinco\textquotedblright{} — count up{]}
  \item {[}YOU SAY: the gendered two — \textquotedblleft{}dois cafés\textquotedblright{} (masc.) / \textquotedblleft{}duas cervejas\textquotedblright{} (fem.){]}
  \item {[}YOU SAY: each with its English cousin — \textquotedblleft{}dois/duo, três/trio, cinco/quintet\textquotedblright{}{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} Give 1–5 in Portuguese. (\emph{Um, dois, três, quatro, cinco}.) Which number still changes for gender, and how? (\emph{Two} — \emph{dois} / \emph{duas}, $\leftarrow$ Latin \emph{duo/duae}.) What does \emph{um/uma} mean besides \textquotedblleft{}one\textquotedblright{}? (\textquotedblleft{}A/an.\textquotedblright{}) Next: \textbf{6–10}, where a Portuguese sound-shift is on full display.
\end{tcolorbox}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}seis, sete, oito, nove, dez\textquotedblright{} — finish the count{]}
  \item {[}YOU SAY: \textquotedblleft{}sete/setembro, oito/outubro, nove/novembro, dez/dezembro\textquotedblright{}{]}
  \item {[}YOU SAY: the \emph{-ct- $\to$ -it-} set — \textquotedblleft{}oito, noite, leite\textquotedblright{} — then Spanish \textquotedblleft{}ocho\textquotedblright{}{]}
\end{itemize}
