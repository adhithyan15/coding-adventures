...
\expandafter\def\csname hlchaptermodality6\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (4) \quad \hlpensign{}~\textbf{pen} (5)\quad
...
\expandafter\def\csname hlchaptermodality7\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (3) \quad \hlsightsign{}~\textbf{eyes} (1) \quad \hlpensign{}~\textbf{pen} (16)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 1 of 20 lessons.%
    \par}\medskip
}

\expandafter\def\csname hlchaptermodality8\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (2) \quad \hlsightsign{}~\textbf{eyes} (1) \quad \hlpensign{}~\textbf{pen} (7)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 2 of 10 lessons.%
    \par}\medskip
}
...
\expandafter\def\csname hlchaptermodality11\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlsightsign{}~\textbf{eyes} (1) \quad \hlpensign{}~\textbf{pen} (1)\quad
