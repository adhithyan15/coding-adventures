...
% canonical-source-hash: fnv1a64:22aa9d7def2323b4
...
\hlblockfigure{\detokenize{figures/MW-W02-aa-independent-filmstrip.pdf}}{How \mw{आ} is written, stroke by stroke}

\begin{enumerate}
\raggedright
  \item look at \textbf{\mw{आ}} for three seconds
  \item finger-trace it once
  \item copy it twice
  \item compare only the upright line and the top bar
\end{enumerate}
...
\subsection*{Writing — observe, trace, copy}
\hlblockfigure{\detokenize{figures/MW-W02-bha-filmstrip.pdf}}{How \mw{भ} is written, stroke by stroke}

\begin{enumerate}
\raggedright
  \item look at \textbf{\mw{भ}}
  \item finger-trace its lower shape, then the upright line
  \item copy \textbf{\mw{भ}} twice
  \item say \emph{bha} after each copy
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item copy \textbf{\mw{आभार}} once while looking
  \item point to \textbf{\mw{भा}} and say \emph{bhā}
  \item hide the word for ten seconds
  \item write \textbf{\mw{आभार}} from memory
  \item compare one sign at a time
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listen:} ask someone or a screen reader to say \emph{ābhār}; identify it as formal gratitude.
  \item \textbf{Speak:} imagine receiving help and say \textbf{\mw{आभार}} without reading.
  \item \textbf{Read:} choose the thanks word from \textbf{\mw{राम} · \mw{आभार} · \mw{सा}}.
  \item \textbf{Write:} close the book for fifteen seconds, then write \textbf{\mw{आभार}} from memory.
\end{enumerate}
