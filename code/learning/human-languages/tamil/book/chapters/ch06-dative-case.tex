...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Your first \textbf{case ending}. English says \textquotedblleft{}\textbf{to} me\textquotedblright{} with a separate word in front. Tamil says it with a piece \textbf{stuck on the back} — and that small difference is the biggest structural fact about the language.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}\emph{peyar} … \emph{peyarukku}\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}\emph{nāṉ} … \emph{enakku}\textquotedblright{} — \textquotedblleft{}I\textquotedblright{} … \textquotedblleft{}to me\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}\emph{vēlaikku}\textquotedblright{} — \textquotedblleft{}for work,\textquotedblright{} from Ch. 5's \ta{வேலை}{]}
\end{itemize}
...
\raggedright
  ...
  \item {[}YOU SAY: \textquotedblleft{}one suffix, one meaning, visible seam\textquotedblright{}{]}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} In Chapter 5 you said \textbf{\ta{நான்} \ta{தமிழ்} \ta{பேசுகிறேன்}} — \textquotedblleft{}\textbf{I} speak Tamil,\textquotedblright{} with \emph{nāṉ} as the subject. Now say \textquotedblleft{}I \textbf{know} Tamil.\textquotedblright{} Tamil will not let you use \emph{nāṉ}.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}\emph{enakku tamiḻ teriyum}\textquotedblright{}{]}
  \item {[}YOU SAY: the contrast — \textquotedblleft{}\emph{nāṉ tamiḻ pēsugiṟēṉ}\textquotedblright{} (I speak) … \textquotedblleft{}\emph{enakku tamiḻ teriyum}\textquotedblright{} (known to me){]}
  \item {[}YOU SAY: the literal — \textquotedblleft{}to-me Tamil is-known\textquotedblright{}{]}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}-ukku · -ku · -ge · -ikku\textquotedblright{}{]}
  \item {[}YOU POINT: the experiencer in each sentence{]}
  \item {[}YOU PARAPHRASE: \textquotedblleft{}the language is known to me\textquotedblright{}{]}
\end{itemize}
