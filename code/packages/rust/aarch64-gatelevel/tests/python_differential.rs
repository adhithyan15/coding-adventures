...
use aarch64_simulator::{AArch64State, MEMORY_SIZE};
...
fn seeded_state(cpu: &AArch64GateLevel, name: &str, raw: u32, seed: usize) -> AArch64State {
...
#[test]
fn python_full_state_corpus_matches_independent_gate_engine() {
    let mut count = 0;
    for line in include_str!("../../aarch64-simulator/tests/python_oracle_hashes.txt")
        .lines()
