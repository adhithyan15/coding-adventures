...
% canonical-source-hash: fnv1a64:1094f3391fc6da43
% canonical-lessons: TE-C33-anuko, TE-C33-artham-cesuko, TE-S130-letter-tha, TE-C33-caduvu, TE-C33-raayu
...
\end{tcolorbox}
\section[tha]{\te{థ} — one character, met inside words you already say}

\label{lesson:TE-S130-letter-tha}



\begin{quote}
Before the new one: \te{ఋ} — what does it do? And one from further back: \te{ణ}?

One character this time — and you have been saying it for pages without knowing which mark on the page it was.
\end{quote}

\subsection*{Script you'll notice: \te{థ}}
\textbf{\te{థ}} — \emph{tha}.
...
The \emph{h} in \emph{tha} is a puff of breath — the fifth pair of that kind, after \textbf{\te{క}/\te{ఖ}}, \textbf{\te{గ}/\te{ఘ}}, \textbf{\te{డ}/\te{ఢ}} and \textbf{\te{బ}/\te{భ}}. The plain letter here is \textbf{\te{త}}. Say \emph{ta}, then say it again and let the breath out after it: that is \textbf{\te{థ}}.

It is not the \emph{th} of English \emph{this} or \emph{thin}. The tongue stays where it goes for \textbf{\te{త}}, against the back of the teeth; only the breath is added.

You already say these, and both have \te{థ} inside them:

\begin{itemize}
\raggedright
  \item \textbf{\te{అర్థం}} \emph{arthaṁ} — meaning, the word inside \emph{arthaṁ cēsukō}
  \item \textbf{\te{అపార్థం}} \emph{apārthaṁ} — a misunderstanding, meaning gone wrong
\end{itemize}

In both, \te{థ} carries \textbf{\te{ర}} stacked on top of it — the \textbf{\te{ర్థ}} block you met when you learned to understand things.

\subsection*{Writing: \te{థ} — copy what you see}
Put your pen on \te{థ} and follow its line. Copy the shape you can see — slowly, and larger than it is printed.
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at these two, and say which one has \te{థ} and which has \te{త}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{ta}, then \emph{tha}, and hear the breath arrive
  \item \emph{Trace it:} \te{థ} three times, saying \emph{tha} as you finish each one
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which character is this — \te{థ}? What does it carry that \te{త} does not? (\emph{\textbf{tha}} — the same \emph{t} with a puff of breath after it, and not the English \emph{th}.)

One more, from much earlier: \te{గ} — what does it do?
\end{tcolorbox}
