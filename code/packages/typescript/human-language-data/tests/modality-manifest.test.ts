...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    // French's recovered order continues the same measurement correction: the
    // prefix falls 2211 -> 2207 and two existing sight-first chapters become
    // visible, raising unstartable chapters 206 -> 208.
    // Chinese now starts observable writing in lesson one. Its small writing block
    // is detachable, so the lesson core remains voice-drivable, while conservative
    // whole-lesson counts move voice/prefix -1 and pen/unstartable +1.
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3399, // +7: Marwadi starter
      ...
      voice: 2465, // -1: Chinese lesson one now includes a detachable writing microstep.
      ...
      pen: 344, // +1: Chinese lesson-one tone tracing.
      ...
      drivableLessons: 2465, // Chinese's lesson core remains voice-drivable; the complete lesson includes pen work.
      ...
      */
      ...
      unstartableChapters: 209, // +1: Chinese begins with a detachable pen microstep.
      overriddenLessons: 0,
