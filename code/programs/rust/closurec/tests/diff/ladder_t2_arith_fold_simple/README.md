...
Exercises constant arithmetic, the simplest fold.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level SIMPLE_OPTIMIZATIONS --js tests/diff/ladder_t2_arith_fold_simple/input/a.js
```
