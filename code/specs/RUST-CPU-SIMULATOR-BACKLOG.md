...
| RCPU-043 / RCPU-044 | 2010 | RISC-V RV32I (07a) | Complete: `riscv-simulator` | Missing |
...
Current selection: **RCPU-044**, the RISC-V RV32I gate-level implementation.
The checked Spec 07a functional audit is complete; pair priority now advances
to its exact DFF/gate partner while earlier cells publish one at a time.
