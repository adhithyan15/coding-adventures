...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      voice: 2460, // Two migrated Urdu opening lessons now honestly expose their visual dependency.
      ...
      */
      ...
      drivableLessons: 2460, // Two Urdu migrations now honestly expose their sight dependency.
      ...
      */
      drivablePrefixTotal: 2174, // Urdu's early pen step ends Chapter 1's ear-only prefix three lessons sooner.
