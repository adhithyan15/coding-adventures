...
CommonMark 0.31.2 Markdown pipeline — convert Markdown to HTML in one call.
...
Parse Markdown and render to HTML. Raw HTML is passed through verbatim (CommonMark-compliant). Use for **trusted** Markdown (documentation, static content).
