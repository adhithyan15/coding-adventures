...
headword: دل
romanization: dil
gloss: heart — Persian, and a real cousin of English heart by the Iranian road, not the Sanskrit one
concept_tag: UR-HEART
prerequisites: [UR-C10-munh]
sounds: [rtl, short-vowels-unwritten]
roots: [middle-persian-dil, pie-kerd]
etymology_hook: dil is Persian, borrowed into Urdu from Middle Persian, itself inherited within Iranian from Proto-Indo-Iranian *jʰārd, from Proto-Indo-European *ḱērd- "heart" -- the very root behind Sanskrit hṛdaya, English heart, Latin cor and Greek kardía; dil and hṛdaya are not opposites, they are the same root arriving in Urdu by two different Indo-Iranian roads, the Iranian one and the Indo-Aryan one.
duration:
  max_seconds: 290
requires:
...
reviews_of: [UR-C10-munh, UR-C08-puchhna, UR-C05-khuda]
---

# دل — "heart," Persian, and still a cousin of the English word
...
<!-- hl-knowledge: introduces=[UR-LEX-DIL]; assesses=[] -->

> **دل** — *dil* — **heart**

> **میرا دل۔** — *merā dil.* — "my heart."

**دل** is masculine.

## The word, taken apart — Persian, and still family
...
Middle Persian *dil* is itself **inherited**, not borrowed, within the
Iranian branch of Indo-Iranian: from Proto-Iranian **\\*jārd**, from
Proto-Indo-Iranian **\\*ȷ́ʰā́rd**, from Proto-Indo-European **\\*ḱērd-**,
"heart." That is the exact same root behind **Sanskrit** *hṛdaya*,
English **heart**, Latin **cor** (behind *courage*, *cordial*), and Greek
**kardía** (behind *cardiac*).

So **دل** and Sanskrit's word for heart are not opposites, and they did not
arrive by accident on the same idea. They are the **same PIE root**, split
...
- [YOU SAY: **dil** — heart; then **merā dil**]
- [YOU SAY: the four PIE cousins so far — **bhāī/brother, nāk/nose,
  āṅkh/eye, dil/heart**]
- [YOU TRACE: **dil** ← Middle Persian ← Proto-Iranian ← PIE *\\*ḱērd-* →
  Sanskrit **hṛdaya**]
- [YOU SAY: one root, two roads — Iranian and Indo-Aryan, the same shape as
  **pūchhnā**/*pursish*]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[UR-LEX-DIL, UR-ETYMON-DIL-HEART-PIE, UR-REGISTER-TWO-ROADS-ONE-ROOT] -->
<!-- hl-activity: {"id":"UR-C11-dil-cousin","kind":"text","assesses":["UR-ETYMON-DIL-HEART-PIE"],"prompt":"Is Urdu دل related to Sanskrit hṛdaya, or is the resemblance a coincidence like پسند and candēre?","answer":"related","accepted":["related, same root","same PIE root","cousins","yes, related"],"feedback":{"correct":"Right: both descend from PIE *ḱērd-, split at the Iranian/Indo-Aryan fork.","incorrect":"They are related — both come from PIE *ḱērd-, by two different Indo-Iranian roads."},"response_seconds":10} -->

[PAUSE 3s] Is **دل**'s resemblance to Sanskrit *hṛdaya* a coincidence, like
**پسند** and *candēre*? (**No — both come from PIE *ḱērd-*, real
cousins.**) Which branch of Indo-Iranian gave Urdu **دل**, and which gave
Sanskrit **hṛdaya**? (**Iranian; Indo-Aryan.**) Name three other English
words from the same root as **دل**. (**Heart, cardiac, courage** or
**cordial**.)

Sources: [Wiktionary: دل](https://en.wiktionary.org/wiki/%D8%AF%D9%84).
`,r=e({default:()=>i}),i=`---
schema_version: 2
id: UR-C12-chai
