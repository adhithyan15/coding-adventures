...
Grounding: English + Latin roots, plus the closest Romance siblings (Spanish,
French) supplied for contrast — every form given in full, no prior knowledge of
them assumed. The recurring decoders are Latin sound-laws (e.g. *-ct-* → *-tt-*)
and Italian's habit of keeping final vowels Latin's other children dropped.
...
title) or French *vous* (the plural). Worth teaching beside them in Chapter 2.
