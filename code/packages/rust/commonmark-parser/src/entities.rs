...
///
/// ```
/// use commonmark_parser::entities::lookup_named_entity;
...
///
/// ```
/// use commonmark_parser::entities::decode_entity;
...
pub fn decode_entity(entity: &str) -> String {
    ...
    if let Some(rest) = inner.strip_prefix('#') {
        ...
        if let Ok(code_point) = u32::from_str_radix(digits, base) {
            // CommonMark: numeric character references that decode to NUL (U+0000)
...
///
/// ```
/// use commonmark_parser::entities::decode_entities;
