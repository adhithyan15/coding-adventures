...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}vēsavi\textquotedblright{} — summer, cousin of Kannada's bēsige{]}
  \item {[}YOU SAY: \textquotedblleft{}vānākālam\textquotedblright{} — the rains, the real central season{]}
  \item {[}YOU SAY: \textquotedblleft{}śītākālam\textquotedblright{} — the cold season{]}
  \item {[}YOU SAY: the double Sanskrit loan — \textquotedblleft{}vasanta ṛtuvu,\textquotedblright{} like Kannada{]}
\end{itemize}
