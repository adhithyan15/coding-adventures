...
% canonical-source-hash: fnv1a64:e8c2dd99e1ac7c36
% canonical-lessons: SA-C09-grhnati, SA-S107-letter-ta, SA-C09-prcchati, SA-C09-sahayyam-karoti, SA-S209-sign-anusvara, SA-C09-snihyati
...
\begin{quote}
Before the new one, the ones you have already met: \sk{ख} · \sk{◌े} · \sk{व}. Say what each of them does.
...
\begin{itemize}
\raggedright
  \item \textbf{\sk{भवान्} / \sk{त्वम्}} \emph{bhavān / tvam} — you
  \item \textbf{\sk{तव} \sk{नाम} \sk{किम्}?} \emph{tava nāma kim?} — what's your name?
  \item \textbf{\sk{न} \sk{चिन्ता}} \emph{na cintā} — no worry / it's nothing / you're welcome
  \item \textbf{\sk{खादति}} \emph{khādati} — he, she, or it eats — the everyday eat-verb, which is not the one English is related to
\end{itemize}

\subsection*{Writing: \sk{त}}
\hlblockfigure{\detokenize{figures/SA-S107-letter-ta-filmstrip.pdf}}{How \sk{त} is written, stroke by stroke}
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at this, and find \sk{त} in it
\end{itemize}

\begin{quote}
\sk{भवान्} / \sk{त्वम्}  ·  \sk{तव} \sk{नाम} \sk{किम्}?  ·  \sk{न} \sk{चिन्ता}
\end{quote}
...
\end{tcolorbox}
\section[ṃ]{\sk{◌ं} — one character, met inside words you already say}

\label{lesson:SA-S209-sign-anusvara}



\begin{quote}
Before the new one, the ones you have already met: \sk{◌े} · \sk{व} · \sk{त}. Say what each of them does.

One character this time. One only — and you have been saying it for pages without knowing which mark on the page it was.
\end{quote}

\subsection*{Script you'll notice: \sk{◌ं}}
\textbf{\sk{◌ं}} — \emph{ṃ (nasal)}.

It is a \textbf{nasal mark}. It is not a letter and never stands alone: it sits on a syllable and sends its sound through the nose.

Where it sits: an anusvāra dot above the top bar, nasalizing the syllable.

Worked through: \textbf{\sk{न}} + \textbf{\sk{◌ं}} = \textbf{\sk{नं}} — \emph{naṃ}.

You already say these words, and \sk{◌ं} is one of the shapes inside them — the rest of their shapes are still ahead of you, so here the character stands on its own:

\begin{itemize}
\raggedright
  \item \emph{ahaṁ saṁskṛtaṁ vadāmi} — I speak Sanskrit
  \item \emph{sāhāyyaṁ karoti} — he, she, or it helps — a noun plus \textquotedblleft{}does,\textquotedblright{} and help named as going along with someone
\end{itemize}

\subsection*{Writing: \sk{◌ं} — copy what you see}
Put your pen on \sk{◌ं} and follow its line. Copy the shape you can see — slowly, and larger than it is printed.
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at this, and find \sk{◌ं} in it
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Trace it:} \sk{◌ं} three times, saying \emph{ṃ (nasal)} as you finish each one
  \item \emph{Look:} back at any page of this chapter and find \sk{◌ं} once more
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which character is this — \sk{◌ं}? Where does it send the sound? (\textbf{Through the nose.}) Name one word you already say that contains it.
\end{tcolorbox}
