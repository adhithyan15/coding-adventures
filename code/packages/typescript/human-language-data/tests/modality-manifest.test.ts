...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3404, // Italian and French each add one guided-copy bridge.
      ...
      voice: 2460, // Italian and French legacy openers now expose their pen dependencies.
      ...
      pen: 354, // +4: Italian and French each add opener trace and guided-copy work.
      ...
      drivableLessons: 2460, // Italian and French openers leave the hands-free set.
      ...
      */
      drivablePrefixTotal: 2172, // French Chapter 1 removes eight more hands-free opening lessons.
      ...
      unstartableChapters: 215, // Italian and French Chapter 1 now honestly start with pen.
      overriddenLessons: 0,
