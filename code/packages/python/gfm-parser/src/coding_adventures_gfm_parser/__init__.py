...
from coding_adventures_gfm_parser.block_parser import (
    apply_gfm_block_extensions,
    convert_to_ast,
    parse_blocks,
)
from coding_adventures_gfm_parser.inline_parser import resolve_inline_content
...
def parse(markdown: str) -> DocumentNode:
    ...
    apply_gfm_block_extensions(result.document, result.raw_inline_content)
