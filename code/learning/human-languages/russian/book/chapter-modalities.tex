...
\expandafter\def\csname hlchaptermodality1\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (1) \quad \hlsightsign{}~\textbf{eyes} (6) \quad \hlpensign{}~\textbf{pen} (5)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 7 of 12 lessons.%
    \par}\medskip
}

\expandafter\def\csname hlchaptermodality2\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (9) \quad \hlsightsign{}~\textbf{eyes} (1)\quad
...
\expandafter\def\csname hlchaptermodality11\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (5) \quad \hlsightsign{}~\textbf{eyes} (1)\quad
...
\expandafter\def\csname hlchaptermodality15\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlsightsign{}~\textbf{eyes} (1) \quad \hlpensign{}~\textbf{pen} (8)\quad
