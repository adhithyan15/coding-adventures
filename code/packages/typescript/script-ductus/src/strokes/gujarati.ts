...
const gujaratiAlphabetSource = (glyph: string): StrokeSource => {
  const letter = gujarati.letters.find(
    ...
    "gujarati:ઝ",
    {
      ...
      strokes: [
        ...
        },
        {
          segments: [
            {
              label: "lift again, then descend the short upper stem",
              path: [
                { x: 496, y: 560 },
                { x: 496, y: 500 },
                { x: 496, y: 440 },
    ...
    "gujarati:ઞ",
    {
      ...
      strokes: [
        ...
        },
        {
          segments: [
            {
              label: "lift, then sweep the short rightward shoulder",
              path: [
                { x: 365, y: 370 },
                { x: 405, y: 370 },
                { x: 445, y: 375 },
    ...
    "gujarati:ણ",
    {
      ...
      strokes: [
        ...
        },
        {
          segments: [
            {
              label: "lift, then circle the separate middle bowl",
              path: [
                { x: 280, y: 555 },
                { x: 330, y: 575 },
                { x: 385, y: 575 },
      ...
      strokes: [
        {
          segments: [
            {
              label:
                "circle the broad loop, wind through the inner turn, and exit across the long right shoulder",
              path: [
                { x: 270, y: 75 },
                { x: 220, y: 120 },
                { x: 170, y: 175 },
      ...
      strokes: [
        {
          segments: [
            {
              label:
                "curl through the left body and inner turn, then exit across the long right shoulder",
              path: [
                { x: 50, y: 556 },
                { x: 90, y: 560 },
                { x: 130, y: 550 },
      ...
      strokes: [
        {
          segments: [
            {
              label:
                "circle the rounded upper turn and sweep around the broad lower body into the long right shoulder",
              path: [
                { x: 35, y: 565 },
                { x: 75, y: 575 },
                { x: 120, y: 565 },
      ...
      strokes: [
        {
          segments: [
            {
              label:
                "circle the rounded upper body, curl through the middle loop, and descend into the lower-right tail",
              path: [
                { x: 45, y: 555 },
                { x: 90, y: 575 },
                { x: 145, y: 580 },
      ...
      strokes: [
        {
          segments: [
            {
              label:
                "circle counterclockwise around the broad rounded left body",
              path: [
                { x: 300, y: 565 },
                { x: 245, y: 550 },
                { x: 190, y: 525 },
        ...
        },
        {
          segments: [
            {
              label: "lift and sweep the middle shoulder from left to right",
              path: [
                { x: 235, y: 340 },
                { x: 285, y: 350 },
                { x: 335, y: 360 },
      ...
      strokes: [
        {
          segments: [
            {
              label:
                "circle the left bowl, rise through the middle turn, and descend the right spine into its foot",
              path: [
                { x: 260, y: 565 },
                { x: 205, y: 545 },
                { x: 160, y: 515 },
      ...
      strokes: [
        {
          segments: [
            {
              label:
                "circle counterclockwise around the rounded left body and return into the right shoulder",
              path: [
                { x: 340, y: 500 },
                { x: 300, y: 505 },
                { x: 255, y: 505 },
      ...
      strokes: [
        {
          segments: [
            {
              label:
                "circle the small upper loop and continue through the broad lower body into its tail",
              path: [
                { x: 230, y: 390 },
                { x: 185, y: 405 },
                { x: 145, y: 425 },
      ...
      strokes: [
        {
          segments: [
            {
              label:
                "circle the rounded upper loop and continue through the left body into the long right shoulder",
              path: [
                { x: 45, y: 500 },
                { x: 45, y: 530 },
                { x: 60, y: 555 },
      ...
      strokes: [
        {
          segments: [
            {
              label:
                "circle the compact upper loop and continue through the middle turn around the broad lower bowl",
              path: [
                { x: 500, y: 550 },
                { x: 455, y: 565 },
                { x: 410, y: 565 },
