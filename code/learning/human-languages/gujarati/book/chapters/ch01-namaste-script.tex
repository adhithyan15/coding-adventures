...
% canonical-source-hash: fnv1a64:9cd2578f1979fbdf
% canonical-lessons: GU-C01-namaste, GU-C01-aahaar, GU-W01-ha, GU-W01-aa-matra, GU-W01-aa, GU-W01-na, GU-W01-ma, GU-W01-sa, GU-W01-ta, GU-W01-e-matra, GU-W01-virama, GU-W01-namaste-read
...
\end{tcolorbox}
\section[āhār]{\gu{આહાર} (āhār) — food, a meal}

\label{lesson:GU-C01-aahaar}
...
\subsection*{You'll want to know: \gu{આહાર}}
\textbf{\gu{આહાર}} — \emph{āhār} — \textquotedblleft{}food, a meal\textquotedblright{}.

Say it: \emph{āhār}. Look at its shape as you say it: the lessons that follow take pieces of it, \textbf{\gu{હ}}, \textbf{\gu{ા}} and \textbf{\gu{આ}}, and write each one on its own.
...
\raggedright
  \item \emph{āhār}
  \item \emph{āhār}, and what it means
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is \textquotedblleft{}food, a meal\textquotedblright{}? (\textbf{\gu{આહાર}}, \emph{āhār}.)
\end{tcolorbox}
...
\hlblockfigure{\detokenize{figures/GU-W01-ha-filmstrip.pdf}}{How \gu{હ} is written, stroke by stroke}
...
\subsection*{Script}
\hlblockfigure{\detokenize{figures/GU-W01-aa-filmstrip.pdf}}{How \gu{આ} is written, stroke by stroke}
...
\subsection*{Script}
\hlblockfigure{\detokenize{figures/GU-W01-na-filmstrip.pdf}}{How \gu{ન} is written, stroke by stroke}
...
\subsection*{Script}
\hlblockfigure{\detokenize{figures/GU-W01-ma-filmstrip.pdf}}{How \gu{મ} is written, stroke by stroke}
...
\subsection*{Script}
\hlblockfigure{\detokenize{figures/GU-W01-sa-filmstrip.pdf}}{How \gu{સ} is written, stroke by stroke}
...
\subsection*{Script}
\hlblockfigure{\detokenize{figures/GU-W01-ta-filmstrip.pdf}}{How \gu{ત} is written, stroke by stroke}
