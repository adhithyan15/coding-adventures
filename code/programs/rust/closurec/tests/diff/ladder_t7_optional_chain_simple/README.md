# ladder_t7_optional_chain_simple

Rung 7.optional_chain of the CCR-066 differential complexity ladder, at `SIMPLE`.

## What this rung is for

Exercises optional chaining through two links.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level SIMPLE_OPTIMIZATIONS --js tests/diff/ladder_t7_optional_chain_simple/input/a.js
```
