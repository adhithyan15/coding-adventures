...
- Give every source owner matching stroke and ductus-view evidence suites, keep
  the shared roots synthetic and owner-neutral, reject duplicate registry keys,
  and keep hostile keys from mutating the prototype.
- Keep every new source shard in Language Ladder's dedicated handwriting-tools
  chunk and record Tamil glyph-level ownership as the next measured conflict
  boundary.
