# Build and run the single-layer-network tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name single_layer_network-tests -Sources @("tests\single_layer_network_test.c", "src\single_layer_network.c")
