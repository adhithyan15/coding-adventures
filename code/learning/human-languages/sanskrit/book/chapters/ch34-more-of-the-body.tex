...
% canonical-source-hash: fnv1a64:9770724f36ae1907
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{bāhuḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{samudraḥ}, then \emph{bāhuḥ}
  \item \emph{Recall:} say \emph{taruḥ}, then read \textbf{\sk{नदी}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{grīvā}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{bāhuḥ}, then \emph{grīvā}
  \item \emph{Recall:} read \textbf{\sk{पत्रम्}}, then say \emph{setuḥ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{asthi}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{grīvā}, then \emph{asthi}
  \item \emph{Recall:} say \emph{tṛṇam}, then read \textbf{\sk{पर्वतः}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{raktam}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{asthi}, then \emph{raktam}
  \item \emph{Recall:} read \textbf{\sk{लता}}, then say \emph{puram}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{dehaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then say what \emph{paradise} was built out of
  \item \emph{Recall:} say \emph{dāru}, then read \textbf{\sk{समुद्रः}}
\end{itemize}
