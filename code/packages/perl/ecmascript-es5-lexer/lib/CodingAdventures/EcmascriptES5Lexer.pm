package CodingAdventures::EcmascriptES5Lexer;

# ============================================================================
# CodingAdventures::EcmascriptES5Lexer — Grammar-driven ECMAScript 5 tokenizer
# ============================================================================
#
# ECMAScript 5 (ECMA-262, 5th Edition, December 2009) adds the `debugger`
# keyword over ES3. Syntactic changes are modest; the real innovations were
...
sub _grammar {
    ...
    my $tokens_file = File::Spec->catfile( _grammars_dir(), 'ecmascript', 'es5.tokens' );
    open my $fh, '<', $tokens_file
        or die "CodingAdventures::EcmascriptES5Lexer: cannot open '$tokens_file': $!";
    my $content = do { local $/; <$fh> };
    close $fh;

    my ($grammar, $err) = CodingAdventures::GrammarTools->parse_token_grammar($content);
    die "CodingAdventures::EcmascriptES5Lexer: failed to parse es5.tokens: $err"
        unless $grammar;
...
sub tokenize {
    ...
    while ($pos < $len) {
        ...
        unless ($matched_tok) {
            ...
            die sprintf(
                "CodingAdventures::EcmascriptES5Lexer: LexerError at line %d col %d: "
...
CodingAdventures::EcmascriptES5Lexer - Grammar-driven ECMAScript 5 (2009) tokenizer
