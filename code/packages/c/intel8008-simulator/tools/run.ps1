# Build and run the intel8008-simulator tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name intel8008_simulator-tests -Sources @("tests\intel8008_simulator_test.c", "src\intel8008_simulator.c")
