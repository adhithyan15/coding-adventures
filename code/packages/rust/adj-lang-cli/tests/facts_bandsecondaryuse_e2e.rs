...
fn band_secondary_use_recalls_both_with_citation() {
    ...
    assert!(
        out.contains("\"source\":\"Microwave radiation will cook your popcorn in just a few minutes, but is also used by astronomers to learn about the structure of nearby galaxies.\""),
