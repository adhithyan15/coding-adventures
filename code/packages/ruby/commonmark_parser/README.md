# coding_adventures_commonmark_parser

CommonMark 0.31.2 compliant Markdown parser that produces a Document AST.

## Overview

`coding_adventures_commonmark_parser` parses CommonMark 0.31.2 Markdown into a
...
**Passes all 652 CommonMark 0.31.2 specification examples.**

## Two-Phase Architecture

The parse is two-phase, mirroring the CommonMark reference implementation:
...
The delimiter stack algorithm (CommonMark Appendix A) is used for emphasis/strong
matching with full left-flanking / right-flanking / mod-3 rule support.

## Installation

```ruby
gem "coding_adventures_commonmark_parser"
```
...
Implements spec **TE01 — CommonMark Parser** and depends on **TE00 — Document AST**.
