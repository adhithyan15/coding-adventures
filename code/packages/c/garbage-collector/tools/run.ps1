# Build and run the garbage-collector tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name garbage_collector-tests -Sources @("tests\garbage_collector_test.c", "src\garbage_collector.c")
