...
describe("shared Perso-Arabic letters retain script-owned provenance", () => {
  ...
  it("keeps Persian and Urdu ط body-first with independently sourced provenance", () => {
    const persian = SCRIPTS.find((script) => script.script === "perso-arabic")!
  ...
  it("keeps Persian گ as an independently sourced three-run kāf-family letter", () => {
    const persian = SCRIPTS.find((script) => script.script === "perso-arabic")!
      .letters.find((entry) => entry.glyph === "گ")!;
