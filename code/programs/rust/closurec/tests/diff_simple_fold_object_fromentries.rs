...
/// `fromEntries(` call — the declined non-global receiver — may remain; the four
/// bare-global calls all fold away.
#[test]
fn simple_fold_object_fromentries_did_not_fall_back_to_whitespace_only() {
    ...
    assert_eq!(
        ...
        1,
        "exactly one fromEntries( call (the declined non-global receiver) should \
