# Build and run the intel-8008-assembler tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name intel_8008_assembler-tests -Sources @("tests\intel_8008_assembler_test.cpp")
