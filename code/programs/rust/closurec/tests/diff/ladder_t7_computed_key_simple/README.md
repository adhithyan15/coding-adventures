# ladder_t7_computed_key_simple

Rung 7.computed_key of the CCR-066 differential complexity ladder, at `SIMPLE`.

## What this rung is for

Exercises a computed property key.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level SIMPLE_OPTIMIZATIONS --js tests/diff/ladder_t7_computed_key_simple/input/a.js
```
