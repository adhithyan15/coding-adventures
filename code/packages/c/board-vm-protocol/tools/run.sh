#!/bin/sh
# Build and run the board-vm-protocol tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c board_vm_protocol-tests tests/board_vm_protocol_test.c src/board_vm_protocol.c
