% Preamble for "Italian, Step by Step, Root by Root" (HL00 book format).
% XeLaTeX only. Mirrors the Spanish/French tracks' preamble (Latin script).
...
\hypersetup{
  pdftitle={Italian, Step by Step, Root by Root},
  pdfauthor={Adhithya Rajasekaran},
  pdfsubject={Etymology-driven Italian curriculum},
