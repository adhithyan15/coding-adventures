use powerpc601_simulator::{PowerPc601Simulator, PowerPcState};

fn seeded_state(cpu: &PowerPc601Simulator, raw: u32, seed: usize) -> PowerPcState {
...
#[test]
fn python_full_state_decode_corpus_matches() {
    let mut count = 0;
    ...
    assert!(count >= 200, "expected broad corpus, got {count}");
}
