...
% canonical-source-hash: fnv1a64:7dc9c28b4df5c831
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\ml{വലിയ}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{paal}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\ml{നല്ല}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{ūṇ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\ml{പുതിയ}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} read \textbf{\ml{ഇത്}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}\ml{പഴയ}\textquotedblright{} three times, pointing at something different each time
  \item \emph{Say it:} it once with a word you already know after it
  \item \emph{Recall:} say \emph{atŭ}, then read \textbf{\ml{ഇവിടെ}}
\end{itemize}
