...
requires:
  knowledge: []
introduces:
  knowledge: [ML-CONCEPT-C06-DATIVE-IKKU-01, ML-CONCEPT-C06-DATIVE-IKKU-02]
practises:
  knowledge: [ML-CONCEPT-C06-DATIVE-IKKU-01, ML-CONCEPT-C06-DATIVE-IKKU-02]
skills: [listening, speaking, reading]
...
word. Malayalam sticks it on the **back** — and that is the biggest structural
fact about the language.

## You'll want to know
<!-- hl-knowledge: introduces=[ML-CONCEPT-C06-DATIVE-IKKU-01]; assesses=[] -->
...
*and* declension at once, indivisible, and it doesn't even settle *which* case.
Malayalam's dative is never ambiguous.

That's what "**agglutinative**" means, and why Malayalam words grow long without
...
register: neutral
variety: standard-colloquial
reviews_of: [ML-C07-numbers-1-5, ML-W07-numbers-1-5-dictation]
---

# Six to ten — voice first

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[ML-CONCEPT-C07-NUMBERS-1-5-01] -->

[PAUSE 2s] Count *onnu* through *anchu*. Keep your pencil down: the next five
meanings and sounds come before their shapes.
...
## Why it's said this way — seven keeps a rare sound
<!-- hl-knowledge: introduces=[ML-CONCEPT-C07-NUMBERS-6-10-02]; assesses=[] -->

The middle sound of *ezhu* is the curled **zh** heard in the name *Tamil* in its
native form. Malayalam and Tamil kept it; Kannada and Telugu hardened it. Practise
only the sound now: *e-zhu*. The written letter waits for a later micro-lesson.

## The word, taken apart — nine is one short of ten
<!-- hl-knowledge: introduces=[ML-CONCEPT-C07-NUMBERS-6-10-03]; assesses=[] -->

*Ompathu* grew from an old word for **one** plus *pathu*, **ten**: one short of
ten. Before *p*, the older *n* becomes *m*. Say *on-pathu* slowly, then let it
settle into *ompathu*.
...
[PAUSE 3s] Count six to ten. Which word preserves the rare *zh*? (***Ezhu.***)
How is *ompathu* built? (**One plus ten: one short of ten.**) Next, the numeral
shapes arrive in groups of three or fewer.
`,y=e({default:()=>b}),b=`---
schema_version: 2
id: ML-C07-numbers-practice
spine_node: SPINE-COUNT-ONE-TO-FIVE
sequence: 354
chapter: 7
type: practice-mix
...
sounds: [zha-llla, gemination]
roots: [proto-dravidian-numbers]
duration:
  max_seconds: 240
requires:
  knowledge: [ML-CONCEPT-C07-NUMBERS-1-5-01, ML-CONCEPT-C07-NUMBERS-6-10-01, ML-SCRIPT-DIGITS-1-3-07, ML-SCRIPT-DIGITS-4-5-07, ML-SCRIPT-DIGITS-6-8-07, ML-SCRIPT-DIGITS-9-10-07]
introduces:
  knowledge: []
practises:
  knowledge: [ML-CONCEPT-C07-NUMBERS-1-5-01, ML-CONCEPT-C07-NUMBERS-1-5-02, ML-CONCEPT-C07-NUMBERS-1-5-03, ML-CONCEPT-C07-NUMBERS-6-10-01, ML-CONCEPT-C07-NUMBERS-6-10-02, ML-CONCEPT-C07-NUMBERS-6-10-03, ML-SCRIPT-DIGITS-1-3-07, ML-SCRIPT-DIGITS-4-5-07, ML-SCRIPT-DIGITS-6-8-07, ML-SCRIPT-DIGITS-9-10-07]
skills: [listening, speaking, reading, writing]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus, fluency]
register: neutral
variety: standard-colloquial
reviews_of: [ML-C07-numbers-1-5, ML-C07-numbers-6-10, ML-W07-numbers-1-5-dictation, ML-W07-numbers-6-10-dictation]
---

# One to ten — the cumulative payoff
...
<!-- hl-knowledge: introduces=[]; assesses=[ML-SCRIPT-DIGITS-1-3-07, ML-SCRIPT-DIGITS-4-5-07, ML-SCRIPT-DIGITS-6-8-07, ML-SCRIPT-DIGITS-9-10-07] -->
...
Now check against **൧ ൨ ൩ ൪ ൫ ൬ ൭ ൮ ൯ ൰**.
...
[PAUSE 3s] Count one to ten, then read **൯ ൪ ൭** out of order. You can now hear,
say, read, and write a representative part of the complete number sequence.
`,x=e({default:()=>S}),S=`---
schema_version: 2
id: ML-C08-dayavayi
...
## You'll want to know
<!-- hl-knowledge: introduces=[ML-CONCEPT-C08-DAYAVAYI-01]; assesses=[] -->
...
## Why it's said this way
<!-- hl-knowledge: introduces=[ML-CONCEPT-C08-DAYAVAYI-02]; assesses=[] -->
...
## Why it's said this way
<!-- hl-knowledge: introduces=[ML-CONCEPT-C08-DAYAVAYI-03]; assesses=[] -->
