# Build and run the jvm-class-file tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name jvm_class_file-tests -Sources @("tests\jvm_class_file_test.cpp")
