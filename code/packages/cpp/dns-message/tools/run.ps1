# Build and run the dns-message tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name dns_message-tests -Sources @("tests\dns_message_test.cpp")
