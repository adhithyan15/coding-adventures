...
| **3** | algebra / calculus | native ADJ `solved_roots` scaffold now covers quadratic, cubic, and quartic banks; broader CAS wiring (PR-6) + rewrite trail (PR-4) |
...
quadratic, cubic, and quartic programs, and the ladder maps those root sets to
printed options without host-side solving. From here, rungs 3→5 gate the broader
