...
describe("the committed corpus", () => {
  ...
  it("pins the first ledger, and it is the reason the rule exists", () => {
    ...
    expect(byNamespace).toEqual({ roots: 2147, "etymon-atom": 867 }); // +1 root + 1 etymon atom: HL-C88 slice 8 // +72 roots, +39 etymon-atom: vocabulary wave 6 // +1 root + 1 etymon atom: HL-C113 (B1 si-condition rung) // HL-C113: HL-C113 imperfect subjunctive // HL-C113 step 8: +4 roots (per-latin, hoc-latin, tam-latin, paucus-latin; bene is re-spent, not minted) and +3 etymon atoms (PERO-PER-HOC, TAMBIEN-TAN-BIEN, TAMPOCO-TAN-POCO) // HL-C128 step 2: +4 roots (iste-latin, ipse-latin, ille-latin, accu-latin) and +3 etymon atoms (ESTE-ISTE, ESE-IPSE, AQUEL-ACCU-ILLE) // HL-C128 step 3: +3 roots (multum-latin, bastare-latin, malus-latin) and +3 etymon atoms (MUY-MULTUM, BASTANTE-BASTAR, MAL-MALUS) // HL-C128 step 4: +3 roots (quis-latin, aut-latin, nec-latin) and +3 etymon atoms (QUIEN-QUEM, O-AUT, NI-NEC); al and del mint none, being rules rather than words // HL-C128 step 5: +1 -- ES-ETYMON-GERUND-NDUM; the gerund lessons mint no root slug, being about an ending rather than a word
  });
