...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Nothing is assumed yet. Begin with the shortest useful answer in the language, and with the first of its three writing systems.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{\ja{はい}} — \emph{ha-i}, two even beats{]} {[}REPEAT x2{]}
  \item {[}YOU READ: \textbf{\ja{は}}, then \textbf{\ja{い}}, left to right{]}
  \item {[}YOU ANSWER: your name is called $\to$ \textbf{\ja{はい}}{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Say \textbf{\ja{はい}} once and count its two beats out loud. This lesson adds the opposite answer, and one fact about beats that Japanese will never let go of.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{\ja{いいえ}} — \emph{i-i-e}, three even beats{]} {[}REPEAT x2{]}
  \item {[}YOU CONTRAST: \textbf{\ja{いえ}} house, \textbf{\ja{いいえ}} no{]}
  \item {[}YOU CHOOSE: agree $\to$ \textbf{\ja{はい}}; decline $\to$ \textbf{\ja{いいえ}}{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Retrieve \textbf{\ja{はい}} and the sign \textbf{\ja{は}}. You are about to meet \textbf{\ja{は}} again in the daytime greeting — where it is not pronounced \emph{ha}.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{\ja{こんにちは}} — \emph{ko-n-ni-chi-wa}, five beats{]} {[}REPEAT x2{]}
  \item {[}YOU DECIDE: \textbf{\ja{は}} in \textbf{\ja{はい}} $\to$ \emph{ha}; \textbf{\ja{は}} ending the greeting $\to$ \emph{wa}{]}
  \item {[}YOU GREET: someone at midday $\to$ \textbf{\ja{こんにちは}}{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Say \textbf{\ja{こんにちは}}. Its history hid two characters, \ja{今日}, that hiragana cannot show you. This lesson opens that second system by naming the language itself.
\end{quote}
...
That is a real, checkable connection, and it is the honest replacement for the Latin roots this curriculum leans on elsewhere. English has no share in it.
\end{cousinweb}

\subsection*{Guided Practice}
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{\ja{日本語}} — \emph{ni-ho-n-go}, four beats{]} {[}REPEAT x2{]}
  \item {[}YOU NAME: \ja{日} sun or day; \ja{本} origin; \ja{語} language{]}
  \item {[}YOU CONNECT: Mandarin \emph{Rìběnyǔ}, Korean \emph{ilbon-eo}, same three characters{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Recall how hiragana writes a long vowel: it writes the vowel twice, as in \textbf{\ja{いいえ}}. Katakana does it differently, and this word shows how.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{\ja{コーヒー}} — \emph{ko-o-hi-i}, four beats{]} {[}REPEAT x2{]}
  \item {[}YOU TRACE: Arabic \emph{qahwa} $\to$ Turkish \emph{kahve} $\to$ Dutch \emph{koffie} $\to$ \textbf{\ja{コーヒー}}{]}
  \item {[}YOU DECIDE: a borrowed word is written in katakana, not hiragana{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Back to hiragana. Five signs are coming, and one small mark that unlocks a whole second row of sounds.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{\ja{ありがとう}} — \emph{a-ri-ga-to-o}, five beats{]} {[}REPEAT x2{]}
  \item {[}YOU BUILD: \textbf{\ja{か}} plus the dakuten $\to$ \textbf{\ja{が}}{]}
  \item {[}YOU CONNECT: \ja{有}\ja{り}\ja{難}\ja{し} \textquotedblleft{}hard to exist\textquotedblright{} $\to$ rare $\to$ precious $\to$ thanks{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Say \textbf{\ja{ありがとう}} once and rebuild \textbf{\ja{が}} from \textbf{\ja{か}}. This lesson adds the ending that makes it usable with a stranger, a shopkeeper, or a boss.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textbf{\ja{ありがとうございます}} — ten beats, final \emph{su} light{]} {[}REPEAT x2{]}
  \item {[}YOU CHOOSE: a close friend $\to$ \textbf{\ja{ありがとう}}; a shop assistant $\to$ \textbf{\ja{ありがとうございます}}{]}
  \item {[}YOU BUILD: \textbf{\ja{こ}} $\to$ \textbf{\ja{ご}}, \textbf{\ja{さ}} $\to$ \textbf{\ja{ざ}}{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Before reading on, retrieve three answers: the daytime greeting, the short yes, and the short no. Nothing new is added here.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU RUN: both voices once with the Japanese, once with romanization only{]}
  \item {[}YOU DECIDE: which line would change if B were a close friend{]} {[}PAUSE 3s{]}
  \item {[}YOU SWAP: take B's part while the other lines are read to you{]}
\end{itemize}
