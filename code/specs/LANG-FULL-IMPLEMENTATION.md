...
- ✅ **AL14** — direct formal procedures. A name- or value-mode `procedure p`
  ...
  capturing an enclosing value formal), implemented standard-function, or
