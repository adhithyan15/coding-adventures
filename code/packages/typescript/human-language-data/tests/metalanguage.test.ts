...
describe("the committed corpus", () => {
  it("pins the first measurement", () => {
    ...
    expect(r.summary.worstTerms.slice(0, 2)).toEqual([
      { term: "verb", lessons: 978 }, // +4: HL-C98 // +2: HL-C99 // +8: vocabulary wave 5 // +3: HL-C88 slices 5-6 // +11: vocabulary wave 6 // +2: B1 si-condition rung // +3: HL-C113 preterite plural // +2: HL-C113 preterite close (strong plurals, review, synthesis) // +2: HL-C113 imperfect subjunctive // +3: HL-C113 unreal condition // HL-C113 step 7: +4 // HL-C128 step 3: +1 // HL-C128 step 5: +2 // HL-C127: +3 // HL-C128 step 7: +2 // HL-C128 step 8: +2 // HL-C128 step 9: +4 // HL-C128 step 10: +3 // HL-C134: +1 each — the carried prose says 'verb' and 'noun' in lessons whose markdown had not, though the book always did // HL-C152: Spanish realizes SPINE-NEGATE-AND-ASK — five lessons, one chapter, A2 complete at 5/5
      { term: "noun", lessons: 501 }, // +1: ES-C02-concordancia names the noun it agrees with // +4: vocabulary wave 5 // +3: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +1: HL-C88 slice 8 (-ario, review, synthesis) // +14: vocabulary wave 6 // HL-C113 step 6: +1 // HL-C128 step 2: +4 // HL-C128 step 3: +4 // HL-C128 step 8: +1 // HL-C128 step 9: +3 // HL-C128 step 10: +4 // HL-C134: +1 each — the carried prose says 'verb' and 'noun' in lessons whose markdown had not, though the book always did
    ]);
  });
