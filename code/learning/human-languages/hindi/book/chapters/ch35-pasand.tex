...
% canonical-source-hash: fnv1a64:555b2afa99c53fe4
% canonical-lessons: HI-C35-lena, HI-S146-letter-va, HI-C35-puchna, HI-C35-madad, HI-C35-pasand
...
\section[lenā / le / letā / letī / lete / lābh]{\hi{लेना} / \hi{ले} / \hi{लेता} / \hi{लेती} / \hi{लेते} — \textquotedblleft{}to take\textquotedblright{} and its present forms}
...
The pattern is regular: remove infinitive \textbf{-\hi{ना}}, then add \textbf{-\hi{ता}} for the masculine form, \textbf{-\hi{ती}} for the feminine, or \textbf{-\hi{ते}} for respectful \textbf{\hi{आप}} and plural subjects. That gives \textbf{\hi{ले} $\to$ \hi{लेता} / \hi{लेती} / \hi{लेते}}.
...
\raggedright
  ...
  \item \emph{Say it:} \textquotedblleft{}you (resp.) take\textquotedblright{} — \textbf{\hi{आप} \hi{लेते} \hi{हैं}} (\emph{āp lete haiṁ})
...
Which Sanskrit verb is \emph{lenā}, and which consonant did it lose? (\textbf{\hi{लभते}} \emph{labhate}; the \textbf{-bh-}.) Which Hindi noun still shows that consonant, and why? (\textbf{\hi{लाभ}} — borrowed back from Sanskrit, so it never eroded.) Give the stem, then the masculine, feminine, and respectful or plural forms. (\textbf{\hi{ले}; \hi{लेता} / \hi{लेती} / \hi{लेते}}.) Say \textquotedblleft{}I'll have water.\textquotedblright{} (\emph{Maiṁ pānī letā / letī hūṁ}.)
\end{tcolorbox}
\section[va]{\hi{व} — the loop you have drawn before}

\label{lesson:HI-S146-letter-va}



\begin{quote}
Before the new one: \textbf{\hi{श}} — how many runs did its left side take?

This one is easier, and its left side is a shape already in your hand.
\end{quote}

\subsection*{Script you'll notice: \hi{व}}
\textbf{\hi{व}} — \emph{va}, somewhere between an English \emph{v} and \emph{w}.
...
Look back at \textbf{\hi{ग}} and you have seen this before: the same counterclockwise loop and the same right stem. What differs is where the loop sits and how it meets the stem.

\subsection*{Script: the last of the four}
\noindent
...
\hi{र} & \emph{ra} \\
\hi{ल} & \emph{la} \\
\textbf{\hi{व}} & \emph{\textbf{va}} \\
\bottomrule
\end{tabularx}

These four sit between the consonants and the vowels — you shape them like consonants and they glide like vowels. Three were already yours. \textbf{This is the fourth}, and the set is complete.

Words you have said since the beginning:

\begin{itemize}
\raggedright
  \item \textbf{\hi{धन्यवाद}} — thank you
  \item \textbf{\hi{अलविदा}} — goodbye
  \item \textbf{\hi{स्वागत}} — welcome
  \item \textbf{\hi{सोमवार}} — Monday
\end{itemize}

\subsection*{Writing: \hi{व}}
\hlblockfigure{\detokenize{figures/HI-S146-letter-va-filmstrip.pdf}}{How \hi{व} is written, stroke by stroke}
...
\textbf{Pen lifts: 2.} The same count as \textbf{\hi{श}}, over much less distance.
...
\begin{quote}
This is one attested teaching order and not a national standard — handwriting here is taught with school-to-school variation. Source: JackPotte, ‘Devanagari v \hi{व}.gif’, strokes 1–3, Wikimedia Commons, 29 March 2009.
\end{quote}

\subsection*{Your turn}
\begin{itemize}
\raggedright
  \item \emph{Look:} at these two words and find \hi{व} in each one
\end{itemize}

\begin{quote}
\hi{धन्यवाद}  ·  \hi{अलविदा}
\end{quote}

\begin{itemize}
\raggedright
  \item \emph{Trace it:} \hi{व} three times, saying \emph{va} as you finish each one
  \item \emph{Say it:} which letter you already draw that shares its loop
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What sound does \textbf{\hi{व}} carry? (\emph{va}.) Which four letters glide between consonant and vowel? Name the word of thanks that ends in it.
\end{tcolorbox}
\section[pūchnā / pūch / pūchtā / pūchtī / pūchte]{\hi{पूछना} / \hi{पूछ} / \hi{पूछता} / \hi{पूछती} / \hi{पूछते} — asking and English \textquotedblleft{}pray\textquotedblright{}}
...
The pattern is regular: remove infinitive \textbf{-\hi{ना}}, then add \textbf{-\hi{ता}} for the masculine form, \textbf{-\hi{ती}} for the feminine, or \textbf{-\hi{ते}} for respectful \textbf{\hi{आप}} and plural subjects. That gives \textbf{\hi{पूछ} $\to$ \hi{पूछता} / \hi{पूछती} / \hi{पूछते}}.
...
Behind \textbf{\hi{पूछना}} stands Sanskrit \textbf{\hi{पृच्छति}} (\emph{pṛcchati}, \textquotedblleft{}asks\textquotedblright{}) and the reconstructed root \emph{\textbf{prek-}}, \textquotedblleft{}\textbf{to ask}\textquotedblright{}:
...
\raggedright
  ...
  \item Latin \textbf{precārius}, \textquotedblleft{}held at another's pleasure\textquotedblright{} — English \textbf{precarious}.
  \item German \textbf{fragen}, Dutch \textbf{vragen} — everyday \textquotedblleft{}to ask\textquotedblright{} to this day.
\end{itemize}

English's inherited cousin, Old English \textbf{frignan}, died out; unrelated \textbf{ask} replaced it. The \emph{prek-} word survived in English only as \textbf{pray}: asking a person and asking a god once shared a name.

\subsection*{Your turn}
\begin{itemize}
\raggedright
  \item {[}YOU SAY (m.): \emph{maiṁ pūchtā hūṁ}  ·  (f.): \emph{maiṁ pūchtī hūṁ}{]}
  \item \emph{Say it:} \textquotedblleft{}you (resp.) ask\textquotedblright{} — \textbf{\hi{आप} \hi{पूछते} \hi{हैं}} (\emph{āp pūchte haiṁ})
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which English verb is \emph{pūchnā}'s true cousin — \emph{ask} or \emph{pray}? (\textbf{Pray} — \emph{ask} is unrelated.) Give the stem, then the masculine, feminine, and respectful or plural forms. (\textbf{\hi{पूछ}; \hi{पूछता} / \hi{पूछती} / \hi{पूछते}}.) Say \textquotedblleft{}I ask (someone's) age.\textquotedblright{} (\emph{Maiṁ umr pūchtā / pūchtī hūṁ}.)
\end{tcolorbox}
\section[madad karnā / madad kartā / madad …]{\hi{मदद} \hi{करना} (madad karnā) — \textquotedblleft{}to help,\textquotedblright{} and the machine that builds it}
...
\begin{cousinweb}
\textbf{\hi{मदद}} (\emph{madad}) is a \textbf{noun}: \textquotedblleft{}\textbf{help, aid}.\textquotedblright{} On its own it does nothing. Bolt \textbf{\hi{करना}} (\emph{karnā}, \textquotedblleft{}to do\textquotedblright{}) on the end and you have the verb \textbf{\hi{मदद} \hi{करना}}, \emph{madad karnā} — literally \textquotedblleft{}\textbf{to do help}.\textquotedblright{}
...
\end{tcolorbox}
\section[mujhe … pasand hai]{\hi{पसंद} (pasand) — Hindi does not like things; things please Hindi}
