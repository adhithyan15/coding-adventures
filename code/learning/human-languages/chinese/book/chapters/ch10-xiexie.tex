...
\hlblockfigure{\detokenize{figures/ZH-W10-yan-filmstrip.pdf}}{How \zh{讠} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item a \textbf{dot} at the top, pressed down and to the right
  \item a short \textbf{horizontal}, which \textbf{turns down} and then \textbf{finishes rising} to the upper right — all one stroke, no lift
\end{enumerate}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/ZH-W10-xie-filmstrip.pdf}}{How \zh{谢} is written, stroke by stroke}
