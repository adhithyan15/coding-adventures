...
\begin{enumerate}
\raggedright
  \item the \textbf{left} stroke — start high, come down, and hook gently to the right at the bottom
  \item the \textbf{right} stroke — a short downward tick, higher up and clear of the first
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item the \textbf{vertical}, down the left side, with the smallest flick left at the foot
  \item a \textbf{short horizontal} crossing that vertical near the top, on its right
  \item the \textbf{loop} — down from the right of that crossbar, round to the left, and back up to close
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item a \textbf{short tick} at the top, on its own, clear of everything below
  \item the \textbf{body} — across to the right, back down and left in a flat zigzag, then out to the lower right in one continuous movement
\end{enumerate}
