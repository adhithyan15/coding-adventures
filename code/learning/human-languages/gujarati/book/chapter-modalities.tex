...
\expandafter\def\csname hlchaptermodality1\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (1) \quad \hlsightsign{}~\textbf{eyes} (4) \quad \hlpensign{}~\textbf{pen} (14)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 1 of 19 lessons.%
    \par}\medskip
}
