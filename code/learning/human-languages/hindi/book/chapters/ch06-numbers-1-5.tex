...
The \textbf{\hi{ँ}} over \emph{pāṁch} is a \emph{chandrabindu}, "moon-dot" — it nasalises the vowel, the way French does in \emph{bon}.
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: "ek, do, tīn, chār, pāṁch"{]}
...
{[}PAUSE 3s{]} Count to five in Hindi. (\emph{Ek, do, tīn, chār, pāṁch}.) Which mark nasalises the vowel in \textbf{\hi{पाँच}}? (The \textbf{chandrabindu}, "moon-dot.") Do you need to draw every unfamiliar letter today? (\textbf{No} — read them now and draw them when their stroke lessons arrive.) Next: watch the Sanskrit forms wear smooth.
\end{tcolorbox}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: "tr\'{\={\i}}ṇi … ti\textbf{ṇṇ}i … t\textbf{ī}n"{]}
  \item {[}YOU SAY: "catv\'{\={a}}ri … cattāri … \textbf{chār}"{]}
  \item {[}YOU COMPARE: "quattuor $\to$ cuatro · catv\'{\={a}}ri $\to$ chār"{]}
\end{itemize}
