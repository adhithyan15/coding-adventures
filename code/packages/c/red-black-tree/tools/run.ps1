# Build and run the red-black-tree tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name red_black_tree-tests -Sources @("tests\red_black_tree_test.c", "src\red_black_tree.c")
