...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    // French's recovered order corrects the previous alphabetical fallback:
    // the prefix falls 2211 -> 2207 and two existing sight-first chapters become
    // visible, raising unstartable chapters 206 -> 208.
    // The early quién micro-lesson is deliberately voice-first: meaning and sound
    // arrive here, while the already-following accent lesson owns the pen work.
    // Therefore total, voice, drivable, and the chapter-5 prefix each rise by one,
    // leaving the combined prefix at 2208.
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3400, // +7: Marwadi starter
      ...
      voice: 2467, // +2: Marwadi synthesis lessons include voice
      ...
      pen: 343, // +5: Marwadi writing lessons
      ...
      drivableLessons: 2467, // +2: Marwadi synthesis lessons remain drivable
      ...
      drivablePrefixTotal: 2208, // French order correction: -4; Spanish early quién voice lesson: +1.
      ...
      unstartableChapters: 208, // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
