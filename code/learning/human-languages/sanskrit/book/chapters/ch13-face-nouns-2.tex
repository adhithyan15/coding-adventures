...
% canonical-source-hash: fnv1a64:52d71e9564d7d933
% canonical-lessons: SA-C13-nasika, SA-S212-letter-dha, SA-C13-hridayam, SA-R13-second-pass-five-parts-three-kinds-of-ancestry
...
\hlblockfigure{\detokenize{figures/SA-S212-letter-dha-filmstrip.pdf}}{How \sk{ध} is written, stroke by stroke}
...
\end{tcolorbox}
\section[akṣi · karṇaḥ · mukham · nāsikā …]{Five parts, and three different kinds of ancestry}

\label{lesson:SA-R13-second-pass-five-parts-three-kinds-of-ancestry}



\begin{quote}
Ear, nose, heart. Say all three before you read on.
\end{quote}
...
Five words, and they do not sort into one story. Sorted by how much anyone can actually claim about where they came from:

\noindent
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
\toprule
\textbf{word} & \textbf{part} & \textbf{how secure the ancestry is} \\
\midrule
\textbf{\sk{हृदयम्}} \emph{hṛdayam} & heart & \textbf{the most secure} the book has shown \\
\textbf{\sk{अक्षि}} \emph{akṣi} & eye & unbroken, and visible in English \emph{eye} \\
\textbf{\sk{नासिका}} \emph{nāsikā} & nose & kin to two modern words, \textbf{parent of neither} \\
\textbf{\sk{मुखम्}} \emph{mukham} & mouth, face & \textbf{two families claim it}, unsettled \\
\textbf{\sk{कर्णः}} \emph{karṇaḥ} & ear & \textbf{never settled}, even by Sanskrit itself \\
\bottomrule
\end{tabularx}

The list runs from a word whose descent is traceable step by step to a word nobody has been able to place at all. Both ends of it are ordinary vocabulary a learner has to know; the difference between them is entirely a matter of what the evidence supports.
\end{tcolorbox}

\begin{culture}
\textbf{Kin is not descent.} \emph{Nāsikā} has relatives in living languages and is the ancestor of none of them — they and it come from the same older word. A family tree is not a chain, and \emph{cousin} is the commonest relation in it.

The endings sort the five a second way, cutting across the first. Three are neuter; \emph{karṇaḥ} takes the masculine visarga; \emph{nāsikā} ends in a long \emph{-ā}, the shape most feminine nouns in this book take. Gender here is a property of the word and not of the thing — a heart is neuter, an ear is masculine, and no fact about bodies explains it.
\end{culture}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which of the five has the securest ancestry, and which has none anyone agrees on? (\textbf{\sk{हृदयम्}}; \textbf{\sk{कर्णः}}.) Is \emph{nāsikā} the parent of its modern look-alikes, or their cousin? (\textbf{Cousin.})
\end{tcolorbox}
