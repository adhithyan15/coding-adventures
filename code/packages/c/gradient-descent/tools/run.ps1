# Build and run the gradient-descent tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name gradient_descent-tests -Sources @("tests\gradient_descent_test.c", "src\gradient_descent.c")
