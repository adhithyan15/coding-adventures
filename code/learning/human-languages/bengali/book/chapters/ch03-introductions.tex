...
% canonical-source-hash: fnv1a64:afac9ead3949d267
...
\section[nām]{\bn{নাম} (nām) — \textquotedblleft{}name,\textquotedblright{} a word older than Europe}
...
\end{tcolorbox}
\section[āmār]{\bn{আমার} (āmār) — \textquotedblleft{}my\textquotedblright{}}
...
Note something Bengali does \emph{not} do: \textbf{\bn{আমার}} never changes for gender. Hindi and Punjabi have \emph{merā} (m.) / \emph{merī} (f.); Bengali has one form, \textbf{āmār}, for a man or a woman, a masculine or feminine thing. Bengali threw grammatical gender away entirely — you will see this again and again, and it makes Bengali, in this one respect, simpler than its western cousins.
\end{grammarlens}

\subsection*{Your turn}
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}āmār\textquotedblright{}
  \item \emph{Say it:} its owner (\emph{āmi}, \textquotedblleft{}I\textquotedblright{})
  \item \emph{Say it:} does it change for a man vs. a woman? (No — Bengali has no gender)
  \item \emph{Recall:} say \emph{āshi}
\end{itemize}
...
\end{tcolorbox}
\section[āmār nām …]{\bn{আমার} \bn{নাম} … (āmār nām …) — \textquotedblleft{}my name is…,\textquotedblright{} with no \textquotedblleft{}is\textquotedblright{}}
...
Look at what is missing: there is \textbf{no verb}. Bengali sets \textquotedblleft{}my name\textquotedblright{} beside \textquotedblleft{}Arun\textquotedblright{} — \emph{āmār nām Arun} — and the \textquotedblleft{}is\textquotedblright{} is understood without being said. This is the \textbf{zero copula}: for present-tense equational sentences (X is Y), Bengali needs no \textquotedblleft{}to be\textquotedblright{} at all. (It is the same habit Tamil has — and unlike Hindi's \emph{merā nām … hai}, which keeps the \emph{hai}.) Bengali only brings back a verb when it talks about a \emph{state} or \emph{place} — you'll see that in Chapter 5.
\end{grammarlens}
...
\end{tcolorbox}
\section[ālāp kore bhālo lāglo]{\bn{আলাপ} \bn{করে} \bn{ভালো} \bn{লাগলো} (ālāp kore bhālo lāglo) — \textquotedblleft{}pleased to meet you\textquotedblright{}}
...
\end{tcolorbox}
\section[ki]{\bn{কি} (ki) — \textquotedblleft{}what\textquotedblright{}}
...
\end{tcolorbox}
\section[tumi / āpni]{\bn{তুমি} / \bn{আপনি} (tumi / āpni) — \textquotedblleft{}you,\textquotedblright{} three ways}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} the three — \emph{tui} (intimate) / \emph{tumi} (familiar) / \emph{āpni} (respectful)
  \item \emph{Say it:} the English cousin of \emph{tumi} (\textbf{thou})
  \item \emph{Say it:} which you use on first meeting (\emph{āpni})
  \item \emph{Recall:} read \textbf{\bn{নাম}}
\end{itemize}
...
\end{tcolorbox}
\section[tomār nām ki?]{\bn{তোমার} \bn{নাম} \bn{কি}? (tomār nām ki?) — \textquotedblleft{}what's your name?\textquotedblright{}}
...
\end{tcolorbox}
\section[Practice]{Chapter 3 — The introduction exchange}
