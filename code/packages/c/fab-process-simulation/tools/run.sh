#!/bin/sh
# Build and run the fab-process-simulation tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c fab_process_simulation-tests tests/fab_process_simulation_test.c src/fab_process_simulation.c
