package CodingAdventures::Cas::Error;

# ============================================================================
# CodingAdventures::Cas::Error — typed exception hierarchy for CAS operations
# ============================================================================
#
...
#
#   CodingAdventures::Cas::Error          — base class (never thrown directly)
...
#
#   die CodingAdventures::Cas::Error::CasNotFoundError->new($hex_key);
#
...
# ---------------------------------------------------------------------------
# Base class: CodingAdventures::Cas::Error
#
...
package CodingAdventures::Cas::Error::CasNotFoundError;

use strict;
use warnings;
use utf8;

our @ISA = ('CodingAdventures::Cas::Error');
...
package CodingAdventures::Cas::Error::CasCorruptedError;
...
package CodingAdventures::Cas::Error::CasAmbiguousPrefixError;
...
package CodingAdventures::Cas::Error::CasPrefixNotFoundError;
...
package CodingAdventures::Cas::Error::CasInvalidPrefixError;
