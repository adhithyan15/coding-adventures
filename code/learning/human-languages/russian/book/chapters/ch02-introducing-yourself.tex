...
% canonical-source-hash: fnv1a64:f497c37d58e6de7c
% canonical-lessons: RU-C02-ya, RU-C02-ty-vy, RU-C02-vy-formality, RU-C02-menya-zovut, RU-C02-kak-vas-zovut, RU-C02-kak-cross-language, RU-C02-ochen-priyatno, RU-C02-practice, RU-C02-practice-cases, RU-C02-practice-zero-copula, RU-R02-second-pass-four-letters-and-what-is-left-out
...
\end{tcolorbox}
\section[s n b d]{\ru{с} \ru{н} \ru{б} \ru{д} — four letters, two kinds of trouble}

\label{lesson:RU-R02-second-pass-four-letters-and-what-is-left-out}



\begin{quote}
The long polite greeting, from memory, and who you would say it to. Then say who you would not.
\end{quote}

\subsection*{Script: two that lie, two that are only new}
\noindent
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
\toprule
\textbf{letter} & \textbf{the trouble} \\
\midrule
\textbf{\ru{с}} & looks like a Latin \emph{c}, says \textbf{s} \\
\textbf{\ru{н}} & looks like a Latin \emph{n}, says \textbf{n} — but the shape is not the one you expect \\
\textbf{\ru{б}} & a genuinely new shape, says \textbf{b} \\
\textbf{\ru{д}} & a genuinely new shape, says \textbf{d} \\
\bottomrule
\end{tabularx}

Two kinds of difficulty, needing different handling. \textbf{\ru{с}} and \textbf{\ru{н}} are false friends: your eye reads those shapes already, and reads them wrong, so the work is \textbf{unlearning}. \textbf{\ru{б}} and \textbf{\ru{д}} arrive with nothing attached, so the work is only \textbf{learning}. The second kind is easier, and mixing the two up is why the first kind keeps catching people out.

\begin{grammarlens}[title={Grammar Lens: the verb that is not there}]
Russian leaves out the present tense of \emph{to be}. Where English needs \emph{am}, \emph{is} or \emph{are}, Russian sets the two halves of the sentence side by side and stops.

The person words are the other half of that. Subject and object forms differ, and with no verb to carry the person, \textbf{the pronoun is doing more work than its English counterpart} — which is why the shapes are worth drilling rather than recognising.
\end{grammarlens}

\subsection*{Your turn}
\begin{itemize}
\raggedright
  \item \emph{Say it:} the polite greeting, then the courtesy exchange that follows it
  \item \emph{Look:} at \ru{с} and \ru{н}, and say which Latin letter each one is pretending to be
  \item \emph{Say it:} \ru{б} and \ru{д}, and note that neither is pretending anything
  \item \emph{Say it:} a sentence with no verb in it, and say what English would have added
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which two of the four are false friends, and why is that harder? (\textbf{\ru{с}} and \textbf{\ru{н}} — you have to \textbf{unlearn} a reading, not only learn one.) What does Russian leave out of a present-tense sentence? (\textbf{The verb \emph{to be}}.) And what does that put on the pronoun? (\textbf{More work} — it carries the person alone.)
\end{tcolorbox}
