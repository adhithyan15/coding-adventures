...
% canonical-source-hash: fnv1a64:c0a7d8d14be14251
...
\end{tcolorbox}
\section[khelnā / kheltā / kheltī / khelte]{\hi{खेलना} / \hi{खेलता} / \hi{खेलती} / \hi{खेलते} — playing in the present}
...
Remove \textbf{-\hi{ना}} to recover \textbf{\hi{खेल}-}, then add the present endings you know: \textbf{\hi{खेलता}} (masculine), \textbf{\hi{खेलती}} (feminine), and \textbf{\hi{खेलते}} (respectful \textbf{\hi{आप}} or plural). So \textbf{\hi{मैं} \hi{खेलता} \hi{हूँ} / \hi{मैं} \hi{खेलती} \hi{हूँ}} means \textquotedblleft{}I play,\textquotedblright{} while \textbf{\hi{आप} \hi{खेलते} \hi{हैं}} means \textquotedblleft{}you play.\textquotedblright{}
...
\raggedright
  ...
  \item \emph{Say it:} \textbf{\hi{मैं} \hi{खेलता} \hi{हूँ}} (\emph{maiṁ kheltā hūṁ}) if masculine; \textbf{\hi{मैं} \hi{खेलती} \hi{हूँ}} (\emph{maiṁ kheltī hūṁ}) if feminine
  \item \emph{Say it:} \textquotedblleft{}you (resp.) play\textquotedblright{} — \textbf{\hi{आप} \hi{खेलते} \hi{हैं}} (\emph{āp khelte haiṁ})
  \item \emph{Write it:} \hi{खेल}, then add \hi{ना} to the end of it
  \item \emph{Recall:} read \textbf{\hi{भारत}}, then say \emph{rel}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What does \hi{खेलना} mean? (\textquotedblleft{}to play\textquotedblright{}.) And \hi{खेल}? (\textquotedblleft{}a game\textquotedblright{}.) Give the masculine, feminine, and respectful or plural present forms. (\textbf{\hi{खेलता} / \hi{खेलती} / \hi{खेलते}}.)
\end{tcolorbox}
