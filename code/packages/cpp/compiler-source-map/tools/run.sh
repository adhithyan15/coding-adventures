#!/bin/sh
# Build and run the compiler-source-map tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp compiler_source_map-tests tests/compiler_source_map_test.cpp
