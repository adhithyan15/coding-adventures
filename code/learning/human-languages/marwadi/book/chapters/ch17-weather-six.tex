...
% canonical-source-hash: fnv1a64:d17d6375f0701786
...
\subsection*{Script — one sign}
\hlblockfigure{\detokenize{figures/MW-W12-ga-filmstrip.pdf}}{How \mw{ग} is written, stroke by stroke}
...
\subsection*{Script — one sign}
\hlblockfigure{\detokenize{figures/MW-W12-dda-filmstrip.pdf}}{How \mw{ड} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item Identify six heard words.
  \item Produce six words from meaning cues.
  \item Match six printed cards to meanings.
  \item Write three heard words from each half without a model.
\end{enumerate}
