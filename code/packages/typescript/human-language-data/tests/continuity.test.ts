...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    expect(report.summary.tracksWithUnorderedLessons).toBe(11); // HL-C251: -1 -- IMPROVEMENT, the migrated russian ch1 lessons close a continuity window that nothing could measure while they were v1 // HL11: -5. Hindi, Telugu, Kannada, Malayalam and Sanskrit now declare a reading order for every lesson, recovered from their own books
