# Build and run the pbkdf2 tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
$env:ISO_INCLUDE = "include ..\hmac\include ..\sha1\include ..\sha256\include ..\sha512\include $harness\include"
. (Join-Path $harness 'lib\iso-lib.ps1')
Iso-BuildAndRun -Lang c -Name pbkdf2-tests -Sources @("tests\pbkdf2_test.c", "src\pbkdf2.c", "..\hmac\src\hmac.c", "..\sha1\src\sha1.c", "..\sha256\src\sha256.c", "..\sha512\src\sha512.c")
