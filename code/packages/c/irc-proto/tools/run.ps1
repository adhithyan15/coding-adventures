# Build and run the irc-proto tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name irc_proto-tests -Sources @("tests\irc_proto_test.c", "src\irc_proto.c")
