...
private:
  ...
  using ControlFileFn = unsigned char (*)(void *, const char *, const char *, const char *,
  ...
  ControlClipboardFn filePickerRequest_ = nullptr;
  ControlFileFn controlFile_ = nullptr;
