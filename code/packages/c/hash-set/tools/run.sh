#!/bin/sh
# Build and run the hash-set tests under EVERY available C/C++ compiler (pure ISO),
...
# Include this package's headers, the sibling hash-map's, and the harness's.
ISO_INCLUDE="include ../hash-map/include $HARNESS/include"
export ISO_INCLUDE
...
# The test compiles the sibling hash-map source in.
iso_build_and_run c hash_set-tests tests/hash_set_test.c src/hash_set.c ../hash-map/src/hash_map.c
