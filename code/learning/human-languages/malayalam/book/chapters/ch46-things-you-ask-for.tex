...
% canonical-source-hash: fnv1a64:6c579407202b39bb
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{paḻaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{paḻaṁ}, then \emph{dayavāyi paḻaṁ tarū} — \textquotedblleft{}please give a fruit\textquotedblright{}
  \item \emph{Recall:} say \emph{nilkkū}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{paḻaṁ}, then \emph{tuṇi}, and ask for each one with \emph{dayavāyi}
  \item \emph{Recall:} read \textbf{\ml{തരൂ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{viḷakkŭ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{viḷakkŭ}, then \emph{tuṇi}, and hear which of the two is the older resident
  \item \emph{Recall:} say \emph{nōkkū}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{uppŭ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{uppŭ}, then \emph{paḻaṁ}, and notice the \emph{p} the cousins kept in one word and lost in the other
  \item \emph{Recall:} read \textbf{\ml{കേൾക്കൂ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{pustakaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{paḻaṁ}, \emph{tuṇi}, \emph{viḷakkŭ}, \emph{uppŭ}, \emph{pustakaṁ}
  \item \emph{Recall:} say \emph{saṁsārikkū}
\end{itemize}
