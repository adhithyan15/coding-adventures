#!/bin/sh
# Build and run the tree-set tests under EVERY available C/C++ compiler (pure ISO),
...
ISO_INCLUDE="include ../avl-tree/include ../red-black-tree/include $HARNESS/include"
export ISO_INCLUDE
...
iso_build_and_run cpp tree_set-tests tests/tree_set_test.cpp
