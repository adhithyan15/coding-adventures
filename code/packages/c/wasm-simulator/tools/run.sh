#!/bin/sh
# Build and run the wasm-simulator tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c wasm_simulator-tests tests/wasm_simulator_test.c src/wasm_simulator.c
