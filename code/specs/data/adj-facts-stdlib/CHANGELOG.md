...
- **#13934 installment 4n: two sentences from two different paragraphs, welded.**
  ...
  **0** removed, in **1** `.adj` file (28 added / 1 removed lines in total) —
  ...
  | S2 "When a person rides a bicycle down a steep hill and picks up speed, the gravitational energy is converting to motion energy." | 1 | **ends** a different paragraph, **606 raw characters** later, **6** block-element tags in between |
