module github.com/adhithyan15/coding-adventures/code/packages/go/brotli

go 1.23

require github.com/adhithyan15/coding-adventures/code/packages/go/huffman-tree v0.0.0
