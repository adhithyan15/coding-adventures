...
% canonical-source-hash: fnv1a64:a2727231bc32243c
...
\raggedright
  ...
  \item \emph{Say it:} \emph{kṛtajñata}, then \emph{nandi}, the formal and the everyday
  \item \emph{Recall:} say \emph{satyaṁ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{upakāraṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{upakāraṁ}, then \emph{dayavāyi}, two courtesies made the same way
  \item \emph{Recall:} read \textbf{\ml{മതി}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{bahumānaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{bahumānaṁ}, then \emph{manassilākkuka}, and find the piece they share
  \item \emph{Recall:} say \emph{tīrccayāyuṁ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{anugrahaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{anugrahaṁ}, then \emph{bahumānaṁ}, both of them things given rather than taken
  \item \emph{Recall:} read \textbf{\ml{ഒരുപക്ഷേ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vandanaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{kṛtajñata}, \emph{upakāraṁ}, \emph{bahumānaṁ}, \emph{anugrahaṁ}, \emph{vandanaṁ}
  \item \emph{Recall:} say \emph{aṅṅane}
\end{itemize}
