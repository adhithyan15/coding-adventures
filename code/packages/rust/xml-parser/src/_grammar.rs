    ...
    ParserGrammar {
        ...
        GrammarRule {
            ...
            body: GrammarElement::Sequence { elements: vec![
                ...
                GrammarElement::Repetition { element: Box::new(GrammarElement::TokenReference { name: r#"COMMENT_TEXT"#.to_string() }) },
        ...
        GrammarRule {
            ...
            body: GrammarElement::Sequence { elements: vec![
                ...
                GrammarElement::Repetition { element: Box::new(GrammarElement::TokenReference { name: r#"CDATA_TEXT"#.to_string() }) },
        ...
        GrammarRule {
            ...
            body: GrammarElement::Sequence { elements: vec![
                ...
                GrammarElement::Repetition { element: Box::new(GrammarElement::TokenReference { name: r#"PI_TEXT"#.to_string() }) },
