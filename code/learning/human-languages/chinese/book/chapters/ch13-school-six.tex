...
\hlblockfigure{\detokenize{figures/ZH-W13-da-filmstrip.pdf}}{How \zh{大} is written, stroke by stroke}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/ZH-W13-xue-filmstrip.pdf}}{How \zh{学} is written, stroke by stroke}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/ZH-W13-sheng-filmstrip.pdf}}{How \zh{生} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listening:} hear six words in mixed order and choose every meaning.
  \item \textbf{Speaking:} produce all six from meaning cards, with tones audible.
  \item \textbf{Reading:} read all six character cards without pinyin.
