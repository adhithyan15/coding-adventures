...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C57-back]
---

# ತುಟಿ (tuṭi) — a lip

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C57-BODY-01, KA-LEX-C57-BODY-02] -->

[PAUSE 2s] Before the new one: what did *bennu* mean?

## You'll want to know: ತುಟಿ
<!-- hl-knowledge: introduces=[KA-LEX-C57-BODY-03]; assesses=[] -->
...
[PAUSE 3s] What does ತುಟಿ mean? ("a lip".) Say it once more.
`,D=e({default:()=>O}),O=`---
schema_version: 2
id: KA-C57-neck
spine_node: SPINE-CHECK-WELLBEING
...
[PAUSE 2s] Before the new one: what did *kaḍime* mean?

## You'll want to know: ಬೇಡ
<!-- hl-knowledge: introduces=[KA-LEX-C58-REPLY-04]; assesses=[] -->
...
[PAUSE 3s] What does ಬೇಡ mean? ("no thank you, I don't want it".) Say it once more.
`,z=e({default:()=>B}),B=`---
schema_version: 2
id: KA-C58-thats-all
spine_node: SPINE-RESPOND-BASIC
...
[PAUSE 2s] Before the new one: what did *kesaru* mean?

## You'll want to know: ಬೆಂಕಿ
<!-- hl-knowledge: introduces=[KA-LEX-C59-GROUND-05]; assesses=[] -->

**ಬೆಂಕಿ** (*beṅki*) — "fire".

Kannada's own, and once again it stands apart from its sisters: Tamil reaches for *neruppu*, Telugu for *maṇṭa*, and Kannada for ಬೆಂಕಿ. The bone-word did this to you a chapter ago. Being close relatives has never obliged four languages to agree.
...
[PAUSE 3s] What does ಬೆಂಕಿ mean? ("fire".) Say it once more.
`,U=e({default:()=>W}),W=`---
schema_version: 2
id: KA-C59-mist
spine_node: SPINE-TAKE-LEAVE
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C59-wind]
---

# ಮಂಜು (mañju) — mist, fog, frost

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C58-REPLY-05, KA-LEX-C59-GROUND-01] -->

[PAUSE 2s] Before the new one: what did *gāḷi* mean?

## You'll want to know: ಮಂಜು
<!-- hl-knowledge: introduces=[KA-LEX-C59-GROUND-02]; assesses=[] -->
...
[PAUSE 3s] What does ಮಂಜು mean? ("mist, fog, frost".) Say it once more.
`,G=e({default:()=>K}),K=`---
schema_version: 2
id: KA-C59-mud
spine_node: SPINE-TAKE-LEAVE
...
register: neutral
variety: standard-colloquial
reviews_of: [KA-C58-thats-all]
---

# ಗಾಳಿ (gāḷi) — wind, air

## Warm-up
<!-- hl-knowledge: introduces=[]; assesses=[KA-LEX-C58-REPLY-04, KA-LEX-C58-REPLY-05] -->

[PAUSE 2s] Before the new run: what did *bēḍa* mean, and what did *aṣṭē* mean?

## You'll want to know: ಗಾಳಿ
<!-- hl-knowledge: introduces=[KA-LEX-C59-GROUND-01]; assesses=[] -->
...
[PAUSE 3s] What does ಗಾಳಿ mean? ("wind, air".) Say it once more.
