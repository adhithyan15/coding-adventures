...
\hlblockfigure{\detokenize{figures/JA-W08-yo-filmstrip.pdf}}{How \ja{よ} is written, stroke by stroke}
...
\subsection*{Script — one sign}
\hlblockfigure{\detokenize{figures/JA-W08-na-filmstrip.pdf}}{How \ja{な} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item Point and read: \textbf{\ja{さ} | \ja{よ} | \ja{う} | \ja{な} | \ja{ら}}.
  \item Cover the romanization and read \textbf{\ja{さようなら}}.
  \item Cover everything, wait ten seconds, and write the five signs.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listen:} hear \emph{konnichiwa} or \emph{sayōnara} and identify meeting or parting.
  \item \textbf{Speak:} answer a parting cue with \emph{sayōnara} on five morae.
  \item \textbf{Read:} cover the romanization and read \textbf{\ja{さようなら}} sign by sign.
  \item \textbf{Write:} hear the word, wait ten seconds, and write all five signs.
\end{enumerate}
