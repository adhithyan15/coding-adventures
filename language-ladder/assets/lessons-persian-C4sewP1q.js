...
chapter: 1
type: practice
headword: "سلام · ممنون · بله · نه"
romanization: "salâm · mamnun · bale · na"
gloss: greet, thank, answer, and revisit one alef with help
prerequisites: [FA-C01-na, FA-W00-alef-guided-copy]
...
reviews_of: [FA-C01-salam, FA-C01-mamnoon, FA-C01-bale, FA-C01-na, FA-W00-alef-guided-copy]
---

# Chapter 1 — one tiny exchange, one tiny mark
...
- B: **سلام** — *salâm*
- A: **ممنون** — *mamnun*
- B: **بله** or **نه** — *bale* or *na*

The later three words remain visible whole-word supports. Today you are proving
the greeting and the page direction, not decoding every letter.
...
## Writing — follow one visible stroke
<!-- hl-knowledge: introduces=[]; assesses=[FA-SCRIPT-RTL-01] -->
<!-- hl-writing-stage: observe-trace -->

Keep this model visible: **ا**. With your finger, trace its one upright stroke
from top to bottom. Do not copy it yet and do not hunt for it inside the joined
word. The next two-minute lesson will name and copy this one shape.
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[FA-LEX-SALAM-01, FA-ETYMON-SALAM-SLM-02, FA-SCRIPT-RTL-01] -->

Which direction does Persian run? (**Right to left.**) What old idea lives
inside *salâm*? (**Peace, safety, or wholeness.**) Say the greeting once.
