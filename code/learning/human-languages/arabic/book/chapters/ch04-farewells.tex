...
\raggedright
  ...
  \item {[}YOU SAY: the family — \textquotedblleft{}\emph{ʿayn} \ar{ع}, and \emph{ghayn} \ar{غ} = the same shape \textbf{plus one dot}\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}\emph{ʿayin} = \textbf{eye} $\to$ the Greeks made it \textbf{O}\textquotedblright{}{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Two related shapes. \textbf{\ar{ه}} (\emph{hāʾ}) is a plain \textquotedblleft{}h\textquotedblright{} — and the most \textbf{shape-shifting} letter you've met, wearing four genuinely different coats. Then \textbf{\ar{ة}}, a letter built \emph{out of} it, whose whole job is to say one grammatical thing: \textbf{this word is feminine}.
\end{quote}
...
\raggedright
  ...
  \item {[}YOU SAY: the name — \textquotedblleft{}\emph{tāʾ marbūṭa}, the \textbf{tied} tāʾ — it marks the feminine\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}\emph{hē} $\to$ Greek epsilon $\to$ Latin \textbf{E}\textquotedblright{}{]}
\end{itemize}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} The closing move. \textbf{\ar{مع} \ar{السلامة}} (\emph{maʿa s-salāma}) is how Arabic says goodbye — literally \textquotedblleft{}\textbf{with safety},\textquotedblright{} \emph{go in peace}. And the heart of it is a word you wrote \textbf{all the way back in Lesson 3}: \textbf{\ar{سلام}}. Everything since has been leading here.
\end{quote}
...
\raggedright
  ...
  \item {[}YOU WRITE: \textbf{\ar{السلامة}} — \textquotedblleft{}the \emph{al-}, then your Lesson-3 word, then the feminine \ar{ة}\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}\emph{maʿa s-salāma} — \textbf{with safety}\textquotedblright{}{]}
  \item {[}YOU SAY: the bookend — \textquotedblleft{}\textbf{\ar{السلام} \ar{عليكم}} to greet, \textbf{\ar{مع} \ar{السلامة}} to part — same root \textbf{s-l-m}\textquotedblright{}{]}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}\emph{maʿa}\textquotedblright{} — the \emph{ʿayn} from the throat{]}
  \item {[}YOU SAY: the contrast — \textquotedblleft{}\emph{bi-khayr} \textbf{in} goodness · \emph{maʿa} \textbf{with}\textquotedblright{}{]}
  \item {[}YOU SAY: the cousin — \textquotedblleft{}\emph{maʿa} · Hebrew \emph{ʿim}\textquotedblright{}{]}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}\emph{as-salāma}\textquotedblright{} — with the doubled \emph{s}, not \emph{al-s}{]}
  \item {[}YOU SAY: the build — \textquotedblleft{}\emph{salām} … \emph{salāma} … \emph{as-salāma}\textquotedblright{}{]}
  \item {[}YOU SAY: the pattern — \textquotedblleft{}peace $\to$ \textbf{the state of} peace\textquotedblright{}{]}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}\emph{maʿa s-salāma}\textquotedblright{}{]}
  \item {[}YOU SAY: the bookend — \textquotedblleft{}\emph{as-salāmu ʿalaykum} … \emph{maʿa s-salāma}\textquotedblright{}{]}
  \item {[}YOU SAY: the root aloud — \textquotedblleft{}\textbf{s · l · m}\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}goodbye $\leftarrow$ God be \textbf{with} ye\textquotedblright{}{]}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}\emph{ilā l-liqāʾ}\textquotedblright{} — double the \emph{l}{]}
  \item {[}YOU SAY: the two farewells — \textquotedblleft{}\emph{maʿa s-salāma} · \emph{ilā l-liqāʾ}\textquotedblright{}{]}
  \item {[}YOU SAY: the loan — \textquotedblleft{}\emph{hasta} $\leftarrow$ \emph{ḥattā}\textquotedblright{}{]}
  \item {[}YOU SAY: the root — \textquotedblleft{}\textbf{l · q · y} — to meet\textquotedblright{}{]}
\end{itemize}
...
\raggedright
  ...
  \item {[}YOU SAY: the bookend — \textquotedblleft{}\textbf{\ar{السلام}} to open, \textbf{\ar{السلامة}} to close\textquotedblright{}{]}
\end{itemize}
