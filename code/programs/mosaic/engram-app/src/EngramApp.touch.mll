// EngramApp.touch.mll - touch / mobile layout for the Engram app shell (UI30).
//
// The desktop shell (EngramApp.mll) lays the header out as a horizontal Row:
// the app title sits on the LEFT and a Row of SIX nav buttons (Decks, Study,
// Browse, Add, Stats, Options) sits to its RIGHT. On a phone-width viewport
// six side-by-side buttons overflow — there is nowhere near enough horizontal
// room. The touch variant stacks everything vertically instead:
//
//   Column [app-shell]
