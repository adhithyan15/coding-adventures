# Build and run the clr-simulator tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name clr_simulator-tests -Sources @("tests\clr_simulator_test.cpp")
