...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Like Kannada, Telugu's week runs on Sanskrit deity-names — but its Sunday breaks the \textquotedblleft{}planet\textquotedblright{} pattern entirely, in a way even Kannada's doesn't.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}Somavāram, Maṅgaḷavāram, Budhavāram, Guruvāram, Śukravāram, Śanivāram\textquotedblright{} — Monday through Saturday{]}
  \item {[}YOU SAY: the odd one — \textquotedblleft{}Ādivāram\textquotedblright{} — not a planet, \textquotedblleft{}the first day\textquotedblright{}{]}
