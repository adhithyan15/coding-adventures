...
\setlength{\itemsep}{0.35em}
  ...
  \end{minipage}
  \item \begin{minipage}[t]{\linewidth}
  \textbf{Sound id:} \texttt{ze}
  \par \textbf{What to do:} read \textbf{\fa{ز}} as English \emph{z}; an ordinary letter from the inherited Arabic set
  \par \textbf{First anchor:} \textbf{\fa{زبان}} \emph{zabân}
  \end{minipage}
  \item \begin{minipage}[t]{\linewidth}
  \textbf{Sound id:} \texttt{heh-e}
  \par \textbf{What to do:} read a word-final \textbf{\fa{ه}} as the vowel \emph{-e}, not as a consonant
  \par \textbf{First anchor:} \textbf{\fa{ستاره}} \emph{setâre}
  \end{minipage}
\end{itemize}
...
\setlength{\itemsep}{0.35em}
  ...
  \item The requests, family, and body chapters need only one new letter across all twelve words: \textbf{\fa{ز}} \emph{ze}, an ordinary member of the inherited Arabic set, inside \textbf{\fa{زبان}} \emph{zabân}. Every other word in those three chapters — \textbf{\fa{آب}}, \textbf{\fa{نان}}, \textbf{\fa{چای}}, \textbf{\fa{کلید}}, \textbf{\fa{مادر}}, \textbf{\fa{پدر}}, \textbf{\fa{برادر}}, \textbf{\fa{دختر}}, \textbf{\fa{چشم}}, \textbf{\fa{دست}}, \textbf{\fa{پا}} — reuses letters already met.
  \item The next fourteen words — \textbf{\fa{نام}}, \textbf{\fa{دل}}, \textbf{\fa{در}}, \textbf{\fa{کتاب}}, \textbf{\fa{آسمان}}, \textbf{\fa{خورشید}}, \textbf{\fa{ماه}}, \textbf{\fa{ستاره}}, \textbf{\fa{باران}}, \textbf{\fa{خواهر}}, \textbf{\fa{پسر}}, \textbf{\fa{مرد}}, \textbf{\fa{زن}}, \textbf{\fa{دوست}} — need no new letters at all, only one new habit: \textbf{\fa{ستاره}}'s final \textbf{\fa{ه}} carries the vowel \emph{-e} rather than a consonant, the sound id \texttt{heh-e}.
\end{itemize}
