module github.com/adhithyan15/coding-adventures/code/packages/go/sql-execution-engine
...
require (
	...
	github.com/adhithyan15/coding-adventures/code/packages/go/sql-parser v0.0.0
)
