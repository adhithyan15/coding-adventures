...
- Added 142 strict, per-glyph declarations for Japanese, Perso-Arabic, Tamil, and Urdu-Nastaliq so shard validation detects clean inventory-owner deletion without introducing a shared script-sized manifest.
