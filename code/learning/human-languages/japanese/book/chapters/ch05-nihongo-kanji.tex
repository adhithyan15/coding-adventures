...
\begin{enumerate}
\raggedright
  \item the left side, down
  \item the top and right side as one turning stroke
  \item the short middle line, left to right
  \item the bottom line, left to right
\end{enumerate}
...
\raggedright
  \item top horizontal
  \item centre vertical, down through it
  \item left-falling branch
  \item right-falling branch
  \item short horizontal across the lower stem
\end{enumerate}
...
\raggedright
  \item left side, down
  \item top and right side as one turning stroke
  \item bottom, left to right, closing the box
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item write \ja{言}, narrow, on the left
  \item write \ja{五} in the upper-right
  \item write \ja{口} directly under \ja{五}
\end{enumerate}
