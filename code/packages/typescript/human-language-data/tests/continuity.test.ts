...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    expect(report.summary.missedByWindow.R2).toBe(3675); // -2: early quién revisits two existing atoms inside R2.
    /* Historical ratchet ledger retained below; this tranche supersedes its numeric pin.
  ...
  it("shows what a declared reading order was worth", () => {
    ...
    expect(spanish).toMatchObject({
      ...
      /* Historical lesson-count ledger retained below; this tranche supersedes its pin.
      ...
      */
      lessonCount: 585, // +1: the early quién micro-lesson.
