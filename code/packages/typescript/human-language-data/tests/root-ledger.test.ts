...
describe("the committed corpus", () => {
  ...
  it("pins the first ledger, and it is the reason the rule exists", () => {
    ...
    expect(byNamespace).toEqual({ roots: 2194, "etymon-atom": 888 }); // +2: Italian and Persian migrated opener etymons.
  });
