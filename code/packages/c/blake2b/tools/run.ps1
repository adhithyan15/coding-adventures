# Build and run the blake2b tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name blake2b-tests -Sources @("tests\blake2b_test.c", "src\blake2b.c")
