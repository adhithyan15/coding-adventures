#!/bin/sh
# Build and run the zstd tests under EVERY available C/C++ compiler (pure ISO),
...
# Include this package's headers, the sibling lzss package (our LZ77
# match-finder dependency, CMP02), and the harness's (for iso_test.h).
...
# The test links this package plus the lzss sources (leaf-to-root).
iso_build_and_run c zstd-tests tests/zstd_test.c src/zstd.c ../lzss/src/lzss.c
