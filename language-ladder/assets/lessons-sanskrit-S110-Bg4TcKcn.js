...
<!-- hl-knowledge: introduces=[SA-SCRIPT-RECOG-110]; assesses=[] -->
...
[PAUSE 3s] Which character is this — र? What sound does it carry? (***ra***.)
...
<!-- hl-knowledge: introduces=[SA-SCRIPT-RECOG-111]; assesses=[] -->
...
[PAUSE 3s] Which character is this — क? What sound does it carry? (***ka***.)
Name one word you already say that contains it.
`,a=e({default:()=>o}),o=`---
schema_version: 2
...
<!-- hl-knowledge: introduces=[SA-SCRIPT-RECOG-112]; assesses=[] -->
...
Put your pen on ◌े and follow its line. Copy the shape you can see — slowly,
...
[PAUSE 3s] Which character is this — ◌े? What vowel does it put on the consonant it attaches to — and what does it take off? (**Puts *e* on; takes the built-in *a* off.**)
Name one word you already say that contains it.
`,s=e({default:()=>c}),c=`---
schema_version: 2
...
<!-- hl-knowledge: introduces=[SA-SCRIPT-RECOG-113]; assesses=[] -->
...
[PAUSE 3s] Which character is this — प? What sound does it carry? (***pa***.)
Name one word you already say that contains it.
`,l=e({default:()=>u}),u=`---
schema_version: 2
...
<!-- hl-knowledge: introduces=[SA-SCRIPT-RECOG-114]; assesses=[] -->
...
[PAUSE 3s] Which character is this — ह? What sound does it carry? (***ha***.)
Name one word you already say that contains it.
