...
% canonical-source-hash: fnv1a64:b62ed5de8d9feb61
% canonical-lessons: GE-C30-auge, GE-C30-ohr, GE-C30-mund, GE-C30-nase, GE-R30-kopf-und-haupt
...
\end{tcolorbox}
\section[Practice]{Kopf und Haupt — two words for one head, and only one of them survived}

\label{lesson:GE-R30-kopf-und-haupt}



\begin{quote}
The nose. Say it — long \textbf{a}, and the \textbf{s} buzzes like a \emph{z}. Then say the verb for what the eyes above it do.
\end{quote}
...
German has two words for a head, and the one it uses every day is the one that did not start out meaning a head at all.

\noindent
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
\toprule
\textbf{word} & \textbf{where it came from} & \textbf{where it is now} \\
\midrule
\textbf{Haupt} & the inherited Germanic head-word, cousin of English \emph{head} & formal, poetic, and alive mainly in compounds \\
\textbf{Kopf} & a word for a \textbf{cup} or \textbf{bowl} & the ordinary, everyday head \\
\bottomrule
\end{tabularx}

A container word pushed the inherited word aside — the same move that gave French \emph{tête} from Latin \emph{testa}, a pot. Bodies get named after the things they resemble, and the joke outlives the people who made it.

Which is why the pains go on \textbf{Kopf} and not on \emph{Haupt}: \emph{Kopfschmerzen} is built from the everyday word, because that is the word you reach for when something hurts.
\end{tcolorbox}

\subsection*{Your turn}
Four you have not been asked for in a long while.

Say these aloud:

\begin{itemize}
\raggedright
  \item \emph{auf} — \textbf{au} as \emph{ow}
  \item \emph{freut mich} — \textbf{eu} as \emph{oy}
  \item the noun inside the warm thank-you — \emph{Dank}
  \item the shrug that answers \emph{how are you} — \emph{es geht}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which of the two head-words is the inherited one, and which is the one you actually use? (\emph{\textbf{Haupt}} inherited; \emph{\textbf{Kopf}} everyday.) What did \emph{Kopf} mean first? (\textbf{A cup or bowl.}) Say the nose, and keep the \textbf{s} buzzing.
\end{tcolorbox}
