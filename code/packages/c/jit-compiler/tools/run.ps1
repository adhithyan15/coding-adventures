# Build and run the jit-compiler tests under MSVC (cl.exe) — pure ISO C/C++ — via
# the shared iso-harness (code\packages\c\iso-harness).
...
Iso-BuildAndRun -Lang c -Name jit_compiler-tests -Sources @("tests\jit_compiler_test.c", "src\jit_compiler.c")
