// index.js -- Load the native Bitset addon
// ==========================================
//
...
const native = require("./bitset_native_node.node");

// Re-export the Bitset class so consumers can do:
//   import { Bitset } from "@coding-adventures/bitset-native";
export const { Bitset } = native;
