...
\begin{enumerate}
\raggedright
  \item \textbf{Listen:} hear one line with no text and identify greeting, language, answer, or thanks.
  \item \textbf{Speak:} take B's part while the other lines are read aloud.
  \item \textbf{Read:} run both voices from Japanese only, with the romanization covered.
  \item \textbf{Write:} hear \textbf{\ja{日本語}}, wait ten seconds, and write the three kanji with no visible model.
\end{enumerate}
