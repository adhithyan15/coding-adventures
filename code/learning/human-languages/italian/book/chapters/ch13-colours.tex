...
% canonical-source-hash: fnv1a64:e70844624a464674
% canonical-lessons: IT-C13-nero-bianco, IT-C13-rosso-blu, IT-C13-colori-origini
...
\end{tcolorbox}
\section[(the colour paths)]{The colour paths — five colours, three roads}

\label{lesson:IT-C13-colori-origini}



\begin{quote}
Say \textbf{rosso} and \textbf{blu}. One came down from Latin; the other walked in from the north. Which is which?
\end{quote}
...
\begin{itemize}
\raggedright
  \item the two Latin colours — \textquotedblleft{}nero, rosso\textquotedblright{}
  \item the two Germanic colours — \textquotedblleft{}bianco, blu\textquotedblright{}
  \item the one from Arabic — \textquotedblleft{}azzurro\textquotedblright{}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
How many roads do Italian's five colours come by? (\textbf{Three}: Latin for \emph{nero} and \emph{rosso}, Germanic for \emph{bianco} and \emph{blu}, Arabic for \emph{azzurro}.)
\end{tcolorbox}
