...
% canonical-source-hash: fnv1a64:87ac4449fbf5bcf3
% canonical-lessons: TA-C37-uur, TA-C37-nanban, TA-W18-read-uur, TA-C37-ivar, TA-C37-avar, TA-C37-ivar-en-nanbar
...
\end{tcolorbox}
\section[avar]{\ta{அவர்} (avar) — the far half of a table you already have}

\label{lesson:TA-C37-avar}



\begin{quote}
Say the word for \emph{this person}, the respectful one.

Now say which front letter points \textbf{near} and which points \textbf{away}. You were given both. \textbf{The lesson before this one filled in only the near half.}
\end{quote}

\subsection*{You'll want to know: \ta{அவர்}}
\begin{quote}
\textbf{\ta{அவர்}} — \emph{avar} — \textbf{that person} (away from you, spoken of respectfully)
\end{quote}

\textbf{One letter is the whole change.} \ta{இவர்} becomes \ta{அவர்}, and \emph{this person here} becomes \emph{that person there} — or, far more often, plain \textbf{he} or \textbf{she} about somebody who is not in the room.

Like \ta{இவர்}, it does not commit you to their sex, and like \ta{இவர்} it carries respect. The caution is the same one the earlier lesson gave: \textbf{\ta{அவர்}} is heard mostly of men, and \textbf{\ta{அவங்க}} (\emph{avaṅga}) does the same respectful job for a woman in speech.

\begin{grammarlens}[title={Grammar Lens: the column that was empty}]
\noindent
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
\toprule
\textbf{} & \textbf{near} & \textbf{far} \\
\midrule
a person, respectfully & \ta{இவர்} & \ta{அவர்} \\
\bottomrule
\end{tabularx}

The pointing system arrived a long way back, and it arrived as a \textbf{rule about a front letter} with only the near column filled in. A reader could say \emph{this person} and could say what \ta{அ}- would mean, and had no \ta{அ}- word to say.

\textbf{That is the ordinary way a gap survives}: the pattern gets taught, the pattern is correct, and nobody notices that half of what it predicts was never handed over.

Filling it costs one letter, and from here \textbf{\ta{அவர்}} is the word you reach for whenever you talk about somebody who is not present — which is most of the talking anybody does.
\end{grammarlens}
...
\raggedright
  \item \ta{அவர்}
  \item the near partner of it
  \item which single letter is the difference
  \item whether \ta{அவர்} tells you the person is a man or a woman (it does not)
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What does \ta{அவர்} mean? (\emph{That person}, respectfully — or plain \emph{he} or \emph{she} about somebody elsewhere.) Which front letter does it carry, and what does that letter do? (\textbf{\ta{அ}-}, which points away.)
\end{tcolorbox}
