...
## Unreleased — source-verified Persian gaf

- Teach Persian **گ** from its independently cited three-run freehand path.
- Preserve the body-before-slashes order and Persian-scoped provenance, then
  rerank **ز** next at 2.

## Unreleased — source-verified Persian and Urdu tah

- Teach Persian and Urdu **ط** with independently cited one-lift paths.
- Preserve their script-scoped identity and body-before-upright order, then
  rerank **گ** next at 2.
...
- Teach Kannada independent vowel **ಉ** from Gopala Krishna A's CC BY-SA 4.0,
  35-frame animation as one continuous path through the upper-left loop, both
  lower bowls, tall middle arch, and open upper terminal.
- Close both affected **ಉ** realizations in the alphabet filmstrip and fit the
  zero-lift order to the bundled Noto Sans Kannada outline, reranking Arabic
  **ق** first at 2.
...
- Teach small hiragana **っ** with the one-run movement from Sirgazil's
  24-frame CC0 **つ** animation, explicitly scaled to the bundled small-tsu
  glyph identified by Unicode 17.
- Close all 4 affected realizations and rerank Arabic **ظ** first at 4 without
  claiming a separate small-tsu handwriting animation.

### Added — source-verified Urdu retroflex tte

- Teach Urdu retroflex **ٹ** with *Zer o Zabar*'s independent-form order: draw
  the be-series body, lift once, then form the small to'e-shaped upper loop by
  moving down, back up, and down again.
- Close all 5 affected realizations and rerank Japanese small **っ** first at 4
  while preserving Urdu-specific provenance and the Nastaliq presentation.

### Added — source-backed Tamil dependent long u

- Teach Tamil dependent long-u **ூ** as Unicode's carrier-first U+0BC2 vowel
  sign, which normally ligates with its consonant.
- Close all 5 affected realizations without inventing handwriting direction or
  pen-lift claims, then rerank Urdu **ٹ** first at 5.
...
- Teach hiragana **く** with Sirgazil's 20-frame CC0 tracing order: sweep
  down-left from the upper right into the central turn, then continue down-right
  to the lower tip without lifting.
- Close all 5 affected realizations and rerank hiragana **た** first at 5 while
  preserving the measured source-closure queue.

### Added — source-verified Telugu independent u

- Teach Telugu independent **ఉ** with the packaged five-movement tracing order:
  a joined upper arch, broad bowl, and right lobe, followed by the separate
  inner bar and upper headstroke.
- Surface three pen-down runs and two lifts without inferring motion from the
  printed glyph alone; close all 6 affected realizations and rerank Japanese
  **く** first at 5.
...
- Teach Malayalam **ആ** with its source-backed two-run ductus: draw the left
  outer arch, lift once, then continue through the inner curl, lower loop,
  central upright, right loop, and below-line finish.
- Close all 6 affected realizations and rerank Arabic **ح** next at 6 while
  preserving the measured source-closure queue.

## Unreleased — source-verified Kannada independent aa

- Teach Kannada **ಆ** with its source-backed two-run ductus: join the compact
  left loop to the broad bowl, lift once, then draw the right loop and inner
  horizontal bar.
- Close all 6 affected realizations and rerank Malayalam independent **ಆ** next
  at 6 while preserving the measured source-closure queue.

## Unreleased — source-verified Kannada independent e

- Teach Kannada **ಎ** with its source-backed, zero-lift loop-to-arch ductus.
- Close all 6 affected realizations and rerank Kannada **ಆ** next at 6 while
  preserving the measured source-closure queue.

## Unreleased — source-verified Japanese hiragana mo

- Teach hiragana **も** with its source-backed three-run ductus: descend through
  the broad lower bowl, then lift for each left-to-right horizontal.
- Close all 6 affected realizations and rerank Kannada **ಎ** next at 6 while
  preserving the measured source-closure queue.
...
- Teach Malayalam independent **ഇ** with its own source-backed, zero-lift
  four-movement ductus from the compact spiral through the right lobe and
  below-line baseline.
- Close all 7 affected realizations in the alphabet filmstrip and rerank
  Malayalam independent **ഉ** next at 7.

## Unreleased — source-verified Telugu independent i

- Teach Telugu independent **ఇ** with its own source-backed three-stroke
  ductus: broad outer bowl, compact upper-left lobe, then angled upper-right
  shoulder.
- Close all 8 affected realizations in the alphabet filmstrip and rerank
  Malayalam independent **ഇ** next at 7.

## Unreleased — source-verified Telugu independent aa

- Teach Telugu independent **ఆ** with its own source-backed two-stroke ductus:
  the hooked left bowl, then the rounded right lobe after one lift.
- Close all 8 affected realizations in the alphabet filmstrip and rerank Telugu
  independent **ఇ** next at 8.
...
- Teach Kannada **ಇ** as one uninterrupted four-movement run with a deliberate
  middle-stem retrace from Yogesh's 98-frame handwriting animation.
- Close 8 affected realizations, preserve zero lifts in the Noto Sans Kannada
  filmstrip, and rerank Malayalam chillu **ൾ** next at 8.
...
- Teach Arabic, Persian, and Urdu **ٓ** as a sourced alef-plus-mark composition
  while retaining each script's own alif carrier provenance.
- Close the 9 Persian and Urdu gaps and rerank Tamil **ங** next at 9.

## Unreleased — source-verified Persian and Urdu che

- Teach Persian and Urdu **چ** with separately cited body-first head-and-bowl
  paths before the lower-left, lower-right, and lower-center dots.
- Preserve both four-stroke filmstrips and rerank maddah above **ٓ** next at 9.
...
- Preserve the source-backed carrier-first, Hamza-after writing order.
- Avoid inflating Arabic's canonical 29-row letter inventory with variants.
...
- Show Faa's loop flowing directly into its broad bowl before the upper dot.
- Keep the completion flag false until the final corpus letter lands.
