...
% canonical-source-hash: fnv1a64:c18e419bcb49beec
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{ātithyam}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{bahu}, then \emph{ātithyam}
  \item \emph{Recall:} say \emph{cakram}, then read \textbf{\sk{कदाचित्}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vinayaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{ātithyam}, then \emph{vinayaḥ}
  \item \emph{Recall:} read \textbf{\sk{कलशः}}, then say \emph{sahasā}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{namratā}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{vinayaḥ}, then \emph{namratā}
  \item \emph{Recall:} say \emph{plavaḥ}, then read \textbf{\sk{प्रायः}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{viśvāsaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{namratā}, then \emph{viśvāsaḥ}
  \item \emph{Recall:} read \textbf{\sk{दर्पणः}}, then say \emph{kiñcit}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{saralaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{ātithyam} and \emph{saralaḥ} together
  \item \emph{Recall:} say \emph{chatram}, then read \textbf{\sk{बहु}}
\end{itemize}
