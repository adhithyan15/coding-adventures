...
### VLT05 — Authentication ✅ shipped (Password + TOTP + WebAuthnPrfAuthenticator scaffold)
...
| `WebAuthnPrfAuthenticator`  | bind      | FIDO2 hmac-secret / PRF — derives key contribution (scaffold shipped; real hardware I/O + ECDSA P-256 verification deferred, `VLT-PM51`) |
