# Build and run the aarch64-encoder tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name aarch64_encoder-tests -Sources @("tests\aarch64_encoder_test.cpp")
