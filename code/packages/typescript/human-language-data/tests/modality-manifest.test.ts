...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3412, // The harakat split adds one lesson after the Arabic greeting ramp and Portuguese bridge.
      ...
      */
      ...
      pen: 363, // The harakat split adds one pen lesson to the merged Arabic and Portuguese total.
      drivableLessons: 2462, // Arabic adds two hands-free greetings while Portuguese removes one opener.
      /* Superseded merge-side totals:
      ...
      */
      ...
      // Italian Chapter 1 now begins with pen, so its former six-lesson voice prefix
      // becomes intentionally unavailable in the hands-free view.
