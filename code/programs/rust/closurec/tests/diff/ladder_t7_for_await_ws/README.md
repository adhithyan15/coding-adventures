# ladder_t7_for_await_ws

Rung 7.for_await of the CCR-066 differential complexity ladder, at `WHITESPACE_ONLY`.

## What this rung is for

Exercises a for-await-of loop inside an async function.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level WHITESPACE_ONLY --js tests/diff/ladder_t7_for_await_ws/input/a.js
```
