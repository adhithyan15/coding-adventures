#!/bin/sh
# Build and run the armv7-encoder tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c armv7_encoder-tests tests/armv7_encoder_test.c src/armv7_encoder.c
