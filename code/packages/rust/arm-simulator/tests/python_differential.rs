use arm_simulator::functional::{ArmState, Armv7Simulator, Flags};

fn seeded_state(cpu: &Armv7Simulator, raw: u32, seed: usize) -> ArmState {
...
fn hash_projected_state(state: &ArmState) -> u64 {
...
#[test]
fn python_common_surface_full_state_corpus_matches() {
    let mut count = 0;
    ...
    assert_eq!(count, 388, "corpus must retain every generated vector");
}
