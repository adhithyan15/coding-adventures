...
% canonical-source-hash: fnv1a64:a5f27dc794ae7df6
...
\raggedright
  ...
  \item \emph{Say it:} \emph{kirāmam}, then \emph{pāy}, the village and what is unrolled for you in it
  \item \emph{Recall:} say \emph{maram}, then read \textbf{\ta{நதி}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kūṭai}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{pāy}, then \emph{kūṭai}, and let the long \ta{ஊ} open the second
  \item \emph{Recall:} read \textbf{\ta{கிளை}}, then say \emph{malai}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kūṭai}, then \emph{katti}, and hold the doubled \ta{த}
  \item \emph{Recall:} say \emph{taḷir}, then read \textbf{\ta{வயல்}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kiṇṇam}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{katti}, then \emph{kiṇṇam}, and let the \ta{ண} double this time
  \item \emph{Recall:} read \textbf{\ta{வேர்}}, then say \emph{pātai}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{peṭṭi}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{pāy}, \emph{kūṭai}, \emph{katti}, \emph{kiṇṇam}, \emph{peṭṭi}
  \item \emph{Recall:} say \emph{vitai}, then read \textbf{\ta{கிராமம்}}
\end{itemize}
