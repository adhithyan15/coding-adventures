...
% canonical-source-hash: fnv1a64:64c8a4983f4bfbbf
% canonical-lessons: ML-S125-letter-uu, ML-S126-letter-oo, ML-C33-cintikkuka, ML-C33-manassilaakkuka, ML-C33-vaayikkuka, ML-C33-ezhutuka
...
It is an \textbf{independent vowel} — the shape a vowel takes when a word \emph{begins} with it, rather than the sign it becomes inside a word.
...
\begin{itemize}
\raggedright
  \item \textbf{\ml{ഉണ്ട്}} \emph{uṇṭŭ} — \textquotedblleft{}there is\textquotedblright{} — the short one, read since the core verbs
  \item \textbf{\ml{ഊ}} — the same vowel held longer, and the one you have been saying by ear in \emph{ūṇ}, \textquotedblleft{}a meal,\textquotedblright{} well before anybody asked you to write it
\end{itemize}
...
Which character is this — \ml{ഊ}? What sound does it carry? (\emph{\textbf{ū}}.) Which of the two is longer — \ml{ഉ} or \ml{ഊ}?
\end{tcolorbox}
...
It is an \textbf{independent vowel}, and you have been reading its other half for chapters.

Inside a word this vowel is a \textbf{sign} wrapped around the consonant — the \textbf{\ml{ോ}} of \textbf{\ml{പോകുക}} \emph{pōkuka} and \textbf{\ml{ചോറ്}} \emph{cōṟu}. When a word \textbf{starts} with the vowel there is no consonant to wrap, so the vowel needs a letter of its own: \textbf{\ml{ഓ}}.

\begin{itemize}
\raggedright
  \item \textbf{\ml{പോകുക}} \emph{pōkuka} — to go — the sign \textbf{\ml{ോ}}, riding a consonant
  \item \textbf{\ml{സുഖമാണോ}?} \emph{sukhamāṇō?} — are you well? — the same sign, at the end
  \item \textbf{\ml{ഓ}} — the letter, for a word that opens on the vowel
\end{itemize}
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which character is this — \ml{ഓ}? What sound does it carry? (\emph{\textbf{ō}}.) When does this vowel need the full letter \ml{ഓ} rather than the sign \ml{ോ}?
\end{tcolorbox}
