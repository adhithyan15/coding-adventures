# Changelog — CodingAdventures::Cas (Perl)
...
- `CodingAdventures::Cas` — main CAS wrapper. Hashes content with SHA-1,
...
- `CodingAdventures::Cas::BlobStore` — abstract base class defining the four
...
- `CodingAdventures::Cas::LocalDiskStore` — filesystem backend using Git's
