...
% canonical-source-hash: fnv1a64:5c00ac3bdf338aca
...
\hlblockfigure{\detokenize{figures/MW-W08-ba-filmstrip.pdf}}{How \mw{ब} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listen:} identify all four heard labels.
  \item \textbf{Speak:} produce two different labels from meanings.
  \item \textbf{Read:} match all four printed words.
  \item \textbf{Write:} write two heard labels without a model.
\end{enumerate}
