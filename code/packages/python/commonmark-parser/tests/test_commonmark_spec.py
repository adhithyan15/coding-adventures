...
This file runs all 652 examples from the CommonMark 0.31.2 specification,
...
The CommonMark 0.31.2 spec has exactly 652 numbered examples covering:
...
Passing all 652 examples means the parser is 100% CommonMark 0.31.2 compliant.
"""
...
def test_commonmark_spec_example(example: dict) -> None:
    """Run a single CommonMark spec example.
    ...
    assert actual == expected, (
        f"CommonMark spec example {example['example']} failed "
