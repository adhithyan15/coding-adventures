# Build and run the wide-int tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name wide_int-tests -Sources @("tests\wide_int_test.c", "src\wide_int.c")
