...
% canonical-source-hash: fnv1a64:3a594ba90e0bdac2
...
\raggedright
  ...
  \item \emph{Say it:} \emph{rassī}, then \emph{sūraj}, and say what the old word held in common
  \item \emph{Recall:} say \emph{bandar}, then read \textbf{\hi{बर्तन}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{sūī}, then \emph{kapṛā}, and say which one goes through the other
  \item \emph{Recall:} read \textbf{\hi{साँप}}, then say \emph{chammach}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{ṭokrī}, then \emph{sabzī} in it
  \item \emph{Recall:} say \emph{murgī}, then read \textbf{\hi{गिलास}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{miṭṭī}, then \emph{dīyā}, and say which one the other is made of
  \item \emph{Recall:} read \textbf{\hi{भैंस}}, then say \emph{tavā}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{merā nām} and your own name
  \item \emph{Recall:} say \emph{mor}, then read \textbf{\hi{चूल्हा}}
\end{itemize}
