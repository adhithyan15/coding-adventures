#!/bin/sh
# Build and run the lisp-vm tests under EVERY available C/C++ compiler (pure ISO),
...
ISO_INCLUDE="include ../lisp-compiler/include ../lisp-parser/include ../lisp-lexer/include $HARNESS/include"
export ISO_INCLUDE
...
iso_build_and_run cpp lisp_vm-tests tests/lisp_vm_test.cpp
