...
\expandafter\def\csname hlchaptermodality1\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (1) \quad \hlpensign{}~\textbf{pen} (10)\quad
...
\expandafter\def\csname hlchaptermodality2\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlsightsign{}~\textbf{eyes} (4) \quad \hlpensign{}~\textbf{pen} (11)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} none of the 15 lessons.%
    \par}\medskip
}
...
\expandafter\def\csname hlchaptermodality4\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlpensign{}~\textbf{pen} (5)\quad
...
\expandafter\def\csname hlchaptermodality8\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (2) \quad \hlsightsign{}~\textbf{eyes} (7) \quad \hlpensign{}~\textbf{pen} (1)\quad
...
\expandafter\def\csname hlchaptermodality19\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlpensign{}~\textbf{pen} (6)\quad
...
\expandafter\def\csname hlchaptermodality24\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (3) \quad \hlpensign{}~\textbf{pen} (5)\quad
...
\expandafter\def\csname hlchaptermodality26\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (3) \quad \hlpensign{}~\textbf{pen} (4)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 1 of 7 lessons.%
    \par}\medskip
}
...
\expandafter\def\csname hlchaptermodality27\endcsname{%
  {\small\noindent
    \textbf{Modes:} \hlvoicesign{}~\textbf{voice} (2) \quad \hlpensign{}~\textbf{pen} (6)\quad
    \hlvoicesign{}~\textbf{Hands-free start:} first 1 of 8 lessons.%
    \par}\medskip
}
