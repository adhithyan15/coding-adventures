...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3403, // +1: Spanish forward-use bridge
      ...
      voice: 2463, // Spanish's forward-use bridge is voice-first
      ...
      drivableLessons: 2463, // Spanish's bridge remains hands-free.
      ...
      unstartableChapters: 213, // Tamil chapter 1 now honestly starts with pen too.
      overriddenLessons: 0,
