...
% canonical-source-hash: fnv1a64:7d5ad96cd20ce331
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{pasu}, then read \textbf{\ta{தயிர்}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\ta{ஆடு}}, then say \emph{ney}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{kōḻi}, then read \textbf{\ta{எண்ணெய்}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\ta{காக்கை}}, then say \emph{vellam}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{paṟavai}, then read \textbf{\ta{சர்க்கரை}}
\end{itemize}
