...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}falei, falaste, falou, falámos, falaram\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}Ontem falei com a minha mãe\textquotedblright{} (\textquotedblleft{}Yesterday I spoke with my mother\textquotedblright{}){]}
  \item {[}YOU SAY: \textquotedblleft{}Trabalhei\textquotedblright{} — Ch. 5's verb in the past{]}
  \item {[}YOU SAY: the five fates — \textquotedblleft{}falou · habló · parlò · sagte · il parla\textquotedblright{}{]}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: the contrast — \textquotedblleft{}\textbf{falei} I spoke · \textbf{tenho falado} I've been speaking\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}Falei com ele ontem\textquotedblright{} — one event{]}
  \item {[}YOU SAY: \textquotedblleft{}Tenho falado com ele\textquotedblright{} — repeatedly, lately{]}
  \item {[}YOU SAY: the warning — \textquotedblleft{}\emph{tenho falado} is \textbf{not} 'I have spoken'\textquotedblright{}{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What does \emph{tenho falado} mean? (\textquotedblleft{}I \textbf{have been} speaking\textquotedblright{} — \textbf{repeatedly}, over a recent stretch.) What do you use for one finished act? (The simple past — \emph{\textbf{falei}}.) Why doesn't Portuguese's compound mean \textquotedblleft{}I spoke\textquotedblright{}? (Because \emph{\textbf{falei}} \textbf{never vacated} that slot, so the new construction took a different job.) Which languages let their compound take over the plain past? (\textbf{French, Italian, German}.)
\end{tcolorbox}
