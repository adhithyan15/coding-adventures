...
off the page. Let's gather them — and add the farewell, which is almost
word-for-word the Tamil one.
...
Malayalam, like Tamil, will not say a bare "I'm leaving." The everyday goodbye
is:

> **പോയി വരാം** (*pōyi varām*) — literally **"having gone, I [will] come
> [back]."**

Set it beside Tamil's *pōy varugiṟēṉ* and Kannada's *hōgi baruttēne*: the same
sentence, the same worldview — never simply depart, always promise a return —
...
- [YOU SAY: the farewell — "pōyi varām," and its Tamil twin "pōy varugiṟēṉ"]
...
illa, śari*.) What does the Malayalam goodbye literally mean, and which Tamil
farewell does it almost exactly match? ("Having gone, I'll come back" — Tamil
*pōy varugiṟēṉ*.)

That completes the four Dravidian first chapters — Tamil, Kannada, Telugu,
Malayalam. Next chapter: introducing yourself — *enṟe pēru…* ("my name…") — and
Malayalam's *nī* / *niṅṅaḷ* (familiar / respectful "you").
`,d=e({default:()=>f}),f=`---
id: ML-C01-sari
chapter: 1
type: word
