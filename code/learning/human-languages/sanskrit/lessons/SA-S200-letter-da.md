...
practises:
  knowledge: [SA-SCRIPT-RECOG-02, SA-SCRIPT-RECOG-200]
...
[PAUSE 1s] Before the new one, one you have already met: न. Say what it does.

[PAUSE 2s] One character this time. One only — and you have been saying it
for pages without knowing which mark on the page it was.

## Script you'll notice: द
<!-- hl-knowledge: introduces=[SA-SCRIPT-RECOG-200]; assesses=[] -->
...
You already say this word, and द is one of the shapes inside it — the rest of its shapes are still ahead of you, so here the character stands on its own:

- *dhanyavādaḥ* — thank you

## Writing: द
<!-- hl-knowledge: introduces=[]; assesses=[SA-SCRIPT-RECOG-200] -->
...
[PAUSE 1s]
- [YOU LOOK: at this, and find द in it]
