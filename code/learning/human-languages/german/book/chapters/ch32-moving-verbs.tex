...
% canonical-source-hash: fnv1a64:9a5880a4119c050e
...
\emph{Öffnen} is the neutral, slightly formal word. What people say out loud is \textbf{aufmachen}, and both halves are yours already: \textbf{auf} from \emph{auf Wiedersehen}, \textbf{machen} from your first verbs.
...
\begin{cousinweb}
Behind the verb is the adjective \textbf{offen}, \textquotedblleft{}open\textquotedblright{} — which the doing verbs already put beside \textbf{open} as a \textbf{p}-to-\textbf{f} pair from the second shift.
...
That makes two verbs here with the same shape of story. The doing verbs gave you \emph{nehmen}, which English lost to Norse \emph{take}. This is the second.
