...
% canonical-source-hash: fnv1a64:4b0042b78564b593
...
\raggedright
  ...
  \item \emph{Say it:} \emph{chatram}, then \emph{kadācit}
  \item \emph{Recall:} say \emph{dadhi}, then read \textbf{\sk{चक्रम्}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{sahasā}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kadācit}, then \emph{sahasā}
  \item \emph{Recall:} read \textbf{\sk{शर्करा}}, then say \emph{kalaśaḥ}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{sahasā}, then \emph{prāyaḥ}
  \item \emph{Recall:} say \emph{navanītam}, then read \textbf{\sk{प्लवः}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kiñcit}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{prāyaḥ}, then \emph{kiñcit}
  \item \emph{Recall:} read \textbf{\sk{शाकम्}}, then say \emph{darpaṇaḥ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{bahu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{kadācit} and \emph{bahu} together
  \item \emph{Recall:} say \emph{modakaḥ}, then read \textbf{\sk{छत्रम्}}
\end{itemize}
