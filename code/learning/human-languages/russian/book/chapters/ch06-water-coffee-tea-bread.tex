...
% canonical-source-hash: fnv1a64:f9d6fc0c6993a7b5
...
\emph{(K\ru{офе} is inanimate and masculine, so it takes exactly the same shape here as it does standing alone — nothing to adjust.)}
\end{cousinweb}
