...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} You already have \emph{medius diēs}. Rome had no separate word for \textquotedblleft{}afternoon\textquotedblright{}; it split the whole day around this word.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}merīdiēs\textquotedblright{} — the same medius diēs, contracted{]}
  \item {[}YOU SAY: \textquotedblleft{}ante merīdiem,\textquotedblright{} \textquotedblleft{}post merīdiem\textquotedblright{} — before/after noon, the source of a.m./p.m.{]}
  \item {[}YOU SAY: the honest twist — no separate Latin word for \textquotedblleft{}afternoon,\textquotedblright{} just a line drawn at noon{]}
\end{itemize}
