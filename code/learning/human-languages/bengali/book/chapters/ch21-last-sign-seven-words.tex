...
% canonical-source-hash: fnv1a64:8863c6cf729f4591
% canonical-lessons: BN-W03-mukh-read, BN-W02-lal-read, BN-W03-kalo-read, BN-W03-shada-read, BN-W04-ii-matra, BN-W04-nil-read, BN-W02-tin-read, BN-W04-ek-read

\chapter{The Last Sign, and Seven Words Back}
\label{ch:bn-last-sign-seven-words}
\hlchaptermodality{21}

\begin{chapteropening}
\textbf{By the end of this chapter:} \emph{I can read the colours, the mouth and two of the numerals off the page, write the long-i sign that completes the script this book teaches, and say why every one of these words reached my ear before it reached my eye.}
