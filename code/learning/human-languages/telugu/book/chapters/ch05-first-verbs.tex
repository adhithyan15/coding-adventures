...
% canonical-source-hash: fnv1a64:7a070fa1fec40d4d
...
Your tongue makes them in two different places. For \te{స} the tip touches just behind your teeth. For \te{ష} it curls back along the roof of your mouth, the same backward curl you already make for \te{ట}. The romanization marks the difference with one dot under the letter — \emph{s} against \emph{ṣ} — which is easy to miss in print and impossible to miss on the page, where they are two unlike shapes.
