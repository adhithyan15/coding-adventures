...
//     --manifest=C:/Users/adhit/Downloads/coding-adventures/.claude/worktrees/go-operations-generator/code/packages/go/vhdl-parser/required_capabilities.json
//
...
var _allowedPath_0 = sync.OnceValue(func() string {
	...
	return filepath.Clean(filepath.Join(filepath.Dir(_file), "../../../grammars/vhdl/vhdl.grammar"))
})
