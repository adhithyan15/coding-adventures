# Build and run the display tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name display-tests -Sources @("tests\display_test.c", "src\display.c")
