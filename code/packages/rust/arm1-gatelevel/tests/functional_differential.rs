...
#[test]
fn all_functional_instruction_family_transitions_match_full_state() {
    let fixture = include_str!("../../arm1-simulator/tests/python_oracle_hashes.txt");
    let mut cpu = ARM1GateLevel::new(MEMORY_SIZE);
    let mut count = 0;
