...
/// Check if a trimmed line is a GFM type 7 HTML block opener.
///
...
fn parse_link_definition(text: &str) -> Option<ParsedLinkDef> {
    ...
    // GFM spec §4.7: "The title may extend over multiple lines."
...
impl BlockParser {
    ...
    pub fn process_line(&mut self, raw_line: &str) {
        ...
        'block: loop {
            ...
            //
            // GFM spec §4.3: A setext heading underline only creates a
...
/// Parse GitHub Flavored Markdown input into a block tree.
///
