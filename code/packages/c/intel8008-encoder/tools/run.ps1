# Build and run the intel8008-encoder tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name intel8008_encoder-tests -Sources @("tests\intel8008_encoder_test.c", "src\intel8008_encoder.c")
