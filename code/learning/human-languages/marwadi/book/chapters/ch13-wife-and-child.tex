...
\hlblockfigure{\detokenize{figures/MW-W09-cha-filmstrip.pdf}}{How \mw{च} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listen:} identify six randomly heard labels.
  \item \textbf{Speak:} produce six different labels from relationship cues.
  \item \textbf{Read:} match all twelve printed labels to meanings.
  \item \textbf{Write:} write four heard labels without a model.
\end{enumerate}
