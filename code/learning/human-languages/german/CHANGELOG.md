...
German's hand-written chapters: **10 -> 9**.
...
- `handwritten_parity.py german`: **51 -> 50** blocks at risk.
...
| atoms taught | 297 | 329 |
| lessons with measured budgets | 139 | 155 |
| atom-measurement-blind lessons | 21 | 19 |
| chapters over the 12-atom budget | 5 | 6 |
| forward references | 36 | **34** |
| atoms never revisited | 81 | 86 |
| reinforcement window misses | 645 | 734 |
| corpus narration refusals | 51 | **49** |
| `handwritten_parity.py german` | 51 | 50 |
