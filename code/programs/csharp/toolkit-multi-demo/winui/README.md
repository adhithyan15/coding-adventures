# Button — WinUI 3 host project

Auto-generated by `mosaic-compile --backend xaml --emit-project`.

This project hosts a Mosaic-authored **UserControl** (Button) placed
...
`bin\Debug\net9.0-windows10.0.19041.0\Button.exe`. The native
...
- The `Button.xaml.cs` and `Button.xaml` files are auto-generated
...
|---|---|---|
| `Button.xaml` | mosaic-compile | No |
| `Button.xaml.cs` | mosaic-compile | No |
| `Button.Event.cs` | mosaic-compile | No |
| `MainWindow.xaml(.cs)` | --emit-project | **Yes** — your host |
| `App.xaml(.cs)` | --emit-project | Rare |
| `Button.csproj` | --emit-project | Rare |
