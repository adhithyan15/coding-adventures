...
Current selection: **RCPU-043**, the RISC-V RV32I functional audit. The distinct
07x functional/gate pair is complete; chronological work now advances to the
existing Spec 07a Rust package while earlier cells publish one at a time.
