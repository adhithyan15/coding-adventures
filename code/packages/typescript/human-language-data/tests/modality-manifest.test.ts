...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      pen: 229, // HL-C168: +1 -- Kannada's ledger closes at 24 of 24 // HL-C156: 85 script segments across the six Indic tracks // chinese script chapter: +7 lessons, +1 chapter -- the seven components 你好 is built from, one glyph each // japanese hiragana tranche: +10 lessons, +1 chapter -- eight signs, one per lesson, plus two assemblies that introduce none // gujarati script tranche: +10 lessons, +1 chapter (ch13) -- nine pieces, one per lesson, plus one assembly
      ...
      unstartableChapters: 185, // HL-C200: +35 telugu pre-A1 lessons, +7 chapters (chapters 46-52) // HL-C181: +5 -- chapter 277, the spine closes at 33/33 // +2: two of vocabulary wave 5's new chapters need eyes from their own first lesson // +1: HL-C88 slices 5-6 // +5: vocabulary wave 6 // HL-C113 step 7: +2 -- chapters 214 and 215 are sight-only // HL-C128 step 2: +1 -- ch223 // HL-C128 step 3: +1 // HL-C128 step 5: +1 // HL-C127: +2 // chinese script chapter: +7 lessons, +1 chapter -- the seven components 你好 is built from, one glyph each // japanese hiragana tranche: +10 lessons, +1 chapter -- eight signs, one per lesson, plus two assemblies that introduce none // gujarati script tranche: +10 lessons, +1 chapter (ch13) -- all ten need a pen, so the chapter has no drivable prefix
      overriddenLessons: 0,
