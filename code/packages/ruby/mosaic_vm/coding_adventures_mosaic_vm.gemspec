...
require_relative "lib/coding_adventures/mosaic_vm/version"

Gem::Specification.new do |spec|
  spec.name          = "coding_adventures_mosaic_vm"
  spec.version       = CodingAdventures::MosaicVm::VERSION
  spec.authors       = ["Adhithya Rajasekaran"]
  spec.summary       = "Generic tree walker that drives Mosaic compiler backends"
