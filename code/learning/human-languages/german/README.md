...
- **Chapter 10 — The Days of the Week**: Wochentage (the gods, and Mittwoch).
- **Chapter 11 — Telling the Time**: Uhr, Mittag/Mitternacht.
- **Chapter 12 — Months and Seasons**: Monate, Jahreszeiten (*Herbst*/harvest).
- **Chapter 13 — Family**: Eltern, Geschwister.
- **Chapter 14 — Bread, Water, Wine**: Brot, Wasser/Wein.
- **Chapter 15 — Numbers Eleven to Twenty**: elf/zwölf (the *-lif* "left over"
  story), 13–20.
- **Chapter 16 — Colours**: schwarz/weiß, rot/blau.
- **Chapter 17 — To Have**: *haben* — the four present forms the ending
...
- **Chapter 18 — The Wrapped Participle**: the weak past participle met one
...
- **Chapter 19 — The Past Built From Have**: the *Perfekt* — *haben* plus a
...
- **Chapter 20 — The Simple Past**: the *Präteritum* — *sagte*, *machte*,
...
- **Chapter 21 — I Am, You Are**: *sein*, met one present form per lesson —
  *bin*, *bist*, *ist*, *sind*, *seid* — plus *müde*, and the grid only at the
  end, as a recap.
- **Chapter 22 — Being Your Years**: *alt*, *das Jahr*, *Wie alt bist du?* and
...
- **Chapter 23 — Three Verbs Under One Roof**: *war/warst/waren*, the three
  Proto-Indo-European roots inside one infinitive, suppletion, and why the
  commonest words are the last to be regularised.
- **Chapter 24 — The Past That Takes To Be**: the *sein*-perfect —
  *kommen*, *fahren*, *werden*, *bleiben*, the learned list, and the
  participle that agrees with nothing where French has four forms.
- **Chapter 25 — Head and Hand**: *der Kopf*, *Haupt*, *die Hand*.
- **Chapter 26 — Yes and No**: *ja*, *nein*, and the negative-answer *doch*.
- **Chapter 27 — Please**: *Wasser, bitte* from previously learned words.
- **Chapter 28 — Sorry**: *Entschuldigung*, *es tut mir leid*.
- **Chapter 29 — Weather**: *das Wetter*, *es ist heiß/kalt*, *es regnet*.
- **Chapter 30 — Dog and Cat**: *Hund*, *Katze*.
- **Chapter 31 — Green and Yellow**: *grün*, *gelb*.
- **Chapter 32 — Verbs of the Mind**: *denken*, *verstehen*, *lesen*,
  *schreiben* — and the strong-verb vowel break (*du liest*).
- **Chapter 33 — Taking, Asking, Helping, Liking**: *nehmen*, *fragen*,
  *helfen*, *mögen/lieben* — and *gern*, German'''s third way of liking.
- **Chapter 34 — Sitting, Standing, Sleeping, Hearing**: *sitzen*, *stehen*,
  *schlafen*, *hören* — the second sound shift's *t*-branch, and a second way
  for a strong verb to break (*du schläfst*).
- **Chapter 35 — Going, Running, Opening, Closing**: *gehen*, *laufen*,
  *rennen*, *öffnen*, *schließen* — where German's walk/run line actually
  falls, and the first separable verbs (*Ich mache die Hand auf*).
- **Chapter 36 — Coffee, Tea, and Milk**: *der Kaffee*, *der Tee*, *die
  ...
  word.
- **Chapter 37 — Friend and Family**: *der Freund*, *die Freundin* (the
  native *-in* feminine suffix), *die Familie* (the one Latin loan in the
  chapter).
- **Chapter 38 — Eyes, Ears, Mouth, Nose**: *das Auge*, *das Ohr*, *der
  Mund*, *die Nase* — extends Chapter 25's body-part material to the rest of
  the face.
- **Chapter 39 — Arm, Finger, Foot, Heart**: *der Arm*, *der Finger*, *der
  Fuß*, *das Herz* — completes the five-word Hand/Arm/Finger/Fuß/Herz set
  Chapter 25 named but only a fifth of which it taught.

**All thirty-nine chapters are authored and in the book (367 pages).**
...
**Thirty-two of thirty-nine chapters are atom-scored: 1–9 and 17–39.** Those
are exactly the chapters whose lessons have been migrated to schema version 2
and so declare real knowledge atoms. Chapters 10–16 are still schema v1 and carry
...
| 17 To Have | `GE-C14-practice` | 8 / 8 = 1.00 |
| 18 The Wrapped Participle | `GE-C15-partizip-practice` | 7 / 7 = 1.00 |
| 19 The Past Built From Have | `GE-C15-perfekt-practice` | 8 / 8 = 1.00 |
| 20 The Simple Past | `GE-C15-praeteritum-practice` | 9 / 9 = 1.00 |
| 21 I Am, You Are | `GE-C16-praesens-practice` | 9 / 9 = 1.00 |
| 22 Being Your Years | `GE-C14-alter-practice` | 6 / 6 = 1.00 |
| 23 Three Verbs Under One Roof | `GE-C16-war-practice` | 7 / 7 = 1.00 |
| 24 The Past That Takes To Be | `GE-C16-haben-oder-sein` | 8 / 8 = 1.00 |
| 25 Head and Hand | `GE-C17-hand` | 4 / 12 = 0.33 — **below the floor** |
| 26 Yes and No | `GE-C18-nein` | 5 / 8 = 0.63 |
| 27 Please | `GE-C19-bitte-requests` | 3 / 3 = 1.00 |
| 28 Sorry | `GE-C20-entschuldigung` | 3 / 3 = 1.00 |
| 29 Weather | `GE-C21-das-wetter` | 5 / 5 = 1.00 |
| 30 Dog and Cat | `GE-C22-hund-katze` | 5 / 5 = 1.00 |
| 31 Green and Yellow | `GE-C23-gruen-gelb` | 5 / 5 = 1.00 |
| 32 Verbs of the Mind | `GE-C24-schreiben` | 10 / 10 = 1.00 |
| 33 Taking, Asking, Helping, Liking | `GE-C25-moegen-lieben` | 10 / 10 = 1.00 |
| 34 Sitting, Standing, Sleeping, Hearing | `GE-C26-hoeren` | 10 / 10 = 1.00 |
| 35 Going, Running, Opening, Closing | `GE-C27-schliessen` | 10 / 10 = 1.00 |
| 36 Coffee, Tea, and Milk | `GE-C28-milch` | 9 / 9 = 1.00 |
| 37 Friend and Family | `GE-C29-familie` | 9 / 9 = 1.00 |
| 38 Eyes, Ears, Mouth, Nose | `GE-C30-nase` | 12 / 12 = 1.00 |
| 39 Arm, Finger, Foot, Heart | `GE-C31-herz` | 12 / 12 = 1.00 |

Chapter 25 is the one authored chapter that fails. It runs three word lessons
...
real Kopf/Haupt/Hand practice lesson. Chapter 26 has the same missing-practice
shape but clears the floor because *nein* reassesses *ja*.

Chapters 32 and 33 close over **all** of their own atoms, and both payoffs also
reach back past their own chapter — chapter 32's to `GE-LEX-HAND-02`,
`GE-ETYMON-HAND-MANUS-05` and `GE-SOUND-GRIMMS-LAW-04` from chapter 25;
chapter 33's to all four of chapter 32's verbs plus `GE-LEX-HUND-02`,
...
Chapters 34 and 35 do the same and were written to drain it deliberately.
Chapter 34's payoff reaches to `GE-SOUND-GRIMMS-LAW-04` (ch. 22),
`GE-LEX-HUND-02`/`GE-ETYMON-HUND-03`/`GE-LEX-KATZE-04` (ch. 27) and all three
of chapter 33's closing atoms; chapter 35's reaches to `GE-LEX-NEHMEN-02`,
`GE-ETYMON-NEHMEN-03` and `GE-ETYMON-HELFEN-08` (ch. 30), `GE-LEX-HAND-02` and
`GE-SOUND-HAND-03` (ch. 22), and back into chapter 34. Six atoms that no lesson
...
Chapters 36–39 are the pre-A1 vocabulary tranche (fourteen nouns; see
CHANGELOG). All four payoffs close over their own chapter's atoms at 1.00
representativeness. Chapter 36's payoff also rescues chapter 35's two
never-revisited atoms, `GE-LEX-SCHLIESSEN-10` and `GE-ETYMON-SCHLIESSEN-11`;
chapter 38's rescues chapter 34's disputed `GE-ETYMON-HOEREN-10` "sharp-eared"
link, never revisited since it was flagged; chapter 39's reaches to chapters
13, 16, 25, 30 and 34 at once, completing the Hand/Arm/Finger/Fuß/Herz set
chapter 25 printed but only a fifth of which it taught.

## Reinforcement chaining (HL09 §7)

A chapter-end payoff cannot close the R1 window (n+1…n+3), so the reach-back
runs at two cadences. Every lesson in chapters 32–33 also names atoms from the
...
| `GE-C25-moegen-lieben` | all of chapters 32 and 33, plus chapters 29 and 30 |
...
| `GE-C26-hoeren` | all of chapter 34, plus chapters 25, 30 and 33 |
...
| `GE-C30-nase` | all of chapter 38, plus ch. 22 `GE-LEX-KOPF-02`/`GE-LEX-HAND-02` |
...
| `GE-C31-herz` | all of chapter 39, plus ch. 22 `GE-LEX-HAND-02`, ch. 27 `GE-ETYMON-HUND-03`, ch. 31 `GE-ETYMON-HOEREN-10` |
