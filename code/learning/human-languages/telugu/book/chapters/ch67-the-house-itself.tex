...
% canonical-source-hash: fnv1a64:c535f1c90a6d75b0
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{gōḍa}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{gōḍa}, then \emph{namaskāram}, as though greeting somebody at a freshly painted one
  \item \emph{Recall:} say \emph{svāgataṁ}, then read \textbf{\te{పొలం}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kappu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{gōḍa}, then \emph{kappu}, and say which one holds up the other
  \item \emph{Recall:} read \textbf{\te{మర్యాద}}, then say \emph{vari}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{gaḍapa}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{gaḍapa}, then \emph{muggu}, and say which one is drawn beside the other
  \item \emph{Recall:} say \emph{manavi}, then read \textbf{\te{గడ్డి}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{meṭṭu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{meṭṭu}, then \emph{gaḍapa}, in the order your feet meet them
  \item \emph{Recall:} read \textbf{\te{అనుమతి}}, then say \emph{kallaṁ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kiṭikī}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{namaskāram} at the last one
  \item \emph{Recall:} say \emph{nammakaṁ}, then read \textbf{\te{పంట}} and say what it means
\end{itemize}
