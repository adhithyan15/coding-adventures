...
| Dartmouth BASIC | `.bas`, `.basic` | `dartmouth-basic-iir-compiler` | LET / PRINT / INPUT / IF / GOTO / FOR / NEXT / END / REM, GOSUB / RETURN, DEF FN, real and string DIM arrays, mixed numeric/string READ / DATA / RESTORE, real arithmetic and formatting, strings, and general `^` compile and run end-to-end through all seven standard matrix backends. Portable `RND` remains a follow-up |
