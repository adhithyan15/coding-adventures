#!/bin/sh
# Build and run the ieee802154-core tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp ieee802154_core-tests tests/ieee802154_core_test.cpp
