# Build and run the in-memory-data-store-protocol tests under MSVC (cl.exe) —
# pure ISO C/C++ — via the shared iso-harness (code\packages\c\iso-harness).
...
Iso-BuildAndRun -Lang c -Name imds_protocol-tests -Sources @("tests\imds_protocol_test.c", "src\imds_protocol.c")
