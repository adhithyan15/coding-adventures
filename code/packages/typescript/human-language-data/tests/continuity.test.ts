...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    */
    expect(report.summary.missedByWindow.R2).toBe(3684); // +3: German exposes three opening atoms; guided copy revisits them immediately, and the 5-15 lesson review belongs to the next tranche.
  });
