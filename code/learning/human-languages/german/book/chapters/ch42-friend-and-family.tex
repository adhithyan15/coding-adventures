...
% canonical-source-hash: fnv1a64:8d8d727259921643
% canonical-lessons: GE-C29-freund, GE-C29-freundin, GE-C29-familie, GE-R29-neun-laute
...
\end{tcolorbox}
\section[Practice]{Nine sounds, said without looking at what they mean}

\label{lesson:GE-R29-neun-laute}



\begin{quote}
\textbf{gut} and \textbf{du}. Same vowel, held long in both. Say them, then say what an English speaker's mouth wants to do to that vowel instead.
\end{quote}

\subsection*{Your turn: nine, for sound only}
You know what all of these mean. This time say them for the noise alone.

Say these aloud:

\begin{itemize}
\raggedright
  \item \emph{gut} — one long \textbf{u}, no glide after it
  \item \emph{du}, then \emph{Sie} — the second is a long \textbf{ee} with an initial \textbf{z}
  \item \emph{heißen} — \textbf{ei} is the English word \emph{eye}, and the \textbf{ß} keeps it long
  \item \emph{freut mich} — \textbf{eu} is the English \emph{oy}, nothing like the letters
  \item \emph{danke} — the final \textbf{-e} is weak, never \emph{-ay}
  \item \emph{bitte} — short \textbf{i}, and the same weak ending
  \item \emph{sehen} — the \textbf{h} is silent and only marks the long \textbf{e}
  \item \emph{auf} — \textbf{au} is \emph{ow}, and the \textbf{f} is a clean stop
\end{itemize}

\begin{culture}
Three of the nine share one habit, and it is the habit that makes German spelling honest once you know it:

\noindent
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
\toprule
\textbf{written} & \textbf{said} & \textbf{what the extra letter is doing} \\
\midrule
\textbf{ei} in \emph{heißen} & \emph{eye} & a pair naming one sound, not two \\
\textbf{eu} in \emph{freut} & \emph{oy} & the same, and neither letter is a clue \\
\textbf{h} in \emph{sehen} & silent & \textbf{length}, not a sound of its own \\
\bottomrule
\end{tabularx}

German spelling is far more regular than English spelling — but regular is not the same as obvious. Each of these is a fixed rule you can rely on everywhere, and none of them can be guessed from the letters by someone reading English habits into them.
\end{culture}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What is the \textbf{h} in \emph{sehen} doing? (\textbf{Marking the vowel long — it is silent.}) What does \textbf{eu} sound like? (\emph{\textbf{oy}}.) And of the nine words above, which one is capitalised mid-sentence, and why? (\emph{\textbf{Sie}} — the formal \emph{you}, capitalised to tell it from \emph{sie}, \emph{she} or \emph{they}.)
\end{tcolorbox}
