# Build and run the pixel-container tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name pixel_container-tests -Sources @("tests\pixel_container_test.c", "src\pixel_container.c")
