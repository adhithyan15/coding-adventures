...
describe("the committed corpus", () => {
  it("pins the first measurement", () => {
    ...
    expect(r.summary.worstTerms.slice(0, 2)).toEqual([
      ...
      { term: "noun", lessons: 487 }, // +1: ES-C02-concordancia names the noun it agrees with // +4: vocabulary wave 5 // +3: HL-C88 slices 5-6 // +1: HL-C88 slice 7 (ES-C09-ncia) // +1: HL-C88 slice 8 (-ario, review, synthesis) // +14: vocabulary wave 6 // HL-C113 step 6: +1 // HL-C128 step 2: +4 // HL-C128 step 3: +4 // HL-C128 step 8: +1 // HL-C128 step 9: +3 // HL-C128 step 10: +4 // HL-C134: +1 each — the carried prose says 'verb' and 'noun' in lessons whose markdown had not, though the book always did
    ]);
  });
