...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}preto, branco\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}o vinho branco\textquotedblright{} — Chapter 11's wine{]}
  \item {[}YOU SAY: \textquotedblleft{}o pão é branco\textquotedblright{} — Chapter 11's bread{]}
  \item {[}YOU SAY: the l$\to$r swap — \textquotedblleft{}blanc $\to$ \textbf{branco}\textquotedblright{}{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What are Portuguese's two blacks? (\textbf{Negro} $\leftarrow$ \emph{niger}, literary; and \textbf{preto} $\leftarrow$ \emph{pressus} \textquotedblleft{}pressed/dense,\textquotedblright{} the everyday one.) Why would \textquotedblleft{}pressed\textquotedblright{} mean black? (\textbf{Dense $\to$ thick $\to$ dark}.) Where does \textbf{branco} come from? (\textbf{Germanic \emph{blank}}, \textquotedblleft{}shining\textquotedblright{} — borrowed \textbf{into} Romance.) What sound change shows in \emph{branco}? (\textbf{l $\to$ r}, as in \emph{praça}.) Next: \textbf{vermelho}, the strangest colour word in the language.
\end{tcolorbox}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}vermelho, azul\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}o vinho é vermelho… o vinho tinto\textquotedblright{} — note: \textbf{wine} is \emph{tinto}, \textquotedblleft{}dyed\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}vermelho — vermilion — vermin\textquotedblright{}{]}
  \item {[}YOU SAY: all four — \textquotedblleft{}preto, branco, vermelho, azul\textquotedblright{}{]}
\end{itemize}
