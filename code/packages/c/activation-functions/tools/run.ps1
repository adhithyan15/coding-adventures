# Build and run the activation-functions tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name activation_functions-tests -Sources @("tests\activation_functions_test.c", "src\activation_functions.c")
