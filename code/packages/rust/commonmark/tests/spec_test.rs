...
//!
//! Runs all 652 examples from the CommonMark 0.31.2 specification against the
//! Rust `commonmark` pipeline (parser + HTML renderer). Each example provides:
//!
...
/// Run all 652 CommonMark spec examples and report pass/fail counts.
///
...
//   cargo test -p commonmark --test spec_test -- tabs
//
