...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Malayalam, like Tamil, has its \textbf{own} solar calendar — but even here, the two closest cousins name their months by two \textbf{different} logics.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: the twelve — \textquotedblleft{}Chiṅṅam, Kanni, Tulām, Vṛścikam, Dhanu, Makaram, Kumbham, Mīnam, Mēḍam, Iḍavam, Mithunam, Karkiḍakam\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}Chiṅṅam = Leo\textquotedblright{} — a zodiac sign, not a nakshatra{]}
  \item {[}YOU SAY: the contrast — Tamil uses nakshatras, Malayalam uses zodiac signs{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} Is Malayalam's calendar solar or lunisolar? (\textbf{Solar} — like Tamil's, and separate from the Hindu lunisolar system.) How does it differ from Tamil's in naming logic? (\textbf{Zodiac signs} — Chiṅṅam=Leo, Kanni=Virgo — rather than Tamil's nakshatra-based names.) What does Chiṅṅam 1 mark? (\textbf{Malayalam New Year}, the start of the Onam season.)
\end{tcolorbox}
