...
% canonical-source-hash: fnv1a64:46b3ed7e60bcd3ac
...
\hlblockfigure{\detokenize{figures/MW-W04-pa-filmstrip.pdf}}{How \mw{प} is written, stroke by stroke}

\begin{enumerate}
\raggedright
  \item look at \textbf{\mw{प}} for three seconds
  \item finger-trace its left stem, bowl, and headline
  \item copy \textbf{\mw{प}} twice
  \item say \emph{pa} after each copy
\end{enumerate}
...
\subsection*{Writing — observe, trace, copy}
\hlblockfigure{\detokenize{figures/MW-W04-nna-filmstrip.pdf}}{How \mw{ण} is written, stroke by stroke}

\begin{enumerate}
\raggedright
  \item look at \textbf{\mw{ण}} for three seconds
  \item finger-trace the lower loop, upright, and headline
  \item copy \textbf{\mw{ण}} twice
  \item say \emph{ṇa} after each copy
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item copy \textbf{\mw{ण}} once
  \item look at \textbf{\mw{णी}}
  \item add \textbf{\mw{ी}} on the right of your copy
  \item compare the joined form, then say \emph{ṇī}
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item copy \textbf{\mw{पाणी}} once while saying \emph{pā-ṇī}
  \item point to \textbf{\mw{पा}}, then \textbf{\mw{णी}}
  \item hide the model for ten seconds
  \item write the complete word from memory
  \item uncover and compare \textbf{\mw{प}}, \textbf{\mw{ा}}, \textbf{\mw{ण}}, and \textbf{\mw{ी}} separately
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listen:} hear \emph{pāṇī} and identify water, without text.
  \item \textbf{Speak:} see a picture or imagine a glass of water and say \emph{pāṇī}, without notes.
  \item \textbf{Read:} choose \textbf{\mw{पाणी}} from \textbf{\mw{आभार} · \mw{हां} · \mw{पाणी}} and give its meaning.
  \item \textbf{Write:} hear \emph{pāṇī}, wait fifteen seconds, then write \textbf{\mw{पाणी}} with no model.
\end{enumerate}
