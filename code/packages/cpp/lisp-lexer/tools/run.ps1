# Build and run the lisp-lexer tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name lisp_lexer-tests -Sources @("tests\lisp_lexer_test.cpp")
