#!/bin/sh
# Build and run the binary-search-tree tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c binary_search_tree-tests tests/binary_search_tree_test.c src/binary_search_tree.c
