# ladder_t6_top_const_and_advanced

Rung 6.top_const_and of the CCR-066 differential complexity ladder, at `ADVANCED`.

## What this rung is for

Exercises a top-level `const` used as a `&&` operand.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t6_top_const_and_advanced/input/a.js
```
