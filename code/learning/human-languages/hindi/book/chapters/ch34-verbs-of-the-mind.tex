...
% canonical-source-hash: fnv1a64:5d5040c6232c782f
% canonical-lessons: HI-C34-sochna, HI-S135-letter-au, HI-C34-samajhna, HI-C34-padhna, HI-C34-likhna
...
\section[sochnā / soch / sochtā / sochtī / sochte]{\hi{सोचना} — \textquotedblleft{}to think,\textquotedblright{} its present forms, and an older grief}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY (m.): \textbf{\hi{मैं} \hi{सोचता} \hi{हूँ}} (\emph{maiṁ sochtā hūṁ})  ·  (f.): \textbf{\hi{मैं} \hi{सोचती} \hi{हूँ}} (\emph{maiṁ sochtī hūṁ}){]}
  \item \emph{Say it:} \textquotedblleft{}you (resp.) think\textquotedblright{} — \textbf{\hi{आप} \hi{सोचते} \hi{हैं}} (\emph{āp sochte haiṁ})
  \item \emph{Say it:} \emph{nahīṁ} on its own, then slide it in front of the verb — \textbf{\hi{मैं} \hi{नहीं} \hi{सोचता} / \hi{सोचती}} (\emph{maiṁ nahīṁ sochtā / sochtī}), \textquotedblleft{}I don't think so.\textquotedblright{} Hindi's negator sits \textbf{before} the verb, never after it
...
\end{tcolorbox}
\section[au]{\hi{औ} — the standing form, and the longest build}

\label{lesson:HI-S135-letter-au}



\begin{quote}
Before the new one: \textbf{\hi{◌ौ}} — how does it differ from \textbf{\hi{◌ो}}?

That mark has a standing form, and it is the most elaborate character in this book.
\end{quote}

\subsection*{Script you'll notice: \hi{औ}}
\textbf{\hi{औ}} — \emph{au}.

Same vowel, standing on its own with no consonant to ride on. Like \textbf{\hi{झ}}, it arrives \textbf{before} any word that needs it, so there is nothing to find it inside yet.

What it is made of:

\begin{itemize}
\raggedright
  \item the joined upper and lower bowls of \textbf{\hi{अ}}
...
\subsection*{Script: built out of a letter you have}
\noindent
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
\toprule
\textbf{what you see} & \textbf{what it is} \\
\midrule
\hi{अ} & the base, taught long ago \\
\textbf{two upper arcs} & what makes it \textbf{au} \\
\hi{◌ौ} & the same vowel, riding on a consonant \\
\bottomrule
\end{tabularx}

The \textbf{two arcs} are the same \emph{two} that the sitting mark carries above the bar. Whichever posture the vowel is in, \textbf{au is the one with a pair of strokes} — one idea, two shapes, and a count that decides it.

\subsection*{Writing: \hi{औ}}
\hlblockfigure{\detokenize{figures/HI-S135-letter-au-filmstrip.pdf}}{How \hi{औ} is written, stroke by stroke}
...
\raggedright
  ...
  \item \textbf{5.} lift at the trailing stem's headline junction and sweep the lower upper arc upward and left
  \item \textbf{6.} lift at the same junction and sweep the taller upper arc upward and left
  \item \textbf{7.} lift and draw the top shirorekhā left-to-right
\end{itemize}

\textbf{Pen lifts: 6.} More than any other character you have drawn — take it slowly.
...
\begin{quote}
This is one attested teaching order and not a national standard — handwriting here is taught with school-to-school variation. Source: Saurmandal, ‘Devanagari \hi{औ} stroke order.svg’, panels 1–7, Wikimedia Commons, 5 August 2023.
\end{quote}

\subsection*{Your turn}
\begin{itemize}
\raggedright
  \item \emph{Look:} at the mark and the letter side by side, and count the arcs on each
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Trace it:} \hi{औ} once, slowly, counting the lifts
  \item \emph{Say it:} which base letter you can see inside it
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What sound is \textbf{\hi{औ}}? (\emph{au}.) What is its sitting form? (\textbf{\hi{◌ौ}}.) How many pen lifts does it take? (Six — the most in the book.)
\end{tcolorbox}
\section[samajhnā / samajh / samajhtā …]{\hi{समझना} (samajhnā) — \textquotedblleft{}to understand,\textquotedblright{} which is to say \textquotedblleft{}to wake up\textquotedblright{}}
...
\end{tcolorbox}
\section[paṛhnā / paṛh / paṛhtā / paṛhtī …]{\hi{पढ़ना} (paṛhnā) — \textquotedblleft{}to read,\textquotedblright{} and just as often \textquotedblleft{}to study\textquotedblright{}}
...
\end{tcolorbox}
\section[likhnā / likh / likhtā / likhtī / likhte]{\hi{लिखना} (likhnā) — \textquotedblleft{}to write,\textquotedblright{} which everywhere means \textquotedblleft{}to scratch\textquotedblright{}}
