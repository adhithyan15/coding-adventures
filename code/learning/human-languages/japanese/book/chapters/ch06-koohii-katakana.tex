...
\begin{enumerate}
\raggedright
  \item top horizontal, then turn down at the right
  \item bottom horizontal, left to right
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item a short stroke from right toward left
  \item a longer vertical stroke that turns and sweeps right at the bottom
\end{enumerate}
