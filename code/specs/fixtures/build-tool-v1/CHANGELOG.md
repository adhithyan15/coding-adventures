...
- Registered the three exact Rust Engram WASM BUILD inputs and added a neutral
  source-collection case covering exact selection, near-name and rename
  exclusion, case sensitivity, and tracked-byte digests without adding broad
  JavaScript, WebAssembly, generated-output, or directory authority.
