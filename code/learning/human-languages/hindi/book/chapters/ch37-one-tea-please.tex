...
% canonical-source-hash: fnv1a64:5b73c6711dcafde5
...
\section[\hi{एक} \hi{चाय} \hi{दीजिए}]{\hi{चाय} (chāy) — tea, and how to actually ask for one}
...
\end{tcolorbox}
\section[\hi{किताब} / \hi{पुस्तक} / \hi{पोथा}]{\hi{किताब} (kitāb) — a book, and the root it is cut from}
