...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      pen: 131, // HL-C154: Tamil's letter ledger completed — 15 more one-character segments, 24/24 positions taught
      ...
      drivablePercent: 68, // +1: vocabulary wave 5's lessons are mostly ear-only // HL12 payment two: -1, Hindi's eight pen segments in the denominator // HL-C128 step 4: +1 -- six drivable lessons in a row lift the ratio // HL-C136 wave I: UNCHANGED at 67, and that is the drive order's own prediction rather than a coincidence -- 42 lessons that need no eyes enter both numerator and denominator, so a meaning ramp costs the driving edition nothing. Only a decoding ramp moves this // HL-C137 wave II: +36 adjective lessons, +6 chapters, and drivablePercent rises AGAIN
      trackCount: 22,
