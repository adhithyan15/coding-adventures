...
% canonical-source-hash: fnv1a64:0b5610d3286c63a6
...
\section[ciṅṅaṁ kanni tulāṁ vṛścikaṁ dhanu …]{\ml{ചിങ്ങം} to \ml{കർക്കടകം} — Kerala's own solar calendar, named by the zodiac}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} the twelve — \textquotedblleft{}Chiṅṅam, Kanni, Tulām, Vṛścikam, Dhanu, Makaram, Kumbham, Mīnam, Mēḍam, Iḍavam, Mithunam, Karkiḍakam\textquotedblright{}
  \item \emph{Say it:} \textquotedblleft{}Chiṅṅam = Leo\textquotedblright{} — a zodiac sign, not a nakshatra
  \item \emph{Say it:} the contrast — Tamil uses nakshatras, Malayalam uses zodiac signs
  \item \emph{Recall:} say \emph{karuppŭ veḷḷa cuvappŭ nīla}
\end{itemize}
