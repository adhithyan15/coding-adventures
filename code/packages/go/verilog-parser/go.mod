module github.com/adhithyan15/coding-adventures/code/packages/go/verilog-parser
...
require (
	...
	github.com/adhithyan15/coding-adventures/code/packages/go/verilog-lexer v0.0.0
)
