...
% canonical-source-hash: fnv1a64:21e92a5179fee3d5
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{siṁhaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{talam}, then \emph{siṁhaḥ}
  \item \emph{Recall:} say \emph{raviḥ}, then read \textbf{\sk{भित्तिः}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vṛkaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{siṁhaḥ}, then \emph{vṛkaḥ}
  \item \emph{Recall:} read \textbf{\sk{रश्मिः}}, then say \emph{vātāyanam}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{chāgaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{vṛkaḥ}, then \emph{chāgaḥ}
  \item \emph{Recall:} say \emph{prakāśaḥ}, then read \textbf{\sk{सोपानम्}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vānaraḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{chāgaḥ}, then \emph{vānaraḥ}
  \item \emph{Recall:} read \textbf{\sk{छाया}}, then say \emph{stambhaḥ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{haṁsaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{siṁhaḥ} and \emph{haṁsaḥ} together
  \item \emph{Recall:} say \emph{tāpaḥ}, then read \textbf{\sk{तलम्}}
\end{itemize}
