# Build and run the static-vector tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name static_vector-tests -Sources @("tests\static_vector_test.cpp")
