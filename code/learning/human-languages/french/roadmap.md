...
Same shape as the [Spanish roadmap](../spanish/roadmap.md): deep one-word
lessons grouped into themed chapters, building toward everyday conversational
French. Lessons are slug-identified; order lives in the book (LaTeX
...
*vous* (← Latin *vos*) rather than a "your grace" title — a clean contrast to
teach side by side.
