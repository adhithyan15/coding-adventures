...
% canonical-source-hash: fnv1a64:4c6b2205b91fa7c5
% canonical-lessons: BN-C19-je, BN-C19-jokhon, BN-C19-abar-bolben, BN-C19-dhire, BN-R30-second-pass-slowly-and-two-signs, BN-R19-lost-and-found
...
Source: \href{https://www.unicode.org/charts/PDF/U0980.pdf}{Unicode Bengali chart}.
\end{tcolorbox}
\section[dhīre]{\bn{ধীরে} — the word you will need most}

\label{lesson:BN-R30-second-pass-slowly-and-two-signs}



\begin{quote}
Someone is speaking faster than you can follow. One word, and it is usually said twice.
\end{quote}

\subsection*{You'll want to know: said twice, and that is the idiom}
\textbf{\bn{ধীরে}} — \emph{slowly}. On its own it is an ordinary adverb. Doubled, \textbf{\bn{ধীরে} \bn{ধীরে}}, it is the everyday way to ask for it: Bengali repeats a word to soften and to spread it out, and a single \textbf{\bn{ধীরে}} can sound like an instruction where the doubled one sounds like a request.

It is half of the repair kit. The other half asks someone to say it again; this half asks them to say it at a speed you can follow, and of the two it is the one a beginner reaches for more often.
...
Both were taught once and read once. Say each aloud, then say what makes the second one harder than the first: \textbf{\bn{হৃদয়}} carries \textbf{\bn{ৃ}}, a sign for a vowel that used to be an \emph{r}, and nothing else in the word warns you it is coming.
\end{tcolorbox}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
How do you ask someone to slow down? (\textbf{\bn{ধীরে} \bn{ধীরে}} — doubled.) What does the doubling do? (\textbf{Softens it} into a request.) Which of the two words above needs \textbf{\bn{ৃ}}? (\textbf{\bn{হৃদয়}}.) And what did that sign once write? (\textbf{An \emph{r}}.)
\end{tcolorbox}
