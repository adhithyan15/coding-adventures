...
describe("the committed corpus", () => {
  ...
  it("pins the first measurement", () => {
    ...
    expect(report.summary.lessons).toBe(1747); // +8: HL-C94 payoff lessons // +4: HL-C98
    ...
    expect(report.summary.paradigmTables).toBe(94);
    expect(report.summary.fullParadigmGrids).toBe(21);
    expect(report.summary.lessonsWithFindings).toBe(108);
  });
