#!/bin/sh
# Build and run the two-layer-network tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c two_layer_network-tests tests/two_layer_network_test.c src/two_layer_network.c
