...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}tarde\textquotedblright{} — \emph{TAR-de}{]}
  \item {[}YOU SAY: \textquotedblleft{}tarde\textquotedblright{} then English \textquotedblleft{}tardy\textquotedblright{} — hear the shared root{]}
  \item {[}YOU SAY: \textquotedblleft{}tardes\textquotedblright{} — plural, add \emph{-s} (vowel ending), just like \emph{día $\to$ días}{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What did Latin \emph{tardus} originally mean, before \textquotedblleft{}afternoon\textquotedblright{}? (Slow, late — as in \emph{tardy}, \emph{retard}.) And how do you make \emph{tarde} plural? (\emph{tardes} — vowel + \emph{-s}.)
\end{tcolorbox}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} Same move as \emph{buenos días}: take \textquotedblleft{}good\textquotedblright{} and \textquotedblleft{}afternoon\textquotedblright{} and snap them together. But watch the ending — this time it comes out \emph{buen\textbf{as}}, and that difference teaches you the other half of the agreement rule.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}buenas tardes\textquotedblright{} — \emph{BWEH-nas TAR-des}{]}
  \item {[}YOU SAY: \textquotedblleft{}buenos días\textquotedblright{} then \textquotedblleft{}buenas tardes\textquotedblright{} — hear the \emph{o} flip to \emph{a}{]}
...
\begin{quote}
\textbf{Warm-up.} {[}PAUSE 2s{]} The last time-of-day word before the evening greeting. \emph{noche} — \textquotedblleft{}night\textquotedblright{} — and it shows off a spelling pattern that will help you decode dozens of Spanish words later.
\end{quote}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}noche\textquotedblright{} — \emph{NO-cheh}{]}
  \item {[}YOU SAY: \textquotedblleft{}noche\textquotedblright{} then \textquotedblleft{}nocturnal\textquotedblright{} then \textquotedblleft{}equinox\textquotedblright{}{]}
  \item {[}YOU SAY: \textquotedblleft{}noches\textquotedblright{} — plural, vowel + \emph{-s}{]}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Wrap-up recall}]
{[}PAUSE 3s{]} What English word is \emph{equi-} + \emph{noche}'s root? (\emph{Equinox}, \textquotedblleft{}equal night.\textquotedblright{}) And what Latin sound did the \emph{-ch-} in \emph{noche} come from? (\emph{-ct-}, as in \emph{noctem $\to$ noche}.)
\end{tcolorbox}
...
\begin{itemize}
\raggedright
  \item {[}YOU SAY: \textquotedblleft{}buenas noches\textquotedblright{} arriving somewhere{]}
  \item {[}YOU SAY: \textquotedblleft{}buenas noches\textquotedblright{} leaving somewhere{]}
  \item {[}YOU SAY: all four times of day — \textquotedblleft{}buenos días, buenas tardes, buenas noches\textquotedblright{} — and notice which take \emph{buenos} vs \emph{buenas} and why{]}
\end{itemize}
...
\raggedright
  ...
  \item {[}YOU SAY: all three \textquotedblleft{}buenos/buenas\textquotedblright{} greetings in a row; for each, say whether the noun is masculine or feminine and why the ending fits{]}
  \item {[}YOU SAY: \textquotedblleft{}hola, buenas tardes\textquotedblright{} — casual + timed, stacked{]}
\end{itemize}
