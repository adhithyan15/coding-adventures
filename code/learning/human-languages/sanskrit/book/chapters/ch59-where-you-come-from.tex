...
% canonical-source-hash: fnv1a64:dd2c76c0f2c9c345
...
Notice what the sentence does \textbf{not} have. There is no \textbf{\sk{अस्ति}} in it. Sanskrit can leave the \emph{is} out when its only work is to link two things, and here it does — \emph{he, Indian}. You have seen that before in \textbf{\sk{न} \sk{चिन्ता}}; this is the same economy.
