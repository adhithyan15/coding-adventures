module github.com/adhithyan15/coding-adventures/code/packages/go/nib-type-checker
...
require (
	...
	github.com/adhithyan15/coding-adventures/code/packages/go/type-checker-protocol v0.0.0
)
