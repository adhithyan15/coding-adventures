...
describe("book chapter modality projection", () => {
  ...
  it("covers all 523 generated and handwritten chapter openings in all 22 books", () => {
    ...
    expect(ledgers.flatMap((track) => track.chapters)).toHaveLength(1003); // telugu pre-A1 round 4: +7 chapters (chapters 67-73) // malayalam pre-A1 round 3: +35 lessons, +7 chapters (chapters 60-66) // kannada pre-A1 round 3: +35 lessons, +7 chapters (chapters 60-66) // merge with main (round 5): +1 -- main advanced again while this tranche was still open; regenerated rather than picked, see lesson-modality.json // merge with main (round 4): +5 -- HL-C231..C240 (chinese ch4/ch5, urdu/persian/russian/japanese script chapters) landed on main while this tranche was in flight; regenerated rather than picked, see lesson-modality.json // telugu pre-A1 round 3: +35 lessons, +7 chapters (chapters 60-66) // tamil pre-A1 round 2: +35 lessons, +7 chapters (chapters 51-57) // merge with main: +1 -- HL-C229 French question tranche landed on main while this tranche was in flight (a second time); regenerated rather than picked, see lesson-modality.json // merge with main: +1 -- hindi script second wave (chapter 59) landed on main while this tranche was in flight; regenerated rather than picked, see lesson-modality.json // hindi pre-A1 round 2: +35 lessons, +7 chapters (chapters 52-58) // tamil pre-A1 tranche: +35 lessons, +7 chapters (chapters 44-50) //HL-C136 wave I: 42 lessons, 6 chapters — 'Pointing, and Asking', six deixis words per Indic track, re-measured against the merged base after main landed HL-C128 steps 3-10 and HL-C127 // +4: HL-C98 // +15: vocabulary wave 5 // +4: HL-C88 slices 5-6 // +3: HL-C88 slice 8 // +12: vocabulary wave 6 // +3: HL-C113 (B1 si-condition rung) // +3: HL-C113 preterite plural // HL-C113 preterite close // HL-C113: HL-C113 imperfect subjunctive // HL-C137 wave II: +36 lessons, +6 chapters — the first adjectives (big/small/good/new/old) and the placement rule behind them, one chapter per Indic track // HL-C152: +5 lessons, +1 chapter — Spanish realizes SPINE-NEGATE-AND-ASK, completing A2 at 5/5 // HL-C158: +4 -- the B1 travel rung (chapter 268) // HL-C159: +4 -- the B1 describe-experience rung (chapter 269) // HL-C163: +6 -- Sanskrit chapter 16 // HL-C165: +11 -- Sanskrit chapters 17 and 18 // HL-C166: +11 -- Sanskrit chapters 19 and 20 // HL-C172: +4 -- the B2 argue rung (chapter 270) // HL-C173: +2 -- B2 closes (chapter 271) // HL-C175: +5 -- chapter 272, reading between the lines // HL-C177: +5 -- chapter 273, C1 closes // HL-C178: +5 -- chapter 274, C2 opens // HL-C179: +5 -- chapter 275, fine shades // HL-C180: +4 -- chapter 276; ARCHAIC-FORM was already taught at chapter 3 // HL-C181: +5 -- chapter 277, the spine closes at 33/33 // HL-C187: +20 -- verb tranche across the five behind tracks // HL-C189: +8 -- Tamil and Sanskrit verb tranche // HL-C190: see/say verbs across four tracks // HL-C192: +24 family words // HL-C194: +16 Spanish words // HL: +35 -- Sanskrit chapters 24-30, 35 pre-A1 vocabulary lessons // HL-C200: +35 telugu pre-A1 lessons, +7 chapters (chapters 46-52) // kannada pre-A1 tranche: +35 lessons, +7 chapters (chapters 46-52) // malayalam pre-A1 tranche: +35 lessons, +7 chapters (chapters 46-52) // hindi pre-A1 tranche: +35 lessons, +7 chapters (chapters 45-51) // spanish pre-A1 tranche: +35 lessons, +7 chapters (chapters 282-288) // sanskrit pre-A1 round 2: +35 lessons, +7 chapters (chapters 31-37) // telugu pre-A1 round 2: +35 lessons, +7 chapters (chapters 53-59) // kannada pre-A1 round 2: +35 lessons, +7 chapters (chapters 53-59) // spanish pre-A1 round 2: +35 lessons, +7 chapters (chapters 289-295) // chinese script chapter: +1 chapter (ch02, the seven components) // japanese hiragana tranche: +1 chapter (ch02, the eight signs) // latin pre-A1 tranche: +20 lessons, +4 chapters (chapters 44-47) // gujarati script tranche: +1 chapter (ch13) // marathi script tranche: +1 chapter (ch14) // punjabi script tranche: +1 chapter (ch14) // russian script tranche: +1 chapter (ch14) // malayalam pre-A1 round 2: +35 lessons, +7 chapters (chapters 53-59) // sanskrit pre-A1 round 3: +35 lessons, +7 chapters (chapters 38-44) // spanish pre-A1 round 3: +35 lessons, +7 chapters (chapters 296-302) // hindi pre-A1 round 3: +35 lessons, +7 chapters (chapters 60-66) // sanskrit pre-A1 round 4: +35 lessons, +7 chapters (chapters 45-51)
