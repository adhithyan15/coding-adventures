...
explicit. The next starter entry is ک; HL-C09Z queues its source-backed audit
from Chapter 1, *Be, kāf, and short vowels*.
...
| HL-C09 | Queued — 25 of 228 verified | Expand `DUCTUS` to cover the ten scripts with prose stroke-order entries. | Add cited, font-checked ductus and verified pen-lift metadata for the remaining 203 entries measured by HL-C19; each passes the on-ink, join-tolerance, coverage, citation, and source-agreement invariants. |
...
| HL-C09Z | Queued — next | Locate and verify independent Urdu ک in *Zer o Zabar*'s source-backed Chapter 1, *Be, kāf, and short vowels*. | Audit the independent animation's angled body and upper hook, reconcile the Urdu kāf form with the Noto Naskh fallback, then author the smallest next path with source, lifts, font, and filmstrip agreement. |
