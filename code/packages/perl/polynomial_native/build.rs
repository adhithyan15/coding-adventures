// build.rs — linker flags for the Perl PolynomialNative XS extension
//
// Perl extension modules are loaded by DynaLoader at runtime. The Perl C API
// symbols are provided by the interpreter process, not linked at build time.
//
