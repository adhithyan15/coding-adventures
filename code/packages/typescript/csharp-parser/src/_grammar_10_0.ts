...
export const PARSER_GRAMMAR: ParserGrammar = {
  ...
  rules: [
  {
    ...
    body: { type: "sequence", elements: [
      ...
      { type: "group", element: { type: "alternation", choices: [
          { type: "rule_reference", name: "file_scoped_namespace_declaration" },
          { type: "sequence", elements: [
            { type: "repetition", element: { type: "rule_reference", name: "top_level_statement" } },
  ...
  },
  {
    ...
    body: { type: "rule_reference", name: "statement" },
    lineNumber: 312,
  },
  {
  ...
  },
  {
    ...
    body: { type: "sequence", elements: [
      ...
      { type: "optional", element: { type: "sequence", elements: [
          { type: "token_reference", name: "LPAREN" },
          { type: "rule_reference", name: "record_parameter_list" },
          { type: "token_reference", name: "RPAREN" },
        ] } },
      { type: "optional", element: { type: "sequence", elements: [
          { type: "token_reference", name: "COLON" },
          { type: "rule_reference", name: "record_base_list" },
        ] } },
      { type: "repetition", element: { type: "rule_reference", name: "type_parameter_constraint_clause" } },
      { type: "group", element: { type: "alternation", choices: [
  ...
  },
  {
    ...
    body: { type: "sequence", elements: [
      { type: "rule_reference", name: "record_parameter" },
      { type: "repetition", element: { type: "sequence", elements: [
          { type: "token_reference", name: "COMMA" },
          { type: "rule_reference", name: "record_parameter" },
        ] } },
  ...
  },
  {
    ...
    body: { type: "sequence", elements: [
      { type: "rule_reference", name: "record_base_type" },
      { type: "repetition", element: { type: "sequence", elements: [
          { type: "token_reference", name: "COMMA" },
          { type: "rule_reference", name: "type" },
        ] } },
  ...
  },
  {
    ...
    body: { type: "sequence", elements: [
      ...
      { type: "repetition", element: { type: "rule_reference", name: "type_parameter_constraint_clause" } },
      { type: "group", element: { type: "alternation", choices: [
          { type: "rule_reference", name: "record_struct_body" },
          { type: "token_reference", name: "SEMICOLON" },
        ] } },
    ] },
    lineNumber: 442,
  ...
  },
  {
    ...
    body: { type: "alternation", choices: [
      { type: "sequence", elements: [
        ...
        { type: "optional", element: { type: "rule_reference", name: "set_or_init_accessor_declaration" } },
      ] },
      { type: "sequence", elements: [
        { type: "rule_reference", name: "set_or_init_accessor_declaration" },
  ...
  {
    name: "pattern",
    body: { type: "rule_reference", name: "or_pattern" },
    lineNumber: 1139,
  },
  {
    name: "or_pattern",
    body: { type: "sequence", elements: [
      { type: "rule_reference", name: "and_pattern" },
      { type: "repetition", element: { type: "sequence", elements: [
  ...
  },
  {
    name: "and_pattern",
    body: { type: "sequence", elements: [
      { type: "rule_reference", name: "not_pattern" },
      { type: "repetition", element: { type: "sequence", elements: [
  ...
  },
  {
    ...
    body: { type: "alternation", choices: [
      { type: "sequence", elements: [
        ...
        { type: "rule_reference", name: "atomic_pattern" },
      ] },
      { type: "rule_reference", name: "atomic_pattern" },
    ] },
    lineNumber: 1145,
  },
  {
    name: "atomic_pattern",
    body: { type: "alternation", choices: [
      { type: "rule_reference", name: "parenthesized_pattern" },
  ...
  },
  {
    ...
    body: { type: "sequence", elements: [
      { type: "rule_reference", name: "dotted_property_name" },
      { type: "token_reference", name: "COLON" },
      { type: "rule_reference", name: "pattern" },
    ] },
    lineNumber: 1187,
  ...
  },
  {
    ...
    body: { type: "alternation", choices: [
      ...
      { type: "rule_reference", name: "target_typed_new_expression" },
