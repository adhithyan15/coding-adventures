...
% canonical-source-hash: fnv1a64:a09013cf44711457
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{pasi}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{pasu}, then \emph{pasi}, and hold the two endings apart
  \item \emph{Recall:} say \emph{tayir}, then read \textbf{\ta{ஊசி}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{tākam}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{pasi}, then \emph{tākam}, and say what each of the two is answered with
  \item \emph{Recall:} read \textbf{\ta{நெய்}}, then say \emph{kayiṟu}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{tūkkam}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{tūkkam}, then \emph{ūsi}, and hear the same long vowel open both
  \item \emph{Recall:} say \emph{eṇṇey}, then read \textbf{\ta{குடை}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kāyccal}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{kāyccal}, then \emph{maruttuvar}, and say which one you take to the other
  \item \emph{Recall:} read \textbf{\ta{வெல்லம்}}, then say \emph{tuṭaippam}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vali}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{pasi}, \emph{tākam}, \emph{tūkkam}, \emph{kāyccal}, \emph{vali}
  \item \emph{Recall:} say \emph{sarkkarai}, then read \textbf{\ta{சீப்பு}}
\end{itemize}
