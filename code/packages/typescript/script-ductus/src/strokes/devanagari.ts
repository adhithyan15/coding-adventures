...
const devanagariAlphabetSource = (glyph: string): StrokeSource => {
  const letter = devanagari.letters.find(
      ...
      strokes: [
        {
          segments: [
            {
              label: "curve right around the upper bowl",
              path: [
                { x: 165, y: 545 },
                { x: 205, y: 575 },
                { x: 250, y: 595 },
        ...
        },
        {
          segments: [
            {
              label: "lift, then sweep the middle shoulder right",
              path: [
                { x: 290, y: 350 },
                { x: 350, y: 340 },
                { x: 410, y: 325 },
    ...
    "devanagari:आ",
    {
      ...
      strokes: [
        ...
        },
        {
          segments: [
            {
              label: "lift, then descend the trailing stem",
              path: [
                { x: 893, y: 590 },
                { x: 893, y: 500 },
                { x: 893, y: 410 },
      ...
      strokes: [
        {
          segments: [
            {
              label: "descend the upright from the headline",
              path: [
                { x: 363, y: 590 },
                { x: 363, y: 540 },
                { x: 363, y: 490 },
      ...
      strokes: [
        {
          segments: [
            {
              label: "curve down and left around the upper bowl",
              path: [
                { x: 350, y: 555 },
                { x: 390, y: 530 },
                { x: 420, y: 500 },
      ...
      strokes: [
        {
          segments: [
            {
              label: "sweep left over the top and around the bowl",
              path: [
                { x: 355, y: 430 },
                { x: 315, y: 430 },
                { x: 270, y: 435 },
    ...
    "devanagari:छ",
    {
      ...
      strokes: [
        ...
        },
        {
          segments: [
            {
              label: "lift, then descend the short upper stem",
              path: [
                { x: 510, y: 551 },
                { x: 510, y: 530 },
                { x: 510, y: 505 },
      ...
      strokes: [
        {
          segments: [
            {
              label: "descend the short central stem",
              path: [
                { x: 350, y: 551 },
                { x: 350, y: 510 },
                { x: 350, y: 470 },
    ...
    "devanagari:ण",
    {
      ...
      strokes: [
        ...
        },
        {
          segments: [
            {
              label: "lift, then descend the outer right stem",
              path: [
                { x: 600, y: 551 },
                { x: 600, y: 475 },
                { x: 600, y: 395 },
    ...
    "devanagari:ब",
    {
      ...
      strokes: [
        ...
        },
        {
          segments: [
            {
              label: "lift, then cross the body down and right",
              path: [
                { x: 175, y: 405 },
                { x: 205, y: 365 },
                { x: 235, y: 325 },
      ...
      strokes: [
        {
          segments: [
            {
              label: "curve clockwise around the inner curl",
              path: [
                { x: 165, y: 551 },
                { x: 195, y: 540 },
                { x: 215, y: 510 },
      ...
      strokes: [
        {
          segments: [
            {
              label: "descend through the hook and diagonal tail",
              path: [
                { x: 250, y: 540 },
                { x: 255, y: 505 },
                { x: 265, y: 465 },
