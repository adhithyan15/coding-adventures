#!/bin/sh
# Build and run the symbolic-ir tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c symbolic_ir-tests tests/symbolic_ir_test.c src/symbolic_ir.c
