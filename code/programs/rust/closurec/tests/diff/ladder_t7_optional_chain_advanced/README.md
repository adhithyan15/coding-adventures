# ladder_t7_optional_chain_advanced

Rung 7.optional_chain of the CCR-066 differential complexity ladder, at `ADVANCED`.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t7_optional_chain_advanced/input/a.js
```
