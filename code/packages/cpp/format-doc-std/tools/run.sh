#!/bin/sh
# Build and run the format-doc-std tests under EVERY available C/C++ compiler (pure ISO),
...
ISO_INCLUDE="include ../format-doc/include $HARNESS/include"
export ISO_INCLUDE
...
iso_build_and_run cpp format_doc_std-tests tests/format_doc_std_test.cpp
