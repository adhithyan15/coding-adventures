module github.com/adhithyan15/coding-adventures/code/packages/go/sql-csv-source

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/csv-parser v0.0.0
	github.com/adhithyan15/coding-adventures/code/packages/go/sql-execution-engine v0.0.0
)
