...
type: word
headword: ho parlato
gloss: the passato prossimo — avere plus a participle, the everyday Italian past
concept_tag: IT-PAST-COMPOUND
prerequisites: [IT-C14-avere, IT-C05-parlare]
...
|---|---|---|
| parl**are** | -are | parl**ato** |
| lavor**are** | -are | lavor**ato** |
| cred**ere** | -ere | cred**uto** |
| dorm**ire** | -ire | dorm**ito** |
...
The silent **h** from last chapter is doing its job again: *ho parlato* on the
page can't be misread as *o parlato* ("or spoken").

Note **parlato** keeps the *-t-* that French wore away: Italian *parlato*, French
...
Not a past tense: *avere* in its plain sense of **possessing**, with *scriptās* as
an **adjective** agreeing with *litterās*. Over centuries "I possess a written
thing" slid into simply "**I wrote**" — a possessive construction **hardened into
a tense**.

The fossil survives. When the object comes **before** the verb, the participle
still agrees with it, exactly as an adjective would:

> **Le ho vist*e*.** — "I saw them [f. pl.]."
...
- [YOU SAY: the conservative *-t-* — "parla**t**o · French parlé"]
- [YOU SAY: "Ho lavorato" ("I worked") — Ch. 5's verb]
...
*ho parlato* originally mean? ("I **have** [a thing] **spoken**" — a
**possessive**.) Why can the participle agree? (It was an **adjective**
describing the object.) Next: the other Italian past, and where it still lives.
`,r=e({default:()=>i}),i=`---
schema_version: 2
...
type: word
headword: parlò
gloss: the passato remoto — the simple past, alive in the south and in books
concept_tag: IT-PAST-SIMPLE-REGIONAL
prerequisites: [IT-C15-passato-prossimo]
...
|---|---|
| **Sicily, much of the south** | **passato remoto** — *parlò* is normal speech |
| Tuscany | both, with a distinction of distance in time |
| **North** | **passato prossimo** almost always; *parlò* feels literary |

So the "correct" answer changes as you travel. In the north the *passato remoto*
...
type: word
headword: la mano
gloss: the hand — the noun that breaks Italian's own gender rule
concept_tag: IT-BODY-HAND
prerequisites: [IT-C17-testa, IT-C01-il-la-lo]
...
Both halves are irregular. A masculine *-o* noun would pluralise in *-i* (*libro
...
*-a*/*-e* (*casa/case*), and *-e*/*-i* (*notte/notti*, which Chapter 1 already
gave you). *Manus* belonged to the Latin **fourth**, whose nouns ended in *-us*
but could be **feminine**:

| Latin | | Italian |
|---|---|---|
| *manus* (4th decl., **fem.**) | → | *la mano* |
| *manūs* (plural) | → | *le mani* |

When Italian dropped the fourth declension, *mano* was left with its old gender
...
(A few others survive the same way: *la radio*, *la foto*, *l'auto* — though
...
- [YOU SAY: the breach — "**la** mano, feminine, ending in **-o**"]
- [YOU SAY: the reason — "fourth declension, *manus*, feminine"]
...
Why? (Latin *manus* was
**fourth declension**, whose nouns ended *-us* but could be feminine; Italian
dropped that declension and left the word stranded.) What is the general lesson?
(An **irregular** word is usually a **regular word from a lost system**.) Which
English word came from Italian here, and what did it mean? (**Manage**, from
*maneggiare*, to **handle a horse**.) Next: the rest of the body.
`,h=e({default:()=>g}),g=`---
schema_version: 2
id: IT-C17-testa
spine_node: SPINE-CHECK-WELLBEING
...
type: word
headword: la testa
gloss: the head — the pot-word, kept in its original shape
...
proper word *caput*. (Only there — Iberia kept *caput*, which is why Portuguese
and Spanish still say *cabeça* and *cabeza*.)
...
So Italian has **both**: *testa* for the thing on your shoulders, *capo* for the
person in charge. English borrowed the second one straight out of Italian —
a *capo* in a crime family is exactly this word.
...
[PAUSE 1s]
- [YOU SAY: "la testa"]
- [YOU SAY: "ho mal di testa" — "I have a headache"]
- [YOU SAY: the erosion — "**testa** … **tête**"]
...
compare with French here? (Italian kept it **almost unchanged** — the spelling is identical, the vowel opened; French wore it down to
*tête* — the conservative-sister pattern again, like *acqua*/*eau*.) What did
Italian do with *caput*? (Kept it as ***il capo***, "boss, chief" — a live
everyday word, where French kept it only outside the head-slot.) Next: the hand.
