...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    */
    expect(report.summary.missedByWindow.R2).toBe(3685); // Persian's new opener etymon begins its wider review window; its payoff work stays in Chapter 1.
  });
