# ladder_t6_class_static_advanced

Rung 6.class_static of the CCR-066 differential complexity ladder, at `ADVANCED`.

## What this rung is for

Exercises a class with a static method.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t6_class_static_advanced/input/a.js
```
...
```js
class A{static f(){return 1}}console.log(A.f());
```
