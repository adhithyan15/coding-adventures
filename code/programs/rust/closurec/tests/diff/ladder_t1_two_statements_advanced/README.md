# ladder_t1_two_statements_advanced
...
Exercises two statements, so statement separation is exercised.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t1_two_statements_advanced/input/a.js
```
