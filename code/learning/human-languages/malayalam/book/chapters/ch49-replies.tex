...
% canonical-source-hash: fnv1a64:18e73528e322929b
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{satyaṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{satyaṁ}, then \emph{śari}, and hear the weight shift between them
  \item \emph{Recall:} say \emph{kāl}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{mati}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{mati}, then \emph{illa}, two words that each finish a sentence alone
  \item \emph{Recall:} read \textbf{\ml{പല്ല്}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{tīrccayāyuṁ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{tīrccayāyuṁ}, slowly, then \emph{satyaṁ}, and put the long word beside the short one
  \item \emph{Recall:} say \emph{muṭi}
\end{itemize}
...
Take it apart and it says \textquotedblleft{}on one side\textquotedblright{}. \ml{ഒരു} (\emph{oru}) is the \emph{one} you met leaning on a noun — the shape \ml{ഒന്ന്} takes when something follows it. \ml{പക്ഷം} (\emph{pakṣaṁ}) is Sanskrit for a side, a wing, one of the alternatives on offer.
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{orupakṣē}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{orupakṣē}, then \emph{tīrccayāyuṁ}, the hedge and the promise
  \item \emph{Recall:} read \textbf{\ml{വിരൽ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{aṅṅane}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order — \emph{satyaṁ}, \emph{mati}, \emph{tīrccayāyuṁ}, \emph{orupakṣē}, \emph{aṅṅane}
  \item \emph{Recall:} say \emph{vayaṟŭ}
\end{itemize}
