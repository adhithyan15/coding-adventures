...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3401, // +1: Spanish brings quién forward as a voice lesson
      ...
      voice: 2466, // +1: Spanish's earlier quién lesson
      ...
      pen: 345, // +5: Marwadi writing lessons
      ...
      drivableLessons: 2466, // Spanish's earlier quién lesson is hands-free
      ...
      unstartableChapters: 210, // French/Marathi order recovery on current main: measured, not inferred. // +1: Marwadi begins with a pen lesson
      overriddenLessons: 0,
