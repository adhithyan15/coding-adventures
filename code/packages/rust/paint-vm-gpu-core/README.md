...
| `PaintPath` | Flattened line/quad/cubic contours; simple fan fill; solid and dashed stroked segments with open-contour caps |
...
- Add stroke joins for expanded path strokes.
