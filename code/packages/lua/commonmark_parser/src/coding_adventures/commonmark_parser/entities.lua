...
function M.decode_entity(ref)
  ...
  -- Unknown reference — return as-is (per CommonMark spec)
  return ref
end
...
function M.decode_entities_full(text)
  ...
  -- Per CommonMark spec §2.5: decimal refs must have 1-7 digits, hex refs 1-6 digits.
...
--   "  → &quot;
--
-- Note: we do NOT escape apostrophes because CommonMark's reference
