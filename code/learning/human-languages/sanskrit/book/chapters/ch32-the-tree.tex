...
% canonical-source-hash: fnv1a64:397df51f22533555
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{taruḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{himam}, then \emph{taruḥ}
  \item \emph{Recall:} say \emph{dvāram}, then read \textbf{\sk{आकाशः}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{patram}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{taruḥ}, then \emph{patram}
  \item \emph{Recall:} read \textbf{\sk{आसनम्}}, then say \emph{candraḥ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{tṛṇam}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{patram}, then \emph{tṛṇam}
  \item \emph{Recall:} say \emph{puṣpam}, then read \textbf{\sk{तारा}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{latā}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{taruḥ}, then \emph{latā}, in the order they grow
  \item \emph{Recall:} read \textbf{\sk{माला}}, then say \emph{vāyuḥ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{dāru}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then name the English word hiding in \emph{dāru}
  \item \emph{Recall:} say \emph{añjaliḥ}, then read \textbf{\sk{हिमम्}}
\end{itemize}
