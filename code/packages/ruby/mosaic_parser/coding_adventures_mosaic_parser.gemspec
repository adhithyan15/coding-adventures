...
require_relative "lib/coding_adventures/mosaic_parser/version"

Gem::Specification.new do |spec|
  spec.name          = "coding_adventures_mosaic_parser"
  spec.version       = CodingAdventures::MosaicParser::VERSION
  spec.authors       = ["Adhithya Rajasekaran"]
  spec.summary       = "Parses Mosaic token stream into an ASTNode tree"
