defmodule CodingAdventures.CommonmarkParser do
  @moduledoc """
  CommonMark 0.31.2 parser — converts Markdown text to a Document AST.
  ...
  All 652 CommonMark 0.31.2 specification examples are supported.
