...
% canonical-source-hash: fnv1a64:deda1b471d653989
% canonical-lessons: SA-C08-cintayati, SA-S112-vowel-sign-e, SA-C08-avagacchati, SA-C08-pathati, SA-S208-letter-va, SA-C08-likhati
...
\begin{quote}
Before the new one, the ones you have already met: \sk{च} · \sk{क} · \sk{ख}. Say what each of them does.
...
Worked through: \textbf{\sk{न}} + \textbf{\sk{◌े}} = \textbf{\sk{ने}} — \emph{ne}.

You already say this word, and \sk{◌े} is one of the shapes inside it — the rest of its shapes are still ahead of you, so here the character stands on its own:
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at this, and find \sk{◌े} in it
\end{itemize}
...
\end{tcolorbox}
\section[va]{\sk{व} — one character, met inside words you already say}

\label{lesson:SA-S208-letter-va}



\begin{quote}
Before the new one, the ones you have already met: \sk{क} · \sk{ख} · \sk{◌े}. Say what each of them does.

One character this time. One only — and you have been saying it for pages without knowing which mark on the page it was.
\end{quote}

\subsection*{Script you'll notice: \sk{व}}
\textbf{\sk{व}} — \emph{va}.
...
\begin{itemize}
\raggedright
  \item a counterclockwise left loop
  \item a top-to-bottom right stem
  \item the top shirorekhā
\end{itemize}

You already say these, and every one of them has \sk{व} somewhere inside it:

\begin{itemize}
\raggedright
  \item \textbf{\sk{वदामि}} \emph{vadāmi} — I speak
\end{itemize}

\subsection*{Writing: \sk{व}}
\hlblockfigure{\detokenize{figures/SA-S208-letter-va-filmstrip.pdf}}{How \sk{व} is written, stroke by stroke}

\begin{itemize}
\raggedright
  \item \textbf{1.} start at the upper-right of the body, travel left around the top, and continue counterclockwise around the loop to the right-side junction
...
\begin{quote}
This is one attested teaching order and not a national standard — handwriting here is taught with school-to-school variation. Source: JackPotte, ‘Devanagari v \sk{व}.gif’, strokes 1–3, Wikimedia Commons, 29 March 2009.
\end{quote}

\subsection*{Your turn}
\begin{itemize}
\raggedright
  \item \emph{Look:} at this, and find \sk{व} in it
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Trace it:} \sk{व} three times, saying \emph{va} as you finish each one
  \item \emph{Look:} back at any page of this chapter and find \sk{व} once more
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which character is this — \sk{व}? What sound does it carry? (\emph{\textbf{va}}.) Name one word you already say that contains it.
\end{tcolorbox}
