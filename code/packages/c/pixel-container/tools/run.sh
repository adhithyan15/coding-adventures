#!/bin/sh
# Build and run the pixel-container tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c pixel_container-tests tests/pixel_container_test.c src/pixel_container.c
