...
Current selection: **RCPU-037**, the x86-64 functional Rust audit. The
2026-08-31 prioritization run completed the PowerPC pair and advances to the
next chronological CPU while completed earlier cells publish one at a time.
