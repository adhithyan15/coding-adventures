...
% canonical-source-hash: fnv1a64:5e55d3f1ab13154f
% canonical-lessons: FA-W15-alef, FA-W15-lam, FA-W15-sin, FA-W15-mim, FA-W15-joining, FA-W15-be, FA-W15-te-nun, FA-W15-he, FA-W15-vav, FA-C15-practice, FA-C15-second-pass-spellable
...
\hlblockfigure{\detokenize{figures/FA-W15-alef-filmstrip.pdf}}{How \fa{ا} is written, stroke by stroke}
...
\hlblockfigure{\detokenize{figures/FA-W15-lam-filmstrip.pdf}}{How \fa{ل} is written, stroke by stroke}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/FA-W15-sin-filmstrip.pdf}}{How \fa{س} is written, stroke by stroke}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/FA-W15-mim-filmstrip.pdf}}{How \fa{م} is written, stroke by stroke}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/FA-W15-be-filmstrip.pdf}}{How \fa{ب} is written, stroke by stroke}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/FA-W15-he-filmstrip.pdf}}{How \fa{ه} is written, stroke by stroke}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/FA-W15-vav-filmstrip.pdf}}{How \fa{و} is written, stroke by stroke}
...
\end{tcolorbox}
\section[mamnun · zan · dust]{\fa{ممنون} · \fa{زن} · \fa{دوست} — three words the letters have caught up with}

\label{lesson:FA-C15-second-pass-spellable}



\begin{quote}
Say the word you have used for \emph{thank you} since the first page. You have had it in your mouth far longer than you have had it on the page.
\end{quote}

\subsection*{You'll want to know: the letters have caught up with the words}
Three words you already say, now taken apart with letters you can name:

\noindent
\begin{tabularx}{\linewidth}{@{}>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X>{\raggedright\arraybackslash}X@{}}
\toprule
\textbf{word} & \textbf{} & \textbf{its letters} \\
\midrule
\textbf{\fa{ممنون}} \emph{mamnun} & thank you & \fa{م} · \fa{م} · \fa{ن} · \fa{و} · \fa{ن} \\
\textbf{\fa{زن}} \emph{zan} & woman & \fa{ز} · \fa{ن} \\
\textbf{\fa{دوست}} \emph{dust} & friend & \fa{د} · \fa{و} · \fa{س} · \fa{ت} \\
\bottomrule
\end{tabularx}

Look at what is \textbf{not} there. \emph{Mamnun} has an \emph{a} you say and no \emph{a} you read, because Persian leaves the short vowels off the page — the rule you were told on the very first word, now visible in a word you can spell. \emph{Dust} has the opposite: the \textbf{\fa{و}} is written, because a long \emph{u} earns a letter.

\textbf{Short vowels are heard and not written; long ones are both.} That single sentence is most of what makes Persian readable.

\subsection*{Your turn}
\begin{itemize}
\raggedright
  \item \emph{Look:} at \textbf{\fa{ممنون}} and name each letter from the right
  \item \emph{Say it:} \textbf{zan} — woman; then name its two letters
  \item \emph{Say it:} \textbf{dust} — friend; then say which of its four letters is the long \emph{u}
  \item \emph{Say it:} \textbf{mamnun} — and say where the \emph{a} you hear has gone on the page
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which word means \emph{thank you}, and which vowel of it is unwritten? (\textbf{\fa{ممنون}} — the short \emph{a}.) Which two letters spell \emph{woman}? (\textbf{\fa{ز} \fa{ن}}.) Which letter of \textbf{\fa{دوست}} carries the long \emph{u}? (\textbf{\fa{و}}.) And what is the rule the three words share? (\textbf{Short vowels are not written; long ones are.})
\end{tcolorbox}
