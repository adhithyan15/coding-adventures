...
const fallbackProps = {
  "rows": [
    [
      "x1",
      "A group heading long enough to wrap onto a second line on a narrow window",
      "A title that keeps going well past the width of any reasonable sidebar",
      "A subtitle that is also far too long, to show how the row grows rather than clipping what the person wrote.",
      "12 September 2026",
      "In progress"
    ]
  ],
