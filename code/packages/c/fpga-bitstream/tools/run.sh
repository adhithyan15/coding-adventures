#!/bin/sh
# Build and run the fpga-bitstream tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c fpga_bitstream-tests tests/fpga_bitstream_test.c src/fpga_bitstream.c
