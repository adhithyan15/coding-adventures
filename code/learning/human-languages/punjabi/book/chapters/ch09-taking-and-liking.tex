...
% canonical-source-hash: fnv1a64:e2f4a4a62c3fc750
% canonical-lessons: PA-C09-laina, PA-C09-puchhna, PA-S09-aunkar-tippi, PA-C09-madad-karna, PA-S09-dulainkar-oora, PA-C09-pasand
...
\end{tcolorbox}
\section[-u · (nasal)]{\pa{ੁ} · \pa{ੰ} — two pieces met inside a word you already say}

\label{lesson:PA-S09-aunkar-tippi}



\begin{quote}
The first mātrā that lives \textbf{below} the line, and the nasal mark's other half.

First, say the last things you learned once more, out loud and from memory:

\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{paṛhnā} · \emph{likhṇā} · \emph{laiṇā}
\end{itemize}
\end{quote}

\subsection*{Script you'll notice: \pa{ੁ} · \pa{ੰ}}
\begin{quote}
\pa{ੁ}
\end{quote}

\textbf{auṅkaṛ} — \emph{-u}. A mātrā for short \emph{u}, and the first one you have met that is written \textbf{below} the letter.

\begin{quote}
\pa{ੰ}
\end{quote}

\textbf{ṭippī} — \emph{(nasal)}. A nasal mark that sits on the head-line. It is the sister of the \emph{bindi} you already know: same job, different company.

Now put them where you have already heard them:

\begin{quote}
\textbf{\pa{ਪ}} + \textbf{\pa{ਸ}} + \textbf{\pa{ੰ}} + \textbf{\pa{ਦ}} $\to$ \textbf{\pa{ਪਸੰਦ}} (\emph{pasand})
\end{quote}

\begin{quote}
\textbf{\pa{ਪਸੰਦ}} — \emph{pasand} — \textbf{pleasing}
\end{quote}
...
Keep \pa{ੁ} · \pa{ੰ} in front of you and do not cover any of them. Follow each shape once with a finger, then copy it once with a pencil, larger than it is printed. Say its sound as your hand stops.
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at \textbf{\pa{ਪਸੰਦ}} and point to each of today's pieces in turn
  \item \emph{Say it:} \emph{-u}, \emph{(nasal)}, then the whole word — \emph{pasand}
  \item \emph{Look:} back at the headword at the top of any earlier lesson in this chapter and find one shape you now know
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Name today's pieces: \emph{auṅkaṛ}, \emph{ṭippī}. Which of them is a \textbf{mātrā} or a mark rather than a letter, and what does \textbf{\pa{ਪਸੰਦ}} say? (\emph{pasand}, “pleasing”.)
...
\subsection*{The letters in this word}
\textbf{\pa{ਮ}} \emph{m}, \textbf{\pa{ਦ}} \emph{d}, \textbf{\pa{ਦ}} \emph{d} — the whole of \emph{madad}, and \textbf{no dot beneath anything}. Chapter 1's \emph{shukrīā} needed a dotted letter for a borrowed sound — a dot you meet for yourself later on. This borrowing needed no new letter at all.
...
\raggedright
  ...
  \item \emph{gall karnā} — “talk-do” — \textbf{to have a chat}
\end{itemize}
...
\end{tcolorbox}
\section[-ū · u]{\pa{ੂ} · \pa{ਉ} — two pieces met inside a word you already say}

\label{lesson:PA-S09-dulainkar-oora}



\begin{quote}
The word that opens every sentence about what you like is five pieces — and you already have three.

First, say the last things you learned once more, out loud and from memory:

\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{laiṇā} · \emph{puchhṇā}
\end{itemize}
\end{quote}

\subsection*{Script you'll notice: \pa{ੂ} · \pa{ਉ}}
\begin{quote}
\pa{ੂ}
\end{quote}

\textbf{dulaiṅkaṛ} — \emph{-ū}. A mātrā for long \emph{ū}, written below the letter as \textbf{two} strokes — the double \emph{auṅkaṛ}.

\begin{quote}
\pa{ਉ}
\end{quote}

\textbf{ūṛā} — \emph{u}. An \textbf{independent} vowel: the letter used when a word \emph{starts} with the vowel and there is no consonant to hang a mātrā on.

Now put them where you have already heard them:

\begin{quote}
\textbf{\pa{ਮ}} + \textbf{\pa{ੈ}} + \textbf{\pa{ਨ}} + \textbf{\pa{ੂ}} + \textbf{\pa{ੰ}} $\to$ \textbf{\pa{ਮੈਨੂੰ}}
\end{quote}
...
\subsection*{Writing: copy what you can see}
Keep \pa{ੂ} · \pa{ਉ} in front of you and do not cover any of them. Follow each shape once with a finger, then copy it once with a pencil, larger than it is printed. Say its sound as your hand stops.
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at \textbf{\pa{ਮੈਨੂੰ}} and point to each of today's pieces in turn
  \item \emph{Say it:} \emph{-ū}, \emph{u}, then the whole word — \emph{mainū̃}
  \item \emph{Look:} back at the headword at the top of any earlier lesson in this chapter and find one shape you now know
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Name today's pieces: \emph{dulaiṅkaṛ}, \emph{ūṛā}. Which of them is a \textbf{mātrā} or a mark rather than a letter, and what does \textbf{\pa{ਮੈਨੂੰ}} say? (\emph{mainū̃}, “to me”.)
