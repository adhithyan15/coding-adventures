...
fn parses_bjt_models_into_operating_point_circuits() {
    let parsed = parse_netlist(
        r#"
.model fast NPN(IS=1e-13 BF=120 VT=26m CJE=2p CJC=3p TF=4n TR=5n XTI=2.5 EG=1.05 VAF=75 VA=120 VAR=60 VB=90 IKF=3m IK=5m IKR=4m TNOM=27 T_NOM=35 KF=2p AF=1.3)
Vcc vcc 0 DC 5
Vbase base 0 DC 0.7
