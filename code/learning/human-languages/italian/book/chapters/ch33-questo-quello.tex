...
% canonical-source-hash: fnv1a64:f4041dd18bbdbcaf
...
Italian also has \textbf{qua} and \textbf{là}, which mean the same and are used just as often; \emph{qui/lì} are slightly more precise and \emph{qua/là} slightly vaguer, and no Italian will notice which you pick.
