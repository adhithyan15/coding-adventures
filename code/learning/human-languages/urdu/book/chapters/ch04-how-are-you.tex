...
% canonical-source-hash: fnv1a64:0bab31542cd555c5
% canonical-lessons: UR-C04-kaise-kaisi, UR-W04-joining, UR-C04-aap-kaise-hain, UR-C04-main-hun, UR-C04-main-hun-more, UR-W04-kaf, UR-C04-thik, UR-C04-main-thik-hun, UR-W04-nun, UR-C04-practice
...
The order is \textbf{you + how + are?} Keep \textbf{\ur{ہیں}} \emph{haiṅ} final, exactly as \textbf{\ur{ہے}} \emph{hai} stayed final in the name question. Respectful \textbf{āp} takes this plural-shaped copula even when speaking to one person.
...
\end{tcolorbox}
\section[(maiṅ ... hūṅ, continued)]{(\ur{میں} ... \ur{ہوں}, continued) — the verb closes the frame}

\label{lesson:UR-C04-main-hun-more}



\begin{quote}
Before going on: say \textbf{\ur{میں} ... \ur{ہوں}} again, and what it means.
\end{quote}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} what this lesson added to \textbf{\ur{میں} ... \ur{ہوں}}, in one sentence
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What did this lesson add to \textbf{\ur{میں} ... \ur{ہوں}}? Say it once more, without looking.
\end{tcolorbox}
...
\hlblockfigure{\detokenize{figures/UR-W04-kaf-filmstrip.pdf}}{How \ur{ک} is written, stroke by stroke}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/UR-W04-nun-filmstrip.pdf}}{How \ur{ن} is written, stroke by stroke}
