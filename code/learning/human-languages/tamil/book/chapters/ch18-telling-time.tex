...
% canonical-source-hash: fnv1a64:8f2f753345a5b327
...
\raggedright
  ...
  \item \emph{Read it:} \textbf{\ta{௩} \ta{மணி}} — the numeral from chapter seven and the hour word you have met, side by side
\end{itemize}
...
\begin{enumerate}
\raggedright
  \item \textbf{a crossing spiral on the left}
  \item \textbf{a tall straight vertical on the right}
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item \textbf{a curl that turns back on itself}
  \item \textbf{a stroke rising to the right}
\end{enumerate}
...
\hlblockfigure{\detokenize{figures/TA-S122-letter-ta-filmstrip.pdf}}{How \ta{த} is written, stroke by stroke}
