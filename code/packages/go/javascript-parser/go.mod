module github.com/adhithyan15/coding-adventures/code/packages/go/javascript-parser

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/grammar-tools v0.0.0
	github.com/adhithyan15/coding-adventures/code/packages/go/javascript-lexer v0.0.0
...
replace github.com/adhithyan15/coding-adventures/code/packages/go/javascript-lexer => ../javascript-lexer
