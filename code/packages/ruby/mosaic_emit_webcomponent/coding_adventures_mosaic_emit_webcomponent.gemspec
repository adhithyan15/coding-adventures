...
require_relative "lib/coding_adventures/mosaic_emit_webcomponent/version"

Gem::Specification.new do |spec|
  spec.name          = "coding_adventures_mosaic_emit_webcomponent"
  spec.version       = CodingAdventures::MosaicEmitWebcomponent::VERSION
  spec.authors       = ["Adhithya Rajasekaran"]
  spec.summary       = "Web Components backend: emits Custom Element classes from MosaicIR"
