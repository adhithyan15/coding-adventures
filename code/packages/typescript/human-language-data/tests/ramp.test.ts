...
describe("corpus snapshot", () => {
  ...
  it("pins the ramp, and the size of its blind spot", () => {
    ...
    */
    // Incoming Arabic-only baseline before Persian:
    /*
    ...
    */
    expect(report.summary.unmeasurableLessons).toBe(496); // Arabic improves the baseline by two; Persian's atom-free guided-copy bridge adds one.
