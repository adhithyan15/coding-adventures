...
% canonical-source-hash: fnv1a64:8a31269a9e596ac5
% canonical-lessons: IT-C01-ciao, IT-W01-ciao-guided-copy, IT-W01-ciao-delayed-copy, IT-W01-ciao-dictation, IT-C01-buono, IT-C01-il-la-lo, IT-C01-giorno, IT-C01-buongiorno, IT-C01-sera, IT-C01-notte, IT-C01-grazie, IT-C01-practice
...
\end{tcolorbox}
\section[ciao]{ciao — write it with the model covered}

\label{lesson:IT-W01-ciao-delayed-copy}



\begin{quote}
Look at \textbf{ciao} once and say it: \emph{CHOW}. Then cover it.
\end{quote}

\subsection*{Writing — delayed copy}
With the model covered, wait ten seconds, then write \textbf{ciao} once from memory.
...
Only after the word is finished, uncover the model. Compare, and repair \textbf{one} letter — the first that differs and no others.

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
If the letter that differed was the \textbf{i}, that is the expected miss. Four letters, and one of them is silent: the \textbf{i} in \emph{ciao} is not a sound, it is the instruction that makes \textbf{c} say \emph{ch} instead of \emph{k}. A hand writing from memory drops the letter it never heard.
\end{tcolorbox}
\section[ciao]{ciao — write it from the sound}

\label{lesson:IT-W01-ciao-dictation}



\begin{quote}
Close the book on every page that has \textbf{ciao} written on it. Nothing to copy and nothing to uncover this time.
\end{quote}

\subsection*{Writing — dictation}
Say \emph{CHOW} aloud, or play it, and write what you hear. Once.
...
Three sounds, four letters. \textbf{ciao} is the clearest possible first lesson in what Italian spelling does: the \textbf{i} is written for the \textbf{c} to read, not for you to say. Dictation is where that stops being a fact about one word and starts being a habit — when you hear \emph{ch} before \emph{a}, \emph{o} or \emph{u}, an \textbf{i} has to go on the page, and nothing in the sound will remind you.
\end{tcolorbox}
