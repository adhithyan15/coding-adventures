...
prerequisites: [FR-C02-je, FR-C02-me]
sounds: [er-ending]
roots: [appellare]
etymology_hook: "appeler ← Latin appellāre, 'to address, call by name' — English appeal, appellation, appellate; to name someone is to call them"
duration:
  max_seconds: 240
requires:
  knowledge: [FR-LEX-JE-01, FR-LEX-ME-03, FR-GRAM-REFLEXIVE-SET-04]
introduces:
  knowledge: [FR-LEX-APPELER-05, FR-GRAM-REFLEXIVE-VERB-06]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [FR-LEX-APPELER-05, FR-GRAM-REFLEXIVE-VERB-06, FR-LEX-ME-03, FR-GRAM-REFLEXIVE-SET-04]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus]
variety: standard-contemporary
register: neutral
reviews_of: [FR-C02-je, FR-C02-me]
---
...
## Sounds you'll need
<!-- hl-knowledge: introduces=[FR-LEX-APPELER-05]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[FR-GRAM-REFLEXIVE-VERB-06]; assesses=[FR-GRAM-REFLEXIVE-SET-04, FR-LEX-ME-03] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[FR-LEX-APPELER-05, FR-GRAM-REFLEXIVE-VERB-06] -->
...
prerequisites: [FR-C02-comment, FR-C02-tu-vous, FR-C02-appeler, FR-C02-je-mappelle]
sounds: [liaison]
roots: [quo-modo, appellare, vos]
etymology_hook: "comment + vous appelez-vous — the statement vous vous appelez becomes a question by flipping verb and pronoun across a hyphen"
duration:
  max_seconds: 250
requires:
  knowledge: [FR-LEX-COMMENT-HOW-10, FR-LEX-TU-VOUS-08, FR-LEX-APPELER-05, FR-GRAM-REFLEXIVE-VERB-06, FR-GRAM-REFLEXIVE-SET-04, FR-LEX-JEMAPPELLE-07]
introduces:
  knowledge: [FR-GRAM-INVERSION-NAME-11]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [FR-GRAM-INVERSION-NAME-11, FR-LEX-COMMENT-HOW-10, FR-LEX-TU-VOUS-08, FR-LEX-APPELER-05, FR-GRAM-REFLEXIVE-SET-04, FR-LEX-JEMAPPELLE-07]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus]
variety: standard-contemporary
...
<!-- hl-knowledge: introduces=[]; assesses=[FR-LEX-COMMENT-HOW-10, FR-LEX-APPELER-05, FR-LEX-TU-VOUS-08] -->
...
<!-- hl-knowledge: introduces=[FR-GRAM-INVERSION-NAME-11]; assesses=[FR-GRAM-REFLEXIVE-SET-04, FR-LEX-JEMAPPELLE-07] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[FR-GRAM-INVERSION-NAME-11, FR-LEX-TU-VOUS-08, FR-LEX-JEMAPPELLE-07] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[FR-GRAM-INVERSION-NAME-11, FR-LEX-TU-VOUS-08] -->
...
prerequisites: [FR-C02-tu-vous, FR-C02-je-mappelle]
sounds: [nasal-on]
roots: [quo-modo]
etymology_hook: "comment ← Latin quo modo, 'in what manner' — the same two words that became Spanish cómo, and the modo alive in English mode and model"
duration:
  max_seconds: 180
requires:
  knowledge: [FR-LEX-TU-VOUS-08, FR-LEX-JEMAPPELLE-07]
introduces:
  knowledge: [FR-LEX-COMMENT-HOW-10]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
...
## Sounds you'll need
<!-- hl-knowledge: introduces=[FR-LEX-COMMENT-HOW-10]; assesses=[] -->
...
<!-- hl-knowledge: introduces=[]; assesses=[FR-LEX-COMMENT-HOW-10] -->
...
prerequisites: [FR-C02-je-mappelle, FR-C01-bon]
sounds: [nasal-on, nasal-an, ch-sh]
roots: [in-cantare]
etymology_hook: "enchanté ← in- + cantāre, 'to sing a spell upon' — English enchant, incantation, chant; and it agrees with the speaker's own gender"
duration:
  max_seconds: 180
requires:
  knowledge: [FR-LEX-JEMAPPELLE-07, FR-GRAM-ADJ-AGREEMENT-04]
introduces:
  knowledge: [FR-LEX-ENCHANTE-12]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [FR-LEX-ENCHANTE-12, FR-GRAM-ADJ-AGREEMENT-04]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus]
variety: standard-contemporary
...
## Sounds you'll need
<!-- hl-knowledge: introduces=[FR-LEX-ENCHANTE-12]; assesses=[] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[FR-LEX-ENCHANTE-12, FR-GRAM-ADJ-AGREEMENT-04] -->
...
roots: [ego]
etymology_hook: "je ← Latin ego — the word for 'I' and the psychologist's ego are one ancient word, one worn to a whisper and one kept whole"
duration:
  max_seconds: 180
requires:
  knowledge: []
introduces:
  knowledge: [FR-LEX-JE-01, FR-ETYMON-JE-EGO-02]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
...
## Sounds you'll need
<!-- hl-knowledge: introduces=[FR-LEX-JE-01]; assesses=[] -->
...
## The word, taken apart
<!-- hl-knowledge: introduces=[FR-ETYMON-JE-EGO-02]; assesses=[] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[FR-LEX-JE-01, FR-ETYMON-JE-EGO-02] -->
...
type: word
headword: me
gloss: me / myself (reflexive and object pronoun)
concept_tag: PRONOUN-ME
prerequisites: [FR-C02-je]
sounds: [soft-e, elision]
roots: [me-latin]
etymology_hook: "me ← Latin mē — literally the same word as English me, from one Proto-Indo-European root that also gave my and mine"
duration:
  max_seconds: 250
requires:
  knowledge: [FR-LEX-JE-01]
introduces:
  knowledge: [FR-LEX-ME-03, FR-GRAM-REFLEXIVE-SET-04]
introduces_idioms: []
introduces_senses: []
introduces_culture_claims: []
practises:
  knowledge: [FR-LEX-ME-03, FR-GRAM-REFLEXIVE-SET-04, FR-LEX-JE-01]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus]
variety: standard-contemporary
...
## Sounds you'll need
<!-- hl-knowledge: introduces=[FR-LEX-ME-03]; assesses=[FR-LEX-JE-01] -->
...
<!-- hl-knowledge: introduces=[FR-GRAM-REFLEXIVE-SET-04]; assesses=[] -->

*me* is one of three little pronouns that **bounce a verb back onto its doer** —
*me* ("myself"), *te* ("yourself"), *se* ("himself, herself"). Their roots run in
parallel with the one you just met, and two of them you already own in English:

- *te* ← Latin **tē**, the cousin of archaic English **thee**.
- *se* ← Latin **sē**, the "self" root behind **se**parate and, at a distance,
  **su**icide (*suī*, "of oneself").

Only **me** does any work here: it is what gives your own name, *je m'appelle*.
*te* turns up once, in the informal "what's your name?" (*comment tu
t'appelles?*), and *se* waits for a lesson that needs it. The set is named so
its shape is familiar, not laid out as a grid to memorize — you meet each one
where it earns its place.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[FR-LEX-ME-03, FR-GRAM-REFLEXIVE-SET-04] -->
...
type: practice
headword: (dialogue)
gloss: the introduction exchange, whole
concept_tag: REVIEW
prerequisites: [FR-C02-je, FR-C02-me, FR-C02-appeler, FR-C02-je-mappelle, FR-C02-tu-vous, FR-C02-comment, FR-C02-comment-vous-appelez-vous, FR-C02-enchante]
sounds: []
roots: []
duration:
  max_seconds: 250
requires:
  knowledge: [FR-LEX-JE-01, FR-ETYMON-JE-EGO-02, FR-LEX-ME-03, FR-GRAM-REFLEXIVE-SET-04, FR-LEX-APPELER-05, FR-GRAM-REFLEXIVE-VERB-06, FR-LEX-JEMAPPELLE-07, FR-LEX-TU-VOUS-08, FR-GRAM-VOUVOIEMENT-09, FR-LEX-COMMENT-HOW-10, FR-GRAM-INVERSION-NAME-11, FR-LEX-ENCHANTE-12]
introduces:
  knowledge: []
introduces_idioms: []
introduces_senses: []
...
## The exchange
<!-- hl-knowledge: introduces=[]; assesses=[FR-LEX-JEMAPPELLE-07, FR-GRAM-INVERSION-NAME-11, FR-LEX-ENCHANTE-12, FR-LEX-JE-01, FR-ETYMON-JE-EGO-02, FR-LEX-ME-03, FR-LEX-APPELER-05, FR-LEX-COMMENT-HOW-10, FR-GRAM-REFLEXIVE-VERB-06, FR-GRAM-VOUVOIEMENT-09, FR-LEX-TU-VOUS-08, FR-GRAM-REFLEXIVE-SET-04] -->
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[FR-LEX-JEMAPPELLE-07, FR-GRAM-INVERSION-NAME-11, FR-LEX-ENCHANTE-12, FR-LEX-TU-VOUS-08] -->
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[FR-LEX-JEMAPPELLE-07, FR-GRAM-INVERSION-NAME-11, FR-LEX-ENCHANTE-12, FR-GRAM-REFLEXIVE-VERB-06, FR-LEX-COMMENT-HOW-10] -->
