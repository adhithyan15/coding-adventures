#!/bin/sh
# Build and run the gradient-descent tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp gradient_descent-tests tests/gradient_descent_test.cpp
