...
A Go port of the `coding-adventures-cas` Rust crate. Provides generic
...
```go
import "github.com/adhithyan15/coding-adventures/code/packages/go/cas"
...
- `code/packages/rust/cas` — Reference Rust implementation (same spec)
