...
mod business_logic {
    ...
    fn physical_pwd_returns_absolute_path() {
        // We import from the binary's library code via the pwd crate.
        // Since main.rs has pub functions, we test them here.
        let result = pwd::get_physical_pwd();
    ...
    fn logical_pwd_returns_absolute_path() {
        let result = pwd::get_logical_pwd();
    ...
    fn logical_pwd_uses_env_when_valid() {
        ...
        let result = pwd::get_logical_pwd().unwrap();
