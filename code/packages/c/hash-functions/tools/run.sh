#!/bin/sh
# Build and run the hash-functions tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c hash_functions-tests tests/hash_functions_test.c src/hash_functions.c
