...
% canonical-source-hash: fnv1a64:2c5a1d6ab5b59cfb
...
\begin{quote}
\emph{maiṅ pānī letā hūṅ.} — I take/get water (man speaking). \emph{maiṅ pānī letī hūṅ.} — I take/get water (woman speaking).
\end{quote}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{madad karnā}
\end{itemize}
...
\begin{quote}
Say \textbf{merā pānī} — my water, underneath \textquotedblleft{}the drinkable thing.\textquotedblright{} Here is the drink you would politely ask for right after it, and a letter from Chapter 9 makes a second appearance.
\end{quote}
...
\subsection*{The letters in this word}
From the right edge: \textbf{\ur{د}} \emph{d}, then \textbf{\ur{و}} carrying long \emph{ū}, then \textbf{\ur{د}} again, then \textbf{\ur{ھ}}. \textbf{\ur{دھ}} extends the two-eyed \emph{he} to a sixth base letter: it has now aspirated \emph{jīm, ṭe, ṛe, che, kāf}, and here it aspirates \textbf{\ur{د}}, giving \emph{dh}.
...
\raggedright
  ...
  \item \emph{Count:} six letters now carrying \textbf{\ur{ھ}} — \emph{jīm, ṭe, ṛe, che, kāf, dāl}
...
\end{tcolorbox}
\section[roṭī]{\ur{روٹی} — \textquotedblleft{}bread,\textquotedblright{} and \emph{pasand} closes the chapter}
...
\begin{quote}
Three drinks so far: \textbf{pānī, chāy, dūdh} — and recall \emph{dūdh}'s real English cousin was \textbf{doughty}, not the tempting \textbf{dough}. This chapter's fourth and final word is the one you would eat, not drink.
\end{quote}
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Does \textbf{\ur{روٹی}} have a secure English cousin? (\textbf{No — the trail stops at Sanskrit.}) Of this chapter's four foods, which one is the Persian loan? (\emph{chāʾe}.) Say \textquotedblleft{}I like bread\textquotedblright{} using the frame from Chapter 8.
