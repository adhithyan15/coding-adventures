# Build and run the b-tree tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name b_tree-tests -Sources @("tests\b_tree_test.c", "src\b_tree.c")
