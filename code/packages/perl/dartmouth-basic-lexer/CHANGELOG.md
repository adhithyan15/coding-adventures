...
- Grammar is now loaded from the compiled
  `CodingAdventures::DartmouthBasicLexer::_Grammar` module instead of
  reading and parsing `dartmouth_basic.tokens` off disk at runtime. A
