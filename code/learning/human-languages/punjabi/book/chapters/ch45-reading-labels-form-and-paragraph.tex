...
% canonical-source-hash: fnv1a64:5b4d0bd6b42e1f93
...
Seventy-two words, and not one of them is new.
\end{quote}

\begin{tcolorbox}[breakable,skin=enhanced,colback=orange!6,colframe=orange!45!black,boxrule=0.5pt,arc=1mm,left=6pt,right=6pt,top=4pt,bottom=4pt,fonttitle=\bfseries,title={Read this}]
\begin{quote}
\pa{ਮੇਰਾ} \pa{ਨਾਂ} \pa{ਅਮਨ} \pa{ਹੈ।} \pa{ਮੇਰਾ} \pa{ਕੰਮ} \pa{ਨੌਕਰੀ} \pa{ਹੈ।} \pa{ਮੈਂ} \pa{ਪੰਜਾਬੀ} \pa{ਬੋਲਦਾ} \pa{ਹਾਂ।} \pa{ਮੈਂ} \pa{ਸੋਚਦਾ} \pa{ਹਾਂ} \pa{ਕਿ} \pa{ਪੰਜਾਬੀ} \pa{ਚੰਗਾ} \pa{ਹੈ।} \pa{ਮਨਨ} \pa{ਮੇਰਾ} \pa{ਦੋਸਤ} \pa{ਹੈ।} \pa{ਮਨਨ} \pa{ਦਾ} \pa{ਕੰਮ} \pa{ਖੇਤੀ} \pa{ਹੈ।} \pa{ਮਨਨ} \pa{ਠੀਕ}-\pa{ਠਾਕ} \pa{ਹੈ।} \pa{ਉਹ} \pa{ਪੰਜਾਬੀ} \pa{ਬੋਲਦਾ} \pa{ਹੈ।} \pa{ਉਹ} \pa{ਸੋਚਦਾ} \pa{ਹੈ} \pa{ਕਿ} \pa{ਪੰਜਾਬੀ} \pa{ਚੰਗਾ} \pa{ਹੈ।} \pa{ਉਹ} \pa{ਮੇਰਾ} \pa{ਦੋਸਤ} \pa{ਹੈ।} \pa{ਮੈਂ} \pa{ਠੀਕ}-\pa{ਠਾਕ} \pa{ਹਾਂ।} \pa{ਮੈਂ} \pa{ਪੰਜਾਬੀ} \pa{ਬੋਲਦਾ} \pa{ਹਾਂ।} \pa{ਮੈਂ} \pa{ਸੋਚਦਾ} \pa{ਹਾਂ} \pa{ਕਿ} \pa{ਪੰਜਾਬੀ} \pa{ਚੰਗਾ} \pa{ਹੈ।} \pa{ਪਰ} \pa{ਮੈਨੂੰ} \pa{ਨਹੀਂ} \pa{ਪਤਾ} \pa{ਕਿ} \pa{ਉਹ} \pa{ਕਿੱਥੇ} \pa{ਹੈ।} \pa{ਅਸੀਂ} \pa{ਜਲਦੀ} \pa{ਮਿਲਾਂਗੇ।} \pa{ਧੰਨਵਾਦ।}
\end{quote}
