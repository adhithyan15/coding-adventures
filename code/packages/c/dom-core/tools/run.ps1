# Build and run the dom-core tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name dom_core-tests -Sources @("tests\dom_core_test.c", "src\dom_core.c")
