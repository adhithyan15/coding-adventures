# Build and run the zip tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
$env:ISO_INCLUDE = "include ..\deflate\include ..\lzss\include $harness\include"
. (Join-Path $harness 'lib\iso-lib.ps1')
Iso-BuildAndRun -Lang c -Name zip-tests -Sources @(
    "tests\zip_test.c",
    "src\zip.c",
    "..\deflate\src\deflate.c",
    "..\lzss\src\lzss.c"
)
