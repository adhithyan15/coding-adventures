...
% canonical-source-hash: fnv1a64:0f4a4b2abebef6c7
...
\hlblockfigure{\detokenize{figures/MW-W06-ttha-filmstrip.pdf}}{How \mw{ठ} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item Read \textbf{\mw{हूं} | \mw{ठीक} | \mw{हूं}} once.
  \item Cover it for ten seconds.
  \item Write all three groups, then say the answer.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listen:} hear one line and identify question or answer.
  \item \textbf{Speak:} hear the question and answer without notes.
  \item \textbf{Read:} match the printed question to its answer.
  \item \textbf{Write:} hear the answer, wait ten seconds, and write it with no model.
\end{enumerate}
