...
% canonical-source-hash: fnv1a64:d51b8db32b3f568b
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}idu nanna magu\textquotedblright{} — this is my child
  \item \emph{Say it:} the root to hold onto — \textquotedblleft{}maka\textquotedblright{}
  \item \emph{Say it:} friend, then child — \textquotedblleft{}snēhita … magu\textquotedblright{}
  \item \emph{Recall:} say \emph{yōcisu}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}ivanu nanna maga\textquotedblright{} — he is my son
  \item \emph{Say it:} the near pair — \textquotedblleft{}magu … maga\textquotedblright{}
  \item \emph{Say it:} Kannada's worn form, then Tamil's fuller one — \textquotedblleft{}maga … makaṉ\textquotedblright{}
  \item \emph{Recall:} read \textbf{\kn{ಅರ್ಥಮಾಡಿಕೊ}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \textquotedblleft{}ivaḷu nanna magaḷu\textquotedblright{} — she is my daughter
  \item \emph{Say it:} the set of three — \textquotedblleft{}magu … maga … magaḷu\textquotedblright{}
  \item \emph{Say it:} one root three endings, then four words no root — \textquotedblleft{}maga, magaḷu … aṇṇa, tamma, akka, tangi\textquotedblright{}
  \item \emph{Say it:} the sisters, near-identical — \textquotedblleft{}magaḷu … makaḷ … makaḷ\textquotedblright{}
  \item \emph{Recall:} say \emph{ōdu}
\end{itemize}
