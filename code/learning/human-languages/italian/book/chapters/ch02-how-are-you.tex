...
\begin{quote}
The \emph{grazie} lesson already promised you this word. Someone says \textbf{grazie}; you reply \textbf{prego}. Like German \emph{bitte}, it's a small word that does several jobs — and it comes straight from \textbf{praying}.
\end{quote}
...
\begin{quote}
Like Spanish, Italian has \textbf{two} verbs for \textquotedblleft{}to be\textquotedblright{} — \textbf{essere} (identity) and \textbf{stare} (state). \textquotedblleft{}How are you?\textquotedblright{} runs on \textbf{stare}. And if you did the Spanish track, this is \emph{estar} with its front \emph{e} taken off.
\end{quote}
...
\raggedright
  ...
  \item answer \textquotedblleft{}Come stai?\textquotedblright{} three ways — \textquotedblleft{}Bene\textquotedblright{} / \textquotedblleft{}Così così\textquotedblright{} / \textquotedblleft{}Non c'è male\textquotedblright{}
