...
| `mathematics/` | Non-arithmetic-primitive math: geometry (area/perimeter/volume), place value, and the K-2 foundational trio (counting sequence, comparison, cardinality). |
