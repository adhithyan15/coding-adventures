...
Last prioritized: 2026-08-08, after publishing #10132 and completing HL-C65.
...
boundary in #10132. The next bounded migration slice is HL-C66, Spanish Chapter
8, whose numbers, age, and `tener` lessons can now build on that explicit frontier.
