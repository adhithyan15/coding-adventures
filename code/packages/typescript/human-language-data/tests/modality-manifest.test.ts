...
describe("corpus regression", () => {
  ...
  it("pins the corpus summary the manifest publishes", () => {
    ...
    expect(manifest.summary).toEqual({
      ...
      // leaving twelve.
      totalLessons: 3413, // Persian's two writing bridges combine with Arabic's seven-lesson greeting-script ramp.
      /* Superseded merge-side totals:
      totalLessons: 3411, // Arabic's seven lessons combine with Portuguese's guided-copy bridge.
      totalLessons: 3406, // Persian adds two writing bridges beside the Italian and Portuguese opener work.
      */
      ...
      voice: 2462, // Arabic adds two voice-first greetings; Portuguese's opener becomes pen-dependent.
      /* Superseded merge-side totals:
      ...
      */
      ...
      pen: 364, // Persian's two pen segments combine with Arabic's eight and the Romance opener work.
      drivableLessons: 2462, // Persian adds no hands-free lesson; Arabic's two gains and the Romance opener losses remain combined.
      ...
      /* Historical baseline and cumulative rationale:
      ...
      */
      drivablePrefixTotal: 2173, // Persian removes four opening lessons and Portuguese removes three from the Italian baseline.
      ...
      */
      fullyDrivableChapters: 666, // Persian Chapter 1 now contains pen work and is no longer fully drivable.
      ...
      unstartableChapters: 216, // Italian, Persian, and Portuguese Chapter 1 now honestly start with pen.
      overriddenLessons: 0,
