#!/bin/sh
# Build and run the arm1-simulator tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c arm1_simulator-tests tests/arm1_simulator_test.c src/arm1_simulator.c
