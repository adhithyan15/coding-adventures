...
% canonical-source-hash: fnv1a64:8f2512d74e51f95c
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{śabdaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{aho}, then \emph{śabdaḥ}
  \item \emph{Recall:} say \emph{siṁhaḥ}, then read \textbf{\sk{तर्हि}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{praśnaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{śabdaḥ}, then \emph{praśnaḥ}
  \item \emph{Recall:} read \textbf{\sk{वृकः}}, then say \emph{yathā}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{vāṇī}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{praśnaḥ}, then \emph{vāṇī}
  \item \emph{Recall:} say \emph{chāgaḥ}, then read \textbf{\sk{केवलम्}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{gītam}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{vāṇī}, then \emph{gītam}
  \item \emph{Recall:} read \textbf{\sk{वानरः}}, then say \emph{muhuḥ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{ślokaḥ}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{śabdaḥ} and \emph{ślokaḥ} together
  \item \emph{Recall:} say \emph{haṁsaḥ}, then read \textbf{\sk{अहो}}
\end{itemize}
