...
% canonical-source-hash: fnv1a64:c84cb11d49cccf33
...
\begin{itemize}
\raggedright
  \item \texttt{ch-hard-k} — Italian \textbf{ch} is a \textbf{hard k} (the opposite of English!): so \textbf{chiamo} = \emph{KYAH-moh}, not \textquotedblleft{}chee-.\textquotedblright{} (Italian softens \emph{c} to \emph{ch}-sound only before \emph{e/i}; the \emph{h} in \emph{chiamo} is there precisely to keep it hard.)
...
\emph{Piacere} stands alone — you just say it, with a small nod, as you shake hands. For a touch more you can say \emph{piacere di conoscerti} (\textquotedblleft{}pleasure to know you\textquotedblright{}).
\end{grammarlens}
...
\begin{quote}
— Buongiorno. \textbf{Come si chiama?} — Mi chiamo Marco Rossi. E Lei? — Rossi. \textbf{Piacere.}
\end{quote}
