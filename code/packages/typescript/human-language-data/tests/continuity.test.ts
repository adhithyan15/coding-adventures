...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    // R1 stops at 3.
    expect(report.summary.missedByWindow.R1).toBe(902); // +2: HL-C98
    ...
    expect(report.summary.missedByWindow.R2).toBe(1921); // +1: ES-C02-concordancia (HL-C85). buenos dias/buenas tardes stop REQUIRING the agreement rule; it becomes a payoff lesson after the learner has used all three greetings.
  });
