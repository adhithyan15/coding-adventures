...
pub use simulator::{
    ...
    HOST_ECALL_ARGUMENT_LOW_REGISTER, HOST_ECALL_EXIT, HOST_ECALL_F64_ADD, HOST_ECALL_F64_CMP,
    HOST_ECALL_F64_DIV, HOST_ECALL_F64_FLOOR, HOST_ECALL_F64_MUL, HOST_ECALL_F64_SUB,
    HOST_ECALL_F64_TO_I64_TRUNC, HOST_ECALL_FLOAT_CONVERSION_FAULT_EXIT_CODE,
