# Build and run the suffix-tree tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name suffix_tree-tests -Sources @("tests\suffix_tree_test.cpp")
