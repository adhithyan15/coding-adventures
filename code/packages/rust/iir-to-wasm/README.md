...
- **String literal output (v0.19.0 — LANG-FULL E4 / BA4)**: `str_const` writes
  ...
  `env.__print_str(ptr,len)`. This is the BASIC `PRINT "HELLO"` foothold only:
  richer string ops (`str_len`, `str_index`, `str_concat`, `str_eq`) still fail
