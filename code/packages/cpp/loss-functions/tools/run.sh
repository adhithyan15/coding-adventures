#!/bin/sh
# Build and run the loss-functions tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp loss_functions-tests tests/loss_functions_test.cpp
