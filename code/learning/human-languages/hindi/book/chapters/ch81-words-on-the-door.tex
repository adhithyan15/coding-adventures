...
% canonical-source-hash: fnv1a64:4b7f9aa5556672d8
...
\section[khulā / khulnā]{\hi{खुला} (khulā) — open}
...
\textbf{\hi{खुला}} (\emph{khulā}) is the word on a shutter, a shop board, a gate and a ticket window. It is also used of a thing that is loose or unpacked: \textbf{\hi{खुला}} (\emph{khulā}) \hi{पैसा} is loose change, coins rather than a note, which is the phrase that will save you at a counter.
...
\raggedright
  ...
  \item \emph{Read it:} \textbf{\hi{खुला}} (\emph{khulā}), as though it were painted on a shutter
  \item \emph{Say it:} \emph{khulā}
  \item \emph{Say it:} \emph{khulā paisā}
  \item \emph{Recall:} say \emph{paisā}, then read \textbf{\hi{होटल}}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What does \textbf{\hi{खुला}} (\emph{khulā}) mean? (\textquotedblleft{}open\textquotedblright{}.) Say it once more.
\end{tcolorbox}
...
Two things to keep straight. First, \hi{बंद} is not the beginning of \textbf{\hi{बंदर}}, the monkey you met among the animals — the eye will want to join them and they are unrelated. Second, \hi{बंद} stands opposite \textbf{\hi{खुला}} (\emph{khulā}) on exactly the same signboards, so learn them as one pair and you have read half a street.
...
\raggedright
  ...
  \item \emph{Write it:} \textbf{\hi{खुला}} (\emph{khulā}) once more, then \hi{बंद} beside it
  \item \emph{Recall:} read \textbf{\hi{रुपया}}, then say \emph{nāshtā}
\end{itemize}
...
\begin{grammarlens}[title={What you've built}]
Three: \textbf{\hi{खुला}} (\emph{khulā}), \hi{बंद}, \hi{प्रवेश}. Two states of a door and one of its two labels.
\end{grammarlens}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{dām}, then read \textbf{\hi{बिल}}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} read \textbf{\hi{महँगा}}, then say \emph{veṭar}
\end{itemize}
...
\begin{grammarlens}[title={What you've built}]
Five: \textbf{\hi{खुला}} (\emph{khulā}), \hi{बंद}, \hi{प्रवेश}, \hi{निकास}, \hi{देर}. Enough to read a door, find a way through it, and understand why the train has not come.
\end{grammarlens}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{kharīdnā}, then read \textbf{\hi{पीना}}
\end{itemize}
