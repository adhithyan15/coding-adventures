#!/bin/sh
# Build and run the ibm704-encoder tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run c ibm704_encoder-tests tests/ibm704_encoder_test.c src/ibm704_encoder.c
