# ladder_t6_local_let_advanced

Rung 6.local_let of the CCR-066 differential complexity ladder, at `ADVANCED`.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level ADVANCED_OPTIMIZATIONS --js tests/diff/ladder_t6_local_let_advanced/input/a.js
```
