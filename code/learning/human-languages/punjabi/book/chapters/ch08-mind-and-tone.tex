...
% canonical-source-hash: fnv1a64:a2d00ca576be15ed
% canonical-lessons: PA-C08-sochna, PA-S08-khakkha-jhajja-pairin, PA-C08-samajhna, PA-C08-parhna, PA-C08-likhna, PA-S08-pappa
...
\end{tcolorbox}
\section[kha · jha · (no vowel)]{\pa{ਖ} · \pa{ਝ} · \pa{੍} — three pieces met inside a word you already say}

\label{lesson:PA-S08-khakkha-jhajja-pairin}



\begin{quote}
One new mark today is not a sound at all. It is an instruction about the letter beside it.

First, say the last things you learned once more, out loud and from memory:

\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{kivēṁ — tusī̃ kivēṁ ho — maiṁ ṭhīk hāṁ — koī gall nahīṁ} · \emph{jāṇnā} · \emph{sochṇā}
\end{itemize}
\end{quote}

\subsection*{Script you'll notice: \pa{ਖ} · \pa{ਝ} · \pa{੍}}
\begin{quote}
\pa{ਖ}
\end{quote}

\textbf{khakkhā} — \emph{kha}. A consonant, \emph{k} with a clear puff of breath after it — the \emph{k} of English \emph{kin}.

\begin{quote}
\pa{ਝ}
\end{quote}

\textbf{jhajjā} — \emph{jha}. Another letter whose breath became \textbf{pitch}: written breathy, said today with a falling tone.

\begin{quote}
\pa{੍}
\end{quote}

\textbf{pairī̃} — \emph{(no vowel)}. Not a letter and not a vowel sign. It is the mark that says \textbf{no vowel here} — the consonant before it runs straight into the next one, and in print the second letter is often tucked \textbf{underneath} the first.

Now put them where you have already heard them:

\begin{quote}
\textbf{\pa{ਖ}} is \textbf{\pa{ਕ}} with breath after it. Set them side by side: \textbf{\pa{ਕ}}  \textbf{\pa{ਖ}}
\end{quote}

\begin{quote}
\textbf{\pa{ੜ}} + \textbf{\pa{੍}} + \textbf{\pa{ਹ}} $\to$ \textbf{\pa{ੜ੍ਹ}}
\end{quote}

\begin{quote}
\textbf{\pa{ੜ੍ਹ}} — \emph{ṛh} — \textbf{a ṛa with a shrunken \emph{ha} tucked underneath it}
\end{quote}
...
Keep \pa{ਖ} · \pa{ਝ} · \pa{੍} in front of you and do not cover any of them. Follow each shape once with a finger, then copy it once with a pencil, larger than it is printed. Say its sound as your hand stops.
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at \textbf{\pa{ੜ੍ਹ}} and point to each of today's pieces in turn
  \item \emph{Say it:} \emph{kha}, \emph{jha}, \emph{(no vowel)}, then the whole word — \emph{ṛh}
  \item \emph{Look:} back at the headword at the top of any earlier lesson in this chapter and find one shape you now know
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Name today's pieces: \emph{khakkhā}, \emph{jhajjā}, \emph{pairī̃}. Which of them is a \textbf{mātrā} or a mark rather than a letter, and what does \textbf{\pa{ੜ੍ਹ}} say? (\emph{ṛh}, “a ṛa with a shrunken \emph{ha} tucked underneath it”.)
...
\end{tcolorbox}
\section[pa]{\pa{ਪ} — one piece met inside a word you already say}

\label{lesson:PA-S08-pappa}



\begin{quote}
One letter today, and it finishes a word this chapter is built on.

First, say the last things you learned once more, out loud and from memory:

\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{sochṇā} · \emph{samajhṇā}
\end{itemize}
\end{quote}

\subsection*{Script you'll notice: \pa{ਪ}}
\begin{quote}
\pa{ਪ}
\end{quote}

\textbf{pappā} — \emph{pa}. A consonant, the plain \emph{p} of \emph{spin} — no puff of breath.

Now put them where you have already heard them:

\begin{quote}
\textbf{\pa{ਪ}} + \textbf{\pa{ਾ}} + \textbf{\pa{ਠ}} $\to$ \textbf{\pa{ਪਾਠ}} (\emph{pāṭh})
\end{quote}

\begin{quote}
\textbf{\pa{ਪਾਠ}} — \emph{pāṭh} — \textbf{a reading, a recitation, a lesson}
\end{quote}

You are not being asked to write any of this. You are being asked to \textbf{recognise} it the next time it goes past.

\subsection*{Writing: copy what you can see}
Keep \pa{ਪ} in front of you and do not cover it. Follow each shape once with a finger, then copy it once with a pencil, larger than it is printed. Say its sound as your hand stops.
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at \textbf{\pa{ਪਾਠ}} and point to each of today's piece in turn
  \item \emph{Say it:} \emph{pa}, then the whole word — \emph{pāṭh}
  \item \emph{Look:} back at the headword at the top of any earlier lesson in this chapter and find one shape you now know
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Name today's piece: \emph{pappā}. Which of them is a \textbf{mātrā} or a mark rather than a letter, and what does \textbf{\pa{ਪਾਠ}} say? (\emph{pāṭh}, “a reading, a recitation, a lesson”.)
