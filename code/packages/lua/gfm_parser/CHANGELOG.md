# Changelog — coding-adventures-gfm-parser (Lua)
...
- Initial release of the Lua GFM 0.31.2 parser.
...
- **Inline nodes produced**: `text`, `emphasis`, `strong`, `code_span`, `link`
  ...
  `soft_break`.
- Full GFM delimiter run algorithm for emphasis/strong including
...
- LuaRocks rockspec (`coding-adventures-gfm-parser-0.1.0-1.rockspec`).
