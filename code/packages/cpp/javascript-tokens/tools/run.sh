#!/bin/sh
# Build and run the javascript-tokens tests under EVERY available C/C++ compiler (pure ISO),
...
iso_build_and_run cpp javascript_tokens-tests tests/javascript_tokens_test.cpp
