...
% canonical-source-hash: fnv1a64:63e9a0ac9e7a65f8
...
\begin{quote}
You have filled in a \hi{नाम} line without a model. A form asks for more than a name, and the next five words are what it asks for.
\end{quote}
