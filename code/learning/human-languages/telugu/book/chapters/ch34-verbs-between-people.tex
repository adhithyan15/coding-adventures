...
% canonical-source-hash: fnv1a64:82105a37b22a2c84
% canonical-lessons: TE-C34-tiisuko, TE-C34-adugu, TE-C34-sahayam-ceyu, TE-C34-ishtam, TE-S130-letter-tha
...
\begin{quote}
Before the new one: \te{ఋ} — what does it do?
...
The \emph{h} in \emph{tha} is a puff of breath, the same thing you added to \textbf{\te{బ}} to get \textbf{\te{భ}} when the good-night greeting arrived. Here the plain letter is \textbf{\te{త}}, the very first character this book ever asked you to trace. Say \emph{ta}, then say it again and let the breath out after it: that is \textbf{\te{థ}}.

It is worth saying what this letter is \textbf{not}. It is not the \emph{th} of English \emph{this} or \emph{thin}. The tongue stays where it goes for \textbf{\te{త}}, against the back of the teeth; only the breath is added.
...
In both, \te{థ} is carrying \textbf{\te{ర}} stacked on top of it — the \textbf{\te{ర్థ}} block named when you learned to understand things. Now the lower half of that block has a name of its own.
...
\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which character is this — \te{థ}? What does it carry that \te{త} does not, and what does it \emph{not} sound like? (\emph{\textbf{tha}} — the same \emph{t} with a puff of breath after it, and not the English \emph{th}.) Name one word you already say that contains it.
\end{tcolorbox}
