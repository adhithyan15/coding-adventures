...
% canonical-source-hash: fnv1a64:337e6407831acb46
...
\raggedright
  ...
  \item \emph{Read it:} \textbf{\ta{௧} \ta{௨} \ta{௩} \ta{௪} \ta{௫}} — then answer \emph{evvaḷavu?} by pointing at one
\end{itemize}
...
\raggedright
  ...
  \item \emph{Recall:} say \emph{ūr}, then read \textbf{\ta{நண்பன்}}, then say \emph{ivar}
\end{itemize}
