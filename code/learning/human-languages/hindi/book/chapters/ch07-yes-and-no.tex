...
% canonical-source-hash: fnv1a64:aa48e6b2a336a865
...
\end{tcolorbox}
\section[nahīṃ]{\hi{नहीं} (nahīṃ) — no / not}
...
\begin{itemize}
\raggedright
  \item \textbf{answer}: \emph{\hi{क्या} \hi{आप} \hi{ठीक} \hi{हैं}?} — \textbf{\hi{नहीं}.} (\textquotedblleft{}Are you well?\textquotedblright{} — \textquotedblleft{}No.\textquotedblright{})
