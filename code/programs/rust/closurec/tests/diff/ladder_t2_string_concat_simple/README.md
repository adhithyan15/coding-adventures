# ladder_t2_string_concat_simple
...
Exercises constant string concatenation.
...
java -Duser.language=en -Duser.country=US -Duser.timezone=UTC -Dfile.encoding=UTF-8 \
  ...
  --compilation_level SIMPLE_OPTIMIZATIONS --js tests/diff/ladder_t2_string_concat_simple/input/a.js
```
