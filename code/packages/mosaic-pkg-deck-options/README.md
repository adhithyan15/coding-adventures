...
values, Anki leech threshold/action controls, sibling-bury checkboxes, and
change events so HTML, React, Electron, SwiftUI, Qt, XAML, and Flutter shells
can share one settings surface.
