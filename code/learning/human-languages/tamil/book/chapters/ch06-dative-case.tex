...
% canonical-source-hash: fnv1a64:465229150c52a691
...
\midrule
\emph{peyar} — name & \emph{peyar\textbf{ukku}} & to/for the name \\
\emph{vēlai} — work & \emph{vēlai\textbf{kku}} & for work \\
\bottomrule
\end{tabularx}
...
\begin{quote}
\emph{nāṉ} (\textquotedblleft{}I\textquotedblright{}) $\to$ \emph{enakku} (\textquotedblleft{}to me\textquotedblright{})
\end{quote}
...
\raggedright
  ...
  \item \textquotedblleft{}\emph{vēlaikku}\textquotedblright{} — \textquotedblleft{}for work,\textquotedblright{} from Ch. 5's \emph{vēlai}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What does \textbf{-\ta{உக்கு}} mean? (\textquotedblleft{}\textbf{To}\textquotedblright{} or \textquotedblleft{}\textbf{for}.\textquotedblright{}) Where does it go? (\textbf{On the end} of the noun — Tamil adds, it doesn't put a word in front.) What is \textquotedblleft{}to me\textquotedblright{}? (\emph{\textbf{enakku}} — the pronoun's body changes to \emph{en-} first.) Why does the suffix show up as \emph{-ukku} and \emph{-kku}? (\textbf{One case, two shapes}, chosen by the noun's ending.) Next: two more letters — \ta{ம} and retroflex \ta{ண}.
\end{tcolorbox}
...
\hlblockfigure{\detokenize{figures/TA-S01-va-filmstrip.pdf}}{How \ta{வ} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item \textbf{a straight vertical stroke on the LEFT}
  \item \textbf{a horizontal along the bottom}
  \item \textbf{a rounded arch closing it on the RIGHT}
\end{enumerate}
...
\begin{quote}
In Chapter 5 you said \emph{\textbf{nāṉ tamiḻ pēsugiṟēṉ}} — \textquotedblleft{}\textbf{I} speak Tamil,\textquotedblright{} with \emph{nāṉ} as the subject. Now say \textquotedblleft{}I \textbf{know} Tamil.\textquotedblright{} Tamil will not let you use \emph{nāṉ}.
\end{quote}
...
\end{tcolorbox}
\section[enakku / nāku / nanage / enikku]{-ukku, -ku, -ge, -ikku — the family shows its bones}
...
\hlblockfigure{\detokenize{figures/TA-S02-nna-filmstrip.pdf}}{How \ta{ண} is written, stroke by stroke}
...
\hlblockfigure{\detokenize{figures/TA-S101-letter-pa-filmstrip.pdf}}{How \ta{ப} is written, stroke by stroke}
