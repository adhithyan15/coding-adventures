...
around a direct signed literal are ignored while preserving that spelling. Real
variables, computed real expressions, and conditionals with a computed leaf
