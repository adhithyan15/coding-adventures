...
describe("the real corpus", () => {
  ...
  it("pins what nothing had measured", { timeout: 30_000 }, () => {
    ...
    expect(report.summary.tracksWithUnorderedLessons).toBe(10); // HL-C258: -1 -- IMPROVEMENT. bengali leaves this list: its ch2-ch5 lessons had no sequence at all, and migration assigned them in one global prerequisite order across the four chapters // HL-C251: -1 -- IMPROVEMENT, the migrated russian ch1 lessons close a continuity window that nothing could measure while they were v1 // HL11: -5. Hindi, Telugu, Kannada, Malayalam and Sanskrit now declare a reading order for every lesson, recovered from their own books
