...
\hlblockfigure{\detokenize{figures/JA-W09-mi-filmstrip.pdf}}{How \ja{み} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item Trace \textbf{\ja{み}} once with a finger.
  \item Trace it once with a pencil.
  \item Point to \textbf{\ja{み}} inside \textbf{\ja{すみません}}; do not decode the other signs yet.
\end{enumerate}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/JA-W09-me-filmstrip.pdf}}{How \ja{め} is written, stroke by stroke}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/JA-W09-ku-filmstrip.pdf}}{How \ja{く} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item Look at \textbf{\ja{く}} for five seconds.
  \item Hide it and write the one angled stroke.
  \item Reveal, check, then join known \textbf{\ja{よ}} + \textbf{\ja{く}} $\to$ \textbf{\ja{よく}}.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item Copy \textbf{\ja{と} $\to$ \ja{ど}} once.
  \item Cover the model and write the voiced sign from the heard mora \emph{do}.
  \item Read \textbf{\ja{と} / \ja{ど}} as \emph{to / do} without changing the vowel.
\end{enumerate}
...
\subsection*{Script — the shape}
\hlblockfigure{\detokenize{figures/JA-W09-mo-filmstrip.pdf}}{How \ja{も} is written, stroke by stroke}
...
\begin{enumerate}
\raggedright
  \item Copy \textbf{\ja{も}} once.
  \item Hide it for ten seconds and write it again.
  \item Add known \textbf{\ja{う}}: \textbf{\ja{もう}}. Read \emph{mo | o}.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item Hear \emph{i | chi | do} without looking.
  \item Write \textbf{\ja{いちど}} from the three morae.
  \item Read \textbf{\ja{もういちど}}, keeping the two beats in \textbf{\ja{もう}}.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item \textbf{Listen:} distinguish \emph{sumimasen} from \emph{mō ichido, onegaishimasu}.
  \item \textbf{Speak:} say the opener, then the request, with a small pause.
  \item \textbf{Read:} independently read \textbf{\ja{もういちど}}; use the printed support for the rest.
  \item \textbf{Write:} from dictation, write only the independently earned block \textbf{\ja{もういちど}}.
\end{enumerate}
