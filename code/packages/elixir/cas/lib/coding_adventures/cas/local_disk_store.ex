defmodule CodingAdventures.Cas.LocalDiskStore do
  @moduledoc """
  ...
  `%LocalDiskStore{root: path}` where `root` is an absolute path string.
      ...
      store = %CodingAdventures.Cas.LocalDiskStore{root: "/tmp/myrepo/objects"}
  """

  alias CodingAdventures.Cas.Hex

  @behaviour CodingAdventures.Cas.BlobStore
  ...
  ## Examples
      ...
      iex> store = CodingAdventures.Cas.LocalDiskStore.new!(System.tmp_dir!() <> "/cas-test-new")
      iex> is_struct(store, CodingAdventures.Cas.LocalDiskStore)
      true
  """
  @spec new!(String.t()) :: t()
  ...
  """
  @impl CodingAdventures.Cas.BlobStore
