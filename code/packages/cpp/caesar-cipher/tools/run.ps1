# Build and run the caesar-cipher tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang cpp -Name caesar_cipher-tests -Sources @("tests\caesar_cipher_test.cpp")
