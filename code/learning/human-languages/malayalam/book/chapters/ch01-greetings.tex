...
% canonical-source-hash: fnv1a64:547a3d0852b626de
...
{[}YOU HEAR: \emph{namaskāram} — “greetings”{]}
...
\begin{itemize}
\raggedright
  \item a · the $\to$ \textquotedblleft{}athe\textquotedblright{}
  \item note the \textquotedblleft{}e\textquotedblright{} sign sits \emph{before} \ml{ത} but is read \emph{after} it
  \item \textquotedblleft{}athe\textquotedblright{} — \textquotedblleft{}yes, that's so\textquotedblright{}
\end{itemize}
