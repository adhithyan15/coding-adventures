...
% canonical-source-hash: fnv1a64:706f32823c58fdc5
...
\textbf{Bitte} taught you a complete polite request out of two known words: \textbf{Wasser, bitte.} The same pattern takes any drink you can name:
...
The last chapter closed on \textbf{schließen}, a verb Proto-Germanic built and English lost outright. \emph{Kaffee} is the opposite kind of word: nothing here is inherited, and nothing needed to be — German simply took the whole word, sound and all, the way it took \emph{Wein} centuries earlier.
\end{cousinweb}
...
\raggedright
  ...
  \item \textquotedblleft{}Kaffee, bitte.\textquotedblright{} — the \emph{bitte} pattern, one word swapped
...
\begin{sounds}
German's \textbf{ch} is not one sound but two. After a back vowel like the \emph{a} of \emph{Nacht}, it is a rasp at the back of the throat. After a front vowel or consonant like the \emph{i} of \textbf{Milch}, it is soft, made further forward — closer to a hissed \emph{h}. Say \emph{ich} (your own word for \textquotedblleft{}I\textquotedblright{}) right before \emph{Milch} and you are making the same sound twice.
\end{sounds}
