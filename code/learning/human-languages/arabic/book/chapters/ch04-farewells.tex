...
% canonical-source-hash: fnv1a64:27f4cdd278ddb5bc
...
\begin{quote}
Point to \textbf{\ar{ْ}}, \textbf{\ar{ّ}}, \textbf{\ar{ً}}: “no vowel”, “double”, “-an”.
...
\hlblockfigure{\detokenize{figures/AR-W10-ayn-filmstrip.pdf}}{How \ar{ع} is written, stroke by stroke}

Break it apart — \emph{an open curve, then a bowl}:

\begin{enumerate}
\raggedright
  \item \textbf{the open-mouth curve} on top — like a small \textbf{c} opening to the left.
  \item \textbf{the bowl below}, when \emph{ʿayn} stands alone or ends a word — a scoop underneath.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item \textbf{the loop} — a closed round body.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item \textbf{\ar{م}} (\emph{mīm}, Lesson 3) — round head, joining left into…
  \item \textbf{\ar{ع}} (\emph{ʿayn}, Lesson 10) — the open curve over its bowl, closing the word.
\end{enumerate}
...
\begin{enumerate}
\raggedright
  \item \textbf{\ar{م}} then \textbf{\ar{ع}} $\to$ \textbf{\ar{مع}}
  \item lift; \textbf{\ar{ا}} + \textbf{\ar{ل}} (the \emph{al-}), the \emph{lām} joining into…
  \item \textbf{\ar{س} · \ar{ل} · \ar{ا}} — and remember the \textbf{\ar{لا}} ligature, and that \emph{alif} \textbf{breaks}…
  \item \textbf{\ar{م}}, then \textbf{\ar{ة}} to close.
\end{enumerate}
