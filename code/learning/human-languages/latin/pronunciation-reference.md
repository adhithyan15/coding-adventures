# Latin / Lingua Latīna — Reference

A **reference**, not a chapter — the lessons teach the sounds through real words.
This page gathers the classical scheme (the one this course uses).
...
2. **Vowels come long or short, marked by a macron.** ā ē ī ō ū are *held longer*
   ...
   never wrote.
3. **Diphthongs:** *ae* = "eye" (*Caesar* = *KYE-sar*), *au* = "ow," *oe* = "oy";
   otherwise adjacent vowels each keep their value.

## Worth flagging

- ***v* = w, *i* = y** as consonants: *vīnum* ("wine") = *WEE-noom*, *Iulius* =
