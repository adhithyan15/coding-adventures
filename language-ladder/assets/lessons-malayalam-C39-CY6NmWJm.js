...
introduces:
  knowledge: [ML-LEX-ANCHOR-GAANAM]
practises:
  knowledge: [ML-LEX-ANCHOR-GAANAM, ML-SCRIPT-RECOG-130]
skills: [listening, speaking, reading]
...
## You'll want to know: ഗാനം
<!-- hl-knowledge: introduces=[ML-LEX-ANCHOR-GAANAM]; assesses=[] -->

**ഗാനം** — *gānam* — "a song".

Say it: *gānam*. Look at its shape as you say it: the next lesson takes one
piece of it, **ഗ**, and writes it on its own.

## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-ANCHOR-GAANAM] -->

[PAUSE 1s]
- [YOU SAY: *gānam*]
- [YOU SAY: *gānam*, and what it means]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-ANCHOR-GAANAM] -->

[PAUSE 3s] What is "a song"? (**ഗാനം**, *gānam*.)
`,a=e({default:()=>o}),o=`---
schema_version: 2
id: ML-C39-kaapi
spine_node: SPINE-POLITE-REQUEST-REPAIR
...
prerequisites: [ML-C41-this, ML-C37-vaay]
sounds: []
roots: []
duration:
  max_seconds: 210
...
practises:
  knowledge: [ML-LEX-C41-DEIXIS-01, ML-LEX-C41-DEIXIS-02, ML-CONCEPT-C37-VAAY-01, ML-CONCEPT-C37-VAAY-02]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output]
register: neutral
...
## Guided Practice
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C41-DEIXIS-02, ML-CONCEPT-C37-VAAY-01, ML-CONCEPT-C37-VAAY-02] -->
