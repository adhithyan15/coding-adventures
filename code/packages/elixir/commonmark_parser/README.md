...
CommonMark 0.31.2 parser for Elixir — 100% spec conformity (652/652 examples).

Converts a CommonMark Markdown string into a `CodingAdventures.DocumentAst` node tree
...
- Lazy paragraph continuation (CommonMark §5.1, §5.3)
...
The inline parser implements the CommonMark delimiter stack algorithm (Appendix A).
...
The test suite runs all 652 examples from the CommonMark 0.31.2 specification
