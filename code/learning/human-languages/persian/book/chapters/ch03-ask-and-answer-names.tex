...
% canonical-source-hash: fnv1a64:6a53bf77fa6a72f7
% canonical-lessons: FA-C03-shoma-to, FA-C03-shoma-to-more, FA-C03-chist, FA-C03-esm-e-shoma-chist, FA-C03-khoshvaghtam, FA-C03-practice
...
\end{tcolorbox}
\section[(shomâ / to, continued)]{(\fa{شما} / \fa{تو}, continued) — The word, taken apart}

\label{lesson:FA-C03-shoma-to-more}



\begin{quote}
Before going on: say \textbf{\fa{شما} / \fa{تو}} again, and what it means.
\end{quote}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} what this lesson added to \textbf{\fa{شما} / \fa{تو}}, in one sentence
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What did this lesson add to \textbf{\fa{شما} / \fa{تو}}? Say it once more, without looking.
\end{tcolorbox}
...
\hlblockfigure{\detokenize{figures/FA-C03-chist-filmstrip.pdf}}{How \fa{چ} is written, stroke by stroke}
