...
schema_version: 2
id: ML-R100-clothing-recall
spine_node: SPINE-DEFINITE-REFERENCE
sequence: 3610
chapter: 100
type: review
headword: (a mundu, a sari, a sandal, a cap)
gloss: cold retrieval of the four worn things, and of an adjective that has not moved since the chapter that taught it
romanization: muṇṭuṁ sāriyuṁ enna ōrmma
concept_tag: ML-CLOTHING-RECALL
prerequisites: [ML-C100-thoppi, ML-C42-adjective-system]
sounds: []
roots: []
duration:
  max_seconds: 270
...
introduces:
  knowledge: []
practises:
  knowledge: [ML-LEX-C100-MUNDU-01, ML-LEX-C100-SARI-01, ML-LEX-C100-SANDAL-01, ML-LEX-C100-CAP-01, ML-LEX-AANU-01, ML-LEX-C42-ADJ-04, ML-LEX-C42-ADJ-05, ML-LEX-C41-DEIXIS-01, ML-LEX-C46-ASK-02]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus]
register: neutral
variety: standard-colloquial
reviews_of: [ML-C100-mundu, ML-C100-saari, ML-C100-cheruppu, ML-C100-thoppi]
---

# (a mundu, a sari, a sandal, a cap) — from cold
...
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C100-MUNDU-01, ML-LEX-C100-SARI-01, ML-LEX-C100-SANDAL-01, ML-LEX-C100-CAP-01, ML-LEX-AANU-01] -->

Four things to wear, and **between them only two endings**:
...
[PAUSE 1s]
- [YOU SAY: *muṇṭŭ*, *sāri*, *ceruppŭ*, *toppi*]
- [YOU SAY: *itŭ putiya muṇṭāṇŭ*, then *itŭ paḻaya ceruppāṇŭ*]
- [YOU SAY: the word for the cloth a **മുണ്ട്** is made of]
- [YOU SAY: which two of the four gain a **യ**, and what they end in]

## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C100-MUNDU-01, ML-LEX-C100-SARI-01, ML-LEX-C100-CAP-01, ML-LEX-C42-ADJ-04] -->

[PAUSE 3s] A mundu, a sari, a cap? (**മുണ്ട്, സാരി, തൊപ്പി**.) Which of the
three takes **nothing** before **ആണ്**? (**മുണ്ട്** — it ends in the half-u.)
And where does **പുതിയ** stand? (**In front, unchanged**.)
`,r=e({default:()=>i}),i=`---
schema_version: 2
id: ML-R101-build-recall
spine_node: SPINE-DEFINITE-REFERENCE
sequence: 3660
chapter: 101
type: review
headword: (short, thin, stout, and height)
gloss: cold retrieval of three adjectives and one noun, and of why the noun needs a different machine
romanization: uyaravuṁ kuṟiyayuṁ enna ōrmma
concept_tag: ML-BUILD-RECALL
prerequisites: [ML-C101-uyaram, ML-C42-adjective-system]
sounds: []
roots: []
duration:
  max_seconds: 270
requires:
  knowledge: [ML-LEX-C101-SHORT-01, ML-LEX-C101-THIN-01, ML-LEX-C101-STOUT-01, ML-LEX-C101-HEIGHT-01, ML-CONCEPT-C32-UNDU-01]
introduces:
  knowledge: []
practises:
  knowledge: [ML-LEX-C101-SHORT-01, ML-LEX-C101-THIN-01, ML-LEX-C101-STOUT-01, ML-LEX-C101-HEIGHT-01, ML-CONCEPT-C32-UNDU-01, ML-CONCEPT-C06-DATIVE-SUBJECT-01, ML-GRAMMAR-C42-ADJ-SYSTEM, ML-CONCEPT-C36-KUTTI-01, ML-LEX-C42-ADJ-02]
skills: [listening, speaking, reading]
modes: [interpretive, interpersonal, presentational]
strands: [meaning-input, meaning-output, language-focus]
register: neutral
variety: standard-colloquial
reviews_of: [ML-C101-kuriya, ML-C101-melinja, ML-C101-thadicha, ML-C101-uyaram]
---

# (short, thin, stout, and height) — from cold
...
Three of this chapter's four words are **adjectives**, and all three behave the
way every adjective in the book has:

| adjective | before the noun |
|---|---|
| **കുറിയ** | **കുറിയ കുട്ടി** (*kuṟiya kuṭṭi*) |
| **മെലിഞ്ഞ** | **മെലിഞ്ഞ കുട്ടി** (*meliñña kuṭṭi*) |
| **തടിച്ച** | **തടിച്ച കുട്ടി** (*taṭicca kuṭṭi*) |

They end **-ിയ**, **-ഞ്ഞ** and **-ച്ച** — three different shapes, all closing on
**-a**, none of them changing for the noun behind it.

**ഉയരം is the odd one, and not because it is irregular.** It is a **noun**, so
...
## What you've built
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C101-HEIGHT-01, ML-CONCEPT-C32-UNDU-01, ML-CONCEPT-C06-DATIVE-SUBJECT-01, ML-LEX-C42-ADJ-02] -->

**The book still has no single word for *tall*.** It has a noun for height and a
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C101-SHORT-01, ML-LEX-C101-STOUT-01, ML-LEX-C101-HEIGHT-01, ML-CONCEPT-C32-UNDU-01] -->

[PAUSE 3s] Short, stout, height? (**കുറിയ, തടിച്ച, ഉയരം**.) Which of the three
cannot go in front of a noun? (**ഉയരം** — it is a noun itself.) So how do you
say *I am tall*? (**എനിക്ക് ഉയരമുണ്ട്**.)
`,a=e({default:()=>o}),o=`---
schema_version: 2
id: ML-R99-arts-recall
spine_node: SPINE-DEFINITE-REFERENCE
sequence: 3560
chapter: 99
type: review
headword: (a song, singing, dance, a story)
gloss: cold retrieval of the four arts words, and of the three things an ending can do to the word in front of it
romanization: pāṭṭuṁ kathayuṁ enna ōrmma
concept_tag: ML-ARTS-RECALL
prerequisites: [ML-C99-katha, ML-C98-sinima]
sounds: []
roots: []
duration:
  max_seconds: 270
requires:
  knowledge: [ML-LEX-C99-SONG-01, ML-LEX-C99-SING-01, ML-LEX-C99-DANCE-01, ML-LEX-C99-STORY-01, ML-LEX-AANU-01]
introduces:
  knowledge: []
practises:
...
register: neutral
variety: standard-colloquial
reviews_of: [ML-C99-paattu, ML-C99-paaduka, ML-C99-nrttham, ML-C99-katha]
---

# (a song, singing, dance, a story) — from cold
...
**പാട്ട്** is the song; **പാടുക** is doing it. Unlike **കളി** and
**കളിക്കുക**, the noun is not sitting whole inside the verb — the long **ṭṭ**
thins to a single **ṭ**:
...
## Wrap-up Recall
<!-- hl-knowledge: introduces=[]; assesses=[ML-LEX-C99-SONG-01, ML-LEX-C99-DANCE-01, ML-LEX-C99-STORY-01] -->

[PAUSE 3s] A song, dance, a story? (**പാട്ട്, നൃത്തം, കഥ**.) Which of the three
**gives a sound up** before **ആണ്**? (**പാട്ട്** — it ends in the half-u.) And
which **adds** one? (**കഥ** — it ends in **അ**, so a **യ** comes in.)
