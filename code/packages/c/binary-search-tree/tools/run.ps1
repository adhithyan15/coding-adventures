# Build and run the binary-search-tree tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name binary_search_tree-tests -Sources @("tests\binary_search_tree_test.c", "src\binary_search_tree.c")
