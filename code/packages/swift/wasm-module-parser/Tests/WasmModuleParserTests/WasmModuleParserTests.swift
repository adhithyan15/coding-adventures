import XCTest
@testable import WasmModuleParser

/// WasmModuleParserTests — unit tests for the WasmModuleParser module.
///
...
final class WasmModuleParserTests: XCTestCase {
    ...
    func testModuleLoads() {
        ...
        let _ = WasmModuleParser()
        XCTAssertTrue(true, "WasmModuleParser instantiated successfully")
    }
}
