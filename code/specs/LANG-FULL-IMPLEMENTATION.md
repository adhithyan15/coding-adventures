...
variable-free, exact tracked-local-integer, or exact integral tracked-local-real
exponents, and exact tracked local
...
operands, standard-free tracked-real powers, effectful
