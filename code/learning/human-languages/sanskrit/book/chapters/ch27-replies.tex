...
% canonical-source-hash: fnv1a64:8f83c96ccae290e3
% canonical-lessons: SA-C27-so-be-it, SA-S223-vowel-sign-ai, SA-C27-well-done, SA-C27-enough, SA-C27-true, SA-C27-thus
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{astu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{asti}, then \emph{astu}, and say what changed between them
  \item \emph{Recall:} say \emph{hastaḥ}, then read \textbf{\sk{गुरुः}}
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
What does \sk{अस्तु} mean? (\textquotedblleft{}so be it, all right\textquotedblright{}.) Say it once more.
\end{tcolorbox}
\section[ai]{\sk{◌ै} — one character, met inside words you already say}

\label{lesson:SA-S223-vowel-sign-ai}



\begin{quote}
Before the new one, the ones you have already met: \sk{◌ू} · \sk{ओ} · \sk{फ}. Say what each of them does.

One character this time. One only — and you have been saying it for pages without knowing which mark on the page it was.
\end{quote}

\subsection*{Script you'll notice: \sk{◌ै}}
\textbf{\sk{◌ै}} — \emph{ai}.
...
Where it sits: a double stroke above the top bar.

Worked through: \textbf{\sk{न}} + \textbf{\sk{◌ै}} = \textbf{\sk{नै}} — \emph{nai}.

You already say these, and every one of them has \sk{◌ै} somewhere inside it:

\begin{itemize}
\raggedright
  \item \textbf{\sk{वैद्यः}} \emph{vaidyaḥ} — a physician
\end{itemize}

\subsection*{Writing: \sk{◌ै} — copy what you see}
Put your pen on \sk{◌ै} and follow its line. Copy the shape you can see — slowly, and larger than it is printed.
...
\begin{itemize}
\raggedright
  \item \emph{Look:} at this, and find \sk{◌ै} in it
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Trace it:} \sk{◌ै} three times, saying \emph{ai} as you finish each one
  \item \emph{Look:} back at any page of this chapter and find \sk{◌ै} once more
\end{itemize}

\begin{tcolorbox}[breakable,colback=teal!4,colframe=teal!35!black,title={Before you move on}]
Which character is this — \sk{◌ै}? What vowel does it put on the consonant it attaches to — and what does it take off? (\textbf{Puts \emph{ai} on; takes the built-in \emph{a} off.}) Name one word you already say that contains it.
\end{tcolorbox}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{sādhu}, then \emph{guruḥ}, and say what English kept of each
  \item \emph{Recall:} read \textbf{\sk{पादः}}, then say \emph{śiṣyaḥ}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{alam}, then \emph{keśaḥ}, and name what those two have in common
  \item \emph{Recall:} say \emph{śiraḥ}, then read \textbf{\sk{राजा}}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{satyam}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{asti}, \emph{astu}, \emph{satyam} — three from one root, in that order
  \item \emph{Recall:} read \textbf{\sk{दन्तः}}, then say \emph{atithiḥ}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{evam}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then \emph{evam astu} as one phrase
  \item \emph{Recall:} say \emph{keśaḥ}, then read \textbf{\sk{वैद्यः}}
\end{itemize}
