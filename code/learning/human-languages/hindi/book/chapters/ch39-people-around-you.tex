...
% canonical-source-hash: fnv1a64:c0ad76be3a15b409
...
\end{tcolorbox}
\section[\hi{औरत} / \hi{महिला} / \hi{स्त्री}]{\hi{औरत} (aurat) — the word for \textquotedblleft{}woman,\textquotedblright{} and which one to use}
