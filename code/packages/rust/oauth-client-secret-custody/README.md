...
audit. Exchange, refresh, and revocation authentication also retain their exact
provider/trace response context for later audit-gated classification.
Authentication can be derived from validated RFC 8414 metadata only
