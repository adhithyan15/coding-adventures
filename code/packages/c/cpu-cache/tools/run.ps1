# Build and run the cpu-cache tests under MSVC (cl.exe) — pure ISO C/C++ — via the
...
Iso-BuildAndRun -Lang c -Name cpu_cache-tests -Sources @("tests\cpu_cache_test.c", "src\cpu_cache.c")
