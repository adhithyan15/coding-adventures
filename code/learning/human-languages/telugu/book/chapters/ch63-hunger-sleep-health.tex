...
% canonical-source-hash: fnv1a64:dcde0df10939f492
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{ākali}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{nāku ākali}, then ask \emph{mīru elā unnāru?}
  \item \emph{Recall:} say \emph{perugu}, then read \textbf{\te{దారం}} and say what it means
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{nidra}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{nidra}, then \emph{ākali}, and say which one you have now
  \item \emph{Recall:} read \textbf{\te{నెయ్యి}}, then say \emph{sūdi}
\end{itemize}
...
\begin{itemize}
\raggedright
  \item \emph{Say it:} \emph{daggu}
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{daggu}, then \emph{nidra}, and say which one keeps you from the other
  \item \emph{Recall:} say \emph{nūne}, then read \textbf{\te{చీపురు}} and say what it means
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} \emph{rōgaṁ}, then \emph{daggu}, and say which one is the smaller trouble
  \item \emph{Recall:} read \textbf{\te{చక్కెర}}, then say \emph{goḍugu}
\end{itemize}
...
\raggedright
  ...
  \item \emph{Say it:} it once more, slowly
  \item \emph{Say it:} all five in order, then ask \emph{mī ārōgyaṁ elā undi?}
  \item \emph{Recall:} say \emph{mirapa}, then read \textbf{\te{అద్దం}} and say what it means
\end{itemize}
