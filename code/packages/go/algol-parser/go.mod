module github.com/adhithyan15/coding-adventures/code/packages/go/algol-parser

go 1.23

require (
	github.com/adhithyan15/coding-adventures/code/packages/go/algol-lexer v0.0.0
...
replace github.com/adhithyan15/coding-adventures/code/packages/go/algol-lexer => ../algol-lexer
