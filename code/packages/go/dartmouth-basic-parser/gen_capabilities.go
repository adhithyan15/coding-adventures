...
//     --manifest=code/packages/go/dartmouth-basic-parser/required_capabilities.json
//
...
var _allowedPath_0 = sync.OnceValue(func() string {
	...
	return filepath.Clean(filepath.Join(filepath.Dir(_file), "../../../grammars/dartmouth_basic/dartmouth_basic.grammar"))
})
