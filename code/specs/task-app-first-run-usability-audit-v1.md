...
| Create, complete, reopen, edit, and delete without project-management terminology | Partial | Create/complete/reopen/delete pass the real WASM and WinUI lifecycles. List has no edit path (#13688), and the completion control exposes only `○`/`✓` as its name (#13691). |
...
| Useful empty, loading, validation, overdue, and persistence-recovery states | Partial | Overdue is a plain-language row chip. Empty state/focus is #13687; blank startup/failure is #13695; blank-name and invalid-date submissions fail silently (#13689); persistence fallback and recovery are console-only (#13690). |
...
3. [#13688](https://github.com/adhithyan15/coding-adventures/issues/13688) —
   edit task names and due dates in List.
4. [#13691](https://github.com/adhithyan15/coding-adventures/issues/13691) —
   descriptive completion-control names.
5. [#13690](https://github.com/adhithyan15/coding-adventures/issues/13690) —
   local-storage, fallback, recovery, and backup discoverability.
6. [#13695](https://github.com/adhithyan15/coding-adventures/issues/13695) —
   visible startup loading and failure states.
7. [#13692](https://github.com/adhithyan15/coding-adventures/issues/13692) —
